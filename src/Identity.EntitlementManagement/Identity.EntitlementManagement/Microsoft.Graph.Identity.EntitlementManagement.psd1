#
# Module manifest for module 'Microsoft.Graph.Identity.EntitlementManagement'
#
...
RootModule = './Microsoft.Graph.Identity.EntitlementManagement.psm1'
...
GUID = '97ec6c14-4065-43b2-8bdf-7a964aaa2982'
...
RequiredAssemblies = 
               './bin/Microsoft.Graph.Identity.EntitlementManagement.private.dll'
...
FormatsToProcess = './Microsoft.Graph.Identity.EntitlementManagement.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
# NestedModules = @()

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-MgEntitlementManagementAccessPackage', 
