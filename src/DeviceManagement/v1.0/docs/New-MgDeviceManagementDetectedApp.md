...
New-MgDeviceManagementDetectedApp [-AdditionalProperties <Hashtable>] [-DeviceCount <Int32>]
 ...
 [-Platform <DetectedAppPlatformType>] [-Publisher <String>] [-ResponseHeadersVariable <String>]
 [-SizeInByte <Int64>] [-Version <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
