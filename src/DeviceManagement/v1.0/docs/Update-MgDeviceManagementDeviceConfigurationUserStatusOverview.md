...
Update-MgDeviceManagementDeviceConfigurationUserStatusOverview -DeviceConfigurationId <String>
 ...
 [-PendingCount <Int32>] [-SuccessCount <Int32>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgDeviceManagementDeviceConfigurationUserStatusOverview -DeviceConfigurationId <String>
 -BodyParameter <IMicrosoftGraphDeviceConfigurationUserOverview> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
