...
Update-MgDeviceManagementUserExperienceAnalyticMetricHistory -UserExperienceAnalyticsMetricHistoryId <String>
 ...
 [-MetricType <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgDeviceManagementUserExperienceAnalyticMetricHistory -UserExperienceAnalyticsMetricHistoryId <String>
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsMetricHistory> [-Headers <IDictionary>] [-Confirm]
