...
New-MgDeviceManagementUserExperienceAnalyticAppHealthOverviewMetricValue [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Unit <String>] [-Value <Double>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgDeviceManagementUserExperienceAnalyticAppHealthOverviewMetricValue
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsMetric> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
