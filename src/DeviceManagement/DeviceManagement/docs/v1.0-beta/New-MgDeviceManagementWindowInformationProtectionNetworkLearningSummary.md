...
# New-MgBetaDeviceManagementWindowInformationProtectionNetworkLearningSummary
...
```
New-MgBetaDeviceManagementWindowInformationProtectionNetworkLearningSummary [-AdditionalProperties <Hashtable>]
