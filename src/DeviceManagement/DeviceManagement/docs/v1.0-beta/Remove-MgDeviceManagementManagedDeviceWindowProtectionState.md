...
# Remove-MgBetaDeviceManagementManagedDeviceWindowProtectionState
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementManagedDeviceWindowProtectionState -ManagedDeviceId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementManagedDeviceWindowProtectionState -InputObject <IDeviceManagementIdentity>
