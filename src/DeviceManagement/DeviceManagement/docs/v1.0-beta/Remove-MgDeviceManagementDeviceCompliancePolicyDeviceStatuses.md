...
# Remove-MgBetaDeviceManagementDeviceCompliancePolicyDeviceStatuses
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceCompliancePolicyDeviceStatuses -DeviceComplianceDeviceStatusId <String>
 -DeviceCompliancePolicyId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceCompliancePolicyDeviceStatuses -InputObject <IDeviceManagementIdentity>
