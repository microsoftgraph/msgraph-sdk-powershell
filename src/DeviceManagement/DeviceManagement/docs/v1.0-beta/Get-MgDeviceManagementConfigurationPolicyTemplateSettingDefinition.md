...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementconfigurationpolicytemplatesettingdefinition
schema: 2.0.0
---
...
Get-MgDeviceManagementConfigurationPolicyTemplateSettingDefinition
 ...
 -DeviceManagementConfigurationSettingTemplateId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceManagementConfigurationPolicyTemplateSettingDefinition -InputObject <IDeviceManagementIdentity>
