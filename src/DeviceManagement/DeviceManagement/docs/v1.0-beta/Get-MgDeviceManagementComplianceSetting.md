...
### List (Default)
```
Get-MgBetaDeviceManagementComplianceSetting [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementComplianceSetting -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
