...
# Update-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses
...
```
Update-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses -DeviceCompliancePolicyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses -InputObject <IDeviceManagementIdentity>
