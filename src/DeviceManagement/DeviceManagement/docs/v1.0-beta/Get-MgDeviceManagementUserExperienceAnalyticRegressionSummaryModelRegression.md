...
# Get-MgBetaDeviceManagementUserExperienceAnalyticRegressionSummaryModelRegression
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticRegressionSummaryModelRegression [-ExpandProperty <String[]>]
