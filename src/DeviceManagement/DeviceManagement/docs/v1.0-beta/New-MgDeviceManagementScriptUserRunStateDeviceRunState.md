...
New-MgDeviceManagementScriptUserRunStateDeviceRunState -DeviceManagementScriptId <String>
 ...
 [-ManagedDevice <IMicrosoftGraphManagedDevice1>] [-ResultMessage <String>] [-RunState <RunState>] [-Confirm]
...
New-MgDeviceManagementScriptUserRunStateDeviceRunState -InputObject <IDeviceManagementIdentity>
 ...
 [-ResultMessage <String>] [-RunState <RunState>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
