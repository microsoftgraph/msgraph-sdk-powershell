...
# Remove-MgBetaDeviceManagementDerivedCredentials
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDerivedCredentials -DeviceManagementDerivedCredentialSettingsId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDerivedCredentials -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
