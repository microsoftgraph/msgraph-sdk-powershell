...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementconfigurationpolicysetting
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementConfigurationPolicySetting -DeviceManagementConfigurationPolicyId <String> [-Count]
...
### Get
```
Get-MgDeviceManagementConfigurationPolicySetting -DeviceManagementConfigurationPolicyId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementConfigurationPolicySetting -InputObject <IDeviceManagementIdentity>
