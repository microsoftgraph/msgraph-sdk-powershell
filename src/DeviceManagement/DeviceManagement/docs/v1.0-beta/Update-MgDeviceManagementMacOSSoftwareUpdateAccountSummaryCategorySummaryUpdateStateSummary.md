...
# Update-MgBetaDeviceManagementMacOSSoftwareUpdateAccountSummaryCategorySummaryUpdateStateSummary
...
Update-MgBetaDeviceManagementMacOSSoftwareUpdateAccountSummaryCategorySummaryUpdateStateSummary
 ...
 [-UpdateCategory <MacOSSoftwareUpdateCategory>] [-UpdateVersion <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
