...
### List (Default)
```
Get-MgBetaDeviceManagementCompliancePolicy [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementCompliancePolicy -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
