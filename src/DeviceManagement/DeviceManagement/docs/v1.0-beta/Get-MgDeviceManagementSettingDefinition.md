...
### List (Default)
```
Get-MgBetaDeviceManagementSettingDefinition [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementSettingDefinition -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
