...
# Get-MgBetaDeviceManagementUserExperienceAnalyticRegressionSummary
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticRegressionSummary [-ExpandProperty <String[]>]
