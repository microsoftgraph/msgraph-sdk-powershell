...
### Get
```
Get-MgBetaDeviceManagementDeviceCompliancePolicy -DeviceCompliancePolicyId <String> [-ExpandProperty <String[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeviceCompliancePolicy1
