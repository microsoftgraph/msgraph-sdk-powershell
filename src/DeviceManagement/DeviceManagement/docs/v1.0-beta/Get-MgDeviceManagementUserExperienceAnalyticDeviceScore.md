...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementuserexperienceanalyticdevicescore
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementUserExperienceAnalyticDeviceScore [-ExpandProperty <String[]>] [-Property <String[]>]
...
key: id of userExperienceAnalyticsDeviceScores
