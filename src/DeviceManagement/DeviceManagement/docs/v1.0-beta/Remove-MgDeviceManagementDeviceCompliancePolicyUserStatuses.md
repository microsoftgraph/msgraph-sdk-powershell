...
# Remove-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses -DeviceCompliancePolicyId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceCompliancePolicyUserStatuses -InputObject <IDeviceManagementIdentity>
