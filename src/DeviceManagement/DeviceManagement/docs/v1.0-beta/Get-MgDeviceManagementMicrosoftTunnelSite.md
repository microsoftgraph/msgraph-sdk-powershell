...
### List (Default)
```
Get-MgDeviceManagementMicrosoftTunnelSite [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceManagementMicrosoftTunnelSite -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
