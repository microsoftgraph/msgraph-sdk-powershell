...
# Get-MgBetaDeviceManagementWindowInformationProtectionNetworkLearningSummary
...
### List1 (Default)
```
Get-MgBetaDeviceManagementWindowInformationProtectionNetworkLearningSummary [-ExpandProperty <String[]>]
