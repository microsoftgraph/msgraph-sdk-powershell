...
# Get-MgBetaDeviceManagementDeviceConfigurationUserStatuses
...
### List (Default)
```
Get-MgBetaDeviceManagementDeviceConfigurationUserStatuses -DeviceConfigurationId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementDeviceConfigurationUserStatuses -InputObject <IDeviceManagementIdentity>
