...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDetectedApp -DetectedAppId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDetectedApp -InputObject <IDeviceManagementIdentity> [-IfMatch <String>] [-PassThru]
