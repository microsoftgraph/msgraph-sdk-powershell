...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementcomanageddeviceuserbyref
schema: 2.0.0
---

# New-MgDeviceManagementComanagedDeviceUserByRef
...
```
New-MgDeviceManagementComanagedDeviceUserByRef -ManagedDeviceId <String> [-AdditionalProperties <Hashtable>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgDeviceManagementComanagedDeviceUserByRef -ManagedDeviceId <String> -BodyParameter <Hashtable> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDeviceManagementComanagedDeviceUserByRef -InputObject <IDeviceManagementIdentity>
...
### Microsoft.Graph.PowerShell.Models.IPathsKvpyntDevicemanagementComanageddevicesManageddeviceIdUsersRefPostResponses201ContentApplicationJsonSchema
