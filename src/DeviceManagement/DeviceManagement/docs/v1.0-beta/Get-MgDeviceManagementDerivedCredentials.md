...
# Get-MgBetaDeviceManagementDerivedCredentials
...
### List (Default)
```
Get-MgBetaDeviceManagementDerivedCredentials [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementDerivedCredentials -DeviceManagementDerivedCredentialSettingsId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementDerivedCredentials -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
