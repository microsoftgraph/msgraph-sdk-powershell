...
# Remove-MgBetaDeviceManagementDeviceConfigurationUserStatuses
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceConfigurationUserStatuses -DeviceConfigurationId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceConfigurationUserStatuses -InputObject <IDeviceManagementIdentity>
