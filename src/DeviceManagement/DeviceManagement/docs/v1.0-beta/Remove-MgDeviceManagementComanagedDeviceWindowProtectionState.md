...
# Remove-MgBetaDeviceManagementComanagedDeviceWindowProtectionState
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementComanagedDeviceWindowProtectionState -ManagedDeviceId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementComanagedDeviceWindowProtectionState -InputObject <IDeviceManagementIdentity>
