...
### List (Default)
```
Get-MgBetaDeviceManagementAssignmentFilter [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementAssignmentFilter -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
