...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementNotificationMessageTemplateSendTestMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgDeviceManagementNotificationMessageTemplateSendTestMessageCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(NotificationMessageTemplateId, "Invoke"))
                return;
