...
{
    [GraphRoute("POST", "/deviceManagement/deviceShellScripts/{deviceShellScript-id}/deviceRunStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceShellScriptDeviceRunState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptDeviceState))]
    public class NewMgDeviceManagementDeviceShellScriptDeviceRunStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RunState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].DeviceRunStates.PostAsync(body, requestConfiguration =>
                {
