...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/settings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentSetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingInstance))]
    public class GetMgDeviceManagementIntentSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].Settings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Intents[DeviceManagementIntentId].Settings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
