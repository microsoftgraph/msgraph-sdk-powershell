...
{
    [GraphRoute("POST", "/deviceManagement/deviceShellScripts/{deviceShellScript-id}/userRunStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceShellScriptUserRunState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptUserState))]
    public class NewMgDeviceManagementDeviceShellScriptUserRunStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserPrincipalName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].UserRunStates.PostAsync(body, requestConfiguration =>
                {
