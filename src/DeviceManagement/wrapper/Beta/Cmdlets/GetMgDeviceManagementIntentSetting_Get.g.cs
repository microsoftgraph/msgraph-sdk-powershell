...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/settings/{deviceManagementSettingInstance-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentSetting_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingInstance))]
    public class GetMgDeviceManagementIntentSetting_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].Settings[DeviceManagementSettingInstanceId].GetAsync(requestConfiguration =>
                {
