...
{
    [GraphRoute("GET", "/deviceManagement/deviceShellScripts")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceShellScript_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceShellScript))]
    public class GetMgDeviceManagementDeviceShellScript_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceShellScriptCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceShellScripts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceShellScripts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
