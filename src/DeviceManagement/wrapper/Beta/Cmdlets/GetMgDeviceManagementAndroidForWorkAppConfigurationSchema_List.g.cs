...
{
    [GraphRoute("GET", "/deviceManagement/androidForWorkAppConfigurationSchemas")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAndroidForWorkAppConfigurationSchema_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AndroidForWorkAppConfigurationSchema))]
    public class GetMgDeviceManagementAndroidForWorkAppConfigurationSchema_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AndroidForWorkAppConfigurationSchemaCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AndroidForWorkAppConfigurationSchemas.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AndroidForWorkAppConfigurationSchemas.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
