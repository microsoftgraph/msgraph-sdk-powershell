...
{
    [GraphRoute("GET", "/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy-id}/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCompliancePolicyAssignment_List")]
    ...
    public class GetMgDeviceManagementCompliancePolicyAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementConfigurationPolicyAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
