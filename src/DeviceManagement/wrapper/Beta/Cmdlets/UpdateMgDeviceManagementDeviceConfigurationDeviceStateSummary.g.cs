...
{
    [GraphRoute("PATCH", "/deviceManagement/deviceConfigurationDeviceStateSummaries")]
    [Cmdlet(VerbsData.Update, "MgDeviceManagementDeviceConfigurationDeviceStateSummary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationDeviceStateSummary))]
    public class UpdateMgDeviceManagementDeviceConfigurationDeviceStateSummaryCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationDeviceStateSummary();
    ...
    if (this.IsParameterBound(nameof(UnknownDeviceCount)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationDeviceStateSummary? result;
            try
            {
                result = client.DeviceManagement.DeviceConfigurationDeviceStateSummaries.PatchAsync(body, requestConfiguration =>
                {
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.DeviceManagement.DeviceConfigurationDeviceStateSummaries.GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex) when (ex is not PipelineStoppedException && ex is not OperationCanceledException)
                {
                    ThrowGraphRequestFailed(ex, null);
