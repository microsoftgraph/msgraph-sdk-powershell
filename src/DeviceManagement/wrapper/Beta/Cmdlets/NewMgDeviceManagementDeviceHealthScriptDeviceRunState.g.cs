...
{
    [GraphRoute("POST", "/deviceManagement/deviceHealthScripts/{deviceHealthScript-id}/deviceRunStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceHealthScriptDeviceRunState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptDeviceState))]
    public class NewMgDeviceManagementDeviceHealthScriptDeviceRunStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RemediationState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceHealthScripts[DeviceHealthScriptId].DeviceRunStates.PostAsync(body, requestConfiguration =>
                {
