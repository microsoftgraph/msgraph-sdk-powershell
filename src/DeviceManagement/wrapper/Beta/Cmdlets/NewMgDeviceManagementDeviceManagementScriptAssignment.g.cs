...
{
    [GraphRoute("POST", "/deviceManagement/deviceManagementScripts/{deviceManagementScript-id}/assignments")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceManagementScriptAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptAssignment))]
    public class NewMgDeviceManagementDeviceManagementScriptAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceManagementScripts[DeviceManagementScriptId].Assignments.PostAsync(body, requestConfiguration =>
                {
