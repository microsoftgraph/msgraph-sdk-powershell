...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAdminEdgeInternetExplorerModeSiteListPublish", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.BrowserSiteList))]
    public class InvokeMgAdminEdgeInternetExplorerModeSiteListPublishCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(BrowserSiteListId, "Invoke"))
                return;
