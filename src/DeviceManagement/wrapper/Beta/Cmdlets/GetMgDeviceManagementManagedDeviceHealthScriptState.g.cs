...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/deviceHealthScriptStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceHealthScriptState")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptPolicyState))]
    public class GetMgDeviceManagementManagedDeviceHealthScriptStateCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceHealthScriptStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceHealthScriptStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
