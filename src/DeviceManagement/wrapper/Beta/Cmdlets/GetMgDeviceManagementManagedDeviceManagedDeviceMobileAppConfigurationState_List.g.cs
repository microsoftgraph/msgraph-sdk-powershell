...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/managedDeviceMobileAppConfigurationStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceManagedDeviceMobileAppConfigurationState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceMobileAppConfigurationState))]
    public class GetMgDeviceManagementManagedDeviceManagedDeviceMobileAppConfigurationState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceMobileAppConfigurationStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].ManagedDeviceMobileAppConfigurationStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].ManagedDeviceMobileAppConfigurationStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
