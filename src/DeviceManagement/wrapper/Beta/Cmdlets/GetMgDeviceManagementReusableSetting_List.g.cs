...
{
    [GraphRoute("GET", "/deviceManagement/reusableSettings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementReusableSetting_List")]
    ...
    public class GetMgDeviceManagementReusableSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementConfigurationSettingDefinitionCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ReusableSettings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ReusableSettings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
