...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementMacOSSoftwareUpdateAccountSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MacOSSoftwareUpdateAccountSummary))]
    public class GetMgDeviceManagementMacOSSoftwareUpdateAccountSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MacOSSoftwareUpdateAccountSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.MacOSSoftwareUpdateAccountSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.MacOSSoftwareUpdateAccountSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
