...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceSecurityBaselineStateSettingState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineSettingState))]
    public class GetMgDeviceManagementComanagedDeviceSecurityBaselineStateSettingState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineSettingStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].SecurityBaselineStates[SecurityBaselineStateId].SettingStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].SecurityBaselineStates[SecurityBaselineStateId].SettingStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
