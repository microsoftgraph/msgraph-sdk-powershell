...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/detectedApps")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceDetectedApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DetectedApp))]
    public class GetMgDeviceManagementManagedDeviceDetectedApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DetectedApps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DetectedApps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
