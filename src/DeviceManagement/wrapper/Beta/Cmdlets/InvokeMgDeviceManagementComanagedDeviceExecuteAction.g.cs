...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices/executeAction")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementComanagedDeviceExecuteAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.BulkManagedDeviceActionResult))]
    public class InvokeMgDeviceManagementComanagedDeviceExecuteActionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.DeviceManagement.Client.DeviceManagement.ComanagedDevices.ExecuteAction.ExecuteActionPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(ActionName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices.ExecuteAction.PostAsync(body, requestConfiguration =>
                {
