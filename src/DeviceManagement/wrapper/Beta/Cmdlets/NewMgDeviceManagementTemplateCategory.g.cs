...
{
    [GraphRoute("POST", "/deviceManagement/templates/{deviceManagementTemplate-id}/categories")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementTemplateCategory", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTemplateSettingCategory))]
    public class NewMgDeviceManagementTemplateCategoryCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(HasRequiredSetting)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Templates[DeviceManagementTemplateId].Categories.PostAsync(body, requestConfiguration =>
                {
