...
{
    [GraphRoute("GET", "/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy-id}/scheduledActionsForRule")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCompliancePolicyScheduledActionForRule_List")]
    ...
    public class GetMgDeviceManagementCompliancePolicyScheduledActionForRule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementComplianceScheduledActionForRuleCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].ScheduledActionsForRule.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].ScheduledActionsForRule.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
