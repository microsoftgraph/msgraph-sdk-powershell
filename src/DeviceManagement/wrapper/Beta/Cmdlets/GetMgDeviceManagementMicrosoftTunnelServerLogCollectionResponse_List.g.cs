...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementMicrosoftTunnelServerLogCollectionResponse_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelServerLogCollectionResponse))]
    public class GetMgDeviceManagementMicrosoftTunnelServerLogCollectionResponse_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelServerLogCollectionResponseCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.MicrosoftTunnelServerLogCollectionResponses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.MicrosoftTunnelServerLogCollectionResponses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
