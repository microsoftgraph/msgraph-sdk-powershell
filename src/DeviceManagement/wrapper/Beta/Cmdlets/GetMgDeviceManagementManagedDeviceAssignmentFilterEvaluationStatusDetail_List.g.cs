...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceAssignmentFilterEvaluationStatusDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AssignmentFilterEvaluationStatusDetails))]
    public class GetMgDeviceManagementManagedDeviceAssignmentFilterEvaluationStatusDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AssignmentFilterEvaluationStatusDetailsCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].AssignmentFilterEvaluationStatusDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].AssignmentFilterEvaluationStatusDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
