...
{
    [GraphRoute("POST", "/deviceManagement/microsoftTunnelSites")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementMicrosoftTunnelSite", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelSite))]
    public class NewMgDeviceManagementMicrosoftTunnelSiteCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UpgradeWindowUtcOffsetInMinutes)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.MicrosoftTunnelSites.PostAsync(body, requestConfiguration =>
                {
