...
{
    [GraphRoute("POST", "/deviceManagement/templates/{deviceManagementTemplate-id}/categories/{deviceManagementTemplateSettingCategory-id}/recommendedSettings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementTemplateCategoryRecommendedSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingInstance))]
    public class NewMgDeviceManagementTemplateCategoryRecommendedSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ValueJson)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Templates[DeviceManagementTemplateId].Categories[DeviceManagementTemplateSettingCategoryId].RecommendedSettings.PostAsync(body, requestConfiguration =>
                {
