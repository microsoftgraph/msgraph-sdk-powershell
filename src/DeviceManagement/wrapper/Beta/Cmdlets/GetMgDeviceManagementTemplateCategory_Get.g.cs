...
{
    [GraphRoute("GET", "/deviceManagement/templates/{deviceManagementTemplate-id}/categories/{deviceManagementTemplateSettingCategory-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTemplateCategory_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTemplateSettingCategory))]
    public class GetMgDeviceManagementTemplateCategory_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Templates[DeviceManagementTemplateId].Categories[DeviceManagementTemplateSettingCategoryId].GetAsync(requestConfiguration =>
                {
