...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentAssignment))]
    public class GetMgDeviceManagementIntentAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Intents[DeviceManagementIntentId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
