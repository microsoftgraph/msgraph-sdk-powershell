...
{
    [GraphRoute("GET", "/deviceManagement/monitoring/alertRecords")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementMonitoringAlertRecord_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagement.AlertRecord))]
    public class GetMgDeviceManagementMonitoringAlertRecord_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagement.AlertRecordCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Monitoring.AlertRecords.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Monitoring.AlertRecords.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
