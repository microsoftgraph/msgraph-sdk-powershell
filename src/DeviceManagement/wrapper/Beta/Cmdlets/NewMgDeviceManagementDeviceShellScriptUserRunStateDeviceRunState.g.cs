...
{
    [GraphRoute("POST", "/deviceManagement/deviceShellScripts/{deviceShellScript-id}/userRunStates/{deviceManagementScriptUserState-id}/deviceRunStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceShellScriptUserRunStateDeviceRunState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptDeviceState))]
    public class NewMgDeviceManagementDeviceShellScriptUserRunStateDeviceRunStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RunState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].UserRunStates[DeviceManagementScriptUserStateId].DeviceRunStates.PostAsync(body, requestConfiguration =>
                {
