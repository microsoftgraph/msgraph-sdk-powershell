...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices/{managedDevice-id}/deviceCompliancePolicyStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComanagedDeviceCompliancePolicyState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceCompliancePolicyState))]
    public class NewMgDeviceManagementComanagedDeviceCompliancePolicyStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DeviceCompliancePolicyStates.PostAsync(body, requestConfiguration =>
                {
