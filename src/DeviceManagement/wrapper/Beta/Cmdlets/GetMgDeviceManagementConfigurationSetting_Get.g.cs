...
{
    [GraphRoute("GET", "/deviceManagement/configurationSettings/{deviceManagementConfigurationSettingDefinition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementConfigurationSetting_Get")]
    ...
    public class GetMgDeviceManagementConfigurationSetting_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ConfigurationSettings[DeviceManagementConfigurationSettingDefinitionId].GetAsync(requestConfiguration =>
                {
