...
{
    [GraphRoute("POST", "/deviceManagement/complianceSettings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComplianceSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceManagementComplianceSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Visibility)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComplianceSettings.PostAsync(body, requestConfiguration =>
                {
