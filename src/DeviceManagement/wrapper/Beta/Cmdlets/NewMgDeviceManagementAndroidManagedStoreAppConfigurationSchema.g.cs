...
{
    [GraphRoute("POST", "/deviceManagement/androidManagedStoreAppConfigurationSchemas")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementAndroidManagedStoreAppConfigurationSchema", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AndroidManagedStoreAppConfigurationSchema))]
    public class NewMgDeviceManagementAndroidManagedStoreAppConfigurationSchemaCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SchemaItems)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.AndroidManagedStoreAppConfigurationSchemas.PostAsync(body, requestConfiguration =>
                {
