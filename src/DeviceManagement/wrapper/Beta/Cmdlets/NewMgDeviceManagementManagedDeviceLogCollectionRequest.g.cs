...
{
    [GraphRoute("POST", "/deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementManagedDeviceLogCollectionRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceLogCollectionResponse))]
    public class NewMgDeviceManagementManagedDeviceLogCollectionRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].LogCollectionRequests.PostAsync(body, requestConfiguration =>
                {
