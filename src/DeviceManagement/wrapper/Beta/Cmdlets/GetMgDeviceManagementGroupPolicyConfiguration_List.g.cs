...
{
    [GraphRoute("GET", "/deviceManagement/groupPolicyConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementGroupPolicyConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.GroupPolicyConfiguration))]
    public class GetMgDeviceManagementGroupPolicyConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.GroupPolicyConfigurationCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.GroupPolicyConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.GroupPolicyConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
