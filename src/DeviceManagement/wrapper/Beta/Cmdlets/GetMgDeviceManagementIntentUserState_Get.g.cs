...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/userStates/{deviceManagementIntentUserState-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentUserState_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentUserState))]
    public class GetMgDeviceManagementIntentUserState_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].UserStates[DeviceManagementIntentUserStateId].GetAsync(requestConfiguration =>
                {
