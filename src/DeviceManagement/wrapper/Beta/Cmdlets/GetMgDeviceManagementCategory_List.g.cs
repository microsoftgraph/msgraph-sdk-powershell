...
{
    [GraphRoute("GET", "/deviceManagement/categories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingCategory))]
    public class GetMgDeviceManagementCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingCategoryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Categories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Categories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
