...
{
    [GraphRoute("GET", "/deviceManagement/deviceManagementScripts")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceManagementScript_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScript))]
    public class GetMgDeviceManagementDeviceManagementScript_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceManagementScripts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceManagementScripts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
