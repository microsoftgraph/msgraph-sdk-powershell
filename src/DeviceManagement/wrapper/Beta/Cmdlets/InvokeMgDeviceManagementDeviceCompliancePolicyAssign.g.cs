...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementDeviceCompliancePolicyAssign", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDeviceManagementDeviceCompliancePolicyAssignCommand : GraphClientCmdlet
    {
