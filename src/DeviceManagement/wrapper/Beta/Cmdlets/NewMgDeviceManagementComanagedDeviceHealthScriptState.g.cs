...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices/{managedDevice-id}/deviceHealthScriptStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComanagedDeviceHealthScriptState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptPolicyState))]
    public class NewMgDeviceManagementComanagedDeviceHealthScriptStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RemediationState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DeviceHealthScriptStates.PostAsync(body, requestConfiguration =>
                {
