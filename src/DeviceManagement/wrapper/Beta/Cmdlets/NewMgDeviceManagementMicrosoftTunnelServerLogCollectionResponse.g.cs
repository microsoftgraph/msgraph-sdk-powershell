...
{
    [GraphRoute("POST", "/deviceManagement/microsoftTunnelServerLogCollectionResponses")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementMicrosoftTunnelServerLogCollectionResponse", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelServerLogCollectionResponse))]
    public class NewMgDeviceManagementMicrosoftTunnelServerLogCollectionResponseCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.MicrosoftTunnelServerLogCollectionResponses.PostAsync(body, requestConfiguration =>
                {
