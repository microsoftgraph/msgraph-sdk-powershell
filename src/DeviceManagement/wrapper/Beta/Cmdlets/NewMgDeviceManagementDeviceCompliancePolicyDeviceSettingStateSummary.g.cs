...
{
    [GraphRoute("POST", "/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/deviceSettingStateSummaries")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceCompliancePolicyDeviceSettingStateSummary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SettingStateDeviceSummary))]
    public class NewMgDeviceManagementDeviceCompliancePolicyDeviceSettingStateSummaryCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UnknownDeviceCount)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceCompliancePolicies[DeviceCompliancePolicyId].DeviceSettingStateSummaries.PostAsync(body, requestConfiguration =>
                {
