...
{
    [GraphRoute("GET", "/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration-id}/definitionValues/{groupPolicyDefinitionValue-id}/presentationValues")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementGroupPolicyConfigurationDefinitionValuePresentationValue_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.GroupPolicyPresentationValue))]
    public class GetMgDeviceManagementGroupPolicyConfigurationDefinitionValuePresentationValue_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.GroupPolicyPresentationValueCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.GroupPolicyConfigurations[GroupPolicyConfigurationId].DefinitionValues[GroupPolicyDefinitionValueId].PresentationValues.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.GroupPolicyConfigurations[GroupPolicyConfigurationId].DefinitionValues[GroupPolicyDefinitionValueId].PresentationValues.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
