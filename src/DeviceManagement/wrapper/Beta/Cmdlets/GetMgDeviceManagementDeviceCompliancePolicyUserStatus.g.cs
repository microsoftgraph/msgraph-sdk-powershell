...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class GetMgDeviceManagementDeviceCompliancePolicyUserStatusCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceManagementDeviceCompliancePolicyUserStatus_Get" : "Get-MgDeviceManagementDeviceCompliancePolicyUserStatus_List";
            try
            {
