...
{
    [GraphRoute("GET", "/deviceManagement/complianceSettings/{deviceManagementConfigurationSettingDefinition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComplianceSetting_Get")]
    ...
    public class GetMgDeviceManagementComplianceSetting_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComplianceSettings[DeviceManagementConfigurationSettingDefinitionId].GetAsync(requestConfiguration =>
                {
