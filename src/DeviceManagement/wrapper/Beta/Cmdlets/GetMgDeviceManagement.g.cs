...
{
    [GraphRoute("GET", "/deviceManagement")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagement")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagement.DeviceManagement))]
    public class GetMgDeviceManagementCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.GetAsync(requestConfiguration =>
                {
