...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/assignments/{deviceManagementIntentAssignment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentAssignment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentAssignment))]
    public class GetMgDeviceManagementIntentAssignment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].Assignments[DeviceManagementIntentAssignmentId].GetAsync(requestConfiguration =>
                {
