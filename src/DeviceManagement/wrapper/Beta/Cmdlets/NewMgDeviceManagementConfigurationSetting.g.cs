...
{
    [GraphRoute("POST", "/deviceManagement/configurationSettings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementConfigurationSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceManagementConfigurationSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Visibility)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ConfigurationSettings.PostAsync(body, requestConfiguration =>
                {
