...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComanagedDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDevice))]
    public class NewMgDeviceManagementComanagedDeviceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ProcessorArchitecture)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices.PostAsync(body, requestConfiguration =>
                {
