...
{
    [GraphRoute("POST", "/deviceManagement/microsoftTunnelConfigurations")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementMicrosoftTunnelConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelConfiguration))]
    public class NewMgDeviceManagementMicrosoftTunnelConfigurationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(AdvancedSettings)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.MicrosoftTunnelConfigurations.PostAsync(body, requestConfiguration =>
                {
