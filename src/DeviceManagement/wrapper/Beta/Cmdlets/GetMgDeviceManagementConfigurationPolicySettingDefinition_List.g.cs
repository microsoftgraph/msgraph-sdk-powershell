...
{
    [GraphRoute("GET", "/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy-id}/settings/{deviceManagementConfigurationSetting-id}/settingDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementConfigurationPolicySettingDefinition_List")]
    ...
    public class GetMgDeviceManagementConfigurationPolicySettingDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ConfigurationPolicies[DeviceManagementConfigurationPolicyId].Settings[DeviceManagementConfigurationSettingId].SettingDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ConfigurationPolicies[DeviceManagementConfigurationPolicyId].Settings[DeviceManagementConfigurationSettingId].SettingDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
