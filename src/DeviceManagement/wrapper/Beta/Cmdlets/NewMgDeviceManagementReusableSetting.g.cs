...
{
    [GraphRoute("POST", "/deviceManagement/reusableSettings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementReusableSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceManagementReusableSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Visibility)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ReusableSettings.PostAsync(body, requestConfiguration =>
                {
