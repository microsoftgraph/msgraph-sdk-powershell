...
{
    [GraphRoute("GET", "/deviceManagement/deviceHealthScripts")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceHealthScript_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScript))]
    public class GetMgDeviceManagementDeviceHealthScript_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceHealthScripts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceHealthScripts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
