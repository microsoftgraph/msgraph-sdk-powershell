...
{
    [GraphRoute("GET", "/deviceManagement/assignmentFilters")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAssignmentFilter_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceAndAppManagementAssignmentFilter))]
    public class GetMgDeviceManagementAssignmentFilter_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceAndAppManagementAssignmentFilterCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AssignmentFilters.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AssignmentFilters.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
