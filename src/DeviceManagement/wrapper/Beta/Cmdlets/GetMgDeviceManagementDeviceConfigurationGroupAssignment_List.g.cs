...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceConfigurationGroupAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationGroupAssignment))]
    public class GetMgDeviceManagementDeviceConfigurationGroupAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationGroupAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].GroupAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].GroupAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
