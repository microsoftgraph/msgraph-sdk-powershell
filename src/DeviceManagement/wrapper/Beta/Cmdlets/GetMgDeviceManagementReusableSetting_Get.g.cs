...
{
    [GraphRoute("GET", "/deviceManagement/reusableSettings/{deviceManagementConfigurationSettingDefinition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementReusableSetting_Get")]
    ...
    public class GetMgDeviceManagementReusableSetting_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ReusableSettings[DeviceManagementConfigurationSettingDefinitionId].GetAsync(requestConfiguration =>
                {
