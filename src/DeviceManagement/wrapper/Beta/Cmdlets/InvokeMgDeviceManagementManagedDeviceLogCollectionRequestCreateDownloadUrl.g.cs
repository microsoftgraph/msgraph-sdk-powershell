...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementManagedDeviceLogCollectionRequestCreateDownloadUrl", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDeviceManagementManagedDeviceLogCollectionRequestCreateDownloadUrlCommand : GraphClientCmdlet
    {
