...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/deviceStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentDeviceState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentDeviceState))]
    public class GetMgDeviceManagementIntentDeviceState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentDeviceStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].DeviceStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Intents[DeviceManagementIntentId].DeviceStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
