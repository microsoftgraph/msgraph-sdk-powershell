...
{
    [GraphRoute("GET", "/deviceManagement/managedDeviceWindowsOSImages")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceWindowsOSImage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceWindowsOperatingSystemImage))]
    public class GetMgDeviceManagementManagedDeviceWindowsOSImage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceWindowsOperatingSystemImageCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDeviceWindowsOSImages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDeviceWindowsOSImages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
