...
{
    [GraphRoute("GET", "/deviceManagement/derivedCredentials")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDerivedCredential_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementDerivedCredentialSettings))]
    public class GetMgDeviceManagementDerivedCredential_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementDerivedCredentialSettingsCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DerivedCredentials.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DerivedCredentials.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
