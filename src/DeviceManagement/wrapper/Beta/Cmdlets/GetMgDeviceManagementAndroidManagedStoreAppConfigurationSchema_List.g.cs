...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAndroidManagedStoreAppConfigurationSchema_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AndroidManagedStoreAppConfigurationSchema))]
    public class GetMgDeviceManagementAndroidManagedStoreAppConfigurationSchema_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AndroidManagedStoreAppConfigurationSchemaCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AndroidManagedStoreAppConfigurationSchemas.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AndroidManagedStoreAppConfigurationSchemas.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
