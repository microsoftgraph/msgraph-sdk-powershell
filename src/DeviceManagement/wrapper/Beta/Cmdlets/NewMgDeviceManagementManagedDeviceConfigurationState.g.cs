...
{
    [GraphRoute("POST", "/deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementManagedDeviceConfigurationState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationState))]
    public class NewMgDeviceManagementManagedDeviceConfigurationStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceConfigurationStates.PostAsync(body, requestConfiguration =>
                {
