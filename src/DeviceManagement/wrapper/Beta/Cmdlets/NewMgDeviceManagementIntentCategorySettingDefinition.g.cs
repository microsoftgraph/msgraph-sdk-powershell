...
{
    [GraphRoute("POST", "/deviceManagement/intents/{deviceManagementIntent-id}/categories/{deviceManagementIntentSettingCategory-id}/settingDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementIntentCategorySettingDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingDefinition))]
    public class NewMgDeviceManagementIntentCategorySettingDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ValueType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].Categories[DeviceManagementIntentSettingCategoryId].SettingDefinitions.PostAsync(body, requestConfiguration =>
                {
