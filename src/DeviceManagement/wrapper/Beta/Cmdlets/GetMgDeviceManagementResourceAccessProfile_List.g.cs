...
{
    [GraphRoute("GET", "/deviceManagement/resourceAccessProfiles")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementResourceAccessProfile_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementResourceAccessProfileBase))]
    public class GetMgDeviceManagementResourceAccessProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementResourceAccessProfileBaseCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ResourceAccessProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ResourceAccessProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
