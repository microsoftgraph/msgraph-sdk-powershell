...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementResourceAccessProfileAssignment_List")]
    ...
    public class GetMgDeviceManagementResourceAccessProfileAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementResourceAccessProfileAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ResourceAccessProfiles[DeviceManagementResourceAccessProfileBaseId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ResourceAccessProfiles[DeviceManagementResourceAccessProfileBaseId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
