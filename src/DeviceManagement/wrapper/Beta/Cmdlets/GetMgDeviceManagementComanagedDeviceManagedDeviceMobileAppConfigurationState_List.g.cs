...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceManagedDeviceMobileAppConfigurationState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceMobileAppConfigurationState))]
    public class GetMgDeviceManagementComanagedDeviceManagedDeviceMobileAppConfigurationState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].ManagedDeviceMobileAppConfigurationStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].ManagedDeviceMobileAppConfigurationStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
