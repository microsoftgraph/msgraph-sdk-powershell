...
{
    [GraphRoute("GET", "/deviceManagement/configurationSettings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementConfigurationSetting_List")]
    ...
    public class GetMgDeviceManagementConfigurationSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ConfigurationSettings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ConfigurationSettings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
