...
{
    [GraphRoute("GET", "/deviceManagement/comanagedDevices/{managedDevice-id}/securityBaselineStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceSecurityBaselineState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineState))]
    public class GetMgDeviceManagementComanagedDeviceSecurityBaselineState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].SecurityBaselineStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].SecurityBaselineStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
