...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementManagedDeviceCleanWindowsDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgDeviceManagementManagedDeviceCleanWindowsDeviceCommand : GraphClientCmdlet
    {
