...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementNotificationMessageTemplateLocalizedNotificationMessage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.LocalizedNotificationMessage))]
    public class GetMgDeviceManagementNotificationMessageTemplateLocalizedNotificationMessage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.LocalizedNotificationMessageCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.NotificationMessageTemplates[NotificationMessageTemplateId].LocalizedNotificationMessages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.NotificationMessageTemplates[NotificationMessageTemplateId].LocalizedNotificationMessages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
