...
{
    [GraphRoute("GET", "/deviceManagement/comanagedDevices/{managedDevice-id}/deviceHealthScriptStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceHealthScriptState")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptPolicyState))]
    public class GetMgDeviceManagementComanagedDeviceHealthScriptStateCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptPolicyStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DeviceHealthScriptStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DeviceHealthScriptStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
