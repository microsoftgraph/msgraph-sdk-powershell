...
{
    [GraphRoute("POST", "/deviceManagement/settingDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementSettingDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingDefinition))]
    public class NewMgDeviceManagementSettingDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ValueType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.SettingDefinitions.PostAsync(body, requestConfiguration =>
                {
