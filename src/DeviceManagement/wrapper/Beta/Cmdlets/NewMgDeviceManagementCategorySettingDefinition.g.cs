...
{
    [GraphRoute("POST", "/deviceManagement/categories/{deviceManagementSettingCategory-id}/settingDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementCategorySettingDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingDefinition))]
    public class NewMgDeviceManagementCategorySettingDefinitionCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(DeviceManagementSettingCategoryId, "New"))
                return;
    ...
    if (this.IsParameterBound(nameof(ValueType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Categories[DeviceManagementSettingCategoryId].SettingDefinitions.PostAsync(body, requestConfiguration =>
                {
