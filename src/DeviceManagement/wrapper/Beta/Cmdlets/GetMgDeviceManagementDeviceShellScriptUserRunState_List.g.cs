...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceShellScriptUserRunState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptUserState))]
    public class GetMgDeviceManagementDeviceShellScriptUserRunState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptUserStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].UserRunStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].UserRunStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
