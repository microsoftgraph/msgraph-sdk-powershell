...
{
    [GraphRoute("POST", "/deviceManagement/compliancePolicies")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementCompliancePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementCompliancePolicy))]
    public class NewMgDeviceManagementCompliancePolicyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Technologies)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.CompliancePolicies.PostAsync(body, requestConfiguration =>
                {
