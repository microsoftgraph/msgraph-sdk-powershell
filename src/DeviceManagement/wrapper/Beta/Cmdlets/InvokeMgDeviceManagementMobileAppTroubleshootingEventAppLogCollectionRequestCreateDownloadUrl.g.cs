...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementMobileAppTroubleshootingEventAppLogCollectionRequestCreateDownloadUrl", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.AppLogCollectionDownloadDetails))]
    public class InvokeMgDeviceManagementMobileAppTroubleshootingEventAppLogCollectionRequestCreateDownloadUrlCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(AppLogCollectionRequestId, "Invoke"))
                return;
