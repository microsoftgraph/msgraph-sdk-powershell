...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/deviceSettingStateSummaries")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentDeviceSettingStateSummary_List")]
    ...
    public class GetMgDeviceManagementIntentDeviceSettingStateSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentDeviceSettingStateSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].DeviceSettingStateSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Intents[DeviceManagementIntentId].DeviceSettingStateSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
