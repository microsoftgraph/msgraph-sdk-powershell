...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntent_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntent))]
    public class GetMgDeviceManagementIntent_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].GetAsync(requestConfiguration =>
                {
