...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementDeviceCompliancePolicyScheduleActionsForRules", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgDeviceManagementDeviceCompliancePolicyScheduleActionsForRulesCommand : GraphClientCmdlet
    {
