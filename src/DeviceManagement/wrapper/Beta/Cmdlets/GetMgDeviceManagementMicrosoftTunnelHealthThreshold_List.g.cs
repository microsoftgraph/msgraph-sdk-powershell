...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementMicrosoftTunnelHealthThreshold_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelHealthThreshold))]
    public class GetMgDeviceManagementMicrosoftTunnelHealthThreshold_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.MicrosoftTunnelHealthThresholdCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.MicrosoftTunnelHealthThresholds.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.MicrosoftTunnelHealthThresholds.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
