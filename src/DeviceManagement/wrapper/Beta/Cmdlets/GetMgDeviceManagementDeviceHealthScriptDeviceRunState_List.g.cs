...
{
    [GraphRoute("GET", "/deviceManagement/deviceHealthScripts/{deviceHealthScript-id}/deviceRunStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceHealthScriptDeviceRunState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptDeviceState))]
    public class GetMgDeviceManagementDeviceHealthScriptDeviceRunState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptDeviceStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceHealthScripts[DeviceHealthScriptId].DeviceRunStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceHealthScripts[DeviceHealthScriptId].DeviceRunStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
