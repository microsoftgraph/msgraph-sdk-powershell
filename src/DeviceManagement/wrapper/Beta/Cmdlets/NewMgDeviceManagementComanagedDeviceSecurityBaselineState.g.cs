...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices/{managedDevice-id}/securityBaselineStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComanagedDeviceSecurityBaselineState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineState))]
    public class NewMgDeviceManagementComanagedDeviceSecurityBaselineStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].SecurityBaselineStates.PostAsync(body, requestConfiguration =>
                {
