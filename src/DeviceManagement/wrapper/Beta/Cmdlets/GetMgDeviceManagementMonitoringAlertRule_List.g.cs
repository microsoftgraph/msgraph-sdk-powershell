...
{
    [GraphRoute("GET", "/deviceManagement/monitoring/alertRules")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementMonitoringAlertRule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagement.AlertRule))]
    public class GetMgDeviceManagementMonitoringAlertRule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagement.AlertRuleCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Monitoring.AlertRules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Monitoring.AlertRules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
