...
{
    [GraphRoute("GET", "/deviceManagement/templates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTemplate))]
    public class GetMgDeviceManagementTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTemplateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Templates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Templates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
