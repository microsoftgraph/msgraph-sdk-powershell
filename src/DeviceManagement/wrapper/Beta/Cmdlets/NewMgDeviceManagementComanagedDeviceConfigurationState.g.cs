...
{
    [GraphRoute("POST", "/deviceManagement/comanagedDevices/{managedDevice-id}/deviceConfigurationStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementComanagedDeviceConfigurationState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationState))]
    public class NewMgDeviceManagementComanagedDeviceConfigurationStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DeviceConfigurationStates.PostAsync(body, requestConfiguration =>
                {
