...
{
    [GraphRoute("PATCH", "/deviceManagement/advancedThreatProtectionOnboardingStateSummary/advancedThreatProtectionOnboardingDeviceSettingStates/{advancedThreatProtectionOnboardingDeviceSettingState-id}")]
    [Cmdlet(VerbsData.Update, "MgDeviceManagementAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class UpdateMgDeviceManagementAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingStateCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(AdvancedThreatProtectionOnboardingDeviceSettingStateId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary.AdvancedThreatProtectionOnboardingDeviceSettingStates[AdvancedThreatProtectionOnboardingDeviceSettingStateId].PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowGraphRequestFailed(ex, AdvancedThreatProtectionOnboardingDeviceSettingStateId);
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.DeviceManagement.AdvancedThreatProtectionOnboardingStateSummary.AdvancedThreatProtectionOnboardingDeviceSettingStates[AdvancedThreatProtectionOnboardingDeviceSettingStateId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex) when (ex is not PipelineStoppedException && ex is not OperationCanceledException)
                {
                    ThrowGraphRequestFailed(ex, AdvancedThreatProtectionOnboardingDeviceSettingStateId);
