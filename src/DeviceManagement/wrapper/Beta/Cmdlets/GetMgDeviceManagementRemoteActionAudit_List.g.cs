...
{
    [GraphRoute("GET", "/deviceManagement/remoteActionAudits")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementRemoteActionAudit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.RemoteActionAudit))]
    public class GetMgDeviceManagementRemoteActionAudit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.RemoteActionAuditCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.RemoteActionAudits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.RemoteActionAudits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
