...
{
    [GraphRoute("POST", "/deviceManagement/templates/{deviceManagementTemplate-id}/settings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementTemplateSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementSettingInstance))]
    public class NewMgDeviceManagementTemplateSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ValueJson)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Templates[DeviceManagementTemplateId].Settings.PostAsync(body, requestConfiguration =>
                {
