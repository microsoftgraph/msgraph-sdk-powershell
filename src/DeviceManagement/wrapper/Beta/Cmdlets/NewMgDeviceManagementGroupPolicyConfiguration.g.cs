...
{
    [GraphRoute("POST", "/deviceManagement/groupPolicyConfigurations")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementGroupPolicyConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.GroupPolicyConfiguration))]
    public class NewMgDeviceManagementGroupPolicyConfigurationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PolicyConfigurationIngestionType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.GroupPolicyConfigurations.PostAsync(body, requestConfiguration =>
                {
