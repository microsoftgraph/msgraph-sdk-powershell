...
{
    [GraphRoute("GET", "/deviceManagement/deviceShellScripts/{deviceShellScript-id}/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceShellScriptAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptAssignment))]
    public class GetMgDeviceManagementDeviceShellScriptAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceShellScripts[DeviceShellScriptId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
