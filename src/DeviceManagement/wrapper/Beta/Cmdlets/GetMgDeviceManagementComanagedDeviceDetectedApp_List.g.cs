...
{
    [GraphRoute("GET", "/deviceManagement/comanagedDevices/{managedDevice-id}/detectedApps")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceDetectedApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DetectedApp))]
    public class GetMgDeviceManagementComanagedDeviceDetectedApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DetectedAppCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DetectedApps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].DetectedApps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
