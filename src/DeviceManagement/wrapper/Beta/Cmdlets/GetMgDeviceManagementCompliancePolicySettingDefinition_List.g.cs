...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCompliancePolicySettingDefinition_List")]
    ...
    public class GetMgDeviceManagementCompliancePolicySettingDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Settings[DeviceManagementConfigurationSettingId].SettingDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Settings[DeviceManagementConfigurationSettingId].SettingDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
