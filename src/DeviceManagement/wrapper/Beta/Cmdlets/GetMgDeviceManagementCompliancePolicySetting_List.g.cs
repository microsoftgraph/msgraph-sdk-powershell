...
{
    [GraphRoute("GET", "/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy-id}/settings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCompliancePolicySetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementConfigurationSetting))]
    public class GetMgDeviceManagementCompliancePolicySetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementConfigurationSettingCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Settings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].Settings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
