...
{
    [GraphRoute("GET", "/deviceManagement/comanagedDevices/{managedDevice-id}/users")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceUser")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.User))]
    public class GetMgDeviceManagementComanagedDeviceUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].Users.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComanagedDevices[ManagedDeviceId].Users.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
