...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementDeviceConfigurationAssign", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDeviceManagementDeviceConfigurationAssignCommand : GraphClientCmdlet
    {
        ...
        public Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationGroupAssignment[]? DeviceConfigurationGroupAssignments { get; set; }
    ...
    if (this.IsParameterBound(nameof(DeviceConfigurationGroupAssignments)))
        body.DeviceConfigurationGroupAssignments = DeviceConfigurationGroupAssignments!.ToList();
