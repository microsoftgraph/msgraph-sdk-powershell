...
{
    [GraphRoute("POST", "/deviceManagement/intents")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementIntent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntent))]
    public class NewMgDeviceManagementIntentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TemplateId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Intents.PostAsync(body, requestConfiguration =>
                {
