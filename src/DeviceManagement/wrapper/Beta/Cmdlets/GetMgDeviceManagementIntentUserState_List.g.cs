...
{
    [GraphRoute("GET", "/deviceManagement/intents/{deviceManagementIntent-id}/userStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIntentUserState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentUserState))]
    public class GetMgDeviceManagementIntentUserState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementIntentUserStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Intents[DeviceManagementIntentId].UserStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Intents[DeviceManagementIntentId].UserStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
