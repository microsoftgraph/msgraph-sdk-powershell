...
{
    [GraphRoute("POST", "/deviceManagement/managedDevices/{managedDevice-id}/managedDeviceMobileAppConfigurationStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementManagedDeviceManagedDeviceMobileAppConfigurationState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceMobileAppConfigurationState))]
    public class NewMgDeviceManagementManagedDeviceManagedDeviceMobileAppConfigurationStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].ManagedDeviceMobileAppConfigurationStates.PostAsync(body, requestConfiguration =>
                {
