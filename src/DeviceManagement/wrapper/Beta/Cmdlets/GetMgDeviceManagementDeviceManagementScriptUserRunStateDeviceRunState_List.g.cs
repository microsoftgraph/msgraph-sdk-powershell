...
{
    [GraphRoute("GET", "/deviceManagement/deviceManagementScripts/{deviceManagementScript-id}/userRunStates/{deviceManagementScriptUserState-id}/deviceRunStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceManagementScriptUserRunStateDeviceRunState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptDeviceState))]
    public class GetMgDeviceManagementDeviceManagementScriptUserRunStateDeviceRunState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementScriptDeviceStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceManagementScripts[DeviceManagementScriptId].UserRunStates[DeviceManagementScriptUserStateId].DeviceRunStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceManagementScripts[DeviceManagementScriptId].UserRunStates[DeviceManagementScriptUserStateId].DeviceRunStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
