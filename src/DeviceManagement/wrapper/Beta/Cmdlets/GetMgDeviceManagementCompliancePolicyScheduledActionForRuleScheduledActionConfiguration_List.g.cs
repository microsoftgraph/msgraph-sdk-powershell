...
{
    [GraphRoute("GET", "/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy-id}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule-id}/scheduledActionConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementCompliancePolicyScheduledActionForRuleScheduledActionConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementComplianceActionItem))]
    public class GetMgDeviceManagementCompliancePolicyScheduledActionForRuleScheduledActionConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementComplianceActionItemCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].ScheduledActionsForRule[DeviceManagementComplianceScheduledActionForRuleId].ScheduledActionConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.CompliancePolicies[DeviceManagementCompliancePolicyId].ScheduledActionsForRule[DeviceManagementComplianceScheduledActionForRuleId].ScheduledActionConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
            ...
            {
                ThrowGraphRequestFailed(ex, DeviceManagementComplianceScheduledActionForRuleId);
                return;
            }
        }
    }
