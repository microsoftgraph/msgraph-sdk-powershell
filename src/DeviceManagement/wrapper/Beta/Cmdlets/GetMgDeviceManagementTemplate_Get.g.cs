...
{
    [GraphRoute("GET", "/deviceManagement/templates/{deviceManagementTemplate-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTemplate_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTemplate))]
    public class GetMgDeviceManagementTemplate_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Templates[DeviceManagementTemplateId].GetAsync(requestConfiguration =>
                {
