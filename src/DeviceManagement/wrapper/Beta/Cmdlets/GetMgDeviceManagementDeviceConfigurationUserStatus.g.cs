...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class GetMgDeviceManagementDeviceConfigurationUserStatusCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? DeviceConfigurationUserStatusId : DeviceConfigurationId);
                return;
            }
        }
    }
