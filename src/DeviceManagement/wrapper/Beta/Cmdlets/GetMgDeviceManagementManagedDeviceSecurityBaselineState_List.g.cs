...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/securityBaselineStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceSecurityBaselineState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SecurityBaselineState))]
    public class GetMgDeviceManagementManagedDeviceSecurityBaselineState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].SecurityBaselineStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].SecurityBaselineStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
