...
{
    [GraphRoute("GET", "/deviceManagement/deviceConfigurationConflictSummary")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceConfigurationConflictSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationConflictSummary))]
    public class GetMgDeviceManagementDeviceConfigurationConflictSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationConflictSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceConfigurationConflictSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceConfigurationConflictSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
