...
{
    [GraphRoute("GET", "/deviceManagement/comanagedDevices/{managedDevice-id}/logCollectionRequests")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComanagedDeviceLogCollectionRequest", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceManagementComanagedDeviceLogCollectionRequestCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceManagementComanagedDeviceLogCollectionRequest_Get or Get-MgDeviceManagementComanagedDeviceLogCollectionRequest_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceManagementComanagedDeviceLogCollectionRequest_Get" : "Get-MgDeviceManagementComanagedDeviceLogCollectionRequest_List";
            try
            {
