...
{
    [GraphRoute("POST", "/deviceManagement/managedDevices/{managedDevice-id}/deviceHealthScriptStates")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementManagedDeviceHealthScriptState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceHealthScriptPolicyState))]
    public class NewMgDeviceManagementManagedDeviceHealthScriptStateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RemediationState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceHealthScriptStates.PostAsync(body, requestConfiguration =>
                {
