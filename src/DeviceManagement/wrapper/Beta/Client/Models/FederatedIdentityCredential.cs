...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Client.Models
{
    ...
    public partial class FederatedIdentityCredential : global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityExpression? ClaimsMatchingExpression { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityExpression ClaimsMatchingExpression { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityCredential"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityCredential CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityCredential();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "claimsMatchingExpression", n => { ClaimsMatchingExpression = n.GetObjectValue<global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityExpression>(global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityExpression.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.FederatedIdentityExpression>("claimsMatchingExpression", ClaimsMatchingExpression);
