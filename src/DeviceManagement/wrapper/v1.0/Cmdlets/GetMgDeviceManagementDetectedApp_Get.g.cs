...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class GetMgDeviceManagementDetectedApp_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DetectedAppId));
                return;
            }
