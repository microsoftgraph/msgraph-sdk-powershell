...
{
    [GraphRoute("GET", "/deviceManagement/deviceConfigurations/{deviceConfiguration-id}/deviceSettingStateSummaries")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceConfigurationDeviceSettingStateSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SettingStateDeviceSummary))]
    public class GetMgDeviceManagementDeviceConfigurationDeviceSettingStateSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].DeviceSettingStateSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].DeviceSettingStateSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
