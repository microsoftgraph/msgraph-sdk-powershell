...
{
    [GraphRoute("GET", "/deviceManagement/deviceCategories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceCategory))]
    public class GetMgDeviceManagementDeviceCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceCategoryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceCategories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceCategories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
