...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class GetMgDeviceManagementWindowsInformationProtectionNetworkLearningSummaryCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceManagementWindowsInformationProtectionNetworkLearningSummary_Get" : "Get-MgDeviceManagementWindowsInformationProtectionNetworkLearningSummary_List";
            try
            {
