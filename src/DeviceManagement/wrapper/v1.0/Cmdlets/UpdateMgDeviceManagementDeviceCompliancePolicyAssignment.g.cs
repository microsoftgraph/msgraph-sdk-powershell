...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class UpdateMgDeviceManagementDeviceCompliancePolicyAssignmentCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeviceCompliancePolicyAssignmentId));
                return;
            }
