...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDevice_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDevice))]
    public class GetMgDeviceManagementManagedDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.ManagedDeviceCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDevices.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
