...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class UpdateMgDeviceManagementDeviceCompliancePolicySettingStateSummaryDeviceComplianceSettingStateCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeviceComplianceSettingStateId));
                return;
            }
