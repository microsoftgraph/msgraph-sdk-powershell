...
{
    [GraphRoute("POST", "/deviceManagement/deviceConfigurations/{deviceConfiguration-id}/deviceSettingStateSummaries")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDeviceConfigurationDeviceSettingStateSummary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.SettingStateDeviceSummary))]
    public class NewMgDeviceManagementDeviceConfigurationDeviceSettingStateSummaryCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UnknownDeviceCount)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].DeviceSettingStateSummaries.PostAsync(body, requestConfiguration =>
                {
