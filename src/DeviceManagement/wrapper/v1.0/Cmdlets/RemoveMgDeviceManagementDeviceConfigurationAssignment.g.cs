...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class RemoveMgDeviceManagementDeviceConfigurationAssignmentCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeviceConfigurationAssignmentId));
                return;
            }
        }
    }
