...
{
    [GraphRoute("GET", "/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/userStatuses")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceCompliancePolicyUserStatus_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceComplianceUserStatus))]
    public class GetMgDeviceManagementDeviceCompliancePolicyUserStatus_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceComplianceUserStatusCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceCompliancePolicies[DeviceCompliancePolicyId].UserStatuses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceCompliancePolicies[DeviceCompliancePolicyId].UserStatuses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
