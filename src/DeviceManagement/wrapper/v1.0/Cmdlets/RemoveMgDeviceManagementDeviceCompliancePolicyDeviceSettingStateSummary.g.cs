...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class RemoveMgDeviceManagementDeviceCompliancePolicyDeviceSettingStateSummaryCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, SettingStateDeviceSummaryId));
                return;
            }
        }
    }
