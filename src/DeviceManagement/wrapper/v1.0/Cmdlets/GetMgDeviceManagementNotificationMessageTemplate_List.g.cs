...
{
    [GraphRoute("GET", "/deviceManagement/notificationMessageTemplates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementNotificationMessageTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.NotificationMessageTemplate))]
    public class GetMgDeviceManagementNotificationMessageTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.NotificationMessageTemplateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.NotificationMessageTemplates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.NotificationMessageTemplates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
