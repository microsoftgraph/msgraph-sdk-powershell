...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    public class UpdateMgDeviceManagementNotificationMessageTemplateLocalizedNotificationMessageCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Subject)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, LocalizedNotificationMessageId));
                return;
            }
