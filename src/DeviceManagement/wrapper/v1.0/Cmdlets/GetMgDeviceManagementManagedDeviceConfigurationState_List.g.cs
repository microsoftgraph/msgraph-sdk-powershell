...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceConfigurationState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationState))]
    public class GetMgDeviceManagementManagedDeviceConfigurationState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationStateCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceConfigurationStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].DeviceConfigurationStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
