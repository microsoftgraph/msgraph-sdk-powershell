...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementWindowsInformationProtectionAppLearningSummary_List")]
    ...
    public class GetMgDeviceManagementWindowsInformationProtectionAppLearningSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.WindowsInformationProtectionAppLearningSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
