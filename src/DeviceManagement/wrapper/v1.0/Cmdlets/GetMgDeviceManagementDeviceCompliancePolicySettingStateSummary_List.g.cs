...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceCompliancePolicySettingStateSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceCompliancePolicySettingStateSummary))]
    public class GetMgDeviceManagementDeviceCompliancePolicySettingStateSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceCompliancePolicySettingStateSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceCompliancePolicySettingStateSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceCompliancePolicySettingStateSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
