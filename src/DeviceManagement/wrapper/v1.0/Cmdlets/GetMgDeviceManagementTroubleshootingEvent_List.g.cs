...
{
    [GraphRoute("GET", "/deviceManagement/troubleshootingEvents")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTroubleshootingEvent_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTroubleshootingEvent))]
    public class GetMgDeviceManagementTroubleshootingEvent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceManagementTroubleshootingEventCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.TroubleshootingEvents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.TroubleshootingEvents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
