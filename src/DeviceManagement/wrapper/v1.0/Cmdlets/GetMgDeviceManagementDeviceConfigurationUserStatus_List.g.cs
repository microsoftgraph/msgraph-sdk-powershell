...
namespace Microsoft.Graph.PowerShell.DeviceManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceConfigurationUserStatus_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationUserStatus))]
    public class GetMgDeviceManagementDeviceConfigurationUserStatus_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.DeviceConfigurationUserStatusCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].UserStatuses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceConfigurations[DeviceConfigurationId].UserStatuses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
