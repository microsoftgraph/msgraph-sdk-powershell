...
{
    [GraphRoute("GET", "/deviceManagement/windowsInformationProtectionNetworkLearningSummaries")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementWindowsInformationProtectionNetworkLearningSummary_List")]
    ...
    public class GetMgDeviceManagementWindowsInformationProtectionNetworkLearningSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.WindowsInformationProtectionNetworkLearningSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
