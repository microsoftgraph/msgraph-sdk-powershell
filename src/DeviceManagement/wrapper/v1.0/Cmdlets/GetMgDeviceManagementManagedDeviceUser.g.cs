...
{
    [GraphRoute("GET", "/deviceManagement/managedDevices/{managedDevice-id}/users")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementManagedDeviceUser")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.User))]
    public class GetMgDeviceManagementManagedDeviceUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].Users.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ManagedDevices[ManagedDeviceId].Users.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
