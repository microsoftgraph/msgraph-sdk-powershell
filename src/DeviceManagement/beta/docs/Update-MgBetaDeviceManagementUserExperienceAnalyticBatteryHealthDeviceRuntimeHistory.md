...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDeviceRuntimeHistory
 ...
 [-DeviceId <String>] [-EstimatedRuntimeInMinutes <Int32>] [-Id <String>] [-ResponseHeadersVariable <String>]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDeviceRuntimeHistory
 ...
 [-EstimatedRuntimeInMinutes <Int32>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-RuntimeDateTime <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
