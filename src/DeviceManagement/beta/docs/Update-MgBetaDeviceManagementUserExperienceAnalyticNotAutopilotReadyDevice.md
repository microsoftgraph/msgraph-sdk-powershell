...
Update-MgBetaDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice
 ...
 [-ResponseHeadersVariable <String>] [-SerialNumber <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice
 ...
 [-ManagedBy <String>] [-Manufacturer <String>] [-Model <String>] [-ResponseHeadersVariable <String>]
 [-SerialNumber <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
