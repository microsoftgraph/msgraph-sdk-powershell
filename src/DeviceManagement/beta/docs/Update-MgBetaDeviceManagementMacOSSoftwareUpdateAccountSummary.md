...
Update-MgBetaDeviceManagementMacOSSoftwareUpdateAccountSummary -MacOSSoftwareUpdateAccountSummaryId <String>
 ...
 [-LastUpdatedDateTime <DateTime>] [-OSVersion <String>] [-ResponseHeadersVariable <String>]
 [-SuccessfulUpdateCount <Int32>] [-TotalUpdateCount <Int32>] [-UserId <String>] [-UserPrincipalName <String>]
