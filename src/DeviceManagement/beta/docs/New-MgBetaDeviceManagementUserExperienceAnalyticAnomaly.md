...
New-MgBetaDeviceManagementUserExperienceAnalyticAnomaly [-AdditionalProperties <Hashtable>]
 ...
 [-State <UserExperienceAnalyticsAnomalyState>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementUserExperienceAnalyticAnomaly
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsAnomaly> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
