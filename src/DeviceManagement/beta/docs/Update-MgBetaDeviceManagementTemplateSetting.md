...
Update-MgBetaDeviceManagementTemplateSetting -DeviceManagementSettingInstanceId <String>
 ...
 [-Id <String>] [-ResponseHeadersVariable <String>] [-ValueJson <String>] [-Headers <IDictionary>] [-Confirm]
...
```
Update-MgBetaDeviceManagementTemplateSetting -InputObject <IDeviceManagementIdentity>
 [-AdditionalProperties <Hashtable>] [-DefinitionId <String>] [-Id <String>]
 [-ResponseHeadersVariable <String>] [-ValueJson <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
