...
Update-MgBetaDeviceManagementUserExperienceAnalyticAppHealthOverview [-AdditionalProperties <Hashtable>]
 ...
 [-MetricValues <IMicrosoftGraphUserExperienceAnalyticsMetric[]>] [-Headers <IDictionary>] [-Confirm]
...
```
Update-MgBetaDeviceManagementUserExperienceAnalyticAppHealthOverview
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsCategory> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
