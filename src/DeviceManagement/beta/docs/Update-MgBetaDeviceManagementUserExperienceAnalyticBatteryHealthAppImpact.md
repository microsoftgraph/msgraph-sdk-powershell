...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthAppImpact
 ...
 [-BatteryUsagePercentage <Double>] [-Id <String>] [-IsForegroundApp] [-ResponseHeadersVariable <String>]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthAppImpact
 ...
 [-Id <String>] [-IsForegroundApp] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm]
