...
Update-MgBetaDeviceManagementManagedDeviceSecurityBaselineState -ManagedDeviceId <String>
 ...
 [-State <SecurityBaselineComplianceState>] [-UserPrincipalName <String>] [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaDeviceManagementManagedDeviceSecurityBaselineState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphSecurityBaselineState> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
