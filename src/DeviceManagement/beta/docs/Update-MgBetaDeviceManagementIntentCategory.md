...
Update-MgBetaDeviceManagementIntentCategory -DeviceManagementIntentId <String>
 ...
 [-Settings <IMicrosoftGraphDeviceManagementSettingInstance[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementIntentCategory -DeviceManagementIntentId <String>
 ...
 -BodyParameter <IMicrosoftGraphDeviceManagementIntentSettingCategory> [-ResponseHeadersVariable <String>]
