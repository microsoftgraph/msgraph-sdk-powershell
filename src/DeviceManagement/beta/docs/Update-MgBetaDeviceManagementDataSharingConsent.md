...
Update-MgBetaDeviceManagementDataSharingConsent -DataSharingConsentId <String>
 ...
 [-GrantedByUserId <String>] [-Id <String>] [-ResponseHeadersVariable <String>] [-ServiceDisplayName <String>]
 [-TermsUrl <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
