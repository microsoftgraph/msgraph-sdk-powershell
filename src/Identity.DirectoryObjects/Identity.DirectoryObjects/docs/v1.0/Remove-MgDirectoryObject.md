...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directoryobjects/remove-mgdirectoryobject
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgDirectoryObject -InputObject <IIdentityDirectoryObjectsIdentity> [-IfMatch <String>] [-PassThru]
