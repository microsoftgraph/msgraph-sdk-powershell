...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directoryobjects/get-mgdirectoryobject
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDirectoryObject -InputObject <IIdentityDirectoryObjectsIdentity> [-ExpandProperty <String[]>]
...
```yaml
Type: System.String[]
Parameter Sets: GetViaIdentity, List1
Aliases: Expand
