...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.site/new-mgsitecontenttypecolumnlink
schema: 2.0.0
---
...
```
New-MgSiteContentTypeColumnLink -ContentTypeId <String> -SiteId <String> [-Id <String>] [-Name <String>]
...
### CreateViaIdentity
```
New-MgSiteContentTypeColumnLink -InputObject <ISitesSiteIdentity> -BodyParameter <IMicrosoftGraphColumnLink>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteContentTypeColumnLink -InputObject <ISitesSiteIdentity> [-Id <String>] [-Name <String>] [-Confirm]
