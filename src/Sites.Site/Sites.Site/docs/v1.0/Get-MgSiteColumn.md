...
### List (Default)
```
Get-MgSiteColumn [-SiteId <String>] [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgSiteColumn -InputObject <ISitesSiteIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
