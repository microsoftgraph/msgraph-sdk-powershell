...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.site/update-mgsitecontenttypecolumnlink
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteContentTypeColumnLink -InputObject <ISitesSiteIdentity>
 -BodyParameter <IMicrosoftGraphColumnLink> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgSiteContentTypeColumnLink -InputObject <ISitesSiteIdentity> [-Id <String>] [-Name <String>]
