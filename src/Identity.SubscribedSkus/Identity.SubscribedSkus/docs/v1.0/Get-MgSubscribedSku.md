...
### List1 (Default)
```
Get-MgSubscribedSku [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity1
```
Get-MgSubscribedSku -InputObject <IIdentitySubscribedSkusIdentity> [-ExpandProperty <String[]>]
