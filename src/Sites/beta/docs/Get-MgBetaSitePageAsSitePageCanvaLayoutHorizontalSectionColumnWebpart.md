...
### List (Default)
```
Get-MgBetaSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -BaseSitePageId <String>
...
### GetViaIdentity
```
Get-MgBetaSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [<CommonParameters>]
```
