...
### List1 (Default)
```
Get-MgBetaSiteGetByPathPage -Path <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### List
```
Get-MgBetaSiteGetByPathPage -Path <String> -Path1 <String> -SiteId <String> [-ExpandProperty <String[]>]
