...
### Get1
```
Get-MgBetaSiteGetByPathDrive -Path <String> -Path1 <String> -SiteId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
...
### List
```
Get-MgBetaSiteGetByPathDrive -Path <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
