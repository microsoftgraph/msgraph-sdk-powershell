...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepageassitepagelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSitePageAsSitePageLastModifiedByUserMailboxSetting -BaseSitePageId <String>
 -GroupId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSitePageAsSitePageLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
