...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepageassitepagecreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSitePageAsSitePageCreatedByUserMailboxSetting -BaseSitePageId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSitePageAsSitePageCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
