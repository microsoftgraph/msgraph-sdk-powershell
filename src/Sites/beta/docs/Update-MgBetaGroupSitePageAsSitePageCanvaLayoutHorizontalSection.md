...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepageassitepagecanvalayouthorizontalsection
schema: 2.0.0
---
...
```
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutHorizontalSection -BaseSitePageId <String> -GroupId <String>
 -HorizontalSectionId <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutHorizontalSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphHorizontalSection> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutHorizontalSection -InputObject <ISitesIdentity>
 ...
 [-Emphasis <String>] [-Id <String>] [-Layout <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
