...
### List (Default)
```
Get-MgBetaSitePageAsSitePage -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSitePageAsSitePage -BaseSitePageId <String> -SiteId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSitePageAsSitePage -InputObject <ISitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
