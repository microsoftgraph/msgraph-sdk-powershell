...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitepageassitepagelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaSitePageAsSitePageLastModifiedByUserMailboxSetting -BaseSitePageId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaSitePageAsSitePageLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
