...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitegetbypathlist
schema: 2.0.0
---

# Get-MgBetaSiteGetByPathList
...
```
Get-MgBetaSiteGetByPathList -Path <String> -Path1 <String> -SiteId <String> [-ExpandProperty <String[]>]
