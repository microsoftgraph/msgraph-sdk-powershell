...
Add-MgBetaSiteContentTypeCopyFromContentTypeHub -SiteId <String> [-AdditionalProperties <Hashtable>]
 [-ContentTypeId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Add-MgBetaSiteContentTypeCopyFromContentTypeHub -InputObject <ISitesIdentity>
 [-AdditionalProperties <Hashtable>] [-ContentTypeId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
