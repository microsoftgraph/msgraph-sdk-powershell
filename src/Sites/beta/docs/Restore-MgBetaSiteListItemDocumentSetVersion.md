...
Restore-MgBetaSiteListItemDocumentSetVersion -DocumentSetVersionId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaSiteListItemDocumentSetVersion -InputObject <ISitesIdentity> [-Headers <IDictionary>]
