...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepageassitepagecanvalayoutverticalsection
schema: 2.0.0
---
...
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -BaseSitePageId <String> -GroupId <String>
 -SiteId <String> [-AdditionalProperties <Hashtable>] [-Emphasis <String>] [-Id <String>]
 [-ResponseHeadersVariable <String>] [-Webparts <IMicrosoftGraphWebPart[]>] [-Headers <IDictionary>]
...
```
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -InputObject <ISitesIdentity>
 [-AdditionalProperties <Hashtable>] [-Emphasis <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-Webparts <IMicrosoftGraphWebPart[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
