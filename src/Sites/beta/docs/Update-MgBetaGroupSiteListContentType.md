...
Update-MgBetaGroupSiteListContentType -ContentTypeId <String> -GroupId <String> -ListId <String>
 ...
 [-ReadOnly] [-Sealed] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaGroupSiteListContentType -ContentTypeId <String> -GroupId <String> -ListId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphContentType> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
