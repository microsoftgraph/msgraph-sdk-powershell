if(($null -eq $TestName) -or ($TestName -contains 'Update-MgGroupSiteTermStoreSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgGroupSiteTermStoreSetChild.Recording.json'
...
Describe 'Update-MgGroupSiteTermStoreSetChild' {
