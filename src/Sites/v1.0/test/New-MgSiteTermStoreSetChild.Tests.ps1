if(($null -eq $TestName) -or ($TestName -contains 'New-MgSiteTermStoreSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteTermStoreSetChild.Recording.json'
...
Describe 'New-MgSiteTermStoreSetChild' {
