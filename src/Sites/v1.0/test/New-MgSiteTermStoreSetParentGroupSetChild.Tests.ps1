if(($null -eq $TestName) -or ($TestName -contains 'New-MgSiteTermStoreSetParentGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteTermStoreSetParentGroupSetChild.Recording.json'
...
Describe 'New-MgSiteTermStoreSetParentGroupSetChild' {
