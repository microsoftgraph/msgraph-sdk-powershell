if(($null -eq $TestName) -or ($TestName -contains 'New-MgGroupSiteTermStoreSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupSiteTermStoreSetChildRelation.Recording.json'
...
Describe 'New-MgGroupSiteTermStoreSetChildRelation' {
