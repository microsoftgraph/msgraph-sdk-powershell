if(($null -eq $TestName) -or ($TestName -contains 'Update-MgGroupSiteTermStoreGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgGroupSiteTermStoreGroupSetChild.Recording.json'
...
Describe 'Update-MgGroupSiteTermStoreGroupSetChild' {
