if(($null -eq $TestName) -or ($TestName -contains 'Update-MgSiteTermStoreGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgSiteTermStoreGroupSetChild.Recording.json'
...
Describe 'Update-MgSiteTermStoreGroupSetChild' {
