if(($null -eq $TestName) -or ($TestName -contains 'Update-MgSiteTermStoreSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgSiteTermStoreSetChildRelation.Recording.json'
...
Describe 'Update-MgSiteTermStoreSetChildRelation' {
