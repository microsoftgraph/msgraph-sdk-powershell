if(($null -eq $TestName) -or ($TestName -contains 'New-MgGroupSiteTermStoreGroupSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupSiteTermStoreGroupSetChildRelation.Recording.json'
...
Describe 'New-MgGroupSiteTermStoreGroupSetChildRelation' {
