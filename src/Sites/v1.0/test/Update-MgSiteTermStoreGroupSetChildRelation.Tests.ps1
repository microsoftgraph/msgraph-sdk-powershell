if(($null -eq $TestName) -or ($TestName -contains 'Update-MgSiteTermStoreGroupSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgSiteTermStoreGroupSetChildRelation.Recording.json'
...
Describe 'Update-MgSiteTermStoreGroupSetChildRelation' {
