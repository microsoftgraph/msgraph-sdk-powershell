if(($null -eq $TestName) -or ($TestName -contains 'New-MgGroupSiteTermStoreGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupSiteTermStoreGroupSetChild.Recording.json'
...
Describe 'New-MgGroupSiteTermStoreGroupSetChild' {
