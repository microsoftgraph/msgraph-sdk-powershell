if(($null -eq $TestName) -or ($TestName -contains 'New-MgGroupSiteTermStoreSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupSiteTermStoreSetChild.Recording.json'
...
Describe 'New-MgGroupSiteTermStoreSetChild' {
