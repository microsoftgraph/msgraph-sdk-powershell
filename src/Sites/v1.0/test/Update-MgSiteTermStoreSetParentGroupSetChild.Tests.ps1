if(($null -eq $TestName) -or ($TestName -contains 'Update-MgSiteTermStoreSetParentGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgSiteTermStoreSetParentGroupSetChild.Recording.json'
...
Describe 'Update-MgSiteTermStoreSetParentGroupSetChild' {
