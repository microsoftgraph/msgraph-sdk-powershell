if(($null -eq $TestName) -or ($TestName -contains 'New-MgSiteTermStoreGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteTermStoreGroupSetChild.Recording.json'
...
Describe 'New-MgSiteTermStoreGroupSetChild' {
