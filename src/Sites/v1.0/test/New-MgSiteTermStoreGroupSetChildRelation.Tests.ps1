if(($null -eq $TestName) -or ($TestName -contains 'New-MgSiteTermStoreGroupSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteTermStoreGroupSetChildRelation.Recording.json'
...
Describe 'New-MgSiteTermStoreGroupSetChildRelation' {
