if(($null -eq $TestName) -or ($TestName -contains 'Update-MgSiteTermStoreSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgSiteTermStoreSetChild.Recording.json'
...
Describe 'Update-MgSiteTermStoreSetChild' {
