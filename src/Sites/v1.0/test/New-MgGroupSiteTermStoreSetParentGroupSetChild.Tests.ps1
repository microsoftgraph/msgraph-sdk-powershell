if(($null -eq $TestName) -or ($TestName -contains 'New-MgGroupSiteTermStoreSetParentGroupSetChild'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupSiteTermStoreSetParentGroupSetChild.Recording.json'
...
Describe 'New-MgGroupSiteTermStoreSetParentGroupSetChild' {
