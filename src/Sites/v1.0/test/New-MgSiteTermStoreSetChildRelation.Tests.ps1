if(($null -eq $TestName) -or ($TestName -contains 'New-MgSiteTermStoreSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteTermStoreSetChildRelation.Recording.json'
...
Describe 'New-MgSiteTermStoreSetChildRelation' {
