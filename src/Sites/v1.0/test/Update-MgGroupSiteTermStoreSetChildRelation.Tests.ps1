if(($null -eq $TestName) -or ($TestName -contains 'Update-MgGroupSiteTermStoreSetChildRelation'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgGroupSiteTermStoreSetChildRelation.Recording.json'
...
Describe 'Update-MgGroupSiteTermStoreSetChildRelation' {
