...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitepageassitepagecanvalayouthorizontalsectioncolumnwebpart
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -BaseSitePageId <String>
...
### GetViaIdentity
```
Get-MgSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [<CommonParameters>]
```
