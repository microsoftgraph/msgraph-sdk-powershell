...
### List1 (Default)
```
Get-MgSiteGetByPathPage -Path <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### List
```
Get-MgSiteGetByPathPage -Path <String> -Path1 <String> -SiteId <String> [-ExpandProperty <String[]>]
