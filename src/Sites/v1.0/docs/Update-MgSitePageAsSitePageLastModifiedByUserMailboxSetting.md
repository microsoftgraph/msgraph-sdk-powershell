...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitepageassitepagelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgSitePageAsSitePageLastModifiedByUserMailboxSetting -BaseSitePageId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSitePageAsSitePageLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
