...
```
Update-MgSiteAnalyticItemActivityStatActivity -ItemActivityId <String> -ItemActivityStatId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphItemActivity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSiteAnalyticItemActivityStatActivity -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSiteAnalyticItemActivityStatActivity -InputObject <ISitesIdentity> [-Access <Hashtable>]
 ...
 [-DriveItem <IMicrosoftGraphDriveItem>] [-Id <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
