...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-Headers <IDictionary>] [-Confirm]
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
 -TermId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
