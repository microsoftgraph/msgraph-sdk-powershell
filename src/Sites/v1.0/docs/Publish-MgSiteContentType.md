...
### Publish (Default)
```
Publish-MgSiteContentType -ContentTypeId <String> -SiteId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgSiteContentType -InputObject <ISitesIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
