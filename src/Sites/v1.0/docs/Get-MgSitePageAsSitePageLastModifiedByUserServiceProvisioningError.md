...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitepageassitepagelastmodifiedbyuserserviceprovisioningerror
schema: 2.0.0
---
...
```
Get-MgSitePageAsSitePageLastModifiedByUserServiceProvisioningError -BaseSitePageId <String> -SiteId <String>
