...
### Delete (Default)
```
Remove-MgSitePage -BaseSitePageId <String> -SiteId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgSitePage -InputObject <ISitesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
