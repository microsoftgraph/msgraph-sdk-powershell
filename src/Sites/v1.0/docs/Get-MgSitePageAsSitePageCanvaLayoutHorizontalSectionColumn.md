...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitepageassitepagecanvalayouthorizontalsectioncolumn
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSitePageAsSitePageCanvaLayoutHorizontalSectionColumn -BaseSitePageId <String>
 -HorizontalSectionId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgSitePageAsSitePageCanvaLayoutHorizontalSectionColumn -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [<CommonParameters>]
```
