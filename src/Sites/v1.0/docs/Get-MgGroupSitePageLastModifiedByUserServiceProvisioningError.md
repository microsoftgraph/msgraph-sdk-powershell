...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitepagelastmodifiedbyuserserviceprovisioningerror
schema: 2.0.0
---
...
```
Get-MgGroupSitePageLastModifiedByUserServiceProvisioningError -BaseSitePageId <String> -GroupId <String>
