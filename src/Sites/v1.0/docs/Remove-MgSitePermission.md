...
### Delete (Default)
```
Remove-MgSitePermission -PermissionId <String> -SiteId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgSitePermission -InputObject <ISitesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
