...
### Delete (Default)
```
Remove-MgSitePermission -PermissionId <String> -SiteId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSitePermission -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
