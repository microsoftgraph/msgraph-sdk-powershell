...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitepageassitepagecanvalayouthorizontalsectioncolumnwebpart
schema: 2.0.0
---
...
```
New-MgGroupSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -BaseSitePageId <String>
...
### CreateViaIdentity
```
New-MgGroupSitePageAsSitePageCanvaLayoutHorizontalSectionColumnWebpart -InputObject <ISitesIdentity>
 -BodyParameter <Hashtable> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
