...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitegetbypathlist
schema: 2.0.0
---

# Get-MgSiteGetByPathList
...
```
Get-MgSiteGetByPathList -Path <String> -Path1 <String> -SiteId <String> [-ExpandProperty <String[]>]
