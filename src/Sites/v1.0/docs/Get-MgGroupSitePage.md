...
### List (Default)
```
Get-MgGroupSitePage -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupSitePage -BaseSitePageId <String> -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>]
