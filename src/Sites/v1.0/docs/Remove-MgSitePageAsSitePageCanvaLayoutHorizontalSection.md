...
### Delete (Default)
```
Remove-MgSitePageAsSitePageCanvaLayoutHorizontalSection -BaseSitePageId <String> -HorizontalSectionId <String>
...
### DeleteViaIdentity
```
Remove-MgSitePageAsSitePageCanvaLayoutHorizontalSection -InputObject <ISitesIdentity> [-IfMatch <String>]
