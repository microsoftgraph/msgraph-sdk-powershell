...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitepageassitepagewebpart
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupSitePageAsSitePageWebPart -BaseSitePageId <String> -GroupId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgGroupSitePageAsSitePageWebPart -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
