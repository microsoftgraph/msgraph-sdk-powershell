...
New-MgGroupSiteOnenoteOperation -GroupId <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ResourceLocation <String>] [-Status <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgGroupSiteOnenoteOperation -GroupId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphOnenoteOperation> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
