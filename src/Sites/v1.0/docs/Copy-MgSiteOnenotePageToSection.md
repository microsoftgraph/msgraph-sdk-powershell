...
Copy-MgSiteOnenotePageToSection -OnenotePageId <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
 [-GroupId <String>] [-Id <String>] [-ResponseHeadersVariable <String>] [-SiteCollectionId <String>]
 [-SiteId1 <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Copy-MgSiteOnenotePageToSection -InputObject <ISitesIdentity> [-SiteId <String>]
 [-AdditionalProperties <Hashtable>] [-GroupId <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-SiteCollectionId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
