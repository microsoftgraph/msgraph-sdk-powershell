...
```
New-MgGroupSiteGetByPathContentType -GroupId <String> -Path <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphContentType> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create1
```
New-MgGroupSiteGetByPathContentType -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphContentType> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgGroupSiteGetByPathContentType -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
