...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitepageassitepagecanvalayouthorizontalsectioncolumn
schema: 2.0.0
---
...
```
New-MgGroupSitePageAsSitePageCanvaLayoutHorizontalSectionColumn -BaseSitePageId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgGroupSitePageAsSitePageCanvaLayoutHorizontalSectionColumn -InputObject <ISitesIdentity>
