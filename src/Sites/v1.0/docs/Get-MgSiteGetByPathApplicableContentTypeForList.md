...
### Get (Default)
```
Get-MgSiteGetByPathApplicableContentTypeForList -ListId <String> -Path <String> -SiteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgSiteGetByPathApplicableContentTypeForList -InputObject <ISitesIdentity> [-Count]
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
