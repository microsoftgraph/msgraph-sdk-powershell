...
```
Update-MgBetaGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
...
```
Update-MgBetaGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
 -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-PassThru] [-Confirm]
