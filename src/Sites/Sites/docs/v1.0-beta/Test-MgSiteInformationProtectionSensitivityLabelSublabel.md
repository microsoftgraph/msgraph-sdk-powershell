...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/test-mgsiteinformationprotectionsensitivitylabelsublabel
schema: 2.0.0
---

# Test-MgSiteInformationProtectionSensitivityLabelSublabel
...
```
Test-MgSiteInformationProtectionSensitivityLabelSublabel -SensitivityLabelId <String> -SiteId <String>
...
### EvaluateViaIdentity
```
Test-MgSiteInformationProtectionSensitivityLabelSublabel -InputObject <ISitesIdentity>
 -BodyParameter <IPaths19H6MbjSitesSiteIdInformationprotectionSensitivitylabelsSensitivitylabelIdSublabelsMicrosoftGraphEvaluatePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths19H6MbjSitesSiteIdInformationprotectionSensitivitylabelsSensitivitylabelIdSublabelsMicrosoftGraphEvaluatePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths19H6MbjSitesSiteIdInformationprotectionSensitivitylabelsSensitivitylabelIdSublabelsMicrosoftGraphEvaluatePostRequestbodyContentApplicationJsonSchema
