...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/new-mgsitepagecanvalayouthorizontalsectioncolumnwebpart
schema: 2.0.0
---
...
```
New-MgSitePageCanvaLayoutHorizontalSectionColumnWebpart -HorizontalSectionColumnId <String>
...
```
New-MgSitePageCanvaLayoutHorizontalSectionColumnWebpart -HorizontalSectionColumnId <String>
 -HorizontalSectionId <String> -SiteId <String> -SitePageId <String> -BodyParameter <Hashtable> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSitePageCanvaLayoutHorizontalSectionColumnWebpart -InputObject <ISitesIdentity>
