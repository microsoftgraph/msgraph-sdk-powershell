...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsitepagecanvalayoutverticalsection
schema: 2.0.0
---

# Update-MgSitePageCanvaLayoutVerticalSection
...
```
Update-MgSitePageCanvaLayoutVerticalSection -SiteId <String> -SitePageId <String>
 [-AdditionalProperties <Hashtable>] [-Emphasis <String>] [-Id <String>]
 [-Webparts <IMicrosoftGraphWebPart[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSitePageCanvaLayoutVerticalSection -SiteId <String> -SitePageId <String>
 -BodyParameter <IMicrosoftGraphVerticalSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSitePageCanvaLayoutVerticalSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphVerticalSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSitePageCanvaLayoutVerticalSection -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-Emphasis <String>] [-Id <String>] [-Webparts <IMicrosoftGraphWebPart[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
