...
### Create
```
New-MgBetaGroupSiteContentType -GroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphContentType1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaGroupSiteContentType -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphContentType1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
