...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mggroupsiteanalyticitemactivitystat
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupSiteAnalyticItemActivityStat -InputObject <ISitesIdentity> [-IfMatch <String>] [-PassThru]
