...
```
Update-MgBetaGroupSiteListContentTypeColumnLink -ColumnLinkId <String> -ContentTypeId <String> -GroupId <String>
...
```
Update-MgBetaGroupSiteListContentTypeColumnLink -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
