...
### Create
```
New-MgBetaSiteListContentType -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphContentType1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaSiteListContentType -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphContentType1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
