...
### Create1
```
New-MgBetaSiteTermStoreSet -SiteId <String> -BodyParameter <IMicrosoftGraphTermStoreSet1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaSiteTermStoreSet -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphTermStoreSet1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
