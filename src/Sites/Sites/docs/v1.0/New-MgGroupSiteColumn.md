...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/new-mggroupsitecolumn
schema: 2.0.0
---
...
### Create
```
New-MgGroupSiteColumn -GroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupSiteColumn -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTermColumn1
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
