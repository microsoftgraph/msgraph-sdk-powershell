...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/set-mgsitetermstoregroupsetchildrelationtotermbyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgSiteTermStoreGroupSetChildRelationToTermByRef -GroupId <String> -RelationId <String> -SetId <String>
...
### SetViaIdentity
```
Set-MgSiteTermStoreGroupSetChildRelationToTermByRef -InputObject <ISitesIdentity> -BodyParameter <Hashtable>
...
```
Set-MgSiteTermStoreGroupSetChildRelationToTermByRef -InputObject <ISitesIdentity>
