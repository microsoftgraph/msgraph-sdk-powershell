...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupsettermrelationfromtermbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSiteTermStoreGroupSetTermRelationFromTermByRef -GroupId <String> -RelationId <String> -SetId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSetTermRelationFromTermByRef -InputObject <ISitesIdentity> [-IfMatch <String>]
