...
### Get1 (Default)
```
Get-MgSiteContentTypeCompatibleHubContentType [-SiteId <String>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgSiteContentTypeCompatibleHubContentType -InputObject <ISitesIdentity> [<CommonParameters>]
```
