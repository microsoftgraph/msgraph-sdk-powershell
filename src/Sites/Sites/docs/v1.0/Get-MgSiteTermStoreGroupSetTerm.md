...
### List2 (Default)
```
Get-MgSiteTermStoreGroupSetTerm -GroupId <String> -SetId <String> -SiteId <String> [-Count]
...
### List
```
Get-MgSiteTermStoreGroupSetTerm -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String> [-Count]
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```
