...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitetermstoresetchildrelationfromtermbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSiteTermStoreSetChildRelationFromTermByRef -RelationId <String> -SetId <String> -SiteId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreSetChildRelationFromTermByRef -InputObject <ISitesIdentity> [-IfMatch <String>]
