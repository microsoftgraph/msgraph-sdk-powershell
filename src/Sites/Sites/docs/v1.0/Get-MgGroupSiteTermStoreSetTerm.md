...
### List1 (Default)
```
Get-MgGroupSiteTermStoreSetTerm -GroupId <String> -SetId <String> -SiteId <String> [-Count]
...
### List2
```
Get-MgGroupSiteTermStoreSetTerm -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String> [-Count]
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```
