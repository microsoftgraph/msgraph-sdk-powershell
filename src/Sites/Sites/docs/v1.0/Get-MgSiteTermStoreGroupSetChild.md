...
### List3 (Default)
```
Get-MgSiteTermStoreGroupSetChild -GroupId <String> -SetId <String> -SiteId <String> [-Count]
...
### List
```
Get-MgSiteTermStoreGroupSetChild -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String> [-Count]
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```
