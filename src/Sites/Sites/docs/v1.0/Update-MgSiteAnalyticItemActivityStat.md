...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsiteanalyticitemactivitystat
schema: 2.0.0
---
...
Update-MgSiteAnalyticItemActivityStat -ItemActivityStatId <String> -SiteId <String>
 ...
 [-Move <IMicrosoftGraphItemActionStat>] [-StartDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgSiteAnalyticItemActivityStat -ItemActivityStatId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgSiteAnalyticItemActivityStat -InputObject <ISitesIdentity> [-Access <IMicrosoftGraphItemActionStat>]
 [-Activities <IMicrosoftGraphItemActivity1[]>] [-AdditionalProperties <Hashtable>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphItemActivity1[]
Parameter Sets: UpdateExpanded1, UpdateViaIdentityExpanded1
Aliases:
