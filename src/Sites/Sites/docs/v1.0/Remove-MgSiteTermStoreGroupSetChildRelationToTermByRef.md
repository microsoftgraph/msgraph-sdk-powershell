...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupsetchildrelationtotermbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSiteTermStoreGroupSetChildRelationToTermByRef -GroupId <String> -RelationId <String> -SetId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSetChildRelationToTermByRef -InputObject <ISitesIdentity> [-IfMatch <String>]
