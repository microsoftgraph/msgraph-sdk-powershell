...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    public class GetMgSiteDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
