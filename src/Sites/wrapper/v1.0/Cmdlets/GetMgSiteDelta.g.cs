...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    public class GetMgSiteDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Sites.Client.Sites.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Sites.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Sites.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
