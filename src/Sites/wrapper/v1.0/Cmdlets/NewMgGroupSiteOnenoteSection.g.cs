...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/sections")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteOnenoteSection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenoteSection))]
    public class NewMgGroupSiteOnenoteSectionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Links)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Sections.PostAsync(body, requestConfiguration =>
                {
