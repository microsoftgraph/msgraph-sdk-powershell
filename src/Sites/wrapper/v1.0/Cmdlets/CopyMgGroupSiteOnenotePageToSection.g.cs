...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/pages/{onenotePage-id}/copyToSection")]
    [Cmdlet(VerbsCommon.Copy, "MgGroupSiteOnenotePageToSection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenoteOperation))]
    public class CopyMgGroupSiteOnenotePageToSectionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Sites.Client.Groups.Item.Sites.Item.Onenote.Pages.Item.CopyToSection.CopyToSectionPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId1)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Pages[OnenotePageId].CopyToSection.PostAsync(body, requestConfiguration =>
                {
