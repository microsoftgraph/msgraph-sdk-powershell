...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteColumn_Get or Get-MgSiteColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteColumn_Get" : "Get-MgSiteColumn_List";
            try
            {
