...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSitePageAsSitePage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SitePage))]
    public class GetMgSitePageAsSitePage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Pages.GraphSitePage.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Sites[SiteId].Pages.GraphSitePage.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
