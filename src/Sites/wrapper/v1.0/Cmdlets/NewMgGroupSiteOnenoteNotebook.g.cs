...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/notebooks")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteOnenoteNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.Notebook))]
    public class NewMgGroupSiteOnenoteNotebookCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserRole)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Notebooks.PostAsync(body, requestConfiguration =>
                {
