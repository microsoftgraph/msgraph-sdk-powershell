...
{
    [GraphRoute("GET", "/sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations")]
    [Cmdlet(VerbsCommon.Get, "MgSiteTermStoreSetParentGroupSetTermRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteTermStoreSetParentGroupSetTermRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteTermStoreSetParentGroupSetTermRelation_Get or Get-MgSiteTermStoreSetParentGroupSetTermRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteTermStoreSetParentGroupSetTermRelation_Get" : "Get-MgSiteTermStoreSetParentGroupSetTermRelation_List";
            try
            {
