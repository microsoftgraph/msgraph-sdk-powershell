...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreSetChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreSetChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreSetChildRelation_Get or Get-MgGroupSiteTermStoreSetChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreSetChildRelation_Get" : "Get-MgGroupSiteTermStoreSetChildRelation_List";
            try
            {
