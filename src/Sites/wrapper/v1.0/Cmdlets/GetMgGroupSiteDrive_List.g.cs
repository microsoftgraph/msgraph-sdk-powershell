...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteDrive_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.Drive))]
    public class GetMgGroupSiteDrive_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.DriveCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Drives.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Drives.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
