...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteList_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.List))]
    public class GetMgGroupSiteList_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.ListCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Lists.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Lists.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
