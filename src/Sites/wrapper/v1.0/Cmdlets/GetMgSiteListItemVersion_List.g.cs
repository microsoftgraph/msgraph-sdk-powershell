...
{
    [GraphRoute("GET", "/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions")]
    [Cmdlet(VerbsCommon.Get, "MgSiteListItemVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.ListItemVersion))]
    public class GetMgSiteListItemVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.ListItemVersionCollectionResponse? result;
            try
            {
                result = client.Sites[SiteId].Lists[ListId].Items[ListItemId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Sites[SiteId].Lists[ListId].Items[ListItemId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
