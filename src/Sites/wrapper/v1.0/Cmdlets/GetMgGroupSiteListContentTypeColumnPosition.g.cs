...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteListContentTypeColumnPosition", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteListContentTypeColumnPositionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteListContentTypeColumnPosition_Get or Get-MgGroupSiteListContentTypeColumnPosition_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteListContentTypeColumnPosition_Get" : "Get-MgGroupSiteListContentTypeColumnPosition_List";
            try
            {
