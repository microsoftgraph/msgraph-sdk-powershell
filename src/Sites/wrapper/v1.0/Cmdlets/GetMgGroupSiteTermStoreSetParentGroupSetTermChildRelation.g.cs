...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/children/{term-id1}/relations")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreSetParentGroupSetTermChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreSetParentGroupSetTermChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation_Get or Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation_Get" : "Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation_List";
            try
            {
