...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    public class GetMgGroupSiteListItemDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Sites.Client.Groups.Item.Sites.Item.Lists.Item.Items.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
