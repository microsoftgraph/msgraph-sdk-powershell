...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/lists/{list-id}/items/{listItem-id}/createLink")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteListItemLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.Permission))]
    public class NewMgGroupSiteListItemLinkCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Sites.Client.Groups.Item.Sites.Item.Lists.Item.Items.Item.CreateLink.CreateLinkPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Recipients)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items[ListItemId].CreateLink.PostAsync(body, requestConfiguration =>
                {
