...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreSetRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreSetRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreSetRelation_Get or Get-MgGroupSiteTermStoreSetRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreSetRelation_Get" : "Get-MgGroupSiteTermStoreSetRelation_List";
            try
            {
