...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/analytics/itemActivityStats/{itemActivityStat-id}/activities")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteAnalyticItemActivityStatActivity_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.ItemActivity))]
    public class GetMgGroupSiteAnalyticItemActivityStatActivity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.ItemActivityCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Analytics.ItemActivityStats[ItemActivityStatId].Activities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Analytics.ItemActivityStats[ItemActivityStatId].Activities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
