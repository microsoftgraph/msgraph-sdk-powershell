...
{
    [GraphRoute("GET", "/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations")]
    [Cmdlet(VerbsCommon.Get, "MgSiteTermStoreSetTermRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteTermStoreSetTermRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteTermStoreSetTermRelation_Get or Get-MgSiteTermStoreSetTermRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteTermStoreSetTermRelation_Get" : "Get-MgSiteTermStoreSetTermRelation_List";
            try
            {
