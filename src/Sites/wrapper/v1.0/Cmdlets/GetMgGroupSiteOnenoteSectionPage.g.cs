...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteOnenoteSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteOnenoteSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteOnenoteSectionPage_Get or Get-MgGroupSiteOnenoteSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteOnenoteSectionPage_Get" : "Get-MgGroupSiteOnenoteSectionPage_List";
            try
            {
