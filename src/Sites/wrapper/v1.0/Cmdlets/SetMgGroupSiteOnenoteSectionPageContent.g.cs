...
{
    [GraphRoute("PUT", "/groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgGroupSiteOnenoteSectionPageContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenotePage))]
    public class SetMgGroupSiteOnenoteSectionPageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Sections[OnenoteSectionId].Pages[OnenotePageId].Content.PutAsync(content, requestConfiguration =>
                {
