...
{
    [GraphRoute("POST", "/sites/{site-id}/lists")]
    [Cmdlet(VerbsCommon.New, "MgSiteList", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.List))]
    public class NewMgSiteListCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(System)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Lists.PostAsync(body, requestConfiguration =>
                {
