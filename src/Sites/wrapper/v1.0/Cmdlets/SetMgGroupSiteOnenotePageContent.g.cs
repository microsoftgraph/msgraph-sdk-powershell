...
{
    [GraphRoute("PUT", "/groups/{group-id}/sites/{site-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgGroupSiteOnenotePageContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenotePage))]
    public class SetMgGroupSiteOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Pages[OnenotePageId].Content.PutAsync(content, requestConfiguration =>
                {
