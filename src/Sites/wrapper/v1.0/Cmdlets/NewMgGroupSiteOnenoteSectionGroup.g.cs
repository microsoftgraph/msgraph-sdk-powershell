...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/sectionGroups")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteOnenoteSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroup))]
    public class NewMgGroupSiteOnenoteSectionGroupCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroup();
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.SectionGroups.PostAsync(body, requestConfiguration =>
                {
