...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/contentTypes/{contentType-id}/columns")]
    ...
    public class GetMgGroupSiteContentTypeColumnCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteContentTypeColumn_Get" : "Get-MgGroupSiteContentTypeColumn_List";
            try
            {
