...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/lists/{list-id}/items")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteListItem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.ListItem))]
    public class NewMgGroupSiteListItemCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SharepointIds)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items.PostAsync(body, requestConfiguration =>
                {
