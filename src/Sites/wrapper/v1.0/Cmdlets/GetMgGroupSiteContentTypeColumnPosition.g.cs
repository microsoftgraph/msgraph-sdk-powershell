...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/contentTypes/{contentType-id}/columnPositions")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteContentTypeColumnPosition", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteContentTypeColumnPositionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteContentTypeColumnPosition_Get or Get-MgGroupSiteContentTypeColumnPosition_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteContentTypeColumnPosition_Get" : "Get-MgGroupSiteContentTypeColumnPosition_List";
            try
            {
