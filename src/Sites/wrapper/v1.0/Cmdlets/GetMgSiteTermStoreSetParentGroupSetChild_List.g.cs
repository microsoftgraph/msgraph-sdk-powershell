...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    public class GetMgSiteTermStoreSetParentGroupSetChild_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, SetId1));
                return;
            }
