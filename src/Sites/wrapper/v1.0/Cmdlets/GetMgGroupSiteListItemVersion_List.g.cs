...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteListItemVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.ListItemVersion))]
    public class GetMgGroupSiteListItemVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items[ListItemId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items[ListItemId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
