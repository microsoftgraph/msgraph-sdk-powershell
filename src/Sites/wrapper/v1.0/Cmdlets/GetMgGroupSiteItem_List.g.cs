...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteItem_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.BaseItem))]
    public class GetMgGroupSiteItem_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.BaseItemCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Items.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Items.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
