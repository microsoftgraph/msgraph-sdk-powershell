...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/resources")]
    [Cmdlet(VerbsCommon.New, "MgGroupSiteOnenoteResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenoteResource))]
    public class NewMgGroupSiteOnenoteResourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ContentUrl)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Resources.PostAsync(body, requestConfiguration =>
                {
