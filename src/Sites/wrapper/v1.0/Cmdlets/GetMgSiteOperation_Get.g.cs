...
{
    [GraphRoute("GET", "/sites/{site-id}/operations/{richLongRunningOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.RichLongRunningOperation))]
    public class GetMgSiteOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Operations[RichLongRunningOperationId].GetAsync(requestConfiguration =>
                {
