...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/termStore/groups/{group-id1}/sets/{set-id}/terms/{term-id}/children/{term-id1}/relations")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreGroupSetTermChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreGroupSetTermChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreGroupSetTermChildRelation_Get or Get-MgGroupSiteTermStoreGroupSetTermChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreGroupSetTermChildRelation_Get" : "Get-MgGroupSiteTermStoreGroupSetTermChildRelation_List";
            try
            {
