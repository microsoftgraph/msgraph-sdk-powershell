...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteOnenoteNotebookSectionGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroup))]
    public class GetMgGroupSiteOnenoteNotebookSectionGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Notebooks[NotebookId].SectionGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Onenote.Notebooks[NotebookId].SectionGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
