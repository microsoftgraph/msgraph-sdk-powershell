...
{
    [GraphRoute("PUT", "/sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem/content")]
    [Cmdlet(VerbsCommon.Set, "MgSiteListItemDriveItemContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.DriveItem))]
    public class SetMgSiteListItemDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Sites[SiteId].Lists[ListId].Items[ListItemId].DriveItem.Content.PutAsync(content, requestConfiguration =>
                {
