...
{
    [GraphRoute("PATCH", "/groups/{group-id}/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}")]
    [Cmdlet(VerbsData.Update, "MgGroupSiteOnenoteSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroup))]
    public class UpdateMgGroupSiteOnenoteSectionGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.SectionGroups[SectionGroupId].PatchAsync(body, requestConfiguration =>
                {
