...
{
    [GraphRoute("POST", "/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/copyToNotebook")]
    [Cmdlet(VerbsCommon.Copy, "MgGroupSiteOnenoteNotebookSectionToNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.OnenoteOperation))]
    public class CopyMgGroupSiteOnenoteNotebookSectionToNotebookCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Sites.Client.Groups.Item.Sites.Item.Onenote.Notebooks.Item.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId1)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].CopyToNotebook.PostAsync(body, requestConfiguration =>
                {
