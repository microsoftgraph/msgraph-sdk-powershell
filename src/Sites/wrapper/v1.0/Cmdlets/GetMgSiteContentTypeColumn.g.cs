...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteContentTypeColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteContentTypeColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteContentTypeColumn_Get or Get-MgSiteContentTypeColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteContentTypeColumn_Get" : "Get-MgSiteContentTypeColumn_List";
            try
            {
