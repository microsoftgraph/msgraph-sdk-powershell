...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreGroupSetChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreGroupSetChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreGroupSetChildRelation_Get or Get-MgGroupSiteTermStoreGroupSetChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreGroupSetChildRelation_Get" : "Get-MgGroupSiteTermStoreGroupSetChildRelation_List";
            try
            {
