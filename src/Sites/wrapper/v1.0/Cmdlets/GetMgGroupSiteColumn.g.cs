...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteColumn_Get or Get-MgGroupSiteColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteColumn_Get" : "Get-MgGroupSiteColumn_List";
            try
            {
