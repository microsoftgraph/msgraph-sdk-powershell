...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteListContentTypeColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteListContentTypeColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteListContentTypeColumn_Get or Get-MgGroupSiteListContentTypeColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteListContentTypeColumn_Get" : "Get-MgGroupSiteListContentTypeColumn_List";
            try
            {
