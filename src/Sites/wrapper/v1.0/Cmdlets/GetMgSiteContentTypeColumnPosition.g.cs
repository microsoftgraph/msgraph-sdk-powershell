...
{
    [GraphRoute("GET", "/sites/{site-id}/contentTypes/{contentType-id}/columnPositions")]
    [Cmdlet(VerbsCommon.Get, "MgSiteContentTypeColumnPosition", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteContentTypeColumnPositionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteContentTypeColumnPosition_Get or Get-MgSiteContentTypeColumnPosition_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteContentTypeColumnPosition_Get" : "Get-MgSiteContentTypeColumnPosition_List";
            try
            {
