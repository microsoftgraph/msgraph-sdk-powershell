...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteTermStoreSetChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteTermStoreSetChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteTermStoreSetChildRelation_Get or Get-MgSiteTermStoreSetChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteTermStoreSetChildRelation_Get" : "Get-MgSiteTermStoreSetChildRelation_List";
            try
            {
