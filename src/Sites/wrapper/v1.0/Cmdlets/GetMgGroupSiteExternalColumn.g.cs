...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteExternalColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteExternalColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteExternalColumn_Get or Get-MgGroupSiteExternalColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteExternalColumn_Get" : "Get-MgGroupSiteExternalColumn_List";
            try
            {
