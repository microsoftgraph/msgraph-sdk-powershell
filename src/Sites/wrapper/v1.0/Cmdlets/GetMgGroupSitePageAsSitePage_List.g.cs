...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/pages/graph.sitePage")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSitePageAsSitePage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SitePage))]
    public class GetMgGroupSitePageAsSitePage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.SitePageCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Pages.GraphSitePage.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Pages.GraphSitePage.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
