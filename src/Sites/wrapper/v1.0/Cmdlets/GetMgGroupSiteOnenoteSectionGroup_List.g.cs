...
{
    [GraphRoute("GET", "/groups/{group-id}/sites/{site-id}/onenote/sectionGroups")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteOnenoteSectionGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroup))]
    public class GetMgGroupSiteOnenoteSectionGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.SectionGroupCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Onenote.SectionGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Onenote.SectionGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
