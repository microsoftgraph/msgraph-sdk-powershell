...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteTermStoreSetTermChildRelation", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupSiteTermStoreSetTermChildRelationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupSiteTermStoreSetTermChildRelation_Get or Get-MgGroupSiteTermStoreSetTermChildRelation_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupSiteTermStoreSetTermChildRelation_Get" : "Get-MgGroupSiteTermStoreSetTermChildRelation_List";
            try
            {
