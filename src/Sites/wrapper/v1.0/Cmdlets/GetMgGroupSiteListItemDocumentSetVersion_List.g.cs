...
namespace Microsoft.Graph.PowerShell.Sites
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSiteListItemDocumentSetVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.DocumentSetVersion))]
    public class GetMgGroupSiteListItemDocumentSetVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Sites.Client.Models.DocumentSetVersionCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items[ListItemId].DocumentSetVersions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Sites[SiteId].Lists[ListId].Items[ListItemId].DocumentSetVersions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
