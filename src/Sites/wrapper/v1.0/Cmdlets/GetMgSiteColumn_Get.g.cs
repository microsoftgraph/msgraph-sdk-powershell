...
{
    [GraphRoute("GET", "/sites/{site-id}/columns/{columnDefinition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteColumn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Sites.Client.Models.ColumnDefinition))]
    public class GetMgSiteColumn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Columns[ColumnDefinitionId].GetAsync(requestConfiguration =>
                {
