...
{
    [GraphRoute("GET", "/admin/configurationManagement/configurationDrifts")]
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationDrift_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationDrift))]
    public class GetMgAdminConfigurationManagementConfigurationDrift_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationDriftCollectionResponse? result;
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationDrifts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ConfigurationManagement.ConfigurationDrifts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
