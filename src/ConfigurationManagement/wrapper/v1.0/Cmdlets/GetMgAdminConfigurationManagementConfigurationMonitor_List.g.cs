...
namespace Microsoft.Graph.PowerShell.ConfigurationManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationMonitor_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationMonitor))]
    public class GetMgAdminConfigurationManagementConfigurationMonitor_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationMonitorCollectionResponse? result;
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationMonitors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ConfigurationManagement.ConfigurationMonitors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
