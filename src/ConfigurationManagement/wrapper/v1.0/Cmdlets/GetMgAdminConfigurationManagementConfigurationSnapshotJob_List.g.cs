...
namespace Microsoft.Graph.PowerShell.ConfigurationManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationSnapshotJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationSnapshotJob))]
    public class GetMgAdminConfigurationManagementConfigurationSnapshotJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationSnapshotJobCollectionResponse? result;
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationSnapshotJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ConfigurationManagement.ConfigurationSnapshotJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
