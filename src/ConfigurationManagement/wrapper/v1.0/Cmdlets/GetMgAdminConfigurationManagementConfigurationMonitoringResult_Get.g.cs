...
namespace Microsoft.Graph.PowerShell.ConfigurationManagement
{
    ...
    public class GetMgAdminConfigurationManagementConfigurationMonitoringResult_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ConfigurationMonitoringResultId));
                return;
            }
