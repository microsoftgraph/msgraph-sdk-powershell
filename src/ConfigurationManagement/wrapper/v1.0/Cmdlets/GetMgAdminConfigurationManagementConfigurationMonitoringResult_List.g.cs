...
namespace Microsoft.Graph.PowerShell.ConfigurationManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationMonitoringResult_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationMonitoringResult))]
    public class GetMgAdminConfigurationManagementConfigurationMonitoringResult_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationMonitoringResultCollectionResponse? result;
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationMonitoringResults.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ConfigurationManagement.ConfigurationMonitoringResults.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
