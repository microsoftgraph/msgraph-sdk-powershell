...
{
    [GraphRoute("GET", "/admin/configurationManagement/configurationMonitors/{configurationMonitor-id}/baseline")]
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationMonitorBaseline")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationBaseline))]
    public class GetMgAdminConfigurationManagementConfigurationMonitorBaselineCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationMonitors[ConfigurationMonitorId].Baseline.GetAsync(requestConfiguration =>
                {
