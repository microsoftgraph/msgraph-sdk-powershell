...
namespace Microsoft.Graph.PowerShell.ConfigurationManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminConfigurationManagementConfigurationSnapshot_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationBaseline))]
    public class GetMgAdminConfigurationManagementConfigurationSnapshot_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationBaselineCollectionResponse? result;
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationSnapshots.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ConfigurationManagement.ConfigurationSnapshots.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
