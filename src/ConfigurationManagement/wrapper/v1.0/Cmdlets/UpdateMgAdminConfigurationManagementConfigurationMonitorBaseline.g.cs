...
{
    [GraphRoute("PATCH", "/admin/configurationManagement/configurationMonitors/{configurationMonitor-id}/baseline")]
    [Cmdlet(VerbsData.Update, "MgAdminConfigurationManagementConfigurationMonitorBaseline", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ConfigurationManagement.Client.Models.ConfigurationBaseline))]
    public class UpdateMgAdminConfigurationManagementConfigurationMonitorBaselineCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Resources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Admin.ConfigurationManagement.ConfigurationMonitors[ConfigurationMonitorId].Baseline.PatchAsync(body, requestConfiguration =>
                {
