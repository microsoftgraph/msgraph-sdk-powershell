# How-To
This document describes how to develop for `Microsoft.Graph.Groups.Endpoint`.

## Building `Microsoft.Graph.Groups.Endpoint`
...
## Testing `Microsoft.Graph.Groups.Endpoint`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Groups.Endpoint` into the session.
