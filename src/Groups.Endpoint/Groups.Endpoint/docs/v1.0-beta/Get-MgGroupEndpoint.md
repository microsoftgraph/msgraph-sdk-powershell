...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.endpoint/get-mggroupendpoint
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupEndpoint -GroupId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgGroupEndpoint -InputObject <IGroupsEndpointIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
