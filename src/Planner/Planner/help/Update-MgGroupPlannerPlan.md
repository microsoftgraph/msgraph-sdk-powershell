...
Update-MgGroupPlannerPlan -GroupId <String> -PlannerPlanId <String> [-AdditionalProperties <Hashtable>]
 [-Buckets <IMicrosoftGraphPlannerBucket[]>] [-Contexts <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
### Update1
```
Update-MgGroupPlannerPlan -GroupId <String> -PlannerPlanId <String> -BodyParameter <IMicrosoftGraphPlannerPlan>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mggroupplannerplan](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mggroupplannerplan)
