...
### Get (Default)
```
Get-MgPlannerTaskDetail -PlannerTaskId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlannerTaskDetail -InputObject <IPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
