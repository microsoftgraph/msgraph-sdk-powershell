...
{
    [GraphRoute("GET", "/planner/plans/{plannerPlan-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanDetail")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlanDetails))]
    public class GetMgPlannerPlanDetailCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Plans[PlannerPlanId].Details.GetAsync(requestConfiguration =>
                {
