...
{
    [GraphRoute("GET", "/users/{user-id}/planner/plans/{plannerPlan-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlan_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class GetMgUserPlannerPlan_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Plans[PlannerPlanId].GetAsync(requestConfiguration =>
                {
