...
{
    [GraphRoute("GET", "/planner/plans/{plannerPlan-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlan_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class GetMgPlannerPlan_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Plans[PlannerPlanId].GetAsync(requestConfiguration =>
                {
