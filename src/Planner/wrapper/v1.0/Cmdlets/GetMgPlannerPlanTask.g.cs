...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerPlanTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerPlanTask_Get or Get-MgPlannerPlanTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerPlanTask_Get" : "Get-MgPlannerPlanTask_List";
            try
            {
