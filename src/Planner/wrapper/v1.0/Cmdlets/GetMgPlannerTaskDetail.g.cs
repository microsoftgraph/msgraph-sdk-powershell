...
{
    [GraphRoute("GET", "/planner/tasks/{plannerTask-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerTaskDetail")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerTaskDetails))]
    public class GetMgPlannerTaskDetailCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Tasks[PlannerTaskId].Details.GetAsync(requestConfiguration =>
                {
