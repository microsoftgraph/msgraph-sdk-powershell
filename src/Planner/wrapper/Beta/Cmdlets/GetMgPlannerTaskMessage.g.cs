...
{
    [GraphRoute("GET", "/planner/tasks/{plannerTask-id}/messages")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerTaskMessage", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerTaskMessageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerTaskMessage_Get or Get-MgPlannerTaskMessage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerTaskMessage_Get" : "Get-MgPlannerTaskMessage_List";
            try
            {
