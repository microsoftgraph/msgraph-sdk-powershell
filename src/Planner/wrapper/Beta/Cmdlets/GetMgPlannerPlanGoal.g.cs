...
{
    [GraphRoute("GET", "/planner/plans/{plannerPlan-id}/goals")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanGoal", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerGoalCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerGoal), ParameterSetName = new[] { "Get" })]
    public class GetMgPlannerPlanGoalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerPlanGoal_Get or Get-MgPlannerPlanGoal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerPlanGoal_Get" : "Get-MgPlannerPlanGoal_List";
            try
            {
