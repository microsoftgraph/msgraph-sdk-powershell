...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupPlannerPlanBucketTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupPlannerPlanBucketTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupPlannerPlanBucketTask_Get or Get-MgGroupPlannerPlanBucketTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupPlannerPlanBucketTask_Get" : "Get-MgGroupPlannerPlanBucketTask_List";
            try
            {
