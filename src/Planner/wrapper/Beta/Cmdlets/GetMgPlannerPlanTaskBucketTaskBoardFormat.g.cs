...
{
    [GraphRoute("GET", "/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanTaskBucketTaskBoardFormat")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerBucketTaskBoardTaskFormat))]
    public class GetMgPlannerPlanTaskBucketTaskBoardFormatCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Plans[PlannerPlanId].Tasks[PlannerTaskId].BucketTaskBoardFormat.GetAsync(requestConfiguration =>
                {
