...
{
    [GraphRoute("GET", "/planner/rosters/{plannerRoster-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerRoster_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerRoster))]
    public class GetMgPlannerRoster_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Rosters[PlannerRosterId].GetAsync(requestConfiguration =>
                {
