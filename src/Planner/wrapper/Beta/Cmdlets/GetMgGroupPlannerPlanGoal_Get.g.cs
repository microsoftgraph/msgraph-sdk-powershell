...
{
    [GraphRoute("GET", "/groups/{group-id}/planner/plans/{plannerPlan-id}/goals/{plannerGoal-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPlannerPlanGoal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerGoal))]
    public class GetMgGroupPlannerPlanGoal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Planner.Plans[PlannerPlanId].Goals[PlannerGoalId].GetAsync(requestConfiguration =>
                {
