...
{
    [GraphRoute("GET", "/users/{user-id}/planner/rosterPlans/{plannerPlan-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerRosterPlan_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class GetMgUserPlannerRosterPlan_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.RosterPlans[PlannerPlanId].GetAsync(requestConfiguration =>
                {
