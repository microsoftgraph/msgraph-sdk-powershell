...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanBucketTaskMessage", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerPlanBucketTaskMessageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerPlanBucketTaskMessage_Get or Get-MgPlannerPlanBucketTaskMessage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerPlanBucketTaskMessage_Get" : "Get-MgPlannerPlanBucketTaskMessage_List";
            try
            {
