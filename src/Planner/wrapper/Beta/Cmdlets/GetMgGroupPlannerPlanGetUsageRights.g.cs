...
{
    [GraphRoute("GET", "/groups/{group-id}/planner/plans/{plannerPlan-id}/getUsageRights()")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPlannerPlanGetUsageRights")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlanUsageRight))]
    public class GetMgGroupPlannerPlanGetUsageRightsCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Planner.Plans[PlannerPlanId].GetUsageRights.GetAsync(requestConfiguration =>
                {
