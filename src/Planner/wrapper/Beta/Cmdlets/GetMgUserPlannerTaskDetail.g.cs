...
{
    [GraphRoute("GET", "/users/{user-id}/planner/tasks/{plannerTask-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerTaskDetail")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerTaskDetails))]
    public class GetMgUserPlannerTaskDetailCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Tasks[PlannerTaskId].Details.GetAsync(requestConfiguration =>
                {
