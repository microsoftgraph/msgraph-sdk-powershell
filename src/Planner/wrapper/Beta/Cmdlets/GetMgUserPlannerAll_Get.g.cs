...
{
    [GraphRoute("GET", "/users/{user-id}/planner/all/{plannerDelta-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerAll_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerDelta))]
    public class GetMgUserPlannerAll_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.All[PlannerDeltaId].GetAsync(requestConfiguration =>
                {
