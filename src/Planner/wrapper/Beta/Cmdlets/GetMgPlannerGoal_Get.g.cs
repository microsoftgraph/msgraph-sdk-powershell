...
{
    [GraphRoute("GET", "/planner/goals/{plannerGoal-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerGoal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerGoal))]
    public class GetMgPlannerGoal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Goals[PlannerGoalId].GetAsync(requestConfiguration =>
                {
