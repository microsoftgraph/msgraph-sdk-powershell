...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanBucketTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerPlanBucketTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerPlanBucketTask_Get or Get-MgPlannerPlanBucketTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerPlanBucketTask_Get" : "Get-MgPlannerPlanBucketTask_List";
            try
            {
