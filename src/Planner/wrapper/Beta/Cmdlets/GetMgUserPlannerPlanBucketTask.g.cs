...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanBucketTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserPlannerPlanBucketTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerPlanBucketTask_Get or Get-MgUserPlannerPlanBucketTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerPlanBucketTask_Get" : "Get-MgUserPlannerPlanBucketTask_List";
            try
            {
