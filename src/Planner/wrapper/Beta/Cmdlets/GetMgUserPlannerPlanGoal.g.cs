...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanGoal", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserPlannerPlanGoalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerPlanGoal_Get or Get-MgUserPlannerPlanGoal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerPlanGoal_Get" : "Get-MgUserPlannerPlanGoal_List";
            try
            {
