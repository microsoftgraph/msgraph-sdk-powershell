...
{
    [GraphRoute("GET", "/users/{user-id}/planner/myDayTasks/{plannerTask-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerMyDayTask_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerTask))]
    public class GetMgUserPlannerMyDayTask_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.MyDayTasks[PlannerTaskId].GetAsync(requestConfiguration =>
                {
