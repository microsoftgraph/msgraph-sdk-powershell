...
{
    [GraphRoute("GET", "/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/messages")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerBucketTaskMessage", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerBucketTaskMessageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerBucketTaskMessage_Get or Get-MgPlannerBucketTaskMessage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerBucketTaskMessage_Get" : "Get-MgPlannerBucketTaskMessage_List";
            try
            {
