...
{
    [GraphRoute("GET", "/users/{user-id}/planner/plans/{plannerPlan-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanDetail")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlanDetails))]
    public class GetMgUserPlannerPlanDetailCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Plans[PlannerPlanId].Details.GetAsync(requestConfiguration =>
                {
