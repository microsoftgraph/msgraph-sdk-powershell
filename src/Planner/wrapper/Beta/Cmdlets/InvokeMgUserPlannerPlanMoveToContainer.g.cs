...
{
    [GraphRoute("POST", "/users/{user-id}/planner/plans/{plannerPlan-id}/moveToContainer")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserPlannerPlanMoveToContainer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class InvokeMgUserPlannerPlanMoveToContainerCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Planner.Client.Users.Item.Planner.Plans.Item.MoveToContainer.MoveToContainerPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Container)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Plans[PlannerPlanId].MoveToContainer.PostAsync(body, requestConfiguration =>
                {
