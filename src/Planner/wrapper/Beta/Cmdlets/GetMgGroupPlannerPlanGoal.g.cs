...
{
    [GraphRoute("GET", "/groups/{group-id}/planner/plans/{plannerPlan-id}/goals")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPlannerPlanGoal", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupPlannerPlanGoalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupPlannerPlanGoal_Get or Get-MgGroupPlannerPlanGoal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupPlannerPlanGoal_Get" : "Get-MgGroupPlannerPlanGoal_List";
            try
            {
