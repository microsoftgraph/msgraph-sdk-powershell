...
{
    [GraphRoute("GET", "/users/{user-id}/planner/plans/{plannerPlan-id}/goals/{plannerGoal-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanGoal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerGoal))]
    public class GetMgUserPlannerPlanGoal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Plans[PlannerPlanId].Goals[PlannerGoalId].GetAsync(requestConfiguration =>
                {
