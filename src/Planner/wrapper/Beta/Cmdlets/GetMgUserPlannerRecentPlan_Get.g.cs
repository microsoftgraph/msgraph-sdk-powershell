...
{
    [GraphRoute("GET", "/users/{user-id}/planner/recentPlans/{plannerPlan-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerRecentPlan_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class GetMgUserPlannerRecentPlan_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.RecentPlans[PlannerPlanId].GetAsync(requestConfiguration =>
                {
