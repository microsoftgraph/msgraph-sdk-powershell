...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanBucket", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserPlannerPlanBucketCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerPlanBucket_Get or Get-MgUserPlannerPlanBucket_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerPlanBucket_Get" : "Get-MgUserPlannerPlanBucket_List";
            try
            {
