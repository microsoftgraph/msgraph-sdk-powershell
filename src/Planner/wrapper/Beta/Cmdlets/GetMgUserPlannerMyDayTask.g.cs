...
{
    [GraphRoute("GET", "/users/{user-id}/planner/myDayTasks")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerMyDayTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserPlannerMyDayTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerMyDayTask_Get or Get-MgUserPlannerMyDayTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerMyDayTask_Get" : "Get-MgUserPlannerMyDayTask_List";
            try
            {
