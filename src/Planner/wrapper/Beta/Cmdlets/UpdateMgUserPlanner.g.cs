...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    public class UpdateMgUserPlannerCommand : GraphClientCmdlet
    {
        ...
        public Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerFavoritePlanReferenceCollection? FavoritePlanReferences { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerRecentPlanReferenceCollection? RecentPlanReferences { get; set; }
    ...
    if (this.IsParameterBound(nameof(FavoritePlanReferences)))
        body.FavoritePlanReferences = FavoritePlanReferences;

    if (this.IsParameterBound(nameof(RecentPlanReferences)))
        body.RecentPlanReferences = RecentPlanReferences;
