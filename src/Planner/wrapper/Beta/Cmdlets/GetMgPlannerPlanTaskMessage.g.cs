...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlannerPlanTaskMessage", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerPlanTaskMessageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerPlanTaskMessage_Get or Get-MgPlannerPlanTaskMessage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerPlanTaskMessage_Get" : "Get-MgPlannerPlanTaskMessage_List";
            try
            {
