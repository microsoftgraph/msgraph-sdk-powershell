...
{
    [GraphRoute("GET", "/users/{user-id}/planner/plans/{plannerPlan-id}/historyItems/{plannerHistoryItem-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanHistoryItem_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerHistoryItem))]
    public class GetMgUserPlannerPlanHistoryItem_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Plans[PlannerPlanId].HistoryItems[PlannerHistoryItemId].GetAsync(requestConfiguration =>
                {
