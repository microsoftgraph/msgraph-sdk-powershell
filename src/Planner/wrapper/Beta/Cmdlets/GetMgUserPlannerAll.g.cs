...
{
    [GraphRoute("GET", "/users/{user-id}/planner/all")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerAll", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerDeltaCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerDelta), ParameterSetName = new[] { "Get" })]
    public class GetMgUserPlannerAllCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerAll_Get or Get-MgUserPlannerAll_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerAll_Get" : "Get-MgUserPlannerAll_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? PlannerDeltaId : UserId);
                return;
            }
        }
    }
