...
namespace Microsoft.Graph.PowerShell.Planner
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerPlanTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserPlannerPlanTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserPlannerPlanTask_Get or Get-MgUserPlannerPlanTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserPlannerPlanTask_Get" : "Get-MgUserPlannerPlanTask_List";
            try
            {
