...
{
    [GraphRoute("GET", "/planner/rosters/{plannerRoster-id}/plans")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerRosterPlan", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerRosterPlanCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerRosterPlan_Get or Get-MgPlannerRosterPlan_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerRosterPlan_Get" : "Get-MgPlannerRosterPlan_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? PlannerPlanId : PlannerRosterId);
                return;
            }
        }
    }
