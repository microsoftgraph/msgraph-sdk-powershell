...
{
    [GraphRoute("GET", "/users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat")]
    [Cmdlet(VerbsCommon.Get, "MgUserPlannerTaskProgressTaskBoardFormat")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerProgressTaskBoardTaskFormat))]
    public class GetMgUserPlannerTaskProgressTaskBoardFormatCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Planner.Tasks[PlannerTaskId].ProgressTaskBoardFormat.GetAsync(requestConfiguration =>
                {
