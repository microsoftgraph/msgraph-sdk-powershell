...
{
    [GraphRoute("GET", "/planner/goals/{plannerGoal-id}/tasks")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerGoalTask", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerGoalTaskCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerGoalTask_Get or Get-MgPlannerGoalTask_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerGoalTask_Get" : "Get-MgPlannerGoalTask_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? PlannerTaskId : PlannerGoalId);
                return;
            }
        }
    }
