...
{
    [GraphRoute("POST", "/planner/plans/{plannerPlan-id}/moveToContainer")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgPlannerPlanMoveToContainer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Planner.Client.Models.PlannerPlan))]
    public class InvokeMgPlannerPlanMoveToContainerCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Planner.Client.Planner.Plans.Item.MoveToContainer.MoveToContainerPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Container)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Planner.Plans[PlannerPlanId].MoveToContainer.PostAsync(body, requestConfiguration =>
                {
