...
{
    [GraphRoute("GET", "/planner/goals")]
    [Cmdlet(VerbsCommon.Get, "MgPlannerGoal", DefaultParameterSetName = "List")]
    ...
    public class GetMgPlannerGoalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPlannerGoal_Get or Get-MgPlannerGoal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPlannerGoal_Get" : "Get-MgPlannerGoal_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? PlannerGoalId : null);
                return;
            }
        }
    }
