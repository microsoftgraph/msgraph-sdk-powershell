...
New-MgPlannerPlan [-AdditionalProperties <Hashtable>] [-Buckets <IMicrosoftGraphPlannerBucket[]>]
 ...
 [-Tasks <IMicrosoftGraphPlannerTask[]>] [-Title <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgPlannerPlan -BodyParameter <IMicrosoftGraphPlannerPlan> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
