...
New-MgPlannerTask [-ActiveChecklistItemCount <Int32>] [-AdditionalProperties <Hashtable>]
 ...
 [-ReferenceCount <Int32>] [-StartDateTime <DateTime>] [-Title <String>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgPlannerTask -BodyParameter <IMicrosoftGraphPlannerTask> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
