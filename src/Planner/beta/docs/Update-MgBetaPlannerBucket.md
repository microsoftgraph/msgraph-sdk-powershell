...
Update-MgBetaPlannerBucket -PlannerBucketId <String> -IfMatch <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ResponseHeadersVariable <String>] [-Tasks <IMicrosoftGraphPlannerTask[]>] [-Headers <IDictionary>]
...
Update-MgBetaPlannerBucket -InputObject <IPlannerIdentity> -IfMatch <String>
 ...
 [-OrderHint <String>] [-PlanId <String>] [-ResponseHeadersVariable <String>]
 [-Tasks <IMicrosoftGraphPlannerTask[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
