...
### Delete (Default)
```
Remove-MgBetaPlannerTask -PlannerTaskId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlannerTask -InputObject <IPlannerIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
