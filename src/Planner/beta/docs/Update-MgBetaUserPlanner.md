...
Update-MgBetaUserPlanner -UserId <String> -IfMatch <String> [-AdditionalProperties <Hashtable>]
 ...
 [-FavoritePlans <IMicrosoftGraphPlannerPlan[]>] [-Id <String>] [-MyDayTasks <IMicrosoftGraphPlannerTask[]>]
 [-Plans <IMicrosoftGraphPlannerPlan[]>] [-RecentPlanReferences <Hashtable>]
 [-RecentPlans <IMicrosoftGraphPlannerPlan[]>] [-RosterPlans <IMicrosoftGraphPlannerPlan[]>]
...
Update-MgBetaUserPlanner -InputObject <IPlannerIdentity> -IfMatch <String>
 -BodyParameter <IMicrosoftGraphPlannerUser> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
