...
Update-MgBetaPlannerPlanDetail -PlannerPlanId <String> -IfMatch <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-SharedWith <Hashtable>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaPlannerPlanDetail -PlannerPlanId <String> -IfMatch <String>
 -BodyParameter <IMicrosoftGraphPlannerPlanDetails> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPlannerPlanDetail -InputObject <IPlannerIdentity> -IfMatch <String>
 ...
 [-ContextDetails <Hashtable>] [-Id <String>] [-SharedWith <Hashtable>] [-Headers <IDictionary>] [-Confirm]
