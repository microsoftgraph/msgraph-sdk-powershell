...
Update-MgBetaPlannerRosterMember -PlannerRosterId <String> -PlannerRosterMemberId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-ResponseHeadersVariable <String>] [-Roles <String[]>]
 [-TenantId <String>] [-UserId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
