...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthreadpostmention
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupThreadPostMention -ConversationThreadId <String> -GroupId <String> -PostId <String> [-Count]
...
### GetViaIdentity
```
Get-MgGroupThreadPostMention -InputObject <IGroupsConversationThreadIdentity> [-Expand <String[]>]
