...
### List (Default)
```
Get-MgGroupThread -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgGroupThread -ConversationThreadId <String> -GroupId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupThread -InputObject <IGroupsConversationThreadIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
