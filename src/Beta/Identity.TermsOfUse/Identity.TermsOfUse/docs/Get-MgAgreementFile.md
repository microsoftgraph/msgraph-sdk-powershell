...
### List (Default)
```
Get-MgAgreementFile -AgreementId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgAgreementFile -AgreementFileId <String> -AgreementId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAgreementFile -InputObject <IIdentityTermsOfUseIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
