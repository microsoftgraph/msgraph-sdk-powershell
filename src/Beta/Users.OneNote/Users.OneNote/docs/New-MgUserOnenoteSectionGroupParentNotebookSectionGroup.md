...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionGroupParentNotebookSectionGroup -SectionGroupId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionGroupParentNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
