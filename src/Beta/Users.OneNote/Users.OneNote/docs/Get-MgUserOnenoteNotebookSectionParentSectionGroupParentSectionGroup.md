...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionParentSectionGroupParentSectionGroup -NotebookId <String>
 -OnenoteSectionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionParentSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity>
