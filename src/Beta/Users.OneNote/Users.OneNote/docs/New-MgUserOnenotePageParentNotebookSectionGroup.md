...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotepageparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgUserOnenotePageParentNotebookSectionGroup -OnenotePageId <String> -UserId <String>
...
### Create1
```
New-MgUserOnenotePageParentNotebookSectionGroup -OnenotePageId <String> -SectionGroupId <String>
...
### CreateViaIdentity
```
New-MgUserOnenotePageParentNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
