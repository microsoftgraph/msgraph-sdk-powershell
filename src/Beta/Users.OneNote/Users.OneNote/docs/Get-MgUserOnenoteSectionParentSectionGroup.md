...
### Get (Default)
```
Get-MgUserOnenoteSectionParentSectionGroup -OnenoteSectionId <String> -UserId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentSectionGroup -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
