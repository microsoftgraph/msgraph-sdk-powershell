...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionPageParentSection -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionPageParentSection -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
