...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionGroupParentNotebookSection -SectionGroupId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionGroupParentNotebookSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
