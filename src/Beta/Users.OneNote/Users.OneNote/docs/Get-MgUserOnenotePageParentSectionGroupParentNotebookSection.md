...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String>
 -OnenoteSectionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSection -InputObject <IUsersOneNoteIdentity>
