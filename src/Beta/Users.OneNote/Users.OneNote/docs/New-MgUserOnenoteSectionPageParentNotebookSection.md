...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionPageParentNotebookSection -InputObject <IUsersOneNoteIdentity>
