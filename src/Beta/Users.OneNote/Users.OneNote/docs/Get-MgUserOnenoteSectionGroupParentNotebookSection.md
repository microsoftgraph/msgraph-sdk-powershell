...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSection -SectionGroupId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUserOnenoteSectionGroupParentNotebookSection -OnenoteSectionId <String> -SectionGroupId <String>
 -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSection -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
