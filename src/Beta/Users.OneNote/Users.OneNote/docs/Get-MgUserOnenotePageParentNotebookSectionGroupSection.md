...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -SectionGroupId <String>
...
### Get
```
Get-MgUserOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity>
