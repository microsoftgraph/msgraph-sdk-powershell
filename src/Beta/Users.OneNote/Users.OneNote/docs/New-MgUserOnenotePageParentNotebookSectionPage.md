...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
```
New-MgUserOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgUserOnenotePageParentNotebookSectionPage -InputObject <IUsersOneNoteIdentity>
