...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteNotebookSection -NotebookId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserOnenoteNotebookSection -NotebookId <String> -OnenoteSectionId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteNotebookSection -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
