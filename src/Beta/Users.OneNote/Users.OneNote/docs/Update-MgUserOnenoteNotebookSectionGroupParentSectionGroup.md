...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotenotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgUserOnenoteNotebookSectionGroupParentSectionGroup -NotebookId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgUserOnenoteNotebookSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity>
