...
### Get (Default)
```
Get-MgUserOnenotePageParentSectionGroup -OnenotePageId <String> -UserId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionGroup -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List
```
Get-MgUserOnenotePageParentSectionGroup -OnenotePageId <String> -UserId <String> [-Count] [-Expand <String[]>]
