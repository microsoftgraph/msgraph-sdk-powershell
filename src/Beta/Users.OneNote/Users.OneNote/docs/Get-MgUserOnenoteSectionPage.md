...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionPage -OnenoteSectionId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionPage -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
