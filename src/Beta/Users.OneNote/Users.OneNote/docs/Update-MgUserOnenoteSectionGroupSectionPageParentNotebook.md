...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgUserOnenoteSectionGroupSectionPageParentNotebook -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgUserOnenoteSectionGroupSectionPageParentNotebook -InputObject <IUsersOneNoteIdentity>
