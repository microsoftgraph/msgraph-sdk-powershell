...
### Get (Default)
```
Get-MgUserOnenotePageParentSection -OnenotePageId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenotePageParentSection -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
