...
### List1 (Default)
```
Get-MgUserOnenoteNotebookSectionGroup -NotebookId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionGroup -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
