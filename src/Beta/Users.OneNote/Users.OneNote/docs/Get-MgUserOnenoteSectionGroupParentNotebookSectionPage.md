...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPage -OnenoteSectionId <String> -SectionGroupId <String>
...
### Get
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPage -InputObject <IUsersOneNoteIdentity>
