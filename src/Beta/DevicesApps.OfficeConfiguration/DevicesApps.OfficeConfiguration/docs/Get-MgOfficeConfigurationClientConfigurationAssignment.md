...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.officeconfiguration/get-mgofficeconfigurationclientconfigurationassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgOfficeConfigurationClientConfigurationAssignment -OfficeClientConfigurationId <String> [-Count]
...
### Get
```
Get-MgOfficeConfigurationClientConfigurationAssignment -OfficeClientConfigurationAssignmentId <String>
 -OfficeClientConfigurationId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgOfficeConfigurationClientConfigurationAssignment -InputObject <IDevicesAppsOfficeConfigurationIdentity>
