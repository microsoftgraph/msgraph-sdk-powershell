...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.administrativeunits/get-mgadministrativeunitbyid
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgAdministrativeUnitById [-Ids <String[]>] [-Types <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
