...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
