...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectionparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentSectionParentNotebookSection -OnenotePageId <String> -SiteId <String> [-Count]
...
### Get
```
Get-MgSiteOnenotePageParentSectionParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
 -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity>
