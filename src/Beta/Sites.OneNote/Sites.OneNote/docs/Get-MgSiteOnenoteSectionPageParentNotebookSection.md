...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
```
Get-MgSiteOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionPageParentNotebookSection -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
