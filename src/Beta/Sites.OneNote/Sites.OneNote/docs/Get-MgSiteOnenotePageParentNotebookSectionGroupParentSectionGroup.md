...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroupParentSectionGroup -OnenotePageId <String>
 -SectionGroupId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
