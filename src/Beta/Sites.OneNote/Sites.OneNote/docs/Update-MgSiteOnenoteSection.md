...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenoteSection -InputObject <ISitesOneNoteIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>]
