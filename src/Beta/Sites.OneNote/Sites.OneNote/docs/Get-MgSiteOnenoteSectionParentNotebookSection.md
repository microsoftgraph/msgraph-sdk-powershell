...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionParentNotebookSection -OnenoteSectionId <String> -SiteId <String> [-Count]
...
### Get
```
Get-MgSiteOnenoteSectionParentNotebookSection -OnenoteSectionId <String> -OnenoteSectionId1 <String>
 -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
