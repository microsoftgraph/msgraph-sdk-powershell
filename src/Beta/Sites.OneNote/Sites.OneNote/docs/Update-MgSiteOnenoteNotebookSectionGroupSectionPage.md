...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsectionpage
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPage -NotebookId <String> -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPage -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
