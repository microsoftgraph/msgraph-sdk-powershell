...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroup -OnenotePageId <String> -SiteId <String> [-Count]
...
### Get
```
Get-MgSiteOnenotePageParentNotebookSectionGroup -OnenotePageId <String> -SectionGroupId <String>
 -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgSiteOnenotePageParentNotebookSectionGroup -OnenotePageId <String> -SectionGroupId <String>
 -SectionGroupId1 <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
