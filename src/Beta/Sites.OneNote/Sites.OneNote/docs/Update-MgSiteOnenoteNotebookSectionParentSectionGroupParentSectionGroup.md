...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentSectionGroup -NotebookId <String>
 -OnenoteSectionId <String> -SiteId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentSectionGroup -NotebookId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
