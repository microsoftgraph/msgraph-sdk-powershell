...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String>
...
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebookSection -InputObject <ISitesOneNoteIdentity>
