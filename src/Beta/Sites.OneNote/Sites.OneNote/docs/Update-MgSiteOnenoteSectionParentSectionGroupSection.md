...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentSectionGroupSection -OnenoteSectionId <String> -OnenoteSectionId1 <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentSectionGroupSection -InputObject <ISitesOneNoteIdentity>
