...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectionpage
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionPage -OnenotePageId <String> -OnenotePageId1 <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSectionPage -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenotePageParentSectionPage -InputObject <ISitesOneNoteIdentity> [-ContentInputFile <String>]
