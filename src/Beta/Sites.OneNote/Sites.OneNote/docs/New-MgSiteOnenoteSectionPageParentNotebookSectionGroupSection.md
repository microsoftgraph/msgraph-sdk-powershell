...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -OnenotePageId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
