...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentNotebookSection -OnenoteSectionId <String> -OnenoteSectionId1 <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity>
