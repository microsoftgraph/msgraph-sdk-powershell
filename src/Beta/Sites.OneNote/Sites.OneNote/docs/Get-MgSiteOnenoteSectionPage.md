...
### List (Default)
```
Get-MgSiteOnenoteSectionPage -OnenoteSectionId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionPage -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
