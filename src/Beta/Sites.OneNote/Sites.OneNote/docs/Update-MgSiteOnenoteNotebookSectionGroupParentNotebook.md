...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupParentNotebook -NotebookId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
