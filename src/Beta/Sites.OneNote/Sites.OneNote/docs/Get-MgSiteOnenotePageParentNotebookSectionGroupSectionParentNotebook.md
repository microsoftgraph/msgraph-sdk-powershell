...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionParentNotebook -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
