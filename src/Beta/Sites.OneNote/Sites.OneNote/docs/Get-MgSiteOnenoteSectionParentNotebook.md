...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenoteSectionParentNotebook -OnenoteSectionId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebook -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
