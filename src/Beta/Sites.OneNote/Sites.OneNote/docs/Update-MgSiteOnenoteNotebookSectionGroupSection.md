...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSection -NotebookId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
