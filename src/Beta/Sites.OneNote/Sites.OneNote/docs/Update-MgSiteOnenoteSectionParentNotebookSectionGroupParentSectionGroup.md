...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentNotebookSectionGroupParentSectionGroup -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentNotebookSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
