...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionParentSectionGroupSection -OnenoteSectionId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionParentSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
