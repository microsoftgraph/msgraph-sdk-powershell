...
### Get (Default)
```
Get-MgSiteOnenote -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenote -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
