...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSection -OnenotePageId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
