...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteNotebookSectionPage -NotebookId <String> -OnenoteSectionId <String> -SiteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgSiteOnenoteNotebookSectionPage -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
