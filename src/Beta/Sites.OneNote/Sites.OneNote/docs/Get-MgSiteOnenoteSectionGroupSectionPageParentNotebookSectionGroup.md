...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionGroupSectionPageParentNotebookSectionGroup -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
```
Get-MgSiteOnenoteSectionGroupSectionPageParentNotebookSectionGroup -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SectionGroupId1 <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupSectionPageParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
