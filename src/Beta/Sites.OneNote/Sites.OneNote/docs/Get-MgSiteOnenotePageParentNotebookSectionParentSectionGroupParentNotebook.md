...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionParentSectionGroupParentNotebook -OnenotePageId <String>
