...
### List (Default)
```
Get-MgBookingBusinessCustomer -BookingBusinessId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBookingBusinessCustomer -BookingBusinessId <String> -BookingCustomerId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBookingBusinessCustomer -InputObject <IBookingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
