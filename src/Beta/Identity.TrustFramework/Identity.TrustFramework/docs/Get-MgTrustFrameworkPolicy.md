...
### List (Default)
```
Get-MgTrustFrameworkPolicy [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgTrustFrameworkPolicy -TrustFrameworkPolicyId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTrustFrameworkPolicy -InputObject <IIdentityTrustFrameworkIdentity> [-Expand <String[]>]
