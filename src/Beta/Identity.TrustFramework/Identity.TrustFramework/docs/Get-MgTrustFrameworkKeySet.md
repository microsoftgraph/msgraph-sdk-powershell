...
### List (Default)
```
Get-MgTrustFrameworkKeySet [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgTrustFrameworkKeySet -TrustFrameworkKeySetId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTrustFrameworkKeySet -InputObject <IIdentityTrustFrameworkIdentity> [-Expand <String[]>]
