...
Get-MgFinancialCompanySaleCreditMemoCustomerPicture -CompanyId <String> -PictureId <String>
 -SalesCreditMemoId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleCreditMemoCustomerPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
