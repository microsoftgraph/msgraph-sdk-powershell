...
### List (Default)
```
Get-MgFinancialCompanyVendorPicture -CompanyId <String> -VendorId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyVendorPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
