...
### List (Default)
```
Get-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -SalesInvoiceLineId <String> [-Count]
...
```
Get-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceId <String> -SalesInvoiceLineId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoiceLineItemPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
...
Get-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
