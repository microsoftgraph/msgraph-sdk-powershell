...
```
Update-MgFinancialCompanyAccount -AccountId <String> -CompanyId <String> [-Blocked] [-Category <String>]
...
```
Update-MgFinancialCompanyAccount -InputObject <IFinancialsIdentity> [-Blocked] [-Category <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Number <String>]
 [-SubCategory <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
