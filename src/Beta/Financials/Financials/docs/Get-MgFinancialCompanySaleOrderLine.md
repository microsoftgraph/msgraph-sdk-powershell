...
### List (Default)
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> -SalesOrderLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderLine -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List1
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> -SalesOrderId <String> [-Count] [-Expand <String[]>]
...
### -SalesOrderLineId
key: salesOrderLine-id of salesOrderLine
