...
Update-MgFinancialCompanyAgedAccountReceivable -AgedAccountsReceivableId <String> -CompanyId <String>
 ...
 [-Period2Amount <Decimal>] [-Period3Amount <Decimal>] [-PeriodLengthFilter <String>] [-PassThru] [-Confirm]
...
```
Update-MgFinancialCompanyAgedAccountReceivable -InputObject <IFinancialsIdentity> [-AgedAsOfDate <DateTime>]
 [-BalanceDue <Decimal>] [-CurrencyCode <String>] [-CurrentAmount <Decimal>] [-CustomerNumber <String>]
 [-Id <String>] [-Name <String>] [-Period1Amount <Decimal>] [-Period2Amount <Decimal>]
 [-Period3Amount <Decimal>] [-PeriodLengthFilter <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
key: agedAccountsReceivable-id of agedAccountsReceivable
