...
### List (Default)
```
Get-MgFinancialCompanyGeneralLedgerEntry -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyGeneralLedgerEntry -InputObject <IFinancialsIdentity> [-Expand <String[]>]
