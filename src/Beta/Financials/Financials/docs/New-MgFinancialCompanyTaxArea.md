...
```
New-MgFinancialCompanyTaxArea -CompanyId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
New-MgFinancialCompanyTaxArea -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
