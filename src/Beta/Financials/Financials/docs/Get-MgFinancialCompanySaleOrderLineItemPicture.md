...
### List (Default)
```
Get-MgFinancialCompanySaleOrderLineItemPicture -CompanyId <String> -SalesOrderLineId <String> [-Count]
...
Get-MgFinancialCompanySaleOrderLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesOrderLineId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderLineItemPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
...
Get-MgFinancialCompanySaleOrderLineItemPicture -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
