...
### Get (Default)
```
Get-MgFinancialCompanyVendorCurrency -CompanyId <String> -VendorId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyVendorCurrency -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
