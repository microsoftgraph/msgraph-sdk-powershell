...
```
New-MgFinancialCompanyShipmentMethod -CompanyId <String> [-Code <String>] [-DisplayName <String>]
...
```
New-MgFinancialCompanyShipmentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
