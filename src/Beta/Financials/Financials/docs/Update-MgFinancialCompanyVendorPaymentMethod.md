...
```
Update-MgFinancialCompanyVendorPaymentMethod -CompanyId <String> -VendorId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyVendorPaymentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
