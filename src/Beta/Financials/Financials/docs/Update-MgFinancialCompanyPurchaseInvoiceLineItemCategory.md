...
```
Update-MgFinancialCompanyPurchaseInvoiceLineItemCategory -CompanyId <String> -PurchaseInvoiceId <String>
 -PurchaseInvoiceLineId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanyPurchaseInvoiceLineItemCategory -InputObject <IFinancialsIdentity> [-Code <String>]
