...
### List (Default)
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> -JournalLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyJournalLine -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> -JournalId <String> [-Count] [-Expand <String[]>]
