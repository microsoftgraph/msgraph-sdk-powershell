...
### List (Default)
```
Get-MgFinancialCompanyItemCategory -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyItemCategory -CompanyId <String> -ItemCategoryId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgFinancialCompanyItemCategory -CompanyId <String> -ItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyItemCategory -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### -ItemCategoryId
key: itemCategory-id of itemCategory
