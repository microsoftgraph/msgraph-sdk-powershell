...
```
Update-MgFinancialCompanyPicture -CompanyId <String> -PictureId <String> [-ContentInputFile <String>]
...
```
Update-MgFinancialCompanyPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
 [-ContentType <String>] [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
