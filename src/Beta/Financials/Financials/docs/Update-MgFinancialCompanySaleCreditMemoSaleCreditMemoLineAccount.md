...
Update-MgFinancialCompanySaleCreditMemoSaleCreditMemoLineAccount -CompanyId <String>
 -SalesCreditMemoId <String> -SalesCreditMemoLineId <String> [-Blocked] [-Category <String>]
...
```
Update-MgFinancialCompanySaleCreditMemoSaleCreditMemoLineAccount -InputObject <IFinancialsIdentity> [-Blocked]
