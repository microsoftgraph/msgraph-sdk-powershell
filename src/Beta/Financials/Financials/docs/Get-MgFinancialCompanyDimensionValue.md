...
### List1 (Default)
```
Get-MgFinancialCompanyDimensionValue -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionValueId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyDimensionValue -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List
```
Get-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionId <String> [-Count] [-Expand <String[]>]
...
### -DimensionValueId
key: dimensionValue-id of dimensionValue
