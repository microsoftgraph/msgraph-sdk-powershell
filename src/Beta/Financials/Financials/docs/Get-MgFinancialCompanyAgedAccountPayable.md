...
### List (Default)
```
Get-MgFinancialCompanyAgedAccountPayable -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyAgedAccountPayable -InputObject <IFinancialsIdentity> [-Expand <String[]>]
