...
### List (Default)
```
Get-MgFinancialCompanySaleCreditMemoLine -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleCreditMemoLine -InputObject <IFinancialsIdentity> [-Expand <String[]>]
