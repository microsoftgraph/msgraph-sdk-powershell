...
### Get (Default)
```
Get-MgFinancialCompanyCustomerPaymentTerm -CompanyId <String> -CustomerPaymentId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgFinancialCompanyCustomerPaymentTerm -CompanyId <String> -CustomerId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyCustomerPaymentTerm -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
