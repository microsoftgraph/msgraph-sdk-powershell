...
### Get (Default)
```
Get-MgFinancialCompanySaleOrderCustomer -CompanyId <String> -SalesOrderId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderCustomer -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
