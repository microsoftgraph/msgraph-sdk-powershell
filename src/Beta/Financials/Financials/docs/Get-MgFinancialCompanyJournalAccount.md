...
### Get (Default)
```
Get-MgFinancialCompanyJournalAccount -CompanyId <String> -JournalId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyJournalAccount -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
