...
```
New-MgFinancialCompanyUnit -CompanyId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
 [-InternationalStandardCode <String>] [-LastModifiedDateTime <DateTime>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgFinancialCompanyUnit -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
 [-Id <String>] [-InternationalStandardCode <String>] [-LastModifiedDateTime <DateTime>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
