...
### List (Default)
```
Get-MgFinancialCompanyAgedAccountReceivable -CompanyId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyAgedAccountReceivable -InputObject <IFinancialsIdentity> [-Expand <String[]>]
