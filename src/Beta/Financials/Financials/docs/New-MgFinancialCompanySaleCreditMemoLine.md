...
```
New-MgFinancialCompanySaleCreditMemoLine -CompanyId <String> [-AccountBlocked] [-AccountCategory <String>]
...
```
New-MgFinancialCompanySaleCreditMemoLine -InputObject <IFinancialsIdentity> [-AccountBlocked]
