...
### UpdateExpanded1
```
Update-MgFinancialCompanyCustomerPaymentMethod -CompanyId <String> -CustomerId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyCustomerPaymentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
