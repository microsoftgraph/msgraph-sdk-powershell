...
### List (Default)
```
Get-MgFinancialCompanyEmployeePicture -CompanyId <String> -EmployeeId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyEmployeePicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
