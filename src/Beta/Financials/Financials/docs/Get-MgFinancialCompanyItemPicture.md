...
### List (Default)
```
Get-MgFinancialCompanyItemPicture -CompanyId <String> -ItemId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyItemPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
