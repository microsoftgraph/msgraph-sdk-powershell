...
### List (Default)
```
Get-MgFinancialCompanyCustomerPicture -CompanyId <String> -CustomerId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyCustomerPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
