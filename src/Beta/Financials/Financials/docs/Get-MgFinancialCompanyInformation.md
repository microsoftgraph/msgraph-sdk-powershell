...
### List (Default)
```
Get-MgFinancialCompanyInformation -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyInformation -CompanyId <String> -CompanyInformationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyInformation -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
