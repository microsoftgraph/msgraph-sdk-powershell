...
### List (Default)
```
Get-MgFinancialCompanyCustomer -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyCustomer -CompanyId <String> -CustomerId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyCustomer -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
