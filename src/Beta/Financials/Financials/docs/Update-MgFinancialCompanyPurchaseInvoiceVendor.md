...
Update-MgFinancialCompanyPurchaseInvoiceVendor -CompanyId <String> -PurchaseInvoiceId <String>
 ...
 [-AddressState <String>] [-AddressStreet <String>] [-Balance <Decimal>] [-Blocked <String>] [-Code <String>]
...
```
Update-MgFinancialCompanyPurchaseInvoiceVendor -InputObject <IFinancialsIdentity> [-AddressCity <String>]
