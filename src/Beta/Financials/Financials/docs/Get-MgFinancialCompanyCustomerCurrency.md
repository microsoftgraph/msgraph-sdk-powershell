...
### Get (Default)
```
Get-MgFinancialCompanyCustomerCurrency -CompanyId <String> -CustomerId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyCustomerCurrency -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
