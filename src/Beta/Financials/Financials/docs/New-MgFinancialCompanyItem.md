...
```
New-MgFinancialCompanyItem -CompanyId <String> [-BaseUnitOfMeasureId <String>] [-Blocked] [-Code <String>]
...
```
New-MgFinancialCompanyItem -InputObject <IFinancialsIdentity> [-BaseUnitOfMeasureId <String>] [-Blocked]
