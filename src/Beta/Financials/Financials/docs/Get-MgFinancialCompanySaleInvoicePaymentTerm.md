...
### Get (Default)
```
Get-MgFinancialCompanySaleInvoicePaymentTerm -CompanyId <String> -SalesInvoiceId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoicePaymentTerm -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
