...
### Get (Default)
```
Get-MgFinancialCompanySaleOrderPaymentTerm -CompanyId <String> -SalesOrderId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderPaymentTerm -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
