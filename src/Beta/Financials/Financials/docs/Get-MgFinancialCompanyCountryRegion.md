...
### List (Default)
```
Get-MgFinancialCompanyCountryRegion -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyCountryRegion -CompanyId <String> -CountryRegionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyCountryRegion -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### -CountryRegionId
key: countryRegion-id of countryRegion
