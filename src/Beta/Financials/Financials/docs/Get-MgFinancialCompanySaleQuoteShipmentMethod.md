...
### Get (Default)
```
Get-MgFinancialCompanySaleQuoteShipmentMethod -CompanyId <String> -SalesQuoteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleQuoteShipmentMethod -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
