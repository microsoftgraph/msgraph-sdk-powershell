...
### Get (Default)
```
Get-MgFinancialCompanyJournalLineAccount -CompanyId <String> -JournalLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyJournalLineAccount -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
