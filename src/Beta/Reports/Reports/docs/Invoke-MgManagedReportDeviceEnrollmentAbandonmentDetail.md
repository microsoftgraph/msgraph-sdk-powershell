...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/invoke-mgmanagedreportdeviceenrollmentabandonmentdetail
schema: 2.0.0
---
...
### Managed (Default)
```
Invoke-MgManagedReportDeviceEnrollmentAbandonmentDetail -Filter <String> -Skip <Int32> -SkipToken <String>
 -Top <Int32> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### ManagedViaIdentity
```
Invoke-MgManagedReportDeviceEnrollmentAbandonmentDetail -InputObject <IReportsIdentity> -OutFile <String>
