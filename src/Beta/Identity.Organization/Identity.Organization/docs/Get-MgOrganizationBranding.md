...
### List (Default)
```
Get-MgOrganizationBranding -OrganizationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgOrganizationBranding -OrganizationalBrandingId <String> -OrganizationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgOrganizationBranding -InputObject <IIdentityOrganizationIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
