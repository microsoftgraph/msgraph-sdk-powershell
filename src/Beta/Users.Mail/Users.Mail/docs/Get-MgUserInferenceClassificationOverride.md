...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mguserinferenceclassificationoverride
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserInferenceClassificationOverride -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserInferenceClassificationOverride -InputObject <IUsersMailIdentity> [-Expand <String[]>]
