...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/new-mgusermailfolder
schema: 2.0.0
---
...
```
New-MgUserMailFolder -UserId <String> [-ChildFolderCount <Int32>]
...
### CreateViaIdentity
```
New-MgUserMailFolder -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMailFolder> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserMailFolder -InputObject <IUsersMailIdentity> [-ChildFolderCount <Int32>]
 [-ChildFolders <IMicrosoftGraphMailFolder[]>] [-DisplayName <String>] [-Id <String>]
 [-MessageRules <IMicrosoftGraphMessageRule[]>] [-Messages <IMicrosoftGraphMessage[]>]
 [-MultiValueExtendedProperties <IMicrosoftGraphMultiValueLegacyExtendedProperty[]>]
 [-ParentFolderId <String>]
