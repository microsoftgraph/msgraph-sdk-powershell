...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermessagesinglevalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
