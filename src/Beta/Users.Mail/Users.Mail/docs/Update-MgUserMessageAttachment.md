...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/update-mgusermessageattachment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserMessageAttachment -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphAttachment>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserMessageAttachment -InputObject <IUsersMailIdentity> [-ContentType <String>] [-Id <String>]
