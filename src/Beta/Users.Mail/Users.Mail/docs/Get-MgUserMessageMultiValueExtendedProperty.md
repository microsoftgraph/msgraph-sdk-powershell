...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermessagemultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMessageMultiValueExtendedProperty -MessageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
