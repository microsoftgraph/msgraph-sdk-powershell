...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMailFolderMultiValueExtendedProperty -MailFolderId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserMailFolderMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
