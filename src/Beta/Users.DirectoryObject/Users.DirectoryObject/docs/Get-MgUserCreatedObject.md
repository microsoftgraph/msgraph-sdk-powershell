...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.directoryobject/get-mgusercreatedobject
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserCreatedObject -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserCreatedObject -DirectoryObjectId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCreatedObject -InputObject <IUsersDirectoryObjectIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
