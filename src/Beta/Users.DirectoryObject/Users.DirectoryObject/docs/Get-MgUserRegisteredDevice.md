...
### List (Default)
```
Get-MgUserRegisteredDevice -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserRegisteredDevice -DirectoryObjectId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserRegisteredDevice -InputObject <IUsersDirectoryObjectIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
