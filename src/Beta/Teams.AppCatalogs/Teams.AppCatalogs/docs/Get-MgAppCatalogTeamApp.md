...
### List (Default)
```
Get-MgAppCatalogTeamApp [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgAppCatalogTeamApp -TeamsAppId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAppCatalogTeamApp -InputObject <ITeamsAppCatalogsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
