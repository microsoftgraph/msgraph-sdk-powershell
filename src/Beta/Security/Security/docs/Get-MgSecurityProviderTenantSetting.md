...
### List (Default)
```
Get-MgSecurityProviderTenantSetting [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSecurityProviderTenantSetting -ProviderTenantSettingId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityProviderTenantSetting -InputObject <ISecurityIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
