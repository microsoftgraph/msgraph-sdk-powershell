...
### List (Default)
```
Get-MgSecurityAction [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSecurityAction -SecurityActionId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityAction -InputObject <ISecurityIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
