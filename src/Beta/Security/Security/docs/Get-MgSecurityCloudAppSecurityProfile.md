...
### List (Default)
```
Get-MgSecurityCloudAppSecurityProfile [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSecurityCloudAppSecurityProfile -CloudAppSecurityProfileId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityCloudAppSecurityProfile -InputObject <ISecurityIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
