# How-To
This document describes how to develop for `Mg.Education`.

## Building `Mg.Education`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Education` into the session.
