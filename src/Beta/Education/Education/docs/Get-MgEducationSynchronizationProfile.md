...
### List (Default)
```
Get-MgEducationSynchronizationProfile [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgEducationSynchronizationProfile -EducationSynchronizationProfileId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSynchronizationProfile -InputObject <IEducationIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
