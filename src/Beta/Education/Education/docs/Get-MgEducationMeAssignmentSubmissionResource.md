...
```
Get-MgEducationMeAssignmentSubmissionResource -EducationAssignmentId <String> -EducationSubmissionId <String>
 -EducationSubmissionResourceId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationMeAssignmentSubmissionResource -InputObject <IEducationIdentity> [-Expand <String[]>]
