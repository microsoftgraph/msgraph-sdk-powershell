...
### List (Default)
```
Get-MgEducationMeAssignmentCategory -EducationAssignmentId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgEducationMeAssignmentCategory -InputObject <IEducationIdentity> [-Expand <String[]>]
