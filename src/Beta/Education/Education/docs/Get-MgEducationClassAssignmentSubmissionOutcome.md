...
```
Get-MgEducationClassAssignmentSubmissionOutcome -EducationAssignmentId <String> -EducationClassId <String>
 -EducationOutcomeId <String> -EducationSubmissionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationClassAssignmentSubmissionOutcome -InputObject <IEducationIdentity> [-Expand <String[]>]
...
### -EducationOutcomeId
key: educationOutcome-id of educationOutcome
