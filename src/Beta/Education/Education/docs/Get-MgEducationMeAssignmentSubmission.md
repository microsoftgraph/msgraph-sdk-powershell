...
### List (Default)
```
Get-MgEducationMeAssignmentSubmission -EducationAssignmentId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgEducationMeAssignmentSubmission -InputObject <IEducationIdentity> [-Expand <String[]>]
