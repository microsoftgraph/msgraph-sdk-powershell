...
### List (Default)
```
Get-MgEducationUserTaughtClass -EducationUserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgEducationUserTaughtClass -EducationClassId <String> -EducationUserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationUserTaughtClass -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
