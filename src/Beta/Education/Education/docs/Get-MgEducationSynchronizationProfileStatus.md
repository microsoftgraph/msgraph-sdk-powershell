...
### Get (Default)
```
Get-MgEducationSynchronizationProfileStatus -EducationSynchronizationProfileId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSynchronizationProfileStatus -InputObject <IEducationIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
