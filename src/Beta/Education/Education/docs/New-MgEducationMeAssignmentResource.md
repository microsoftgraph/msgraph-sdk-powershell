...
```
New-MgEducationMeAssignmentResource -EducationAssignmentId <String> [-DistributeForStudentWork] [-Id <String>]
...
```
New-MgEducationMeAssignmentResource -InputObject <IEducationIdentity> [-DistributeForStudentWork]
