...
### List1 (Default)
```
Get-MgEducationClassAssignmentCategory -EducationClassId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgEducationClassAssignmentCategory -InputObject <IEducationIdentity> [-Expand <String[]>]
