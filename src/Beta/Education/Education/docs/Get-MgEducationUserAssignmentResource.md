...
### List (Default)
```
Get-MgEducationUserAssignmentResource -EducationAssignmentId <String> -EducationUserId <String> [-Count]
...
Get-MgEducationUserAssignmentResource -EducationAssignmentId <String> -EducationAssignmentResourceId <String>
 -EducationUserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationUserAssignmentResource -InputObject <IEducationIdentity> [-Expand <String[]>]
