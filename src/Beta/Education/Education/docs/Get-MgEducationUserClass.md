...
### List (Default)
```
Get-MgEducationUserClass -EducationUserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgEducationUserClass -EducationClassId <String> -EducationUserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationUserClass -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
