...
New-MgEducationUserAssignmentResource -EducationAssignmentId <String> -EducationUserId <String>
 [-DistributeForStudentWork] [-Id <String>] [-ResourceCreatedBy <IMicrosoftGraphIdentitySet>]
...
```
New-MgEducationUserAssignmentResource -InputObject <IEducationIdentity> [-DistributeForStudentWork]
