...
```
New-MgEducationMeAssignmentCategory -EducationAssignmentId <String> [-DisplayName <String>] [-Id <String>]
...
```
New-MgEducationMeAssignmentCategory -InputObject <IEducationIdentity> [-DisplayName <String>] [-Id <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
