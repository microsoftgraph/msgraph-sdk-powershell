...
### List (Default)
```
Get-MgEducationSchoolClass -EducationSchoolId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgEducationSchoolClass -EducationClassId <String> -EducationSchoolId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSchoolClass -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
