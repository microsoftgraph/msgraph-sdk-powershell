...
Update-MgEducationClassAssignmentSubmission -EducationAssignmentId <String> -EducationClassId <String>
 -EducationSubmissionId <String> [-Id <String>] [-Outcomes <IMicrosoftGraphEducationOutcome[]>]
...
```
Update-MgEducationClassAssignmentSubmission -InputObject <IEducationIdentity> [-Id <String>]
