...
### List (Default)
```
Get-MgEducationSchool [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgEducationSchool -EducationSchoolId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSchool -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
