...
Get-MgEducationMeAssignmentSubmissionOutcome -EducationAssignmentId <String> -EducationOutcomeId <String>
 -EducationSubmissionId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationMeAssignmentSubmissionOutcome -InputObject <IEducationIdentity> [-Expand <String[]>]
