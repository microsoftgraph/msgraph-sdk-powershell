...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/update-mgteamprimarychannelmessagehostedcontent
schema: 2.0.0
---
...
Update-MgTeamPrimaryChannelMessageHostedContent -ChatMessageHostedContentId <String> -ChatMessageId <String>
 -TeamId <String> [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgTeamPrimaryChannelMessageHostedContent -ChatMessageHostedContentId <String> -ChatMessageId <String>
 -TeamId <String> -BodyParameter <IMicrosoftGraphChatMessageHostedContent> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgTeamPrimaryChannelMessageHostedContent -InputObject <ITeamsTeamIdentity>
...
```
Update-MgTeamPrimaryChannelMessageHostedContent -InputObject <ITeamsTeamIdentity> [-Id <String>] [-PassThru]
