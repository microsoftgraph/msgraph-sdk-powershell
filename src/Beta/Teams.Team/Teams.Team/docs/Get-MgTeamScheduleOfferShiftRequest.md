...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamscheduleoffershiftrequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamScheduleOfferShiftRequest -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTeamScheduleOfferShiftRequest -OfferShiftRequestId <String> -TeamId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleOfferShiftRequest -InputObject <ITeamsTeamIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### -OfferShiftRequestId
key: offerShiftRequest-id of offerShiftRequest
