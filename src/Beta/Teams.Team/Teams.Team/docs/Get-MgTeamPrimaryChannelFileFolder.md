...
### Get (Default)
```
Get-MgTeamPrimaryChannelFileFolder -TeamId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamPrimaryChannelFileFolder -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
