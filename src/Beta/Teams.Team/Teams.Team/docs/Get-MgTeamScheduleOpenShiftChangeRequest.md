...
### List (Default)
```
Get-MgTeamScheduleOpenShiftChangeRequest -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgTeamScheduleOpenShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-Expand <String[]>]
