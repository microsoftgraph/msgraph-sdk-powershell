...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduleopenshiftchangerequest
schema: 2.0.0
---
...
```
New-MgTeamScheduleOpenShiftChangeRequest -TeamId <String> [-AssignedTo <String>] [-CreatedDateTime <DateTime>]
...
### CreateViaIdentity
```
New-MgTeamScheduleOpenShiftChangeRequest -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphOpenShiftChangeRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgTeamScheduleOpenShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-AssignedTo <String>]
