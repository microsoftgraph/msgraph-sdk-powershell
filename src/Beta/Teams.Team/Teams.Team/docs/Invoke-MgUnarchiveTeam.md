...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/invoke-mgunarchiveteam
schema: 2.0.0
---
...
```
Invoke-MgUnarchiveTeam -InputObject <ITeamsTeamIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
