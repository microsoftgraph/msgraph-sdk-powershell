...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamchannelmessagedelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgTeamChannelMessageDelta -InputObject <ITeamsTeamIdentity> [<CommonParameters>]
```
