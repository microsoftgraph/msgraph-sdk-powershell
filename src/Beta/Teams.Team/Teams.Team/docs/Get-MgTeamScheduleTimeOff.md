...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamscheduletimeoff
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamScheduleTimeOff -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTeamScheduleTimeOff -TeamId <String> -TimeOffId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleTimeOff -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
