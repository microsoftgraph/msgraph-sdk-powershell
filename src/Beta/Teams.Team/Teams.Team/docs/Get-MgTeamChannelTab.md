...
### List (Default)
```
Get-MgTeamChannelTab -ChannelId <String> -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTeamChannelTab -ChannelId <String> -TeamId <String> -TeamsTabId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamChannelTab -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
