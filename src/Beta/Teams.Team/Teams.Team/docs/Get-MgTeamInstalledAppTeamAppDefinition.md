...
### Get (Default)
```
Get-MgTeamInstalledAppTeamAppDefinition -TeamId <String> -TeamsAppInstallationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamInstalledAppTeamAppDefinition -InputObject <ITeamsTeamIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
