...
### List (Default)
```
Get-MgTeamScheduleSwapShiftChangeRequest -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-Expand <String[]>]
