...
### List (Default)
```
Get-MgTeamPrimaryChannelMessage -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTeamPrimaryChannelMessage -ChatMessageId <String> -TeamId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamPrimaryChannelMessage -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
