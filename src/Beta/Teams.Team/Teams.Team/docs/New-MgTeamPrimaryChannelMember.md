...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamprimarychannelmember
schema: 2.0.0
---
...
```
New-MgTeamPrimaryChannelMember -TeamId <String> [-DisplayName <String>] [-Id <String>] [-Roles <String[]>]
...
### CreateViaIdentity
```
New-MgTeamPrimaryChannelMember -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphConversationMember> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgTeamPrimaryChannelMember -InputObject <ITeamsTeamIdentity> [-DisplayName <String>] [-Id <String>]
