...
### List (Default)
```
Get-MgTeamScheduleSchedulingGroup -TeamId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTeamScheduleSchedulingGroup -SchedulingGroupId <String> -TeamId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleSchedulingGroup -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
