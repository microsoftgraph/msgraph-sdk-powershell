...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupParentSectionGroup -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
