...
### Get (Default)
```
Get-MgGroupOnenotePageParentSection -GroupId <String> -OnenotePageId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenotePageParentSection -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
