...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SectionGroupId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphOnenoteSection>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
