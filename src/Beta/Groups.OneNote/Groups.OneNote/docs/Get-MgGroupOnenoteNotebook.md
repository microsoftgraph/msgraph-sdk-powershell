...
### List (Default)
```
Get-MgGroupOnenoteNotebook -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupOnenoteNotebook -GroupId <String> -NotebookId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteNotebook -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
