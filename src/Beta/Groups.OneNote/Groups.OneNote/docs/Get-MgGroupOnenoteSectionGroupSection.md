...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenoteSectionGroupSection -GroupId <String> -SectionGroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupSection -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
