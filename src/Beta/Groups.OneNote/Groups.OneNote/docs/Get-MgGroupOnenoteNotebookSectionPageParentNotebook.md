...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
