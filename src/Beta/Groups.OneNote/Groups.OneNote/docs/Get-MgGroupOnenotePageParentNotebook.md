...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenotePageParentNotebook -GroupId <String> -OnenotePageId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenotePageParentNotebook -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
