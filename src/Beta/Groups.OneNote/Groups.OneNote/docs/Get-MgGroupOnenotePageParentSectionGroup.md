...
### Get (Default)
```
Get-MgGroupOnenotePageParentSectionGroup -GroupId <String> -OnenotePageId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupOnenotePageParentSectionGroup -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
