...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenoteSectionGroup -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupOnenoteSectionGroup -GroupId <String> -SectionGroupId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroup -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgGroupOnenoteSectionGroup -GroupId <String> -SectionGroupId <String> [-Count] [-Expand <String[]>]
