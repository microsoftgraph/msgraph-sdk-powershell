...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotepageparentnotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgGroupOnenotePageParentNotebookSectionParentSectionGroupSection -GroupId <String> -OnenotePageId <String>
...
```
New-MgGroupOnenotePageParentNotebookSectionParentSectionGroupSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupOnenotePageParentNotebookSectionParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
