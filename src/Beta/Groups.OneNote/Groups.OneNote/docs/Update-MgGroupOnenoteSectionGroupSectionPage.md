...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupsectionpage
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupSectionPage -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupSectionPage -InputObject <IGroupsOneNoteIdentity>
