...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionPageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
...
```
New-MgGroupOnenoteSectionPageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgGroupOnenoteSectionPageParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
