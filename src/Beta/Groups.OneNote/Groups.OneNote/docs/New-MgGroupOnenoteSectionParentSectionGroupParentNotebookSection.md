...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectionparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
