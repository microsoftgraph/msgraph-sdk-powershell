...
```
Get-MgGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
 -OnenotePageId1 <String> -OnenoteSectionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenotePageParentNotebookSectionPage -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
