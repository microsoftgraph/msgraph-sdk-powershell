...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
...
```
Get-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -OnenoteSectionId1 <String> -SectionGroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
