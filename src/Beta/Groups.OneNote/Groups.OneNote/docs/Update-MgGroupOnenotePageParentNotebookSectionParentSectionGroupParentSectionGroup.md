...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentnotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <IGroupsOneNoteIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
