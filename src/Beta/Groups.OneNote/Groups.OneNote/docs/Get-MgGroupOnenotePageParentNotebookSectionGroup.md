...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenotePageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String> [-Count]
...
### Get
```
Get-MgGroupOnenotePageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenotePageParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
