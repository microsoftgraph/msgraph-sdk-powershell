...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroup -GroupId <String> -NotebookId <String>
...
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroup -GroupId <String> -NotebookId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
