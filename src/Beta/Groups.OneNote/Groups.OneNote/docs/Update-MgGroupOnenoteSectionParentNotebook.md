...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentNotebook -GroupId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
