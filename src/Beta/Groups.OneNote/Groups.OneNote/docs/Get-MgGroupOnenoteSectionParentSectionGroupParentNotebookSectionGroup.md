...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
