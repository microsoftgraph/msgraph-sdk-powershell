...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionpageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroupParentSectionGroup -GroupId <String>
