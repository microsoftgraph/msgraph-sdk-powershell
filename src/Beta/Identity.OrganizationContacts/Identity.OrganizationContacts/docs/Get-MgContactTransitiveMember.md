...
### List (Default)
```
Get-MgContactTransitiveMember -OrgContactId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgContactTransitiveMember -DirectoryObjectId <String> -OrgContactId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgContactTransitiveMember -InputObject <IIdentityOrganizationContactsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
