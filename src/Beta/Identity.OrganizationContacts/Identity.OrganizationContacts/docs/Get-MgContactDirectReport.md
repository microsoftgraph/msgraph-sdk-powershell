...
### List (Default)
```
Get-MgContactDirectReport -OrgContactId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgContactDirectReport -DirectoryObjectId <String> -OrgContactId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgContactDirectReport -InputObject <IIdentityOrganizationContactsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
