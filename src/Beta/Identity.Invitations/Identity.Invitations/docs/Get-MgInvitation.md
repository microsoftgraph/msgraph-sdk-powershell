...
### List (Default)
```
Get-MgInvitation [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgInvitation -InvitationId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgInvitation -InputObject <IIdentityInvitationsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
