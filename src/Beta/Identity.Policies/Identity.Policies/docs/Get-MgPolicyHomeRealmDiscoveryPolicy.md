...
### List (Default)
```
Get-MgPolicyHomeRealmDiscoveryPolicy [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgPolicyHomeRealmDiscoveryPolicy -HomeRealmDiscoveryPolicyId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPolicyHomeRealmDiscoveryPolicy -InputObject <IIdentityPoliciesIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
