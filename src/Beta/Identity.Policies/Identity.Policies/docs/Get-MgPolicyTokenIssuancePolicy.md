...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.policies/get-mgpolicytokenissuancepolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgPolicyTokenIssuancePolicy [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgPolicyTokenIssuancePolicy -TokenIssuancePolicyId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPolicyTokenIssuancePolicy -InputObject <IIdentityPoliciesIdentity> [-Expand <String[]>]
