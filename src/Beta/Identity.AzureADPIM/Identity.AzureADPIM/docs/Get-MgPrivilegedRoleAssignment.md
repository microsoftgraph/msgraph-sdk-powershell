...
### List (Default)
```
Get-MgPrivilegedRoleAssignment -PrivilegedRoleId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgPrivilegedRoleAssignment -InputObject <IIdentityAzureAdpimIdentity> [-Expand <String[]>]
