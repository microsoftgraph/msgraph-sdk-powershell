...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.azureadpim/get-mgprivilegedroleassignmentroleinfo
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgPrivilegedRoleAssignmentRoleInfo -PrivilegedRoleAssignmentId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrivilegedRoleAssignmentRoleInfo -InputObject <IIdentityAzureAdpimIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
