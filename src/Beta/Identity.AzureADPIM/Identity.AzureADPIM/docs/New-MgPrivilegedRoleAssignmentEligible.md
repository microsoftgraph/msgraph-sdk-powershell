...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.azureadpim/new-mgprivilegedroleassignmenteligible
schema: 2.0.0
---
...
### MakeViaIdentity
```
New-MgPrivilegedRoleAssignmentEligible -InputObject <IIdentityAzureAdpimIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
