...
### List (Default)
```
Get-MgGroupPlannerPlan -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupPlannerPlan -GroupId <String> -PlannerPlanId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupPlannerPlan -InputObject <IGroupsPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
