...
Get-MgGroupPlannerPlanBucketTaskBoardFormat -GroupId <String> -PlannerBucketId <String>
 -PlannerPlanId <String> -PlannerTaskId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupPlannerPlanBucketTaskBoardFormat -InputObject <IGroupsPlannerIdentity> [-Expand <String[]>]
