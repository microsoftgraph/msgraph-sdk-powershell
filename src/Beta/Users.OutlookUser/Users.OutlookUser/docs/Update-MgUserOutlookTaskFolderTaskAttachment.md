...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/update-mguseroutlooktaskfoldertaskattachment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserOutlookTaskFolderTaskAttachment -InputObject <IUsersOutlookUserIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserOutlookTaskFolderTaskAttachment -InputObject <IUsersOutlookUserIdentity> [-ContentType <String>]
