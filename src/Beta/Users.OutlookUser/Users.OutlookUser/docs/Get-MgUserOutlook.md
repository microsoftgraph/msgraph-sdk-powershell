...
### Get (Default)
```
Get-MgUserOutlook -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOutlook -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
