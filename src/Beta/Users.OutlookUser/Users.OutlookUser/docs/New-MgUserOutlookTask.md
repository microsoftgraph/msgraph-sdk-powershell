...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/new-mguseroutlooktask
schema: 2.0.0
---
...
```
New-MgUserOutlookTask -UserId <String> [-AssignedTo <String>] [-Attachments <IMicrosoftGraphAttachment[]>]
...
### CreateViaIdentity
```
New-MgUserOutlookTask -InputObject <IUsersOutlookUserIdentity> -BodyParameter <IMicrosoftGraphOutlookTask>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOutlookTask -InputObject <IUsersOutlookUserIdentity> [-AssignedTo <String>]
