...
### List (Default)
```
Get-MgUserOutlookMasterCategory -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserOutlookMasterCategory -OutlookCategoryId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOutlookMasterCategory -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
