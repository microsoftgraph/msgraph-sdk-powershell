...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/get-mguseroutlooktaskgrouptaskfoldertask
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOutlookTaskGroupTaskFolderTask -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>]
