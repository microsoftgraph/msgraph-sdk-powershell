...
### List (Default)
```
Get-MgPlace [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgPlace -PlaceId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlace -InputObject <IPlacesIdentity> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
