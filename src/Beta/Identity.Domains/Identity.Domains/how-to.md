# How-To
This document describes how to develop for `Microsoft.Graph.Identity.Domains`.

## Building `Microsoft.Graph.Identity.Domains`
...
## Testing `Microsoft.Graph.Identity.Domains`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Identity.Domains` into the session.
