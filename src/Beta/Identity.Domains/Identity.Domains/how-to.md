# How-To
This document describes how to develop for `Mg.Identity.Domains`.

## Building `Mg.Identity.Domains`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Identity.Domains` into the session.
