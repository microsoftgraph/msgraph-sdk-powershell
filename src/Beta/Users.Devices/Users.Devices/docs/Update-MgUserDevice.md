...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.devices/update-mguserdevice
schema: 2.0.0
---
...
```
Update-MgUserDevice -DeviceId <String> -UserId <String> [-AccountEnabled]
...
### UpdateViaIdentity
```
Update-MgUserDevice -InputObject <IUsersDevicesIdentity> -BodyParameter <IMicrosoftGraphDevice> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserDevice -InputObject <IUsersDevicesIdentity> [-DeviceId <String>] [-AccountEnabled]
 [-AlternativeSecurityIds <IMicrosoftGraphAlternativeSecurityId[]>]
 [-ApproximateLastSignInDateTime <DateTime>] [-Commands <IMicrosoftGraphCommand[]>]
