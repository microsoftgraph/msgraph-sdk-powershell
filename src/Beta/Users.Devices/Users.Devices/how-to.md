# How-To
This document describes how to develop for `Microsoft.Graph.Users.Devices`.

## Building `Microsoft.Graph.Users.Devices`
...
## Testing `Microsoft.Graph.Users.Devices`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Users.Devices` into the session.
