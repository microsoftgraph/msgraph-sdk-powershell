# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Users.Devices`.

## Building `Microsoft.Graph.Beta.Users.Devices`
...
## Testing `Microsoft.Graph.Beta.Users.Devices`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Users.Devices` into the session.
