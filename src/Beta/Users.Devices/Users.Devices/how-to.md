# How-To
This document describes how to develop for `Mg.Users.Devices`.

## Building `Mg.Users.Devices`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Users.Devices` into the session.
