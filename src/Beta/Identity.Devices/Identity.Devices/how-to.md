# How-To
This document describes how to develop for `Mg.Identity.Devices`.

## Building `Mg.Identity.Devices`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Identity.Devices` into the session.
