...
### List (Default)
```
Get-MgUserJoinedGroup -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgUserJoinedGroup -GroupId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserJoinedGroup -InputObject <IUsersGroupsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
