# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Files.Drives`.

## Building `Microsoft.Graph.Beta.Files.Drives`
...
## Testing `Microsoft.Graph.Beta.Files.Drives`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Files.Drives` into the session.
