# How-To
This document describes how to develop for `Mg.Files.Drives`.

## Building `Mg.Files.Drives`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Files.Drives` into the session.
