# How-To
This document describes how to develop for `Microsoft.Graph.Files.Drives`.

## Building `Microsoft.Graph.Files.Drives`
...
## Testing `Microsoft.Graph.Files.Drives`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Files.Drives` into the session.
