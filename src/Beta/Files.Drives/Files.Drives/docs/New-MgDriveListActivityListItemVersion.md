...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/new-mgdrivelistactivitylistitemversion
schema: 2.0.0
---

# New-MgDriveListActivityListItemVersion
...
```
New-MgDriveListActivityListItemVersion -ItemActivityOldId <String> [-FieldId <String>] [-Id <String>]
...
### Create
```
New-MgDriveListActivityListItemVersion -DriveId <String> -ItemActivityOldId <String>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create1
```
New-MgDriveListActivityListItemVersion -ItemActivityOldId <String>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateExpanded
```
New-MgDriveListActivityListItemVersion -DriveId <String> -ItemActivityOldId <String> [-FieldId <String>]
...
### CreateViaIdentity
```
New-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-FieldId <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-PublicationLevel <String>] [-PublicationVersionId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
