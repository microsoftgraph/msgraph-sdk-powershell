...
### Get1 (Default)
```
Get-MgDriveListItemActivityListItem -ItemActivityOldId <String> -ListItemId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgDriveListItemActivityListItem -InputObject <IFilesDrivesIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
