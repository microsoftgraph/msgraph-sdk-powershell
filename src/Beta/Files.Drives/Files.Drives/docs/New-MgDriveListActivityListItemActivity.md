...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/new-mgdrivelistactivitylistitemactivity
schema: 2.0.0
---
...
```
New-MgDriveListActivityListItemActivity -ItemActivityOldId <String>
...
### Create
```
New-MgDriveListActivityListItemActivity -DriveId <String> -ItemActivityOldId <String>
...
### CreateViaIdentity
```
New-MgDriveListActivityListItemActivity -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
