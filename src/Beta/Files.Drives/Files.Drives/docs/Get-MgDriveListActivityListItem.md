...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/get-mgdrivelistactivitylistitem
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgDriveListActivityListItem -ItemActivityOldId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### Get
```
Get-MgDriveListActivityListItem -DriveId <String> -ItemActivityOldId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListActivityListItem -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
