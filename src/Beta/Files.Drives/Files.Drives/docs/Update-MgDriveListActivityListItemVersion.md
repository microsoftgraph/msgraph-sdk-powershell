...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/update-mgdrivelistactivitylistitemversion
schema: 2.0.0
---
...
```
Update-MgDriveListActivityListItemVersion -ItemActivityOldId <String> -ListItemVersionId <String>
...
### Update
```
Update-MgDriveListActivityListItemVersion -DriveId <String> -ItemActivityOldId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-FieldId <String>]
