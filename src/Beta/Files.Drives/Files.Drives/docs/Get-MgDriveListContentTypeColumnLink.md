...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/get-mgdrivelistcontenttypecolumnlink
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDriveListContentTypeColumnLink -ContentTypeId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgDriveListContentTypeColumnLink -ColumnLinkId <String> -ContentTypeId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListContentTypeColumnLink -InputObject <IFilesDrivesIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List
```
Get-MgDriveListContentTypeColumnLink -ContentTypeId <String> -DriveId <String> [-Count] [-Expand <String[]>]
