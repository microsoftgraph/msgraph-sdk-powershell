...
### Get (Default)
```
Get-MgUserTeamworkInstalledAppTeamApp -TeamsAppInstallationId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserTeamworkInstalledAppTeamApp -InputObject <ITeamsTeamworkIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
