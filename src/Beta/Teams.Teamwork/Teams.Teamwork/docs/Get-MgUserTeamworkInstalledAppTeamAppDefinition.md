...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.teamwork/get-mguserteamworkinstalledappteamappdefinition
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserTeamworkInstalledAppTeamAppDefinition -TeamsAppInstallationId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserTeamworkInstalledAppTeamAppDefinition -InputObject <ITeamsTeamworkIdentity> [-Expand <String[]>]
