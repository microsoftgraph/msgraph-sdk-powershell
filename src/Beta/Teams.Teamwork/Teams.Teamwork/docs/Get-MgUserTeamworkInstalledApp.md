...
### List (Default)
```
Get-MgUserTeamworkInstalledApp -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserTeamworkInstalledApp -TeamsAppInstallationId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserTeamworkInstalledApp -InputObject <ITeamsTeamworkIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
