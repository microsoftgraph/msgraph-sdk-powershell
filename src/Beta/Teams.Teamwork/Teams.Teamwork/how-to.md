# How-To
This document describes how to develop for `Mg.Teams.Teamwork`.

## Building `Mg.Teams.Teamwork`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Teams.Teamwork` into the session.
