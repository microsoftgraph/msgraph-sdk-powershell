...
### List (Default)
```
Get-MgGroupEndpoint -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgGroupEndpoint -EndpointId <String> -GroupId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEndpoint -InputObject <IGroupsEndpointIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
