# How-To
This document describes how to develop for `Mg.Groups.Endpoint`.

## Building `Mg.Groups.Endpoint`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Groups.Endpoint` into the session.
