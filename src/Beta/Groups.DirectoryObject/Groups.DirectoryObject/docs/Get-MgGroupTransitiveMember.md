...
### List1 (Default)
```
Get-MgGroupTransitiveMember -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgGroupTransitiveMember -DirectoryObjectId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupTransitiveMember -InputObject <IGroupsDirectoryObjectIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
