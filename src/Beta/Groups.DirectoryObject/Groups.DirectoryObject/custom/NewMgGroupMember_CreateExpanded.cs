namespace Microsoft.Graph.PowerShell.Cmdlets
{
        ...
        Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewMgGroupMember_CreateExpanded" /> cmdlet class.
        /// </summary>
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateGroupMember(GroupId, BodyParameterBody, onCreated, onDefault, this, Pipeline);
