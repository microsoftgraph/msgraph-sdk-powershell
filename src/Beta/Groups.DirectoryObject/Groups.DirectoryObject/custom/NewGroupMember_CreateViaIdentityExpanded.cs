namespace Microsoft.Graph.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"GroupMember_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [Generated]
    public partial class NewGroupMember_CreateViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewGroupMember_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewGroupMember_CreateViaIdentityExpanded()
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateGroupMember(InputObject.GroupId ?? null, BodyParameterBody, onCreated, onDefault, this, Pipeline);
