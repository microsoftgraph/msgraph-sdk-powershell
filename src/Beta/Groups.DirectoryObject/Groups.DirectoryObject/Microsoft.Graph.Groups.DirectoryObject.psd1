#
# Module manifest for module 'Microsoft.Graph.Groups.DirectoryObject'
#
...
FormatsToProcess = './Microsoft.Graph.Groups.DirectoryObject.format.ps1xml'
...
CmdletsToExport = 'Get-MgGroupAcceptedSender', 'Get-MgGroupCreatedOnBehalf', 
