...
Get-MgOnPremisPublishingProfileAgentGroup -OnPremisesAgentGroupId <String> -OnPremisesAgentGroupId1 <String>
 -OnPremisesAgentId <String> -OnPremisesPublishingProfileId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
Get-MgOnPremisPublishingProfileAgentGroup -OnPremisesAgentGroupId <String> -OnPremisesAgentId <String>
 -OnPremisesPublishingProfileId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
...
```
Get-MgOnPremisPublishingProfileAgentGroup -OnPremisesAgentGroupId <String> -OnPremisesAgentId <String>
 -OnPremisesPublishingProfileId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
