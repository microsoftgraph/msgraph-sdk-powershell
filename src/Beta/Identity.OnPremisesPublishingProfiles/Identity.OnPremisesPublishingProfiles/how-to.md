# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`.

## Building `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`
...
## Testing `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`
...
## Packing `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`
...
There are multiple scripts created for performing different actions for developing `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`.
- `build-module.ps1`
  ...
  - **Parameters**: [`Switch` parameters]
    - `-Run`: After building, creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles`.
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Identity.OnPremisesPublishingProfiles` into the session.
