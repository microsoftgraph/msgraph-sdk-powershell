# How-To
This document describes how to develop for `Microsoft.Graph.Identity.OnPremisesPublishingProfiles`.

## Building `Microsoft.Graph.Identity.OnPremisesPublishingProfiles`
...
## Testing `Microsoft.Graph.Identity.OnPremisesPublishingProfiles`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Identity.OnPremisesPublishingProfiles` into the session.
