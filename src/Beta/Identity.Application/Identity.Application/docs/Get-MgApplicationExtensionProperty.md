...
### List (Default)
```
Get-MgApplicationExtensionProperty -ApplicationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgApplicationExtensionProperty -ApplicationId <String> -ExtensionPropertyId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationExtensionProperty -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
