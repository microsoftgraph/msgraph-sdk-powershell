...
### Get (Default)
```
Get-MgApplicationCreatedOnBehalf -ApplicationId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationCreatedOnBehalf -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
