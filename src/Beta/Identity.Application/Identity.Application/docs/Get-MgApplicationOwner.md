...
### List (Default)
```
Get-MgApplicationOwner -ApplicationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgApplicationOwner -ApplicationId <String> -DirectoryObjectId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationOwner -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
