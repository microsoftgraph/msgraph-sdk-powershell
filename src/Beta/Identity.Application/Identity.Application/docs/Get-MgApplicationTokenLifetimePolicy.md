...
### List (Default)
```
Get-MgApplicationTokenLifetimePolicy -ApplicationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgApplicationTokenLifetimePolicy -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
