...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/start-mgapplicationsynchronizationjob
schema: 2.0.0
---
...
### StartViaIdentity
```
Start-MgApplicationSynchronizationJob -InputObject <IIdentityApplicationIdentity> [-PassThru] [-Confirm]
