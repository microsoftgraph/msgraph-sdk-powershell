...
### List (Default)
```
Get-MgApplicationTemplate [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgApplicationTemplate -ApplicationTemplateId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationTemplate -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
