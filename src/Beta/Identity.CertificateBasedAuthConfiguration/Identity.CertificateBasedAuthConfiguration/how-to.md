# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`.

## Building `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`
...
## Testing `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`
...
## Packing `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`
...
There are multiple scripts created for performing different actions for developing `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`.
- `build-module.ps1`
  ...
  - **Parameters**: [`Switch` parameters]
    - `-Run`: After building, creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration`.
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Identity.CertificateBasedAuthConfiguration` into the session.
