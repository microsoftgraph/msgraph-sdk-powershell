# How-To
This document describes how to develop for `Microsoft.Graph.Identity.CertificateBasedAuthConfiguration`.

## Building `Microsoft.Graph.Identity.CertificateBasedAuthConfiguration`
...
## Testing `Microsoft.Graph.Identity.CertificateBasedAuthConfiguration`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Identity.CertificateBasedAuthConfiguration` into the session.
