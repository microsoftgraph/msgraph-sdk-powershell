...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.onlinemeetings/get-mguseronlinemeeting
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnlineMeeting -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserOnlineMeeting -OnlineMeetingId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnlineMeeting -InputObject <IOnlineMeetingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
