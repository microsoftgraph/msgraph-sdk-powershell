...
```
Get-MgUserCalendarGroupCalendarEventExtension -CalendarGroupId <String> -CalendarId <String> -EventId <String>
 -ExtensionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarEventExtension -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
