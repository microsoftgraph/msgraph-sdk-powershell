...
### List1 (Default)
```
Get-MgUserCalendarPermission -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgUserCalendarPermission -CalendarPermissionId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCalendarPermission -InputObject <IUsersCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgUserCalendarPermission -CalendarId <String> -UserId <String> [-Count] [-Expand <String[]>]
