...
### Get (Default)
```
Get-MgUserCalendarViewCalendar -EventId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### Get1
```
Get-MgUserCalendarViewCalendar -CalendarId <String> -EventId <String> -UserId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserCalendarViewCalendar -InputObject <IUsersCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
