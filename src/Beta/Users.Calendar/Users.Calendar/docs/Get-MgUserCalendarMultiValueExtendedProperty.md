...
### List1 (Default)
```
Get-MgUserCalendarMultiValueExtendedProperty -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserCalendarMultiValueExtendedProperty -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
