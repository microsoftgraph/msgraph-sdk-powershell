...
### List1 (Default)
```
Get-MgUserCalendarEventAttachment -EventId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserCalendarEventAttachment -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
