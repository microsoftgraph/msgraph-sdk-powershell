$TestRecordingFile = Join-Path $PSScriptRoot 'New-UserCalendarViewSingleValueExtendedProperty.Recording.json'
...
Describe 'New-UserCalendarViewSingleValueExtendedProperty' {
