$TestRecordingFile = Join-Path $PSScriptRoot 'Update-UserCalendarViewMultiValueExtendedProperty.Recording.json'
...
Describe 'Update-UserCalendarViewMultiValueExtendedProperty' {
