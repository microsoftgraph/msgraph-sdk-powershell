...
### List (Default)
```
Get-MgGroupCalendarMultiValueExtendedProperty -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
