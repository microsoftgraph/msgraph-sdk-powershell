...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendareventsinglevalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarEventSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### Get
```
Get-MgGroupCalendarEventSingleValueExtendedProperty -EventId <String> -GroupId <String>
 -SingleValueLegacyExtendedPropertyId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
