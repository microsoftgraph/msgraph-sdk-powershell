...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarviewcalendarevent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarViewCalendarEvent -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgGroupCalendarViewCalendarEvent -EventId <String> -EventId1 <String> -GroupId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarViewCalendarEvent -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
