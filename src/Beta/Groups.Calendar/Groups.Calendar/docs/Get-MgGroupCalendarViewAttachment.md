...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarviewattachment
schema: 2.0.0
---

# Get-MgGroupCalendarViewAttachment
...
### List (Default)
```
Get-MgGroupCalendarViewAttachment -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgGroupCalendarViewAttachment -AttachmentId <String> -EventId <String> -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupCalendarViewAttachment -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
