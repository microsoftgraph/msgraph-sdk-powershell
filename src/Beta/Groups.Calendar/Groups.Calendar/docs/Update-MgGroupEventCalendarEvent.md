...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupeventcalendarevent
schema: 2.0.0
---

# Update-MgGroupEventCalendarEvent
...
```
Update-MgGroupEventCalendarEvent -EventId <String> -EventId1 <String> -GroupId <String>
 ...
 [-CalendarHexColor <String>] [-CalendarId <String>] [-CalendarIsDefaultCalendar] [-CalendarIsRemovable]
 [-CalendarIsShared] [-CalendarIsSharedWithMe] [-CalendarIsTallyingResponses]
...
### UpdateViaIdentity
```
Update-MgGroupEventCalendarEvent -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupEventCalendarEvent -InputObject <IGroupsCalendarIdentity> [-AddressCity <String>]
