...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventattachment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupEventAttachment -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgGroupEventAttachment -AttachmentId <String> -EventId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventAttachment -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
