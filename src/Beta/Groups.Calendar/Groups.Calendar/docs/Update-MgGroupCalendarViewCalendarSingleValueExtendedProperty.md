...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarviewcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgGroupCalendarViewCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupCalendarViewCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
