...
### List (Default)
```
Get-MgGroupCalendarEventAttachment -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarEventAttachment -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
