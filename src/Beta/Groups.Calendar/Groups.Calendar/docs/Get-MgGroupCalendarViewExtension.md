...
### List (Default)
```
Get-MgGroupCalendarViewExtension -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarViewExtension -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
