...
### Update
```
Update-MgGroupCalendarView -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent>
...
### UpdateViaIdentity
```
Update-MgGroupCalendarView -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
