...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarviewcalendarpermission
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarViewCalendarPermission -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgGroupCalendarViewCalendarPermission -CalendarPermissionId <String> -EventId <String> -GroupId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarViewCalendarPermission -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
