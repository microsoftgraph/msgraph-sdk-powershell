...
### Get (Default)
```
Get-MgGroupCalendarViewCalendar -EventId <String> -GroupId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgGroupCalendarViewCalendar -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
