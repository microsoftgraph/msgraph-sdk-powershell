...
### List (Default)
```
Get-MgCommunicationCallOperation -CallId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgCommunicationCallOperation -CallId <String> -CommsOperationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgCommunicationCallOperation -InputObject <ICloudCommunicationsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
