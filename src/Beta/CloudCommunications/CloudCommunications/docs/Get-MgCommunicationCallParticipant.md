...
### List (Default)
```
Get-MgCommunicationCallParticipant -CallId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgCommunicationCallParticipant -CallId <String> -ParticipantId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgCommunicationCallParticipant -InputObject <ICloudCommunicationsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
