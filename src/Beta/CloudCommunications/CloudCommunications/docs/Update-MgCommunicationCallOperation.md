...
```
Update-MgCommunicationCallOperation -CallId <String> -CommsOperationId <String> [-ClientContext <String>]
...
```
Update-MgCommunicationCallOperation -InputObject <ICloudCommunicationsIdentity> [-ClientContext <String>]
 [-Id <String>] [-ResultInfoCode <Int32>] [-ResultInfoMessage <String>] [-ResultInfoSubcode <Int32>]
 [-Status <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -CommsOperationId
key: commsOperation-id of commsOperation
