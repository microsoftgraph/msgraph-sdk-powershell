...
### Get (Default)
```
Get-MgUserAnalytic -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserAnalytic -InputObject <IAnalyticsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
