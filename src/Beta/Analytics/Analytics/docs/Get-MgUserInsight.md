...
### Get (Default)
```
Get-MgUserInsight -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInsight -InputObject <IAnalyticsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
