...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.analytics/get-mguserinsightsharedresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserInsightSharedResource -SharedInsightId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInsightSharedResource -InputObject <IAnalyticsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
