...
### Get (Default)
```
Get-MgPlannerBucketTaskBoardFormat -PlannerBucketId <String> -PlannerTaskId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlannerBucketTaskBoardFormat -InputObject <IPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
