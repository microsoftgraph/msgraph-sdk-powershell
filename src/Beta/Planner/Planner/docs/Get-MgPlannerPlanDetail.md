...
### Get (Default)
```
Get-MgPlannerPlanDetail -PlannerPlanId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlannerPlanDetail -InputObject <IPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
