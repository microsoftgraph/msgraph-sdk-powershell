# How-To
This document describes how to develop for `Mg.Users.ActivityFeed`.

## Building `Mg.Users.ActivityFeed`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Users.ActivityFeed` into the session.
