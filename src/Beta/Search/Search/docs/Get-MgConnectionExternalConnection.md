...
### List (Default)
```
Get-MgConnectionExternalConnection [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgConnectionExternalConnection -ExternalConnectionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgConnectionExternalConnection -InputObject <ISearchIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
