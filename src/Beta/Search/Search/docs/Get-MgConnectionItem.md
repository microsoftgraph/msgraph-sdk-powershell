...
### List (Default)
```
Get-MgConnectionItem -ExternalConnectionId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgConnectionItem -ExternalConnectionId <String> -ExternalItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgConnectionItem -InputObject <ISearchIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
