...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchatinstalledappteamapp
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgChatInstalledAppTeamApp -ChatId <String> -TeamsAppInstallationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgChatInstalledAppTeamApp -InputObject <ITeamsChatsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
