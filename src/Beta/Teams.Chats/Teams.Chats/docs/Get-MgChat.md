...
### List (Default)
```
Get-MgChat [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgChat -ChatId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgChat -InputObject <ITeamsChatsIdentity> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
