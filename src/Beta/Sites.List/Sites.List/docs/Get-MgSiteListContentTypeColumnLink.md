...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistcontenttypecolumnlink
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListContentTypeColumnLink -ContentTypeId <String> -ListId <String> -SiteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgSiteListContentTypeColumnLink -InputObject <ISitesListIdentity> [-Expand <String[]>]
