...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/new-mgsitelistactivitylistitemversion
schema: 2.0.0
---

# New-MgSiteListActivityListItemVersion
...
```
New-MgSiteListActivityListItemVersion -ItemActivityOldId <String> -ListId <String> -SiteId <String>
 [-FieldId <String>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-PublicationLevel <String>] [-PublicationVersionId <String>] [-Confirm]
...
### CreateViaIdentity
```
New-MgSiteListActivityListItemVersion -InputObject <ISitesListIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteListActivityListItemVersion -InputObject <ISitesListIdentity> [-FieldId <String>] [-Id <String>]
