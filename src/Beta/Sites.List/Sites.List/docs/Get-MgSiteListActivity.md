...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistactivity
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListActivity -ListId <String> -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSiteListActivity -ItemActivityOldId <String> -ListId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListActivity -InputObject <ISitesListIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
