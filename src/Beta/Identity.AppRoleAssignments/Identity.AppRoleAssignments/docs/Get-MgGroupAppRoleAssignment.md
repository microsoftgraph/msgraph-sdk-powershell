...
### List (Default)
```
Get-MgGroupAppRoleAssignment -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupAppRoleAssignment -AppRoleAssignmentId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupAppRoleAssignment -InputObject <IIdentityAppRoleAssignmentsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
