# How-To
This document describes how to develop for `Mg.Identity.AppRoleAssignments`.

## Building `Mg.Identity.AppRoleAssignments`
...
## Testing `Mg.Identity.AppRoleAssignments`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Identity.AppRoleAssignments` into the session.
