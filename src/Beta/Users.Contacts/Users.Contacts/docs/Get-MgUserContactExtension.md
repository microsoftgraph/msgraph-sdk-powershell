...
### List (Default)
```
Get-MgUserContactExtension -ContactId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserContactExtension -ContactId <String> -ExtensionId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserContactExtension -InputObject <IUsersContactsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
