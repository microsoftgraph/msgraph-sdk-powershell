...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldersinglevalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserContactFolderSingleValueExtendedProperty -InputObject <IUsersContactsIdentity> [-Expand <String[]>]
