...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldercontactphoto
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserContactFolderContactPhoto -InputObject <IUsersContactsIdentity> [-Expand <String[]>]
