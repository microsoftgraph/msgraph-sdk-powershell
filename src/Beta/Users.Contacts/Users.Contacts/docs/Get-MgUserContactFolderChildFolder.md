...
### List (Default)
```
Get-MgUserContactFolderChildFolder -ContactFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserContactFolderChildFolder -InputObject <IUsersContactsIdentity> [-Expand <String[]>]
