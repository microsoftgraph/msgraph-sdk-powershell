...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldercontact
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserContactFolderContact -ContactFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserContactFolderContact -InputObject <IUsersContactsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
