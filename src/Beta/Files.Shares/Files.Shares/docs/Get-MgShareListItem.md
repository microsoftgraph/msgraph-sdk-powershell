...
### Get1 (Default)
```
Get-MgShareListItem -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get
```
Get-MgShareListItem -ListItemId <String> -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListItem -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgShareListItem -SharedDriveItemId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
