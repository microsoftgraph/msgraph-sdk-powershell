...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistdrive
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgShareListDrive -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListDrive -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
