...
### List (Default)
```
Get-MgShareItem -SharedDriveItemId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgShareItem -DriveItemId <String> -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareItem -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
