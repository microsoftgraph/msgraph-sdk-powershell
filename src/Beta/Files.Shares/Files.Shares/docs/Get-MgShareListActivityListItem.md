...
### Get (Default)
```
Get-MgShareListActivityListItem -ItemActivityOldId <String> -SharedDriveItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivityListItem -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
