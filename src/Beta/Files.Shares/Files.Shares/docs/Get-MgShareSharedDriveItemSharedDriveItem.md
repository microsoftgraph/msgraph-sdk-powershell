...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgshareshareddriveitemshareddriveitem
schema: 2.0.0
---
...
### List (Default)
```
Get-MgShareSharedDriveItemSharedDriveItem [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgShareSharedDriveItemSharedDriveItem -SharedDriveItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareSharedDriveItemSharedDriveItem -InputObject <IFilesSharesIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
