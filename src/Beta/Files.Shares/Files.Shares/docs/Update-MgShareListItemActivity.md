...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/update-mgsharelistitemactivity
schema: 2.0.0
---
...
```
Update-MgShareListItemActivity -ItemActivityOldId <String> -SharedDriveItemId <String>
...
### Update
```
Update-MgShareListItemActivity -ItemActivityOldId <String> -ListItemId <String> -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgShareListItemActivity -InputObject <IFilesSharesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
