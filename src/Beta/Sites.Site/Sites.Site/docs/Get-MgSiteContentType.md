...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.site/get-mgsitecontenttype
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteContentType -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSiteContentType -ContentTypeId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteContentType -InputObject <ISitesSiteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
