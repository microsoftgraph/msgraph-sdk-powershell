...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Test-MgServicePrincipalSynchronizationJobCredentials.Recording.json'
...
Describe 'Test-MgServicePrincipalSynchronizationJobCredentials' {
