...
### List (Default)
```
Get-MgServicePrincipalAppRoleAssignment -ServicePrincipalId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgServicePrincipalAppRoleAssignment -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
