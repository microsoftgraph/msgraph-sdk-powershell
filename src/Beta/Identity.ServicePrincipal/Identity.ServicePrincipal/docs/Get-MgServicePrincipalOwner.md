...
### List (Default)
```
Get-MgServicePrincipalOwner -ServicePrincipalId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgServicePrincipalOwner -DirectoryObjectId <String> -ServicePrincipalId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgServicePrincipalOwner -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
