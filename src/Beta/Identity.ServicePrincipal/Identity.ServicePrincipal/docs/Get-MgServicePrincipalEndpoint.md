...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/get-mgserviceprincipalendpoint
schema: 2.0.0
---
...
### List (Default)
```
Get-MgServicePrincipalEndpoint -ServicePrincipalId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgServicePrincipalEndpoint -EndpointId <String> -ServicePrincipalId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgServicePrincipalEndpoint -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
