...
### List (Default)
```
Get-MgServicePrincipalOwnedObject -ServicePrincipalId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgServicePrincipalOwnedObject -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
