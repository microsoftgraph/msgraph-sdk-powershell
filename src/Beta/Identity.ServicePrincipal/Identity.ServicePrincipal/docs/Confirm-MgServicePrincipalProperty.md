...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/confirm-mgserviceprincipalproperty
schema: 2.0.0
---
...
```
Confirm-MgServicePrincipalProperty [-DisplayName <String>] [-EntityType <String>] [-MailNickname <String>]
