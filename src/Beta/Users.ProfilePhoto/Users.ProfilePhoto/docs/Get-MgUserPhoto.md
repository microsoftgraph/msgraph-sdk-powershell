...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.profilephoto/get-mguserphoto
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserPhoto -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgUserPhoto -ProfilePhotoId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPhoto -InputObject <IUsersProfilePhotoIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgUserPhoto -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
