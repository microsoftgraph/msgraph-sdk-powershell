...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/update-mgimpossibletravelriskeventimpossibletravelriskeventimpossibletravelriskevent
schema: 2.0.0
---

# Update-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
...
```
Update-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
 -ImpossibleTravelRiskEventId <String> [-ClosedDateTime <DateTime>] [-CreatedDateTime <DateTime>]
 [-DeviceInformation <String>] [-GeoCoordinateAltitude <Double>] [-GeoCoordinateLatitude <Double>]
 [-GeoCoordinateLongitude <Double>] [-Id <String>] [-ImpactedUser <IMicrosoftGraphUser>] [-IPAddress <String>]
 [-IsAtypicalLocation] [-LocationCity <String>] [-LocationCountryOrRegion <String>] [-LocationState <String>]
 [-PreviouLocationCity <String>] [-PreviouLocationCountryOrRegion <String>] [-PreviouLocationState <String>]
 [-PreviousIPAddress <String>] [-PreviousLocationGeoCoordinatesAltitude <Double>]
 [-PreviousLocationGeoCoordinatesLatitude <Double>] [-PreviousLocationGeoCoordinatesLongitude <Double>]
 [-PreviousSigninDateTime <DateTime>] [-RiskEventDateTime <DateTime>] [-RiskEventStatus <String>]
 [-RiskEventType <String>] [-RiskLevel <String>] [-UserAgent <String>] [-UserDisplayName <String>]
...
```
Update-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
 -ImpossibleTravelRiskEventId <String> -BodyParameter <IMicrosoftGraphImpossibleTravelRiskEvent> [-PassThru]
...
```
Update-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
 -InputObject <IIdentityProtectionIdentity> -BodyParameter <IMicrosoftGraphImpossibleTravelRiskEvent>
