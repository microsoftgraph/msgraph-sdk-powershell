...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/get-mgimpossibletravelriskeventimpossibletravelriskeventimpossibletravelriskevent
schema: 2.0.0
---

# Get-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
...
### List (Default)
```
Get-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent [-Count]
...
```
Get-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
 -ImpossibleTravelRiskEventId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
...
### -ImpossibleTravelRiskEventId
key: impossibleTravelRiskEvent-id of impossibleTravelRiskEvent
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphImpossibleTravelRiskEvent
