...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/confirm-mgriskyusercompromised
schema: 2.0.0
---
...
```
Confirm-MgRiskyUserCompromised [-UserIds <String[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
