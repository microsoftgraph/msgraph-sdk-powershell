# How-To
This document describes how to develop for `Mg.Notification`.

## Building `Mg.Notification`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Notification` into the session.
