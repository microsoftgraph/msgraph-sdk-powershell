...
### List (Default)
```
Get-MgAccessReviewInstance -AccessReviewId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgAccessReviewInstance -AccessReviewId <String> -AccessReviewId1 <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAccessReviewInstance -InputObject <IIdentityAccessReviewIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
