...
### List (Default)
```
Get-MgAuditLogDirectoryAudit [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgAuditLogDirectoryAudit -DirectoryAuditId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAuditLogDirectoryAudit -InputObject <IIdentityAuditLogsIdentity> [-Expand <String[]>]
