...
### List (Default)
```
Get-MgAuditLogDirectoryProvisioning [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgAuditLogDirectoryProvisioning -ProvisioningObjectSummaryId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAuditLogDirectoryProvisioning -InputObject <IIdentityAuditLogsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
