...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannertaskbuckettaskboardformat
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserPlannerTaskBucketTaskBoardFormat -PlannerTaskId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPlannerTaskBucketTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
