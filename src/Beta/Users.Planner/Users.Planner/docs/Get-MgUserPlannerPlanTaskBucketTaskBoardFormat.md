...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplantaskbuckettaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanTaskBucketTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-Expand <String[]>]
