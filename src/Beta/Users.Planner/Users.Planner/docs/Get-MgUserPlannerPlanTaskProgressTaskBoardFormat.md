...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplantaskprogresstaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanTaskProgressTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-Expand <String[]>]
