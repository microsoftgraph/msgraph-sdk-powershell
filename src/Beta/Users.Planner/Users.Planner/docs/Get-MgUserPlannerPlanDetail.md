...
### Get (Default)
```
Get-MgUserPlannerPlanDetail -PlannerPlanId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPlannerPlanDetail -InputObject <IUsersPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
