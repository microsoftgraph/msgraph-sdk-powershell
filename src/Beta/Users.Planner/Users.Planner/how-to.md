# How-To
This document describes how to develop for `Mg.Users.Planner`.

## Building `Mg.Users.Planner`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Users.Planner` into the session.
