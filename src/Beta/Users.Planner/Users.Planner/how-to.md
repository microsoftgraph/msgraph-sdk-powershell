# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Users.Planner`.

## Building `Microsoft.Graph.Beta.Users.Planner`
...
## Testing `Microsoft.Graph.Beta.Users.Planner`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Users.Planner` into the session.
