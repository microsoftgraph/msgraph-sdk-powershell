# How-To
This document describes how to develop for `Microsoft.Graph.Users.Planner`.

## Building `Microsoft.Graph.Users.Planner`
...
## Testing `Microsoft.Graph.Users.Planner`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Users.Planner` into the session.
