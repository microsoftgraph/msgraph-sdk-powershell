...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.lifecyclepolicies/invoke-mgrenewgrouplifecyclepolicygroup
schema: 2.0.0
---

# Invoke-MgRenewGroupLifecyclePolicyGroup
...
```
Invoke-MgRenewGroupLifecyclePolicyGroup [-GroupId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
