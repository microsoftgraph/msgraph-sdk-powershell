# How-To
This document describes how to develop for `Mg.Groups.LifecyclePolicies`.

## Building `Mg.Groups.LifecyclePolicies`
...
## Testing `Mg.Groups.LifecyclePolicies`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Mg.Groups.LifecyclePolicies` into the session.
