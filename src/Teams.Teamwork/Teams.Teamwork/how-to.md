# How-To
This document describes how to develop for `Microsoft.Graph.Teams.Teamwork`.

## Building `Microsoft.Graph.Teams.Teamwork`
...
## Testing `Microsoft.Graph.Teams.Teamwork`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Teams.Teamwork` into the session.
