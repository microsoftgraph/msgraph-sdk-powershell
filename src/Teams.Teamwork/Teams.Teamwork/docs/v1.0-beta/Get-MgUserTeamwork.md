...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.teamwork/get-mguserteamwork
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserTeamwork -InputObject <ITeamsTeamworkIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
