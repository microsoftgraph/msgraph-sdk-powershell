...
### List1 (Default)
```
Get-MgContact [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity1
```
Get-MgContact -InputObject <IIdentityOrganizationContactsIdentity> [-ExpandProperty <String[]>]
