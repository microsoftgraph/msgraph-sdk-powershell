...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.organizationcontacts/get-mgcontactmember
schema: 2.0.0
---
...
### List (Default)
```
Get-MgContactMember -OrgContactId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgContactMember -DirectoryObjectId <String> -OrgContactId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgContactMember -InputObject <IIdentityOrganizationContactsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
