...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistactivitylistitemversionfield
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgShareListActivityListItemVersionField -ItemActivityOldId <String> -ListItemVersionId <String>
 -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivityListItemVersionField -InputObject <IFilesSharesIdentity> [-Expand <String[]>]
