...
### List1 (Default)
```
Get-MgShareSharedDriveItemSharedDriveItem [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgShareSharedDriveItemSharedDriveItem -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
