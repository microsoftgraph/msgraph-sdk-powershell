...
### List (Default)
```
Get-MgShareListColumn -SharedDriveItemId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgShareListColumn -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
