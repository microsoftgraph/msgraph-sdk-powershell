...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/new-mgsharelistactivitylistitemversion
schema: 2.0.0
---

# New-MgShareListActivityListItemVersion
...
```
New-MgShareListActivityListItemVersion -ItemActivityOldId <String> -SharedDriveItemId <String>
...
### CreateViaIdentity
```
New-MgShareListActivityListItemVersion -InputObject <IFilesSharesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgShareListActivityListItemVersion -InputObject <IFilesSharesIdentity> [-FieldId <String>] [-Id <String>]
