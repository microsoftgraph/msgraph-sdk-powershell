...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/update-mgsharelistactivity
schema: 2.0.0
---

# Update-MgShareListActivity
...
```
Update-MgShareListActivity -ItemActivityOldId <String> -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgShareListActivity -InputObject <IFilesSharesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgShareListActivity -InputObject <IFilesSharesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
