...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistcontenttypecolumnlink
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgShareListContentTypeColumnLink -ContentTypeId <String> -SharedDriveItemId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgShareListContentTypeColumnLink -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>]
