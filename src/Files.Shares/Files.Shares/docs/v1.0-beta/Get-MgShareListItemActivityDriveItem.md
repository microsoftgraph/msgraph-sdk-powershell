...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistitemactivitydriveitem
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgShareListItemActivityDriveItem -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>]
