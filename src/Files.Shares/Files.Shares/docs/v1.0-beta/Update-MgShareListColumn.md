...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/update-mgsharelistcolumn
schema: 2.0.0
---
...
```
Update-MgShareListColumn -InputObject <IFilesSharesIdentity> [-Boolean <IMicrosoftGraphBooleanColumn>]
