...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistactivity
schema: 2.0.0
---
...
### List (Default)
```
Get-MgShareListActivity -SharedDriveItemId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgShareListActivity -ItemActivityOldId <String> -SharedDriveItemId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivity -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
