...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistactivitylistitemactivity
schema: 2.0.0
---
...
### List (Default)
```
Get-MgShareListActivityListItemActivity -ItemActivityOldId <String> -SharedDriveItemId <String> [-Count]
...
### Get
```
Get-MgShareListActivityListItemActivity -ItemActivityOldId <String> -ItemActivityOldId1 <String>
 -SharedDriveItemId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgShareListActivityListItemActivity -EndDateTime <String> -Interval <String> -ItemActivityOldId <String>
 -SharedDriveItemId <String> -StartDateTime <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivityListItemActivity -InputObject <IFilesSharesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgShareListActivityListItemActivity -InputObject <IFilesSharesIdentity> [<CommonParameters>]
```
