...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/new-mgsharelistactivitylistitemactivity
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgShareListActivityListItemActivity -InputObject <IFilesSharesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
