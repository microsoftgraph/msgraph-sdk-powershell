...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistactivitylistitemfield
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgShareListActivityListItemField -ItemActivityOldId <String> -SharedDriveItemId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivityListItemField -InputObject <IFilesSharesIdentity> [-Expand <String[]>]
