...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistitemactivitylistitem
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgShareListItemActivityListItem -ItemActivityOldId <String> -SharedDriveItemId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get
```
Get-MgShareListItemActivityListItem -ItemActivityOldId <String> -ListItemId <String>
 -SharedDriveItemId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListItemActivityListItem -InputObject <IFilesSharesIdentity> [-Expand <String[]>]
