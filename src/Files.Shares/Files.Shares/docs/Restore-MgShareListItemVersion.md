...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/restore-mgsharelistitemversion
schema: 2.0.0
---
...
### RestoreViaIdentity
```
Restore-MgShareListItemVersion -InputObject <IFilesSharesIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
