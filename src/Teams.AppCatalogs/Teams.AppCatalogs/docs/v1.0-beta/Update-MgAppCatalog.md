...
### Update
```
Update-MgAppCatalog -BodyParameter <IMicrosoftGraphAppCatalogs1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAppCatalogs1
...
BODYPARAMETER <IMicrosoftGraphAppCatalogs1>: appCatalogs
  - `[Id <String>]`: Read-only.
