...
### List (Default)
```
Get-MgAppCatalogTeamAppDefinition -TeamsAppId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgAppCatalogTeamAppDefinition -TeamsAppDefinitionId <String> -TeamsAppId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAppCatalogTeamAppDefinition -InputObject <ITeamsAppCatalogsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
