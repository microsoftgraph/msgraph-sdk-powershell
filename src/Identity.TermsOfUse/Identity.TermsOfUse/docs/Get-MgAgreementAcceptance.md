...
### List (Default)
```
Get-MgAgreementAcceptance [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgAgreementAcceptance -AgreementAcceptanceId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAgreementAcceptance -InputObject <IIdentityTermsOfUseIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
