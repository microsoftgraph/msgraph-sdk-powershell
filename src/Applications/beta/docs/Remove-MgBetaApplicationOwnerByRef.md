...
### Delete (Default)
```
Remove-MgBetaApplicationOwnerByRef -ApplicationId <String> -DirectoryObjectId <String> [-IfMatch <String>]
...
### Delete1
```
Remove-MgBetaApplicationOwnerByRef -ApplicationId <String> -Id <String> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
