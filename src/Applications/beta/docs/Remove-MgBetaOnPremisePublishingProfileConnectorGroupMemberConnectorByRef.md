...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaonpremisepublishingprofileconnectorgroupmemberconnectorbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaOnPremisePublishingProfileConnectorGroupMemberConnectorByRef -ConnectorGroupId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaOnPremisePublishingProfileConnectorGroupMemberConnectorByRef -InputObject <IApplicationsIdentity>
