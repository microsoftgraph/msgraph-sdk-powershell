...
### Delete (Default)
```
Remove-MgBetaApplication -ApplicationId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaApplication -InputObject <IApplicationsIdentity> [-IfMatch <String>]
