...
### Delete (Default)
```
Remove-MgBetaApplicationAppManagementPolicyAppManagementPolicyByRef -ApplicationId <String>
 -AppManagementPolicyId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaApplicationAppManagementPolicyAppManagementPolicyByRef -InputObject <IApplicationsIdentity>
