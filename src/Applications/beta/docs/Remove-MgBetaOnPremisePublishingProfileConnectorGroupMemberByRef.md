...
Remove-MgBetaOnPremisePublishingProfileConnectorGroupMemberByRef -ConnectorGroupId <String>
 -ConnectorId <String> -OnPremisesPublishingProfileId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
```
Remove-MgBetaOnPremisePublishingProfileConnectorGroupMemberByRef -ConnectorGroupId <String>
 -OnPremisesPublishingProfileId <String> -Id <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
