...
### Delete (Default)
```
Remove-MgBetaApplicationTokenLifetimePolicyTokenLifetimePolicyByRef -ApplicationId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaApplicationTokenLifetimePolicyTokenLifetimePolicyByRef -InputObject <IApplicationsIdentity>
