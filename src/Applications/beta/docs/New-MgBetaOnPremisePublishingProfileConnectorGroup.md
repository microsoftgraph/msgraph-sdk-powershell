...
New-MgBetaOnPremisePublishingProfileConnectorGroup -OnPremisesPublishingProfileId <String>
 ...
 [-Name <String>] [-Region <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaOnPremisePublishingProfileConnectorGroup -OnPremisesPublishingProfileId <String>
 -BodyParameter <IMicrosoftGraphConnectorGroup> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
