...
New-MgBetaApplication [-AdditionalProperties <Hashtable>] [-Api <IMicrosoftGraphApiApplication>]
 ...
 [-Windows <IMicrosoftGraphWindowsApplication>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaApplication -BodyParameter <IMicrosoftGraphApplication> [-Headers <IDictionary>] [-Confirm]
