...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaonpremisepublishingprofileconnectormemberofconnectorgroupbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaOnPremisePublishingProfileConnectorMemberOfConnectorGroupByRef -ConnectorGroupId <String>
