...
### Delete (Default)
```
Remove-MgBetaServicePrincipalOwnerDirectoryObjectByRef -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalOwnerDirectoryObjectByRef -InputObject <IApplicationsIdentity>
