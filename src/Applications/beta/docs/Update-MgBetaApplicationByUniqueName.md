...
```
Update-MgBetaApplicationByUniqueName -UniqueName <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgBetaApplicationByUniqueName -InputObject <IApplicationsIdentity> [-UniqueName <String>]
