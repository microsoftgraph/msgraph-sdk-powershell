...
### Get (Default)
```
Get-MgBetaApplicationConnectorGroupByRef -ApplicationId <String> [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationConnectorGroupByRef -InputObject <IApplicationsIdentity> [-Headers <IDictionary>]
 [<CommonParameters>]
```
