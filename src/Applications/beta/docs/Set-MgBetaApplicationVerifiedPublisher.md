...
Set-MgBetaApplicationVerifiedPublisher -ApplicationId <String> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-VerifiedPublisherId <String>] [-Headers <IDictionary>] [-PassThru]
...
```
Set-MgBetaApplicationVerifiedPublisher -InputObject <IApplicationsIdentity>
 [-AdditionalProperties <Hashtable>] [-ResponseHeadersVariable <String>] [-VerifiedPublisherId <String>]
