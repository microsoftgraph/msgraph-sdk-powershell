...
New-MgBetaApplicationExtensionProperty -ApplicationId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-IsSyncedFromOnPremises] [-Name <String>] [-TargetObjects <String[]>] [-Headers <IDictionary>] [-Confirm]
...
New-MgBetaApplicationExtensionProperty -ApplicationId <String>
 -BodyParameter <IMicrosoftGraphExtensionProperty> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaApplicationExtensionProperty -InputObject <IApplicationsIdentity>
 ...
 [-TargetObjects <String[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
