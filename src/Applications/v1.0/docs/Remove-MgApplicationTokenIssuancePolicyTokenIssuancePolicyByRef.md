...
### Delete (Default)
```
Remove-MgApplicationTokenIssuancePolicyTokenIssuancePolicyByRef -ApplicationId <String>
...
### DeleteViaIdentity
```
Remove-MgApplicationTokenIssuancePolicyTokenIssuancePolicyByRef -InputObject <IApplicationsIdentity>
