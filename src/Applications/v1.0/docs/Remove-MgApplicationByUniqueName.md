...
### Delete (Default)
```
Remove-MgApplicationByUniqueName -UniqueName <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgApplicationByUniqueName -InputObject <IApplicationsIdentity> [-IfMatch <String>]
