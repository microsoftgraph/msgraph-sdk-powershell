...
### Delete (Default)
```
Remove-MgServicePrincipalByAppId -AppId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-PassThru]
