...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.applications/update-mgserviceprincipalsynchronizationjobbulkupload
schema: 2.0.0
---
...
```
Update-MgServicePrincipalSynchronizationJobBulkUpload -ServicePrincipalId <String>
...
### UpdateViaIdentity
```
Update-MgServicePrincipalSynchronizationJobBulkUpload -InputObject <IApplicationsIdentity>
