...
### GetExpanded (Default)
```
Get-MgApplicationMemberGroup -ApplicationId <String> [-AdditionalProperties <Hashtable>] [-SecurityEnabledOnly]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgapplicationmembergroup](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgapplicationmembergroup)
