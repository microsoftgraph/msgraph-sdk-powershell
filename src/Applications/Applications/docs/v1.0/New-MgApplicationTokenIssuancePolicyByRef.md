...
### Create (Default)
```
New-MgApplicationTokenIssuancePolicyByRef -ApplicationId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgApplicationTokenIssuancePolicyByRef -InputObject <IApplicationsIdentity> [-PassThru] [-Confirm]
