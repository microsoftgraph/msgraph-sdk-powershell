...
### Create1 (Default)
```
New-MgServicePrincipalClaimMappingPolicyByRef -ServicePrincipalId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgServicePrincipalClaimMappingPolicyByRef -InputObject <IApplicationsIdentity> [-PassThru] [-Confirm]
