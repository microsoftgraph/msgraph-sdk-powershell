...
```
Update-MgApplication -ApplicationId <String> [-AppId <String>] [-AddIns <IMicrosoftGraphAddIn[]>]
 [-AdditionalProperties <Hashtable>] [-Api <IMicrosoftGraphApiApplication>] [-AppId1 <String>]
 [-ApplicationTemplateId <String>] [-AppRoles <IMicrosoftGraphAppRole[]>]
 ...
 [-VerifiedPublisher <IMicrosoftGraphVerifiedPublisher>] [-Web <IMicrosoftGraphWebApplication>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update1
```
Update-MgApplication -ApplicationId <String> -BodyParameter <IMicrosoftGraphApplication1> [-AppId <String>]
...
```
Update-MgApplication -InputObject <IApplicationsIdentity> [-AppId <String>] [-AddIns <IMicrosoftGraphAddIn[]>]
 [-AdditionalProperties <Hashtable>] [-Api <IMicrosoftGraphApiApplication>] [-ApplicationTemplateId <String>]
