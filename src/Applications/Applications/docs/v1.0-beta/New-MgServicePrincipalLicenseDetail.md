...
```
New-MgServicePrincipalLicenseDetail -ServicePrincipalId <String> [-AppId <String>]
...
New-MgServicePrincipalLicenseDetail -ServicePrincipalId <String>
 -BodyParameter <IMicrosoftGraphLicenseDetails> [-AppId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
