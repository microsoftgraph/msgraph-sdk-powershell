...
Update-MgApplicationSynchronizationTemplateSchemaDirectory -ApplicationId <String>
 -DirectoryDefinitionId <String> -SynchronizationTemplateId <String> [-AppId <String>]
...
Update-MgApplicationSynchronizationTemplateSchemaDirectory -ApplicationId <String>
 ...
 -BodyParameter <IMicrosoftGraphDirectoryDefinition> [-AppId <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
