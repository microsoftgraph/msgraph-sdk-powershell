...
```
New-MgServicePrincipalAppRoleAssignment -ServicePrincipalId <String> [-AppId <String>]
...
New-MgServicePrincipalAppRoleAssignment -ServicePrincipalId <String>
 -BodyParameter <IMicrosoftGraphAppRoleAssignment1> [-AppId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
