...
### List (Default)
```
Get-MgServicePrincipalSynchronizationJob -ServicePrincipalId <String> [-AppId <String>]
...
Get-MgServicePrincipalSynchronizationJob -ServicePrincipalId <String> -SynchronizationJobId <String>
 [-AppId <String>] [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
### Example 1: Using the Get-MgServicePrincipalSynchronizationJob Cmdlet
```powershell
