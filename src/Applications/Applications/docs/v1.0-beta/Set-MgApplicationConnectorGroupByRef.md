...
### SetExpanded (Default)
```
Set-MgApplicationConnectorGroupByRef -ApplicationId <String> [-AppId <String>]
...
### Set
```
Set-MgApplicationConnectorGroupByRef -ApplicationId <String> -BodyParameter <IReferenceUpdate>
