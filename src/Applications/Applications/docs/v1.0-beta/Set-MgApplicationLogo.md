...
### Update (Default)
```
Set-MgApplicationLogo -ApplicationId <String> -BodyParameter <Stream> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-MgApplicationLogo -InputObject <IApplicationsIdentity> -BodyParameter <Stream> [-PassThru] [-Confirm]
