...
```
Update-MgApplication -ApplicationId <String> [-AppId <String>] [-AdditionalProperties <Hashtable>]
 [-Api <IMicrosoftGraphApiApplication1>] [-AppId1 <String>]
...
### Update
```
Update-MgApplication -ApplicationId <String> -BodyParameter <IMicrosoftGraphApplication> [-AppId <String>]
...
```
Update-MgApplication -InputObject <IApplicationsIdentity> [-AppId <String>]
 [-AdditionalProperties <Hashtable>] [-Api <IMicrosoftGraphApiApplication1>]
 [-AppManagementPolicies <IMicrosoftGraphAppManagementPolicy[]>] [-AppRoles <IMicrosoftGraphAppRole[]>]
 [-Certification <IMicrosoftGraphCertification>] [-ConnectorGroup <IMicrosoftGraphConnectorGroup>]
 [-CreatedDateTime <DateTime>] [-CreatedOnBehalfOf <IMicrosoftGraphDirectoryObject>]
 [-DefaultRedirectUri <String>] [-DeletedDateTime <DateTime>] [-Description <String>]
