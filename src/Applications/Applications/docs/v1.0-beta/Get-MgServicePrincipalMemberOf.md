...
### List (Default)
```
Get-MgServicePrincipalMemberOf -ServicePrincipalId <String> [-AppId <String>] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgServicePrincipalMemberOf -DirectoryObjectId <String> -ServicePrincipalId <String> [-AppId <String>]
