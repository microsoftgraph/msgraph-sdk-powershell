...
### List (Default)
```
Get-MgServicePrincipalEndpoint -ServicePrincipalId <String> [-AppId <String>] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgServicePrincipalEndpoint -EndpointId <String> -ServicePrincipalId <String> [-AppId <String>]
