...
```
New-MgApplicationFederatedIdentityCredential -ApplicationId <String> [-AppId <String>]
...
New-MgApplicationFederatedIdentityCredential -ApplicationId <String>
 -BodyParameter <IMicrosoftGraphFederatedIdentityCredential> [-AppId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
