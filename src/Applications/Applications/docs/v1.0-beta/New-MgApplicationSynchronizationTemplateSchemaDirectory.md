...
New-MgApplicationSynchronizationTemplateSchemaDirectory -ApplicationId <String>
 -SynchronizationTemplateId <String> [-AppId <String>] [-AdditionalProperties <Hashtable>]
...
```
New-MgApplicationSynchronizationTemplateSchemaDirectory -ApplicationId <String>
 -SynchronizationTemplateId <String> -BodyParameter <IMicrosoftGraphDirectoryDefinition> [-AppId <String>]
