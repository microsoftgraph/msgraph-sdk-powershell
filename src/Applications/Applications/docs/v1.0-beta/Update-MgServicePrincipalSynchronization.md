...
```
Update-MgServicePrincipalSynchronization -ServicePrincipalId <String> [-AppId <String>]
...
Update-MgServicePrincipalSynchronization -ServicePrincipalId <String>
 -BodyParameter <IMicrosoftGraphSynchronization> [-AppId <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
