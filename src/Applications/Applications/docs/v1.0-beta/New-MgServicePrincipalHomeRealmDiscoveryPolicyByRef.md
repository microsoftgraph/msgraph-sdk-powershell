...
```
New-MgServicePrincipalHomeRealmDiscoveryPolicyByRef -ServicePrincipalId <String> [-AppId <String>]
...
New-MgServicePrincipalHomeRealmDiscoveryPolicyByRef -ServicePrincipalId <String>
 -BodyParameter <IReferenceCreate> [-AppId <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
