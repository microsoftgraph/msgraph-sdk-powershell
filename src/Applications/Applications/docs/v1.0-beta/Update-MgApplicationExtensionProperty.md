...
```
Update-MgApplicationExtensionProperty -ApplicationId <String> -ExtensionPropertyId <String> [-AppId <String>]
...
Update-MgApplicationExtensionProperty -ApplicationId <String> -ExtensionPropertyId <String>
 -BodyParameter <IMicrosoftGraphExtensionProperty> [-AppId <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
