...
### List (Default)
```
Get-MgServicePrincipalDelegatedPermissionClassification -ServicePrincipalId <String> [-AppId <String>]
...
Get-MgServicePrincipalDelegatedPermissionClassification -DelegatedPermissionClassificationId <String>
 -ServicePrincipalId <String> [-AppId <String>] [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
