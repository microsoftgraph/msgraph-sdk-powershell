...
### List (Default)
```
Get-MgServicePrincipalTransitiveMemberOf -ServicePrincipalId <String> [-AppId <String>]
...
Get-MgServicePrincipalTransitiveMemberOf -DirectoryObjectId <String> -ServicePrincipalId <String>
 [-AppId <String>] [-ExpandProperty <String[]>] [-Property <String[]>] [-ConsistencyLevel <String>]
 [<CommonParameters>]
```
