...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgOnPremisePublishingProfileAgentGroup.Recording.json'
...
Describe 'Update-MgOnPremisePublishingProfileAgentGroup' {
