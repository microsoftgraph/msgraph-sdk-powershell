...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/{directoryObject-id}/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerAsServicePrincipal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ServicePrincipal))]
    public class GetMgApplicationOwnerAsServicePrincipal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners[DirectoryObjectId].GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
