...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgApplicationTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ApplicationTemplate))]
    public class GetMgApplicationTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.ApplicationTemplateCollectionResponse? result;
            try
            {
                result = client.ApplicationTemplates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ApplicationTemplates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
