...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/{directoryObject-id}/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerAsEndpoint_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.Endpoint))]
    public class GetMgApplicationOwnerAsEndpoint_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners[DirectoryObjectId].GraphEndpoint.GetAsync(requestConfiguration =>
                {
