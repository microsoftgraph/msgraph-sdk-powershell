...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/graph.appRoleAssignment")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerAsAppRoleAssignment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class GetMgServicePrincipalOwnerAsAppRoleAssignment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners[DirectoryObjectId].GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
