...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgApplicationHomeRealmDiscoveryPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.HomeRealmDiscoveryPolicy))]
    public class GetMgApplicationHomeRealmDiscoveryPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.HomeRealmDiscoveryPolicyCollectionResponse? result;
            try
            {
                result = client.Applications[ApplicationId].HomeRealmDiscoveryPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Applications[ApplicationId].HomeRealmDiscoveryPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
