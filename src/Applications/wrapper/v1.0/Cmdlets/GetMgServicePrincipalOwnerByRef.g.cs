...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerByRef")]
    [OutputType(typeof(string))]
    public class GetMgServicePrincipalOwnerByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].Owners.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
