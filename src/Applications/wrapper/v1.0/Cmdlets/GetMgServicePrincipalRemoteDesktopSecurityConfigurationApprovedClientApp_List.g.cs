...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalRemoteDesktopSecurityConfigurationApprovedClientApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ApprovedClientApp))]
    public class GetMgServicePrincipalRemoteDesktopSecurityConfigurationApprovedClientApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.ApprovedClientAppCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].RemoteDesktopSecurityConfiguration.ApprovedClientApps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].RemoteDesktopSecurityConfiguration.ApprovedClientApps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
