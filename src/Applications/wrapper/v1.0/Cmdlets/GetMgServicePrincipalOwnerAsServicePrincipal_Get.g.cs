...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerAsServicePrincipal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ServicePrincipal))]
    public class GetMgServicePrincipalOwnerAsServicePrincipal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners[DirectoryObjectId].GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
