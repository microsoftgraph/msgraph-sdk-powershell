...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class UpdateMgServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroupCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(DisplayName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, TargetDeviceGroupId));
                return;
            }
