...
{
    [GraphRoute("GET", "/groups/{group-id}/appRoleAssignments/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupAppRoleAssignmentCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupAppRoleAssignmentCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].AppRoleAssignments.Count.GetAsync(requestConfiguration =>
                {
