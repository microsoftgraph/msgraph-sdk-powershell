...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerByRef")]
    [OutputType(typeof(string))]
    public class GetMgApplicationOwnerByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Applications[ApplicationId].Owners.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
