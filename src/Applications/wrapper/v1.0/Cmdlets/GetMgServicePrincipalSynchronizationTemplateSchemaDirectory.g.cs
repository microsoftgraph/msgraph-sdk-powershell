...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class GetMgServicePrincipalSynchronizationTemplateSchemaDirectoryCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? DirectoryDefinitionId : SynchronizationTemplateId));
                return;
            }
        }
    }
