...
{
    [GraphRoute("POST", "/users/{user-id}/appRoleAssignments")]
    [Cmdlet(VerbsCommon.New, "MgUserAppRoleAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class NewMgUserAppRoleAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ResourceId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].AppRoleAssignments.PostAsync(body, requestConfiguration =>
                {
