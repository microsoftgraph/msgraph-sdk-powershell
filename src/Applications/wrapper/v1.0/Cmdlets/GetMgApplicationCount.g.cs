...
{
    [GraphRoute("GET", "/applications/$count")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationCount")]
    [OutputType(typeof(int))]
    public class GetMgApplicationCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications.Count.GetAsync(requestConfiguration =>
                {
