...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalTokenLifetimePolicy")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.TokenLifetimePolicy))]
    public class GetMgServicePrincipalTokenLifetimePolicyCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.TokenLifetimePolicyCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].TokenLifetimePolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].TokenLifetimePolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
