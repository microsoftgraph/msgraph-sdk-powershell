...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/{directoryObject-id}/graph.appRoleAssignment")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerAsAppRoleAssignment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class GetMgApplicationOwnerAsAppRoleAssignment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners[DirectoryObjectId].GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
