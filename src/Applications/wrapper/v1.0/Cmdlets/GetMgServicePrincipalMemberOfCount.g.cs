...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/memberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgServicePrincipalMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].MemberOf.Count.GetAsync(requestConfiguration =>
                {
