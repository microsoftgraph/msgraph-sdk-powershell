...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalClaimMappingPolicy")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ClaimsMappingPolicy))]
    public class GetMgServicePrincipalClaimMappingPolicyCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.ClaimsMappingPolicyCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].ClaimsMappingPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].ClaimsMappingPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
