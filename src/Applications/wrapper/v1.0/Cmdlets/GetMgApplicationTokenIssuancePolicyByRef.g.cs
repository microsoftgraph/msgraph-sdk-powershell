...
{
    [GraphRoute("GET", "/applications/{application-id}/tokenIssuancePolicies/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationTokenIssuancePolicyByRef")]
    [OutputType(typeof(string))]
    public class GetMgApplicationTokenIssuancePolicyByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].TokenIssuancePolicies.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Applications[ApplicationId].TokenIssuancePolicies.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
