...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class GetMgApplicationExtensionPropertyCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? ExtensionPropertyId : ApplicationId));
                return;
            }
        }
    }
