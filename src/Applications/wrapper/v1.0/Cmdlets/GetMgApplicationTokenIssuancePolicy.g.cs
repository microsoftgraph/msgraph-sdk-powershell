...
{
    [GraphRoute("GET", "/applications/{application-id}/tokenIssuancePolicies")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationTokenIssuancePolicy")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.TokenIssuancePolicy))]
    public class GetMgApplicationTokenIssuancePolicyCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].TokenIssuancePolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Applications[ApplicationId].TokenIssuancePolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
