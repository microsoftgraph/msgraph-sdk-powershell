...
{
    [GraphRoute("GET", "/applications/{application-id}/logo")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationLogo")]
    [OutputType(typeof(byte[]))]
    public class GetMgApplicationLogoCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Logo.GetAsync(requestConfiguration =>
                {
