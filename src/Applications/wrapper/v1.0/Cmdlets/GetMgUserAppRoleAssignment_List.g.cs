...
{
    [GraphRoute("GET", "/users/{user-id}/appRoleAssignments")]
    [Cmdlet(VerbsCommon.Get, "MgUserAppRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class GetMgUserAppRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].AppRoleAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].AppRoleAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
