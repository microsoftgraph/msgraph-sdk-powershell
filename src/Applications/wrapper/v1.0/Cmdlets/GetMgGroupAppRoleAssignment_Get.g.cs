...
{
    [GraphRoute("GET", "/groups/{group-id}/appRoleAssignments/{appRoleAssignment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupAppRoleAssignment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class GetMgGroupAppRoleAssignment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].AppRoleAssignments[AppRoleAssignmentId].GetAsync(requestConfiguration =>
                {
