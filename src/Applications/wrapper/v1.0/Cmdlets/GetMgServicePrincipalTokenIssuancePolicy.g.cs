...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalTokenIssuancePolicy")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.TokenIssuancePolicy))]
    public class GetMgServicePrincipalTokenIssuancePolicyCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.TokenIssuancePolicyCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].TokenIssuancePolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].TokenIssuancePolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
