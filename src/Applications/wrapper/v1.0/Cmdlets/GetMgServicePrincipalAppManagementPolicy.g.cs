...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class GetMgServicePrincipalAppManagementPolicyCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? AppManagementPolicyId : ServicePrincipalId));
                return;
            }
        }
    }
