...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalMemberOfAsAdministrativeUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AdministrativeUnit))]
    public class GetMgServicePrincipalMemberOfAsAdministrativeUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].MemberOf.GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].MemberOf.GraphAdministrativeUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
