...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnedObjectAsAppRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class GetMgServicePrincipalOwnedObjectAsAppRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignmentCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].OwnedObjects.GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].OwnedObjects.GraphAppRoleAssignment.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
