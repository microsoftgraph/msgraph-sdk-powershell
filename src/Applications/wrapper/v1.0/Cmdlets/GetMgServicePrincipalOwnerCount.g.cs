...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/$count")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerCount")]
    [OutputType(typeof(int))]
    public class GetMgServicePrincipalOwnerCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners.Count.GetAsync(requestConfiguration =>
                {
