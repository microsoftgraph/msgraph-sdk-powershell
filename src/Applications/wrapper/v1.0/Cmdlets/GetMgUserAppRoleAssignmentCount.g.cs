...
{
    [GraphRoute("GET", "/users/{user-id}/appRoleAssignments/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserAppRoleAssignmentCount")]
    [OutputType(typeof(int))]
    public class GetMgUserAppRoleAssignmentCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].AppRoleAssignments.Count.GetAsync(requestConfiguration =>
                {
