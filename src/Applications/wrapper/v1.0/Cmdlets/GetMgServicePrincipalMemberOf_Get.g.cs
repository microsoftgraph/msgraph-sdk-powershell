...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/memberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.DirectoryObject))]
    public class GetMgServicePrincipalMemberOf_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].MemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
