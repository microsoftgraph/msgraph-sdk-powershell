...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/$count")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerCount")]
    [OutputType(typeof(int))]
    public class GetMgApplicationOwnerCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners.Count.GetAsync(requestConfiguration =>
                {
