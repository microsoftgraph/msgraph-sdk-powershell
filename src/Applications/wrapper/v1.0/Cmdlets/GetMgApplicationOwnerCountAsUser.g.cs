...
{
    [GraphRoute("GET", "/applications/{application-id}/owners/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationOwnerCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgApplicationOwnerCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Applications[ApplicationId].Owners.GraphUser.Count.GetAsync(requestConfiguration =>
                {
