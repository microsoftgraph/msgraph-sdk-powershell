...
{
    [GraphRoute("GET", "/servicePrincipals/$count")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalCount")]
    [OutputType(typeof(int))]
    public class GetMgServicePrincipalCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals.Count.GetAsync(requestConfiguration =>
                {
