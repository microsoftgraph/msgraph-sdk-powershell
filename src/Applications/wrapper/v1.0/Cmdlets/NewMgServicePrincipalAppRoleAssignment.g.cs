...
{
    [GraphRoute("POST", "/servicePrincipals/{servicePrincipal-id}/appRoleAssignments")]
    [Cmdlet(VerbsCommon.New, "MgServicePrincipalAppRoleAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppRoleAssignment))]
    public class NewMgServicePrincipalAppRoleAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ResourceId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].AppRoleAssignments.PostAsync(body, requestConfiguration =>
                {
