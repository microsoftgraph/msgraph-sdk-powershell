...
namespace Microsoft.Graph.PowerShell.Applications.Client.Models
{
    ...
    public partial class CustomClaimsPolicy : global::Microsoft.Graph.PowerShell.Applications.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimBase>? Claims { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimBase> Claims { get; set; }
#endif
        ...
        public static new global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimsPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimsPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "claims", n => { Claims = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimBase>(global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimBase.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Applications.Client.Models.CustomClaimBase>("claims", Claims);
