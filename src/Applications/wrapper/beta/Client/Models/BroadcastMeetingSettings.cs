...
namespace Microsoft.Graph.PowerShell.Applications.Client.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingAudience? AllowedAudience { get; set; }
        /// <summary>Caption settings of a Teams live event.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingCaptionSettings? Captions { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingCaptionSettings Captions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedAudience", n => { AllowedAudience = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingAudience>(); } },
                { "captions", n => { Captions = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingCaptionSettings>(global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingCaptionSettings.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingAudience>("allowedAudience", AllowedAudience);
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Applications.Client.Models.BroadcastMeetingCaptionSettings>("captions", Captions);
