...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalDelegatedPermissionClassification_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.DelegatedPermissionClassification))]
    public class GetMgServicePrincipalDelegatedPermissionClassification_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.DelegatedPermissionClassificationCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].DelegatedPermissionClassifications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].DelegatedPermissionClassifications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
