...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgServicePrincipalGetMemberObjects", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgServicePrincipalGetMemberObjectsCommand : GraphClientCmdlet
    {
