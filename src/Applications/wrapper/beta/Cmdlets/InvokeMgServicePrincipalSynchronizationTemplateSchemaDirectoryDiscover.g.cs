...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgServicePrincipalSynchronizationTemplateSchemaDirectoryDiscover", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.DirectoryDefinition))]
    public class InvokeMgServicePrincipalSynchronizationTemplateSchemaDirectoryDiscoverCommand : GraphClientCmdlet
    {
