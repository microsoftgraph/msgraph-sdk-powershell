...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgServicePrincipalSynchronizationJobRestart", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgServicePrincipalSynchronizationJobRestartCommand : GraphClientCmdlet
    {
