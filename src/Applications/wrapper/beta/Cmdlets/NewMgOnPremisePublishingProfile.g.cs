...
{
    [GraphRoute("POST", "/onPremisesPublishingProfiles")]
    [Cmdlet(VerbsCommon.New, "MgOnPremisePublishingProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesPublishingProfile))]
    public class NewMgOnPremisePublishingProfileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(HybridAgentUpdaterConfiguration)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles.PostAsync(body, requestConfiguration =>
                {
