...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/agents/{onPremisesAgent-id}/agentGroups/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfileAgentGroupByRef")]
    [OutputType(typeof(string))]
    public class GetMgOnPremisePublishingProfileAgentGroupByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].Agents[OnPremisesAgentId].AgentGroups.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].Agents[OnPremisesAgentId].AgentGroups.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
