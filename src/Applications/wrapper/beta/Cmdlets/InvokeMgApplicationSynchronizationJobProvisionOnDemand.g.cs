...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationSynchronizationJobProvisionOnDemand", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.StringKeyStringValuePair))]
    public class InvokeMgApplicationSynchronizationJobProvisionOnDemandCommand : GraphClientCmdlet
    {
