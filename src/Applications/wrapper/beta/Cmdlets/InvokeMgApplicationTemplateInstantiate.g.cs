...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationTemplateInstantiate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ApplicationServicePrincipal))]
    public class InvokeMgApplicationTemplateInstantiateCommand : GraphClientCmdlet
    {
