...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/publishedResources/{publishedResource-id}/agentGroups/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfilePublishedResourceAgentGroupByRef")]
    [OutputType(typeof(string))]
    public class GetMgOnPremisePublishingProfilePublishedResourceAgentGroupByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].PublishedResources[PublishedResourceId].AgentGroups.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].PublishedResources[PublishedResourceId].AgentGroups.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
