...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgServicePrincipalSynchronizationJobValidateCredentials", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgServicePrincipalSynchronizationJobValidateCredentialsCommand : GraphClientCmdlet
    {
