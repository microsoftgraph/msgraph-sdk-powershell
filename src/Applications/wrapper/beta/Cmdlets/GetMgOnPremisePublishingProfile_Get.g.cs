...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfile_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesPublishingProfile))]
    public class GetMgOnPremisePublishingProfile_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].GetAsync(requestConfiguration =>
                {
