...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationSynchronizationJobStart", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgApplicationSynchronizationJobStartCommand : GraphClientCmdlet
    {
