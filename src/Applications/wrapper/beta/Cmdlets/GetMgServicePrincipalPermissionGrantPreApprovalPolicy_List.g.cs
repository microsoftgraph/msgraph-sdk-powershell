...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/permissionGrantPreApprovalPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalPermissionGrantPreApprovalPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.PermissionGrantPreApprovalPolicy))]
    public class GetMgServicePrincipalPermissionGrantPreApprovalPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.PermissionGrantPreApprovalPolicyCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].PermissionGrantPreApprovalPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].PermissionGrantPreApprovalPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
