...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class NewMgServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public global::System.DateTimeOffset? PreferredTokenSigningKeyEndDateTime { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Applications.Client.Models.PasswordSingleSignOnSettings? PasswordSingleSignOnSettings { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Applications.Client.Models.PermissionScope[]? PublishedPermissionScopes { get; set; }
    ...
    if (this.IsParameterBound(nameof(ErrorUrl)))
    ...
    if (this.IsParameterBound(nameof(PreferredTokenSigningKeyEndDateTime)))
        body.PreferredTokenSigningKeyEndDateTime = PreferredTokenSigningKeyEndDateTime;
    ...
    if (this.IsParameterBound(nameof(PasswordSingleSignOnSettings)))
        body.PasswordSingleSignOnSettings = PasswordSingleSignOnSettings;

    if (this.IsParameterBound(nameof(PublishedPermissionScopes)))
        body.PublishedPermissionScopes = PublishedPermissionScopes!.ToList();
