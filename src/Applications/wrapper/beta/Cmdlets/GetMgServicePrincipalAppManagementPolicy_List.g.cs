...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalAppManagementPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.AppManagementPolicy))]
    public class GetMgServicePrincipalAppManagementPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.AppManagementPolicyCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].AppManagementPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].AppManagementPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
