...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerAsUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.User))]
    public class GetMgServicePrincipalOwnerAsUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners.GraphUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].Owners.GraphUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
