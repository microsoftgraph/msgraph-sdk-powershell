...
{
    [GraphRoute("POST", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/agentGroups/{onPremisesAgentGroup-id}/agents")]
    [Cmdlet(VerbsCommon.New, "MgOnPremisePublishingProfileAgentGroupAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesAgent))]
    public class NewMgOnPremisePublishingProfileAgentGroupAgentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SupportedPublishingTypes)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].AgentGroups[OnPremisesAgentGroupId].Agents.PostAsync(body, requestConfiguration =>
                {
