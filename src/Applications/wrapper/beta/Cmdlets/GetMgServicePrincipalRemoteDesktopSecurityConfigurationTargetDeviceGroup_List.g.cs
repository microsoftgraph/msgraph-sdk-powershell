...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.TargetDeviceGroup))]
    public class GetMgServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.TargetDeviceGroupCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].RemoteDesktopSecurityConfiguration.TargetDeviceGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].RemoteDesktopSecurityConfiguration.TargetDeviceGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
