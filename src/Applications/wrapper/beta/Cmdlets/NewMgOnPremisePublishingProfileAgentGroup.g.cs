...
{
    [GraphRoute("POST", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/agentGroups")]
    [Cmdlet(VerbsCommon.New, "MgOnPremisePublishingProfileAgentGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesAgentGroup))]
    public class NewMgOnPremisePublishingProfileAgentGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PublishingType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].AgentGroups.PostAsync(body, requestConfiguration =>
                {
