...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgServicePrincipalCheckMemberGroups", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgServicePrincipalCheckMemberGroupsCommand : GraphClientCmdlet
    {
