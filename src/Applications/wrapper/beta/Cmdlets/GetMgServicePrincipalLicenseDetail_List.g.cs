...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/licenseDetails")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalLicenseDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.LicenseDetails))]
    public class GetMgServicePrincipalLicenseDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.LicenseDetailsCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].LicenseDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].LicenseDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
