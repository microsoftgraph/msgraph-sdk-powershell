...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationUnsetVerifiedPublisher", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgApplicationUnsetVerifiedPublisherCommand : GraphClientCmdlet
    {
