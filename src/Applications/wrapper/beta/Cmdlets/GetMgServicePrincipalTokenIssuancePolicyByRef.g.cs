...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalTokenIssuancePolicyByRef")]
    [OutputType(typeof(string))]
    public class GetMgServicePrincipalTokenIssuancePolicyByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.StringCollectionResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].TokenIssuancePolicies.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].TokenIssuancePolicies.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
