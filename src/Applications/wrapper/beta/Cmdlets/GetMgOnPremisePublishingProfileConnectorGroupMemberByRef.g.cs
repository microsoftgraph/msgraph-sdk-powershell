...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/connectorGroups/{connectorGroup-id}/members/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfileConnectorGroupMemberByRef")]
    [OutputType(typeof(string))]
    public class GetMgOnPremisePublishingProfileConnectorGroupMemberByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].ConnectorGroups[ConnectorGroupId].Members.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].ConnectorGroups[ConnectorGroupId].Members.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
