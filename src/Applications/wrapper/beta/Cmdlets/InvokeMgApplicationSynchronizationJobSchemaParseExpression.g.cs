...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationSynchronizationJobSchemaParseExpression", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ParseExpressionResponse))]
    public class InvokeMgApplicationSynchronizationJobSchemaParseExpressionCommand : GraphClientCmdlet
    {
