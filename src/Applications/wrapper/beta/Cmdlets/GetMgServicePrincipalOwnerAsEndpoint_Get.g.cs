...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalOwnerAsEndpoint_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.Endpoint))]
    public class GetMgServicePrincipalOwnerAsEndpoint_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Owners[DirectoryObjectId].GraphEndpoint.GetAsync(requestConfiguration =>
                {
