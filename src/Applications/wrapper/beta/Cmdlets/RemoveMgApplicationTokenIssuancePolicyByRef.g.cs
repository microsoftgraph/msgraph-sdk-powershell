...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Remove, "MgApplicationTokenIssuancePolicyByRef", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    public class RemoveMgApplicationTokenIssuancePolicyByRefCommand : GraphClientCmdlet
    {
