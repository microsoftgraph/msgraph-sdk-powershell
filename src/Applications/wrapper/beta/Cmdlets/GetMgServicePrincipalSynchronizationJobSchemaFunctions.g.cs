...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalSynchronizationJobSchemaFunctions")]
    ...
    public class GetMgServicePrincipalSynchronizationJobSchemaFunctionsCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Applications.Client.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Functions.FunctionsGetResponse? result;
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].Synchronization.Jobs[SynchronizationJobId].Schema.Functions.GetAsFunctionsGetResponseAsync(requestConfiguration =>
                {
