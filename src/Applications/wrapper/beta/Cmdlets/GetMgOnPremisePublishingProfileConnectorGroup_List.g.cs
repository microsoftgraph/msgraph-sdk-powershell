...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfileConnectorGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ConnectorGroup))]
    public class GetMgOnPremisePublishingProfileConnectorGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].ConnectorGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].ConnectorGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
