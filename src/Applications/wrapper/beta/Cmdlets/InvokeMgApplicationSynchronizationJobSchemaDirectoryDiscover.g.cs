...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationSynchronizationJobSchemaDirectoryDiscover", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.DirectoryDefinition))]
    public class InvokeMgApplicationSynchronizationJobSchemaDirectoryDiscoverCommand : GraphClientCmdlet
    {
