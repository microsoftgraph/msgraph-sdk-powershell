...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    public class NewMgApplicationCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesPublishing? OnPremisesPublishing { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Applications.Client.Models.SignInAudienceRestrictionsBase? SignInAudienceRestrictions { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Applications.Client.Models.WindowsApplication? Windows { get; set; }
    ...
    if (this.IsParameterBound(nameof(OnPremisesPublishing)))
        body.OnPremisesPublishing = OnPremisesPublishing;
    ...
    if (this.IsParameterBound(nameof(SignInAudienceRestrictions)))
        body.SignInAudienceRestrictions = SignInAudienceRestrictions;
    ...
    if (this.IsParameterBound(nameof(Windows)))
