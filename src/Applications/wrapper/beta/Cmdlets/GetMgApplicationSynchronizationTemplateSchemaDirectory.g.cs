...
{
    [GraphRoute("GET", "/applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/directories")]
    [Cmdlet(VerbsCommon.Get, "MgApplicationSynchronizationTemplateSchemaDirectory", DefaultParameterSetName = "List")]
    ...
    public class GetMgApplicationSynchronizationTemplateSchemaDirectoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgApplicationSynchronizationTemplateSchemaDirectory_Get or Get-MgApplicationSynchronizationTemplateSchemaDirectory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgApplicationSynchronizationTemplateSchemaDirectory_Get" : "Get-MgApplicationSynchronizationTemplateSchemaDirectory_List";
            try
            {
