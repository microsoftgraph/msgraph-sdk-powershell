...
{
    [GraphRoute("POST", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/publishedResources")]
    [Cmdlet(VerbsCommon.New, "MgOnPremisePublishingProfilePublishedResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.PublishedResource))]
    public class NewMgOnPremisePublishingProfilePublishedResourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PublishingType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].PublishedResources.PostAsync(body, requestConfiguration =>
                {
