...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/connectors/{connector-id}/memberOf")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfileConnectorMemberOf")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.ConnectorGroup))]
    public class GetMgOnPremisePublishingProfileConnectorMemberOfCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Applications.Client.Models.ConnectorGroupCollectionResponse? result;
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].Connectors[ConnectorId].MemberOf.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].Connectors[ConnectorId].MemberOf.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
