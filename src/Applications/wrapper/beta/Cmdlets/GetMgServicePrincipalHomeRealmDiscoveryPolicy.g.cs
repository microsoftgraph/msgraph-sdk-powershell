...
{
    [GraphRoute("GET", "/servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgServicePrincipalHomeRealmDiscoveryPolicy")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.HomeRealmDiscoveryPolicy))]
    public class GetMgServicePrincipalHomeRealmDiscoveryPolicyCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.ServicePrincipals[ServicePrincipalId].HomeRealmDiscoveryPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.ServicePrincipals[ServicePrincipalId].HomeRealmDiscoveryPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
