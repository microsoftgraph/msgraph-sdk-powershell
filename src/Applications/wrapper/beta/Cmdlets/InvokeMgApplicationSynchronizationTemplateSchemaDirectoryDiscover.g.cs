...
namespace Microsoft.Graph.PowerShell.Applications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgApplicationSynchronizationTemplateSchemaDirectoryDiscover", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.DirectoryDefinition))]
    public class InvokeMgApplicationSynchronizationTemplateSchemaDirectoryDiscoverCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(DirectoryDefinitionId, "Invoke"))
                return;
