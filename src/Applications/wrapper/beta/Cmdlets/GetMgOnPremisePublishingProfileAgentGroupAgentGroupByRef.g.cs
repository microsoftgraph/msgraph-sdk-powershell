...
{
    [GraphRoute("GET", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/agentGroups/{onPremisesAgentGroup-id}/agents/{onPremisesAgent-id}/agentGroups/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgOnPremisePublishingProfileAgentGroupAgentGroupByRef")]
    [OutputType(typeof(string))]
    public class GetMgOnPremisePublishingProfileAgentGroupAgentGroupByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].AgentGroups[OnPremisesAgentGroupId].Agents[OnPremisesAgentId].AgentGroups.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].AgentGroups[OnPremisesAgentGroupId].Agents[OnPremisesAgentId].AgentGroups.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
