...
{
    [GraphRoute("POST", "/onPremisesPublishingProfiles/{onPremisesPublishingProfile-id}/agentGroups/{onPremisesAgentGroup-id}/publishedResources/{publishedResource-id}/agentGroups")]
    [Cmdlet(VerbsCommon.New, "MgOnPremisePublishingProfileAgentGroupPublishedResourceAgentGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Applications.Client.Models.OnPremisesAgentGroup))]
    public class NewMgOnPremisePublishingProfileAgentGroupPublishedResourceAgentGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PublishingType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.OnPremisesPublishingProfiles[OnPremisesPublishingProfileId].AgentGroups[OnPremisesAgentGroupId].PublishedResources[PublishedResourceId].AgentGroups.PostAsync(body, requestConfiguration =>
                {
