...
### List (Default)
```
Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment [-Count] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment -AppRoleAssignmentId <String>
