...
### List (Default)
```
Get-MgUserAppRoleAssignment -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserAppRoleAssignment -AppRoleAssignmentId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserAppRoleAssignment -InputObject <IIdentityAppRoleAssignmentsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
