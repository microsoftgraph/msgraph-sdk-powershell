...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgUserOnenotePageParentNotebookSectionGroup.Recording.json'
...
Describe 'New-MgUserOnenotePageParentNotebookSectionGroup' {
