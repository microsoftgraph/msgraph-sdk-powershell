...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgUserOnenotePageParentNotebookSectionGroup.Recording.json'
...
Describe 'Update-MgUserOnenotePageParentNotebookSectionGroup' {
