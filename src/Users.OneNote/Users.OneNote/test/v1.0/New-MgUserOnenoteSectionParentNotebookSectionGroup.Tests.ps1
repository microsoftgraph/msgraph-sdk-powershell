...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgUserOnenoteSectionParentNotebookSectionGroup.Recording.json'
...
Describe 'New-MgUserOnenoteSectionParentNotebookSectionGroup' {
