...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectionparentnotebooksection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionParentNotebookSection -OnenoteSectionId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionParentNotebookSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
