...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotenotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgUserOnenoteNotebookSectionParentSectionGroupParentNotebook -NotebookId <String>
...
```
Update-MgUserOnenoteNotebookSectionParentSectionGroupParentNotebook -NotebookId <String>
 -OnenoteSectionId <String> -UserId <String> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgUserOnenoteNotebookSectionParentSectionGroupParentNotebook -InputObject <IUsersOneNoteIdentity>
