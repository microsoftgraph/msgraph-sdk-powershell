...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionParentNotebook -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionParentNotebook -InputObject <IUsersOneNoteIdentity>
