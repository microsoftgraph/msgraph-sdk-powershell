...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPageParentNotebook -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <IUsersOneNoteIdentity>
