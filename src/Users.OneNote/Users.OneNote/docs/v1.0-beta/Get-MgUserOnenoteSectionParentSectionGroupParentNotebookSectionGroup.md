...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionParentSectionGroupParentNotebookSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
