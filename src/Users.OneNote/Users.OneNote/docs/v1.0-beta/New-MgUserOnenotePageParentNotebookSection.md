...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotepageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgUserOnenotePageParentNotebookSection -OnenotePageId <String> -UserId <String>
...
### CreateViaIdentity1
```
New-MgUserOnenotePageParentNotebookSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
