...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotepageparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgUserOnenotePageParentSectionGroupSection -OnenotePageId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenotePageParentSectionGroupSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
