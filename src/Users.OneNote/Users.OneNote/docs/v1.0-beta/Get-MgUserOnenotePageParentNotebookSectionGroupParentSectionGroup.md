...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgUserOnenotePageParentNotebookSectionGroupParentSectionGroup -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenotePageParentNotebookSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity>
