...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotenotebooksectiongroup
schema: 2.0.0
---
...
### Create
```
New-MgUserOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
