...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPageParentSection -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionPageParentSection -InputObject <IUsersOneNoteIdentity>
