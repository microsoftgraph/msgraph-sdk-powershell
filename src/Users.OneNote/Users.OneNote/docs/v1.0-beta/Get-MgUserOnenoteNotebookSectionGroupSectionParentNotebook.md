...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionGroupSectionParentNotebook -NotebookId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionGroupSectionParentNotebook -InputObject <IUsersOneNoteIdentity>
