...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -OnenotePageId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
