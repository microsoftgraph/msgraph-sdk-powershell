...
### List1 (Default)
```
Get-MgUserOnenoteOperation -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgUserOnenoteOperation -InputObject <IUsersOneNoteIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
