...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotesectiongroupparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgUserOnenoteSectionGroupParentNotebookSectionParentNotebook -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgUserOnenoteSectionGroupParentNotebookSectionParentNotebook -InputObject <IUsersOneNoteIdentity>
