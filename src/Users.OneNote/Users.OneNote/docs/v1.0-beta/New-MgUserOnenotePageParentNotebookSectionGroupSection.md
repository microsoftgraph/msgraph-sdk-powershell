...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgUserOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -SectionGroupId <String>
...
### CreateViaIdentity1
```
New-MgUserOnenotePageParentNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity>
