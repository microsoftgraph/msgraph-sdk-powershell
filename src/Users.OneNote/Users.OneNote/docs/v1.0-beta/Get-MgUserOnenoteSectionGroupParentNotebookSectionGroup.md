...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionGroup -SectionGroupId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionGroup -SectionGroupId <String> -SectionGroupId1 <String>
 -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
