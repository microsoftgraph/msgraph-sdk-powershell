...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
