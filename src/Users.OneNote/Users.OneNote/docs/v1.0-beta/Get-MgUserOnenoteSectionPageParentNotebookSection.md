...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionPageParentNotebookSection -InputObject <IUsersOneNoteIdentity>
