...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupsectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroupSectionPage -OnenoteSectionId <String> -SectionGroupId <String> -UserId <String>
...
### Get
```
Get-MgUserOnenoteSectionGroupSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionPage -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
