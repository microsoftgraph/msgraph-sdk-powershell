...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionParentSectionGroup -InputObject <IUsersOneNoteIdentity>
