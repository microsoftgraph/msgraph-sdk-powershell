...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionGroupParentSectionGroup -NotebookId <String> -SectionGroupId <String>
 -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity>
