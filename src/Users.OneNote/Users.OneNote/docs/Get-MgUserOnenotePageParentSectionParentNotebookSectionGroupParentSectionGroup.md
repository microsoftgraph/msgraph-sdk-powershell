...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentsectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -OnenotePageId <String>
...
```
Get-MgUserOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup
 -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
