...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotenotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgUserOnenoteNotebookSectionGroupSection -NotebookId <String> -SectionGroupId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
