...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
New-MgUserOnenoteNotebookSectionParentSectionGroup -NotebookId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionParentSectionGroup -InputObject <IUsersOneNoteIdentity>
