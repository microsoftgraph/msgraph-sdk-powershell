...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgUserOnenoteSectionGroupParentNotebookSectionPageParentNotebook -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgUserOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
