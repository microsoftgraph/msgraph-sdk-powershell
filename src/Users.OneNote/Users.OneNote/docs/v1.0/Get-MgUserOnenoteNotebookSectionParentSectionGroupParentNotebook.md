...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionParentSectionGroupParentNotebook -NotebookId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionParentSectionGroupParentNotebook -InputObject <IUsersOneNoteIdentity>
