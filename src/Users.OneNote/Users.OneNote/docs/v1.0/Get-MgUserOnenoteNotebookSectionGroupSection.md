...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserOnenoteNotebookSectionGroupSection -NotebookId <String> -SectionGroupId <String> -UserId <String>
...
### Get1
```
Get-MgUserOnenoteNotebookSectionGroupSection -NotebookId <String> -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenoteNotebookSectionGroupSection -InputObject <IUsersOneNoteIdentity> [-ExpandProperty <String[]>]
