...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSectionGroup -OnenotePageId <String> -UserId <String>
...
### Get1
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSectionGroup -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSectionGroup -InputObject <IUsersOneNoteIdentity>
