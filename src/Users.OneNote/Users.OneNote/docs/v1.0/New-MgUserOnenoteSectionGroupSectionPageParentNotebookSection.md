...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionGroupSectionPageParentNotebookSection -OnenotePageId <String>
...
### CreateViaIdentity1
```
New-MgUserOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
