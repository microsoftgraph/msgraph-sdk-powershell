...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgUserOnenotePageParentNotebookSectionParentSectionGroupParentNotebook -OnenotePageId <String>
