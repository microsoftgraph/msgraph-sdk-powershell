...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgUserOnenoteSectionParentNotebookSectionGroupParentSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionParentNotebookSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity>
