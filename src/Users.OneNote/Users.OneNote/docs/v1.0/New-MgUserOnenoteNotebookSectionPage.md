...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotenotebooksectionpage
schema: 2.0.0
---
...
```
New-MgUserOnenoteNotebookSectionPage -NotebookId <String> -OnenoteSectionId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionPage -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOnenoteNotebookSectionPage -InputObject <IUsersOneNoteIdentity> [-ContentInputFile <String>]
