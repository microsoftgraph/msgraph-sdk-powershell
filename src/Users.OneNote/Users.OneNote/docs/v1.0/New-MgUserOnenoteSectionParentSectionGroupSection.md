...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/new-mguseronenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgUserOnenoteSectionParentSectionGroupSection -OnenoteSectionId <String> -UserId <String>
...
### CreateViaIdentity1
```
New-MgUserOnenoteSectionParentSectionGroupSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
