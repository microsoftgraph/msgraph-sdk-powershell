...
### List1 (Default)
```
Get-MgUserOnenoteSectionPage -OnenoteSectionId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionPage -InputObject <IUsersOneNoteIdentity> [-ExpandProperty <String[]>]
