...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -InputObject <IUsersOneNoteIdentity>
