...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionParentSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionGroupParentNotebookSectionParentSectionGroup -InputObject <IUsersOneNoteIdentity>
