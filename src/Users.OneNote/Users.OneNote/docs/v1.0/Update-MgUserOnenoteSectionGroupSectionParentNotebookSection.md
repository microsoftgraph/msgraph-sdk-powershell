...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/update-mguseronenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgUserOnenoteSectionGroupSectionParentNotebookSection -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgUserOnenoteSectionGroupSectionParentNotebookSection -InputObject <IUsersOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
