...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenotePageParentNotebookSection -OnenotePageId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUserOnenotePageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSection -InputObject <IUsersOneNoteIdentity> [-ExpandProperty <String[]>]
