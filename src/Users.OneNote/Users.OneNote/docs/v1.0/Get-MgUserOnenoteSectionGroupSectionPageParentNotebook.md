...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionGroupSectionPageParentNotebook -InputObject <IUsersOneNoteIdentity>
