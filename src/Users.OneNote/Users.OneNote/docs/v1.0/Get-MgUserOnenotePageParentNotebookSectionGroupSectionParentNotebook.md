...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenotePageParentNotebookSectionGroupSectionParentNotebook -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionGroupSectionParentNotebook -InputObject <IUsersOneNoteIdentity>
