...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotenotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteNotebookSectionPageParentNotebook -NotebookId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionPageParentNotebook -InputObject <IUsersOneNoteIdentity>
