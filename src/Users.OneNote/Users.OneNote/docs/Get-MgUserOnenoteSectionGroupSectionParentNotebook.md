...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserOnenoteSectionGroupSectionParentNotebook -OnenoteSectionId <String> -SectionGroupId <String>
 -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionParentNotebook -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
