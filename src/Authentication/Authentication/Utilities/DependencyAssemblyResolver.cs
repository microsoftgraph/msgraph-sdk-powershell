...
namespace Microsoft.Graph.PowerShell.Authentication.Utilities
{
    public static class DependencyAssemblyResolver
    {
        ...
        {
            { "Azure.Core", new Version("1.24.0") },
            { "Azure.Identity", new Version("1.6.0") },
            { "Microsoft.Identity.Client", new Version("4.43.1") },
            { "Microsoft.Identity.Client.Extensions.Msal", new Version("2.20.0") },
            { "Microsoft.IdentityModel.JsonWebTokens", new Version("6.17.0") },
            { "Microsoft.IdentityModel.Logging", new Version("6.17.0") },
            { "Microsoft.IdentityModel.Tokens", new Version("6.17.0") },
            { "System.IdentityModel.Tokens.Jwt", new Version("6.17.0") },
            { "System.Security.Cryptography.ProtectedData", new Version("6.0.0") },
            { "Newtonsoft.Json", new Version("13.0.1") },
            { "System.Text.Json", new Version("6.0.3") },
