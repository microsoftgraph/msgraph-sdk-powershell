...
namespace Microsoft.Graph.PowerShell.Authentication.Utilities
{
    public static class DependencyAssemblyResolver
    {
        ...
        private static IReadOnlyDictionary<string, Version> Dependencies = new Dictionary<string, Version>
        {
            ...
            { "Microsoft.IdentityModel.JsonWebTokens", new Version("6.21.0") },
            { "Microsoft.IdentityModel.Logging", new Version("6.21.0") },
            { "Microsoft.IdentityModel.Tokens", new Version("6.21.0") },
            { "System.IdentityModel.Tokens.Jwt", new Version("6.21.0") },
