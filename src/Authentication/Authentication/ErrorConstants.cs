...
namespace Microsoft.Graph.PowerShell.Authentication
{
    public static class ErrorConstants
    {
        ...
        {
            public const string CannotModifyBuiltInEnvironment = "Cannot {0} built-in environment {1}.";
            public const string InvalidUrlParameter = "Parameter '{0}' has an invalid endpoint URL. Please use a valid URL with a network protocol i.e. [protocol]://[resource-name].";
