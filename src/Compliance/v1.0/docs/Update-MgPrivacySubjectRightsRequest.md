...
Update-MgPrivacySubjectRightsRequest -SubjectRightsRequestId <String> [-AdditionalProperties <Hashtable>]
 [-AssignedTo <IMicrosoftGraphIdentity>] [-ClosedDateTime <DateTime>]
...
Update-MgPrivacySubjectRightsRequest -SubjectRightsRequestId <String>
 -BodyParameter <IMicrosoftGraphSubjectRightsRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSubjectRightsRequestHistory[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
