...
```
Update-MgBetaComplianceEdiscoveryCaseLegalHoldUserSource -CaseId <String> -LegalHoldId <String>
 -UserSourceId <String> -BodyParameter <IMicrosoftGraphEdiscoveryUserSource> [-Headers <IDictionary>]
...
Update-MgBetaComplianceEdiscoveryCaseLegalHoldUserSource -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphEdiscoveryUserSource> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
