...
```
Update-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSource -CustodianId <String> -EdiscoveryCaseId <String>
...
```
Update-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSource -CustodianId <String> -EdiscoveryCaseId <String>
 -UnifiedGroupSourceId <String> -BodyParameter <IMicrosoftGraphUnifiedGroupSource> [-PassThru] [-WhatIf]
...
```
Update-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSource -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedGroupSource> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
