...
```
New-MgComplianceEdiscoveryCaseCustodianSiteSource -CustodianId <String> -EdiscoveryCaseId <String>
...
```
New-MgComplianceEdiscoveryCaseCustodianSiteSource -CustodianId <String> -EdiscoveryCaseId <String>
 -BodyParameter <IMicrosoftGraphSiteSource> [-WhatIf] [-Confirm] [<CommonParameters>]
```
