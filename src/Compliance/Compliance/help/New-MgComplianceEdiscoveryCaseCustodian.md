...
```
New-MgComplianceEdiscoveryCaseCustodian -EdiscoveryCaseId <String> [-AcknowledgedDateTime <DateTime>]
 [-AdditionalProperties <Hashtable>] [-ApplyHoldToSources] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Email <String>] [-Id <String>]
...
### Create
```
New-MgComplianceEdiscoveryCaseCustodian -EdiscoveryCaseId <String> -BodyParameter <IMicrosoftGraphCustodian>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
New-MgComplianceEdiscoveryCaseCustodian -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphCustodian> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Read-only.
  ...
  \[Status \<String\>\]: custodianStatus
  \[UnifiedGroupSources \<IMicrosoftGraphUnifiedGroupSource\[\]\>\]: 
    \[CreatedBy \<IMicrosoftGraphIdentitySet\>\]: identitySet
    \[CreatedDateTime \<DateTime?\>\]: 
    \[DisplayName \<String\>\]: 
    \[Id \<String\>\]: Read-only.
...
The directoryObject type is the base type for many other directory entity types.
  ...
  \[UserSources \<IMicrosoftGraphUserSource\[\]\>\]: 
    \[CreatedBy \<IMicrosoftGraphIdentitySet\>\]: identitySet
    \[CreatedDateTime \<DateTime?\>\]: 
    \[DisplayName \<String\>\]: 
    \[Id \<String\>\]: Read-only.
