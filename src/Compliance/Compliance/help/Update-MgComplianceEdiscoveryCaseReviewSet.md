...
Update-MgComplianceEdiscoveryCaseReviewSet -EdiscoveryCaseId <String> -ReviewSetId <String>
 ...
 [-DisplayName <String>] [-Id <String>] [-Queries <IMicrosoftGraphReviewSetQuery[]>] [-PassThru] [-WhatIf]
...
```
Update-MgComplianceEdiscoveryCaseReviewSet -EdiscoveryCaseId <String> -ReviewSetId <String>
 -BodyParameter <IMicrosoftGraphReviewSet> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
