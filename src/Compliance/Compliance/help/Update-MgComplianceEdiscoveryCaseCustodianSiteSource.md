...
```
Update-MgComplianceEdiscoveryCaseCustodianSiteSource -CustodianId <String> -EdiscoveryCaseId <String>
...
```
Update-MgComplianceEdiscoveryCaseCustodianSiteSource -CustodianId <String> -EdiscoveryCaseId <String>
 -SiteSourceId <String> -BodyParameter <IMicrosoftGraphSiteSource> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgComplianceEdiscoveryCaseCustodianSiteSource -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphSiteSource> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
BODYPARAMETER \<IMicrosoftGraphSiteSource\>: siteSource
