...
```
New-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSource -CustodianId <String> -EdiscoveryCaseId <String>
...
```
New-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSource -CustodianId <String> -EdiscoveryCaseId <String>
 -BodyParameter <IMicrosoftGraphUnifiedGroupSource> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUnifiedGroupSource
## OUTPUTS
...
BODYPARAMETER \<IMicrosoftGraphUnifiedGroupSource\>: unifiedGroupSource
...
For example, if a user changes their display name, the API may show the new value in a future response, but the items associated with the user won't show up as having changed when using delta.
  ...
  \[DisplayName \<String\>\]: 
  \[Id \<String\>\]: Read-only.
  \[Group \<IMicrosoftGraphGroup\>\]: Represents an Azure Active Directory object.
The directoryObject type is the base type for many other directory entity types.
    \[(Any) \<Object\>\]: This indicates any property can be added to this object.
...
Supports $filter (eq only).
    \[AssignedLabels \<IMicrosoftGraphAssignedLabel\[\]\>\]: The list of sensitivity label pairs (label ID, label name) associated with an Microsoft 365 group.
Returned only on $select.
Read-only.
...
Nullable.
        ...
        \[LastDeliveredDateTime \<DateTime?\>\]: The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time.
For example, midnight UTC on Jan 1, 2014 would look like this: '2014-01-01T00:00:00Z'
        \[Posts \<IMicrosoftGraphPost\[\]\>\]: Read-only.
Nullable.
          \[Categories \<String\[\]\>\]: The categories associated with the item
          \[ChangeKey \<String\>\]: Identifies the version of the item.
Every time the item is changed, changeKey changes as well.
...
Returned only on $select.
Supports $filter.
        \[EmployeeType \<String\>\]: Captures enterprise worker type: Employee, Contractor, Consultant, Vendor, etc.
Returned only on $select.
Supports $filter.
...
Returned only on $select.
Supports $filter with the supported values.
...
Required.
              \[IsActive \<Boolean?\>\]: Indicates whether the schedulingGroup can be used when creating new entities or updating existing ones.
Required.
...
Possible values:'User' - service plan can be assigned to individual users.'Company' - service plan can be assigned to the entire tenant.
            \[ProvisioningStatus \<String\>\]: The provisioning status of the service plan.
Possible values:'Success' - Service is fully provisioned.'Disabled' - Service has been disabled.'PendingInput' - Service is not yet provisioned; awaiting service confirmation.'PendingActivation' - Service is provisioned but requires explicit activation by administrator (for example, Intune_O365 service plan)'PendingProvisioning' - Microsoft has added a new service to the product SKU and it has not been activated in the tenant, yet.
...
Not guaranteed to relate apps in all conditions.
          ...
          \[FlaggedReasons \<String\[\]\>\]: Zero or more reasons an app registration is flagged.
E.g.
...
This property is read-only.
          \[AzureActiveDirectoryDeviceId \<String\>\]: The unique identifier for the Azure Active Directory device.
Read only.
This property is read-only.
...
Read-only
          ...
          \[DeviceCategory \<IMicrosoftGraphDeviceCategory1\>\]: Device categories provides a way to organize your devices.
...
(Namespace version)
          ...
          \[EthernetMacAddress \<String\>\]: Ethernet MAC.
This property is read-only.
...
Can be overwritten to a user friendly name.
          ...
          \[ManagementCertificateExpirationDate \<DateTime?\>\]: Reports device management certificate expiration date.
This property is read-only.
...
Windows, iOS, etc.
          ...
          \[PhoneNumber \<String\>\]: Phone number of the device
          \[PhysicalMemoryInBytes \<Int64?\>\]: Total Memory in Bytes.
This property is read-only.
          \[PreferMdmOverGroupPolicyAppliedDateTime \<DateTime?\>\]: Reports the DateTime the preferMdmOverGroupPolicy setting was set. 
...
This property is read-only.
          \[RetireAfterDateTime \<DateTime?\>\]: Indicates the time after when a device will be auto retired because of scheduled action.
This property is read-only.
          ...
          \[SkuNumber \<Int32?\>\]: Device sku number, see also: https://docs.microsoft.com/en-us/windows/win32/api/sysinfoapi/nf-sysinfoapi-getproductinfo.
Valid values 0 to 2147483647.
This property is read-only.
...
This property is read-only.
          ...
          \[UsersLoggedOn \<IMicrosoftGraphLoggedOnUser\[\]\>\]: Indicates the last logged on users of a device.
This property is read-only.
...
By default, a strong password is required.
        ...
        \[PendingAccessReviewInstances \<IMicrosoftGraphAccessReviewInstance\[\]\>\]: 
          \[Id \<String\>\]: Read-only.
...
Not nullable.
        ...
        \[ProxyAddresses \<String\[\]\>\]: For example: \['SMTP: bob@contoso.com', 'smtp: bob@sales.contoso.com'\] The any operator is required for filter expressions on multi-valued properties.
Read-only, Not nullable.
Supports $filter.
...
For example, midnight UTC on Jan 1, 2014 would look like this: '2014-01-01T00:00:00Z'
        ...
        \[ShowInAddressList \<Boolean?\>\]: true if the Outlook global address list should contain this user, otherwise false.
...
Nullable.
              \[Id \<String\>\]: Read-only.
              \[Body \<IMicrosoftGraphItemBody\>\]: itemBody
              \[BodyLastModifiedDateTime \<DateTime?\>\]: The date and time when the task was last modified.
...
Read-only.
Nullable.
    \[Members \<IMicrosoftGraphDirectoryObject\[\]\>\]: Users and groups that are members of this group.
HTTP Methods: GET (supported for all groups), POST (supported for Microsoft 365 groups, security groups and mail-enabled security groups), DELETE (supported for Microsoft 365 groups and security groups) Nullable.
...
Returned by default.
    \[PreferredLanguage \<String\>\]: The preferred language for an Microsoft 365 group.
Should follow ISO 639-1 Code; for example 'en-US'.
Returned by default.
...
Returned by default.
    \[Settings \<IMicrosoftGraphDirectorySetting\[\]\>\]: Read-only.
Nullable.
      \[Id \<String\>\]: Read-only.
      \[DisplayName \<String\>\]: 
      \[TemplateId \<String\>\]: 
...
Access the default site with /sites/root.
    ...
    \[Theme \<String\>\]: Specifies an Microsoft 365 group's color theme.
...
Returned only on $select.
    ...
    \[Visibility \<String\>\]: Specifies the visibility of a Microsoft 365 group.
