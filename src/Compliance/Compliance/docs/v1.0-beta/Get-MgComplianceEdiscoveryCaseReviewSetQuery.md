...
### List (Default)
```
Get-MgComplianceEdiscoveryCaseReviewSetQuery -CaseId <String> -ReviewSetId <String> [-Count]
...
### Example 1: Using the Get-MgComplianceEdiscoveryCaseReviewSetQuery Cmdlet
```powershell
