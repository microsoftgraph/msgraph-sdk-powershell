...
### Reset (Default)
```
Reset-MgComplianceEdiscoveryCaseSettingToDefault -CaseId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgComplianceEdiscoveryCaseSettingToDefault -InputObject <IComplianceIdentity> [-PassThru] [-WhatIf]
