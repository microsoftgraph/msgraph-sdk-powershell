...
{
    [GraphRoute("PATCH", "/privacy/subjectRightsRequests/{subjectRightsRequest-id}/collaborators/{user-id}/mailboxSettings")]
    [Cmdlet(VerbsData.Update, "MgPrivacySubjectRightsRequestCollaboratorMailboxSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.MailboxSettings))]
    public class UpdateMgPrivacySubjectRightsRequestCollaboratorMailboxSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(WorkingHours)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Collaborators[UserId].MailboxSettings.PatchAsync(body, requestConfiguration =>
                {
