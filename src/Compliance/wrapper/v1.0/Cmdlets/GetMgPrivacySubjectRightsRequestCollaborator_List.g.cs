...
namespace Microsoft.Graph.PowerShell.Compliance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequestCollaborator_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.User))]
    public class GetMgPrivacySubjectRightsRequestCollaborator_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Compliance.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Collaborators.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Collaborators.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
