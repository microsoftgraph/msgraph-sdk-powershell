...
{
    [GraphRoute("GET", "/compliance")]
    [Cmdlet(VerbsCommon.Get, "MgCompliance")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.Compliance))]
    public class GetMgComplianceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Compliance.GetAsync(requestConfiguration =>
                {
