...
{
    [GraphRoute("GET", "/privacy/subjectRightsRequests/{subjectRightsRequest-id}/approvers/{user-id}/serviceProvisioningErrors")]
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequestApproverServiceProvisioningError")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.ServiceProvisioningError))]
    public class GetMgPrivacySubjectRightsRequestApproverServiceProvisioningErrorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Compliance.Client.Models.ServiceProvisioningErrorCollectionResponse? result;
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Approvers[UserId].ServiceProvisioningErrors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Approvers[UserId].ServiceProvisioningErrors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
