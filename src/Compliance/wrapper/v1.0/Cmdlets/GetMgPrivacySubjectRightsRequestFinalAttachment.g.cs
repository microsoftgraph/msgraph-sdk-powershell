...
{
    [GraphRoute("GET", "/privacy/subjectRightsRequests/{subjectRightsRequest-id}/getFinalAttachment()")]
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequestFinalAttachment")]
    [OutputType(typeof(byte[]))]
    public class GetMgPrivacySubjectRightsRequestFinalAttachmentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].GetFinalAttachment.GetAsync(requestConfiguration =>
                {
