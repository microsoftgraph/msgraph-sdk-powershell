...
{
    [GraphRoute("GET", "/privacy/subjectRightsRequests/{subjectRightsRequest-id}/collaborators")]
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequestCollaborator", DefaultParameterSetName = "List")]
    ...
    public class GetMgPrivacySubjectRightsRequestCollaboratorCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPrivacySubjectRightsRequestCollaborator_Get or Get-MgPrivacySubjectRightsRequestCollaborator_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPrivacySubjectRightsRequestCollaborator_Get" : "Get-MgPrivacySubjectRightsRequestCollaborator_List";
            try
            {
