...
{
    [GraphRoute("GET", "/privacy/subjectRightsRequests")]
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.SubjectRightsRequest))]
    public class GetMgPrivacySubjectRightsRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Compliance.Client.Models.SubjectRightsRequestCollectionResponse? result;
            try
            {
                result = client.Privacy.SubjectRightsRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Privacy.SubjectRightsRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
