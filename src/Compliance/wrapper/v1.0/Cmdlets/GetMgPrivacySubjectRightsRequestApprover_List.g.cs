...
namespace Microsoft.Graph.PowerShell.Compliance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrivacySubjectRightsRequestApprover_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.User))]
    public class GetMgPrivacySubjectRightsRequestApprover_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Approvers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].Approvers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
