...
{
    [GraphRoute("PATCH", "/privacy/subjectRightsRequests/{subjectRightsRequest-id}")]
    [Cmdlet(VerbsData.Update, "MgPrivacySubjectRightsRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Compliance.Client.Models.SubjectRightsRequest))]
    public class UpdateMgPrivacySubjectRightsRequestCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Privacy.SubjectRightsRequests[SubjectRightsRequestId].PatchAsync(body, requestConfiguration =>
                {
