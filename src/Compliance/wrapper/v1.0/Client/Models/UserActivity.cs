...
namespace Microsoft.Graph.PowerShell.Compliance.Client.Models
{
    ...
    public partial class UserActivity : global::Microsoft.Graph.PowerShell.Compliance.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.ActivityHistoryItem>? HistoryItems { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.ActivityHistoryItem> HistoryItems { get; set; }
#endif
        ...
        public global::Microsoft.Graph.PowerShell.Compliance.Client.Models.Status? Status { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Compliance.Client.Models.VisualInfo? VisualElements { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Compliance.Client.Models.VisualInfo VisualElements { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Compliance.Client.Models.UserActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Compliance.Client.Models.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Compliance.Client.Models.UserActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "historyItems", n => { HistoryItems = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.ActivityHistoryItem>(global::Microsoft.Graph.PowerShell.Compliance.Client.Models.ActivityHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.Status>(); } },
                { "userTimezone", n => { UserTimezone = n.GetStringValue(); } },
                { "visualElements", n => { VisualElements = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.VisualInfo>(global::Microsoft.Graph.PowerShell.Compliance.Client.Models.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.ActivityHistoryItem>("historyItems", HistoryItems);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.Status>("status", Status);
            writer.WriteStringValue("userTimezone", UserTimezone);
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Compliance.Client.Models.VisualInfo>("visualElements", VisualElements);
        }
    }
}
