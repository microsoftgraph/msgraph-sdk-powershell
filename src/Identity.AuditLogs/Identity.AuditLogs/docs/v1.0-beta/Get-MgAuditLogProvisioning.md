...
### List (Default)
```
Get-MgAuditLogProvisioning [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgAuditLogProvisioning -InputObject <IIdentityAuditLogsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
