...
```
Update-MgAuditLogSignIn -SignInId <String> [-AppDisplayName <String>] [-AppId <String>]
...
### Update1
```
Update-MgAuditLogSignIn -SignInId <String> -BodyParameter <IMicrosoftGraphSignIn> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgAuditLogSignIn -InputObject <IIdentityAuditLogsIdentity> -BodyParameter <IMicrosoftGraphSignIn>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgAuditLogSignIn -InputObject <IIdentityAuditLogsIdentity> [-AppDisplayName <String>] [-AppId <String>]
 [-AppliedConditionalAccessPolicies <IMicrosoftGraphAppliedConditionalAccessPolicy[]>]
 [-ClientAppUsed <String>] [-ConditionalAccessStatus <String>] [-CorrelationId <String>]
 [-CreatedDateTime <DateTime>] [-DeviceDetailBrowser <String>] [-DeviceDetailDeviceId <String>]
 [-DeviceDetailDisplayName <String>] [-DeviceDetailIsCompliant] [-DeviceDetailIsManaged]
