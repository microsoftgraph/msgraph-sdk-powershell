...
### List1 (Default)
```
Get-MgAuditLogSignIn [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity1
```
Get-MgAuditLogSignIn -InputObject <IIdentityAuditLogsIdentity> [-ExpandProperty <String[]>]
