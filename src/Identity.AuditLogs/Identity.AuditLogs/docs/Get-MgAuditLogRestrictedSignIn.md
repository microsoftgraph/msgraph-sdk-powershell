...
### List (Default)
```
Get-MgAuditLogRestrictedSignIn [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgAuditLogRestrictedSignIn -RestrictedSignInId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAuditLogRestrictedSignIn -InputObject <IIdentityAuditLogsIdentity> [-Expand <String[]>]
