...
{
    [GraphRoute("POST", "/security/attackSimulation/endUserNotifications")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAttackSimulationEndUserNotification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.EndUserNotification))]
    public class NewMgSecurityAttackSimulationEndUserNotificationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.AttackSimulation.EndUserNotifications.PostAsync(body, requestConfiguration =>
                {
