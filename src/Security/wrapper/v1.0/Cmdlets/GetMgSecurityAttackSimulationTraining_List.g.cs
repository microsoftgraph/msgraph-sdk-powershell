...
{
    [GraphRoute("GET", "/security/attackSimulation/trainings")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationTraining_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Training))]
    public class GetMgSecurityAttackSimulationTraining_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.TrainingCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.Trainings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.Trainings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
