...
{
    [GraphRoute("GET", "/security/threatIntelligence/articleIndicators")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceArticleIndicator_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.ArticleIndicator))]
    public class GetMgSecurityThreatIntelligenceArticleIndicator_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.ArticleIndicatorCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.ArticleIndicators.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.ArticleIndicators.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
