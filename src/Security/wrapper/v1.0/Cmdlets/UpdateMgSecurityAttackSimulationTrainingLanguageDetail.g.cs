...
{
    [GraphRoute("PATCH", "/security/attackSimulation/trainings/{training-id}/languageDetails/{trainingLanguageDetail-id}")]
    [Cmdlet(VerbsData.Update, "MgSecurityAttackSimulationTrainingLanguageDetail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.TrainingLanguageDetail))]
    public class UpdateMgSecurityAttackSimulationTrainingLanguageDetailCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(TrainingLanguageDetailId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.AttackSimulation.Trainings[TrainingId].LanguageDetails[TrainingLanguageDetailId].PatchAsync(body, requestConfiguration =>
                {
