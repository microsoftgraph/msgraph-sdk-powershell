...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityCollaborationAnalyzedEmailCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Urls)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AnalyzedEmailId));
                return;
            }
