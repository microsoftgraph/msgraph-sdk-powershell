...
{
    [GraphRoute("POST", "/security/threatIntelligence/sslCertificates")]
    [Cmdlet(VerbsCommon.New, "MgSecurityThreatIntelligenceSslCertificate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.SslCertificate))]
    public class NewMgSecurityThreatIntelligenceSslCertificateCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Subject)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.ThreatIntelligence.SslCertificates.PostAsync(body, requestConfiguration =>
                {
