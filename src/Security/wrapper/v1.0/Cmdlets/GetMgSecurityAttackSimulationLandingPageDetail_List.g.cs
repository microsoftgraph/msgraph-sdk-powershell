...
{
    [GraphRoute("GET", "/security/attackSimulation/landingPages/{landingPage-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationLandingPageDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.LandingPageDetail))]
    public class GetMgSecurityAttackSimulationLandingPageDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.LandingPageDetailCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.LandingPages[LandingPageId].Details.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.LandingPages[LandingPageId].Details.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
