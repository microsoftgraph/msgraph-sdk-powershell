...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityAttackSimulationLandingPageDetail_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, LandingPageId));
                return;
            }
