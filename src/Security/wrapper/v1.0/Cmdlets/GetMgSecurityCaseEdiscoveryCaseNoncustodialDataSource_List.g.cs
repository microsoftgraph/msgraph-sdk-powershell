...
{
    [GraphRoute("GET", "/security/cases/ediscoveryCases/{ediscoveryCase-id}/noncustodialDataSources")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityCaseEdiscoveryCaseNoncustodialDataSource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoveryNoncustodialDataSource))]
    public class GetMgSecurityCaseEdiscoveryCaseNoncustodialDataSource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].NoncustodialDataSources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].NoncustodialDataSources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
