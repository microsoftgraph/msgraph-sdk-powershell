...
{
    [GraphRoute("GET", "/security/cases/ediscoveryCases/{ediscoveryCase-id}/searches")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityCaseEdiscoveryCaseSearch_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoverySearch))]
    public class GetMgSecurityCaseEdiscoveryCaseSearch_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoverySearchCollectionResponse? result;
            try
            {
                result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Searches.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Searches.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
