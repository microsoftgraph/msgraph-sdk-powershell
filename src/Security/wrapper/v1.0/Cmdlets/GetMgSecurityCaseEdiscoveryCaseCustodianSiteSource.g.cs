...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityCaseEdiscoveryCaseCustodianSiteSourceCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSecurityCaseEdiscoveryCaseCustodianSiteSource_Get" : "Get-MgSecurityCaseEdiscoveryCaseCustodianSiteSource_List";
            try
            {
