...
{
    [GraphRoute("GET", "/security/dataSecurityAndGovernance/sensitivityLabels")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityDataSecurityAndGovernanceSensitivityLabel_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SensitivityLabel))]
    public class GetMgSecurityDataSecurityAndGovernanceSensitivityLabel_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.SensitivityLabelCollectionResponse? result;
            try
            {
                result = client.Security.DataSecurityAndGovernance.SensitivityLabels.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.DataSecurityAndGovernance.SensitivityLabels.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
