...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityCaseEdiscoveryCaseOperationCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, CaseOperationId));
                return;
            }
