...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityThreatIntelligenceHostSslCertificateCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? HostSslCertificateId : null));
                return;
            }
        }
    }
