...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationLoginPage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.LoginPage))]
    public class GetMgSecurityAttackSimulationLoginPage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.LoginPageCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.LoginPages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.LoginPages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
