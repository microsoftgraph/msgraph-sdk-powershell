...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostCookie_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostCookie))]
    public class GetMgSecurityThreatIntelligenceHostCookie_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostCookieCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.HostCookies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.HostCookies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
