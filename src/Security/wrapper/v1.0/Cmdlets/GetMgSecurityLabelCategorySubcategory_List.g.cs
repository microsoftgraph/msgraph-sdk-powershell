...
{
    [GraphRoute("GET", "/security/labels/categories/{categoryTemplate-id}/subcategories")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityLabelCategorySubcategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.SubcategoryTemplate))]
    public class GetMgSecurityLabelCategorySubcategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.SubcategoryTemplateCollectionResponse? result;
            try
            {
                result = client.Security.Labels.Categories[CategoryTemplateId].Subcategories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Labels.Categories[CategoryTemplateId].Subcategories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
