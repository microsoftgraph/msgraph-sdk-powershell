...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityIdentitySensorHealthIssue_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HealthIssue))]
    public class GetMgSecurityIdentitySensorHealthIssue_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.HealthIssueCollectionResponse? result;
            try
            {
                result = client.Security.Identities.Sensors[SensorId].HealthIssues.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Identities.Sensors[SensorId].HealthIssues.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
