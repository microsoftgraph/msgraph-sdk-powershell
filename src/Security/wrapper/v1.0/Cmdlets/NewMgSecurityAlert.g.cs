...
{
    [GraphRoute("POST", "/security/alerts")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAlert", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Alert))]
    public class NewMgSecurityAlertCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(VulnerabilityStates)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Alerts.PostAsync(body, requestConfiguration =>
                {
