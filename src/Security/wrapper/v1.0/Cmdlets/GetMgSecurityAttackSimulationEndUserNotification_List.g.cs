...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationEndUserNotification_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.EndUserNotification))]
    public class GetMgSecurityAttackSimulationEndUserNotification_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.EndUserNotificationCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.EndUserNotifications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.EndUserNotifications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
