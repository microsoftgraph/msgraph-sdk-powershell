...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityLabelCitationCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CreatedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, CitationTemplateId));
                return;
            }
