...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityIdentityAccount_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.IdentityAccounts))]
    public class GetMgSecurityIdentityAccount_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.IdentityAccountsCollectionResponse? result;
            try
            {
                result = client.Security.Identities.IdentityAccounts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Identities.IdentityAccounts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
