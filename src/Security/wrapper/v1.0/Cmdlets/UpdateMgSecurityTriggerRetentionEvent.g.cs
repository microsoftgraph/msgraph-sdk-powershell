...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityTriggerRetentionEventCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, RetentionEventId));
                return;
            }
