...
{
    [GraphRoute("GET", "/security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceSslCertificateRelatedHost_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.Host))]
    public class GetMgSecurityThreatIntelligenceSslCertificateRelatedHost_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.ThreatIntelligence.SslCertificates[SslCertificateId].RelatedHosts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.SslCertificates[SslCertificateId].RelatedHosts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
