...
{
    [GraphRoute("GET", "/security/threatIntelligence/intelProfiles")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceIntelProfile_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.IntelligenceProfile))]
    public class GetMgSecurityThreatIntelligenceIntelProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.IntelligenceProfileCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.IntelProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.IntelProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
