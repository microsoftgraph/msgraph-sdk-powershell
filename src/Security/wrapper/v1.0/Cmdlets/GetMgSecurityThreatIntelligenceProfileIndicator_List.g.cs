...
{
    [GraphRoute("GET", "/security/threatIntelligence/intelligenceProfileIndicators")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceProfileIndicator_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.IntelligenceProfileIndicator))]
    public class GetMgSecurityThreatIntelligenceProfileIndicator_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.IntelligenceProfileIndicatorCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.IntelligenceProfileIndicators.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.IntelligenceProfileIndicators.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
