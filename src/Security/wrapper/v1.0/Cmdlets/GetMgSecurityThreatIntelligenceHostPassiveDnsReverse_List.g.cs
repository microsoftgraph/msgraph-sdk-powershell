...
{
    [GraphRoute("GET", "/security/threatIntelligence/hosts/{host-id}/passiveDnsReverse")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostPassiveDnsReverse_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.PassiveDnsRecord))]
    public class GetMgSecurityThreatIntelligenceHostPassiveDnsReverse_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.PassiveDnsRecordCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.Hosts[HostId].PassiveDnsReverse.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.Hosts[HostId].PassiveDnsReverse.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
