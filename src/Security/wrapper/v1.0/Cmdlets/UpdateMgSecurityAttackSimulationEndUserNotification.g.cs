...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityAttackSimulationEndUserNotificationCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, EndUserNotificationId));
                return;
            }
