...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationOperation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.AttackSimulationOperation))]
    public class GetMgSecurityAttackSimulationOperation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.AttackSimulationOperationCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.Operations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.Operations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
