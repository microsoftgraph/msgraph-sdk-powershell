...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityThreatIntelligenceSslCertificateRelatedHostCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSecurityThreatIntelligenceSslCertificateRelatedHost_Get" : "Get-MgSecurityThreatIntelligenceSslCertificateRelatedHost_List";
            try
            {
