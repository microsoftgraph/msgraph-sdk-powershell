...
{
    [GraphRoute("POST", "/security/alerts_v2")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAlertV2", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.Alert))]
    public class NewMgSecurityAlertV2Command : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Alerts_v2.PostAsync(body, requestConfiguration =>
                {
