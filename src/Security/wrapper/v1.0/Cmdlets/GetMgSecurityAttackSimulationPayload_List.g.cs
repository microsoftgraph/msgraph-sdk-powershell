...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationPayload_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Payload))]
    public class GetMgSecurityAttackSimulationPayload_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.PayloadCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.Payloads.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.Payloads.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
