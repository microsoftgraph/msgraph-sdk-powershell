...
{
    [GraphRoute("POST", "/security/attackSimulation/payloads")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAttackSimulationPayload", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Payload))]
    public class NewMgSecurityAttackSimulationPayloadCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Theme)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.AttackSimulation.Payloads.PostAsync(body, requestConfiguration =>
                {
