...
{
    [GraphRoute("GET", "/security/attackSimulation/landingPages")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationLandingPage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.LandingPage))]
    public class GetMgSecurityAttackSimulationLandingPage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.LandingPageCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.LandingPages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.LandingPages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
