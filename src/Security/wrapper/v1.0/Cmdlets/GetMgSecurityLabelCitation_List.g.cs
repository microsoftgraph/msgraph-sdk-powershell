...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityLabelCitation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.CitationTemplate))]
    public class GetMgSecurityLabelCitation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.CitationTemplateCollectionResponse? result;
            try
            {
                result = client.Security.Labels.Citations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Labels.Citations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
