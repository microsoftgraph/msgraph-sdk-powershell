...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAlert_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Alert))]
    public class GetMgSecurityAlert_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.AlertCollectionResponse? result;
            try
            {
                result = client.Security.Alerts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Alerts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
