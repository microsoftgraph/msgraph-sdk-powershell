...
{
    [GraphRoute("GET", "/security/threatIntelligence/articles")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceArticle_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.Article))]
    public class GetMgSecurityThreatIntelligenceArticle_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.ArticleCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.Articles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.Articles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
