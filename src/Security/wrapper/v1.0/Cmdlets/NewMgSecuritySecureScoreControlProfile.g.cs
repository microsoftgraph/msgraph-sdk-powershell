...
{
    [GraphRoute("POST", "/security/secureScoreControlProfiles")]
    [Cmdlet(VerbsCommon.New, "MgSecuritySecureScoreControlProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SecureScoreControlProfile))]
    public class NewMgSecuritySecureScoreControlProfileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(VendorInformation)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.SecureScoreControlProfiles.PostAsync(body, requestConfiguration =>
                {
