...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecuritySubjectRightsRequestApprover_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.User))]
    public class GetMgSecuritySubjectRightsRequestApprover_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.SubjectRightsRequests[SubjectRightsRequestId].Approvers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.SubjectRightsRequests[SubjectRightsRequestId].Approvers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
