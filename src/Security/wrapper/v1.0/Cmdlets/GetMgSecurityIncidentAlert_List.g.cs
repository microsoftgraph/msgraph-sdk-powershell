...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityIncidentAlert_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.Alert))]
    public class GetMgSecurityIncidentAlert_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.AlertCollectionResponse? result;
            try
            {
                result = client.Security.Incidents[IncidentId].Alerts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Incidents[IncidentId].Alerts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
