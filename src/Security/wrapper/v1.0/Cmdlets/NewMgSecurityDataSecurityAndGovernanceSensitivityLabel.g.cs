...
{
    [GraphRoute("POST", "/security/dataSecurityAndGovernance/sensitivityLabels")]
    [Cmdlet(VerbsCommon.New, "MgSecurityDataSecurityAndGovernanceSensitivityLabel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SensitivityLabel))]
    public class NewMgSecurityDataSecurityAndGovernanceSensitivityLabelCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ActionSource)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.DataSecurityAndGovernance.SensitivityLabels.PostAsync(body, requestConfiguration =>
                {
