...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceSslCertificate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.SslCertificate))]
    public class GetMgSecurityThreatIntelligenceSslCertificate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.SslCertificateCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.SslCertificates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.SslCertificates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
