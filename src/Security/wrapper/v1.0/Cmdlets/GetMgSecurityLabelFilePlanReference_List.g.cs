...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityLabelFilePlanReference_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.FilePlanReferenceTemplate))]
    public class GetMgSecurityLabelFilePlanReference_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.FilePlanReferenceTemplateCollectionResponse? result;
            try
            {
                result = client.Security.Labels.FilePlanReferences.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Labels.FilePlanReferences.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
