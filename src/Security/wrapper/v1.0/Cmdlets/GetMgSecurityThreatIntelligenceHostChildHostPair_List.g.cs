...
{
    [GraphRoute("GET", "/security/threatIntelligence/hosts/{host-id}/childHostPairs")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostChildHostPair_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostPair))]
    public class GetMgSecurityThreatIntelligenceHostChildHostPair_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostPairCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.Hosts[HostId].ChildHostPairs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.Hosts[HostId].ChildHostPairs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
