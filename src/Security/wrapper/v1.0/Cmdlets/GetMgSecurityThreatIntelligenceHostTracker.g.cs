...
{
    [GraphRoute("GET", "/security/threatIntelligence/hostTrackers")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostTracker")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostTracker))]
    public class GetMgSecurityThreatIntelligenceHostTrackerCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostTrackerCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.HostTrackers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.HostTrackers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
