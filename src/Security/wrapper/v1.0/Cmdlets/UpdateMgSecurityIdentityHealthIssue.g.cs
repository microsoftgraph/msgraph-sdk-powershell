...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityIdentityHealthIssueCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, HealthIssueId));
                return;
            }
