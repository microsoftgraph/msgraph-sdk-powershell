...
{
    [GraphRoute("POST", "/security/subjectRightsRequests")]
    [Cmdlet(VerbsCommon.New, "MgSecuritySubjectRightsRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SubjectRightsRequest))]
    public class NewMgSecuritySubjectRightsRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.SubjectRightsRequests.PostAsync(body, requestConfiguration =>
                {
