...
{
    [GraphRoute("POST", "/security/attackSimulation/trainings")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAttackSimulationTraining", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Training))]
    public class NewMgSecurityAttackSimulationTrainingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.AttackSimulation.Trainings.PostAsync(body, requestConfiguration =>
                {
