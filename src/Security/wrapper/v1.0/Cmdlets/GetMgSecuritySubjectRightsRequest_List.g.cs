...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecuritySubjectRightsRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SubjectRightsRequest))]
    public class GetMgSecuritySubjectRightsRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.SubjectRightsRequestCollectionResponse? result;
            try
            {
                result = client.Security.SubjectRightsRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.SubjectRightsRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
