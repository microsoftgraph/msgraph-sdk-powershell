...
{
    [GraphRoute("POST", "/security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians")]
    [Cmdlet(VerbsCommon.New, "MgSecurityCaseEdiscoveryCaseCustodian", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoveryCustodian))]
    public class NewMgSecurityCaseEdiscoveryCaseCustodianCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Custodians.PostAsync(body, requestConfiguration =>
                {
