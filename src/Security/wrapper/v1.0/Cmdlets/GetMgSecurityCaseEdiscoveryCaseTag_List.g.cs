...
{
    [GraphRoute("GET", "/security/cases/ediscoveryCases/{ediscoveryCase-id}/tags")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityCaseEdiscoveryCaseTag_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoveryReviewTag))]
    public class GetMgSecurityCaseEdiscoveryCaseTag_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.EdiscoveryReviewTagCollectionResponse? result;
            try
            {
                result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Tags.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Tags.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
