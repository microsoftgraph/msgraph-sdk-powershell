...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityAuditLogQueryRecord_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AuditLogRecordId));
                return;
            }
