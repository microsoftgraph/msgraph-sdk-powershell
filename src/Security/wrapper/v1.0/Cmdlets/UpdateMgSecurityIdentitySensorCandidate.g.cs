...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class UpdateMgSecurityIdentitySensorCandidateCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SenseClientVersion)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, SensorCandidateId));
                return;
            }
