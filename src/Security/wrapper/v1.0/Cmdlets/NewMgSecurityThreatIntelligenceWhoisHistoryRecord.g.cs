...
{
    [GraphRoute("POST", "/security/threatIntelligence/whoisHistoryRecords")]
    [Cmdlet(VerbsCommon.New, "MgSecurityThreatIntelligenceWhoisHistoryRecord", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.WhoisHistoryRecord))]
    public class NewMgSecurityThreatIntelligenceWhoisHistoryRecordCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Host)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.ThreatIntelligence.WhoisHistoryRecords.PostAsync(body, requestConfiguration =>
                {
