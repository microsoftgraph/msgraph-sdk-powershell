...
{
    [GraphRoute("GET", "/security/threatIntelligence/hostPairs")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostPair_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostPair))]
    public class GetMgSecurityThreatIntelligenceHostPair_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.ThreatIntelligence.HostPairs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.HostPairs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
