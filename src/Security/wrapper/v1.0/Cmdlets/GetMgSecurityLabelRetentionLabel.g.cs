...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityLabelRetentionLabelCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? RetentionLabelId : null));
                return;
            }
        }
    }
