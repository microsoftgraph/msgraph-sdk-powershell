...
{
    [GraphRoute("GET", "/security/labels/categories")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityLabelCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.CategoryTemplate))]
    public class GetMgSecurityLabelCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.CategoryTemplateCollectionResponse? result;
            try
            {
                result = client.Security.Labels.Categories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Labels.Categories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
