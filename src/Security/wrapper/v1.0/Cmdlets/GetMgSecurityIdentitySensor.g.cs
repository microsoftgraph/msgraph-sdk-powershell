...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityIdentitySensorCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? SensorId : null));
                return;
            }
        }
    }
