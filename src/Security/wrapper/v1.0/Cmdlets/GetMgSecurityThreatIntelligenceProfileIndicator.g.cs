...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityThreatIntelligenceProfileIndicatorCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? IntelligenceProfileIndicatorId : null);
                return;
            }
        }
    }
