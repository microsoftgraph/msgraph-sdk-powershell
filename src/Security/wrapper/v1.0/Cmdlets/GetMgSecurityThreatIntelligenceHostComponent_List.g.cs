...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligenceHostComponent_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostComponent))]
    public class GetMgSecurityThreatIntelligenceHostComponent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.HostComponentCollectionResponse? result;
            try
            {
                result = client.Security.ThreatIntelligence.HostComponents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.HostComponents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
