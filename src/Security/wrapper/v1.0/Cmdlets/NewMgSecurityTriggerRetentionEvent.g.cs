...
{
    [GraphRoute("POST", "/security/triggers/retentionEvents")]
    [Cmdlet(VerbsCommon.New, "MgSecurityTriggerRetentionEvent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.RetentionEvent))]
    public class NewMgSecurityTriggerRetentionEventCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Triggers.RetentionEvents.PostAsync(body, requestConfiguration =>
                {
