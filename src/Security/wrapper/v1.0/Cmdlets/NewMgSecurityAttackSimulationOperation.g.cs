...
{
    [GraphRoute("POST", "/security/attackSimulation/operations")]
    [Cmdlet(VerbsCommon.New, "MgSecurityAttackSimulationOperation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.AttackSimulationOperation))]
    public class NewMgSecurityAttackSimulationOperationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.AttackSimulation.Operations.PostAsync(body, requestConfiguration =>
                {
