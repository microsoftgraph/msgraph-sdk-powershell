...
{
    [GraphRoute("GET", "/security/attackSimulation/payloads")]
    ...
    public class GetMgSecurityAttackSimulationPayloadCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSecurityAttackSimulationPayload_Get" : "Get-MgSecurityAttackSimulationPayload_List";
            try
            {
