...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationEndUserNotificationDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.EndUserNotificationDetail))]
    public class GetMgSecurityAttackSimulationEndUserNotificationDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.EndUserNotificationDetailCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.EndUserNotifications[EndUserNotificationId].Details.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.EndUserNotifications[EndUserNotificationId].Details.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
