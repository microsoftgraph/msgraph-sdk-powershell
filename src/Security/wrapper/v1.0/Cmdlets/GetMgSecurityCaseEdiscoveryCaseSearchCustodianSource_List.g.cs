...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityCaseEdiscoveryCaseSearchCustodianSource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.DataSource))]
    public class GetMgSecurityCaseEdiscoveryCaseSearchCustodianSource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Searches[EdiscoverySearchId].CustodianSources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.Cases.EdiscoveryCases[EdiscoveryCaseId].Searches[EdiscoverySearchId].CustodianSources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
