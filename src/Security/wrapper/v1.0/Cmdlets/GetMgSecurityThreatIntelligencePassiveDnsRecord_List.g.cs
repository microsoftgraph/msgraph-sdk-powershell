...
{
    [GraphRoute("GET", "/security/threatIntelligence/passiveDnsRecords")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityThreatIntelligencePassiveDnsRecord_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.PassiveDnsRecord))]
    public class GetMgSecurityThreatIntelligencePassiveDnsRecord_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.ThreatIntelligence.PassiveDnsRecords.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.ThreatIntelligence.PassiveDnsRecords.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
