...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityThreatIntelligenceIntelProfileIndicatorCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? IntelligenceProfileIndicatorId : IntelligenceProfileId));
                return;
            }
        }
    }
