...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecuritySubjectRightsRequestNote_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.AuthoredNote))]
    public class GetMgSecuritySubjectRightsRequestNote_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.AuthoredNoteCollectionResponse? result;
            try
            {
                result = client.Security.SubjectRightsRequests[SubjectRightsRequestId].Notes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.SubjectRightsRequests[SubjectRightsRequestId].Notes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
