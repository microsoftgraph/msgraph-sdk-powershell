...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecurityTriggerTypeRetentionEventType_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.RetentionEventType))]
    public class GetMgSecurityTriggerTypeRetentionEventType_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.Security.RetentionEventTypeCollectionResponse? result;
            try
            {
                result = client.Security.TriggerTypes.RetentionEventTypes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.TriggerTypes.RetentionEventTypes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
