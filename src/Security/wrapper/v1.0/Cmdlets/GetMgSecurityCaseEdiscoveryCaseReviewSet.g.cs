...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityCaseEdiscoveryCaseReviewSetCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? EdiscoveryReviewSetId : EdiscoveryCaseId);
                return;
            }
        }
    }
