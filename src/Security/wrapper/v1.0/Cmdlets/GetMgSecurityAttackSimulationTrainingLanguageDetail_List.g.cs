...
{
    [GraphRoute("GET", "/security/attackSimulation/trainings/{training-id}/languageDetails")]
    [Cmdlet(VerbsCommon.Get, "MgSecurityAttackSimulationTrainingLanguageDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.TrainingLanguageDetail))]
    public class GetMgSecurityAttackSimulationTrainingLanguageDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.TrainingLanguageDetailCollectionResponse? result;
            try
            {
                result = client.Security.AttackSimulation.Trainings[TrainingId].LanguageDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.AttackSimulation.Trainings[TrainingId].LanguageDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
