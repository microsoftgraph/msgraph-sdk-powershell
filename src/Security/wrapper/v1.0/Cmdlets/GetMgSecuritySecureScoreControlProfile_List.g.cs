...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSecuritySecureScoreControlProfile_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.SecureScoreControlProfile))]
    public class GetMgSecuritySecureScoreControlProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Security.Client.Models.SecureScoreControlProfileCollectionResponse? result;
            try
            {
                result = client.Security.SecureScoreControlProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Security.SecureScoreControlProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
