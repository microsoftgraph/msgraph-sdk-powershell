...
namespace Microsoft.Graph.PowerShell.Security
{
    ...
    public class GetMgSecurityLabelAuthorityCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? AuthorityTemplateId : null));
                return;
            }
        }
    }
