...
{
    [GraphRoute("POST", "/security/labels/departments")]
    [Cmdlet(VerbsCommon.New, "MgSecurityLabelDepartment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Security.Client.Models.Security.DepartmentTemplate))]
    public class NewMgSecurityLabelDepartmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CreatedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Security.Labels.Departments.PostAsync(body, requestConfiguration =>
                {
