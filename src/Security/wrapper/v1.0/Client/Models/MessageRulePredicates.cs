...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>? FromAddresses { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient> FromAddresses { get; set; }
#endif
...
#nullable restore
        ...
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.Importance? Importance { get; set; }
        ...
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageActionFlag? MessageActionFlag { get; set; }
...
#nullable restore
        ...
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.Sensitivity? Sensitivity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>? SentToAddresses { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient> SentToAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.SizeRange? WithinSizeRange { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.SizeRange WithinSizeRange { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageRulePredicates"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageRulePredicates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageRulePredicates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageRulePredicates();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fromAddresses", n => { FromAddresses = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>(global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "hasAttachments", n => { HasAttachments = n.GetBoolValue(); } },
                { "headerContains", n => { HeaderContains = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "importance", n => { Importance = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Importance>(); } },
                ...
                { "messageActionFlag", n => { MessageActionFlag = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageActionFlag>(); } },
                ...
                { "sensitivity", n => { Sensitivity = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Sensitivity>(); } },
                { "sentCcMe", n => { SentCcMe = n.GetBoolValue(); } },
                { "sentOnlyToMe", n => { SentOnlyToMe = n.GetBoolValue(); } },
                { "sentToAddresses", n => { SentToAddresses = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>(global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "withinSizeRange", n => { WithinSizeRange = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.SizeRange>(global::Microsoft.Graph.PowerShell.Security.Client.Models.SizeRange.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>("fromAddresses", FromAddresses);
            writer.WriteBoolValue("hasAttachments", HasAttachments);
            writer.WriteCollectionOfPrimitiveValues<string>("headerContains", HeaderContains);
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Importance>("importance", Importance);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.MessageActionFlag>("messageActionFlag", MessageActionFlag);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Sensitivity>("sensitivity", Sensitivity);
            writer.WriteBoolValue("sentCcMe", SentCcMe);
            writer.WriteBoolValue("sentOnlyToMe", SentOnlyToMe);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Security.Client.Models.Recipient>("sentToAddresses", SentToAddresses);
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.SizeRange>("withinSizeRange", WithinSizeRange);
