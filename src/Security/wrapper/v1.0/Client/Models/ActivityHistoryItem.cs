...
namespace Microsoft.Graph.PowerShell.Security.Client.Models
{
    ...
    public partial class ActivityHistoryItem : global::Microsoft.Graph.PowerShell.Security.Client.Models.Entity, IParsable
...
#nullable enable
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.UserActivity? Activity { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.UserActivity Activity { get; set; }
#endif
        ...
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.Status? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Security.Client.Models.ActivityHistoryItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Security.Client.Models.ActivityHistoryItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Security.Client.Models.ActivityHistoryItem();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "activity", n => { Activity = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.UserActivity>(global::Microsoft.Graph.PowerShell.Security.Client.Models.UserActivity.CreateFromDiscriminatorValue); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "expirationDateTime", n => { ExpirationDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastActiveDateTime", n => { LastActiveDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "startedDateTime", n => { StartedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Status>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.UserActivity>("activity", Activity);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.Status>("status", Status);
