...
namespace Microsoft.Graph.PowerShell.Security.Client.Models
{
    ...
    public partial class DeviceLogCollectionResponse : global::Microsoft.Graph.PowerShell.Security.Client.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::Microsoft.Graph.PowerShell.Security.Client.Models.AppLogUploadState? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Security.Client.Models.DeviceLogCollectionResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Security.Client.Models.DeviceLogCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Security.Client.Models.DeviceLogCollectionResponse();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.AppLogUploadState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Security.Client.Models.AppLogUploadState>("status", Status);
        }
    }
}
