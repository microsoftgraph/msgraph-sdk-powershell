...
Update-MgBetaSecurityThreatSubmissionFileThreat -FileThreatSubmissionId <String>
 ...
 [-Status <String>] [-TenantId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityThreatSubmissionFileThreat -FileThreatSubmissionId <String>
 -BodyParameter <IMicrosoftGraphSecurityFileThreatSubmission> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
