...
### Close (Default)
```
Close-MgBetaSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
