...
### Update
```
Update-MgBetaSecurityAlert -AlertId <String> -BodyParameter <IMicrosoftGraphAlert> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaSecurityAlert -InputObject <ISecurityIdentity> -BodyParameter <IMicrosoftGraphAlert> [-Confirm]
