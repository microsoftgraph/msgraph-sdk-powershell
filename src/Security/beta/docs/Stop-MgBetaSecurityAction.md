...
### Cancel (Default)
```
Stop-MgBetaSecurityAction -SecurityActionId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaSecurityAction -InputObject <ISecurityIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
