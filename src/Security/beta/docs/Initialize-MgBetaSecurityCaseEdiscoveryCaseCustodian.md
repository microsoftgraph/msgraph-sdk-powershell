...
Initialize-MgBetaSecurityCaseEdiscoveryCaseCustodian -EdiscoveryCaseId <String>
 -EdiscoveryCustodianId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaSecurityCaseEdiscoveryCaseCustodian -InputObject <ISecurityIdentity> [-Headers <IDictionary>]
