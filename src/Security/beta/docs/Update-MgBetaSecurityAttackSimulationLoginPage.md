...
Update-MgBetaSecurityAttackSimulationLoginPage -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphLoginPage> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaSecurityAttackSimulationLoginPage -InputObject <ISecurityIdentity>
 ...
 [-Source <String>] [-Status <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
