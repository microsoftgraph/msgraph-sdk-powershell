...
Update-MgBetaUserSecurity -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-InformationProtection <IMicrosoftGraphSecurityInformationProtection>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaUserSecurity -UserId <String> -BodyParameter <IMicrosoftGraphSecurityAutoGenerated> [-Confirm]
...
Update-MgBetaUserSecurity -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityAutoGenerated> [-Confirm] [-WhatIf] [<CommonParameters>]
```
