...
### Update
```
Update-MgBetaUserSecurity -UserId <String> -BodyParameter <IMicrosoftGraphSecurity1>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaUserSecurity -InputObject <ISecurityIdentity> -BodyParameter <IMicrosoftGraphSecurity1>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurity1
