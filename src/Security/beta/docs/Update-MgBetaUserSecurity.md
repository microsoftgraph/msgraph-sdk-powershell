...
Update-MgBetaUserSecurity -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-InformationProtection <IMicrosoftGraphSecurityInformationProtection>] [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaUserSecurity -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityAutoGenerated> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
