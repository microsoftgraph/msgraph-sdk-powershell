...
### Delete (Default)
```
Remove-MgBetaSecurityAttackSimulationPayload -PayloadId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityAttackSimulationPayload -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
