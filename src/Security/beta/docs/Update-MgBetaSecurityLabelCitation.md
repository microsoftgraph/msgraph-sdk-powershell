...
Update-MgBetaSecurityLabelCitation -CitationTemplateId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>] [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaSecurityLabelCitation -CitationTemplateId <String>
 -BodyParameter <IMicrosoftGraphSecurityCitationTemplate> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
