...
### List (Default)
```
Get-MgBetaSecurityAttackSimulationTrainingCampaign [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityAttackSimulationTrainingCampaign -TrainingCampaignId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityAttackSimulationTrainingCampaign -InputObject <ISecurityIdentity>
