...
### Delete (Default)
```
Remove-MgBetaSecurityAuditLogQuery -AuditLogQueryId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityAuditLogQuery -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
