...
New-MgBetaSecurityCloudAppSecurityProfile [-AdditionalProperties <Hashtable>] [-AzureSubscriptionId <String>]
 ...
 [-PolicyName <String>] [-Publisher <String>] [-ResponseHeadersVariable <String>] [-RiskScore <String>]
 [-Tags <String[]>] [-Type <String>] [-VendorInformation <IMicrosoftGraphSecurityVendorInformation>]
