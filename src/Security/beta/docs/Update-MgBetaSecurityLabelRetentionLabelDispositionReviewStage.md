...
```
Update-MgBetaSecurityLabelRetentionLabelDispositionReviewStage -DispositionReviewStageNumber <String>
 -RetentionLabelId <String> [-AdditionalProperties <Hashtable>] [-Id <String>] [-Name <String>]
 [-ResponseHeadersVariable <String>] [-ReviewersEmailAddresses <String[]>] [-StageNumber <String>]
...
Update-MgBetaSecurityLabelRetentionLabelDispositionReviewStage -InputObject <ISecurityIdentity>
 ...
 [-ReviewersEmailAddresses <String[]>] [-StageNumber <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
