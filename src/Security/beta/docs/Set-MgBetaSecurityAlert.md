...
Set-MgBetaSecurityAlert -AlertId <String> -BodyParameter <IMicrosoftGraphSecurityAlertComment[]>
 [-IfMatch <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSecurityAlert -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityAlertComment[]> [-IfMatch <String>] [-Headers <IDictionary>]
