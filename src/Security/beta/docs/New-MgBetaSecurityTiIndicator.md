...
New-MgBetaSecurityTiIndicator [-Action <String>] [-ActivityGroupNames <String[]>]
 ...
 [-Url <String>] [-UserAgent <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaSecurityTiIndicator -BodyParameter <IMicrosoftGraphTiIndicator> [-Headers <IDictionary>] [-Confirm]
