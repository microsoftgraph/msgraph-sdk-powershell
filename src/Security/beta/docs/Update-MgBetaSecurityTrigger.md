...
Update-MgBetaSecurityTrigger [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-RetentionEvents <IMicrosoftGraphSecurityRetentionEvent[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityTrigger -BodyParameter <IMicrosoftGraphSecurityTriggersRoot> [-Headers <IDictionary>]
