...
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-SubCategories <IMicrosoftGraphSecuritySubCategoryTemplate[]>] [-Headers <IDictionary>]
...
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String>
 -BodyParameter <IMicrosoftGraphSecurityCategoryTemplate> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
