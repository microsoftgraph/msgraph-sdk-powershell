...
### Reopen (Default)
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReopenViaIdentity
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-Headers <IDictionary>]
