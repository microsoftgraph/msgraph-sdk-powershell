...
```
Update-MgBetaSecurityAlertV2 -AlertId <String> [-ActorDisplayName <String>]
...
### Update
```
Update-MgBetaSecurityAlertV2 -AlertId <String> -BodyParameter <IMicrosoftGraphSecurityAlert> [-Confirm]
