...
Update-MgSecurityThreatIntelligenceHostReputation -HostId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Score <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSecurityThreatIntelligenceHostReputation -HostId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostReputation> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostReputation -InputObject <ISecurityIdentity>
 ...
 [-Rules <IMicrosoftGraphSecurityHostReputationRule[]>] [-Score <Int32>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
