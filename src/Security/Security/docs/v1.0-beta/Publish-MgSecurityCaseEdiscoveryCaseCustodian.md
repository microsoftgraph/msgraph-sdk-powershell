...
### ReleaseViaIdentity1
```
Publish-MgBetaSecurityCaseEdiscoveryCaseCustodian -InputObject <ISecurityIdentity> [-PassThru] [-Confirm]
...
### Example 1: Using the Publish-MgBetaSecurityCaseEdiscoveryCaseCustodian Cmdlet
```powershell
