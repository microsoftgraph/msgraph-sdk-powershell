...
Update-MgSecurityCaseEdiscoveryCaseReviewSet -EdiscoveryCaseId <String> -EdiscoveryReviewSetId <String>
 ...
 [-Queries <IMicrosoftGraphSecurityEdiscoveryReviewSetQuery[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgSecurityCaseEdiscoveryCaseReviewSet -EdiscoveryCaseId <String> -EdiscoveryReviewSetId <String>
 -BodyParameter <IMicrosoftGraphSecurityEdiscoveryReviewSet> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityEdiscoveryFile[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
