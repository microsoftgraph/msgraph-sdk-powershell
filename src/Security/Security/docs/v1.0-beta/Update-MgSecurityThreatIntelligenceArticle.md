...
Update-MgSecurityThreatIntelligenceArticle -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityArticle> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceArticle -InputObject <ISecurityIdentity>
 ...
 [-Summary <IMicrosoftGraphSecurityFormattedContent>] [-Tags <String[]>] [-Title <String>] [-PassThru]
