...
### GetViaIdentity
```
Get-MgBetaSecurityCaseEdiscoveryCaseReviewSetQuery -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
...
### Example 1: Using the Get-MgBetaSecurityCaseEdiscoveryCaseReviewSetQuery Cmdlet
```powershell
