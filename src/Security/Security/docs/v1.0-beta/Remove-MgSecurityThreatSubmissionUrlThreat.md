...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/remove-mgsecuritythreatsubmissionurlthreat
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityThreatSubmissionUrlThreat -UrlThreatSubmissionId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityThreatSubmissionUrlThreat -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
