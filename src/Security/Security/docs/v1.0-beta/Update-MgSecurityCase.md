...
Update-MgSecurityCase [-AdditionalProperties <Hashtable>]
 [-EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase[]>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgSecurityCase -BodyParameter <IMicrosoftGraphSecurityCasesRoot> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
