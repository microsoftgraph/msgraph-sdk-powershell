...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritythreatintelligencehostcomponent
schema: 2.0.0
---
...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String> [-AdditionalProperties <Hashtable>]
 [-Category <String>] [-FirstSeenDateTime <DateTime>] [-Host <IMicrosoftGraphSecurityHost>] [-Id <String>]
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-Version <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostComponent> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
