...
```
Update-MgSecurityCaseEdiscoveryCaseReviewSetFile -EdiscoveryCaseId <String> -EdiscoveryFileId <String>
 -EdiscoveryReviewSetId <String> -BodyParameter <IMicrosoftGraphSecurityEdiscoveryFile> [-PassThru] [-Confirm]
...
Update-MgSecurityCaseEdiscoveryCaseReviewSetFile -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityEdiscoveryFile> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
