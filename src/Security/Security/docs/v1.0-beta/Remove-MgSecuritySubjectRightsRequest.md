...
online version: https://docs.microsoft.com/en-us/powershell/module/Microsoft.Graph.security/remove-mgsecuritysubjectrightsrequest
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaSecuritySubjectRightsRequest -SubjectRightsRequestId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecuritySubjectRightsRequest -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
