...
Update-MgSecurityAlert -AlertId <String> [-ActivityGroupName <String>] [-AssignedTo <String>]
 ...
 [-Id <String>] [-LastModifiedDateTime <DateTime>] [-MalwareStates <IMicrosoftGraphMalwareState[]>]
 ...
 [-Triggers <IMicrosoftGraphAlertTrigger[]>] [-UserStates <IMicrosoftGraphUserSecurityState[]>]
