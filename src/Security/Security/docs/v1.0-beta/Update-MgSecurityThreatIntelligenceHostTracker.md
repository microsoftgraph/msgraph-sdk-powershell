...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritythreatintelligencehosttracker
schema: 2.0.0
---
...
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String> [-AdditionalProperties <Hashtable>]
 [-FirstSeenDateTime <DateTime>] [-Host <IMicrosoftGraphSecurityHost>] [-Id <String>] [-Kind <String>]
 [-LastSeenDateTime <DateTime>] [-Value <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostTracker> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgSecurityThreatIntelligenceHostTracker -InputObject <ISecurityIdentity>
 [-AdditionalProperties <Hashtable>] [-FirstSeenDateTime <DateTime>] [-Host <IMicrosoftGraphSecurityHost>]
 [-Id <String>] [-Kind <String>] [-LastSeenDateTime <DateTime>] [-Value <String>] [-PassThru] [-Confirm]
