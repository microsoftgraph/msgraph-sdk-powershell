...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/remove-mgsecuritycaseediscoverycaselegalholdusersource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityCaseEdiscoveryCaseLegalHoldUserSource -EdiscoveryCaseId <String>
 -EdiscoveryHoldPolicyId <String> -UserSourceId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityCaseEdiscoveryCaseLegalHoldUserSource -InputObject <ISecurityIdentity> [-IfMatch <String>]
