...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritythreatintelligencehostcooky
schema: 2.0.0
---

# Update-MgSecurityThreatIntelligenceHostCooky
...
```
Update-MgSecurityThreatIntelligenceHostCooky -HostCookieId <String> [-AdditionalProperties <Hashtable>]
 [-Domain <String>] [-FirstSeenDateTime <DateTime>] [-Host <IMicrosoftGraphSecurityHost>] [-Id <String>]
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSecurityThreatIntelligenceHostCooky -HostCookieId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSecurityThreatIntelligenceHostCooky -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostCooky -InputObject <ISecurityIdentity>
 ...
 [-Host <IMicrosoftGraphSecurityHost>] [-Id <String>] [-LastSeenDateTime <DateTime>] [-Name <String>]
