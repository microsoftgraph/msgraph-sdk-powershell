...
### List (Default)
```
Get-MgSecuritySecureScore [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSecuritySecureScore -SecureScoreId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecuritySecureScore -InputObject <ISecurityIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
