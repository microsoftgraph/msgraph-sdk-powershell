...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/remove-mgsecuritycaseediscoverycasereviewset
schema: 2.0.0
---
...
### DeleteViaIdentity1
```
Remove-MgSecurityCaseEdiscoveryCaseReviewSet -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
