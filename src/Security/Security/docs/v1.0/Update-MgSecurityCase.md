...
Update-MgSecurityCase [-AdditionalProperties <Hashtable>]
 [-EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase1[]>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update1
```
Update-MgSecurityCase -BodyParameter <IMicrosoftGraphSecurityCasesRoot1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityCasesRoot1
...
BODYPARAMETER <IMicrosoftGraphSecurityCasesRoot1>: casesRoot
  - `[(Any) <Object>]`: This indicates any property can be added to this object.
  - `[Id <String>]`: 
  - `[EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase1[]>]`: 
