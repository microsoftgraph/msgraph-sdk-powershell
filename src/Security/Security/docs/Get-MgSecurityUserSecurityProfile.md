...
### List (Default)
```
Get-MgSecurityUserSecurityProfile [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSecurityUserSecurityProfile -UserSecurityProfileId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityUserSecurityProfile -InputObject <ISecurityIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
