...
Update-MgSecurityThreatIntelligenceHostPair -HostPairId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostPair> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostPair -InputObject <ISecurityIdentity>
 ...
 [-ParentHost <IMicrosoftGraphSecurityHost>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
