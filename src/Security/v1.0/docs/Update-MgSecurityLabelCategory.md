...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritylabelcategory
schema: 2.0.0
---
...
```
Update-MgSecurityLabelCategory -CategoryTemplateId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgSecurityLabelCategory -CategoryTemplateId <String>
...
### UpdateViaIdentity
```
Update-MgSecurityLabelCategory -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityCategoryTemplate> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgSecurityLabelCategory -InputObject <ISecurityIdentity> [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>]
 [-Id <String>] [-ResponseHeadersVariable <String>]
 [-Subcategories <IMicrosoftGraphSecuritySubcategoryTemplate[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
