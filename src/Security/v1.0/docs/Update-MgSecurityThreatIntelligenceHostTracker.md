...
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Value <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostTracker> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
