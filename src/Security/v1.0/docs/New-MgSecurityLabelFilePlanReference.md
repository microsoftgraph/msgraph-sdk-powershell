...
```
New-MgSecurityLabelFilePlanReference [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgSecurityLabelFilePlanReference -BodyParameter <Hashtable> [-ResponseHeadersVariable <String>]
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityFilePlanReferenceTemplate
