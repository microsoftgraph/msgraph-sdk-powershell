...
### List (Default)
```
Get-MgSecurityLabelCitation [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgSecurityLabelCitation -CitationTemplateId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityLabelCitation -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
