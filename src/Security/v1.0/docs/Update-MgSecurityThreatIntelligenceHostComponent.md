...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-Version <String>] [-Headers <IDictionary>] [-Confirm]
...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostComponent> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
