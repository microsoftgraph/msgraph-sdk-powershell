...
```
Update-MgSecurityLabelCitation -CitationTemplateId <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgSecurityLabelCitation -InputObject <ISecurityIdentity> [-AdditionalProperties <Hashtable>]
 [-CitationJurisdiction <String>] [-CitationUrl <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
