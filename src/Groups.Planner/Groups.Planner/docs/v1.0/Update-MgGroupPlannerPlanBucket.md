...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/update-mggroupplannerplanbucket
schema: 2.0.0
---
...
```
Update-MgGroupPlannerPlanBucket -InputObject <IGroupsPlannerIdentity> [-Id <String>] [-Name <String>]
