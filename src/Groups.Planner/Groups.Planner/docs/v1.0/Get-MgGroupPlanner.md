...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/get-mggroupplanner
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupPlanner -InputObject <IGroupsPlannerIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
