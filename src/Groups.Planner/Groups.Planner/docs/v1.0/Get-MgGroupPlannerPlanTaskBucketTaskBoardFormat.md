...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/get-mggroupplannerplantaskbuckettaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupPlannerPlanTaskBucketTaskBoardFormat -InputObject <IGroupsPlannerIdentity>
