...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/get-mggroupplannerplanbuckettaskprogresstaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupPlannerPlanBucketTaskProgressTaskBoardFormat -InputObject <IGroupsPlannerIdentity>
