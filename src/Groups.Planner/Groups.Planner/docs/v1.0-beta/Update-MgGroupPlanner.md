...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/update-mggroupplanner
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupPlanner -InputObject <IGroupsPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerGroup>
