...
### Create
```
New-MgUserChatMessage -ChatId <String> -UserId <String> -BodyParameter <IMicrosoftGraphChatMessage1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserChatMessage -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage1> [-Confirm]
