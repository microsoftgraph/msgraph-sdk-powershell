...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mgteamchannelsharedwithteam
schema: 2.0.0
---
...
This example shows how to use the New-MgTeamChannelSharedWithTeam Cmdlet.
