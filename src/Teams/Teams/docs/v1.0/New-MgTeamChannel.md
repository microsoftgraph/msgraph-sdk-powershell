...
```
New-MgTeamChannel -TeamId <String> [-AdditionalProperties <Hashtable>] [-Description <String>]
 [-DisplayName <String>] [-Email <String>] [-FilesFolder <IMicrosoftGraphDriveItem1>] [-Id <String>]
 [-Messages <IMicrosoftGraphChatMessage1[]>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-Confirm]
...
```
New-MgTeamChannel -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>] [-Description <String>]
 [-DisplayName <String>] [-Email <String>] [-FilesFolder <IMicrosoftGraphDriveItem1>] [-Id <String>]
 [-Messages <IMicrosoftGraphChatMessage1[]>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
