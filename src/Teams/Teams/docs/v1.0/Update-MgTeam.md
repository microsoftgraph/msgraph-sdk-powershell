...
```
Update-MgTeam -TeamId <String> [-AdditionalProperties <Hashtable>] [-Channels <IMicrosoftGraphChannel1[]>]
 [-Classification <String>] [-Description <String>] [-DisplayName <String>]
 [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup1>]
...
### UpdateViaIdentity
```
Update-MgTeam -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeam> [-PassThru] [-Confirm]
