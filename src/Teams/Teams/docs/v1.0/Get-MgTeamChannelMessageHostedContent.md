...
### List1 (Default)
```
Get-MgTeamChannelMessageHostedContent -ChannelId <String> -ChatMessageId <String> -TeamId <String> [-Count]
...
### Example 1: Using the Get-MgTeamChannelMessageHostedContent Cmdlet
```powershell
