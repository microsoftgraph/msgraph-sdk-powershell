...
New-MgGroupTeamPrimaryChannelSharedWithTeam -GroupId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Team <IMicrosoftGraphTeam1>] [-TenantId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
This example shows how to use the New-MgGroupTeamPrimaryChannelSharedWithTeam Cmdlet.
