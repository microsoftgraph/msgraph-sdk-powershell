...
```
Update-MgGroupTeam -GroupId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Members <IMicrosoftGraphConversationMember[]>] [-MemberSettings <IMicrosoftGraphTeamMemberSettings1>]
...
### UpdateViaIdentity
```
Update-MgGroupTeam -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeam> [-PassThru] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTeamMemberSettings1
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
