...
### Create
```
New-MgBetaGroupTeamOperation -GroupId <String> -BodyParameter <IMicrosoftGraphTeamsAsyncOperation1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaGroupTeamOperation -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsAsyncOperation1>
