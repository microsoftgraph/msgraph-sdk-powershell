...
### Set1 (Default)
```
Set-MgBetaTeamChannelFileFolderContent -ChannelId <String> -TeamId <String> -InFile <String>
 [-BodyParameter <Stream>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgBetaTeamChannelFileFolderContent -InputObject <ITeamsIdentity> -InFile <String> [-BodyParameter <Stream>]
