...
### Set1 (Default)
```
Set-MgBetaTeamPrimaryChannelFileFolderContent -TeamId <String> -InFile <String> [-BodyParameter <Stream>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgBetaTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> -InFile <String>
