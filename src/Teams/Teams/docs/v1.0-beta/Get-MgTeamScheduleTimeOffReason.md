...
### List1 (Default)
```
Get-MgBetaTeamScheduleTimeOffReason -TeamId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### Example 1: Using the Get-MgBetaTeamScheduleTimeOffReason Cmdlet
```powershell
