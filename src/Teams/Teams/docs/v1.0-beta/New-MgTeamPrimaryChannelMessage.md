...
New-MgTeamPrimaryChannelMessage -TeamId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-DeletedDateTime <DateTime>] [-Etag <String>] [-EventDetail <Hashtable>] [-From <IMicrosoftGraphIdentitySet>]
...
### Create
```
New-MgTeamPrimaryChannelMessage -TeamId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-WhatIf]
