...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mgteamprimarychannelshared
schema: 2.0.0
---

# Update-MgTeamPrimaryChannelShared
...
```
Update-MgTeamPrimaryChannelShared -SharedWithChannelTeamInfoId <String> -TeamId <String>
...
```
Update-MgTeamPrimaryChannelShared -SharedWithChannelTeamInfoId <String> -TeamId <String>
 -BodyParameter <IMicrosoftGraphSharedWithChannelTeamInfo> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgTeamPrimaryChannelShared -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphSharedWithChannelTeamInfo> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgTeamPrimaryChannelShared -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-AllowedMembers <IMicrosoftGraphConversationMember[]>] [-DisplayName <String>] [-Id <String>] [-IsHostTeam]
 [-Team <IMicrosoftGraphTeam>] [-TenantId <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
