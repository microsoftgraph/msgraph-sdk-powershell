...
### DeleteViaIdentity1
```
Remove-MgBetaTeamworkWorkforceIntegration -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
...
### Example 1: Using the Remove-MgBetaTeamworkWorkforceIntegration Cmdlet
```powershell
