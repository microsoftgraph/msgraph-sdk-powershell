...
### Delete (Default)
```
Remove-MgTeamworkDeviceOperation -TeamworkDeviceId <String> -TeamworkDeviceOperationId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamworkDeviceOperation -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
