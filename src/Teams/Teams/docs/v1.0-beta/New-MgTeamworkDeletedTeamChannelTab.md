...
```
New-MgBetaTeamworkDeletedTeamChannelTab -ChannelId <String> -DeletedTeamId <String>
 -BodyParameter <IMicrosoftGraphTeamsTab1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaTeamworkDeletedTeamChannelTab -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsTab1>
