...
### Provision (Default)
```
New-MgBetaTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
