...
### List1 (Default)
```
Get-MgBetaUserChatInstalledApp -ChatId <String> -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgBetaUserChatInstalledApp -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
