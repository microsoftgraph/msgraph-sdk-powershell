...
```
New-MgUserChat -UserId <String> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
...
```
New-MgUserChat -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-Id <String>] [-InstalledApps <IMicrosoftGraphTeamsAppInstallation1[]>] [-LastUpdatedDateTime <DateTime>]
 [-Members <IMicrosoftGraphConversationMember[]>] [-Messages <IMicrosoftGraphChatMessage[]>] [-Topic <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
