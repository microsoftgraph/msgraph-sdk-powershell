...
```
Get-MgTeamPrimaryChannelSharedWithTeamAllowedMemberByRef -SharedWithChannelTeamInfoId <String>
 -TeamId <String> [-Filter <String>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
