...
### CreateViaIdentity1
```
New-MgBetaTeamChannelMessage -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage> [-Confirm]
...
$params = @{
  ...
  "body": [
	...
	HostedContents = @(
		@{
			"@Microsoft.Graph.Beta.temporaryId" = "1"
		...
		@{
			"@Microsoft.Graph.Beta.temporaryId" = "2"
