...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mguserchatmember
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserChatMember -ChatId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
