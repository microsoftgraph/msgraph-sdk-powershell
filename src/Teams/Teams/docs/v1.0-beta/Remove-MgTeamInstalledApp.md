...
### DeleteViaIdentity1
```
Remove-MgBetaTeamInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1: Using the Remove-MgBetaTeamInstalledApp Cmdlet
```powershell
