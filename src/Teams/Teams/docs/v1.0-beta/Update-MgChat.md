...
```
Update-MgChat -ChatId <String> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
...
```
Update-MgChat -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-Id <String>] [-InstalledApps <IMicrosoftGraphTeamsAppInstallation1[]>] [-LastUpdatedDateTime <DateTime>]
 [-Members <IMicrosoftGraphConversationMember[]>] [-Messages <IMicrosoftGraphChatMessage[]>] [-Topic <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
