...
```
Send-MgBetaChatActivityNotification -ChatId <String> [-ActivityType <String>] [-AdditionalProperties <Hashtable>]
...
$params = @{
	...
	Recipient = @{
		"@odata.type" = "Microsoft.Graph.Beta.chatMembersNotificationRecipient"
