...
New-MgUserChat -UserId <String> [-AdditionalProperties <Hashtable>] [-ChatType <String>]
 ...
 [-Messages <IMicrosoftGraphChatMessage[]>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-Topic <String>] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mguserchat](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mguserchat)
