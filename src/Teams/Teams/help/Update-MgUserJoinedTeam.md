...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mguserjoinedteam
schema: 2.0.0
---
...
### Update
```
Update-MgUserJoinedTeam -TeamId <String> -UserId <String> -BodyParameter <IMicrosoftGraphTeam1> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserJoinedTeam -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-Channels <IMicrosoftGraphChannel1[]>] [-Classification <String>] [-Description <String>]
 [-DisplayName <String>] [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup1>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation1[]>] [-InternalId <String>] [-IsArchived]
...
### UpdateViaIdentity
```
Update-MgUserJoinedTeam -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeam1> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mguserjoinedteam](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mguserjoinedteam)
