...
```
Update-MgChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String> -ChatMessageId <String>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mgchatmessagehostedcontent](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mgchatmessagehostedcontent)
