...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mguserjoinedteam
schema: 2.0.0
---
...
New-MgUserJoinedTeam -UserId <String> [-AdditionalProperties <Hashtable>]
 [-Channels <IMicrosoftGraphChannel1[]>] [-Classification <String>] [-Description <String>]
 [-DisplayName <String>] [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup1>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation1[]>] [-InternalId <String>] [-IsArchived]
 [-MemberSettings <IMicrosoftGraphTeamMemberSettings>] [-Members <IMicrosoftGraphConversationMember[]>]
 [-MessagingSettings <IMicrosoftGraphTeamMessagingSettings>]
 [-Operations <IMicrosoftGraphTeamsAsyncOperation[]>] [-PrimaryChannel <IMicrosoftGraphChannel1>]
 [-Schedule <IMicrosoftGraphSchedule1>] [-Specialization <String>] [-Template <Hashtable>]
 [-Visibility <String>] [-WebUrl <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgUserJoinedTeam -UserId <String> -BodyParameter <IMicrosoftGraphTeam1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserJoinedTeam -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-Channels <IMicrosoftGraphChannel1[]>] [-Classification <String>] [-Description <String>]
 [-DisplayName <String>] [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup1>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation1[]>] [-InternalId <String>] [-IsArchived]
...
### CreateViaIdentity
```
New-MgUserJoinedTeam -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeam1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mguserjoinedteam](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mguserjoinedteam)
