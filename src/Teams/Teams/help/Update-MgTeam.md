...
```
Update-MgTeam -TeamId <String> [-AdditionalProperties <Hashtable>] [-Channels <IMicrosoftGraphChannel[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mgteam](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mgteam)
