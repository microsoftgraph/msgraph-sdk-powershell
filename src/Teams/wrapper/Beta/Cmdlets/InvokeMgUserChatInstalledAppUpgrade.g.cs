...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserChatInstalledAppUpgrade", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserChatInstalledAppUpgradeCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(TeamsAppInstallationId, "Invoke"))
                return;
