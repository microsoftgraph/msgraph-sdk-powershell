...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamChannelMemberAdd", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Teams.Client.Teams.Item.Channels.Item.Members.Add.AddPostResponse))]
    public class InvokeMgTeamChannelMemberAddCommand : GraphClientCmdlet
    {
