...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamworkDeletedTeamChannelCompleteMigration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgTeamworkDeletedTeamChannelCompleteMigrationCommand : GraphClientCmdlet
    {
