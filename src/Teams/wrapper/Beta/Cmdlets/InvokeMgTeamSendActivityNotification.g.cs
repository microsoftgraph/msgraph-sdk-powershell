...
{
    [GraphRoute("POST", "/teams/{team-id}/sendActivityNotification")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamSendActivityNotification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgTeamSendActivityNotificationCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Teams.Client.Teams.Item.SendActivityNotification.SendActivityNotificationPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Recipient)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                client.Teams[TeamId].SendActivityNotification.PostAsync(body, requestConfiguration =>
                {
