...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserChatTargetedMessageReplySoftDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserChatTargetedMessageReplySoftDeleteCommand : GraphClientCmdlet
    {
