...
{
    [GraphRoute("GET", "/teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgTeamChannelMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamChannelMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamChannelMessageReplyHostedContent_Get or Get-MgTeamChannelMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamChannelMessageReplyHostedContent_Get" : "Get-MgTeamChannelMessageReplyHostedContent_List";
            try
            {
