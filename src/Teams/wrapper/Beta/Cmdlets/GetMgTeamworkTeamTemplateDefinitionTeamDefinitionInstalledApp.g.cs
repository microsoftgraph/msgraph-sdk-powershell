...
{
    [GraphRoute("GET", "/teamwork/teamTemplates/{teamTemplate-id}/definitions/{teamTemplateDefinition-id}/teamDefinition/installedApps")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledApp", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledAppCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledApp_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledApp_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledApp_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionInstalledApp_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TeamsAppInstallationId : TeamTemplateDefinitionId);
                return;
            }
        }
    }
