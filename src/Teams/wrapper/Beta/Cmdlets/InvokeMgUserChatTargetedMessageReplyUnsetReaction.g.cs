...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserChatTargetedMessageReplyUnsetReaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserChatTargetedMessageReplyUnsetReactionCommand : GraphClientCmdlet
    {
