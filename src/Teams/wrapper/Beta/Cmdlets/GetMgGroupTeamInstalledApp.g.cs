...
{
    [GraphRoute("GET", "/groups/{group-id}/team/installedApps")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamInstalledApp", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTeamInstalledAppCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTeamInstalledApp_Get or Get-MgGroupTeamInstalledApp_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTeamInstalledApp_Get" : "Get-MgGroupTeamInstalledApp_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TeamsAppInstallationId : GroupId);
                return;
            }
        }
    }
