...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgGroupTeamPrimaryChannelMessageUnsetReaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgGroupTeamPrimaryChannelMessageUnsetReactionCommand : GraphClientCmdlet
    {
