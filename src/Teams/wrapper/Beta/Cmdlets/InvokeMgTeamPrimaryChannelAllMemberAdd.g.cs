...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamPrimaryChannelAllMemberAdd", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgTeamPrimaryChannelAllMemberAddCommand : GraphClientCmdlet
    {
