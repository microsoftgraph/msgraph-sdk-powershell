...
{
    [GraphRoute("GET", "/teamwork/devices/{teamworkDevice-id}/operations")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDeviceOperation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkDeviceOperation))]
    public class GetMgTeamworkDeviceOperation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkDeviceOperationCollectionResponse? result;
            try
            {
                result = client.Teamwork.Devices[TeamworkDeviceId].Operations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teamwork.Devices[TeamworkDeviceId].Operations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
