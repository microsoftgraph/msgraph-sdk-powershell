...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamworkDeletedTeamChannelAllMemberAdd", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgTeamworkDeletedTeamChannelAllMemberAddCommand : GraphClientCmdlet
    {
