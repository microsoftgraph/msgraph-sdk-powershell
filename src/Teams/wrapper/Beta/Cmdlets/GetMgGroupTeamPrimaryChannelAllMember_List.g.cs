...
{
    [GraphRoute("GET", "/groups/{group-id}/team/primaryChannel/allMembers")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamPrimaryChannelAllMember_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ConversationMember))]
    public class GetMgGroupTeamPrimaryChannelAllMember_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.PrimaryChannel.AllMembers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Team.PrimaryChannel.AllMembers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
