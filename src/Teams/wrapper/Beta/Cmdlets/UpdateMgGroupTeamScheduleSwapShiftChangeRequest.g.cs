...
{
    [GraphRoute("PATCH", "/groups/{group-id}/team/schedule/swapShiftsChangeRequests/{swapShiftsChangeRequest-id}")]
    [Cmdlet(VerbsData.Update, "MgGroupTeamScheduleSwapShiftChangeRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SwapShiftsChangeRequest))]
    public class UpdateMgGroupTeamScheduleSwapShiftChangeRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.SwapShiftsChangeRequests[SwapShiftsChangeRequestId].PatchAsync(body, requestConfiguration =>
                {
