...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class UpdateMgTeamworkTeamAppSettingCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Teams.Client.Models.CustomAppSettings? CustomAppSettings { get; set; }
    ...
    if (this.IsParameterBound(nameof(IsChatResourceSpecificConsentEnabled)))
        body.IsChatResourceSpecificConsentEnabled = IsChatResourceSpecificConsentEnabled;
    ...
    if (this.IsParameterBound(nameof(CustomAppSettings)))
        body.CustomAppSettings = CustomAppSettings;
