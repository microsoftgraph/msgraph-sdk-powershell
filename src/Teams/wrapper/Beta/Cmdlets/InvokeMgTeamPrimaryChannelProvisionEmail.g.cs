...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamPrimaryChannelProvisionEmail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ProvisionChannelEmailResult))]
    public class InvokeMgTeamPrimaryChannelProvisionEmailCommand : GraphClientCmdlet
    {
