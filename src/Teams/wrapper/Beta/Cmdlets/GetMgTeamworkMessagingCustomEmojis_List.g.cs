...
{
    [GraphRoute("GET", "/teamwork/messaging/customEmojis")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkMessagingCustomEmojis_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkCustomEmoji))]
    public class GetMgTeamworkMessagingCustomEmojis_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkCustomEmojiCollectionResponse? result;
            try
            {
                result = client.Teamwork.Messaging.CustomEmojis.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teamwork.Messaging.CustomEmojis.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
