...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgChatMarkChatUnreadForUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgChatMarkChatUnreadForUserCommand : GraphClientCmdlet
    {
