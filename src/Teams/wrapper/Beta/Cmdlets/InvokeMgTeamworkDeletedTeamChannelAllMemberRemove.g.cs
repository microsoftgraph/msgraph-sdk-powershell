...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamworkDeletedTeamChannelAllMemberRemove", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgTeamworkDeletedTeamChannelAllMemberRemoveCommand : GraphClientCmdlet
    {
