...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamPrimaryChannelTab", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamPrimaryChannelTabCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamPrimaryChannelTab_Get or Get-MgTeamPrimaryChannelTab_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamPrimaryChannelTab_Get" : "Get-MgTeamPrimaryChannelTab_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TeamsTabId : TeamId);
                return;
            }
        }
    }
