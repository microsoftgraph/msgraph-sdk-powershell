...
{
    [GraphRoute("GET", "/teams/{team-id}/schedule/shiftsRoleDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgTeamScheduleShiftRoleDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ShiftsRoleDefinition))]
    public class GetMgTeamScheduleShiftRoleDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.ShiftsRoleDefinitionCollectionResponse? result;
            try
            {
                result = client.Teams[TeamId].Schedule.ShiftsRoleDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teams[TeamId].Schedule.ShiftsRoleDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
