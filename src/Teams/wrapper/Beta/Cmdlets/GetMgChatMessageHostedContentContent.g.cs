...
{
    [GraphRoute("GET", "/chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}/$value")]
    [Cmdlet(VerbsCommon.Get, "MgChatMessageHostedContentContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgChatMessageHostedContentContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Chats[ChatId].Messages[ChatMessageId].HostedContents[ChatMessageHostedContentId].Content.GetAsync(requestConfiguration =>
                {
