...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class NewMgAppCatalogTeamAppDefinitionCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Teams.Client.Models.TeamsAppInstallationScopes? AllowedInstallationScopes { get; set; }
    ...
    if (this.IsParameterBound(nameof(AzureADAppId)))
        body.AzureADAppId = AzureADAppId;
    ...
    if (this.IsParameterBound(nameof(AllowedInstallationScopes)))
        body.AllowedInstallationScopes = AllowedInstallationScopes;
