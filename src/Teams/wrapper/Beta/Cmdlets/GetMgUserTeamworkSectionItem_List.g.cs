...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTeamworkSectionItem_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkSectionItem))]
    public class GetMgUserTeamworkSectionItem_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkSectionItemCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Teamwork.Sections[TeamworkSectionId].Items.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Teamwork.Sections[TeamworkSectionId].Items.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
