...
{
    [GraphRoute("GET", "/teamwork/devices/{teamworkDevice-id}")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkDevice))]
    public class GetMgTeamworkDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teamwork.Devices[TeamworkDeviceId].GetAsync(requestConfiguration =>
                {
