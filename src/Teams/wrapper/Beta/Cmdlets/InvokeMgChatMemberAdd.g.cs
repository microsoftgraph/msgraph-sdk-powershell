...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgChatMemberAdd", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Teams.Client.Chats.Item.Members.Add.AddPostResponse))]
    public class InvokeMgChatMemberAddCommand : GraphClientCmdlet
    {
