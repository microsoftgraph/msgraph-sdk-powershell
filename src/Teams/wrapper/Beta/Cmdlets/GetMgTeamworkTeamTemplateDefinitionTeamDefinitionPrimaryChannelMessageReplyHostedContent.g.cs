...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContent_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContent_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelMessageReplyHostedContent_List";
            try
            {
