...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgGroupTeamPrimaryChannelArchive", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgGroupTeamPrimaryChannelArchiveCommand : GraphClientCmdlet
    {
