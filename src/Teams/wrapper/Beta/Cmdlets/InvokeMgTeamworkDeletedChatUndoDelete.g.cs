...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamworkDeletedChatUndoDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgTeamworkDeletedChatUndoDeleteCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(DeletedChatId, "Invoke"))
                return;
