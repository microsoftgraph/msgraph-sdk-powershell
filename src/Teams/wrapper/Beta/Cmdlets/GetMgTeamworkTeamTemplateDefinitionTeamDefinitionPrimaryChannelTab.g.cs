...
{
    [GraphRoute("GET", "/teamwork/teamTemplates/{teamTemplate-id}/definitions/{teamTemplateDefinition-id}/teamDefinition/primaryChannel/tabs")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTab", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTabCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTab_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTab_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTab_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPrimaryChannelTab_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TeamsTabId : TeamTemplateDefinitionId);
                return;
            }
        }
    }
