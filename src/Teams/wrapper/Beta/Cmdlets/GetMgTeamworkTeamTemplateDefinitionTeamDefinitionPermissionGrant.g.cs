...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrant", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrantCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrant_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrant_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrant_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionPermissionGrant_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ResourceSpecificPermissionGrantId : TeamTemplateDefinitionId);
                return;
            }
        }
    }
