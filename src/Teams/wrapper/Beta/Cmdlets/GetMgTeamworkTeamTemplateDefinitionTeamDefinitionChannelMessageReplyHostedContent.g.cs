...
{
    [GraphRoute("GET", "/teamwork/teamTemplates/{teamTemplate-id}/definitions/{teamTemplateDefinition-id}/teamDefinition/channels/{channel-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContent_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContent_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelMessageReplyHostedContent_List";
            try
            {
