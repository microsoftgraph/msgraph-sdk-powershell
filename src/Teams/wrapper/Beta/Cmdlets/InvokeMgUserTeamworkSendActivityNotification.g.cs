...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserTeamworkSendActivityNotification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserTeamworkSendActivityNotificationCommand : GraphClientCmdlet
    {
