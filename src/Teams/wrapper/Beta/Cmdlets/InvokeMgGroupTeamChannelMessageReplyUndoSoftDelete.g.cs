...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgGroupTeamChannelMessageReplyUndoSoftDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgGroupTeamChannelMessageReplyUndoSoftDeleteCommand : GraphClientCmdlet
    {
