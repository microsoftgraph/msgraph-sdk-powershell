...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserChatTargetedMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserChatTargetedMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserChatTargetedMessageReplyHostedContent_Get or Get-MgUserChatTargetedMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserChatTargetedMessageReplyHostedContent_Get" : "Get-MgUserChatTargetedMessageReplyHostedContent_List";
            try
            {
