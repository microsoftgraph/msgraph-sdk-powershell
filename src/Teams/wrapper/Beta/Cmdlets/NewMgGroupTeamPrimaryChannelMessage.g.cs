...
{
    [GraphRoute("POST", "/groups/{group-id}/team/primaryChannel/messages")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamPrimaryChannelMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ChatMessage))]
    public class NewMgGroupTeamPrimaryChannelMessageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Reactions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.PrimaryChannel.Messages.PostAsync(body, requestConfiguration =>
                {
