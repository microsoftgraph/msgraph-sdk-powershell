...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgTeamPrimaryChannelMessageReplyUnsetReaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgTeamPrimaryChannelMessageReplyUnsetReactionCommand : GraphClientCmdlet
    {
