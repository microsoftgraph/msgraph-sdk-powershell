...
{
    [GraphRoute("GET", "/teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgTeamPrimaryChannelMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamPrimaryChannelMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamPrimaryChannelMessageReplyHostedContent_Get or Get-MgTeamPrimaryChannelMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamPrimaryChannelMessageReplyHostedContent_Get" : "Get-MgTeamPrimaryChannelMessageReplyHostedContent_List";
            try
            {
