...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamOwner_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.User))]
    public class GetMgGroupTeamOwner_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Team.Owners.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Team.Owners.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
