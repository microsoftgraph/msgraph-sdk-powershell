...
{
    [GraphRoute("GET", "/teamwork/devices/{teamworkDevice-id}/operations/{teamworkDeviceOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDeviceOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkDeviceOperation))]
    public class GetMgTeamworkDeviceOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teamwork.Devices[TeamworkDeviceId].Operations[TeamworkDeviceOperationId].GetAsync(requestConfiguration =>
                {
