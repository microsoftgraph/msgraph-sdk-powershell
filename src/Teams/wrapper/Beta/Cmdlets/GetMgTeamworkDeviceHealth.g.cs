...
{
    [GraphRoute("GET", "/teamwork/devices/{teamworkDevice-id}/health")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDeviceHealth")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkDeviceHealth))]
    public class GetMgTeamworkDeviceHealthCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teamwork.Devices[TeamworkDeviceId].Health.GetAsync(requestConfiguration =>
                {
