...
{
    [GraphRoute("POST", "/users/{user-id}/chats/{chat-id}/sendActivityNotification")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserChatSendActivityNotification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserChatSendActivityNotificationCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Teams.Client.Users.Item.Chats.Item.SendActivityNotification.SendActivityNotificationPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Recipient)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                client.Users[UserId].Chats[ChatId].SendActivityNotification.PostAsync(body, requestConfiguration =>
                {
