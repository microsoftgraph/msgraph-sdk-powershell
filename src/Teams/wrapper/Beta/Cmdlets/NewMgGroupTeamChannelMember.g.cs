...
{
    [GraphRoute("POST", "/groups/{group-id}/team/channels/{channel-id}/members")]
    ...
    if (this.IsParameterBound(nameof(VisibleHistoryStartDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Channels[ChannelId].Members.PostAsync(body, requestConfiguration =>
                {
