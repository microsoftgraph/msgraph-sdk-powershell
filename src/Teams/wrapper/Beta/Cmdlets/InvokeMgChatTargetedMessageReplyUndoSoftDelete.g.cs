...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgChatTargetedMessageReplyUndoSoftDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgChatTargetedMessageReplyUndoSoftDeleteCommand : GraphClientCmdlet
    {
