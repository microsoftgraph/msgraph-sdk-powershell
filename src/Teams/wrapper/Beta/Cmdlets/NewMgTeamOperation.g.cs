...
{
    [GraphRoute("POST", "/teams/{team-id}/operations")]
    [Cmdlet(VerbsCommon.New, "MgTeamOperation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamsAsyncOperation))]
    public class NewMgTeamOperationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Operations.PostAsync(body, requestConfiguration =>
                {
