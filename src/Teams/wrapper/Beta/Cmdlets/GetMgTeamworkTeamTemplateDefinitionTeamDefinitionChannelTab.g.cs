...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTab", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTabCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTab_Get or Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTab_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTab_Get" : "Get-MgTeamworkTeamTemplateDefinitionTeamDefinitionChannelTab_List";
            try
            {
