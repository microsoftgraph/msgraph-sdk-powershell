...
namespace Microsoft.Graph.PowerShell.Teams.Client.Models
{
    ...
    public partial class WorkbookDocumentTaskChange : global::Microsoft.Graph.PowerShell.Teams.Client.Models.Entity, IParsable
...
#nullable enable
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity? Assignee { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity Assignee { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity? ChangedBy { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity ChangedBy { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookDocumentTaskChange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookDocumentTaskChange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookDocumentTaskChange();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignee", n => { Assignee = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity>(global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity.CreateFromDiscriminatorValue); } },
                { "changedBy", n => { ChangedBy = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity>(global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity>("assignee", Assignee);
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.WorkbookEmailIdentity>("changedBy", ChangedBy);
