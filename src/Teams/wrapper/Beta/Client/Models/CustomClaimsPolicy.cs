...
namespace Microsoft.Graph.PowerShell.Teams.Client.Models
{
    ...
    public partial class CustomClaimsPolicy : global::Microsoft.Graph.PowerShell.Teams.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimBase>? Claims { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimBase> Claims { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimsPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimsPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimsPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "claims", n => { Claims = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimBase>(global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimBase.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Teams.Client.Models.CustomClaimBase>("claims", Claims);
