...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationError? Error { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecutionResult? State { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecution"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecution"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecution CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecution();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "error", n => { Error = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationError>(global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationError.CreateFromDiscriminatorValue); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecutionResult>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationError>("error", Error);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Teams.Client.Models.SynchronizationTaskExecutionResult>("state", State);
