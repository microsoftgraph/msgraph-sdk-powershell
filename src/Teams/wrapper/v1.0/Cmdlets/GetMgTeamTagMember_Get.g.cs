...
{
    [GraphRoute("GET", "/teams/{team-id}/tags/{teamworkTag-id}/members/{teamworkTagMember-id}")]
    [Cmdlet(VerbsCommon.Get, "MgTeamTagMember_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkTagMember))]
    public class GetMgTeamTagMember_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Tags[TeamworkTagId].Members[TeamworkTagMemberId].GetAsync(requestConfiguration =>
                {
