...
{
    [GraphRoute("GET", "/chats/{chat-id}/permissionGrants/{resourceSpecificPermissionGrant-id}")]
    [Cmdlet(VerbsCommon.Get, "MgChatPermissionGrant_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ResourceSpecificPermissionGrant))]
    public class GetMgChatPermissionGrant_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Chats[ChatId].PermissionGrants[ResourceSpecificPermissionGrantId].GetAsync(requestConfiguration =>
                {
