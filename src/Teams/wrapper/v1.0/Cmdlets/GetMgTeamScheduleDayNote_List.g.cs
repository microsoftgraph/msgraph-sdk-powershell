...
{
    [GraphRoute("GET", "/teams/{team-id}/schedule/dayNotes")]
    [Cmdlet(VerbsCommon.Get, "MgTeamScheduleDayNote_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.DayNote))]
    public class GetMgTeamScheduleDayNote_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.DayNotes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teams[TeamId].Schedule.DayNotes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
