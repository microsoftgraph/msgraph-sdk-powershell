...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class UndoMgTeamworkDeletedChatDeleteCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeletedChatId));
                return;
            }
