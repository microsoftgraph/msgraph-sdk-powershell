...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserChatTargetedMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserChatTargetedMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserChatTargetedMessageHostedContent_Get or Get-MgUserChatTargetedMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserChatTargetedMessageHostedContent_Get" : "Get-MgUserChatTargetedMessageHostedContent_List";
            try
            {
