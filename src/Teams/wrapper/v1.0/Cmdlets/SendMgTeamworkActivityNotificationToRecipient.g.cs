...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommunications.Send, "MgTeamworkActivityNotificationToRecipient", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class SendMgTeamworkActivityNotificationToRecipientCommand : GraphClientCmdlet
    {
