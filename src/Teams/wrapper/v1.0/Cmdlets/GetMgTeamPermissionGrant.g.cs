...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class GetMgTeamPermissionGrantCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ResourceSpecificPermissionGrantId : TeamId);
                return;
            }
        }
    }
