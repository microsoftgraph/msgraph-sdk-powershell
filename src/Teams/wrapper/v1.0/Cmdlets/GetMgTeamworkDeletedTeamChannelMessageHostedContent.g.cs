...
{
    [GraphRoute("GET", "/teamwork/deletedTeams/{deletedTeam-id}/channels/{channel-id}/messages/{chatMessage-id}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDeletedTeamChannelMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamworkDeletedTeamChannelMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamworkDeletedTeamChannelMessageHostedContent_Get or Get-MgTeamworkDeletedTeamChannelMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkDeletedTeamChannelMessageHostedContent_Get" : "Get-MgTeamworkDeletedTeamChannelMessageHostedContent_List";
            try
            {
