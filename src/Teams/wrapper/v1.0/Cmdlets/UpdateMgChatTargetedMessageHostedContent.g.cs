...
{
    [GraphRoute("PATCH", "/chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/hostedContents/{chatMessageHostedContent-id}")]
    [Cmdlet(VerbsData.Update, "MgChatTargetedMessageHostedContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ChatMessageHostedContent))]
    public class UpdateMgChatTargetedMessageHostedContentCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ContentType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Chats[ChatId].TargetedMessages[TargetedChatMessageId].HostedContents[ChatMessageHostedContentId].PatchAsync(body, requestConfiguration =>
                {
