...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class GetMgChatTargetedMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ChatMessageHostedContentId : TargetedChatMessageId);
                return;
            }
        }
    }
