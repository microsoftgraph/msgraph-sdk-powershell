...
{
    [GraphRoute("GET", "/teams/{team-id}/schedule/offerShiftRequests")]
    [Cmdlet(VerbsCommon.Get, "MgTeamScheduleOfferShiftRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OfferShiftRequest))]
    public class GetMgTeamScheduleOfferShiftRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.OfferShiftRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teams[TeamId].Schedule.OfferShiftRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
