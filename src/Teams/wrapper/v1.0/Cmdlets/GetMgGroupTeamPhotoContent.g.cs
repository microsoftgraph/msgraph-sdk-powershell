...
{
    [GraphRoute("GET", "/groups/{group-id}/team/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgGroupTeamPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Photo.Content.GetAsync(requestConfiguration =>
                {
