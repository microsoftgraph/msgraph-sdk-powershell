...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamworkDeletedChat_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.DeletedChat))]
    public class GetMgTeamworkDeletedChat_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.DeletedChatCollectionResponse? result;
            try
            {
                result = client.Teamwork.DeletedChats.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teamwork.DeletedChats.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
