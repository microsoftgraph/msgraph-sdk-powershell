...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamScheduleSchedulingGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SchedulingGroup))]
    public class GetMgTeamScheduleSchedulingGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.SchedulingGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teams[TeamId].Schedule.SchedulingGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
