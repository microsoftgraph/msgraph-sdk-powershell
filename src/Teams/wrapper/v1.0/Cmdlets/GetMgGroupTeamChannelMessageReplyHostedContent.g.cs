...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamChannelMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTeamChannelMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTeamChannelMessageReplyHostedContent_Get or Get-MgGroupTeamChannelMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTeamChannelMessageReplyHostedContent_Get" : "Get-MgGroupTeamChannelMessageReplyHostedContent_List";
            try
            {
