...
{
    [GraphRoute("GET", "/groups/{group-id}/team/channels/{channel-id}/tabs")]
    ...
    public class GetMgGroupTeamChannelTabCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTeamChannelTab_Get" : "Get-MgGroupTeamChannelTab_List";
            try
            {
