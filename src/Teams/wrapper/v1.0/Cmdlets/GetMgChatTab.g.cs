...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgChatTab", DefaultParameterSetName = "List")]
    ...
    public class GetMgChatTabCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgChatTab_Get or Get-MgChatTab_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgChatTab_Get" : "Get-MgChatTab_List";
            try
            {
