...
{
    [GraphRoute("POST", "/groups/{group-id}/team/channels")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.Channel))]
    public class NewMgGroupTeamChannelCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Summary)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Channels.PostAsync(body, requestConfiguration =>
                {
