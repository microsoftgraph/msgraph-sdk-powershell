...
{
    [GraphRoute("POST", "/teams/{team-id}/schedule/offerShiftRequests")]
    [Cmdlet(VerbsCommon.New, "MgTeamScheduleOfferShiftRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OfferShiftRequest))]
    public class NewMgTeamScheduleOfferShiftRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.OfferShiftRequests.PostAsync(body, requestConfiguration =>
                {
