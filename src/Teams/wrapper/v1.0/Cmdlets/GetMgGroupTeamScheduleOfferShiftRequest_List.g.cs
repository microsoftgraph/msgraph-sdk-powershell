...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamScheduleOfferShiftRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OfferShiftRequest))]
    public class GetMgGroupTeamScheduleOfferShiftRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.OfferShiftRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Team.Schedule.OfferShiftRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
