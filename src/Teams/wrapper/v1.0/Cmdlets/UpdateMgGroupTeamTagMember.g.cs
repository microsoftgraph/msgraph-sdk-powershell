...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    public class UpdateMgGroupTeamTagMemberCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, TeamworkTagMemberId));
                return;
            }
