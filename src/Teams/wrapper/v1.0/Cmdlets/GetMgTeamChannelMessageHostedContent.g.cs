...
{
    [GraphRoute("GET", "/teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgTeamChannelMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamChannelMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamChannelMessageHostedContent_Get or Get-MgTeamChannelMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamChannelMessageHostedContent_Get" : "Get-MgTeamChannelMessageHostedContent_List";
            try
            {
