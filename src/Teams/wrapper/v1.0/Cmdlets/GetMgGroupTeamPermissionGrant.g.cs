...
{
    [GraphRoute("GET", "/groups/{group-id}/team/permissionGrants")]
    ...
    public class GetMgGroupTeamPermissionGrantCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTeamPermissionGrant_Get" : "Get-MgGroupTeamPermissionGrant_List";
            try
            {
