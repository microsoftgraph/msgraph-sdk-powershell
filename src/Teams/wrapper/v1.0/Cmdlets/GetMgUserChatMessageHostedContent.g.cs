...
{
    [GraphRoute("GET", "/users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgUserChatMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserChatMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserChatMessageHostedContent_Get or Get-MgUserChatMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserChatMessageHostedContent_Get" : "Get-MgUserChatMessageHostedContent_List";
            try
            {
