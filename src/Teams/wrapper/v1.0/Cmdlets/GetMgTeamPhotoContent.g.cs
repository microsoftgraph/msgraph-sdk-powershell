...
{
    [GraphRoute("GET", "/teams/{team-id}/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgTeamPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgTeamPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Photo.Content.GetAsync(requestConfiguration =>
                {
