...
{
    [GraphRoute("GET", "/groups/{group-id}/team/schedule/schedulingGroups")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamScheduleSchedulingGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SchedulingGroup))]
    public class GetMgGroupTeamScheduleSchedulingGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.SchedulingGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Team.Schedule.SchedulingGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
