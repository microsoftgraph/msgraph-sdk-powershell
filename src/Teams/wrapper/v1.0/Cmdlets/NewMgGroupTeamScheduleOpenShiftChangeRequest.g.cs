...
{
    [GraphRoute("POST", "/groups/{group-id}/team/schedule/openShiftChangeRequests")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamScheduleOpenShiftChangeRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OpenShiftChangeRequest))]
    public class NewMgGroupTeamScheduleOpenShiftChangeRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.OpenShiftChangeRequests.PostAsync(body, requestConfiguration =>
                {
