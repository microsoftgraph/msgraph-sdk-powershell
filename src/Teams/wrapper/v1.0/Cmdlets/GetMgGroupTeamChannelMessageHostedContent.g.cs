...
{
    [GraphRoute("GET", "/groups/{group-id}/team/channels/{channel-id}/messages/{chatMessage-id}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTeamChannelMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTeamChannelMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTeamChannelMessageHostedContent_Get or Get-MgGroupTeamChannelMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTeamChannelMessageHostedContent_Get" : "Get-MgGroupTeamChannelMessageHostedContent_List";
            try
            {
