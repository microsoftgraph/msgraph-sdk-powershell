...
{
    [GraphRoute("GET", "/chats/{chat-id}/messages/{chatMessage-id}")]
    [Cmdlet(VerbsCommon.Get, "MgChatMessage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ChatMessage))]
    public class GetMgChatMessage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Chats[ChatId].Messages[ChatMessageId].GetAsync(requestConfiguration =>
                {
