...
{
    [GraphRoute("GET", "/teams/{team-id}/permissionGrants/{resourceSpecificPermissionGrant-id}")]
    [Cmdlet(VerbsCommon.Get, "MgTeamPermissionGrant_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.ResourceSpecificPermissionGrant))]
    public class GetMgTeamPermissionGrant_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].PermissionGrants[ResourceSpecificPermissionGrantId].GetAsync(requestConfiguration =>
                {
