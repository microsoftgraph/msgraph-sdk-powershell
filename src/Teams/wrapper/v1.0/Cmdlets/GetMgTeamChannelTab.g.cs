...
{
    [GraphRoute("GET", "/teams/{team-id}/channels/{channel-id}/tabs")]
    [Cmdlet(VerbsCommon.Get, "MgTeamChannelTab", DefaultParameterSetName = "List")]
    ...
    public class GetMgTeamChannelTabCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgTeamChannelTab_Get or Get-MgTeamChannelTab_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamChannelTab_Get" : "Get-MgTeamChannelTab_List";
            try
            {
