...
{
    [GraphRoute("POST", "/teams/{team-id}/primaryChannel/sharedWithTeams")]
    [Cmdlet(VerbsCommon.New, "MgTeamPrimaryChannelSharedWithTeam", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SharedWithChannelTeamInfo))]
    public class NewMgTeamPrimaryChannelSharedWithTeamCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(IsHostTeam)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].PrimaryChannel.SharedWithTeams.PostAsync(body, requestConfiguration =>
                {
