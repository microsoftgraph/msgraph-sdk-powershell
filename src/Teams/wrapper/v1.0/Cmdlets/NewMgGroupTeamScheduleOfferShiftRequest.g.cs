...
{
    [GraphRoute("POST", "/groups/{group-id}/team/schedule/offerShiftRequests")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamScheduleOfferShiftRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OfferShiftRequest))]
    public class NewMgGroupTeamScheduleOfferShiftRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.OfferShiftRequests.PostAsync(body, requestConfiguration =>
                {
