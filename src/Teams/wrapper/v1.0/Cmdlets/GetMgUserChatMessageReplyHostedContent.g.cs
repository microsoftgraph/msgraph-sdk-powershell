...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserChatMessageReplyHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserChatMessageReplyHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserChatMessageReplyHostedContent_Get or Get-MgUserChatMessageReplyHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserChatMessageReplyHostedContent_Get" : "Get-MgUserChatMessageReplyHostedContent_List";
            try
            {
