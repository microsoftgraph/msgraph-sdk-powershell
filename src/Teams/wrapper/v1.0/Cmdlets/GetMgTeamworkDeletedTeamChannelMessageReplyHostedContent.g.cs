...
{
    [GraphRoute("GET", "/teamwork/deletedTeams/{deletedTeam-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents")]
    ...
    public class GetMgTeamworkDeletedTeamChannelMessageReplyHostedContentCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgTeamworkDeletedTeamChannelMessageReplyHostedContent_Get" : "Get-MgTeamworkDeletedTeamChannelMessageReplyHostedContent_List";
            try
            {
