...
{
    [GraphRoute("GET", "/chats/{chat-id}/tabs/{teamsTab-id}")]
    [Cmdlet(VerbsCommon.Get, "MgChatTab_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamsTab))]
    public class GetMgChatTab_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Chats[ChatId].Tabs[TeamsTabId].GetAsync(requestConfiguration =>
                {
