...
{
    [GraphRoute("POST", "/groups/{group-id}/team/schedule/schedulingGroups")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamScheduleSchedulingGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SchedulingGroup))]
    public class NewMgGroupTeamScheduleSchedulingGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CreatedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Schedule.SchedulingGroups.PostAsync(body, requestConfiguration =>
                {
