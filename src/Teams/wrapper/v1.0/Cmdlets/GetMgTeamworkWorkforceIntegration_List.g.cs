...
namespace Microsoft.Graph.PowerShell.Teams
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTeamworkWorkforceIntegration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.WorkforceIntegration))]
    public class GetMgTeamworkWorkforceIntegration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Teams.Client.Models.WorkforceIntegrationCollectionResponse? result;
            try
            {
                result = client.Teamwork.WorkforceIntegrations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Teamwork.WorkforceIntegrations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
