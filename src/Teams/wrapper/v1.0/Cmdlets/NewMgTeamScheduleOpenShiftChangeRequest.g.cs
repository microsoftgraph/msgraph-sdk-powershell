...
{
    [GraphRoute("POST", "/teams/{team-id}/schedule/openShiftChangeRequests")]
    [Cmdlet(VerbsCommon.New, "MgTeamScheduleOpenShiftChangeRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.OpenShiftChangeRequest))]
    public class NewMgTeamScheduleOpenShiftChangeRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.OpenShiftChangeRequests.PostAsync(body, requestConfiguration =>
                {
