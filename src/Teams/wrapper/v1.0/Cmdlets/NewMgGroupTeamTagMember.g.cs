...
{
    [GraphRoute("POST", "/groups/{group-id}/team/tags/{teamworkTag-id}/members")]
    [Cmdlet(VerbsCommon.New, "MgGroupTeamTagMember", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TeamworkTagMember))]
    public class NewMgGroupTeamTagMemberCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Team.Tags[TeamworkTagId].Members.PostAsync(body, requestConfiguration =>
                {
