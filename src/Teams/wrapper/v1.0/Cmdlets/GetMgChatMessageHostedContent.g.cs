...
{
    [GraphRoute("GET", "/chats/{chat-id}/messages/{chatMessage-id}/hostedContents")]
    [Cmdlet(VerbsCommon.Get, "MgChatMessageHostedContent", DefaultParameterSetName = "List")]
    ...
    public class GetMgChatMessageHostedContentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgChatMessageHostedContent_Get or Get-MgChatMessageHostedContent_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgChatMessageHostedContent_Get" : "Get-MgChatMessageHostedContent_List";
            try
            {
