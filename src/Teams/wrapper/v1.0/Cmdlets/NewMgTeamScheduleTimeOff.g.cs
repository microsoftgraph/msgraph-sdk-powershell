...
{
    [GraphRoute("POST", "/teams/{team-id}/schedule/timesOff")]
    [Cmdlet(VerbsCommon.New, "MgTeamScheduleTimeOff", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.TimeOff))]
    public class NewMgTeamScheduleTimeOffCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SharedTimeOff)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.TimesOff.PostAsync(body, requestConfiguration =>
                {
