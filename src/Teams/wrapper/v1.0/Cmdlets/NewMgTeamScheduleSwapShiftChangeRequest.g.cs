...
{
    [GraphRoute("POST", "/teams/{team-id}/schedule/swapShiftsChangeRequests")]
    [Cmdlet(VerbsCommon.New, "MgTeamScheduleSwapShiftChangeRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Teams.Client.Models.SwapShiftsChangeRequest))]
    public class NewMgTeamScheduleSwapShiftChangeRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Teams[TeamId].Schedule.SwapShiftsChangeRequests.PostAsync(body, requestConfiguration =>
                {
