...
New-MgBetaTeamworkDeviceOperation -TeamworkDeviceId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastActionDateTime <DateTime>] [-OperationType <String>] [-ResponseHeadersVariable <String>]
 [-StartedDateTime <DateTime>] [-Status <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaTeamworkDeviceOperation -TeamworkDeviceId <String>
 -BodyParameter <IMicrosoftGraphTeamworkDeviceOperation> [-ResponseHeadersVariable <String>]
