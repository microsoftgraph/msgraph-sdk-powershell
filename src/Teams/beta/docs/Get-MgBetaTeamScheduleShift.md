...
### Get
```
Get-MgBetaTeamScheduleShift -ShiftId <String> -TeamId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTeamScheduleShift -InputObject <ITeamsIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
