...
### Delete (Default)
```
Remove-MgBetaChatTab -ChatId <String> -TeamsTabId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaChatTab -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
