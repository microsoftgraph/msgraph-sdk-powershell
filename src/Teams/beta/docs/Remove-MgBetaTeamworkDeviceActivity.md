...
### Delete (Default)
```
Remove-MgBetaTeamworkDeviceActivity -TeamworkDeviceId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaTeamworkDeviceActivity -InputObject <ITeamsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
