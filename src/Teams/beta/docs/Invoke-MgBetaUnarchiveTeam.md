...
### Unarchive (Default)
```
Invoke-MgBetaUnarchiveTeam -TeamId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnarchiveViaIdentity
```
Invoke-MgBetaUnarchiveTeam -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
