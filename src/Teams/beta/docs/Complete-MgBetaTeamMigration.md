...
### Complete (Default)
```
Complete-MgBetaTeamMigration -TeamId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaTeamMigration -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
