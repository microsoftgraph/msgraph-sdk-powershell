...
### Provision (Default)
```
New-MgBetaTeamChannelEmail -ChannelId <String> -TeamId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
