...
Get-MgBetaUserChatMessageReplyHostedContent -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
 ...
 [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [-All] [-CountVariable <String>] [-Headers <IDictionary>]
...
```
Get-MgBetaUserChatMessageReplyHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -ChatMessageId1 <String> -UserId <String> -OutFile <String> [-Format <String>]
...
### GetViaIdentity1
```
Get-MgBetaUserChatMessageReplyHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-Format <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
