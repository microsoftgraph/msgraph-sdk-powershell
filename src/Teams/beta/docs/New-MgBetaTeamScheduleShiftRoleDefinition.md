...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamscheduleshiftroledefinition
schema: 2.0.0
---
...
### Create
```
New-MgBetaTeamScheduleShiftRoleDefinition -TeamId <String>
