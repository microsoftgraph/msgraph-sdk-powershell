...
Update-MgBetaTeamScheduleOpenShift -OpenShiftId <String> -TeamId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SharedOpenShift <IMicrosoftGraphOpenShiftItem>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaTeamScheduleOpenShift -OpenShiftId <String> -TeamId <String>
 -BodyParameter <IMicrosoftGraphOpenShift> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
