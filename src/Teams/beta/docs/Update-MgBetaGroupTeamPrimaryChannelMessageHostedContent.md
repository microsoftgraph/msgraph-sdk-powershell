...
Update-MgBetaGroupTeamPrimaryChannelMessageHostedContent -ChatMessageHostedContentId <String>
 ...
 [-ContentBytesInputFile <String>] [-ContentType <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaGroupTeamPrimaryChannelMessageHostedContent -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -GroupId <String> -BodyParameter <Hashtable> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
