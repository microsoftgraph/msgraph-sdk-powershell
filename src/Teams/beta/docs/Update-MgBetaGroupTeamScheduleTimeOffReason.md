...
Update-MgBetaGroupTeamScheduleTimeOffReason -GroupId <String> -TimeOffReasonId <String>
 ...
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupTeamScheduleTimeOffReason -GroupId <String> -TimeOffReasonId <String>
 -BodyParameter <IMicrosoftGraphTimeOffReason> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaGroupTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-IsActive] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-Headers <IDictionary>] [-Confirm]
