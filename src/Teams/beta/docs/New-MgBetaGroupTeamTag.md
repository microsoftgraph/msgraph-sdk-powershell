...
New-MgBetaGroupTeamTag -GroupId <String> [-AdditionalProperties <Hashtable>] [-Description <String>]
 ...
 [-ResponseHeadersVariable <String>] [-TagType <String>] [-TeamId <String>] [-Headers <IDictionary>]
...
New-MgBetaGroupTeamTag -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Members <IMicrosoftGraphTeamworkTagMember[]>] [-ResponseHeadersVariable <String>] [-TagType <String>]
 [-TeamId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
