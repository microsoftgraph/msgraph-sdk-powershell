...
Update-MgBetaGroupTeamScheduleDayNote -DayNoteId <String> -GroupId <String>
 ...
 [-ResponseHeadersVariable <String>] [-SharedDayNote <IMicrosoftGraphItemBody>] [-Headers <IDictionary>]
...
Update-MgBetaGroupTeamScheduleDayNote -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-ResponseHeadersVariable <String>]
 [-SharedDayNote <IMicrosoftGraphItemBody>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
