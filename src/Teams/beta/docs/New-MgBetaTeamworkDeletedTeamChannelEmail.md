...
### Provision (Default)
```
New-MgBetaTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String> [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-Confirm]
