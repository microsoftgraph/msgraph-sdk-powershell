...
### Message (Default)
```
Invoke-MgBetaMessageTeamChannel -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### MessageViaIdentity
```
Invoke-MgBetaMessageTeamChannel -InputObject <ITeamsIdentity> [-Count] [-ExpandProperty <String[]>]
