...
Update-MgBetaTeamworkDeviceHealth -TeamworkDeviceId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-PeripheralsHealth <IMicrosoftGraphTeamworkPeripheralsHealth>] [-ResponseHeadersVariable <String>]
 [-SoftwareUpdateHealth <IMicrosoftGraphTeamworkSoftwareUpdateHealth>] [-Headers <IDictionary>] [-Confirm]
