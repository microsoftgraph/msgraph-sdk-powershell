...
```
Get-MgBetaTeamChannelMessageHostedContent -ChannelId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -TeamId <String> -OutFile <String> [-Format <String>] [-Headers <IDictionary>]
...
### GetViaIdentity1
```
Get-MgBetaTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-Format <String>]
