...
### AddExpanded (Default)
```
Add-MgBetaTeamMember -TeamId <String> [-AdditionalProperties <Hashtable>] [-ResponseHeadersVariable <String>]
...
Add-MgBetaTeamMember -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-Values <IMicrosoftGraphConversationMember[]>] [-Headers <IDictionary>]
