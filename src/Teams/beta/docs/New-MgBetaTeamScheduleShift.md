...
New-MgBetaTeamScheduleShift -TeamId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SharedShift <IMicrosoftGraphShiftItem>] [-UserId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaTeamScheduleShift -TeamId <String> -BodyParameter <IMicrosoftGraphShift> [-Headers <IDictionary>]
