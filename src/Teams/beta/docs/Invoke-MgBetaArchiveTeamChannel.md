...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaarchiveteamchannel
schema: 2.0.0
---
...
Invoke-MgBetaArchiveTeamChannel -ChannelId <String> -TeamId <String> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-ShouldSetSpoSiteReadOnlyForMembers] [-Headers <IDictionary>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1R5Aj03TeamsTeamIdChannelsChannelIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1R5Aj03TeamsTeamIdChannelsChannelIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
