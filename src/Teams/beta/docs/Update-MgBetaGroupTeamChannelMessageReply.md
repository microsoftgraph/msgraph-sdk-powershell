...
```
Update-MgBetaGroupTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String> -ChatMessageId1 <String>
 -GroupId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
