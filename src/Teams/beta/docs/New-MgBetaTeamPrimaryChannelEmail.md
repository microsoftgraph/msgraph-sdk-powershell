...
### Provision (Default)
```
New-MgBetaTeamPrimaryChannelEmail -TeamId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
