...
```
This example shows how to use the New-MgBetaBetaTeamPrimaryChannelMessage Cmdlet.
...
### Example 7: <span class="no-loc" dir="ltr" lang="en-us">@mention</span> a channel in a channel message
...
### Example 8: <span class="no-loc" dir="ltr" lang="en-us">@mention</span> a team in a channel message
