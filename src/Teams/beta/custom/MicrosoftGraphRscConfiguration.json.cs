...
namespace Microsoft.Graph.Beta.PowerShell.Models
{
    ...
    public partial class MicrosoftGraphRscConfiguration
    {
        ...
        public static Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphRscConfiguration FromJson(Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonObject json ? new MicrosoftGraphRscConfiguration(json, new global::System.Collections.Generic.HashSet<string>() { @"id", @"scopeType", @"state" }) : null;
        }
        ...
        internal MicrosoftGraphRscConfiguration(Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            __microsoftGraphEntity = new Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphEntity(json, new global::System.Collections.Generic.HashSet<string>((exclusions ?? new System.Collections.Generic.HashSet<string>())) { @"id", @"scopeType", @"state" });
            {
                _scopeType =
                    If(json?.PropertyT<Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonString>("scopeType"), out var __jsonScopeType)
                    ? (MicrosoftGraphRscConfigurationScopeType)Enum.Parse(typeof(MicrosoftGraphRscConfigurationScopeType), __jsonScopeType.ToString())
                    : ScopeType;
            }
            {
                _state =
                    If(json?.PropertyT<Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonString>("state"), out var __jsonState)
                    ? (MicrosoftGraphRscConfigurationState)Enum.Parse(typeof(MicrosoftGraphRscConfigurationState), __jsonState.ToString())
                    : State;
            }
        ...
        public Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonNode ToJson(Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonObject container, Microsoft.Graph.Beta.PowerShell.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf(null != (((object)this._state)?.ToString()) ? (Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonNode)new Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonString(this._state.ToString()) : null, "state", container.Add);
            AddIf(null != (((object)this._scopeType)?.ToString()) ? (Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonNode)new Microsoft.Graph.Beta.PowerShell.Runtime.Json.JsonString(this._scopeType.ToString()) : null, "scopeType", container.Add);
