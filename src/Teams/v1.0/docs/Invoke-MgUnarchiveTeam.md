...
### Unarchive (Default)
```
Invoke-MgUnarchiveTeam -TeamId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnarchiveViaIdentity
```
Invoke-MgUnarchiveTeam -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
