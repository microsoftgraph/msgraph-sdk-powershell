...
```
Get-MgTeamChannelMessageReplyHostedContent -ChannelId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -ChatMessageId1 <String> -TeamId <String> -OutFile <String> [-Format <String>]
...
### GetViaIdentity1
```
Get-MgTeamChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
