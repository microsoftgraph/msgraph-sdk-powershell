...
### Delete (Default)
```
Remove-MgTeamIncomingChannel -ChannelId <String> -TeamId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamIncomingChannel -InputObject <ITeamsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
