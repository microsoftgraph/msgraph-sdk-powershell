...
### Provision (Default)
```
New-MgTeamChannelEmail -ChannelId <String> -TeamId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgTeamChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
