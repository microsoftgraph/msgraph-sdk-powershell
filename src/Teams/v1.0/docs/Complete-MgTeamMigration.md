...
### Complete (Default)
```
Complete-MgTeamMigration -TeamId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgTeamMigration -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
