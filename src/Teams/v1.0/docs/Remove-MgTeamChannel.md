...
### Delete (Default)
```
Remove-MgTeamChannel -ChannelId <String> -TeamId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgTeamChannel -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
