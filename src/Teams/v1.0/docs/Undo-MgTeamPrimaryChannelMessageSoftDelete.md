...
### Undo (Default)
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -ChatMessageId <String> -TeamId <String>
...
### UndoViaIdentity
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
