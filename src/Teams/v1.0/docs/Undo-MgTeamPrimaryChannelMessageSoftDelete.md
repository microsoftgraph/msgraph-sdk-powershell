...
### Undo (Default)
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -ChatMessageId <String> -TeamId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru]
