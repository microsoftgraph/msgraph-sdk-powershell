...
### Remove (Default)
```
Remove-MgTeamChannelEmail -ChannelId <String> -TeamId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgTeamChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
