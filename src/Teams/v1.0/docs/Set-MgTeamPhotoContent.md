...
### Set (Default)
```
Set-MgTeamPhotoContent -TeamId <String> -InFile <String> [-Data <Stream>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgTeamPhotoContent -InputObject <ITeamsIdentity> -InFile <String> [-Data <Stream>] [-PassThru] [-Confirm]
