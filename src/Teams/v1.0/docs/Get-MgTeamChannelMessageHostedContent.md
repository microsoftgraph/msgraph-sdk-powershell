...
```
Get-MgTeamChannelMessageHostedContent -ChannelId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -TeamId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```
...
### GetViaIdentity1
```
Get-MgTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-Headers <IDictionary>]
