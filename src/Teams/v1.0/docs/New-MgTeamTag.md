...
New-MgTeamTag -TeamId <String> [-AdditionalProperties <Hashtable>] [-Description <String>]
 ...
 [-TagType <String>] [-TeamId1 <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgTeamTag -TeamId <String> -BodyParameter <IMicrosoftGraphTeamworkTag> [-Headers <IDictionary>] [-Confirm]
...
New-MgTeamTag -InputObject <ITeamsIdentity> [-TeamId <String>] [-AdditionalProperties <Hashtable>]
 ...
 [-Members <IMicrosoftGraphTeamworkTagMember[]>] [-TagType <String>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
