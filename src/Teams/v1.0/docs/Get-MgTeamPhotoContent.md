...
### Get (Default)
```
Get-MgTeamPhotoContent -TeamId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamPhotoContent -InputObject <ITeamsIdentity> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```
