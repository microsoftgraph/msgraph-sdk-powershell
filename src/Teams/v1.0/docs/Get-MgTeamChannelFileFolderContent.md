...
### Get (Default)
```
Get-MgTeamChannelFileFolderContent -ChannelId <String> -TeamId <String> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamChannelFileFolderContent -InputObject <ITeamsIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
