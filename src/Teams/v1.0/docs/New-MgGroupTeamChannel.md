...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannel
schema: 2.0.0
---
...
### Create
```
New-MgGroupTeamChannel -GroupId <String> -BodyParameter <IMicrosoftGraphChannel> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
