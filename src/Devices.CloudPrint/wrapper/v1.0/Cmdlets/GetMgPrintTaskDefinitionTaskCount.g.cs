...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    public class GetMgPrintTaskDefinitionTaskCountCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, PrintTaskDefinitionId));
                return;
            }
