...
{
    [GraphRoute("GET", "/print/operations")]
    [Cmdlet(VerbsCommon.Get, "MgPrintOperation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintOperation))]
    public class GetMgPrintOperation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintOperationCollectionResponse? result;
            try
            {
                result = client.Print.Operations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Operations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
