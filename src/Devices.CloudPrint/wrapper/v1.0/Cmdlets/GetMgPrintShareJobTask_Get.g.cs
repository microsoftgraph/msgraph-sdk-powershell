...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/jobs/{printJob-id}/tasks/{printTask-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareJobTask_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTask))]
    public class GetMgPrintShareJobTask_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].Jobs[PrintJobId].Tasks[PrintTaskId].GetAsync(requestConfiguration =>
                {
