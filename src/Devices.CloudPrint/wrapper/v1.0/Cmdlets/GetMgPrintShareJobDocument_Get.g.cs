...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareJobDocument_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintDocument))]
    public class GetMgPrintShareJobDocument_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].Jobs[PrintJobId].Documents[PrintDocumentId].GetAsync(requestConfiguration =>
                {
