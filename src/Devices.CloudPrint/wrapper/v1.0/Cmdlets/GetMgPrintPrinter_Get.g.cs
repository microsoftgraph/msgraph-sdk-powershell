...
{
    [GraphRoute("GET", "/print/printers/{printer-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinter_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.Printer))]
    public class GetMgPrintPrinter_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].GetAsync(requestConfiguration =>
                {
