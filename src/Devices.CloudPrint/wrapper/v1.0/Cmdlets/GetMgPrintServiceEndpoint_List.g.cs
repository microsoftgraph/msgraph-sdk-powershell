...
{
    [GraphRoute("GET", "/print/services/{printService-id}/endpoints")]
    [Cmdlet(VerbsCommon.Get, "MgPrintServiceEndpoint_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintServiceEndpoint))]
    public class GetMgPrintServiceEndpoint_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintServiceEndpointCollectionResponse? result;
            try
            {
                result = client.Print.Services[PrintServiceId].Endpoints.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Services[PrintServiceId].Endpoints.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
