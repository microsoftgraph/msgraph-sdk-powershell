...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/printer")]
    [Cmdlet(VerbsCommon.Get, "MgPrintSharePrinter")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.Printer))]
    public class GetMgPrintSharePrinterCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].Printer.GetAsync(requestConfiguration =>
                {
