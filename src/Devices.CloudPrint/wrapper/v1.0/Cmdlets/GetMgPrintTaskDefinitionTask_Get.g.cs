...
{
    [GraphRoute("GET", "/print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintTaskDefinitionTask_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTask))]
    public class GetMgPrintTaskDefinitionTask_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.TaskDefinitions[PrintTaskDefinitionId].Tasks[PrintTaskId].GetAsync(requestConfiguration =>
                {
