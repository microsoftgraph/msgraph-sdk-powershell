...
{
    [GraphRoute("GET", "/print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/trigger")]
    [Cmdlet(VerbsCommon.Get, "MgPrintTaskDefinitionTaskTrigger")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskTrigger))]
    public class GetMgPrintTaskDefinitionTaskTriggerCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.TaskDefinitions[PrintTaskDefinitionId].Tasks[PrintTaskId].Trigger.GetAsync(requestConfiguration =>
                {
