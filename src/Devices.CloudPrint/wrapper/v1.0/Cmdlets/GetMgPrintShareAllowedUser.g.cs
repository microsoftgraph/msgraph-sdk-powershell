...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/allowedUsers")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareAllowedUser")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.User))]
    public class GetMgPrintShareAllowedUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.Print.Shares[PrinterShareId].AllowedUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Shares[PrinterShareId].AllowedUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
