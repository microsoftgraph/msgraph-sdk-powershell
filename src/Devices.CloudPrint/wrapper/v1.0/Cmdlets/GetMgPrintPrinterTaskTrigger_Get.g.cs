...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterTaskTrigger_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskTrigger))]
    public class GetMgPrintPrinterTaskTrigger_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].TaskTriggers[PrintTaskTriggerId].GetAsync(requestConfiguration =>
                {
