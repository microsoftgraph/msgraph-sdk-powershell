...
{
    [GraphRoute("GET", "/print/taskDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgPrintTaskDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskDefinition))]
    public class GetMgPrintTaskDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskDefinitionCollectionResponse? result;
            try
            {
                result = client.Print.TaskDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.TaskDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
