...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/jobs/{printJob-id}/documents")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareJobDocument", DefaultParameterSetName = "List")]
    ...
    public class GetMgPrintShareJobDocumentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgPrintShareJobDocument_Get or Get-MgPrintShareJobDocument_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPrintShareJobDocument_Get" : "Get-MgPrintShareJobDocument_List";
            try
            {
