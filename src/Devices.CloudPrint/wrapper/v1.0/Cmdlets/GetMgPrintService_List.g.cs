...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrintService_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintService))]
    public class GetMgPrintService_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintServiceCollectionResponse? result;
            try
            {
                result = client.Print.Services.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Services.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
