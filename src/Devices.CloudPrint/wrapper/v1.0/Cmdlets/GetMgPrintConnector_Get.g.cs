...
{
    [GraphRoute("GET", "/print/connectors/{printConnector-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintConnector_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintConnector))]
    public class GetMgPrintConnector_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Connectors[PrintConnectorId].GetAsync(requestConfiguration =>
                {
