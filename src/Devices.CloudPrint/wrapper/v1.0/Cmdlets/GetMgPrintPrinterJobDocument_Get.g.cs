...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/jobs/{printJob-id}/documents/{printDocument-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterJobDocument_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintDocument))]
    public class GetMgPrintPrinterJobDocument_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].Jobs[PrintJobId].Documents[PrintDocumentId].GetAsync(requestConfiguration =>
                {
