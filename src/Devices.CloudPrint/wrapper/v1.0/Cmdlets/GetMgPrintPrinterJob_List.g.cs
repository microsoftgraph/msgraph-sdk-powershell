...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/jobs")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintJob))]
    public class GetMgPrintPrinterJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintJobCollectionResponse? result;
            try
            {
                result = client.Print.Printers[PrinterId].Jobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Printers[PrinterId].Jobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
