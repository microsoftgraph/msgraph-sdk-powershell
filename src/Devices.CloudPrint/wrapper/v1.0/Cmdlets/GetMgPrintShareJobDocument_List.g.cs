...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrintShareJobDocument_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintDocument))]
    public class GetMgPrintShareJobDocument_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].Jobs[PrintJobId].Documents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Shares[PrinterShareId].Jobs[PrintJobId].Documents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
