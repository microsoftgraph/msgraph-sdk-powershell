...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/jobs/{printJob-id}/tasks/{printTask-id}/trigger")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterJobTaskTrigger")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskTrigger))]
    public class GetMgPrintPrinterJobTaskTriggerCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].Jobs[PrintJobId].Tasks[PrintTaskId].Trigger.GetAsync(requestConfiguration =>
                {
