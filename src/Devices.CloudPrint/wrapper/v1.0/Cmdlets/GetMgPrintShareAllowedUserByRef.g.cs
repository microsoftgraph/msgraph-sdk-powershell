...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/allowedUsers/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareAllowedUserByRef")]
    [OutputType(typeof(string))]
    public class GetMgPrintShareAllowedUserByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].AllowedUsers.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Shares[PrinterShareId].AllowedUsers.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
