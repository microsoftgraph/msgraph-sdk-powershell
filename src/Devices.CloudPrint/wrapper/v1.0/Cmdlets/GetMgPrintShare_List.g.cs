...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrintShare_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrinterShare))]
    public class GetMgPrintShare_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Shares.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
