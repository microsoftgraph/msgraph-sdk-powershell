...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/jobs/{printJob-id}/tasks/{printTask-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterJobTask_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTask))]
    public class GetMgPrintPrinterJobTask_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].Jobs[PrintJobId].Tasks[PrintTaskId].GetAsync(requestConfiguration =>
                {
