...
{
    [GraphRoute("GET", "/print/operations/{printOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintOperation))]
    public class GetMgPrintOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Operations[PrintOperationId].GetAsync(requestConfiguration =>
                {
