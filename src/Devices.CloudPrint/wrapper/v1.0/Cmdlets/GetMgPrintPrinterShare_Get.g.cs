...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/shares/{printerShare-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterShare_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrinterShare))]
    public class GetMgPrintPrinterShare_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].Shares[PrinterShareId].GetAsync(requestConfiguration =>
                {
