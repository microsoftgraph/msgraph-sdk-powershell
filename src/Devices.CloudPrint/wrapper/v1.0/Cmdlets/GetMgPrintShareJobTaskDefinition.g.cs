...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/jobs/{printJob-id}/tasks/{printTask-id}/definition")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareJobTaskDefinition")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskDefinition))]
    public class GetMgPrintShareJobTaskDefinitionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Shares[PrinterShareId].Jobs[PrintJobId].Tasks[PrintTaskId].Definition.GetAsync(requestConfiguration =>
                {
