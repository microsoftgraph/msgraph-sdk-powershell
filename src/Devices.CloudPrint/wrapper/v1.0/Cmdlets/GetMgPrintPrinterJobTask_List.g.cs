...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterJobTask_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTask))]
    public class GetMgPrintPrinterJobTask_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskCollectionResponse? result;
            try
            {
                result = client.Print.Printers[PrinterId].Jobs[PrintJobId].Tasks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Printers[PrinterId].Jobs[PrintJobId].Tasks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
