...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/shares")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterShare_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrinterShare))]
    public class GetMgPrintPrinterShare_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrinterShareCollectionResponse? result;
            try
            {
                result = client.Print.Printers[PrinterId].Shares.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Printers[PrinterId].Shares.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
