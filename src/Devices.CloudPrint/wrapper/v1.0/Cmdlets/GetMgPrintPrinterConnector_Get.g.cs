...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/connectors/{printConnector-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterConnector_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintConnector))]
    public class GetMgPrintPrinterConnector_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.Printers[PrinterId].Connectors[PrintConnectorId].GetAsync(requestConfiguration =>
                {
