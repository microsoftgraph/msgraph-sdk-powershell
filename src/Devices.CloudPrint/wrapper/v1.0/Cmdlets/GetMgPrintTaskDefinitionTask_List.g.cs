...
{
    [GraphRoute("GET", "/print/taskDefinitions/{printTaskDefinition-id}/tasks")]
    [Cmdlet(VerbsCommon.Get, "MgPrintTaskDefinitionTask_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTask))]
    public class GetMgPrintTaskDefinitionTask_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Print.TaskDefinitions[PrintTaskDefinitionId].Tasks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.TaskDefinitions[PrintTaskDefinitionId].Tasks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
