...
{
    [GraphRoute("GET", "/print/shares/{printerShare-id}/allowedGroups")]
    [Cmdlet(VerbsCommon.Get, "MgPrintShareAllowedGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.Group))]
    public class GetMgPrintShareAllowedGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.GroupCollectionResponse? result;
            try
            {
                result = client.Print.Shares[PrinterShareId].AllowedGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Shares[PrinterShareId].AllowedGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
