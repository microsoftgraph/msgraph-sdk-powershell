...
namespace Microsoft.Graph.PowerShell.Devices.CloudPrint
{
    ...
    public class GetMgPrintShareAllowedGroupCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, PrinterShareId));
                return;
            }
