...
{
    [GraphRoute("GET", "/print/printers/{printer-id}/taskTriggers")]
    [Cmdlet(VerbsCommon.Get, "MgPrintPrinterTaskTrigger_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskTrigger))]
    public class GetMgPrintPrinterTaskTrigger_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CloudPrint.Client.Models.PrintTaskTriggerCollectionResponse? result;
            try
            {
                result = client.Print.Printers[PrinterId].TaskTriggers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Print.Printers[PrinterId].TaskTriggers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
