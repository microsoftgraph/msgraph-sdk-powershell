...
### Start (Default)
```
Start-MgBetaPrintPrinterJobPrintJob -PrinterId <String> -PrintJobId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterJobPrintJob -InputObject <IDevicesCloudPrintIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
