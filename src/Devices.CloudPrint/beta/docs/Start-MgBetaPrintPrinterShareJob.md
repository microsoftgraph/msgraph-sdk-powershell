...
### Start (Default)
```
Start-MgBetaPrintPrinterShareJob -PrinterShareId <String> -PrintJobId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterShareJob -InputObject <IDevicesCloudPrintIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
