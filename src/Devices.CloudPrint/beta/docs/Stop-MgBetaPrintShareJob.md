...
### Cancel (Default)
```
Stop-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
