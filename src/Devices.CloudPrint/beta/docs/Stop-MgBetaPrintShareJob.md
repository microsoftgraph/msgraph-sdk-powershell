...
### Cancel (Default)
```
Stop-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
