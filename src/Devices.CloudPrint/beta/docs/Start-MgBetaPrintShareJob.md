...
### Start (Default)
```
Start-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
