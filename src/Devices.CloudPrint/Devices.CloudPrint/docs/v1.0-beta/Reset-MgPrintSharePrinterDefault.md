...
### Reset (Default)
```
Reset-MgPrintSharePrinterDefault -PrinterShareId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgPrintSharePrinterDefault -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
