...
### DeleteViaIdentity
```
Remove-MgBetaPrintConnector -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
...
### Example 1: Using the Remove-MgBetaPrintConnector Cmdlet
```powershell
