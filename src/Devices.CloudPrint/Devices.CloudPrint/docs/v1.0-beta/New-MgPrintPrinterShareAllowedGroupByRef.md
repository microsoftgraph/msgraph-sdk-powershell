...
### Create (Default)
```
New-MgPrintPrinterShareAllowedGroupByRef -PrinterShareId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgPrintPrinterShareAllowedGroupByRef -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-Confirm]
