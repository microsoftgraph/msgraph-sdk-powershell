...
### Create (Default)
```
New-MgPrintPrinterShareAllowedUserByRef -PrinterShareId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgPrintPrinterShareAllowedUserByRef -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-Confirm]
