...
### Get1
```
Get-MgBetaPrintPrinterTaskTrigger -PrinterId <String> -PrintTaskTriggerId <String> [-ExpandProperty <String[]>]
...
### Example 1: Using the Get-MgBetaPrintPrinterTaskTrigger Cmdlet
```powershell
