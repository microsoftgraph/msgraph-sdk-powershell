...
Update-MgPrint [-AdditionalProperties <Hashtable>] [-Connectors <IMicrosoftGraphPrintConnector1[]>]
 [-Operations <IMicrosoftGraphPrintOperation[]>] [-Printers <IMicrosoftGraphPrinter1[]>]
...
### Update1
```
Update-MgPrint -BodyParameter <IMicrosoftGraphPrint1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphPrint1
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphPrinter1[]
Parameter Sets: UpdateExpanded1
Aliases:
...
BODYPARAMETER <IMicrosoftGraphPrint1>: print
  ...
  - `[Connectors <IMicrosoftGraphPrintConnector1[]>]`: The list of available print connectors.
  ...
  - `[Printers <IMicrosoftGraphPrinter1[]>]`: The list of printers registered in the tenant.
    - `[Capabilities <IMicrosoftGraphPrinterCapabilities1>]`: printerCapabilities
      ...
      - `[CopiesPerJob <IMicrosoftGraphIntegerRange1>]`: integerRange
        - `[(Any) <Object>]`: This indicates any property can be added to this object.
    ...
    - `[Jobs <IMicrosoftGraphPrintJob1[]>]`: The list of jobs that are queued for printing by the printer/printerShare.
      ...
      - `[Configuration <IMicrosoftGraphPrintJobConfiguration1>]`: printJobConfiguration
        ...
        - `[Orientation <String>]`: 
        - `[OutputBin <String>]`: 
        - `[PageRanges <IMicrosoftGraphIntegerRange1[]>]`: 
        - `[PagesPerSheet <Int32?>]`: 
        - `[Quality <String>]`: printQuality
        - `[Scaling <String>]`: printScaling
      ...
      - `[Documents <IMicrosoftGraphPrintDocument1[]>]`: 
        - `[Id <String>]`: The unique idenfier for an entity. Read-only.
      ...
      - `[Status <IMicrosoftGraphPrintJobStatus1>]`: printJobStatus
        ...
        - `[State <String>]`: 
      - `[Tasks <IMicrosoftGraphPrintTask1[]>]`: A list of printTasks that were triggered by this print job.
        - `[Id <String>]`: The unique idenfier for an entity. Read-only.
        ...
        - `[Drive <IMicrosoftGraphDrive1>]`: drive
          ...
          - `[CreatedByUser <IMicrosoftGraphUser>]`: user
            ...
            - `[Authentication <IMicrosoftGraphAuthentication1>]`: authentication
              ...
              - `[PasswordMethods <IMicrosoftGraphPasswordAuthenticationMethod1[]>]`: Represents the password that's registered to a user for authentication. For security, the password itself will never be returned in the object, but action can be taken to reset a password.
                - `[Id <String>]`: The unique idenfier for an entity. Read-only.
  ...
  - `[Shares <IMicrosoftGraphPrinterShare1[]>]`: The list of printer shares registered in the tenant.
  - `[TaskDefinitions <IMicrosoftGraphPrintTaskDefinition1[]>]`: List of abstract definition for a task that can be triggered when various events occur within Universal Print.
