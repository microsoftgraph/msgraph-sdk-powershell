...
New-MgPrintShareAllowedUser -PrinterShareId <String> [-AdditionalProperties <Hashtable>]
 [-DisplayName <String>] [-IPAddress <String>] [-Id <String>] [-UserPrincipalName <String>] [-WhatIf]
...
New-MgPrintShareAllowedUser -InputObject <IDevicesCloudPrintIdentity>
 -BodyParameter <IMicrosoftGraphPrintUserIdentity> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/new-mgprintsharealloweduser](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/new-mgprintsharealloweduser)
