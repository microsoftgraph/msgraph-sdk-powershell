...
```
Update-MgPrintShareAllowedUser -PrintUserIdentityId <String> -PrinterShareId <String>
...
Update-MgPrintShareAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-AdditionalProperties <Hashtable>]
 [-DisplayName <String>] [-IPAddress <String>] [-Id <String>] [-UserPrincipalName <String>] [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/update-mgprintsharealloweduser](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/update-mgprintsharealloweduser)
