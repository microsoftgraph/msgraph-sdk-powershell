...
```
Update-MgPrintServiceEndpoint -PrintServiceEndpointId <String> -PrintServiceId <String>
 -BodyParameter <IMicrosoftGraphPrintServiceEndpoint> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgPrintServiceEndpoint -InputObject <IDevicesCloudPrintIdentity> [-AdditionalProperties <Hashtable>]
 [-DisplayName <String>] [-Id <String>] [-Uri <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
