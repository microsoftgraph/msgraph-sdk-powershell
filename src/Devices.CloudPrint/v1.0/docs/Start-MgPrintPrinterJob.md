...
### Start (Default)
```
Start-MgPrintPrinterJob -PrinterId <String> -PrintJobId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>] [-Confirm]
