...
### Start (Default)
```
Start-MgPrintPrinterJob -PrinterId <String> -PrintJobId <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
