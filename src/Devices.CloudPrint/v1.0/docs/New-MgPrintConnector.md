...
New-MgPrintConnector [-AdditionalProperties <Hashtable>] [-AppVersion <String>] [-DisplayName <String>]
 ...
 [-OperatingSystem <String>] [-RegisteredDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgPrintConnector -BodyParameter <IMicrosoftGraphPrintConnector> [-Headers <IDictionary>] [-Confirm]
