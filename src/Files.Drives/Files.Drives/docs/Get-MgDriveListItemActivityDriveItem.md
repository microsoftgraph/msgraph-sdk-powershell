...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/get-mgdrivelistitemactivitydriveitem
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgDriveListItemActivityDriveItem -ItemActivityOldId <String> -ListItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get
```
Get-MgDriveListItemActivityDriveItem -DriveId <String> -ItemActivityOldId <String> -ListItemId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListItemActivityDriveItem -InputObject <IFilesDrivesIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
