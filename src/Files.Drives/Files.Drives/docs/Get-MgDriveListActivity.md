...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/get-mgdrivelistactivity
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDriveListActivity [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgDriveListActivity -DriveId <String> -ItemActivityOldId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgDriveListActivity -ItemActivityOldId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListActivity -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgDriveListActivity -DriveId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
