...
### Get1 (Default)
```
Get-MgDriveListItemField -ListItemId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get
```
Get-MgDriveListItemField -DriveId <String> -ListItemId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListItemField -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
