...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/update-mgdrivelistitemactivity
schema: 2.0.0
---
...
```
Update-MgDriveListItemActivity -ItemActivityOldId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListItemActivity -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
