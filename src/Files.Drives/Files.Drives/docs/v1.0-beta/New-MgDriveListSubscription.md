...
New-MgDriveListSubscription [-ApplicationId <String>] [-ChangeType <String>] [-ClientState <String>]
 ...
 [-LatestSupportedTlsVersion <String>] [-LifecycleNotificationUrl <String>] [-NotificationUrl <String>]
 [-Resource <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgDriveListSubscription -BodyParameter <IMicrosoftGraphSubscription1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgDriveListSubscription -InputObject <IFilesDrivesIdentity> -BodyParameter <IMicrosoftGraphSubscription1>
