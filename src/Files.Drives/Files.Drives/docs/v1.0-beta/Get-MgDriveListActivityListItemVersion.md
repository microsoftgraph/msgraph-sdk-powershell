...
### List1 (Default)
```
Get-MgDriveListActivityListItemVersion -ItemActivityOldId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-ExpandProperty <String[]>]
