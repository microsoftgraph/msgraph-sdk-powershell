...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/update-mgdriveactivitylistitemactivity
schema: 2.0.0
---
...
```
Update-MgDriveActivityListItemActivity -ItemActivityOldId <String> -ItemActivityOldId1 <String>
...
### Update1
```
Update-MgDriveActivityListItemActivity -DriveId <String> -ItemActivityOldId <String>
...
### UpdateViaIdentity
```
Update-MgDriveActivityListItemActivity -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
