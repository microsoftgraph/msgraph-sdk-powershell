...
### List1 (Default)
```
Get-MgDriveActivityListItemVersion -ItemActivityOldId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDriveActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-ExpandProperty <String[]>]
