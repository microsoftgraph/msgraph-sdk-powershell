...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/remove-mgdrive
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgDrive -InputObject <IFilesDrivesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
