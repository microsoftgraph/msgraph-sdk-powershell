...
### Get2 (Default)
```
Get-MgDrive [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
### GetViaIdentity1
```
Get-MgDrive -InputObject <IFilesDrivesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```

### List1
```
Get-MgDrive [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
