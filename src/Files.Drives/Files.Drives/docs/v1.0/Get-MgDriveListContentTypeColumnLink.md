...
### List1 (Default)
```
Get-MgDriveListContentTypeColumnLink -ContentTypeId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgDriveListContentTypeColumnLink -InputObject <IFilesDrivesIdentity> [-ExpandProperty <String[]>]
