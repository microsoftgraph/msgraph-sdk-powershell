...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/new-mgdrivelistcontenttype
schema: 2.0.0
---
...
```
New-MgDriveListContentType [-ColumnLinks <IMicrosoftGraphColumnLink[]>] [-Description <String>]
 [-Group <String>] [-Hidden] [-Id <String>] [-InheritedFrom <IMicrosoftGraphItemReference>] [-Name <String>]
 [-OrderDefault] [-OrderPosition <Int32>] [-ParentId <String>] [-ReadOnly] [-Sealed] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Create1
```
New-MgDriveListContentType -BodyParameter <IMicrosoftGraphContentType> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateExpanded
```
New-MgDriveListContentType -DriveId <String> [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
...
### CreateViaIdentity
```
New-MgDriveListContentType -InputObject <IFilesDrivesIdentity> -BodyParameter <IMicrosoftGraphContentType>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgDriveListContentType -InputObject <IFilesDrivesIdentity> [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
 [-Description <String>] [-Group <String>] [-Hidden] [-Id <String>]
 [-InheritedFrom <IMicrosoftGraphItemReference>] [-Name <String>] [-OrderDefault] [-OrderPosition <Int32>]
 [-ParentId <String>] [-ReadOnly] [-Sealed] [-Confirm] [-WhatIf] [<CommonParameters>]
```
