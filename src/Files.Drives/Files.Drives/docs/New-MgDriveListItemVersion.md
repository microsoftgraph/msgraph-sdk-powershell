...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/new-mgdrivelistitemversion
schema: 2.0.0
---
...
```
New-MgDriveListItemVersion -ListItemId <String> [-FieldId <String>] [-Id <String>]
...
### Create
```
New-MgDriveListItemVersion -ListItemId <String> -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm]
...
### CreateExpanded1
```
New-MgDriveListItemVersion -DriveId <String> -ListItemId <String> [-FieldId <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-PublicationLevel <String>] [-PublicationVersionId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgDriveListItemVersion -InputObject <IFilesDrivesIdentity> -BodyParameter <IMicrosoftGraphListItemVersion>
...
```
New-MgDriveListItemVersion -InputObject <IFilesDrivesIdentity> [-FieldId <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-PublicationLevel <String>] [-PublicationVersionId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
