...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/restore-mgdrivelistactivitylistitemversion
schema: 2.0.0
---
...
### Restore1 (Default)
```
Restore-MgDriveListActivityListItemVersion -ItemActivityOldId <String> -ListItemVersionId <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Restore
```
Restore-MgDriveListActivityListItemVersion -DriveId <String> -ItemActivityOldId <String>
 -ListItemVersionId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveListActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-PassThru] [-Confirm]
