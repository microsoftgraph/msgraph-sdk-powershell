...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.people/get-mguserperson
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserPerson -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgUserPerson -InputObject <IUsersPeopleIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
