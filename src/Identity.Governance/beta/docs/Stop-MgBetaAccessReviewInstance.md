...
### Stop (Default)
```
Stop-MgBetaAccessReviewInstance -AccessReviewId <String> -AccessReviewId1 <String>
...
### StopViaIdentity
```
Stop-MgBetaAccessReviewInstance -InputObject <IIdentityGovernanceIdentity> [-ResponseHeadersVariable <String>]
