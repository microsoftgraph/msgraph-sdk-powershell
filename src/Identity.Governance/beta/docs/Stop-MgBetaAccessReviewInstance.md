...
### Stop (Default)
```
Stop-MgBetaAccessReviewInstance -AccessReviewId <String> -AccessReviewId1 <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-MgBetaAccessReviewInstance -InputObject <IIdentityGovernanceIdentity> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
