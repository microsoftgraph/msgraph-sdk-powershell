...
### Send (Default)
```
Send-MgBetaAccessReviewReminder -AccessReviewId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SendViaIdentity
```
Send-MgBetaAccessReviewReminder -InputObject <IIdentityGovernanceIdentity> [-Headers <IDictionary>]
