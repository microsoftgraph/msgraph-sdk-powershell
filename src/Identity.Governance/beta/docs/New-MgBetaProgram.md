...
New-MgBetaProgram [-AdditionalProperties <Hashtable>] [-Controls <IMicrosoftGraphProgramControl[]>]
 [-Description <String>] [-DisplayName <String>] [-Id <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaProgram -BodyParameter <IMicrosoftGraphProgram> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
