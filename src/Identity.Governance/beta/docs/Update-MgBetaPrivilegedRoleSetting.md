...
Update-MgBetaPrivilegedRoleSetting -PrivilegedRoleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-MinElevationDuration <TimeSpan>] [-NotificationToUserOnElevation] [-ResponseHeadersVariable <String>]
 [-TicketingInfoOnElevation] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
