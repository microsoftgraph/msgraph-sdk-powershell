...
Update-MgBetaPrivilegedRoleAssignmentRoleInfoSetting -PrivilegedRoleAssignmentId <String>
 ...
 [-NotificationToUserOnElevation] [-TicketingInfoOnElevation] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaPrivilegedRoleAssignmentRoleInfoSetting -PrivilegedRoleAssignmentId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSettings> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
