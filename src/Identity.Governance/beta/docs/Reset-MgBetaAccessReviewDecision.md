...
### Reset (Default)
```
Reset-MgBetaAccessReviewDecision -AccessReviewId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity>
