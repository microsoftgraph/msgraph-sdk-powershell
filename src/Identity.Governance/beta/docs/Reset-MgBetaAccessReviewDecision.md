...
### Reset (Default)
```
Reset-MgBetaAccessReviewDecision -AccessReviewId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity> [-Headers <IDictionary>]
