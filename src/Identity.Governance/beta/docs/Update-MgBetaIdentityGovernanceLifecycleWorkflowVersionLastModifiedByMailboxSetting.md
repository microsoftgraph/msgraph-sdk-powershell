...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowVersionLastModifiedByMailboxSetting -WorkflowId <String>
 -WorkflowVersionNumber <Int32> -BodyParameter <IMicrosoftGraphMailboxSettings> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowVersionLastModifiedByMailboxSetting
 -InputObject <IIdentityGovernanceIdentity> -BodyParameter <IMicrosoftGraphMailboxSettings> [-Confirm]
