...
### Delete (Default)
```
Remove-MgBetaProgram -ProgramId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaProgram -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
