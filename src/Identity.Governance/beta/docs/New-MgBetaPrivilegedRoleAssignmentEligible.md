...
### Make (Default)
```
New-MgBetaPrivilegedRoleAssignmentEligible -PrivilegedRoleAssignmentId <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### MakeViaIdentity
```
New-MgBetaPrivilegedRoleAssignmentEligible -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
