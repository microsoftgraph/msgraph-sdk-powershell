...
### Self (Default)
```
Invoke-MgBetaSelfPrivilegedRoleDeactivate -PrivilegedRoleId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SelfViaIdentity
```
Invoke-MgBetaSelfPrivilegedRoleDeactivate -InputObject <IIdentityGovernanceIdentity>
