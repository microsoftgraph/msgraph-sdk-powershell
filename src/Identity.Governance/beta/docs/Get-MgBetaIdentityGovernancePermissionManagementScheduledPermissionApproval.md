...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancepermissionmanagementscheduledpermissionapproval
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaIdentityGovernancePermissionManagementScheduledPermissionApproval [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaIdentityGovernancePermissionManagementScheduledPermissionApproval -ApprovalId <String>
