...
Update-MgBetaProgramControlType -ProgramControlTypeId <String> [-AdditionalProperties <Hashtable>]
 [-ControlTypeGroupId <String>] [-DisplayName <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
...
Update-MgBetaProgramControlType -ProgramControlTypeId <String>
 -BodyParameter <IMicrosoftGraphProgramControlType> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
