...
Update-MgBetaEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandler
 ...
 [-Id <String>] [-Stage <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandler
 -AccessPackageAssignmentPolicyId <String> -CustomExtensionHandlerId <String>
 -BodyParameter <IMicrosoftGraphCustomExtensionHandler> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
