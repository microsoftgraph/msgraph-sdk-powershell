...
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UsersCount <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSummary> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaPrivilegedRoleSummary -InputObject <IIdentityGovernanceIdentity>
 ...
 [-MfaEnabled] [-Status <String>] [-UsersCount <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
