...
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgbetaentitlementmanagementconnectedorganization
#>
...
process {
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\Get-MgBetaEntitlementManagementConnectedOrganization_List @PSBoundParameters
}
