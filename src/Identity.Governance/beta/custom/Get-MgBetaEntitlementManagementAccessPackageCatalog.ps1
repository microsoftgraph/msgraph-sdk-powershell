...
.Notes
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgbetaentitlementmanagementaccesspackagecatalog
#>
function Get-MgBetaEntitlementManagementAccessPackageCatalog {
[OutputType([Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAccessPackageCatalog])]
...
process {
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\Get-MgBetaEntitlementManagementAccessPackageCatalog_List @PSBoundParameters
}
