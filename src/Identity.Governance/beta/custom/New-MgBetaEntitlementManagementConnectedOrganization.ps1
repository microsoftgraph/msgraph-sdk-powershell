...
.Example
PS C:\> New-MgBetaEntitlementManagementConnectedOrganization -DomainName microsoft.com
...
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/new-mgbetaentitlementmanagementconnectedorganization
#>
function New-MgBetaEntitlementManagementConnectedOrganization {
[OutputType([Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphConnectedOrganization])]
...
process {
    ...
    if ($DomainName -ne $null -and $DomainName.Length -gt 0) {
        $dis = new-object Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphIdentitySource
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\New-MgBetaEntitlementManagementConnectedOrganization_CreateExpanded @PSBoundParameters
}
