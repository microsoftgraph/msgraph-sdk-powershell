...
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgbetaentitlementmanagementaccesspackageassignmentpolicy
#>
...
process {
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\Get-MgBetaEntitlementManagementAccessPackageAssignmentPolicy_List @PSBoundParameters
}
