...
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/new-mgbetaentitlementmanagementaccesspackageassignmentrequest
#>
function New-MgBetaEntitlementManagementAccessPackageAssignmentRequest {
...
process {
    ...
    $AccessPackageAssignmentRequestBodyAccessPackageAssignment = new-object microsoft.Graph.Beta.PowerShell.models.MicrosoftGraphAccessPackageAssignment
    if ($AccessPackageAssignmentId -ne $null -and $AccessPackageAssignmentId.Length -ne 0) {
    ...
    if ($TargetId -ne $null -and $TargetId.Length -ne 0) {
        ...
        $AccessPackageAssignmentRequestBodyAccessPackageAssignment.Target = new-object microsoft.Graph.Beta.PowerShell.models.MicrosoftGraphAccessPackageSubject
    ...
    if ($null -ne $StartDate -and $StartDate.Length -ne 0) {
        ...
        $AccessPackageAssignmentRequestBodyAccessPackageAssignment.Schedule = new-object Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphRequestSchedule
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\New-MgBetaEntitlementManagementAccessPackageAssignmentRequest_CreateExpanded @PSBoundParameters
