...
.Notes
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgbetaentitlementmanagementaccesspackage
#>
...
process {
    ...
    Microsoft.Graph.Beta.Identity.Governance.private\Get-MgBetaEntitlementManagementAccessPackage_List @PSBoundParameters
