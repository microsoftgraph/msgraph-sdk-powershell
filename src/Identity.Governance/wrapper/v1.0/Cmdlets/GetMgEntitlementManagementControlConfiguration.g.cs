...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgEntitlementManagementControlConfigurationCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ControlConfigurationId : null);
                return;
            }
        }
    }
