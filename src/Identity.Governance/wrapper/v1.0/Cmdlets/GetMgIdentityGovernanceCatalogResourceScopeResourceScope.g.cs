...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogResourceScopeResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceCatalogResourceScopeResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceCatalogResourceScopeResourceScope_Get or Get-MgIdentityGovernanceCatalogResourceScopeResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceCatalogResourceScopeResourceScope_Get" : "Get-MgIdentityGovernanceCatalogResourceScopeResourceScope_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceScopeId1 : AccessPackageResourceScopeId);
                return;
            }
        }
    }
