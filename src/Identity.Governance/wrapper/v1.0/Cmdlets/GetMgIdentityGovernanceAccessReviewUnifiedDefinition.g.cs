...
{
    [GraphRoute("GET", "/identityGovernance/accessReviews/unified/definitions")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceAccessReviewUnifiedDefinition", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceAccessReviewUnifiedDefinitionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceAccessReviewUnifiedDefinition_Get or Get-MgIdentityGovernanceAccessReviewUnifiedDefinition_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceAccessReviewUnifiedDefinition_Get" : "Get-MgIdentityGovernanceAccessReviewUnifiedDefinition_List";
            try
            {
