...
{
    [GraphRoute("GET", "/identityGovernance/catalogs/{accessPackageCatalog-id}/resources")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogResource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResource))]
    public class GetMgIdentityGovernanceCatalogResource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.Catalogs[AccessPackageCatalogId].Resources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.Catalogs[AccessPackageCatalogId].Resources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
