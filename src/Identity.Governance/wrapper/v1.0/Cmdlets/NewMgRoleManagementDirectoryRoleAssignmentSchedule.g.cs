...
{
    [GraphRoute("POST", "/roleManagement/directory/roleAssignmentSchedules")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementDirectoryRoleAssignmentSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentSchedule))]
    public class NewMgRoleManagementDirectoryRoleAssignmentScheduleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ScheduleInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleAssignmentSchedules.PostAsync(body, requestConfiguration =>
                {
