...
{
    [GraphRoute("POST", "/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}/stages")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.ApprovalStage))]
    public class NewMgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ReviewedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.PrivilegedAccess.Group.AssignmentApprovals[ApprovalId].Stages.PostAsync(body, requestConfiguration =>
                {
