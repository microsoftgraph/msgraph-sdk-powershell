...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceEntitlementManagementExternalOriginResourceConnector_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.ExternalOriginResourceConnector))]
    public class GetMgIdentityGovernanceEntitlementManagementExternalOriginResourceConnector_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.ExternalOriginResourceConnectorCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ExternalOriginResourceConnectors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.ExternalOriginResourceConnectors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
