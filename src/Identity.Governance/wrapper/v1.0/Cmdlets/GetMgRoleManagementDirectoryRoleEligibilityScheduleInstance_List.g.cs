...
{
    [GraphRoute("GET", "/roleManagement/directory/roleEligibilityScheduleInstances")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDirectoryRoleEligibilityScheduleInstance_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleInstance))]
    public class GetMgRoleManagementDirectoryRoleEligibilityScheduleInstance_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleInstanceCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Directory.RoleEligibilityScheduleInstances.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Directory.RoleEligibilityScheduleInstances.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
