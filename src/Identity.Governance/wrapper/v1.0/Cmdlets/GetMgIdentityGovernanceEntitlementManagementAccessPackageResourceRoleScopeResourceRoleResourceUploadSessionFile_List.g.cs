...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/resourceRoleScopes/{accessPackageResourceRoleScope-id}/scope/resource/roles/{accessPackageResourceRole-id}/resource/uploadSessions/{customDataProvidedResourceUploadSession-id}/files")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeResourceRoleResourceUploadSessionFile_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.CustomDataProvidedResourceFile))]
    public class GetMgIdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeResourceRoleResourceUploadSessionFile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].ResourceRoleScopes[AccessPackageResourceRoleScopeId].Scope.Resource.Roles[AccessPackageResourceRoleId].Resource.UploadSessions[CustomDataProvidedResourceUploadSessionId].Files.GetAsync(requestConfiguration =>
                {
