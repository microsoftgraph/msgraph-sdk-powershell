...
{
    [GraphRoute("GET", "/roleManagement/entitlementManagement/roleEligibilityScheduleRequests")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementEntitlementManagementRoleEligibilityScheduleRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleRequest))]
    public class GetMgRoleManagementEntitlementManagementRoleEligibilityScheduleRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleRequestCollectionResponse? result;
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
