...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/incompatibleGroups/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAccessPackageIncompatibleGroupByRef")]
    [OutputType(typeof(string))]
    public class GetMgEntitlementManagementAccessPackageIncompatibleGroupByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleGroups.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleGroups.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
