...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgEntitlementManagementResourceRequestCatalogResourceRoleCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceRoleId : AccessPackageResourceRequestId);
                return;
            }
        }
    }
