...
{
    [GraphRoute("PATCH", "/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance-id}")]
    [Cmdlet(VerbsData.Update, "MgRoleManagementDirectoryRoleAssignmentScheduleInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleInstance))]
    public class UpdateMgRoleManagementDirectoryRoleAssignmentScheduleInstanceCommand : PSCmdlet
    {
        ...
        {
            if (!ShouldProcess(UnifiedRoleAssignmentScheduleInstanceId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(StartDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleAssignmentScheduleInstances[UnifiedRoleAssignmentScheduleInstanceId].PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleAssignmentScheduleInstanceId));
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.RoleManagement.Directory.RoleAssignmentScheduleInstances[UnifiedRoleAssignmentScheduleInstanceId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleAssignmentScheduleInstanceId));
