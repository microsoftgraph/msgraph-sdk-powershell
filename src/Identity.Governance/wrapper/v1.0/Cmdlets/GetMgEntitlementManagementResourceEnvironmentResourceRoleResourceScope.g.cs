...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceEnvironmentResourceRoleResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceEnvironmentResourceRoleResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceEnvironmentResourceRoleResourceScope_Get or Get-MgEntitlementManagementResourceEnvironmentResourceRoleResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceEnvironmentResourceRoleResourceScope_Get" : "Get-MgEntitlementManagementResourceEnvironmentResourceRoleResourceScope_List";
            try
            {
