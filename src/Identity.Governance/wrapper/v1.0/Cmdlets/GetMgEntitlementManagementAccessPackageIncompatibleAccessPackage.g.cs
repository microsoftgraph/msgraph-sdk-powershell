...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/incompatibleAccessPackages")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAccessPackageIncompatibleAccessPackage")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackage))]
    public class GetMgEntitlementManagementAccessPackageIncompatibleAccessPackageCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleAccessPackages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleAccessPackages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
