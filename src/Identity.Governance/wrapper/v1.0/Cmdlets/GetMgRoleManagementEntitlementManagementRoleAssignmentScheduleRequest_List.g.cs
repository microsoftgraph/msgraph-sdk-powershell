...
{
    [GraphRoute("GET", "/roleManagement/entitlementManagement/roleAssignmentScheduleRequests")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementEntitlementManagementRoleAssignmentScheduleRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleRequest))]
    public class GetMgRoleManagementEntitlementManagementRoleAssignmentScheduleRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
