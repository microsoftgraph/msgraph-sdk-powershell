...
{
    [GraphRoute("POST", "/identityGovernance/termsOfUse/agreements/{agreement-id}/files")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceTermsOfUseAgreementFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalization))]
    public class NewMgIdentityGovernanceTermsOfUseAgreementFileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(FileData)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.TermsOfUse.Agreements[AgreementId].Files.PostAsync(body, requestConfiguration =>
                {
