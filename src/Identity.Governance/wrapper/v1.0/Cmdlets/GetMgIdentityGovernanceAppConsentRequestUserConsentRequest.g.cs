...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgIdentityGovernanceAppConsentRequestUserConsentRequestCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? UserConsentRequestId : AppConsentRequestId));
                return;
            }
        }
    }
