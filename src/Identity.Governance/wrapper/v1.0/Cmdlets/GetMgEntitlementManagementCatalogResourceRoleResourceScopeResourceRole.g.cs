...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementCatalogResourceRoleResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole_Get or Get-MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole_Get" : "Get-MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole_List";
            try
            {
