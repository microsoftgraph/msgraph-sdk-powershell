...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementFileLocalization_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalization))]
    public class GetMgAgreementFileLocalization_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].File.Localizations[AgreementFileLocalizationId].GetAsync(requestConfiguration =>
                {
