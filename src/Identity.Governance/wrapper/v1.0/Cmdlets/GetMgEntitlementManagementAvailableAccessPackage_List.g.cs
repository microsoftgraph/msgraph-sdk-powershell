...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAvailableAccessPackage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AvailableAccessPackage))]
    public class GetMgEntitlementManagementAvailableAccessPackage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AvailableAccessPackageCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AvailableAccessPackages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AvailableAccessPackages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
