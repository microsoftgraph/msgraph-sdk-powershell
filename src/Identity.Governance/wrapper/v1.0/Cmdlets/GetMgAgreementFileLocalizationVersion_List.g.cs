...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgAgreementFileLocalizationVersion_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AgreementFileLocalizationId));
                return;
            }
