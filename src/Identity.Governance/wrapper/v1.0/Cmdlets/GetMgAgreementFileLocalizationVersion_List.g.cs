...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementFileLocalizationVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileVersion))]
    public class GetMgAgreementFileLocalizationVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileVersionCollectionResponse? result;
            try
            {
                result = client.Agreements[AgreementId].File.Localizations[AgreementFileLocalizationId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Agreements[AgreementId].File.Localizations[AgreementFileLocalizationId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
