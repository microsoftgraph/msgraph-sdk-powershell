...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/acceptances/{agreementAcceptance-id}")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementAcceptance_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementAcceptance))]
    public class GetMgAgreementAcceptance_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].Acceptances[AgreementAcceptanceId].GetAsync(requestConfiguration =>
                {
