...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions/{agreementFileVersion-id}")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementFileVersion_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileVersion))]
    public class GetMgAgreementFileVersion_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].Files[AgreementFileLocalizationId].Versions[AgreementFileVersionId].GetAsync(requestConfiguration =>
                {
