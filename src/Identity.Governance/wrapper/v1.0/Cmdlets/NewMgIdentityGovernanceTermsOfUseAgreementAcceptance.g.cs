...
{
    [GraphRoute("POST", "/identityGovernance/termsOfUse/agreementAcceptances")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceTermsOfUseAgreementAcceptance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementAcceptance))]
    public class NewMgIdentityGovernanceTermsOfUseAgreementAcceptanceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.TermsOfUse.AgreementAcceptances.PostAsync(body, requestConfiguration =>
                {
