...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceEnvironmentResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceEnvironmentResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceEnvironmentResourceRole_Get or Get-MgEntitlementManagementResourceEnvironmentResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceEnvironmentResourceRole_Get" : "Get-MgEntitlementManagementResourceEnvironmentResourceRole_List";
            try
            {
