...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgIdentityGovernanceLifecycleWorkflowVersionAdministrationScopeTargetCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? DirectoryObjectId : WorkflowVersionVersionNumber));
                return;
            }
        }
    }
