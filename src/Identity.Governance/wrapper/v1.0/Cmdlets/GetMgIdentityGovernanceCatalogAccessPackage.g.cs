...
{
    [GraphRoute("GET", "/identityGovernance/catalogs/{accessPackageCatalog-id}/accessPackages")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogAccessPackage", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceCatalogAccessPackageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceCatalogAccessPackage_Get or Get-MgIdentityGovernanceCatalogAccessPackage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceCatalogAccessPackage_Get" : "Get-MgIdentityGovernanceCatalogAccessPackage_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageId : AccessPackageCatalogId);
                return;
            }
        }
    }
