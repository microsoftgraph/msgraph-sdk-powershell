...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/assignmentRequests")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAssignmentRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageAssignmentRequest))]
    public class GetMgEntitlementManagementAssignmentRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageAssignmentRequestCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AssignmentRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AssignmentRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
