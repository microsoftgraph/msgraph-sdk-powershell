...
{
    [GraphRoute("GET", "/identityGovernance/accessReviews/definitions")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceAccessReviewDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessReviewScheduleDefinition))]
    public class GetMgIdentityGovernanceAccessReviewDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessReviewScheduleDefinitionCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.AccessReviews.Definitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.AccessReviews.Definitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
