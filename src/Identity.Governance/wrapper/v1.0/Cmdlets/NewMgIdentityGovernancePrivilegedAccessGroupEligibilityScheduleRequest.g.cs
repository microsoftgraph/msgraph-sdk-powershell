...
{
    [GraphRoute("POST", "/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(AccessId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleRequests.PostAsync(body, requestConfiguration =>
                {
