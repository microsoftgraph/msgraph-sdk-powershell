...
{
    [GraphRoute("POST", "/identityGovernance/catalogs")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceCatalog", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageCatalog))]
    public class NewMgIdentityGovernanceCatalogCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.Catalogs.PostAsync(body, requestConfiguration =>
                {
