...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/files")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementFile")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalization))]
    public class GetMgAgreementFileCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].Files.GetAsync(requestConfiguration =>
                {
