...
{
    [GraphRoute("GET", "/users/{user-id}/agreementAcceptances")]
    [Cmdlet(VerbsCommon.Get, "MgUserAgreementAcceptance_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementAcceptance))]
    public class GetMgUserAgreementAcceptance_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementAcceptanceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].AgreementAcceptances.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].AgreementAcceptances.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
