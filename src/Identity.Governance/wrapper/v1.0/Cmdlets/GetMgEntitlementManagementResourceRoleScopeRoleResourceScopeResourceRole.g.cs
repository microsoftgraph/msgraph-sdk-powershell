...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope-id}/role/resource/scopes/{accessPackageResourceScope-id}/resource/roles")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole_Get or Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole_Get" : "Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceRoleId : AccessPackageResourceScopeId);
                return;
            }
        }
    }
