...
{
    [GraphRoute("POST", "/identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/tasks")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceLifecycleWorkflowTask", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.TaskObject))]
    public class NewMgIdentityGovernanceLifecycleWorkflowTaskCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Category)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.LifecycleWorkflows.Workflows[WorkflowId].Tasks.PostAsync(body, requestConfiguration =>
                {
