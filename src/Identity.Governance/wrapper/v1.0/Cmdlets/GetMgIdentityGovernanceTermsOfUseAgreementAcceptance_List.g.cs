...
{
    [GraphRoute("GET", "/identityGovernance/termsOfUse/agreementAcceptances")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceTermsOfUseAgreementAcceptance_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementAcceptance))]
    public class GetMgIdentityGovernanceTermsOfUseAgreementAcceptance_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.TermsOfUse.AgreementAcceptances.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.TermsOfUse.AgreementAcceptances.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
