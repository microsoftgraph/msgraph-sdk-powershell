...
{
    [GraphRoute("PATCH", "/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest-id}")]
    [Cmdlet(VerbsData.Update, "MgRoleManagementDirectoryRoleAssignmentScheduleRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleRequest))]
    public class UpdateMgRoleManagementDirectoryRoleAssignmentScheduleRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TicketInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleAssignmentScheduleRequests[UnifiedRoleAssignmentScheduleRequestId].PatchAsync(body, requestConfiguration =>
                {
