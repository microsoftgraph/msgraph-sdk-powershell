...
{
    [GraphRoute("GET", "/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions")]
    [Cmdlet(VerbsCommon.Get, "MgAgreementFileVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileVersion))]
    public class GetMgAgreementFileVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].Files[AgreementFileLocalizationId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Agreements[AgreementId].Files[AgreementFileLocalizationId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
