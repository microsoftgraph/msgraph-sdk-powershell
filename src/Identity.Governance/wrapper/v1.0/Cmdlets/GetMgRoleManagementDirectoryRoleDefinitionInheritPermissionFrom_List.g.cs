...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDirectoryRoleDefinitionInheritPermissionFrom_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementDirectoryRoleDefinitionInheritPermissionFrom_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Directory.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
