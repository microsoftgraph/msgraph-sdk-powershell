...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgIdentityGovernanceAppConsentRequestCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AppConsentRequestId : null);
                return;
            }
        }
    }
