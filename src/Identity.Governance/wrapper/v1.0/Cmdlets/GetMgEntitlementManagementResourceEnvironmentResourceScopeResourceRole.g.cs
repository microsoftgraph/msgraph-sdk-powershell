...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceEnvironmentResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceEnvironmentResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceEnvironmentResourceScopeResourceRole_Get or Get-MgEntitlementManagementResourceEnvironmentResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceEnvironmentResourceScopeResourceRole_Get" : "Get-MgEntitlementManagementResourceEnvironmentResourceScopeResourceRole_List";
            try
            {
