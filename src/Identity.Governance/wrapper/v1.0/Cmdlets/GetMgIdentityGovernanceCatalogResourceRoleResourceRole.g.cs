...
{
    [GraphRoute("GET", "/identityGovernance/catalogs/{accessPackageCatalog-id}/resourceRoles/{accessPackageResourceRole-id}/resource/roles")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogResourceRoleResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceCatalogResourceRoleResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceCatalogResourceRoleResourceRole_Get or Get-MgIdentityGovernanceCatalogResourceRoleResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceCatalogResourceRoleResourceRole_Get" : "Get-MgIdentityGovernanceCatalogResourceRoleResourceRole_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceRoleId1 : AccessPackageResourceRoleId);
                return;
            }
        }
    }
