...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleAssignmentSchedules")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleAssignmentSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentSchedule))]
    public class NewMgRoleManagementEntitlementManagementRoleAssignmentScheduleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ScheduleInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.PostAsync(body, requestConfiguration =>
                {
