...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class UpdateMgEntitlementManagementCatalogResourceRoleResourceScopeResourceRoleCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AccessPackageResourceRoleId1));
                return;
            }
