...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScope_Get or Get-MgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScope_Get" : "Get-MgIdentityGovernanceCatalogResourceScopeResourceRoleResourceScope_List";
            try
            {
