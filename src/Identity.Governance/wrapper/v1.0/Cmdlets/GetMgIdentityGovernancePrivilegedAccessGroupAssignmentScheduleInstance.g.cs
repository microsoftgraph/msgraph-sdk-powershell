...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgIdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstanceCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? PrivilegedAccessGroupAssignmentScheduleInstanceId : null));
                return;
            }
        }
    }
