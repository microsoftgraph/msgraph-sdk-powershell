...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgRoleManagementDirectoryRoleAssignmentScheduleRequestCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? UnifiedRoleAssignmentScheduleRequestId : null);
                return;
            }
        }
    }
