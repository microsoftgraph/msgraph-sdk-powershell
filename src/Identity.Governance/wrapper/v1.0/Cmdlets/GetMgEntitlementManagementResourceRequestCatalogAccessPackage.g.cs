...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgEntitlementManagementResourceRequestCatalogAccessPackageCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageId : AccessPackageResourceRequestId);
                return;
            }
        }
    }
