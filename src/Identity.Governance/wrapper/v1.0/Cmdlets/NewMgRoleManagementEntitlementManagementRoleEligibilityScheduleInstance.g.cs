...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleEligibilityScheduleInstances")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleEligibilityScheduleInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleInstance))]
    public class NewMgRoleManagementEntitlementManagementRoleEligibilityScheduleInstanceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(StartDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleEligibilityScheduleInstances.PostAsync(body, requestConfiguration =>
                {
