...
{
    [GraphRoute("POST", "/identityGovernance/entitlementManagement/resources")]
    [Cmdlet(VerbsCommon.New, "MgEntitlementManagementResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResource))]
    public class NewMgEntitlementManagementResourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Attributes)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.Resources.PostAsync(body, requestConfiguration =>
                {
