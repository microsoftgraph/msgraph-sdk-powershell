...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleAssignments")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignment))]
    public class NewMgRoleManagementEntitlementManagementRoleAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RoleDefinitionId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignments.PostAsync(body, requestConfiguration =>
                {
