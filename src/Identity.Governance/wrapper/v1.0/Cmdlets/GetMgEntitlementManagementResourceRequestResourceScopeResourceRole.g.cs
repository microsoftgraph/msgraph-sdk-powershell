...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceRequestResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceRequestResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole_Get or Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole_Get" : "Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole_List";
            try
            {
