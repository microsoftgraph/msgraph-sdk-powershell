...
{
    [GraphRoute("POST", "/roleManagement/directory/roleDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementDirectoryRoleDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleDefinition))]
    public class NewMgRoleManagementDirectoryRoleDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RolePermissions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleDefinitions.PostAsync(body, requestConfiguration =>
                {
