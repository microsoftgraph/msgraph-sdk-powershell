...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementCatalogResourceScopeResourceRoleResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope_Get or Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope_Get" : "Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope_List";
            try
            {
