...
{
    [GraphRoute("POST", "/identityGovernance/entitlementManagement/controlConfigurations")]
    [Cmdlet(VerbsCommon.New, "MgEntitlementManagementControlConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.ControlConfiguration))]
    public class NewMgEntitlementManagementControlConfigurationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ModifiedDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ControlConfigurations.PostAsync(body, requestConfiguration =>
                {
