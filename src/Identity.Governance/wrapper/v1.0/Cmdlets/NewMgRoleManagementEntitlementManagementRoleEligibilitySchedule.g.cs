...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleEligibilitySchedules")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleEligibilitySchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilitySchedule))]
    public class NewMgRoleManagementEntitlementManagementRoleEligibilityScheduleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ScheduleInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.PostAsync(body, requestConfiguration =>
                {
