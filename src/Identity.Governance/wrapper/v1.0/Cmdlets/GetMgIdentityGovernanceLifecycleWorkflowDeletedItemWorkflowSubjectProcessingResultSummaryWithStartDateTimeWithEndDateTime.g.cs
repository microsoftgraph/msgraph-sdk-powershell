...
{
    [GraphRoute("GET", "/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow-id}/subjectProcessingResults/microsoft.graph.identityGovernance.summary(startDateTime={startDateTime},endDateTime={endDateTime})")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowSubjectProcessingResultSummaryWithStartDateTimeWithEndDateTime")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.SubjectSummary))]
    public class GetMgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowSubjectProcessingResultSummaryWithStartDateTimeWithEndDateTimeCommand : GraphClientCmdlet
    {
