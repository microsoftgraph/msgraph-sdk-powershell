...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/availableAccessPackages/{availableAccessPackage-id}/resourceRoleScopes")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAvailableAccessPackageResourceRoleScope_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResourceRoleScope))]
    public class GetMgEntitlementManagementAvailableAccessPackageResourceRoleScope_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResourceRoleScopeCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AvailableAccessPackages[AvailableAccessPackageId].ResourceRoleScopes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AvailableAccessPackages[AvailableAccessPackageId].ResourceRoleScopes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
