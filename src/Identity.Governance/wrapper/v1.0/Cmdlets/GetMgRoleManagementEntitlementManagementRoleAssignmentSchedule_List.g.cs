...
{
    [GraphRoute("GET", "/roleManagement/entitlementManagement/roleAssignmentSchedules")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementEntitlementManagementRoleAssignmentSchedule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentSchedule))]
    public class GetMgRoleManagementEntitlementManagementRoleAssignmentSchedule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleCollectionResponse? result;
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
