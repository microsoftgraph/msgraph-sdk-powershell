...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization-id}/externalSponsors/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementConnectedOrganizationExternalSponsorByRef")]
    [OutputType(typeof(string))]
    public class GetMgEntitlementManagementConnectedOrganizationExternalSponsorByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ConnectedOrganizations[ConnectedOrganizationId].ExternalSponsors.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.ConnectedOrganizations[ConnectedOrganizationId].ExternalSponsors.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
