...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/incompatibleAccessPackages/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementAccessPackageIncompatibleAccessPackageByRef")]
    [OutputType(typeof(string))]
    public class GetMgEntitlementManagementAccessPackageIncompatibleAccessPackageByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleAccessPackages.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.AccessPackages[AccessPackageId].IncompatibleAccessPackages.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
