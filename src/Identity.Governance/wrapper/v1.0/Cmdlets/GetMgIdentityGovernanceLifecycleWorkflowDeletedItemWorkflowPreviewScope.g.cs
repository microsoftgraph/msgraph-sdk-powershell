...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScope_Get or Get-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScope_Get" : "Get-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowPreviewScope_List";
            try
            {
