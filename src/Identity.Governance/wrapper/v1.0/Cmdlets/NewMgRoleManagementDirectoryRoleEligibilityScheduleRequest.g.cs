...
{
    [GraphRoute("POST", "/roleManagement/directory/roleEligibilityScheduleRequests")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementDirectoryRoleEligibilityScheduleRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleRequest))]
    public class NewMgRoleManagementDirectoryRoleEligibilityScheduleRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TicketInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Directory.RoleEligibilityScheduleRequests.PostAsync(body, requestConfiguration =>
                {
