...
{
    [GraphRoute("PATCH", "/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}")]
    [Cmdlet(VerbsData.Update, "MgRoleManagementEntitlementManagementRoleEligibilityScheduleRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilityScheduleRequest))]
    public class UpdateMgRoleManagementEntitlementManagementRoleEligibilityScheduleRequestCommand : PSCmdlet
    {
        ...
        {
            if (!ShouldProcess(UnifiedRoleEligibilityScheduleRequestId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(TicketInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests[UnifiedRoleEligibilityScheduleRequestId].PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleEligibilityScheduleRequestId));
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests[UnifiedRoleEligibilityScheduleRequestId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleEligibilityScheduleRequestId));
