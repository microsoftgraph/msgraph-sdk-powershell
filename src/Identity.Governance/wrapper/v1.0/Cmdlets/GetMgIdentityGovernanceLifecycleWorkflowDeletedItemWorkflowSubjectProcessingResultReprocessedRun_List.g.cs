...
{
    [GraphRoute("GET", "/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow-id}/subjectProcessingResults/{subjectProcessingResult-id}/reprocessedRuns")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowSubjectProcessingResultReprocessedRun_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.Run))]
    public class GetMgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowSubjectProcessingResultReprocessedRun_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows[WorkflowId].SubjectProcessingResults[SubjectProcessingResultId].ReprocessedRuns.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows[WorkflowId].SubjectProcessingResults[SubjectProcessingResultId].ReprocessedRuns.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
