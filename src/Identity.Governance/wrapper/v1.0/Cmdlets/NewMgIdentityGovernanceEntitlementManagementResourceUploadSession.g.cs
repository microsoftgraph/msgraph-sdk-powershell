...
{
    [GraphRoute("POST", "/identityGovernance/entitlementManagement/resources/{accessPackageResource-id}/uploadSessions")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceEntitlementManagementResourceUploadSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.CustomDataProvidedResourceUploadSession))]
    public class NewMgIdentityGovernanceEntitlementManagementResourceUploadSessionCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(AccessPackageResourceId, "New"))
                return;
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.Resources[AccessPackageResourceId].UploadSessions.PostAsync(body, requestConfiguration =>
                {
