...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleAssignmentScheduleInstances")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleInstance))]
    public class NewMgRoleManagementEntitlementManagementRoleAssignmentScheduleInstanceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(StartDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.PostAsync(body, requestConfiguration =>
                {
