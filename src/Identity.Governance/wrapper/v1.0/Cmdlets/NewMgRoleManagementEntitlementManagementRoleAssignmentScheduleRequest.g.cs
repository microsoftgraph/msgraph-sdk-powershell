...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/roleAssignmentScheduleRequests")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementRoleAssignmentScheduleRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleAssignmentScheduleRequest))]
    public class NewMgRoleManagementEntitlementManagementRoleAssignmentScheduleRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TicketInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.PostAsync(body, requestConfiguration =>
                {
