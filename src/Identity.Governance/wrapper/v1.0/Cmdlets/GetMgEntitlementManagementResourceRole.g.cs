...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgEntitlementManagementResourceRoleCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceRoleId : AccessPackageResourceId);
                return;
            }
        }
    }
