...
{
    [GraphRoute("POST", "/identityGovernance/accessReviews/unified/definitions")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceAccessReviewUnifiedDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessReviewScheduleDefinition))]
    public class NewMgIdentityGovernanceAccessReviewUnifiedDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(StageSettings)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.AccessReviews.Unified.Definitions.PostAsync(body, requestConfiguration =>
                {
