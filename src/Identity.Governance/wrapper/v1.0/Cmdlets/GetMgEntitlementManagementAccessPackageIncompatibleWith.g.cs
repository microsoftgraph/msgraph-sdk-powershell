...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/accessPackagesIncompatibleWith")]
    ...
    public class GetMgEntitlementManagementAccessPackageIncompatibleWithCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementAccessPackageIncompatibleWith_Get" : "Get-MgEntitlementManagementAccessPackageIncompatibleWith_List";
            try
            {
