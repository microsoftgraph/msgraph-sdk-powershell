...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceRequestCatalogResourceRoleResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope_Get or Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope_Get" : "Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope_List";
            try
            {
