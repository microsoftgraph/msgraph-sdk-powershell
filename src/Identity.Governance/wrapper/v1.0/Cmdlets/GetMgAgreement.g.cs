...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAgreement", DefaultParameterSetName = "List")]
    ...
    public class GetMgAgreementCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgAgreement_Get or Get-MgAgreement_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgAgreement_Get" : "Get-MgAgreement_List";
            try
            {
