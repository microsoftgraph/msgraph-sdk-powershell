...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources/{accessPackageResource-id}/scopes")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceEnvironmentResourceScope", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceEnvironmentResourceScopeCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceEnvironmentResourceScope_Get or Get-MgEntitlementManagementResourceEnvironmentResourceScope_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceEnvironmentResourceScope_Get" : "Get-MgEntitlementManagementResourceEnvironmentResourceScope_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? AccessPackageResourceScopeId : AccessPackageResourceId);
                return;
            }
        }
    }
