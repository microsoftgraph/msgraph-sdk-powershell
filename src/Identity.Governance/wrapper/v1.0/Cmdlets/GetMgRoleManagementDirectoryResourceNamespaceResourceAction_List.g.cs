...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDirectoryResourceNamespaceResourceAction_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRbacResourceAction))]
    public class GetMgRoleManagementDirectoryResourceNamespaceResourceAction_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRbacResourceActionCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Directory.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Directory.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
