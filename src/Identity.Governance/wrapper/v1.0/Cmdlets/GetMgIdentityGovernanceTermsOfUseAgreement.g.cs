...
{
    [GraphRoute("GET", "/identityGovernance/termsOfUse/agreements")]
    ...
    public class GetMgIdentityGovernanceTermsOfUseAgreementCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceTermsOfUseAgreement_Get" : "Get-MgIdentityGovernanceTermsOfUseAgreement_List";
            try
            {
