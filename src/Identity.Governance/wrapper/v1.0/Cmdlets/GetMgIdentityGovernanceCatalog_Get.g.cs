...
{
    [GraphRoute("GET", "/identityGovernance/catalogs/{accessPackageCatalog-id}")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalog_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageCatalog))]
    public class GetMgIdentityGovernanceCatalog_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.Catalogs[AccessPackageCatalogId].GetAsync(requestConfiguration =>
                {
