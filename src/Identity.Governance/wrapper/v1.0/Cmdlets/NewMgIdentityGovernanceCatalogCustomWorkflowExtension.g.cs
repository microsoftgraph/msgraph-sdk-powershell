...
{
    [GraphRoute("POST", "/identityGovernance/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceCatalogCustomWorkflowExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.CustomCalloutExtension))]
    public class NewMgIdentityGovernanceCatalogCustomWorkflowExtensionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(EndpointConfiguration)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.Catalogs[AccessPackageCatalogId].CustomWorkflowExtensions.PostAsync(body, requestConfiguration =>
                {
