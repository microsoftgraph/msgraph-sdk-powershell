...
{
    [GraphRoute("POST", "/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleInstanceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MemberType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleInstances.PostAsync(body, requestConfiguration =>
                {
