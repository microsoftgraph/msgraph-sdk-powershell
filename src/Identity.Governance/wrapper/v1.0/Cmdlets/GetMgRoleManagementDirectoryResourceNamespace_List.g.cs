...
{
    [GraphRoute("GET", "/roleManagement/directory/resourceNamespaces")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDirectoryResourceNamespace_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRbacResourceNamespace))]
    public class GetMgRoleManagementDirectoryResourceNamespace_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRbacResourceNamespaceCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Directory.ResourceNamespaces.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Directory.ResourceNamespaces.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
