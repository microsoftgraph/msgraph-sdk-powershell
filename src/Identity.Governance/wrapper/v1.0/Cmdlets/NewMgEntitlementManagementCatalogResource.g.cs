...
{
    [GraphRoute("POST", "/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resources")]
    [Cmdlet(VerbsCommon.New, "MgEntitlementManagementCatalogResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResource))]
    public class NewMgEntitlementManagementCatalogResourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Attributes)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.Catalogs[AccessPackageCatalogId].Resources.PostAsync(body, requestConfiguration =>
                {
