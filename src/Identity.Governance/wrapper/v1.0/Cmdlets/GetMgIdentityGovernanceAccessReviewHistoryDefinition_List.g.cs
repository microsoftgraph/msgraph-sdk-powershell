...
{
    [GraphRoute("GET", "/identityGovernance/accessReviews/historyDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceAccessReviewHistoryDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessReviewHistoryDefinition))]
    public class GetMgIdentityGovernanceAccessReviewHistoryDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessReviewHistoryDefinitionCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.AccessReviews.HistoryDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.AccessReviews.HistoryDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
