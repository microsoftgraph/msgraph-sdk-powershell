...
{
    [GraphRoute("POST", "/identityGovernance/termsOfUse/agreements")]
    [Cmdlet(VerbsCommon.New, "MgIdentityGovernanceTermsOfUseAgreement", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.Agreement))]
    public class NewMgIdentityGovernanceTermsOfUseAgreementCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TermsExpiration)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.TermsOfUse.Agreements.PostAsync(body, requestConfiguration =>
                {
