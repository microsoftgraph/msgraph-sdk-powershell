...
{
    [GraphRoute("GET", "/identityGovernance/termsOfUse/agreements/{agreement-id}/files")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceTermsOfUseAgreementFile")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalization))]
    public class GetMgIdentityGovernanceTermsOfUseAgreementFileCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalizationCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.TermsOfUse.Agreements[AgreementId].Files.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.TermsOfUse.Agreements[AgreementId].Files.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
