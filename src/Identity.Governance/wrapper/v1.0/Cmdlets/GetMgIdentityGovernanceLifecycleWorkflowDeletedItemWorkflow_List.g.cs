...
{
    [GraphRoute("GET", "/identityGovernance/lifecycleWorkflows/deletedItems/workflows")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflow_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.Workflow))]
    public class GetMgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflow_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.WorkflowCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
