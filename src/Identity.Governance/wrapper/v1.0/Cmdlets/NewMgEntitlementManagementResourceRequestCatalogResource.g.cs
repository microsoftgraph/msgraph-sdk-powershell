...
{
    [GraphRoute("POST", "/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/resources")]
    [Cmdlet(VerbsCommon.New, "MgEntitlementManagementResourceRequestCatalogResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AccessPackageResource))]
    public class NewMgEntitlementManagementResourceRequestCatalogResourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Attributes)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ResourceRequests[AccessPackageResourceRequestId].Catalog.Resources.PostAsync(body, requestConfiguration =>
                {
