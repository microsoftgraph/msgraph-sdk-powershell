...
{
    [GraphRoute("GET", "/identityGovernance/catalogs/{accessPackageCatalog-id}/resourceRoles/{accessPackageResourceRole-id}/resource/scopes/{accessPackageResourceScope-id}/resource/roles")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRole_Get or Get-MgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRole_Get" : "Get-MgIdentityGovernanceCatalogResourceRoleResourceScopeResourceRole_List";
            try
            {
