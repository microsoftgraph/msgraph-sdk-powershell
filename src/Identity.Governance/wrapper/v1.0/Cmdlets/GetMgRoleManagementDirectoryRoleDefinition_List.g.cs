...
{
    [GraphRoute("GET", "/roleManagement/directory/roleDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDirectoryRoleDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementDirectoryRoleDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleDefinitionCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Directory.RoleDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Directory.RoleDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
