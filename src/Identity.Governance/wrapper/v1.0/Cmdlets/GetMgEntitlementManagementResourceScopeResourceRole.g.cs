...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementResourceScopeResourceRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgEntitlementManagementResourceScopeResourceRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEntitlementManagementResourceScopeResourceRole_Get or Get-MgEntitlementManagementResourceScopeResourceRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEntitlementManagementResourceScopeResourceRole_Get" : "Get-MgEntitlementManagementResourceScopeResourceRole_List";
            try
            {
