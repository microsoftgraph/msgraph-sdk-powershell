...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceLifecycleWorkflowUserProcessingResultTaskProcessingResult_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.IdentityGovernance.TaskProcessingResult))]
    public class GetMgIdentityGovernanceLifecycleWorkflowUserProcessingResultTaskProcessingResult_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.LifecycleWorkflows.Workflows[WorkflowId].UserProcessingResults[UserProcessingResultId].TaskProcessingResults.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.LifecycleWorkflows.Workflows[WorkflowId].UserProcessingResults[UserProcessingResultId].TaskProcessingResults.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
