...
{
    [GraphRoute("GET", "/agreements")]
    [Cmdlet(VerbsCommon.Get, "MgAgreement_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.Agreement))]
    public class GetMgAgreement_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementCollectionResponse? result;
            try
            {
                result = client.Agreements.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Agreements.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
