...
{
    [GraphRoute("POST", "/agreements/{agreement-id}/file/localizations")]
    [Cmdlet(VerbsCommon.New, "MgAgreementFileLocalization", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileLocalization))]
    public class NewMgAgreementFileLocalizationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(FileData)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Agreements[AgreementId].File.Localizations.PostAsync(body, requestConfiguration =>
                {
