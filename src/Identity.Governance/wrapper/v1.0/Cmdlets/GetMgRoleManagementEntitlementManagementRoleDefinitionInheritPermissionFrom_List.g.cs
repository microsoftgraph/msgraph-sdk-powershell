...
{
    [GraphRoute("GET", "/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementEntitlementManagementRoleDefinitionInheritPermissionFrom_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementEntitlementManagementRoleDefinitionInheritPermissionFrom_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.EntitlementManagement.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
