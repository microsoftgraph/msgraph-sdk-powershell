...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Remove, "MgIdentityGovernanceEntitlementManagementResourceEnvironmentResourceScopeResourceRoleResourceUploadSessionFileContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    public class RemoveMgIdentityGovernanceEntitlementManagementResourceEnvironmentResourceScopeResourceRoleResourceUploadSessionFileContentCommand : GraphClientCmdlet
    {
