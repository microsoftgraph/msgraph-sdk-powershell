...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class UpdateMgIdentityGovernanceLifecycleWorkflowUserProcessingResultSubjectMailboxSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(WorkingHours)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowGraphRequestFailed(ex, UserProcessingResultId);
                return;
            }
