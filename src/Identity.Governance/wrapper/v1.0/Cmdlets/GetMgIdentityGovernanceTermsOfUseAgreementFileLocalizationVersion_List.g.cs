...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.AgreementFileVersion))]
    public class GetMgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.TermsOfUse.Agreements[AgreementId].File.Localizations[AgreementFileLocalizationId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.TermsOfUse.Agreements[AgreementId].File.Localizations[AgreementFileLocalizationId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
