...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityGovernanceEntitlementManagementResourceRequestCatalogResourceUploadSession_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.CustomDataProvidedResourceUploadSession))]
    public class GetMgIdentityGovernanceEntitlementManagementResourceRequestCatalogResourceUploadSession_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ResourceRequests[AccessPackageResourceRequestId].Catalog.Resources[AccessPackageResourceId].UploadSessions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.ResourceRequests[AccessPackageResourceRequestId].Catalog.Resources[AccessPackageResourceId].UploadSessions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
