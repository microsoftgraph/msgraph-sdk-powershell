...
{
    [GraphRoute("GET", "/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization-id}/internalSponsors/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEntitlementManagementConnectedOrganizationInternalSponsorByRef")]
    [OutputType(typeof(string))]
    public class GetMgEntitlementManagementConnectedOrganizationInternalSponsorByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.StringCollectionResponse? result;
            try
            {
                result = client.IdentityGovernance.EntitlementManagement.ConnectedOrganizations[ConnectedOrganizationId].InternalSponsors.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityGovernance.EntitlementManagement.ConnectedOrganizations[ConnectedOrganizationId].InternalSponsors.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
