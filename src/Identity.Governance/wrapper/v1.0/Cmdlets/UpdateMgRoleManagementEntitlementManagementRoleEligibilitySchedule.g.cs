...
{
    [GraphRoute("PATCH", "/roleManagement/entitlementManagement/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule-id}")]
    [Cmdlet(VerbsData.Update, "MgRoleManagementEntitlementManagementRoleEligibilitySchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRoleEligibilitySchedule))]
    public class UpdateMgRoleManagementEntitlementManagementRoleEligibilityScheduleCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ScheduleInfo)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.RoleEligibilitySchedules[UnifiedRoleEligibilityScheduleId].PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleEligibilityScheduleId));
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.RoleManagement.EntitlementManagement.RoleEligibilitySchedules[UnifiedRoleEligibilityScheduleId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, UnifiedRoleEligibilityScheduleId));
