...
namespace Microsoft.Graph.PowerShell.Identity.Governance
{
    ...
    public class GetMgIdentityGovernanceLifecycleWorkflowRunTaskProcessingResultCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TaskProcessingResultId : RunId);
                return;
            }
        }
    }
