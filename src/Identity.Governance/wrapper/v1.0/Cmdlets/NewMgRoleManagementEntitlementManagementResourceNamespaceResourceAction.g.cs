...
{
    [GraphRoute("POST", "/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace-id}/resourceActions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementEntitlementManagementResourceNamespaceResourceAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Governance.Client.Models.UnifiedRbacResourceAction))]
    public class NewMgRoleManagementEntitlementManagementResourceNamespaceResourceActionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ResourceScopeId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.EntitlementManagement.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.PostAsync(body, requestConfiguration =>
                {
