...
### List (Default)
```
Get-MgProgramControl [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### List1
```
Get-MgProgramControl -ProgramControlId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
