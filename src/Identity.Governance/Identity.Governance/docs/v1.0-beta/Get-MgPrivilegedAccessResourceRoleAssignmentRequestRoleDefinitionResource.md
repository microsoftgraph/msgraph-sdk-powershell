...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgprivilegedaccessresourceroleassignmentrequestroledefinitionresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgPrivilegedAccessResourceRoleAssignmentRequestRoleDefinitionResource -GovernanceResourceId <String>
