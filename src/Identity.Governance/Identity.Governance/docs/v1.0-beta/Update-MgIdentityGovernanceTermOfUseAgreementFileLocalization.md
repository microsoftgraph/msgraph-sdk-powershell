...
```
Update-MgIdentityGovernanceTermOfUseAgreementFileLocalization -AgreementFileLocalizationId <String>
...
### UpdateViaIdentity
```
Update-MgIdentityGovernanceTermOfUseAgreementFileLocalization -InputObject <IIdentityGovernanceIdentity>
