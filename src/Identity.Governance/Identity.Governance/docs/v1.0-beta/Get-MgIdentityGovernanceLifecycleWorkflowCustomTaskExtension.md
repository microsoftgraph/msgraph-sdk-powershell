...
### List (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowCustomTaskExtension [-ExpandProperty <String[]>] [-Filter <String>]
...
### Example 1: Using the Get-MgBetaIdentityGovernanceLifecycleWorkflowCustomTaskExtension Cmdlet
```powershell
