...
New-MgBetaEntitlementManagementAccessPackageResourceRequest
 ...
 [-IsValidationOnly] [-Justification <String>] [-Requestor <IMicrosoftGraphAccessPackageSubject1>]
...
AccessPackageResource : Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphAccessPackageResource
