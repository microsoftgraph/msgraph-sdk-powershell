...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowRun -RunId <String> -WorkflowId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowRun -InputObject <IIdentityGovernanceIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
