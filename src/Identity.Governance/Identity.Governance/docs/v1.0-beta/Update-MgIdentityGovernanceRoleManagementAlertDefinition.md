...
Update-MgIdentityGovernanceRoleManagementAlertDefinition -UnifiedRoleManagementAlertDefinitionId <String>
 ...
 [-ScopeType <String>] [-SecurityImpact <String>] [-SeverityLevel <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgIdentityGovernanceRoleManagementAlertDefinition -UnifiedRoleManagementAlertDefinitionId <String>
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementAlertDefinition> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
