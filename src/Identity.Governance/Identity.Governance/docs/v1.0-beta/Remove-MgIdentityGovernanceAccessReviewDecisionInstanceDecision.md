...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceAccessReviewDecisionInstanceDecision -AccessReviewInstanceDecisionItemId <String>
 -AccessReviewInstanceDecisionItemId1 <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
