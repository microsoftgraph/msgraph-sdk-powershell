...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowRunUserProcessingResult -RunId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowRunUserProcessingResult -InputObject <IIdentityGovernanceIdentity>
