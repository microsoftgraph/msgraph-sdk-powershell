...
online version: https://docs.microsoft.com/en-us/powershell/module/Microsoft.Graph.identity.governance/remove-mgidentitygovernancelifecycleworkflowdeleteditemworkflowtaskreport
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowTaskReport -TaskReportId <String>
 -WorkflowId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
