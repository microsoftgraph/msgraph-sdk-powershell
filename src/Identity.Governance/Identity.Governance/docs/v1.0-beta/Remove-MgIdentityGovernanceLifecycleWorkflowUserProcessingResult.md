...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowUserProcessingResult -UserProcessingResultId <String>
 -WorkflowId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowUserProcessingResult -InputObject <IIdentityGovernanceIdentity>
