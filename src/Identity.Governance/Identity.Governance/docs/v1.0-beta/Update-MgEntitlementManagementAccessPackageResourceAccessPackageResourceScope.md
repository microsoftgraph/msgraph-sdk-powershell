...
Update-MgEntitlementManagementAccessPackageResourceAccessPackageResourceScope
 ...
 [-OriginSystem <String>] [-RoleOriginId <String>] [-Url <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgEntitlementManagementAccessPackageResourceAccessPackageResourceScope
 -AccessPackageResourceId <String> -AccessPackageResourceScopeId <String>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceScope> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
