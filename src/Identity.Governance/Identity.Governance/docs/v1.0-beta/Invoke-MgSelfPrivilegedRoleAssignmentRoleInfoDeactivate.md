...
### Self (Default)
```
Invoke-MgBetaSelfPrivilegedRoleAssignmentRoleInfoDeactivate -PrivilegedRoleAssignmentId <String> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SelfViaIdentity
```
Invoke-MgBetaSelfPrivilegedRoleAssignmentRoleInfoDeactivate -InputObject <IIdentityGovernanceIdentity> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
