...
Update-MgIdentityGovernanceRoleManagementAlertConfiguration
 ...
 [-Id <String>] [-IsEnabled] [-ScopeId <String>] [-ScopeType <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernanceRoleManagementAlertConfiguration
 ...
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementAlertConfiguration> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
