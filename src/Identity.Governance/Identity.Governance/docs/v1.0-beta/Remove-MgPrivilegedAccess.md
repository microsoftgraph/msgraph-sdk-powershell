...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccess -PrivilegedAccessId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccess -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>] [-PassThru]
