...
### Update
```
Update-MgProgram -ProgramId <String> -BodyParameter <IMicrosoftGraphProgram> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgProgram -InputObject <IIdentityGovernanceIdentity> -BodyParameter <IMicrosoftGraphProgram> [-PassThru]
