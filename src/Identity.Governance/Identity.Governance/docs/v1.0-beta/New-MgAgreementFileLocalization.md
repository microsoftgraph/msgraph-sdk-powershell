...
### Create
```
New-MgAgreementFileLocalization -AgreementId <String> -BodyParameter <Hashtable> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgAgreementFileLocalization -InputObject <IIdentityGovernanceIdentity> -BodyParameter <Hashtable>
