...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/remove-mgidentitygovernanceaccessreviewdecisioninstancedefinitionbyref
schema: 2.0.0
---

# Remove-MgIdentityGovernanceAccessReviewDecisionInstanceDefinitionByRef
...
```
Remove-MgIdentityGovernanceAccessReviewDecisionInstanceDefinitionByRef
 -AccessReviewInstanceDecisionItemId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
