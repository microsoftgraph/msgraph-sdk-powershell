...
### Delete (Default)
```
Remove-MgBetaAccessReviewMyDecision -AccessReviewDecisionId <String> -AccessReviewId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaAccessReviewMyDecision -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>] [-PassThru]
