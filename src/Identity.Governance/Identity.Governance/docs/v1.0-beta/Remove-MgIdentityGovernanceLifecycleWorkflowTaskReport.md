...
### Delete (Default)
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowTaskReport -TaskReportId <String> -WorkflowId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityGovernanceLifecycleWorkflowTaskReport -InputObject <IIdentityGovernanceIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
