...
Update-MgEntitlementManagementCatalogAccessPackageAssignmentPolicyQuestion
 ...
 [-Text <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgEntitlementManagementCatalogAccessPackageAssignmentPolicyQuestion
 -AccessPackageAssignmentPolicyId <String> -AccessPackageCatalogId <String> -AccessPackageId <String>
 -AccessPackageQuestionId <String> -BodyParameter <IMicrosoftGraphAccessPackageQuestion> [-PassThru]
...
Update-MgEntitlementManagementCatalogAccessPackageAssignmentPolicyQuestion
 ...
 [-Sequence <Int32>] [-Text <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
