...
New-MgEntitlementManagementCatalogAccessPackageIncompatibleGroupByRef -AccessPackageCatalogId <String>
 -AccessPackageId <String> [-AdditionalProperties <Hashtable>] [-OdataId <String>] [-PassThru] [-Confirm]
...
```
New-MgEntitlementManagementCatalogAccessPackageIncompatibleGroupByRef -AccessPackageCatalogId <String>
 -AccessPackageId <String> -BodyParameter <IReferenceCreate> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgEntitlementManagementCatalogAccessPackageIncompatibleGroupByRef
 -InputObject <IIdentityGovernanceIdentity> [-AdditionalProperties <Hashtable>] [-OdataId <String>]
