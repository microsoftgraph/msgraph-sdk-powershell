...
### List (Default)
```
Get-MgAccessReviewMyDecision -AccessReviewId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgaccessreviewmydecision](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgaccessreviewmydecision)
