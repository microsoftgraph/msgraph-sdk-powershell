...
Update-MgIdentityGovernanceTermsOfUseAgreementFile -AgreementId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Localizations <IMicrosoftGraphAgreementFileLocalization[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernanceTermsOfUseAgreementFile -AgreementId <String>
 -BodyParameter <IMicrosoftGraphAgreementFile> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
