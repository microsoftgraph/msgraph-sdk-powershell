...
Update-MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleInstance
 ...
 [-Principal <IMicrosoftGraphDirectoryObject>] [-PrincipalId <String>] [-StartDateTime <DateTime>] [-Confirm]
...
Update-MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleInstance
 ...
 -BodyParameter <IMicrosoftGraphPrivilegedAccessGroupEligibilityScheduleInstance> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleInstance
 ...
 [-PrincipalId <String>] [-StartDateTime <DateTime>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
