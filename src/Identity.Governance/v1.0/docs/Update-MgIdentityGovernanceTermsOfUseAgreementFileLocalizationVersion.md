...
```
Update-MgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion -AgreementFileLocalizationId <String>
 -AgreementFileVersionId <String> -AgreementId <String> -BodyParameter <Hashtable> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion
 ...
 [-IsDefault] [-IsMajorVersion] [-Language <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
