...
New-MgIdentityGovernanceLifecycleWorkflowTask -WorkflowId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TaskProcessingResults <IMicrosoftGraphIdentityGovernanceTaskProcessingResult[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgIdentityGovernanceLifecycleWorkflowTask -WorkflowId <String>
 -BodyParameter <IMicrosoftGraphIdentityGovernanceTask> [-Confirm] [-WhatIf] [<CommonParameters>]
```
