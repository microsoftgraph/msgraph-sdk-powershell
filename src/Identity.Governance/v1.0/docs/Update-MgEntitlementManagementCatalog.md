...
Update-MgEntitlementManagementCatalog -AccessPackageCatalogId <String>
 ...
 [-Id <String>] [-IsExternallyVisible] [-ModifiedDateTime <DateTime>] [-State <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgEntitlementManagementCatalog -AccessPackageCatalogId <String>
 -BodyParameter <IMicrosoftGraphAccessPackageCatalog> [-Confirm] [-WhatIf] [<CommonParameters>]
```
