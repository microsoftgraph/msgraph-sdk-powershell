...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/get-mggroupeventcalendarschedule
schema: 2.0.0
---

# Get-MgGroupEventCalendarSchedule
...
```
Get-MgGroupEventCalendarSchedule -EventId <String> -GroupId <String> [-AvailabilityViewInterval <Int32>]
...
### Get1
```
Get-MgGroupEventCalendarSchedule -EventId <String> -GroupId <String>
 -BodyParameter <IPaths1Kab48VGroupsGroupIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupEventCalendarSchedule -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1Kab48VGroupsGroupIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgGroupEventCalendarSchedule -InputObject <IGroupsActionsIdentity> [-AvailabilityViewInterval <Int32>]
 [-EndTimeDateTime <String>] [-EndTimeZone <String>] [-Schedules <String[]>] [-StartTimeDateTime <String>]
 [-StartTimeZone <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Kab48VGroupsGroupIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1Kab48VGroupsGroupIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
