...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgacceptgroupeventtentatively
schema: 2.0.0
---
...
```
Invoke-MgAcceptGroupEventTentatively -EventId <String> -GroupId <String> [-Comment <String>] [-SendResponse]
...
### AcceptViaIdentity1
```
Invoke-MgAcceptGroupEventTentatively -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1In5HfGroupsGroupIdEventsEventIdMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptGroupEventTentatively -InputObject <IGroupsActionsIdentity> [-Comment <String>] [-SendResponse]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
