...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/confirm-mggroupgrantedpermission
schema: 2.0.0
---
...
### CheckViaIdentity
```
Confirm-MgGroupGrantedPermission -InputObject <IGroupsActionsIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
