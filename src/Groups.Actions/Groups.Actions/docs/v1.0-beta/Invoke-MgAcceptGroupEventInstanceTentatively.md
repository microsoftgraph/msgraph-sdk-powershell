...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgacceptgroupeventinstancetentatively
schema: 2.0.0
---
...
```
Invoke-MgAcceptGroupEventInstanceTentatively -EventId <String> -EventId1 <String> -GroupId <String>
...
### AcceptViaIdentity1
```
Invoke-MgAcceptGroupEventInstanceTentatively -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths10WzqkgGroupsGroupIdEventsEventIdInstancesEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptGroupEventInstanceTentatively -InputObject <IGroupsActionsIdentity> [-Comment <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths10WzqkgGroupsGroupIdEventsEventIdInstancesEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
