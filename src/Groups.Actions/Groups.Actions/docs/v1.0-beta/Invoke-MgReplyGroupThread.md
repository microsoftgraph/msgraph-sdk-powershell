...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgreplygroupthread
schema: 2.0.0
---
...
```
Invoke-MgReplyGroupThread -ConversationThreadId <String> -GroupId <String> [-Post <IMicrosoftGraphPost1>]
...
### ReplyViaIdentity1
```
Invoke-MgReplyGroupThread -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPathsPlnw85GroupsGroupIdThreadsConversationthreadIdMicrosoftGraphReplyPostRequestbodyContentApplicationJsonSchema1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgReplyGroupThread -InputObject <IGroupsActionsIdentity> [-Post <IMicrosoftGraphPost1>] [-PassThru]
