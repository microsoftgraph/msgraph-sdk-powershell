...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgacceptgroupcalendarevent
schema: 2.0.0
---
...
```
Invoke-MgAcceptGroupCalendarEvent -EventId <String> -GroupId <String> [-Comment <String>] [-SendResponse]
...
### AcceptViaIdentity
```
Invoke-MgAcceptGroupCalendarEvent -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPathsU86NbuGroupsGroupIdCalendarEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptGroupCalendarEvent -InputObject <IGroupsActionsIdentity> [-Comment <String>] [-SendResponse]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
