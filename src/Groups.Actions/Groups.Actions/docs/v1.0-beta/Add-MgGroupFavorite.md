...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/add-mggroupfavorite
schema: 2.0.0
---
...
### AddViaIdentity1
```
Add-MgGroupFavorite -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
