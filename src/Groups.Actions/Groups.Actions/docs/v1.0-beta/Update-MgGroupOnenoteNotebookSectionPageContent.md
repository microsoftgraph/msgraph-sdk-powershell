...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/update-mggrouponenotenotebooksectionpagecontent
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionPageContent -GroupId <String> -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> [-Commands <IMicrosoftGraphOnenotePatchContentCommand[]>] [-PassThru] [-Confirm]
...
Update-MgGroupOnenoteNotebookSectionPageContent -GroupId <String> -NotebookId <String> -OnenotePageId <String>
 ...
 -BodyParameter <IPaths1QdzbqtGroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PatchViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionPageContent -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1QdzbqtGroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1QdzbqtGroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1QdzbqtGroupsGroupIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema
