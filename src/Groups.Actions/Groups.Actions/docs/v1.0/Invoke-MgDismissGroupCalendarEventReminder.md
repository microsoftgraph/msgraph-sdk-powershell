...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgdismissgroupcalendareventreminder
schema: 2.0.0
---
...
### DismissViaIdentity
```
Invoke-MgDismissGroupCalendarEventReminder -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
