...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/update-mggrouponenotesectiongroupsectionpagecontent
schema: 2.0.0
---
...
Update-MgGroupOnenoteSectionGroupSectionPageContent -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> [-Commands <IMicrosoftGraphOnenotePatchContentCommand[]>]
...
### PatchViaIdentity
```
Update-MgGroupOnenoteSectionGroupSectionPageContent -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths13IutgfGroupsGroupIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
