...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/confirm-mggroupmembergroup
schema: 2.0.0
---
...
```
Confirm-MgGroupMemberGroup -GroupId <String> [-GroupIds <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CheckViaIdentity
```
Confirm-MgGroupMemberGroup -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1ObknsuGroupsGroupIdMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Confirm-MgGroupMemberGroup -InputObject <IGroupsActionsIdentity> [-GroupIds <String[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
