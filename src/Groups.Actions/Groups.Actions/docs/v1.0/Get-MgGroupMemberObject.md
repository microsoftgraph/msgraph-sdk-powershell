...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/get-mggroupmemberobject
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgGroupMemberObject -GroupId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgGroupMemberObject -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1Bxm9V4GroupsGroupIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgGroupMemberObject -InputObject <IGroupsActionsIdentity> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
