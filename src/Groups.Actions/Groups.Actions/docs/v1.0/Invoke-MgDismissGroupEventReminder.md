...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgdismissgroupeventreminder
schema: 2.0.0
---
...
### DismissViaIdentity
```
Invoke-MgDismissGroupEventReminder -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
