...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/reset-mggroupunseencount
schema: 2.0.0
---
...
### ResetViaIdentity
```
Reset-MgGroupUnseenCount -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
