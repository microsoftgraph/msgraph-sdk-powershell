...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgsubscribegroup
schema: 2.0.0
---
...
```
Invoke-MgSubscribeGroup -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
