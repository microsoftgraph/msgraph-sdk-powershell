...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgacceptgroupevent
schema: 2.0.0
---
...
```
Invoke-MgAcceptGroupEvent -EventId <String> -GroupId <String> [-Comment <String>] [-SendResponse] [-PassThru]
...
### AcceptViaIdentity
```
Invoke-MgAcceptGroupEvent -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPathsEy6J5AGroupsGroupIdEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptGroupEvent -InputObject <IGroupsActionsIdentity> [-Comment <String>] [-SendResponse]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
