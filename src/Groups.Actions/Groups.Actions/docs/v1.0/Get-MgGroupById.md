...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/get-mggroupbyid
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgGroupById [-Ids <String[]>] [-Types <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
