...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/get-mggroupmembergroup
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgGroupMemberGroup -GroupId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgGroupMemberGroup -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPathsAp3OzjGroupsGroupIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgGroupMemberGroup -InputObject <IGroupsActionsIdentity> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
