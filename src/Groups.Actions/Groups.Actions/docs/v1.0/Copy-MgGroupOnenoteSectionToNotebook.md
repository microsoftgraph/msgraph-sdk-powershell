...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/copy-mggrouponenotesectiontonotebook
schema: 2.0.0
---
...
```
Copy-MgGroupOnenoteSectionToNotebook -GroupId <String> -OnenoteSectionId <String> [-GroupId1 <String>]
...
### CopyViaIdentity
```
Copy-MgGroupOnenoteSectionToNotebook -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1Pi7DraGroupsGroupIdOnenoteSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Copy-MgGroupOnenoteSectionToNotebook -InputObject <IGroupsActionsIdentity> [-GroupId <String>] [-Id <String>]
 [-RenameAs <String>] [-SiteCollectionId <String>] [-SiteId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
