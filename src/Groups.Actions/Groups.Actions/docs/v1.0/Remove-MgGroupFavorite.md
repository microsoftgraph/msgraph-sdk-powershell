...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/remove-mggroupfavorite
schema: 2.0.0
---
...
### RemoveViaIdentity
```
Remove-MgGroupFavorite -InputObject <IGroupsActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
