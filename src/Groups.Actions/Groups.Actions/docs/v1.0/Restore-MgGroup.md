...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/restore-mggroup
schema: 2.0.0
---
...
### RestoreViaIdentity
```
Restore-MgGroup -InputObject <IGroupsActionsIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
