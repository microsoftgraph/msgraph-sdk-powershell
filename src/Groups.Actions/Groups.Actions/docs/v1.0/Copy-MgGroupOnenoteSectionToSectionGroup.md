...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/copy-mggrouponenotesectiontosectiongroup
schema: 2.0.0
---
...
```
Copy-MgGroupOnenoteSectionToSectionGroup -GroupId <String> -OnenoteSectionId <String> [-GroupId1 <String>]
...
### CopyViaIdentity
```
Copy-MgGroupOnenoteSectionToSectionGroup -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths7006K8GroupsGroupIdOnenoteSectionsOnenotesectionIdMicrosoftGraphCopytosectiongroupPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Copy-MgGroupOnenoteSectionToSectionGroup -InputObject <IGroupsActionsIdentity> [-GroupId <String>]
 [-Id <String>] [-RenameAs <String>] [-SiteCollectionId <String>] [-SiteId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
