...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/invoke-mgsnoozegroupeventinstancereminder
schema: 2.0.0
---
...
```
Invoke-MgSnoozeGroupEventInstanceReminder -EventId <String> -EventId1 <String> -GroupId <String>
...
### SnoozeViaIdentity
```
Invoke-MgSnoozeGroupEventInstanceReminder -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPathsWwloeuGroupsGroupIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsWwloeuGroupsGroupIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
