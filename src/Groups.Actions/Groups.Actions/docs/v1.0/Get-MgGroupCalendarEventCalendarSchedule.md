...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.actions/get-mggroupcalendareventcalendarschedule
schema: 2.0.0
---
...
```
Get-MgGroupCalendarEventCalendarSchedule -EventId <String> -GroupId <String>
...
```
Get-MgGroupCalendarEventCalendarSchedule -EventId <String> -GroupId <String>
 -BodyParameter <IPaths1D3Sml5GroupsGroupIdCalendarEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupCalendarEventCalendarSchedule -InputObject <IGroupsActionsIdentity>
 -BodyParameter <IPaths1D3Sml5GroupsGroupIdCalendarEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1D3Sml5GroupsGroupIdCalendarEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1D3Sml5GroupsGroupIdCalendarEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
