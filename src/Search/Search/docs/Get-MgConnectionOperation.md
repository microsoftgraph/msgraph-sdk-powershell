...
### List (Default)
```
Get-MgConnectionOperation -ExternalConnectionId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgConnectionOperation -ConnectionOperationId <String> -ExternalConnectionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgConnectionOperation -InputObject <ISearchIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
