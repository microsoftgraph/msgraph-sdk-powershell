...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.search/get-mgexternalconnectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgExternalConnectionGroup -ExternalConnectionId <String> [-Count] [-ExpandProperty <String[]>]
...
### Example 1: Using the Get-MgExternalConnectionGroup Cmdlet
```powershell
