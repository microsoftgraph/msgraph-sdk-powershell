...
### Create
```
New-MgExternalIndustryDataInboundFlow -BodyParameter <IMicrosoftGraphIndustryDataInboundFlow> [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIndustryDataInboundFlow
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIndustryDataConnector
Parameter Sets: CreateExpanded
Aliases:
