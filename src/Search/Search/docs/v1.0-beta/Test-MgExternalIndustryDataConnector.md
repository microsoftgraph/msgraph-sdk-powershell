...
### Validate (Default)
```
Test-MgExternalIndustryDataConnector -IndustryDataConnectorId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ValidateViaIdentity
```
Test-MgExternalIndustryDataConnector -InputObject <ISearchIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
