...
Update-MgExternalIndustryDataInboundFlow -InboundFlowId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Year <IMicrosoftGraphIndustryDataYearTimePeriodDefinition>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgExternalIndustryDataInboundFlow -InboundFlowId <String>
 -BodyParameter <IMicrosoftGraphIndustryDataInboundFlow> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
