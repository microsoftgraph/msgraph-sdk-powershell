...
New-MgExternalIndustryDataOperation [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 ...
 [-StatusDetail <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgExternalIndustryDataOperation -BodyParameter <IMicrosoftGraphLongRunningOperation> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
