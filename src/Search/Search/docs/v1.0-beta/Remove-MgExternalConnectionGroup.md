...
### Delete (Default)
```
Remove-MgBetaExternalConnectionGroup -ExternalConnectionId <String> -ExternalGroupId <String> [-IfMatch <String>]
...
### Example 1: Using the Remove-MgBetaExternalConnectionGroup Cmdlet
```powershell
