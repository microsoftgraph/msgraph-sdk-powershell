...
### Create
```
New-MgExternalIndustryDataYear -BodyParameter <IMicrosoftGraphIndustryDataYearTimePeriodDefinition> [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIndustryDataYearTimePeriodDefinition
