...
namespace Microsoft.Graph.PowerShell.Search
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSearchQna_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.Search.Qna))]
    public class GetMgSearchQna_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Search.Client.Models.Search.QnaCollectionResponse? result;
            try
            {
                result = client.Search.Qnas.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Search.Qnas.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
