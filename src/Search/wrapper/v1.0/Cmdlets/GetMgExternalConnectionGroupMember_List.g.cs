...
namespace Microsoft.Graph.PowerShell.Search
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgExternalConnectionGroupMember_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.Identity))]
    public class GetMgExternalConnectionGroupMember_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.IdentityCollectionResponse? result;
            try
            {
                result = client.External.Connections[ExternalConnectionId].Groups[ExternalGroupId].Members.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.External.Connections[ExternalConnectionId].Groups[ExternalGroupId].Members.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
