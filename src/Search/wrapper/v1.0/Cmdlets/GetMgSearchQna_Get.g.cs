...
{
    [GraphRoute("GET", "/search/qnas/{qna-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSearchQna_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.Search.Qna))]
    public class GetMgSearchQna_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Search.Qnas[QnaId].GetAsync(requestConfiguration =>
                {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, QnaId));
                return;
            }
