...
{
    [GraphRoute("GET", "/external/connections/{externalConnection-id}/groups/{externalGroup-id}")]
    [Cmdlet(VerbsCommon.Get, "MgExternalConnectionGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.ExternalGroup))]
    public class GetMgExternalConnectionGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.External.Connections[ExternalConnectionId].Groups[ExternalGroupId].GetAsync(requestConfiguration =>
                {
