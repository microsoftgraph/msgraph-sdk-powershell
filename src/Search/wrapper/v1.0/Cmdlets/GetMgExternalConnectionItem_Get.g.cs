...
{
    [GraphRoute("GET", "/external/connections/{externalConnection-id}/items/{externalItem-id}")]
    [Cmdlet(VerbsCommon.Get, "MgExternalConnectionItem_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.ExternalItem))]
    public class GetMgExternalConnectionItem_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.External.Connections[ExternalConnectionId].Items[ExternalItemId].GetAsync(requestConfiguration =>
                {
