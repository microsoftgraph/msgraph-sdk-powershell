...
namespace Microsoft.Graph.PowerShell.Search
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSearchAcronym_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.Search.Acronym))]
    public class GetMgSearchAcronym_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Search.Client.Models.Search.AcronymCollectionResponse? result;
            try
            {
                result = client.Search.Acronyms.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Search.Acronyms.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
