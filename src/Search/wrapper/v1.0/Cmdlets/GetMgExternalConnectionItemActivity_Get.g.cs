...
{
    [GraphRoute("GET", "/external/connections/{externalConnection-id}/items/{externalItem-id}/activities/{externalActivity-id}")]
    [Cmdlet(VerbsCommon.Get, "MgExternalConnectionItemActivity_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.ExternalActivity))]
    public class GetMgExternalConnectionItemActivity_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.External.Connections[ExternalConnectionId].Items[ExternalItemId].Activities[ExternalActivityId].GetAsync(requestConfiguration =>
                {
