...
{
    [GraphRoute("GET", "/external/connections/{externalConnection-id}/schema")]
    [Cmdlet(VerbsCommon.Get, "MgExternalConnectionSchema")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.ExternalConnectors.Schema))]
    public class GetMgExternalConnectionSchemaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.External.Connections[ExternalConnectionId].Schema.GetAsync(requestConfiguration =>
                {
