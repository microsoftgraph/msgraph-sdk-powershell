...
namespace Microsoft.Graph.PowerShell.Search
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSearchBookmark_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Search.Client.Models.Search.Bookmark))]
    public class GetMgSearchBookmark_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Search.Client.Models.Search.BookmarkCollectionResponse? result;
            try
            {
                result = client.Search.Bookmarks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Search.Bookmarks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
