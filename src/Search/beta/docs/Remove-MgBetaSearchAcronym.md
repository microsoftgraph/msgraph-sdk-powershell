...
### Delete (Default)
```
Remove-MgBetaSearchAcronym -AcronymId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSearchAcronym -InputObject <ISearchIdentity> [-IfMatch <String>]
