...
### Delete (Default)
```
Remove-MgBetaSearchBookmark -BookmarkId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSearchBookmark -InputObject <ISearchIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
