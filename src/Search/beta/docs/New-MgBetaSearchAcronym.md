...
New-MgBetaSearchAcronym [-AdditionalProperties <Hashtable>] [-Description <String>] [-DisplayName <String>]
 ...
 [-StandsFor <String>] [-State <String>] [-WebUrl <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaSearchAcronym -BodyParameter <IMicrosoftGraphSearchAcronym> [-Headers <IDictionary>] [-Confirm]
