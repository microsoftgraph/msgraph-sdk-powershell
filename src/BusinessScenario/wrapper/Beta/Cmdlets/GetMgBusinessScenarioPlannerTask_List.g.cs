...
namespace Microsoft.Graph.PowerShell.BusinessScenario
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerTask_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenarioTask))]
    public class GetMgBusinessScenarioPlannerTask_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenarioTaskCollectionResponse? result;
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
