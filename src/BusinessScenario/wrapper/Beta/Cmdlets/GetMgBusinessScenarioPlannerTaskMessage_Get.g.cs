...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/messages/{plannerTaskChatMessage-id}")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerTaskMessage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerTaskChatMessage))]
    public class GetMgBusinessScenarioPlannerTaskMessage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks[BusinessScenarioTaskId].Messages[PlannerTaskChatMessageId].GetAsync(requestConfiguration =>
                {
