...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/details")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerTaskDetail")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerTaskDetails))]
    public class GetMgBusinessScenarioPlannerTaskDetailCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks[BusinessScenarioTaskId].Details.GetAsync(requestConfiguration =>
                {
