...
namespace Microsoft.Graph.PowerShell.BusinessScenario
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenario_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenario))]
    public class GetMgBusinessScenario_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenarioCollectionResponse? result;
            try
            {
                result = client.Solutions.BusinessScenarios.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BusinessScenarios.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
