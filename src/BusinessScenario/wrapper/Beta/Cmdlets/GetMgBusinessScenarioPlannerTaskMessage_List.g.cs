...
namespace Microsoft.Graph.PowerShell.BusinessScenario
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerTaskMessage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerTaskChatMessage))]
    public class GetMgBusinessScenarioPlannerTaskMessage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerTaskChatMessageCollectionResponse? result;
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks[BusinessScenarioTaskId].Messages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks[BusinessScenarioTaskId].Messages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
