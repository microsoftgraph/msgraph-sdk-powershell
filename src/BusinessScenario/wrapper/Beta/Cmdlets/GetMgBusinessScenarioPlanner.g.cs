...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlanner")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenarioPlanner))]
    public class GetMgBusinessScenarioPlannerCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.GetAsync(requestConfiguration =>
                {
