...
{
    [GraphRoute("POST", "/solutions/businessScenarios/{businessScenario-id}/planner/tasks")]
    [Cmdlet(VerbsCommon.New, "MgBusinessScenarioPlannerTask", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenarioTask))]
    public class NewMgBusinessScenarioPlannerTaskCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks.PostAsync(body, requestConfiguration =>
                {
