...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner/planConfiguration")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerPlanConfiguration")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerPlanConfiguration))]
    public class GetMgBusinessScenarioPlannerPlanConfigurationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.PlanConfiguration.GetAsync(requestConfiguration =>
                {
