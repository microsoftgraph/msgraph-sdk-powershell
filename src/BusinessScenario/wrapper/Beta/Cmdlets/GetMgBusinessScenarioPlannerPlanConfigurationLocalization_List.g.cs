...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner/planConfiguration/localizations")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerPlanConfigurationLocalization_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerPlanConfigurationLocalization))]
    public class GetMgBusinessScenarioPlannerPlanConfigurationLocalization_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerPlanConfigurationLocalizationCollectionResponse? result;
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.PlanConfiguration.Localizations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.PlanConfiguration.Localizations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
