...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/progressTaskBoardFormat")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenarioPlannerTaskProgressTaskBoardFormat")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.PlannerProgressTaskBoardTaskFormat))]
    public class GetMgBusinessScenarioPlannerTaskProgressTaskBoardFormatCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].Planner.Tasks[BusinessScenarioTaskId].ProgressTaskBoardFormat.GetAsync(requestConfiguration =>
                {
