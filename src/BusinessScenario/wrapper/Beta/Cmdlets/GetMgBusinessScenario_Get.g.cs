...
{
    [GraphRoute("GET", "/solutions/businessScenarios/{businessScenario-id}")]
    [Cmdlet(VerbsCommon.Get, "MgBusinessScenario_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BusinessScenario.Client.Models.BusinessScenario))]
    public class GetMgBusinessScenario_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BusinessScenarios[BusinessScenarioId].GetAsync(requestConfiguration =>
                {
