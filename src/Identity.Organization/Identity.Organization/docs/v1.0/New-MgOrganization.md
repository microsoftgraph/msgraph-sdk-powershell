...
```
New-MgOrganization [-AssignedPlans <IMicrosoftGraphAssignedPlan[]>] [-BusinessPhones <String[]>]
 ...
 [-PreferredLanguage <String>] [-PrivacyProfileContactEmail <String>] [-PrivacyProfileStatementUrl <String>]
