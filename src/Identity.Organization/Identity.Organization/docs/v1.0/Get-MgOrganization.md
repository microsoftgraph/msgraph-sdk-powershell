...
### List1 (Default)
```
Get-MgOrganization [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity1
```
Get-MgOrganization -InputObject <IIdentityOrganizationIdentity> [-ExpandProperty <String[]>]
