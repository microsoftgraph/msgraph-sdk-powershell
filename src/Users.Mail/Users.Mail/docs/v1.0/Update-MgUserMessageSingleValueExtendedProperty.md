...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/update-mgusermessagesinglevalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserMessageSingleValueExtendedProperty -InputObject <IUsersMailIdentity> [-Id <String>]
