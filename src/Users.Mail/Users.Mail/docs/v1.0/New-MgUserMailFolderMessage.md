...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/new-mgusermailfoldermessage
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessage>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> [-Attachments <IMicrosoftGraphAttachment[]>]
