...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mguserinferenceclassification
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserInferenceClassification -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
