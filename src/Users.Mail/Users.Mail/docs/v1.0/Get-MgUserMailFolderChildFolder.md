...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfolderchildfolder
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserMailFolderChildFolder -MailFolderId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgUserMailFolderChildFolder -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
