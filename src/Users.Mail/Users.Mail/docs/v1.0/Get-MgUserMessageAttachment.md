...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermessageattachment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMessageAttachment -MessageId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserMessageAttachment -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
