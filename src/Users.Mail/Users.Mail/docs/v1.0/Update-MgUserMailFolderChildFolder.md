...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/update-mgusermailfolderchildfolder
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserMailFolderChildFolder -InputObject <IUsersMailIdentity>
 -BodyParameter <IMicrosoftGraphMailFolder1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserMailFolderChildFolder -InputObject <IUsersMailIdentity> [-ChildFolderCount <Int32>]
