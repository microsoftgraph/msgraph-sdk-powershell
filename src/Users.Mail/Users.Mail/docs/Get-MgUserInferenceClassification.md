...
### Get (Default)
```
Get-MgUserInferenceClassification -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInferenceClassification -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
