...
### List (Default)
```
Get-MgUserMessageExtension -MessageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserMessageExtension -ExtensionId <String> -MessageId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserMessageExtension -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
