...
### List (Default)
```
Get-MgUserMailFolderMessage -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserMailFolderMessage -MailFolderId <String> -MessageId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
