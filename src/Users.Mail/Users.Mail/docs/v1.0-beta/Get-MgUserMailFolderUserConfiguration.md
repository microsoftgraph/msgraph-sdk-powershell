...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfolderuserconfiguration
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMailFolderUserConfiguration -MailFolderId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserMailFolderUserConfiguration -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
