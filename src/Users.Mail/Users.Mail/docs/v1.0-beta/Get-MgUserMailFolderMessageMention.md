...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermessagemention
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserMailFolderMessageMention -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
