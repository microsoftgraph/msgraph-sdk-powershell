...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermessage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
