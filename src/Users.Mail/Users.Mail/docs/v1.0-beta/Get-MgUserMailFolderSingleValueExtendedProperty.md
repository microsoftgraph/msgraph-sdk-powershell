...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldersinglevalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserMailFolderSingleValueExtendedProperty -MailFolderId <String> -UserId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgUserMailFolderSingleValueExtendedProperty -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
