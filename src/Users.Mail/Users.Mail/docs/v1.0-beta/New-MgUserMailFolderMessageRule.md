...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/new-mgusermailfoldermessagerule
schema: 2.0.0
---
...
```
New-MgUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-ActionAssignCategories <String[]>]
...
### CreateViaIdentity
```
New-MgUserMailFolderMessageRule -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessageRule>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserMailFolderMessageRule -InputObject <IUsersMailIdentity> [-ActionAssignCategories <String[]>]
 [-ActionCopyToFolder <String>] [-ActionDelete] [-ActionForwardAsAttachmentTo <IMicrosoftGraphRecipient[]>]
 [-ActionForwardTo <IMicrosoftGraphRecipient[]>] [-ActionMarkAsRead] [-ActionMarkImportance <String>]
 [-ActionMoveToFolder <String>] [-ActionPermanentDelete] [-ActionRedirectTo <IMicrosoftGraphRecipient[]>]
 [-ActionStopProcessingRules] [-Conditions <IMicrosoftGraphMessageRulePredicates>] [-DisplayName <String>]
