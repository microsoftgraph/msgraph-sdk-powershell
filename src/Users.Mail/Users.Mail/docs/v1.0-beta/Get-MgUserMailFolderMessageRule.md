...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermessagerule
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserMailFolderMessageRule -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
