...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/new-mgusermailfoldermessagemention
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserMailFolderMessageMention -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMention>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserMailFolderMessageMention -InputObject <IUsersMailIdentity> [-Application <String>]
