...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/update-mgusermailfoldermessage
schema: 2.0.0
---
...
Update-MgUserMailFolderMessage -MailFolderId <String> -MessageId <String> -UserId <String>
 ...
 [-Extensions <IMicrosoftGraphExtension[]>] [-FlagStatus <String>] [-From <IMicrosoftGraphRecipient>]
 [-HasAttachments] [-Id <String>] [-Importance <String>] [-InferenceClassification <String>]
...
### UpdateViaIdentity
```
Update-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> -BodyParameter <IMicrosoftGraphMessage1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserMailFolderMessage -InputObject <IUsersMailIdentity> [-Attachments <IMicrosoftGraphAttachment[]>]
