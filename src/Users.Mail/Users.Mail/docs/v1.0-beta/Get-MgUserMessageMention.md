...
### List (Default)
```
Get-MgUserMessageMention -MessageId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserMessageMention -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
