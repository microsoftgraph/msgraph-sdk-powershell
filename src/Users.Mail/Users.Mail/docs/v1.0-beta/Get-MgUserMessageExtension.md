...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermessageextension
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserMessageExtension -InputObject <IUsersMailIdentity> [-ExpandProperty <String[]>]
