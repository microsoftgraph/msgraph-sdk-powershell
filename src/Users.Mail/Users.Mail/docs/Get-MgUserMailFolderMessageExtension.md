...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermessageextension
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserMailFolderMessageExtension -InputObject <IUsersMailIdentity> [-Expand <String[]>]
