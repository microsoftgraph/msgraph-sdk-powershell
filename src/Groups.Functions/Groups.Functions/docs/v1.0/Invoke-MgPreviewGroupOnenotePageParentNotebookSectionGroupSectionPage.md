...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/invoke-mgpreviewgrouponenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
### Preview1 (Default)
```
Invoke-MgPreviewGroupOnenotePageParentNotebookSectionGroupSectionPage -GroupId <String>
 -OnenotePageId <String> -OnenotePageId1 <String> -OnenoteSectionId <String> -SectionGroupId <String>
 [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewGroupOnenotePageParentNotebookSectionGroupSectionPage -InputObject <IGroupsFunctionsIdentity>
 [<CommonParameters>]
```
