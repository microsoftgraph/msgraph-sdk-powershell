...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/invoke-mgpreviewgrouponenotenotebooksectiongroupsectionpage
schema: 2.0.0
---
...
Invoke-MgPreviewGroupOnenoteNotebookSectionGroupSectionPage -GroupId <String> -NotebookId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> -SectionGroupId <String> [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewGroupOnenoteNotebookSectionGroupSectionPage -InputObject <IGroupsFunctionsIdentity>
 [<CommonParameters>]
```
