...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/get-mggroupeventdelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgGroupEventDelta -InputObject <IGroupsFunctionsIdentity> [<CommonParameters>]
```
