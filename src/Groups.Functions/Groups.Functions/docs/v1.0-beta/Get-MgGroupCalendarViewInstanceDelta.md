...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/get-mggroupcalendarviewinstancedelta
schema: 2.0.0
---

# Get-MgGroupCalendarViewInstanceDelta
...
### Delta (Default)
```
Get-MgGroupCalendarViewInstanceDelta -EventId <String> -GroupId <String> [<CommonParameters>]
```
...
### DeltaViaIdentity
```
Get-MgGroupCalendarViewInstanceDelta -InputObject <IGroupsFunctionsIdentity> [<CommonParameters>]
```
