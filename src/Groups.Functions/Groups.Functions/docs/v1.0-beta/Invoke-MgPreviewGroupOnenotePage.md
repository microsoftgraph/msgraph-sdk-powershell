...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/invoke-mgpreviewgrouponenotepage
schema: 2.0.0
---
...
### PreviewViaIdentity
```
Invoke-MgPreviewGroupOnenotePage -InputObject <IGroupsFunctionsIdentity> [<CommonParameters>]
```
