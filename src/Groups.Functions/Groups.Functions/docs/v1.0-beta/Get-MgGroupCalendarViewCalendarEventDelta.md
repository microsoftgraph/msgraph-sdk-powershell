...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/get-mggroupcalendarviewcalendareventdelta
schema: 2.0.0
---
...
### Delta1 (Default)
```
Get-MgGroupCalendarViewCalendarEventDelta -EventId <String> -GroupId <String> [<CommonParameters>]
```

### DeltaViaIdentity1
```
Get-MgGroupCalendarViewCalendarEventDelta -InputObject <IGroupsFunctionsIdentity> [<CommonParameters>]
```
