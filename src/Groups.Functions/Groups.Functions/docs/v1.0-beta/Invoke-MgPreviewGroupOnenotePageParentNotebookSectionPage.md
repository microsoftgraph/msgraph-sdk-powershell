...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.functions/invoke-mgpreviewgrouponenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### Preview (Default)
```
Invoke-MgPreviewGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
 -OnenotePageId1 <String> -OnenoteSectionId <String> [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewGroupOnenotePageParentNotebookSectionPage -InputObject <IGroupsFunctionsIdentity>
 [<CommonParameters>]
```
