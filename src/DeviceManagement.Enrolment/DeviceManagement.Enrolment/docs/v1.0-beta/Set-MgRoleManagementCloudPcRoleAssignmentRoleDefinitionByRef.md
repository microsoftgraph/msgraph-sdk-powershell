...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagementcloudpcroleassignmentroledefinitionbyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgRoleManagementCloudPcRoleAssignmentRoleDefinitionByRef -UnifiedRoleAssignmentMultipleId <String>
...
### SetViaIdentity
```
Set-MgRoleManagementCloudPcRoleAssignmentRoleDefinitionByRef -InputObject <IDeviceManagementEnrolmentIdentity>
 -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
