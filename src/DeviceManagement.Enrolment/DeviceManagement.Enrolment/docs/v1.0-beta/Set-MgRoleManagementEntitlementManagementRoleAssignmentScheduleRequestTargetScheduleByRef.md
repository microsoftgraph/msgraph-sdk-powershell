...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentschedulerequesttargetschedulebyref
schema: 2.0.0
---
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleRequestTargetScheduleByRef
 -UnifiedRoleAssignmentScheduleRequestId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm]
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleRequestTargetScheduleByRef
 -UnifiedRoleAssignmentScheduleRequestId <String> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
