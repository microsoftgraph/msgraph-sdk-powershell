...
### Get
```
Get-MgRoleManagementDeviceManagementRoleAssignmentPrincipal -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgRoleManagementDeviceManagementRoleAssignmentPrincipal -InputObject <IDeviceManagementEnrolmentIdentity>
