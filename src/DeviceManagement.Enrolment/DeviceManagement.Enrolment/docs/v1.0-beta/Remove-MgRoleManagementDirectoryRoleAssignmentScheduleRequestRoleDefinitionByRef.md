...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectoryroleassignmentschedulerequestroledefinitionbyref
schema: 2.0.0
---
...
```
Remove-MgRoleManagementDirectoryRoleAssignmentScheduleRequestRoleDefinitionByRef
 -UnifiedRoleAssignmentScheduleRequestId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
