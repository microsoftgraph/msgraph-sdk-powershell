...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementcloudpcroleassignmentroledefinitionbyref
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgRoleManagementCloudPcRoleAssignmentRoleDefinitionByRef -UnifiedRoleAssignmentMultipleId <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgRoleManagementCloudPcRoleAssignmentRoleDefinitionByRef -InputObject <IDeviceManagementEnrolmentIdentity>
 [<CommonParameters>]
```
