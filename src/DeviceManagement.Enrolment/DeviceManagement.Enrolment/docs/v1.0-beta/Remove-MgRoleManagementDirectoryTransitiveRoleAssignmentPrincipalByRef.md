...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectorytransitiveroleassignmentprincipalbyref
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryTransitiveRoleAssignmentPrincipalByRef
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryTransitiveRoleAssignmentPrincipalByRef -UnifiedRoleAssignmentId <String>
