...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementcloudpcroledefinitioninheritpermissionfrom
schema: 2.0.0
---
...
### List (Default)
```
Get-MgRoleManagementCloudPcRoleDefinitionInheritPermissionFrom -UnifiedRoleDefinitionId <String> [-Count]
...
### Get
```
Get-MgRoleManagementCloudPcRoleDefinitionInheritPermissionFrom -UnifiedRoleDefinitionId <String>
