...
```
New-MgRoleManagementEntitlementManagementRoleEligibilitySchedule
 -BodyParameter <IMicrosoftGraphUnifiedRoleEligibilitySchedule1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
This example shows how to use the New-MgRoleManagementEntitlementManagementRoleEligibilitySchedule Cmdlet.
...
BODYPARAMETER <IMicrosoftGraphUnifiedRoleEligibilitySchedule1>: unifiedRoleEligibilitySchedule
  - `[(Any) <Object>]`: This indicates any property can be added to this object.
  - `[AppScope <IMicrosoftGraphAppScope>]`: appScope
    - `[(Any) <Object>]`: This indicates any property can be added to this object.
    - `[Id <String>]`: The unique idenfier for an entity. Read-only.
