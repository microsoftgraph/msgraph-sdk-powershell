...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectorytransitiveroleassignmentdirectoryscopebyref
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryTransitiveRoleAssignmentDirectoryScopeByRef
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryTransitiveRoleAssignmentDirectoryScopeByRef -UnifiedRoleAssignmentId <String>
