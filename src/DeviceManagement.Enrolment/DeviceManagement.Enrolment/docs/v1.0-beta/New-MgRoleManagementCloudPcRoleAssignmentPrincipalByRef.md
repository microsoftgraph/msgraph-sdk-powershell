...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/new-mgrolemanagementcloudpcroleassignmentprincipalbyref
schema: 2.0.0
---
...
```
New-MgRoleManagementCloudPcRoleAssignmentPrincipalByRef -UnifiedRoleAssignmentMultipleId <String>
...
### CreateViaIdentity
```
New-MgRoleManagementCloudPcRoleAssignmentPrincipalByRef -InputObject <IDeviceManagementEnrolmentIdentity>
 -BodyParameter <Hashtable> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IPathsJ502MqRolemanagementCloudpcRoleassignmentsUnifiedroleassignmentmultipleIdPrincipalsRefPostResponses201ContentApplicationJsonSchema
