...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementcloudpcroleassignmentappscope
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgRoleManagementCloudPcRoleAssignmentAppScope -AppScopeId <String>
...
### DeleteViaIdentity
```
Remove-MgRoleManagementCloudPcRoleAssignmentAppScope -InputObject <IDeviceManagementEnrolmentIdentity>
