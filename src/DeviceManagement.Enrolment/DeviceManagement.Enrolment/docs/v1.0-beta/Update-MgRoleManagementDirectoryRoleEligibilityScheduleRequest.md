...
Update-MgRoleManagementDirectoryRoleEligibilityScheduleRequest
 ...
 -BodyParameter <IMicrosoftGraphUnifiedRoleEligibilityScheduleRequest1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
