...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementexchangetransitiveroleassignmentdirectoryscope
schema: 2.0.0
---

# Get-MgRoleManagementExchangeTransitiveRoleAssignmentDirectoryScope
...
### Get (Default)
```
Get-MgRoleManagementExchangeTransitiveRoleAssignmentDirectoryScope -UnifiedRoleAssignmentId <String>
