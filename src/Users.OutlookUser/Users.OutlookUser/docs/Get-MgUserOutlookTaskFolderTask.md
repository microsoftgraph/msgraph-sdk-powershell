...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/get-mguseroutlooktaskfoldertask
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOutlookTaskFolderTask -OutlookTaskFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOutlookTaskFolderTask -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>]
