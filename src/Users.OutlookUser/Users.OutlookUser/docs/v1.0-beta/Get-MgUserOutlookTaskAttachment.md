...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/get-mguseroutlooktaskattachment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOutlookTaskAttachment -InputObject <IUsersOutlookUserIdentity> [-ExpandProperty <String[]>]
