...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/update-mguseroutlooktaskgrouptaskfoldertask
schema: 2.0.0
---
...
Update-MgUserOutlookTaskGroupTaskFolderTask -OutlookTaskFolderId <String> -OutlookTaskGroupId <String>
 -OutlookTaskId <String> -UserId <String> [-AssignedTo <String>] [-Attachments <IMicrosoftGraphAttachment[]>]
 [-BodyContent <String>] [-BodyContentType <String>] [-Categories <String[]>] [-ChangeKey <String>]
...
### UpdateViaIdentity
```
Update-MgUserOutlookTaskGroupTaskFolderTask -InputObject <IUsersOutlookUserIdentity>
 -BodyParameter <IMicrosoftGraphOutlookTask> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserOutlookTaskGroupTaskFolderTask -InputObject <IUsersOutlookUserIdentity> [-AssignedTo <String>]
