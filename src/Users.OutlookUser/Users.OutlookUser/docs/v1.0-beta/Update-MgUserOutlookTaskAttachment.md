...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/update-mguseroutlooktaskattachment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserOutlookTaskAttachment -InputObject <IUsersOutlookUserIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserOutlookTaskAttachment -InputObject <IUsersOutlookUserIdentity> [-ContentType <String>]
