...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/new-mguseroutlooktaskgrouptaskfoldertaskattachment
schema: 2.0.0
---
...
New-MgUserOutlookTaskGroupTaskFolderTaskAttachment -OutlookTaskFolderId <String> -OutlookTaskGroupId <String>
 -OutlookTaskId <String> -UserId <String> [-ContentType <String>] [-Id <String>] [-IsInline]
...
### CreateViaIdentity
```
New-MgUserOutlookTaskGroupTaskFolderTaskAttachment -InputObject <IUsersOutlookUserIdentity>
