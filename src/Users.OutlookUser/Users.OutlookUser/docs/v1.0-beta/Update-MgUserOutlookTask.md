...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/update-mguseroutlooktask
schema: 2.0.0
---
...
```
Update-MgUserOutlookTask -OutlookTaskId <String> -UserId <String> [-AssignedTo <String>]
...
### UpdateViaIdentity
```
Update-MgUserOutlookTask -InputObject <IUsersOutlookUserIdentity> -BodyParameter <IMicrosoftGraphOutlookTask>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserOutlookTask -InputObject <IUsersOutlookUserIdentity> [-AssignedTo <String>]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-BodyContent <String>] [-BodyContentType <String>]
 [-Categories <String[]>] [-ChangeKey <String>] [-CompletedDateTimeDateTime <String>]
 [-CompletedDateTimeZone <String>] [-CreatedDateTime <DateTime>] [-DueDateTimeDateTime <String>]
 [-DueDateTimeZone <String>] [-HasAttachments] [-Id <String>] [-Importance <String>] [-IsReminderOn]
