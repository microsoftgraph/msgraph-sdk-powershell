...
### List (Default)
```
Get-MgUserOutlookTaskGroup -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserOutlookTaskGroup -InputObject <IUsersOutlookUserIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
