...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/get-mguseroutlooktaskgroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOutlookTaskGroup -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserOutlookTaskGroup -OutlookTaskGroupId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOutlookTaskGroup -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
