...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/get-mguseroutlooktaskfolder
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOutlookTaskFolder -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserOutlookTaskFolder -OutlookTaskFolderId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOutlookTaskFolder -InputObject <IUsersOutlookUserIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
