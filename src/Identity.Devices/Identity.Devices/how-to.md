# How-To
This document describes how to develop for `Microsoft.Graph.Identity.Devices`.

## Building `Microsoft.Graph.Identity.Devices`
...
## Testing `Microsoft.Graph.Identity.Devices`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Identity.Devices` into the session.
