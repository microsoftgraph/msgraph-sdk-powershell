...
### List1 (Default)
```
Get-MgDeviceExtension -DeviceId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceExtension -InputObject <IIdentityDevicesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
