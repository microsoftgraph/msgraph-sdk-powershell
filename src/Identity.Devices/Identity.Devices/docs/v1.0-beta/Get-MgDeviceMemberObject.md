...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.devices/get-mgdevicememberobject
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceMemberObject -DeviceId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgDeviceMemberObject -InputObject <IIdentityDevicesIdentity>
 -BodyParameter <IPaths1QbmtipDevicesDeviceIdMicrosoftGraphGetmemberobjectsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgDeviceMemberObject -InputObject <IIdentityDevicesIdentity> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
