...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.devices/test-mgdeviceproperty
schema: 2.0.0
---
...
```
Test-MgDeviceProperty [-DisplayName <String>] [-EntityType <String>] [-MailNickname <String>]
