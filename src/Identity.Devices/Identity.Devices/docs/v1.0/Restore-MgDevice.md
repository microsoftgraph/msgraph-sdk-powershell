...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.devices/restore-mgdevice
schema: 2.0.0
---
...
### RestoreViaIdentity1
```
Restore-MgDevice -InputObject <IIdentityDevicesIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
