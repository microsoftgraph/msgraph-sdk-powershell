...
### List (Default)
```
Get-MgDeviceRegisteredOwner -DeviceId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDeviceRegisteredOwner -DeviceId <String> -DirectoryObjectId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceRegisteredOwner -InputObject <IIdentityDevicesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
