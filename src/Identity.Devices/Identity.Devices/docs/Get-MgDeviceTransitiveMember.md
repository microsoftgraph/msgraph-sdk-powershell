...
### List (Default)
```
Get-MgDeviceTransitiveMember -DeviceId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDeviceTransitiveMember -DeviceId <String> -DirectoryObjectId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceTransitiveMember -InputObject <IIdentityDevicesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
