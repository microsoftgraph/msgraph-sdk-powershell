...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerrecentplan
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserPlannerRecentPlan -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserPlannerRecentPlan -PlannerPlanId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPlannerRecentPlan -InputObject <IUsersPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
