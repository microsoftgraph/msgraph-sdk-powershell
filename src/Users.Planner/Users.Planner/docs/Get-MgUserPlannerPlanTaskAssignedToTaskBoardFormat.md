...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplantaskassignedtotaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanTaskAssignedToTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-Expand <String[]>]
