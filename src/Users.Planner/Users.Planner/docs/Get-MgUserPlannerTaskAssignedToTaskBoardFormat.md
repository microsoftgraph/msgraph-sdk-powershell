...
### Get (Default)
```
Get-MgUserPlannerTaskAssignedToTaskBoardFormat -PlannerTaskId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPlannerTaskAssignedToTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
