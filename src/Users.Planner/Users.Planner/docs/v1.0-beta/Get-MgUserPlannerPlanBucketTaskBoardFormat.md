...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplanbuckettaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanBucketTaskBoardFormat -InputObject <IUsersPlannerIdentity> [-ExpandProperty <String[]>]
