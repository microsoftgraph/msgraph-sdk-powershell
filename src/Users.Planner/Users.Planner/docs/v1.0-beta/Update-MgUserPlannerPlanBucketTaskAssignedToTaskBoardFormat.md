...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/update-mguserplannerplanbuckettaskassignedtotaskboardformat
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserPlannerPlanBucketTaskAssignedToTaskBoardFormat -InputObject <IUsersPlannerIdentity>
