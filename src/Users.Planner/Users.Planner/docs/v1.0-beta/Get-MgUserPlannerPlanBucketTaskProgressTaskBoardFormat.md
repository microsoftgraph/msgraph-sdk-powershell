...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplanbuckettaskprogresstaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanBucketTaskProgressTaskBoardFormat -InputObject <IUsersPlannerIdentity>
