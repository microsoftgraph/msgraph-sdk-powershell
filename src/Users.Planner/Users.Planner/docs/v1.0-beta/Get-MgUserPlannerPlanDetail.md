...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplandetail
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanDetail -InputObject <IUsersPlannerIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
