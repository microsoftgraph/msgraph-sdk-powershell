...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannertaskassignedtotaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerTaskAssignedToTaskBoardFormat -InputObject <IUsersPlannerIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
