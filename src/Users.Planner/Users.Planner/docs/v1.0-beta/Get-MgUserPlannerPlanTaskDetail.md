...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplantaskdetail
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserPlannerPlanTaskDetail -InputObject <IUsersPlannerIdentity> [-ExpandProperty <String[]>]
