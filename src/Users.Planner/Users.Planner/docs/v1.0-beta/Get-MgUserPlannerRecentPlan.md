...
### List (Default)
```
Get-MgUserPlannerRecentPlan -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserPlannerRecentPlan -InputObject <IUsersPlannerIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
