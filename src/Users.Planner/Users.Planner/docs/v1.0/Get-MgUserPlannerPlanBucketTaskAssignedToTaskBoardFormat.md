...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplanbuckettaskassignedtotaskboardformat
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserPlannerPlanBucketTaskAssignedToTaskBoardFormat -InputObject <IUsersPlannerIdentity>
