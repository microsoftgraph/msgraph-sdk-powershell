...
```
Update-MgUserPlanner -UserId <String> [-Id <String>] [-Plans <IMicrosoftGraphPlannerPlan1[]>]
...
### UpdateViaIdentity2
```
Update-MgUserPlanner -InputObject <IUsersPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerUser1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded2
```
Update-MgUserPlanner -InputObject <IUsersPlannerIdentity> [-Id <String>]
