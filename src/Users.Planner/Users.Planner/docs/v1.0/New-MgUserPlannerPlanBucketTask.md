...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/new-mguserplannerplanbuckettask
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserPlannerPlanBucketTask -InputObject <IUsersPlannerIdentity>
 -BodyParameter <IMicrosoftGraphPlannerTask1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserPlannerPlanBucketTask -InputObject <IUsersPlannerIdentity> [-ActiveChecklistItemCount <Int32>]
