...
### List (Default)
```
Get-MgDirectorySettingTemplate [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgDirectorySettingTemplate -InputObject <IIdentityDirectorySettingTemplatesIdentity>
