...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchatmember
schema: 2.0.0
---
...
### List (Default)
```
Get-MgChatMember -ChatId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgChatMember -ChatId <String> -ConversationMemberId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgChatMember -InputObject <ITeamsChatsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
