...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.approleassignments/get-mgapproleassignmentapproleassignmentapproleassignment
schema: 2.0.0
---

# Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment
...
### List (Default)
```
Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment -AppRoleAssignmentId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAppRoleAssignmentAppRoleAssignmentAppRoleAssignment -InputObject <IIdentityAppRoleAssignmentsIdentity>
