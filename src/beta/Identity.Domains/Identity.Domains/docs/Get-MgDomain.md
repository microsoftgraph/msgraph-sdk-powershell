...
### List (Default)
```
Get-MgDomain [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgDomain -DomainId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDomain -InputObject <IIdentityDomainsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
