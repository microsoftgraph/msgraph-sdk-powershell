...
### List (Default)
```
Get-MgPlannerBucket [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>] [-Search <String>]
 [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgPlannerBucket -PlannerBucketId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlannerBucket -InputObject <IPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
