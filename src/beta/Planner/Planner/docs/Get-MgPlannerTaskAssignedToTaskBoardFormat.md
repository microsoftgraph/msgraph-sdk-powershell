...
### Get (Default)
```
Get-MgPlannerTaskAssignedToTaskBoardFormat -PlannerTaskId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPlannerTaskAssignedToTaskBoardFormat -InputObject <IPlannerIdentity> [-Expand <String[]>]
