...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannerplanbucket
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserPlannerPlanBucket -PlannerPlanId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserPlannerPlanBucket -InputObject <IUsersPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
