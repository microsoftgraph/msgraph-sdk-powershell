...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.planner/get-mguserplannertaskdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserPlannerTaskDetail -PlannerTaskId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPlannerTaskDetail -InputObject <IUsersPlannerIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
