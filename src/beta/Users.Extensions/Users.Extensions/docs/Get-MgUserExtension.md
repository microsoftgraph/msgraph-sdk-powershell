...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.extensions/get-mguserextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserExtension -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgUserExtension -ExtensionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserExtension -InputObject <IUsersExtensionsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
