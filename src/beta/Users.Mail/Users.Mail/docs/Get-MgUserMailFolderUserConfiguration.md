...
### List (Default)
```
Get-MgUserMailFolderUserConfiguration -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserMailFolderUserConfiguration -InputObject <IUsersMailIdentity> [-Expand <String[]>]
