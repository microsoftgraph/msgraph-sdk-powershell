...
### List (Default)
```
Get-MgUserMailFolderChildFolder -MailFolderId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserMailFolderChildFolder -InputObject <IUsersMailIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
