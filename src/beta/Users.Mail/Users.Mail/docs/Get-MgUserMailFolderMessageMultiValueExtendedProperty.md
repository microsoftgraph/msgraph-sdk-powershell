...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.mail/get-mgusermailfoldermessagemultivalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserMailFolderMessageMultiValueExtendedProperty -InputObject <IUsersMailIdentity> [-Expand <String[]>]
