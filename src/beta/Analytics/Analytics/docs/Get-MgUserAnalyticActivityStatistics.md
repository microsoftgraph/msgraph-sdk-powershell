...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.analytics/get-mguseranalyticactivitystatistics
schema: 2.0.0
---

# Get-MgUserAnalyticActivityStatistics
...
### List (Default)
```
Get-MgUserAnalyticActivityStatistics -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserAnalyticActivityStatistics -ActivityStatisticsId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserAnalyticActivityStatistics -InputObject <IAnalyticsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
