...
### List (Default)
```
Get-MgActivitystatisticActivityStatistics [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgActivitystatisticActivityStatistics -ActivityStatisticsId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgActivitystatisticActivityStatistics -InputObject <IAnalyticsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
