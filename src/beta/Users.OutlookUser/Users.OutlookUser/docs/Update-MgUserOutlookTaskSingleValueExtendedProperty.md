...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.outlookuser/update-mguseroutlooktasksinglevalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserOutlookTaskSingleValueExtendedProperty -InputObject <IUsersOutlookUserIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserOutlookTaskSingleValueExtendedProperty -InputObject <IUsersOutlookUserIdentity> [-Id <String>]
