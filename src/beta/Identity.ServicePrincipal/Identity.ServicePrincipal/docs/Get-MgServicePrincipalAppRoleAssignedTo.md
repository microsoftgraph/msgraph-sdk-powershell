...
### List (Default)
```
Get-MgServicePrincipalAppRoleAssignedTo -ServicePrincipalId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgServicePrincipalAppRoleAssignedTo -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
