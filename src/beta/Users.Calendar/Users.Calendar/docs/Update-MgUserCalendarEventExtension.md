...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/update-mgusercalendareventextension
schema: 2.0.0
---
...
```
Update-MgUserCalendarEventExtension -EventId <String> -ExtensionId <String> -UserId <String> [-Id <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgUserCalendarEventExtension -CalendarId <String> -EventId <String> -ExtensionId <String>
...
### Update1
```
Update-MgUserCalendarEventExtension -EventId <String> -ExtensionId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUserCalendarEventExtension -InputObject <IUsersCalendarIdentity>
 -BodyParameter <IMicrosoftGraphExtension> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarEventExtension -InputObject <IUsersCalendarIdentity> [-Id <String>] [-PassThru]
