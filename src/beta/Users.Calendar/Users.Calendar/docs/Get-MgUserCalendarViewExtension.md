...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/get-mgusercalendarviewextension
schema: 2.0.0
---

# Get-MgUserCalendarViewExtension
...
### List1 (Default)
```
Get-MgUserCalendarViewExtension -EventId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserCalendarViewExtension -CalendarId <String> -EventId <String> -ExtensionId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgUserCalendarViewExtension -EventId <String> -ExtensionId <String> -UserId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserCalendarViewExtension -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List
```
Get-MgUserCalendarViewExtension -CalendarId <String> -EventId <String> -UserId <String> [-Count]
