...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/get-mgusercalendargroupcalendarviewsinglevalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserCalendarGroupCalendarViewSingleValueExtendedProperty -CalendarGroupId <String> -CalendarId <String>
...
```
Get-MgUserCalendarGroupCalendarViewSingleValueExtendedProperty -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -SingleValueLegacyExtendedPropertyId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarViewSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity>
