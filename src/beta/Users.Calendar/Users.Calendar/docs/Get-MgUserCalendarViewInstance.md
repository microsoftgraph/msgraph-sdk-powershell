...
### List1 (Default)
```
Get-MgUserCalendarViewInstance -EventId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get1
```
Get-MgUserCalendarViewInstance -EventId <String> -EventId1 <String> -UserId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserCalendarViewInstance -InputObject <IUsersCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
