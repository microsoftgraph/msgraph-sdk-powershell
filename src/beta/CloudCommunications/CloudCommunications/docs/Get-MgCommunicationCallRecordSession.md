...
### List (Default)
```
Get-MgCommunicationCallRecordSession -CallRecordId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgCommunicationCallRecordSession -CallRecordId <String> -SessionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgCommunicationCallRecordSession -InputObject <ICloudCommunicationsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
