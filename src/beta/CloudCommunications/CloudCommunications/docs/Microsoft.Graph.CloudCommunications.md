...
Module Guid: ec35a124-6807-4a2e-a3dc-446c887d677d
...
### [Get-MgCommunicationCallRecordSessionSegment](Get-MgCommunicationCallRecordSessionSegment.md)
Get segments from communications

### [Get-MgCommunicationCloudCommunication](Get-MgCommunicationCloudCommunication.md)
Get communications
...
### [New-MgCommunicationCallRecord](New-MgCommunicationCallRecord.md)
Create new navigation property to callRecords for communications

### [New-MgCommunicationCallRecordSession](New-MgCommunicationCallRecordSession.md)
Create new navigation property to sessions for communications

### [New-MgCommunicationCallRecordSessionSegment](New-MgCommunicationCallRecordSessionSegment.md)
...
### [Update-MgCommunicationCall](Update-MgCommunicationCall.md)
...
### [Update-MgCommunicationCallRecord](Update-MgCommunicationCallRecord.md)
...
### [Update-MgCommunicationCallRecordSessionSegment](Update-MgCommunicationCallRecordSessionSegment.md)
Update the navigation property segments in communications

### [Update-MgCommunicationCloudCommunication](Update-MgCommunicationCloudCommunication.md)
