...
### List (Default)
```
Get-MgCommunicationCall [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgCommunicationCall -CallId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgCommunicationCall -InputObject <ICloudCommunicationsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
