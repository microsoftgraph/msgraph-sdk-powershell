...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannelmessagedelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgTeamPrimaryChannelMessageDelta -InputObject <ITeamsTeamIdentity> [<CommonParameters>]
```
