...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannelmessagereply
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamPrimaryChannelMessageReply -ChatMessageId <String> -TeamId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgTeamPrimaryChannelMessageReply -InputObject <ITeamsTeamIdentity> [-Expand <String[]>]
