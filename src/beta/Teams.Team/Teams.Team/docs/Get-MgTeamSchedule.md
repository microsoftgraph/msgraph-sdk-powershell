...
### Get (Default)
```
Get-MgTeamSchedule -TeamId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamSchedule -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
