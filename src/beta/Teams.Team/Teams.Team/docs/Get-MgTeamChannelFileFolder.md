...
### Get (Default)
```
Get-MgTeamChannelFileFolder -ChannelId <String> -TeamId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamChannelFileFolder -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
