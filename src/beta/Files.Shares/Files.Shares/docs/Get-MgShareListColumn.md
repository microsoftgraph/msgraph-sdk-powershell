...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistcolumn
schema: 2.0.0
---
...
### List (Default)
```
Get-MgShareListColumn -SharedDriveItemId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgShareListColumn -ColumnDefinitionId <String> -SharedDriveItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListColumn -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
