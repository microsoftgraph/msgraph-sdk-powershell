...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.shares/get-mgsharelistitemversionfield
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgShareListItemVersionField -ListItemVersionId <String> -SharedDriveItemId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgShareListItemVersionField -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
