...
### List (Default)
```
Get-MgShareListActivity -SharedDriveItemId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgShareListActivity -ItemActivityOldId <String> -SharedDriveItemId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListActivity -InputObject <IFilesSharesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
