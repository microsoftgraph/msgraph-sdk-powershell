...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.administrativeunits/get-mgadministrativeunitextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgAdministrativeUnitExtension -AdministrativeUnitId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgAdministrativeUnitExtension -AdministrativeUnitId <String> -ExtensionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAdministrativeUnitExtension -InputObject <IIdentityAdministrativeUnitsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
