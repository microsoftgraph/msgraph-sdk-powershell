...
### List (Default)
```
Get-MgAdministrativeUnitMember -AdministrativeUnitId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgAdministrativeUnitMember -AdministrativeUnitId <String> -DirectoryObjectId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAdministrativeUnitMember -InputObject <IIdentityAdministrativeUnitsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
