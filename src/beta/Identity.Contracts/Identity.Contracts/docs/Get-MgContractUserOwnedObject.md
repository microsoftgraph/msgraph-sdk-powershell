...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.contracts/get-mgcontractuserownedobject
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgContractUserOwnedObject [-Type <String>] [-UserId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
