...
### List (Default)
```
Get-MgExternalConnection [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgExternalConnection -ExternalConnectionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgExternalConnection -InputObject <ISearchIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
