...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.site/new-mgsitecontenttype
schema: 2.0.0
---
...
```
New-MgSiteContentType -SiteId <String> [-ColumnLinks <IMicrosoftGraphColumnLink[]>] [-Description <String>]
...
### CreateViaIdentity
```
New-MgSiteContentType -InputObject <ISitesSiteIdentity> -BodyParameter <IMicrosoftGraphContentType> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteContentType -InputObject <ISitesSiteIdentity> [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
