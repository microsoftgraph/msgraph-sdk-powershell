...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.site/get-mgsitecolumn
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteColumn -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSiteColumn -ColumnDefinitionId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteColumn -InputObject <ISitesSiteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
