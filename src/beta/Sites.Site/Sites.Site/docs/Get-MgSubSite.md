...
### List1 (Default)
```
Get-MgSubSite -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get1
```
Get-MgSubSite -SiteId <String> -SiteId1 <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgSubSite -InputObject <ISitesSiteIdentity> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
