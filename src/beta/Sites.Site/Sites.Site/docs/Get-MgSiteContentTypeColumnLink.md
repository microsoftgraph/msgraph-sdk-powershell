...
### List (Default)
```
Get-MgSiteContentTypeColumnLink -ContentTypeId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgSiteContentTypeColumnLink -InputObject <ISitesSiteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
