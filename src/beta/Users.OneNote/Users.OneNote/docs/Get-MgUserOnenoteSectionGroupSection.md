...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroupSection -SectionGroupId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgUserOnenoteSectionGroupSection -OnenoteSectionId <String> -SectionGroupId <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSection -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
