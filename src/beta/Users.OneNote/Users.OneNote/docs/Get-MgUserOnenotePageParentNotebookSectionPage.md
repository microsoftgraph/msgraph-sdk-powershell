...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### Get
```
Get-MgUserOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenotePageId1 <String>
 -OnenoteSectionId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionPage -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
