...
### Get (Default)
```
Get-MgUserOnenoteSectionGroupParentSectionGroup -SectionGroupId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupParentSectionGroup -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
