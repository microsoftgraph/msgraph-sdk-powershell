...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.onenote/get-mguseronenotesectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionGroup -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserOnenoteSectionGroup -SectionGroupId <String> -UserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgUserOnenoteSectionGroup -SectionGroupId <String> -SectionGroupId1 <String> -UserId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionGroup -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgUserOnenoteSectionGroup -SectionGroupId <String> -UserId <String> [-Count] [-Expand <String[]>]
