...
### List (Default)
```
Get-MgUserOnenotePageParentSectionPage -OnenotePageId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionPage -InputObject <IUsersOneNoteIdentity> [-Expand <String[]>]
