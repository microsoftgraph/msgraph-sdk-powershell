...
### List (Default)
```
Get-MgGroupEventSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
