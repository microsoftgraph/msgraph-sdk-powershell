...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarviewmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupCalendarViewMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
...
```
Update-MgGroupCalendarViewMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
