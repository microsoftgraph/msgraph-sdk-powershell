...
### Get (Default)
```
Get-MgGroupCalendarEventCalendar -EventId <String> -GroupId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarEventCalendar -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
