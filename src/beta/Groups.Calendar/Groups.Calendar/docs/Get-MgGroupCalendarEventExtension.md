...
### List (Default)
```
Get-MgGroupCalendarEventExtension -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarEventExtension -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
