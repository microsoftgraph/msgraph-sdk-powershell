...
### List (Default)
```
Get-MgGroupEventExtension -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupEventExtension -EventId <String> -ExtensionId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventExtension -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
