...
### List (Default)
```
Get-MgGroupEventMultiValueExtendedProperty -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
