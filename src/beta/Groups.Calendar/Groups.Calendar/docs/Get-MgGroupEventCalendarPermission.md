...
### List (Default)
```
Get-MgGroupEventCalendarPermission -EventId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupEventCalendarPermission -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
