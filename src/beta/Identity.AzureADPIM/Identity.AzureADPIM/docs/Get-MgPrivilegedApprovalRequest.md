...
### Get (Default)
```
Get-MgPrivilegedApprovalRequest -PrivilegedApprovalId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrivilegedApprovalRequest -InputObject <IIdentityAzureAdpimIdentity> [-Expand <String[]>]
