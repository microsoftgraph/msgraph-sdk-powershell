...
### List (Default)
```
Get-MgPrivilegedRoleAssignmentPrivilegedRoleAssignmentPrivilegedRoleAssignment [-Count] [-Expand <String[]>]
...
```
Get-MgPrivilegedRoleAssignmentPrivilegedRoleAssignmentPrivilegedRoleAssignment
 -PrivilegedRoleAssignmentId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
