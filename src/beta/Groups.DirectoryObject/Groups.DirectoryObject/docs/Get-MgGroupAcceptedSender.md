...
### List (Default)
```
Get-MgGroupAcceptedSender -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupAcceptedSender -DirectoryObjectId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupAcceptedSender -InputObject <IGroupsDirectoryObjectIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
