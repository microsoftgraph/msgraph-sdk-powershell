...
### List2 (Default)
```
Get-MgGroupMemberWithLicenseError -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupMemberWithLicenseError -DirectoryObjectId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupMemberWithLicenseError -InputObject <IGroupsDirectoryObjectIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
