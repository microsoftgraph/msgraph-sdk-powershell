...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.directoryobject/new-mggroupacceptedsender
schema: 2.0.0
---
...
```
New-MgGroupAcceptedSender -GroupId <String> [-DeletedDateTime <DateTime>] [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgGroupAcceptedSender -InputObject <IGroupsDirectoryObjectIdentity>
 -BodyParameter <IMicrosoftGraphDirectoryObject> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupAcceptedSender -InputObject <IGroupsDirectoryObjectIdentity> [-DeletedDateTime <DateTime>]
