...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.planner/update-mggroupplannerplantaskassignedtotaskboardformat
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupPlannerPlanTaskAssignedToTaskBoardFormat -InputObject <IGroupsPlannerIdentity>
...
```
Update-MgGroupPlannerPlanTaskAssignedToTaskBoardFormat -InputObject <IGroupsPlannerIdentity> [-Id <String>]
