...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteSectionParentNotebook -GroupId <String> -OnenoteSectionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteSectionParentNotebook -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
