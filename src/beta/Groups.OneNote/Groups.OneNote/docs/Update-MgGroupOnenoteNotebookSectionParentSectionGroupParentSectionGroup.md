...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupParentSectionGroup -GroupId <String>
 -NotebookId <String> -OnenoteSectionId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupParentSectionGroup -GroupId <String>
 -NotebookId <String> -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
