...
### Get (Default)
```
Get-MgGroupOnenoteSectionParentSectionGroup -GroupId <String> -OnenoteSectionId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
