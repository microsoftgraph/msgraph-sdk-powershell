...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupsectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupSectionPageParentNotebookSectionGroup -GroupId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> -SectionGroupId <String> -SectionGroupId1 <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupSectionPageParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
