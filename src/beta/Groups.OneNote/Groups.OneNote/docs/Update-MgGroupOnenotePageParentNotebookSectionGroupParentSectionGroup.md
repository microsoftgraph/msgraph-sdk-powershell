...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentNotebookSectionGroupParentSectionGroup -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenotePageParentNotebookSectionGroupParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
