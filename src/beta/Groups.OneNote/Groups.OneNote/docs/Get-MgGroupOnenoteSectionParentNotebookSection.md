...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupOnenoteSectionParentNotebookSection -GroupId <String> -OnenoteSectionId <String> [-Count]
...
### Get
```
Get-MgGroupOnenoteSectionParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteSectionParentNotebookSection -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
