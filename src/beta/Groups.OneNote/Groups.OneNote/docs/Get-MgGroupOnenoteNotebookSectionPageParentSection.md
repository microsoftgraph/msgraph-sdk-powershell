...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionPageParentSection -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionPageParentSection -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
