...
### List (Default)
```
Get-MgGroupOnenoteNotebookSection -GroupId <String> -NotebookId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSection -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>]
