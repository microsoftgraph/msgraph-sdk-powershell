...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionGroupSectionParentSectionGroup -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionGroupSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
