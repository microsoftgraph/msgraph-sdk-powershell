...
### Get (Default)
```
Get-MgFinancialCompanySaleOrderLineItem -CompanyId <String> -SalesOrderLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderLineItem -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
