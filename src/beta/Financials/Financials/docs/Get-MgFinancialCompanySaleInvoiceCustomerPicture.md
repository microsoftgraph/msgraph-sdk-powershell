...
### List (Default)
```
Get-MgFinancialCompanySaleInvoiceCustomerPicture -CompanyId <String> -SalesInvoiceId <String> [-Count]
...
Get-MgFinancialCompanySaleInvoiceCustomerPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoiceCustomerPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
