...
Update-MgFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> [-ContentInputFile <String>] [-ContentType <String>] [-Height <Int32>]
...
```
Update-MgFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceId <String> -PurchaseInvoiceLineId <String> [-ContentInputFile <String>]
