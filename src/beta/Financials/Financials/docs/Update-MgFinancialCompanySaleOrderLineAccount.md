...
```
Update-MgFinancialCompanySaleOrderLineAccount -CompanyId <String> -SalesOrderLineId <String> [-Blocked]
...
```
Update-MgFinancialCompanySaleOrderLineAccount -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> [-Blocked] [-Category <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleOrderLineAccount -InputObject <IFinancialsIdentity> [-Blocked]
 [-Category <String>] [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Number <String>] [-SubCategory <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
