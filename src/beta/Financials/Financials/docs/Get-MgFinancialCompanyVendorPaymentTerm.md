...
### Get (Default)
```
Get-MgFinancialCompanyVendorPaymentTerm -CompanyId <String> -VendorId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyVendorPaymentTerm -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
