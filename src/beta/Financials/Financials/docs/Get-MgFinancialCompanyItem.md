...
### List (Default)
```
Get-MgFinancialCompanyItem -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanyItem -CompanyId <String> -ItemId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyItem -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
