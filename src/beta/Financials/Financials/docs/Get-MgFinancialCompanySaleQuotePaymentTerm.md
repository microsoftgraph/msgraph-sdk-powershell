...
### Get (Default)
```
Get-MgFinancialCompanySaleQuotePaymentTerm -CompanyId <String> -SalesQuoteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleQuotePaymentTerm -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
