...
```
Update-MgFinancialCompanyUnit -CompanyId <String> -UnitOfMeasureId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyUnit -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
 [-Id <String>] [-InternationalStandardCode <String>] [-LastModifiedDateTime <DateTime>] [-PassThru]
