...
```
Update-MgFinancialCompanySaleQuoteLineItemCategory -CompanyId <String> -SalesQuoteId <String>
 -SalesQuoteLineId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleQuoteLineItemCategory -InputObject <IFinancialsIdentity> [-Code <String>]
