...
```
Update-MgFinancialCompanySaleOrderLineItem -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> [-BaseUnitOfMeasureId <String>] [-Blocked] [-Code <String>]
...
```
Update-MgFinancialCompanySaleOrderLineItem -InputObject <IFinancialsIdentity> [-BaseUnitOfMeasureId <String>]
