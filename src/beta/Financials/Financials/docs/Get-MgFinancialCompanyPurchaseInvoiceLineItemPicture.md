...
```
Get-MgFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceId <String> -PurchaseInvoiceLineId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyPurchaseInvoiceLineItemPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
...
Get-MgFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PurchaseInvoiceId <String>
 -PurchaseInvoiceLineId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
