...
### Get (Default)
```
Get-MgFinancialCompanySaleQuoteCurrency -CompanyId <String> -SalesQuoteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleQuoteCurrency -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
