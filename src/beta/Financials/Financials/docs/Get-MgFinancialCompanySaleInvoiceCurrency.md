...
### Get (Default)
```
Get-MgFinancialCompanySaleInvoiceCurrency -CompanyId <String> -SalesInvoiceId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoiceCurrency -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
