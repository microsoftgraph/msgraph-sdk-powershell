...
```
New-MgFinancialCompanySaleQuoteLineItemPicture -CompanyId <String> -SalesQuoteId <String>
 -SalesQuoteLineId <String> [-ContentInputFile <String>] [-ContentType <String>] [-Height <Int32>]
...
```
New-MgFinancialCompanySaleQuoteLineItemPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
