...
### List (Default)
```
Get-MgFinancialCompanyCustomerPaymentJournal -CompanyId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyCustomerPaymentJournal -InputObject <IFinancialsIdentity> [-Expand <String[]>]
