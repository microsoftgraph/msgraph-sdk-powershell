...
Get-MgFinancialCompanyPurchaseInvoiceVendorPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyPurchaseInvoiceVendorPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
