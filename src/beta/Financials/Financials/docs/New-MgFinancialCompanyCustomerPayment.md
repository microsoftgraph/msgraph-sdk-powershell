...
```
New-MgFinancialCompanyCustomerPayment -CompanyId <String> [-Amount <Decimal>] [-AppliesToInvoiceId <String>]
...
```
New-MgFinancialCompanyCustomerPayment -InputObject <IFinancialsIdentity> [-Amount <Decimal>]
