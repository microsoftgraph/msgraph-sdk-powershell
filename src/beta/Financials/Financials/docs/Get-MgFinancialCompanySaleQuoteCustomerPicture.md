...
### List (Default)
```
Get-MgFinancialCompanySaleQuoteCustomerPicture -CompanyId <String> -SalesQuoteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleQuoteCustomerPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
