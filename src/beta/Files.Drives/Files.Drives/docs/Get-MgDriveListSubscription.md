...
### List (Default)
```
Get-MgDriveListSubscription [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgDriveListSubscription -SubscriptionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### Get1
```
Get-MgDriveListSubscription -DriveId <String> -SubscriptionId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveListSubscription -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgDriveListSubscription -DriveId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
