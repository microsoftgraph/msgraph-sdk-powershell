...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/restore-mgdriveactivitylistitemversion
schema: 2.0.0
---
...
### Restore1 (Default)
```
Restore-MgDriveActivityListItemVersion -ItemActivityOldId <String> -ListItemVersionId <String> [-PassThru]
...
### RestoreViaIdentity
```
Restore-MgDriveActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
