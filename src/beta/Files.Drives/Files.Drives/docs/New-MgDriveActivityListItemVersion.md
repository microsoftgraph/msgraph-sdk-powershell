...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/new-mgdriveactivitylistitemversion
schema: 2.0.0
---

# New-MgDriveActivityListItemVersion
...
```
New-MgDriveActivityListItemVersion -ItemActivityOldId <String> [-FieldId <String>] [-Id <String>]
...
### Create
```
New-MgDriveActivityListItemVersion -DriveId <String> -ItemActivityOldId <String>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create1
```
New-MgDriveActivityListItemVersion -ItemActivityOldId <String> -BodyParameter <IMicrosoftGraphListItemVersion>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateExpanded
```
New-MgDriveActivityListItemVersion -DriveId <String> -ItemActivityOldId <String> [-FieldId <String>]
...
### CreateViaIdentity
```
New-MgDriveActivityListItemVersion -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgDriveActivityListItemVersion -InputObject <IFilesDrivesIdentity> [-FieldId <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-PublicationLevel <String>] [-PublicationVersionId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
