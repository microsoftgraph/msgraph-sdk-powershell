...
### Get1 (Default)
```
Get-MgDriveActivityListItemField -ItemActivityOldId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### Get
```
Get-MgDriveActivityListItemField -DriveId <String> -ItemActivityOldId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveActivityListItemField -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
