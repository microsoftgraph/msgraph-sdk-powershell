...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files.drives/update-mgdrivelistactivitylistitemactivity
schema: 2.0.0
---
...
```
Update-MgDriveListActivityListItemActivity -ItemActivityOldId <String> -ItemActivityOldId1 <String>
...
### Update
```
Update-MgDriveListActivityListItemActivity -DriveId <String> -ItemActivityOldId <String>
 -ItemActivityOldId1 <String> -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgDriveListActivityListItemActivity -DriveId <String> -ItemActivityOldId <String>
 -ItemActivityOldId1 <String> [-ActionCreate <IMicrosoftGraphCreateAction>]
...
### UpdateViaIdentity
```
Update-MgDriveListActivityListItemActivity -InputObject <IFilesDrivesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
