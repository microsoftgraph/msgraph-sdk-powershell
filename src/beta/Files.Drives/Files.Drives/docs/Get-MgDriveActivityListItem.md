...
### Get1 (Default)
```
Get-MgDriveActivityListItem -ItemActivityOldId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### Get
```
Get-MgDriveActivityListItem -DriveId <String> -ItemActivityOldId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveActivityListItem -InputObject <IFilesDrivesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
