...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistactivitydriveitem
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteListActivityDriveItem -ItemActivityOldId <String> -ListId <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListActivityDriveItem -InputObject <ISitesListIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
