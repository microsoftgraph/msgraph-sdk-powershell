...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactmultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserContactMultiValueExtendedProperty -ContactId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserContactMultiValueExtendedProperty -InputObject <IUsersContactsIdentity> [-Expand <String[]>]
