...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/update-mgusercontactfoldercontactphoto
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserContactFolderContactPhoto -InputObject <IUsersContactsIdentity>
 -BodyParameter <IMicrosoftGraphProfilePhoto> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserContactFolderContactPhoto -InputObject <IUsersContactsIdentity> [-Height <Int32>] [-Id <String>]
