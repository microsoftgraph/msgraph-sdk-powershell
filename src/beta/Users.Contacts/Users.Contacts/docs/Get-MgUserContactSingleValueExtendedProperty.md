...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactsinglevalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserContactSingleValueExtendedProperty -ContactId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserContactSingleValueExtendedProperty -InputObject <IUsersContactsIdentity> [-Expand <String[]>]
