...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/invoke-mgmanagedreportdeviceenrollmentabandonmentsummary
schema: 2.0.0
---
...
### Managed (Default)
```
Invoke-MgManagedReportDeviceEnrollmentAbandonmentSummary -Filter <String> -Skip <Int32> -SkipToken <String>
 -Top <Int32> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### ManagedViaIdentity
```
Invoke-MgManagedReportDeviceEnrollmentAbandonmentSummary -InputObject <IReportsIdentity> -OutFile <String>
