...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/new-mggroupthreadpostsinglevalueextendedproperty
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgGroupThreadPostSingleValueExtendedProperty -InputObject <IGroupsConversationThreadIdentity>
