...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthreadpostextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupThreadPostExtension -ConversationThreadId <String> -GroupId <String> -PostId <String> [-Count]
...
Get-MgGroupThreadPostExtension -ConversationThreadId <String> -ExtensionId <String> -GroupId <String>
 -PostId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupThreadPostExtension -InputObject <IGroupsConversationThreadIdentity> [-Expand <String[]>]
