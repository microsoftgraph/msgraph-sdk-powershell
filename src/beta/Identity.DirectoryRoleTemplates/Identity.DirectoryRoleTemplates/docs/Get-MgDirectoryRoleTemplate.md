...
### List (Default)
```
Get-MgDirectoryRoleTemplate [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgDirectoryRoleTemplate -DirectoryRoleTemplateId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDirectoryRoleTemplate -InputObject <IIdentityDirectoryRoleTemplatesIdentity> [-Expand <String[]>]
