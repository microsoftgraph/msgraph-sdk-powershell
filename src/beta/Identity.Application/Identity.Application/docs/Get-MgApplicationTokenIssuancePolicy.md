...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/get-mgapplicationtokenissuancepolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgApplicationTokenIssuancePolicy -ApplicationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgApplicationTokenIssuancePolicy -ApplicationId <String> -TokenIssuancePolicyId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationTokenIssuancePolicy -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
