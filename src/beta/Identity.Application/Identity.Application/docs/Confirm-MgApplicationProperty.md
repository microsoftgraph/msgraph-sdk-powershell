...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/confirm-mgapplicationproperty
schema: 2.0.0
---

# Confirm-MgApplicationProperty
...
```
Confirm-MgApplicationProperty [-DisplayName <String>] [-EntityType <String>] [-MailNickname <String>]
