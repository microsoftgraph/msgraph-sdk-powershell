...
### List (Default)
```
Get-MgEducationMeAssignmentResource -EducationAssignmentId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgEducationMeAssignmentResource -InputObject <IEducationIdentity> [-Expand <String[]>]
