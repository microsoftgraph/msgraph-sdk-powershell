...
### List (Default)
```
Get-MgEducationClassTeacher -EducationClassId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgEducationClassTeacher -EducationClassId <String> -EducationUserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationClassTeacher -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
