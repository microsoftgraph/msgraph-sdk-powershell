...
### Get (Default)
```
Get-MgEducationSchoolAdministrativeUnit -EducationSchoolId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSchoolAdministrativeUnit -InputObject <IEducationIdentity> [-Expand <String[]>]
