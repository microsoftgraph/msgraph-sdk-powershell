...
### List (Default)
```
Get-MgBookingBusinessAppointment -BookingBusinessId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBookingBusinessAppointment -InputObject <IBookingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
