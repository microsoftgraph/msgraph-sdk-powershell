...
### List (Default)
```
Get-MgBookingBusinessService -BookingBusinessId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBookingBusinessService -BookingBusinessId <String> -BookingServiceId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBookingBusinessService -InputObject <IBookingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
