...
### List (Default)
```
Get-MgBookingCurrency [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgBookingCurrency -BookingCurrencyId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBookingCurrency -InputObject <IBookingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
