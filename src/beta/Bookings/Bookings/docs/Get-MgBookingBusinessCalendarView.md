...
### List (Default)
```
Get-MgBookingBusinessCalendarView -BookingBusinessId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBookingBusinessCalendarView -InputObject <IBookingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
