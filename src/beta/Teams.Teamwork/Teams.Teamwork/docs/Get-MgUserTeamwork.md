...
### Get (Default)
```
Get-MgUserTeamwork -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserTeamwork -InputObject <ITeamsTeamworkIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
