...
### List (Default)
```
Get-MgUserPerson -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgUserPerson -PersonId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPerson -InputObject <IUsersPeopleIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
