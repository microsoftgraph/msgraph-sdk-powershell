...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotenotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteNotebookSection -NotebookId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgSiteOnenoteNotebookSection -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteNotebookSection -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
