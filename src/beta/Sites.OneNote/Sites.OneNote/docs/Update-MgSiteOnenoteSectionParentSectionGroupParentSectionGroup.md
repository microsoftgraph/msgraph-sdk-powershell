...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentSectionGroupParentSectionGroup -OnenoteSectionId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
