...
### List (Default)
```
Get-MgSiteOnenoteNotebook -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSiteOnenoteNotebook -NotebookId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteNotebook -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
