...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupParentNotebookSectionGroup -SectionGroupId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
