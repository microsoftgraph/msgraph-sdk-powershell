...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionGroup -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSiteOnenoteSectionGroup -SectionGroupId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgSiteOnenoteSectionGroup -SectionGroupId <String> -SectionGroupId1 <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroup -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgSiteOnenoteSectionGroup -SectionGroupId <String> -SiteId <String> [-Count] [-Expand <String[]>]
