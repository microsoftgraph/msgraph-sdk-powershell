...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionParentNotebook -NotebookId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
