...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenoteresource
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteResource -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSiteOnenoteResource -OnenoteResourceId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteResource -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
