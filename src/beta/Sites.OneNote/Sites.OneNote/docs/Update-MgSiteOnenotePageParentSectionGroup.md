...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionGroup -OnenotePageId <String> -SiteId <String>
...
### Update1
```
Update-MgSiteOnenotePageParentSectionGroup -OnenotePageId <String> -SectionGroupId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
