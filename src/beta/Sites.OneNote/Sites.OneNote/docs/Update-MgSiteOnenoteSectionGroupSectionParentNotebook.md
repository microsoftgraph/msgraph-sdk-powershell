...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupSectionParentNotebook -OnenoteSectionId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
