...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenoteSectionPageParentSection -OnenotePageId <String> -OnenoteSectionId <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionPageParentSection -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
