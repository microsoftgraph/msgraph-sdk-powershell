...
### List (Default)
```
Get-MgUser [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgUser -InputObject <IUsersUserIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
