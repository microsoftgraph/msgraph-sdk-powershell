...
### Sync (Default)
```
Sync-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>
