...
### Sync (Default)
```
Sync-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-Headers <IDictionary>]
