...
### Disable (Default)
```
Disable-MgBetaDeviceManagementComanagedDeviceLostMode -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementComanagedDeviceLostMode -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
