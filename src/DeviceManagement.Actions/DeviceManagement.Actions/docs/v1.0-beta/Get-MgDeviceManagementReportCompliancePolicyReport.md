...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/get-mgdevicemanagementreportcompliancepolicyreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceManagementReportCompliancePolicyReport -OutFile <String> [-AdditionalProperties <Hashtable>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1VpdeuuDevicemanagementReportsMicrosoftGraphGetcompliancepoliciesreportfordevicePostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
