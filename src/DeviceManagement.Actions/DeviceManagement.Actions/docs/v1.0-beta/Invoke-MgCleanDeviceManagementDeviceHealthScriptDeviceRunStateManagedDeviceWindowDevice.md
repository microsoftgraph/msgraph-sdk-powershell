...
Invoke-MgCleanDeviceManagementDeviceHealthScriptDeviceRunStateManagedDeviceWindowDevice
 ...
 [-KeepUserData] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPathsCd187BDevicemanagementDevicehealthscriptsDevicehealthscriptIdDevicerunstatesDevicehealthscriptdevicestateIdManageddeviceMicrosoftGraphCleanwindowsdevicePostRequestbodyContentApplicationJsonSchema
