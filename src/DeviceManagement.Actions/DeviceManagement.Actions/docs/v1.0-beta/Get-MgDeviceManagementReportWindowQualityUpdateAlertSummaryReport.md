...
# Get-MgBetaDeviceManagementReportWindowQualityUpdateAlertSummaryReport
...
### GetExpanded (Default)
```
Get-MgBetaDeviceManagementReportWindowQualityUpdateAlertSummaryReport -OutFile <String>
