...
### Sync (Default)
```
Sync-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru] [-Confirm]
