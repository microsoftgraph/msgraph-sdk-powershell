...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/invoke-mgrotatedevicemanagementcomanageddevicelocaladminpassword
schema: 2.0.0
---

# Invoke-MgRotateDeviceManagementComanagedDeviceLocalAdminPassword
...
### Rotate (Default)
```
Invoke-MgRotateDeviceManagementComanagedDeviceLocalAdminPassword -ManagedDeviceId <String> [-PassThru]
