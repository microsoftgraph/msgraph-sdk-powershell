...
```yaml
Type: IPathsUqso5LDevicemanagementWindowsautopilotdeviceidentitiesWindowsautopilotdeviceidentityIdIntendeddeploymentprofileMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
