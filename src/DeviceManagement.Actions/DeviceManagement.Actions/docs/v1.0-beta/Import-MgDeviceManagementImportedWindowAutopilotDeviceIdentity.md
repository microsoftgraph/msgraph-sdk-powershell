...
# Import-MgBetaDeviceManagementImportedWindowAutopilotDeviceIdentity
...
```
Import-MgBetaDeviceManagementImportedWindowAutopilotDeviceIdentity [-AdditionalProperties <Hashtable>]
