...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/get-mgdevicemanagementreportcompliancepolicydevicereport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceManagementReportCompliancePolicyDeviceReport -OutFile <String> [-AdditionalProperties <Hashtable>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1J8LkxdDevicemanagementReportsMicrosoftGraphGetcompliancepolicydevicesreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
