...
```yaml
Type: IPathsC9T4K6DevicemanagementRoleassignmentsDeviceandappmanagementroleassignmentIdRolescopetagsMicrosoftGraphGetrolescopetagsbyidPostRequestbodyContentApplicationJsonSchema
