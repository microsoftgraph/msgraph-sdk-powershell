...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/invoke-mgenrolldevicemanagementcomanageddevicenowaction
schema: 2.0.0
---

# Invoke-MgEnrollDeviceManagementComanagedDeviceNowAction
...
### Enroll (Default)
```
Invoke-MgEnrollDeviceManagementComanagedDeviceNowAction -ManagedDeviceId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### EnrollViaIdentity
```
Invoke-MgEnrollDeviceManagementComanagedDeviceNowAction -InputObject <IDeviceManagementActionsIdentity>
