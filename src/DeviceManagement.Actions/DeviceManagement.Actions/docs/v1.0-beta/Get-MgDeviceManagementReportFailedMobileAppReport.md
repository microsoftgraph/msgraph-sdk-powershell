...
### Get
```
Get-MgDeviceManagementReportFailedMobileAppReport -OutFile <String>
...
```yaml
Type: IPaths1NdtknnDevicemanagementReportsMicrosoftGraphGetfailedmobileappsreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
