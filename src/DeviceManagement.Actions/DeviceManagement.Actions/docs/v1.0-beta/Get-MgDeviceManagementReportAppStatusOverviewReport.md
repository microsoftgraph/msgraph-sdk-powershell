...
### Get
```
Get-MgDeviceManagementReportAppStatusOverviewReport -OutFile <String>
...
```yaml
Type: IPathsDfju0ZDevicemanagementReportsMicrosoftGraphGetappstatusoverviewreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
