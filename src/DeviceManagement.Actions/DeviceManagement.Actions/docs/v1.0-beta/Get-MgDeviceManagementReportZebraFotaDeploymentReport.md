...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths13QvfzrDevicemanagementReportsMicrosoftGraphGetzebrafotadeploymentreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
