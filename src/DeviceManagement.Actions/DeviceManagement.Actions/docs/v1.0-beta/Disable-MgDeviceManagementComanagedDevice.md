...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/disable-mgdevicemanagementcomanageddevice
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-MgDeviceManagementComanagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
