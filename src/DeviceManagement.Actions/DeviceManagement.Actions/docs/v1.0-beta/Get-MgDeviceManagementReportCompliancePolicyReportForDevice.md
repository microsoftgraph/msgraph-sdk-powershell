...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/get-mgdevicemanagementreportcompliancepolicyreportfordevice
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceManagementReportCompliancePolicyReportForDevice -OutFile <String>
