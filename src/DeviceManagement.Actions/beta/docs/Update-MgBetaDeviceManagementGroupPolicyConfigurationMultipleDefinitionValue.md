...
Update-MgBetaDeviceManagementGroupPolicyConfigurationMultipleDefinitionValue
 ...
 [-AdditionalProperties <Hashtable>] [-DeletedIds <String[]>] [-ResponseHeadersVariable <String>]
 [-Updated <IMicrosoftGraphGroupPolicyDefinitionValue[]>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
