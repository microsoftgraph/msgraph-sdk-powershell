...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Support.OperationApprovalSource
Parameter Sets: CancelExpanded, CancelViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1P4Y40GDevicemanagementOperationapprovalrequestsOperationapprovalrequestIdMicrosoftGraphCancelapprovalPostRequestbodyContentApplicationJsonSchema
