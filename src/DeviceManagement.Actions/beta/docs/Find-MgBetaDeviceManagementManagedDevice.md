...
### Locate (Default)
```
Find-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
