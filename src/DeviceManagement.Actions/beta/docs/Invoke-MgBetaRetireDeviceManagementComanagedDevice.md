...
### Retire (Default)
```
Invoke-MgBetaRetireDeviceManagementComanagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RetireViaIdentity
```
Invoke-MgBetaRetireDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
