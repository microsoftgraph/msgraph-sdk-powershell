...
### Lock (Default)
```
Lock-MgBetaDeviceManagementManagedDeviceRemote -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### LockViaIdentity
```
Lock-MgBetaDeviceManagementManagedDeviceRemote -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
