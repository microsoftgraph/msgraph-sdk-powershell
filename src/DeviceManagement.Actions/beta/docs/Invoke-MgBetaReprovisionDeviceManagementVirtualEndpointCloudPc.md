...
Invoke-MgBetaReprovisionDeviceManagementVirtualEndpointCloudPc -CloudPcId <String>
 [-AdditionalProperties <Hashtable>] [-OSVersion <String>] [-ResponseHeadersVariable <String>]
 [-UserAccountType <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
