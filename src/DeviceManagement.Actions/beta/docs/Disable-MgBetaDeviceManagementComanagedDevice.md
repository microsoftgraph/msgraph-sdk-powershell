...
### Disable (Default)
```
Disable-MgBetaDeviceManagementComanagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
