...
Get-MgBetaDeviceManagementVirtualEndpointReportCrossRegionDisasterRecoveryReport -OutFile <String>
 ...
 [-ResponseHeadersVariable <String>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Km25K2DevicemanagementVirtualendpointReportsMicrosoftGraphRetrievecrossregiondisasterrecoveryreportPostRequestbodyContentApplicationJsonSchema
