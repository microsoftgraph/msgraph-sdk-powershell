...
### Disable (Default)
```
Disable-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
