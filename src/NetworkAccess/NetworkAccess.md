...
``` yaml
directive:
# Remove report operations whose path-derived response models exceed the Windows file name limit.
  - remove-operation: networkAccess.report_deviceReport
  - remove-operation: networkAccess.report_usageProfiling
  - remove-operation: networkAccess.report_userReport
