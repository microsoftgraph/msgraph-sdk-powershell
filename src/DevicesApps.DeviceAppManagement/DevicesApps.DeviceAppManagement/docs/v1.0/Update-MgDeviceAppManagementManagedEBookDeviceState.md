...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmanagedebookdevicestate
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementManagedEBookDeviceState -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceInstallState> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
