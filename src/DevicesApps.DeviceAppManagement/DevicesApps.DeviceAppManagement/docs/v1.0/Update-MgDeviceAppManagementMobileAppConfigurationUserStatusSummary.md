...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappconfigurationuserstatussummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppConfigurationUserStatusSummary
 -ManagedDeviceMobileAppConfigurationId <String> [-ConfigurationVersion <Int32>] [-ErrorCount <Int32>]
...
```
Update-MgDeviceAppManagementMobileAppConfigurationUserStatusSummary
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-ConfigurationVersion <Int32>] [-ErrorCount <Int32>]
 [-FailedCount <Int32>] [-Id <String>] [-LastUpdateDateTime <DateTime>] [-NotApplicableCount <Int32>]
 [-PendingCount <Int32>] [-SuccessCount <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
