...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementtargetedmanagedappconfiguration
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementTargetedManagedAppConfiguration [-Count] [-ExpandProperty <String[]>]
