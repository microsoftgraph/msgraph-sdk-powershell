...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedappregistrationappliedpolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationAppliedPolicy -ManagedAppRegistrationId <String> [-Count]
