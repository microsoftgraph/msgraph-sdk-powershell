...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedebookinstallsummary
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementManagedEBookInstallSummary -InputObject <IDevicesAppsDeviceAppManagementIdentity>
