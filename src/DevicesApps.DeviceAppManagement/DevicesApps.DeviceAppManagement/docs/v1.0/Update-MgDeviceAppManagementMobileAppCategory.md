...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappcategory
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppCategory -MobileAppCategoryId <String> [-DisplayName <String>]
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementMobileAppCategory -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppCategory> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -MobileAppCategoryId
key: mobileAppCategory-id of mobileAppCategory
