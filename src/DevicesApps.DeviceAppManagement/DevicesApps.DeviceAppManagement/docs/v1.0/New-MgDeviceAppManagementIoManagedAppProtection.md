...
```
New-MgDeviceAppManagementIoManagedAppProtection [-AllowedDataStorageLocations <String[]>]
...
### Create
```
New-MgDeviceAppManagementIoManagedAppProtection -BodyParameter <IMicrosoftGraphIosManagedAppProtection>
