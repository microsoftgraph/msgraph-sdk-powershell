...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementdeviceappmanagementdeviceappmanagement
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementDeviceAppManagementDeviceAppManagement
 -BodyParameter <IMicrosoftGraphDeviceAppManagement1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
