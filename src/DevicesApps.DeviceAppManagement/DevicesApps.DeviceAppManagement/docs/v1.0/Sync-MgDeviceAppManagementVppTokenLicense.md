...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/sync-mgdeviceappmanagementvpptokenlicense
schema: 2.0.0
---
...
### Sync1 (Default)
```
Sync-MgDeviceAppManagementVppTokenLicense -VppTokenId <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity1
```
Sync-MgDeviceAppManagementVppTokenLicense -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-Confirm]
