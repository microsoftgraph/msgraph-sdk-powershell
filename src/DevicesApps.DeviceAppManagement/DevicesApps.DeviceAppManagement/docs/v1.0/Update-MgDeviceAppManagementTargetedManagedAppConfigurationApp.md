...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementtargetedmanagedappconfigurationapp
schema: 2.0.0
---
...
Update-MgDeviceAppManagementTargetedManagedAppConfigurationApp -ManagedMobileAppId <String>
 -TargetedManagedAppConfigurationId <String> [-Id <String>]
