...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementiomanagedappprotectiondeploymentsummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementIoManagedAppProtectionDeploymentSummary -IosManagedAppProtectionId <String>
