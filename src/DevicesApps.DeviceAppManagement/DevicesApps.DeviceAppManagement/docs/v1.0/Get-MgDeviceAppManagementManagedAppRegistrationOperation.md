...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedappregistrationoperation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationOperation -ManagedAppRegistrationId <String> [-Count]
