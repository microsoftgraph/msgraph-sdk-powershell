...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappassignment
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementMobileAppAssignment -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
key: mobileAppAssignment-id of mobileAppAssignment
