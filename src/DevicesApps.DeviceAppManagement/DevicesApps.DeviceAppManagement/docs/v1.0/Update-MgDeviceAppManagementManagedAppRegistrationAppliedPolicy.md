...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmanagedappregistrationappliedpolicy
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementManagedAppRegistrationAppliedPolicy
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> -BodyParameter <IMicrosoftGraphManagedAppPolicy>
