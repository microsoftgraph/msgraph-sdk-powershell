...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementiomanagedappprotectiondeploymentsummary
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementIoManagedAppProtectionDeploymentSummary -IosManagedAppProtectionId <String>
