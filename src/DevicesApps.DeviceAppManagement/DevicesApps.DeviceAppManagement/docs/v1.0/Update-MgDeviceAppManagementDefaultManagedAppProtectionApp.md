...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementdefaultmanagedappprotectionapp
schema: 2.0.0
---
...
Update-MgDeviceAppManagementDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
 -ManagedMobileAppId <String> [-Id <String>] [-MobileAppIdentifier <IMicrosoftGraphMobileAppIdentifier>]
...
Update-MgDeviceAppManagementDefaultManagedAppProtectionApp
 ...
 [-MobileAppIdentifier <IMicrosoftGraphMobileAppIdentifier>] [-Version <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
