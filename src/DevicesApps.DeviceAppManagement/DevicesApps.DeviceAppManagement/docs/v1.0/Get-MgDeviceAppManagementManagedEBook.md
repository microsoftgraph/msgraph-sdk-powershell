...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementManagedEBook -InputObject <IDevicesAppsDeviceAppManagementIdentity>
