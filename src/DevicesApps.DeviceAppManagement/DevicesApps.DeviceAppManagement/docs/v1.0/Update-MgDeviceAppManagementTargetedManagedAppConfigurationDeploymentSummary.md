...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementtargetedmanagedappconfigurationdeploymentsummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementTargetedManagedAppConfigurationDeploymentSummary
 -TargetedManagedAppConfigurationId <String> [-ConfigurationDeployedUserCount <Int32>]
