...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedebookuserstatesummary
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementManagedEBookUserStateSummary -ManagedEBookId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementManagedEBookUserStateSummary -InputObject <IDevicesAppsDeviceAppManagementIdentity>
