...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/set-mgdeviceappmanagementmanagedebook
schema: 2.0.0
---
...
### AssignViaIdentity1
```
Set-MgDeviceAppManagementManagedEBook -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IPathsWfdti0DeviceappmanagementManagedebooksManagedebookIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
