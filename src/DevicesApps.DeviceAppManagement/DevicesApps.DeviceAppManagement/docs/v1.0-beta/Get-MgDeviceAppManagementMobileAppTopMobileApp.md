...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileapptopmobileapp
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementMobileAppTopMobileApp -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [<CommonParameters>]
```
