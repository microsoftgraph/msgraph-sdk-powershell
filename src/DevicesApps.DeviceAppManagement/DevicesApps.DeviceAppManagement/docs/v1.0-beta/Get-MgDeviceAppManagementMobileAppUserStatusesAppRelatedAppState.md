...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileappuserstatusesapprelatedappstate
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppUserStatusesAppRelatedAppState -DeviceId <String> -MobileAppId <String>
