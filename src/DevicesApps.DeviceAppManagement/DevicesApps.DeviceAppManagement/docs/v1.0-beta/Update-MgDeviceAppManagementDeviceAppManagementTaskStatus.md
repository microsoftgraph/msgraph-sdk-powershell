...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementdeviceappmanagementtaskstatus
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementDeviceAppManagementTaskStatus -DeviceAppManagementTaskId <String> [-Note <String>]
 [-Status <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgDeviceAppManagementDeviceAppManagementTaskStatus -DeviceAppManagementTaskId <String>
...
```
Update-MgDeviceAppManagementDeviceAppManagementTaskStatus
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-Note <String>] [-Status <String>] [-PassThru]
...
key: deviceAppManagementTask-id of deviceAppManagementTask
