...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedebookassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementManagedEBookAssignment -ManagedEBookId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceAppManagementManagedEBookAssignment -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
key: managedEBookAssignment-id of managedEBookAssignment
