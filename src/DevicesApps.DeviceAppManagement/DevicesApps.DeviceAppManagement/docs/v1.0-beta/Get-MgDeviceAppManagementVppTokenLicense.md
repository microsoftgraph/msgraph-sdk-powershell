...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementvpptokenlicense
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementVppTokenLicense -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [<CommonParameters>]
```
