...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementwdacsupplementalpolicydeploysummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementWdacSupplementalPolicyDeploySummary
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-DeployedDeviceCount <Int32>]
 [-FailedDeviceCount <Int32>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
