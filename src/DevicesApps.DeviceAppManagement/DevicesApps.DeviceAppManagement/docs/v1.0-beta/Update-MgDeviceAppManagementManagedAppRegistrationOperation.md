...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmanagedappregistrationoperation
schema: 2.0.0
---
...
Update-MgDeviceAppManagementManagedAppRegistrationOperation -ManagedAppOperationId <String>
 -ManagedAppRegistrationId <String> [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
...
```
Update-MgDeviceAppManagementManagedAppRegistrationOperation
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> -BodyParameter <IMicrosoftGraphManagedAppOperation>
...
```
Update-MgDeviceAppManagementManagedAppRegistrationOperation
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-DisplayName <String>] [-Id <String>]
...
key: managedAppOperation-id of managedAppOperation
...
key: managedAppRegistration-id of managedAppRegistration
