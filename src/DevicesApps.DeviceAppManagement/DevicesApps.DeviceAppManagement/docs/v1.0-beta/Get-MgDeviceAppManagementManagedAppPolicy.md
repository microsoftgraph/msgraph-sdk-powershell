...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedapppolicy
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementManagedAppPolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementManagedAppPolicy -InputObject <IDevicesAppsDeviceAppManagementIdentity>
