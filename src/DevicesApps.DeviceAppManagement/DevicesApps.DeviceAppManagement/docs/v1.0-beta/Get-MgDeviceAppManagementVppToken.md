...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementvpptoken
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementVppToken [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgDeviceAppManagementVppToken -InputObject <IDevicesAppsDeviceAppManagementIdentity>
