...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileApp [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceAppManagementMobileApp -InputObject <IDevicesAppsDeviceAppManagementIdentity>
