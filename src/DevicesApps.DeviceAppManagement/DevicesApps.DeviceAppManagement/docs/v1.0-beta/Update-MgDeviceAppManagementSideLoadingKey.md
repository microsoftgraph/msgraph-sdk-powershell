...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementsideloadingkey
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementSideLoadingKey -SideLoadingKeyId <String> [-Description <String>]
...
### Update
```
Update-MgDeviceAppManagementSideLoadingKey -SideLoadingKeyId <String>
 -BodyParameter <IMicrosoftGraphSideLoadingKey> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgDeviceAppManagementSideLoadingKey -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphSideLoadingKey> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
