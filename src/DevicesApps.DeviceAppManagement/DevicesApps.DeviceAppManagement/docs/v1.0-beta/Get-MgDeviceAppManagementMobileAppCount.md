...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileappcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppCount -Status <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceAppManagementMobileAppCount -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [<CommonParameters>]
```
