...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmanagedappregistrationintendedpolicy
schema: 2.0.0
---
...
Update-MgDeviceAppManagementManagedAppRegistrationIntendedPolicy -ManagedAppPolicyId <String>
 -ManagedAppRegistrationId <String> [-CreatedDateTime <DateTime>] [-Description <String>]
