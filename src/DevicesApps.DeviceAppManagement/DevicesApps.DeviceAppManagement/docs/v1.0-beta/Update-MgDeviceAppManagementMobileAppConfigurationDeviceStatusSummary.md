...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappconfigurationdevicestatussummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppConfigurationDeviceStatusSummary
 -ManagedDeviceMobileAppConfigurationId <String> [-ConfigurationVersion <Int32>] [-ConflictCount <Int32>]
...
```
Update-MgDeviceAppManagementMobileAppConfigurationDeviceStatusSummary
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-ConfigurationVersion <Int32>]
