...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/new-mgdeviceappmanagementiolobappprovisioningconfigurationuserstatuses
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementIoLobAppProvisioningConfigurationUserStatuses
 -IosLobAppProvisioningConfigurationId <String> [-DevicesCount <Int32>] [-Id <String>]
