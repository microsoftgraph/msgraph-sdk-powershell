...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementwindowinformationprotectionpolicy
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementWindowInformationProtectionPolicy -WindowsInformationProtectionPolicyId <String>
 ...
 [-DataRecoveryCertificateSubjectName <String>] [-DaysWithoutContactBeforeUnenroll <Int32>]
