...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/new-mgdeviceappmanagementpolicysetitem
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementPolicySetItem -PolicySetId <String> [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-ErrorCode <String>] [-GuidedDeploymentTags <String[]>] [-Id <String>]
 [-ItemType <String>] [-LastModifiedDateTime <DateTime>] [-PayloadId <String>] [-Status <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgDeviceAppManagementPolicySetItem -PolicySetId <String> -BodyParameter <IMicrosoftGraphPolicySetItem>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDeviceAppManagementPolicySetItem -InputObject <IDevicesAppsDeviceAppManagementIdentity>
