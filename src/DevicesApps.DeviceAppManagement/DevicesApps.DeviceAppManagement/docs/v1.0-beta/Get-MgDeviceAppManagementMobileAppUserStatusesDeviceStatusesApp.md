...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileappuserstatusesdevicestatusesapp
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppUserStatusesDeviceStatusesApp -MobileAppId <String>
