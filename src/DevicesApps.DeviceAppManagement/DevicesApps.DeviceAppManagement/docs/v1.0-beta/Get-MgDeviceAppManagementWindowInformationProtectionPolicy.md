...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementwindowinformationprotectionpolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementWindowInformationProtectionPolicy [-Count] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgDeviceAppManagementWindowInformationProtectionPolicy -WindowsInformationProtectionPolicyId <String>
...
key: windowsInformationProtectionPolicy-id of windowsInformationProtectionPolicy
