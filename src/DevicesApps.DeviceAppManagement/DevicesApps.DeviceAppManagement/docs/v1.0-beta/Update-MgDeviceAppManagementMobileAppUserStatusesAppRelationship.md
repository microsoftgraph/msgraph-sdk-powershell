...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappuserstatusesapprelationship
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppUserStatusesAppRelationship -MobileAppId <String>
 -UserAppInstallStatusId <String> [-Relationships <IMicrosoftGraphMobileAppRelationship[]>] [-PassThru]
