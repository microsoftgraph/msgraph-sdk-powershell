...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedappregistrationintendedpolicy
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationIntendedPolicy -ManagedAppRegistrationId <String> [-Count]
