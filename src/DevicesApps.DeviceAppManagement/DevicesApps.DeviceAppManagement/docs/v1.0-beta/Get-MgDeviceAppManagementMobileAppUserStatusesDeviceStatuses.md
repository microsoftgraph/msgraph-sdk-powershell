...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmobileappuserstatusesdevicestatuses
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppUserStatusesDeviceStatuses -MobileAppId <String>
 -UserAppInstallStatusId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
