...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/new-mgdeviceappmanagementiolobappprovisioningconfigurationassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementIoLobAppProvisioningConfigurationAssignment
 -IosLobAppProvisioningConfigurationId <String> [-Id <String>]
