...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileapprelationship
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppRelationship -MobileAppId <String> -MobileAppRelationshipId <String>
 [-Id <String>] [-TargetDisplayName <String>] [-TargetId <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementMobileAppRelationship -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppRelationship> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
key: mobileAppRelationship-id of mobileAppRelationship
...
BODYPARAMETER <IMicrosoftGraphMobileAppRelationship>: Describes the relationship for a child mobile app to its parent mobile app.
  - `[Id <String>]`: Read-only.
