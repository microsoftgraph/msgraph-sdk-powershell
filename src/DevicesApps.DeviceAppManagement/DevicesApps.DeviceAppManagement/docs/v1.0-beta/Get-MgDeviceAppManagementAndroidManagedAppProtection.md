...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementandroidmanagedappprotection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementAndroidManagedAppProtection -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
