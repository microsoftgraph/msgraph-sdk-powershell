...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementwdacsupplementalpolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementWdacSupplementalPolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceAppManagementWdacSupplementalPolicy -InputObject <IDevicesAppsDeviceAppManagementIdentity>
