...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementwindowinformationprotectiondeviceregistration
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementWindowInformationProtectionDeviceRegistration [-Count] [-ExpandProperty <String[]>]
