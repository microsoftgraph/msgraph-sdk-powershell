...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementdefaultmanagedappprotectiondeploymentsummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementDefaultManagedAppProtectionDeploymentSummary
 -DefaultManagedAppProtectionId <String> [-ConfigurationDeployedUserCount <Int32>]
