...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagemententerprisecodesigningcertificate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementEnterpriseCodeSigningCertificate [-Count] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgDeviceAppManagementEnterpriseCodeSigningCertificate -EnterpriseCodeSigningCertificateId <String>
