...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmanagedapppolicy
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementManagedAppPolicy -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedAppPolicy1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
