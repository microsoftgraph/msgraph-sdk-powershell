...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmobileappdevicestatusesapprelationship
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppDeviceStatusesAppRelationship -MobileAppId <String>
 -MobileAppInstallStatusId <String> [-Relationships <IMicrosoftGraphMobileAppRelationship[]>] [-PassThru]
