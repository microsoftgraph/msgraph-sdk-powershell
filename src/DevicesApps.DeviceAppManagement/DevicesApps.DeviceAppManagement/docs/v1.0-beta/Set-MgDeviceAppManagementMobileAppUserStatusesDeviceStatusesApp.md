...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/set-mgdeviceappmanagementmobileappuserstatusesdevicestatusesapp
schema: 2.0.0
---
...
```
Set-MgDeviceAppManagementMobileAppUserStatusesDeviceStatusesApp -MobileAppId <String>
