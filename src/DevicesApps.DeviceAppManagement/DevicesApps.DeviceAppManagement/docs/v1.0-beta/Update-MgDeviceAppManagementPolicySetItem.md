...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementpolicysetitem
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementPolicySetItem -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphPolicySetItem> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
