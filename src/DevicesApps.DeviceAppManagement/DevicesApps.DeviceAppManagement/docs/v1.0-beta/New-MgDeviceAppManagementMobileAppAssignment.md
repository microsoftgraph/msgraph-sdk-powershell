...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/new-mgdeviceappmanagementmobileappassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAssignment -MobileAppId <String> [-Id <String>] [-Intent <String>]
 [-Settings <IMicrosoftGraphMobileAppAssignmentSettings>] [-Source <String>] [-SourceId <String>]
...
### CreateViaIdentity
```
New-MgDeviceAppManagementMobileAppAssignment -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgDeviceAppManagementMobileAppAssignment -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 [-Id <String>] [-Intent <String>] [-Settings <IMicrosoftGraphMobileAppAssignmentSettings>] [-Source <String>]
 [-SourceId <String>] [-Target <IMicrosoftGraphDeviceAndAppManagementAssignmentTarget>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphMobileAppAssignmentSettings
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
