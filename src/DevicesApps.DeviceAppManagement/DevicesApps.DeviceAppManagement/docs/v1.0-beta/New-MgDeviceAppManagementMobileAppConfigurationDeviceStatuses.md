...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/new-mgdeviceappmanagementmobileappconfigurationdevicestatuses
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppConfigurationDeviceStatuses -ManagedDeviceMobileAppConfigurationId <String>
