...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/invoke-mghasdeviceappmanagementiolobappprovisioningconfigurationpayloadlink
schema: 2.0.0
---
...
### HasExpanded (Default)
```
Invoke-MgHasDeviceAppManagementIoLobAppProvisioningConfigurationPayloadLink [-PayloadIds <String[]>]
