...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementmanagedebookuserstatesummarydevicestate
schema: 2.0.0
---
...
Get-MgDeviceAppManagementManagedEBookUserStateSummaryDeviceState -ManagedEBookId <String>
 -UserInstallStateSummaryId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
