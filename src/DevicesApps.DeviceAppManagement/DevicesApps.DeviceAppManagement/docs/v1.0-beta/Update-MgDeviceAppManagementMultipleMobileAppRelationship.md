...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/update-mgdeviceappmanagementmultiplemobileapprelationship
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMultipleMobileAppRelationship -MobileAppId <String>
