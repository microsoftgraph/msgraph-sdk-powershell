...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/set-mgdeviceappmanagementmobileappdevicestatusesapp
schema: 2.0.0
---
...
```
Set-MgDeviceAppManagementMobileAppDeviceStatusesApp -MobileAppId <String> -MobileAppInstallStatusId <String>
...
### AssignViaIdentity
```
Set-MgDeviceAppManagementMobileAppDeviceStatusesApp -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IPaths2Hf785DeviceappmanagementMobileappsMobileappIdDevicestatusesMobileappinstallstatusIdAppMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
