...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/clear-mgdeviceappmanagementwindowinformationprotectiondeviceregistration
schema: 2.0.0
---
...
```
Clear-MgDeviceAppManagementWindowInformationProtectionDeviceRegistration
 -InputObject <IDevicesAppsDeviceAppManagementIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
