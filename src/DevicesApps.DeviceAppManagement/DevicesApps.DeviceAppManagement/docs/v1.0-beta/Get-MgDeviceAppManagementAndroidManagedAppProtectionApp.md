...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/get-mgdeviceappmanagementandroidmanagedappprotectionapp
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementAndroidManagedAppProtectionApp -AndroidManagedAppProtectionId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementAndroidManagedAppProtectionApp -InputObject <IDevicesAppsDeviceAppManagementIdentity>
