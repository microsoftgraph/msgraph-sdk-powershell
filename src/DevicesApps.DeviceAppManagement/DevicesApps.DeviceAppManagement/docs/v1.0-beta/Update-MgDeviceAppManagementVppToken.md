...
### Update
```
Update-MgDeviceAppManagementVppToken -VppTokenId <String> -BodyParameter <IMicrosoftGraphVppToken2>
...
Update-MgDeviceAppManagementVppToken -InputObject <IDevicesAppsDeviceAppManagementIdentity>
 -BodyParameter <IMicrosoftGraphVppToken2> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
