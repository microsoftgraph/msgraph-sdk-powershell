...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.deviceappmanagement/invoke-mghasdeviceappmanagementtargetedmanagedappconfigurationpayloadlink
schema: 2.0.0
---
...
### HasExpanded (Default)
```
Invoke-MgHasDeviceAppManagementTargetedManagedAppConfigurationPayloadLink [-PayloadIds <String[]>] [-Confirm]
