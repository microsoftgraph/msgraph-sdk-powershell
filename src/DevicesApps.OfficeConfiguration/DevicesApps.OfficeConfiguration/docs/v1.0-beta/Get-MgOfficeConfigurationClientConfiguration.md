...
### List (Default)
```
Get-MgOfficeConfigurationClientConfiguration [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgOfficeConfigurationClientConfiguration -OfficeClientConfigurationId <String>
