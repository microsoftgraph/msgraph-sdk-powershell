...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/get-mgsitebypath
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteByPath -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
