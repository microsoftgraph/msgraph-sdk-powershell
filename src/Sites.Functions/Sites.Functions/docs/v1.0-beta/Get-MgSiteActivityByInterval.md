...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/get-mgsiteactivitybyinterval
schema: 2.0.0
---
...
### GetViaIdentity2
```
Get-MgSiteActivityByInterval -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
