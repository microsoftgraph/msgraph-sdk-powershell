...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/get-mggetrecentnotebook
schema: 2.0.0
---

# Get-MgGetRecentNotebook
...
### Get1 (Default)
```
Get-MgGetRecentNotebook -IncludePersonalNotebooks -SiteId <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGetRecentNotebook -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
