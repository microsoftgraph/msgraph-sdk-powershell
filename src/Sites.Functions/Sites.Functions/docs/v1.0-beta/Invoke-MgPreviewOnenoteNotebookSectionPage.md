...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotenotebooksectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenoteNotebookSectionPage
...
### Preview1 (Default)
```
Invoke-MgPreviewOnenoteNotebookSectionPage -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewOnenoteNotebookSectionPage -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
