...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotesectiongroupsectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenoteSectionGroupSectionPage
...
### Preview1 (Default)
```
Invoke-MgPreviewOnenoteSectionGroupSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewOnenoteSectionGroupSectionPage -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
