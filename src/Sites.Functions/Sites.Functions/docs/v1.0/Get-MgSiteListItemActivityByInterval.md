...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/get-mgsitelistitemactivitybyinterval
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListItemActivityByInterval -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
