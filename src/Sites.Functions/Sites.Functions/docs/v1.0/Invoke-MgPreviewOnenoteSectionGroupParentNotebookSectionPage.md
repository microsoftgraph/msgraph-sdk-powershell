...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenoteSectionGroupParentNotebookSectionPage
...
### Preview1 (Default)
```
Invoke-MgPreviewOnenoteSectionGroupParentNotebookSectionPage -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewOnenoteSectionGroupParentNotebookSectionPage -InputObject <ISitesFunctionsIdentity>
 [<CommonParameters>]
```
