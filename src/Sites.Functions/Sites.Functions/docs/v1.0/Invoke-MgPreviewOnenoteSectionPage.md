...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotesectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenoteSectionPage
...
### Preview1 (Default)
```
Invoke-MgPreviewOnenoteSectionPage -OnenotePageId <String> -OnenoteSectionId <String> -SiteId <String>
 [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewOnenoteSectionPage -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
