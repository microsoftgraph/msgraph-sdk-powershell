...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotepageparentsectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenotePageParentSectionPage
...
### Preview1 (Default)
```
Invoke-MgPreviewOnenotePageParentSectionPage -OnenotePageId <String> -OnenotePageId1 <String> -SiteId <String>
 [<CommonParameters>]
```

### PreviewViaIdentity1
```
Invoke-MgPreviewOnenotePageParentSectionPage -InputObject <ISitesFunctionsIdentity> [<CommonParameters>]
```
