...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.functions/invoke-mgpreviewonenotenotebooksectiongroupsectionpage
schema: 2.0.0
---

# Invoke-MgPreviewOnenoteNotebookSectionGroupSectionPage
...
### Preview (Default)
```
Invoke-MgPreviewOnenoteNotebookSectionGroupSectionPage -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewOnenoteNotebookSectionGroupSectionPage -InputObject <ISitesFunctionsIdentity>
 [<CommonParameters>]
```
