...
### List (Default)
```
Get-MgAccessReviewMyDecision -AccessReviewId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgAccessReviewMyDecision -InputObject <IIdentityAccessReviewIdentity> [-ExpandProperty <String[]>]
