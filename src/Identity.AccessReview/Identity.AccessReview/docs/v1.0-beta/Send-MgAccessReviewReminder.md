...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.accessreview/send-mgaccessreviewreminder
schema: 2.0.0
---
...
### SendViaIdentity
```
Send-MgAccessReviewReminder -InputObject <IIdentityAccessReviewIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
