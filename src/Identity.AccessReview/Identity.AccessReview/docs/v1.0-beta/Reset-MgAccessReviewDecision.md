...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.accessreview/reset-mgaccessreviewdecision
schema: 2.0.0
---
...
### ResetViaIdentity
```
Reset-MgAccessReviewDecision -InputObject <IIdentityAccessReviewIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
