...
New-MgDomain [-AuthenticationType <String>] [-AvailabilityStatus <String>]
 ...
 [-ServiceConfigurationRecords <IMicrosoftGraphDomainDnsRecord[]>] [-StateLastActionDateTime <DateTime>]
 [-StateOperation <String>] [-StateStatus <String>] [-SupportedServices <String[]>]
