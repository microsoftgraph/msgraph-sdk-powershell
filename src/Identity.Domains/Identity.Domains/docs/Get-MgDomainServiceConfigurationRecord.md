...
### List (Default)
```
Get-MgDomainServiceConfigurationRecord -DomainId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDomainServiceConfigurationRecord -DomainDnsRecordId <String> -DomainId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDomainServiceConfigurationRecord -InputObject <IIdentityDomainsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
