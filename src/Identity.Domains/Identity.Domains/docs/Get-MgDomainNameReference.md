...
### List (Default)
```
Get-MgDomainNameReference -DomainId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDomainNameReference -DirectoryObjectId <String> -DomainId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDomainNameReference -InputObject <IIdentityDomainsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
