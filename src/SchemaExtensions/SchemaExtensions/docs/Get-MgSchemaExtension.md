...
### List (Default)
```
Get-MgSchemaExtension [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgSchemaExtension -SchemaExtensionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSchemaExtension -InputObject <ISchemaExtensionsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
