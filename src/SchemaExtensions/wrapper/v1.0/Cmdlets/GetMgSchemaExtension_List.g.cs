...
namespace Microsoft.Graph.PowerShell.SchemaExtensions
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSchemaExtension_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.SchemaExtensions.Client.Models.SchemaExtension))]
    public class GetMgSchemaExtension_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.SchemaExtensions.Client.Models.SchemaExtensionCollectionResponse? result;
            try
            {
                result = client.SchemaExtensions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.SchemaExtensions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
