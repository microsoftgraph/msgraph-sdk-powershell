...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Test-MgApplicationSynchronizationJobCredentials.Recording.json'
...
Describe 'Test-MgApplicationSynchronizationJobCredentials' {
