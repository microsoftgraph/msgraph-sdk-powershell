...
### List (Default)
```
Get-MgApplication [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgApplication -InputObject <IIdentityApplicationIdentity> [-ExpandProperty <String[]>]
