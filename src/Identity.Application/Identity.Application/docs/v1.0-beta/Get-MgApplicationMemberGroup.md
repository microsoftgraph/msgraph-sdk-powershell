...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/get-mgapplicationmembergroup
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgApplicationMemberGroup -ApplicationId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgApplicationMemberGroup -InputObject <IIdentityApplicationIdentity>
 -BodyParameter <IPaths1Ezr0XyApplicationsApplicationIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgApplicationMemberGroup -InputObject <IIdentityApplicationIdentity> [-SecurityEnabledOnly] [-Confirm]
