...
```
New-MgApplication [-ApiAcceptMappedClaims] [-ApiKnownClientApplications <String[]>]
 [-ApiOauth2PermissionScopes <IMicrosoftGraphPermissionScope[]>]
 [-ApiPreAuthorizedApplications <IMicrosoftGraphPreAuthorizedApplication1[]>]
 ...
 [-ConnectorGroupApplications <IMicrosoftGraphApplication1[]>] [-ConnectorGroupId <String>]
 [-ConnectorGroupIsDefault] [-ConnectorGroupMembers <IMicrosoftGraphConnector[]>]
 [-ConnectorGroupName <String>] [-ConnectorGroupRegion <String>] [-ConnectorGroupType <String>]
 ...
 [-TokenLifetimePolicies <IMicrosoftGraphTokenLifetimePolicy1[]>] [-WebHomePageUrl <String>]
 [-WebLogoutUrl <String>] [-WebOauth2AllowImplicitFlow] [-WebRedirectUris <String[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphPreAuthorizedApplication1[]
Parameter Sets: CreateExpanded
Aliases:
