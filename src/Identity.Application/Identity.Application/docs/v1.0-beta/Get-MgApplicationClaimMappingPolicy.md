...
### List (Default)
```
Get-MgApplicationClaimMappingPolicy -ApplicationId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgApplicationClaimMappingPolicy -InputObject <IIdentityApplicationIdentity> [-ExpandProperty <String[]>]
