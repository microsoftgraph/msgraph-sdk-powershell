...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/remove-mgapplicationtemplate
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgApplicationTemplate -InputObject <IIdentityApplicationIdentity> [-IfMatch <String>] [-PassThru]
