...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/get-mgapplicationclaimmappingpolicy
schema: 2.0.0
---

# Get-MgApplicationClaimMappingPolicy
...
### List (Default)
```
Get-MgApplicationClaimMappingPolicy -ApplicationId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgApplicationClaimMappingPolicy -ApplicationId <String> -ClaimsMappingPolicyId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationClaimMappingPolicy -InputObject <IIdentityApplicationIdentity> [-Expand <String[]>]
