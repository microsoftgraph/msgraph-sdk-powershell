...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/get-mgapplicationtokenlifetimepolicy
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgApplicationTokenLifetimePolicy -InputObject <IIdentityApplicationIdentity> [-ExpandProperty <String[]>]
