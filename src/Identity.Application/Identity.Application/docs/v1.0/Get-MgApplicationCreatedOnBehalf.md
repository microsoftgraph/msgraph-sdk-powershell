...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/get-mgapplicationcreatedonbehalf
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgApplicationCreatedOnBehalf -InputObject <IIdentityApplicationIdentity> [-ExpandProperty <String[]>]
