...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/new-mgapplication
schema: 2.0.0
---
...
```
New-MgApplication [-AddIns <IMicrosoftGraphAddIn[]>] [-ApiAcceptMappedClaims]
 ...
 [-WebLogoutUrl <String>] [-WebRedirectUris <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
