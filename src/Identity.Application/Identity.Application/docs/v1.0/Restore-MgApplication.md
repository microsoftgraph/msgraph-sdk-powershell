...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/restore-mgapplication
schema: 2.0.0
---
...
### RestoreViaIdentity1
```
Restore-MgApplication -InputObject <IIdentityApplicationIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
