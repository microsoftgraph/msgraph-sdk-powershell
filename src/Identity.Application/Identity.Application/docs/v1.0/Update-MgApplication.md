...
```
Update-MgApplication -ApplicationId <String> [-AddIns <IMicrosoftGraphAddIn[]>] [-ApiAcceptMappedClaims]
 ...
 [-LogoInputFile <String>] [-Oauth2RequirePostResponse]
 ...
 [-WebLogoutUrl <String>] [-WebRedirectUris <String[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgApplication -InputObject <IIdentityApplicationIdentity> [-AddIns <IMicrosoftGraphAddIn[]>]
 [-ApiAcceptMappedClaims] [-ApiKnownClientApplications <String[]>]
