...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.application/invoke-mginstantiateapplicationtemplate
schema: 2.0.0
---
...
```
Invoke-MgInstantiateApplicationTemplate -ApplicationTemplateId <String> [-DisplayName <String>] [-Confirm]
...
```
Invoke-MgInstantiateApplicationTemplate -InputObject <IIdentityApplicationIdentity>
 -BodyParameter <IPathsCuokzfApplicationtemplatesApplicationtemplateIdMicrosoftGraphInstantiatePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgInstantiateApplicationTemplate -InputObject <IIdentityApplicationIdentity> [-DisplayName <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
