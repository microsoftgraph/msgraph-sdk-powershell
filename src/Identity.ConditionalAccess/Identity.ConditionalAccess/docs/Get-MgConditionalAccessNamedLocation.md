...
### List (Default)
```
Get-MgConditionalAccessNamedLocation [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgConditionalAccessNamedLocation -NamedLocationId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgConditionalAccessNamedLocation -InputObject <IIdentityConditionalAccessIdentity> [-Expand <String[]>]
