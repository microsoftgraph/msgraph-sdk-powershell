...
namespace Microsoft.Graph.PowerShell.Users.Actions
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserAssignLicense", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Actions.Client.Models.User))]
    public class InvokeMgUserAssignLicenseCommand : GraphClientCmdlet
    {
