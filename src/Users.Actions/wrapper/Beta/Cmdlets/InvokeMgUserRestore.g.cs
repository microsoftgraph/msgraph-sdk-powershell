...
{
    [GraphRoute("POST", "/users/{user-id}/restore")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserRestore", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Actions.Client.Models.DirectoryObject))]
    public class InvokeMgUserRestoreCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Restore.PostAsync(requestConfiguration =>
                {
