...
namespace Microsoft.Graph.PowerShell.Users.Actions
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserReprocessLicenseAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Actions.Client.Models.User))]
    public class InvokeMgUserReprocessLicenseAssignmentCommand : GraphClientCmdlet
    {
