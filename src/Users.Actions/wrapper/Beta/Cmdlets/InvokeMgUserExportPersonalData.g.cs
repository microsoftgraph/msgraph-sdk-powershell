...
namespace Microsoft.Graph.PowerShell.Users.Actions
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserExportPersonalData", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserExportPersonalDataCommand : GraphClientCmdlet
    {
