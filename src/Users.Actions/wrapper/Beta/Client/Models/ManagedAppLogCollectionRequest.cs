...
namespace Microsoft.Graph.PowerShell.Users.Actions.Client.Models
{
    ...
    public partial class ManagedAppLogCollectionRequest : global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUpload>? UploadedLogs { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUpload> UploadedLogs { get; set; }
#endif
        /// <summary>Represents the current consent status of the associated `managedAppLogCollectionRequest`.</summary>
        public global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUploadConsent? UserLogUploadConsent { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogCollectionRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogCollectionRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogCollectionRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "uploadedLogs", n => { UploadedLogs = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUpload>(global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUpload.CreateFromDiscriminatorValue)?.AsList(); } },
                { "userLogUploadConsent", n => { UserLogUploadConsent = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUploadConsent>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUpload>("uploadedLogs", UploadedLogs);
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Users.Actions.Client.Models.ManagedAppLogUploadConsent>("userLogUploadConsent", UserLogUploadConsent);
