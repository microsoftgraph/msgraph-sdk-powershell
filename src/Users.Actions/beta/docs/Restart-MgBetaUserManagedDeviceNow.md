...
### Reboot (Default)
```
Restart-MgBetaUserManagedDeviceNow -ManagedDeviceId <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgBetaUserManagedDeviceNow -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
