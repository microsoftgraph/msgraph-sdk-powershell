...
### Checkout (Default)
```
Invoke-MgBetaCheckoutUserDriveRoot -DriveId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgBetaCheckoutUserDriveRoot -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
