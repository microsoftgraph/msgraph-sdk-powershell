...
Invoke-MgBetaPreviewUserDriveItem -DriveId <String> -DriveItemId <String> -UserId <String>
 [-AdditionalProperties <Hashtable>] [-AllowEdit] [-Chromeless] [-Page <String>]
 [-ResponseHeadersVariable <String>] [-Viewer <String>] [-Zoom <Double>] [-Headers <IDictionary>] [-Confirm]
...
Invoke-MgBetaPreviewUserDriveItem -InputObject <IUsersActionsIdentity> [-AdditionalProperties <Hashtable>]
 [-AllowEdit] [-Chromeless] [-Page <String>] [-ResponseHeadersVariable <String>] [-Viewer <String>]
