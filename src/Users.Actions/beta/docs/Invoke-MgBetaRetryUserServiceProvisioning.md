...
### Retry (Default)
```
Invoke-MgBetaRetryUserServiceProvisioning -UserId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
