...
### Retry (Default)
```
Invoke-MgBetaRetryUserServiceProvisioning -UserId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity>
