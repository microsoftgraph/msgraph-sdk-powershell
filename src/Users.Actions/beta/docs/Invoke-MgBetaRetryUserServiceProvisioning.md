...
### Retry (Default)
```
Invoke-MgBetaRetryUserServiceProvisioning -UserId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm]
