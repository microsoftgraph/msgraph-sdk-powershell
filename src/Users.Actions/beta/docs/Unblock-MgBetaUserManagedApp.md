...
### Unblock (Default)
```
Unblock-MgBetaUserManagedApp -UserId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnblockViaIdentity
```
Unblock-MgBetaUserManagedApp -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
