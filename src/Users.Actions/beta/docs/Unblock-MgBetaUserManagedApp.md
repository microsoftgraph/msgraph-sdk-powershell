...
### Unblock (Default)
```
Unblock-MgBetaUserManagedApp -UserId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnblockViaIdentity
```
Unblock-MgBetaUserManagedApp -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
