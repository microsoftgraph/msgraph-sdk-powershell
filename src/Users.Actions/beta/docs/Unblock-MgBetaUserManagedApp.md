...
### Unblock (Default)
```
Unblock-MgBetaUserManagedApp -UserId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnblockViaIdentity
```
Unblock-MgBetaUserManagedApp -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
