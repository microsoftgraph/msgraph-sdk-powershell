...
### License (Default)
```
Invoke-MgBetaLicenseUser -UserId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LicenseViaIdentity
```
Invoke-MgBetaLicenseUser -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
