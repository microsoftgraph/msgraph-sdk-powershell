...
### Dismiss (Default)
```
Invoke-MgBetaDismissUserEventReminder -EventId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissUserEventReminder -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
