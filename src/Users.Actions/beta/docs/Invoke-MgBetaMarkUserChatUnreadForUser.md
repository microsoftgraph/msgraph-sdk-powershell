...
Invoke-MgBetaMarkUserChatUnreadForUser -ChatId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 [-LastMessageReadDateTime <DateTime>] [-ResponseHeadersVariable <String>] [-TenantId <String>]
...
```
Invoke-MgBetaMarkUserChatUnreadForUser -InputObject <IUsersActionsIdentity>
 [-AdditionalProperties <Hashtable>] [-LastMessageReadDateTime <DateTime>] [-ResponseHeadersVariable <String>]
