...
### Reenable (Default)
```
Invoke-MgBetaReenableUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReenableViaIdentity
```
Invoke-MgBetaReenableUserManagedDevice -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
