...
### End (Default)
```
Stop-MgBetaUserCloudPcGracePeriod -CloudPcId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EndViaIdentity
```
Stop-MgBetaUserCloudPcGracePeriod -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
