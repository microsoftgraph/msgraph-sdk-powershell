...
### Unfollow (Default)
```
Invoke-MgBetaUnfollowUserDriveRoot -DriveId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgBetaUnfollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
