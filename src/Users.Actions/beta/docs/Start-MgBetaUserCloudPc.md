...
### PowerOn (Default)
```
Start-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PowerOnViaIdentity
```
Start-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
