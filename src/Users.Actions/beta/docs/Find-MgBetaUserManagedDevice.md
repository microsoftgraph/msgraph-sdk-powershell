...
### Locate (Default)
```
Find-MgBetaUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgBetaUserManagedDevice -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
