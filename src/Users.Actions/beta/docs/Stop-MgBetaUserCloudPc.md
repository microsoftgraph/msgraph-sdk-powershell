...
### PowerOff (Default)
```
Stop-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PowerOffViaIdentity
```
Stop-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
