...
Invoke-MgBetaUnarchiveUserPlannerPlan -PlannerPlanId <String> -UserId <String>
 [-AdditionalProperties <Hashtable>] [-Justification <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
...
Invoke-MgBetaUnarchiveUserPlannerPlan -InputObject <IUsersActionsIdentity> [-AdditionalProperties <Hashtable>]
 [-Justification <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths5Cs2PvUsersUserIdPlannerPlansPlannerplanIdMicrosoftGraphUnarchivePostRequestbodyContentApplicationJsonSchema
