...
### Follow (Default)
```
Invoke-MgBetaFollowUserDriveRoot -DriveId <String> -UserId <String> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
