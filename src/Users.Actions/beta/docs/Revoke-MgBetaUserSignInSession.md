...
### Revoke (Default)
```
Revoke-MgBetaUserSignInSession -UserId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgBetaUserSignInSession -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm]
