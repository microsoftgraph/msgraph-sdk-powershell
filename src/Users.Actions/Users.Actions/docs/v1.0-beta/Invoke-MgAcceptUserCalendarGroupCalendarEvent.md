...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgacceptusercalendargroupcalendarevent
schema: 2.0.0
---
...
```
Invoke-MgAcceptUserCalendarGroupCalendarEvent -CalendarGroupId <String> -CalendarId <String> -EventId <String>
...
Invoke-MgAcceptUserCalendarGroupCalendarEvent -CalendarGroupId <String> -CalendarId <String> -EventId <String>
 -UserId <String>
 -BodyParameter <IPathsWalct4UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AcceptViaIdentity1
```
Invoke-MgAcceptUserCalendarGroupCalendarEvent -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsWalct4UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptUserCalendarGroupCalendarEvent -InputObject <IUsersActionsIdentity> [-Comment <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsWalct4UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPathsWalct4UsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema
