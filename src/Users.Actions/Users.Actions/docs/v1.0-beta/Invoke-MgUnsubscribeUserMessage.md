...
### Unsubscribe (Default)
```
Invoke-MgUnsubscribeUserMessage -MessageId <String> -UserId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UnsubscribeViaIdentity
```
Invoke-MgUnsubscribeUserMessage -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
