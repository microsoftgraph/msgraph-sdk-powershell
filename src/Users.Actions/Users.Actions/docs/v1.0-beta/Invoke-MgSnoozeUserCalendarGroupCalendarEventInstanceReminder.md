...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgsnoozeusercalendargroupcalendareventinstancereminder
schema: 2.0.0
---
...
```
Invoke-MgSnoozeUserCalendarGroupCalendarEventInstanceReminder -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -EventId1 <String> -UserId <String> [-NewReminderTimeDateTime <String>]
...
Invoke-MgSnoozeUserCalendarGroupCalendarEventInstanceReminder -CalendarGroupId <String> -CalendarId <String>
 ...
 -BodyParameter <IPaths16Pob1QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnoozeViaIdentity1
```
Invoke-MgSnoozeUserCalendarGroupCalendarEventInstanceReminder -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths16Pob1QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths16Pob1QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths16Pob1QUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdInstancesEventId1MicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
