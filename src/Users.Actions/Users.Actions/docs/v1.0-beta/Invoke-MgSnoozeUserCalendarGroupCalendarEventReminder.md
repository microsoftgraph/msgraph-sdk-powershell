...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgsnoozeusercalendargroupcalendareventreminder
schema: 2.0.0
---
...
```
Invoke-MgSnoozeUserCalendarGroupCalendarEventReminder -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -UserId <String> [-NewReminderTimeDateTime <String>] [-NewReminderTimeZone <String>]
...
Invoke-MgSnoozeUserCalendarGroupCalendarEventReminder -CalendarGroupId <String> -CalendarId <String>
 ...
 -BodyParameter <IPaths1N721HkUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnoozeViaIdentity1
```
Invoke-MgSnoozeUserCalendarGroupCalendarEventReminder -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1N721HkUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1N721HkUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1N721HkUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
