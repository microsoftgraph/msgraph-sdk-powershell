...
# Confirm-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberGroup
...
```
Confirm-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberGroup -UserId <String>
...
### CheckViaIdentity
```
Confirm-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberGroup -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1MgihfkUsersUserIdAuthenticationWindowshelloforbusinessmethodsWindowshelloforbusinessauthenticationmethodIdDeviceMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1MgihfkUsersUserIdAuthenticationWindowshelloforbusinessmethodsWindowshelloforbusinessauthenticationmethodIdDeviceMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1MgihfkUsersUserIdAuthenticationWindowshelloforbusinessmethodsWindowshelloforbusinessauthenticationmethodIdDeviceMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema
