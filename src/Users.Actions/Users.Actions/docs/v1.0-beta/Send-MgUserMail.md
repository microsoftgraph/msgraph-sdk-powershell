...
```
Send-MgUserMail -UserId <String> [-Message <IMicrosoftGraphMessage1>] [-SaveToSentItems] [-PassThru]
...
```
Send-MgUserMail -InputObject <IUsersActionsIdentity> [-Message <IMicrosoftGraphMessage1>] [-SaveToSentItems]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
