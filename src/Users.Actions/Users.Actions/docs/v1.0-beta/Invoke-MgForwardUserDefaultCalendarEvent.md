...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgforwarduserdefaultcalendarevent
schema: 2.0.0
---
...
```
Invoke-MgForwardUserDefaultCalendarEvent -EventId <String> -UserId <String> [-Comment <String>]
 [-ToRecipients <IMicrosoftGraphRecipient[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Forward
```
Invoke-MgForwardUserDefaultCalendarEvent -EventId <String> -UserId <String>
 -BodyParameter <IPaths14Vftw9UsersUserIdCalendarEventsEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ForwardViaIdentity
```
Invoke-MgForwardUserDefaultCalendarEvent -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths14Vftw9UsersUserIdCalendarEventsEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgForwardUserDefaultCalendarEvent -InputObject <IUsersActionsIdentity> [-Comment <String>]
 [-ToRecipients <IMicrosoftGraphRecipient[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths14Vftw9UsersUserIdCalendarEventsEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths14Vftw9UsersUserIdCalendarEventsEventIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
