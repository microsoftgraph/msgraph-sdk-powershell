...
```
Invoke-MgAcceptUserEventInstance -EventId <String> -EventId1 <String> -UserId <String> [-Comment <String>]
...
```
Invoke-MgAcceptUserEventInstance -InputObject <IUsersActionsIdentity> [-Comment <String>] [-SendResponse]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
