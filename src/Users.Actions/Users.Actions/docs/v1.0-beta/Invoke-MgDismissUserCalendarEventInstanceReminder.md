...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissusercalendareventinstancereminder
schema: 2.0.0
---
...
### Dismiss2 (Default)
```
Invoke-MgDismissUserCalendarEventInstanceReminder -CalendarId <String> -EventId <String> -EventId1 <String>
 -UserId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity2
```
Invoke-MgDismissUserCalendarEventInstanceReminder -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm]
...
Parameter Sets: DismissViaIdentity2
Aliases:
