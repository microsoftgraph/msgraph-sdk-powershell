...
### SetExpanded (Default)
```
Set-MgUserManagedDeviceName -ManagedDeviceId <String> -UserId <String> [-DeviceName <String>] [-PassThru]
...
```
Set-MgUserManagedDeviceName -InputObject <IUsersActionsIdentity> [-DeviceName <String>] [-PassThru] [-Confirm]
