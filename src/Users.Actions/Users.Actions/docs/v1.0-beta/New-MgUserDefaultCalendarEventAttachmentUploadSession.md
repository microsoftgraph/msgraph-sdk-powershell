...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/new-mguserdefaultcalendareventattachmentuploadsession
schema: 2.0.0
---
...
```
New-MgUserDefaultCalendarEventAttachmentUploadSession -EventId <String> -UserId <String>
...
```
New-MgUserDefaultCalendarEventAttachmentUploadSession -EventId <String> -UserId <String>
 -BodyParameter <IPaths1Ht4B6AUsersUserIdCalendarEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity2
```
New-MgUserDefaultCalendarEventAttachmentUploadSession -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1Ht4B6AUsersUserIdCalendarEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Ht4B6AUsersUserIdCalendarEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1Ht4B6AUsersUserIdCalendarEventsEventIdAttachmentsMicrosoftGraphCreateuploadsessionPostRequestbodyContentApplicationJsonSchema
