...
### GetExpanded (Default)
```
Get-MgUserOnenoteNotebookFromWebUrl -UserId <String> [-WebUrl <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Get-MgUserOnenoteNotebookFromWebUrl -InputObject <IUsersActionsIdentity> [-WebUrl <String>] [-Confirm]
