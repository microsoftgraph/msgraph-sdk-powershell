...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/get-mgusercalendargroupcalendareventcalendarschedule
schema: 2.0.0
---
...
```
Get-MgUserCalendarGroupCalendarEventCalendarSchedule -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -UserId <String> [-AvailabilityViewInterval <Int32>] [-EndTimeDateTime <String>]
...
Get-MgUserCalendarGroupCalendarEventCalendarSchedule -CalendarGroupId <String> -CalendarId <String>
 ...
 -BodyParameter <IPaths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUserCalendarGroupCalendarEventCalendarSchedule -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgUserCalendarGroupCalendarEventCalendarSchedule -InputObject <IUsersActionsIdentity>
 [-AvailabilityViewInterval <Int32>] [-EndTimeDateTime <String>] [-EndTimeZone <String>]
 [-Schedules <String[]>] [-StartTimeDateTime <String>] [-StartTimeZone <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1IagkehUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdCalendarMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
