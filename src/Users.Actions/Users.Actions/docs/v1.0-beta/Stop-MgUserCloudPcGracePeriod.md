...
### End (Default)
```
Stop-MgUserCloudPcGracePeriod -CloudPcId <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### EndViaIdentity
```
Stop-MgUserCloudPcGracePeriod -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
