...
```
Copy-MgUserMessage -MessageId <String> -UserId <String> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Copy-MgUserMessage -InputObject <IUsersActionsIdentity> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
