...
### Power (Default)
```
Start-MgUserCloudPcOn -CloudPcId <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PowerViaIdentity
```
Start-MgUserCloudPcOn -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
