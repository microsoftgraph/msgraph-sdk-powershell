...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissuserdefaultcalendareventreminder
schema: 2.0.0
---
...
### Dismiss (Default)
```
Invoke-MgDismissUserDefaultCalendarEventReminder -EventId <String> -UserId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissUserDefaultCalendarEventReminder -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
