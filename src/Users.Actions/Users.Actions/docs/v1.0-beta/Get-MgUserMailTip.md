...
### GetExpanded (Default)
```
Get-MgUserMailTip -UserId <String> [-EmailAddresses <String[]>] [-MailTipsOptions <String>] [-Confirm]
...
```
Get-MgUserMailTip -InputObject <IUsersActionsIdentity> [-EmailAddresses <String[]>]
