...
# Restore-MgBetaUserAuthenticationWindowHelloForBusinessMethodDevice
...
### Restore (Default)
```
Restore-MgBetaUserAuthenticationWindowHelloForBusinessMethodDevice -UserId <String>
 -WindowsHelloForBusinessAuthenticationMethodId <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaUserAuthenticationWindowHelloForBusinessMethodDevice -InputObject <IUsersActionsIdentity> [-Confirm]
