...
```
Invoke-MgForwardUserMessage -MessageId <String> -UserId <String> [-Comment <String>]
 [-Message <IMicrosoftGraphMessage1>] [-ToRecipients <IMicrosoftGraphRecipient[]>] [-PassThru] [-Confirm]
...
```
Invoke-MgForwardUserMessage -InputObject <IUsersActionsIdentity> [-Comment <String>]
 [-Message <IMicrosoftGraphMessage1>] [-ToRecipients <IMicrosoftGraphRecipient[]>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
