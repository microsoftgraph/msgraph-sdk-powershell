...
```
Stop-MgUserEvent -EventId <String> -UserId <String> [-Comment <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Stop-MgUserEvent -InputObject <IUsersActionsIdentity> [-Comment <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
