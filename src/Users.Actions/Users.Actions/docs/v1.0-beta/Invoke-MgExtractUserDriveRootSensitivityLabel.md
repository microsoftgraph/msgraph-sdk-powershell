...
### Extract (Default)
```
Invoke-MgBetaExtractUserDriveRootSensitivityLabel -DriveId <String> -UserId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractUserDriveRootSensitivityLabel -InputObject <IUsersActionsIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
