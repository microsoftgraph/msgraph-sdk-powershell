...
### Extract (Default)
```
Invoke-MgExtractUserDriveRootSensitivityLabel -DriveId <String> -UserId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgExtractUserDriveRootSensitivityLabel -InputObject <IUsersActionsIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
