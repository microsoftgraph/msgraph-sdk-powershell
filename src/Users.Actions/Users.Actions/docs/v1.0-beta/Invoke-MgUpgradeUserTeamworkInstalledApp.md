...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgupgradeuserteamworkinstalledapp
schema: 2.0.0
---
...
### Upgrade (Default)
```
Invoke-MgUpgradeUserTeamworkInstalledApp -TeamsAppInstallationId <String> -UserId <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpgradeViaIdentity
```
Invoke-MgUpgradeUserTeamworkInstalledApp -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
