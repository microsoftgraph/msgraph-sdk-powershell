...
### GetExpanded (Default)
```
Get-MgUserMemberGroup -UserId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgUserMemberGroup -InputObject <IUsersActionsIdentity> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
