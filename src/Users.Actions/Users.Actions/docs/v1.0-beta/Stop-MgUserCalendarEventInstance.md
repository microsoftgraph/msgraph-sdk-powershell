...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/stop-mgusercalendareventinstance
schema: 2.0.0
---

# Stop-MgUserCalendarEventInstance
