...
```
Copy-MgUserOnenoteSectionToNotebook -OnenoteSectionId <String> -UserId <String> [-GroupId <String>]
...
```
Copy-MgUserOnenoteSectionToNotebook -InputObject <IUsersActionsIdentity> [-GroupId <String>] [-Id <String>]
