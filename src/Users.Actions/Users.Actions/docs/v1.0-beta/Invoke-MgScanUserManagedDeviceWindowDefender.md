...
```
Invoke-MgScanUserManagedDeviceWindowDefender -ManagedDeviceId <String> -UserId <String> [-QuickScan]
...
```
Invoke-MgScanUserManagedDeviceWindowDefender -InputObject <IUsersActionsIdentity> [-QuickScan] [-PassThru]
