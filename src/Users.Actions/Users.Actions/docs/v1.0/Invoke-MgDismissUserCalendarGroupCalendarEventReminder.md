...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissusercalendargroupcalendareventreminder
schema: 2.0.0
---
...
### Dismiss (Default)
```
Invoke-MgDismissUserCalendarGroupCalendarEventReminder -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissUserCalendarGroupCalendarEventReminder -InputObject <IUsersActionsIdentity> [-PassThru]
