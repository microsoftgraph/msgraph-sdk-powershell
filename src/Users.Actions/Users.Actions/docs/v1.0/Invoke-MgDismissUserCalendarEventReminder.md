...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissusercalendareventreminder
schema: 2.0.0
---
...
### Dismiss2 (Default)
```
Invoke-MgDismissUserCalendarEventReminder -CalendarId <String> -EventId <String> -UserId <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity2
```
Invoke-MgDismissUserCalendarEventReminder -InputObject <IUsersActionsIdentity> [-PassThru] [-Confirm]
