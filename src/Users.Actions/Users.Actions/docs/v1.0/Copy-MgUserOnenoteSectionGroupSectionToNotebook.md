...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/copy-mguseronenotesectiongroupsectiontonotebook
schema: 2.0.0
---
...
```
Copy-MgUserOnenoteSectionGroupSectionToNotebook -OnenoteSectionId <String> -SectionGroupId <String>
...
### CopyViaIdentity1
```
Copy-MgUserOnenoteSectionGroupSectionToNotebook -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsDqjogtUsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Copy-MgUserOnenoteSectionGroupSectionToNotebook -InputObject <IUsersActionsIdentity> [-GroupId <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsDqjogtUsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPathsDqjogtUsersUserIdOnenoteSectiongroupsSectiongroupIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema
