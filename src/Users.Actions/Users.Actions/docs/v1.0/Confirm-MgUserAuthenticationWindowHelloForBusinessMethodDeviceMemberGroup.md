...
This example shows how to use the Confirm-MgUserAuthenticationWindowHelloForBusinessMethodDeviceMemberGroup Cmdlet.
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1MgihfkUsersUserIdAuthenticationWindowshelloforbusinessmethodsWindowshelloforbusinessauthenticationmethodIdDeviceMicrosoftGraphCheckmembergroupsPostRequestbodyContentApplicationJsonSchema
