...
### Recover (Default)
```
Restore-MgUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### RecoverViaIdentity
```
Restore-MgUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
