...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgsnoozeuserdefaultcalendareventreminder
schema: 2.0.0
---
...
```
Invoke-MgSnoozeUserDefaultCalendarEventReminder -EventId <String> -UserId <String>
...
```
Invoke-MgSnoozeUserDefaultCalendarEventReminder -EventId <String> -UserId <String>
 -BodyParameter <IPathsE89WzyUsersUserIdCalendarEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SnoozeViaIdentity1
```
Invoke-MgSnoozeUserDefaultCalendarEventReminder -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsE89WzyUsersUserIdCalendarEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsE89WzyUsersUserIdCalendarEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPathsE89WzyUsersUserIdCalendarEventsEventIdMicrosoftGraphSnoozereminderPostRequestbodyContentApplicationJsonSchema
