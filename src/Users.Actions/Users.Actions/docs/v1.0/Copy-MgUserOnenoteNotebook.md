...
```
Copy-MgUserOnenoteNotebook -NotebookId <String> -UserId <String> [-GroupId <String>]
...
```
Copy-MgUserOnenoteNotebook -InputObject <IUsersActionsIdentity> [-GroupId <String>] [-NotebookFolder <String>]
