...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdeclineusereventcalendarevent
schema: 2.0.0
---
...
```
Invoke-MgDeclineUserEventCalendarEvent -EventId <String> -EventId1 <String> -UserId <String>
...
```
Invoke-MgDeclineUserEventCalendarEvent -EventId <String> -EventId1 <String> -UserId <String>
 -BodyParameter <IPathsWzrwtkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeclineViaIdentity
```
Invoke-MgDeclineUserEventCalendarEvent -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsWzrwtkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgDeclineUserEventCalendarEvent -InputObject <IUsersActionsIdentity> [-Comment <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsWzrwtkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPathsWzrwtkUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema
