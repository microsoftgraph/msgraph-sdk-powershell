...
```
Invoke-MgReplyAllUserMessage -MessageId <String> -UserId <String> [-Comment <String>]
...
```
Invoke-MgReplyAllUserMessage -InputObject <IUsersActionsIdentity> [-Comment <String>]
 [-Message <IMicrosoftGraphMessage>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
