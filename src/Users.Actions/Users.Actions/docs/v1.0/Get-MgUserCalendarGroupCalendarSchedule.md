...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/get-mgusercalendargroupcalendarschedule
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgUserCalendarGroupCalendarSchedule -CalendarGroupId <String> -CalendarId <String> -UserId <String>
...
```
Get-MgUserCalendarGroupCalendarSchedule -CalendarGroupId <String> -CalendarId <String> -UserId <String>
 -BodyParameter <IPaths5Dr3VuUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarSchedule -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths5Dr3VuUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths5Dr3VuUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths5Dr3VuUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdMicrosoftGraphGetschedulePostRequestbodyContentApplicationJsonSchema
