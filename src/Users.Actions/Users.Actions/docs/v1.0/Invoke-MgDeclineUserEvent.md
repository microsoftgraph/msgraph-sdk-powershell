...
```
Invoke-MgDeclineUserEvent -EventId <String> -UserId <String> [-Comment <String>] [-SendResponse] [-PassThru]
...
```
Invoke-MgDeclineUserEvent -InputObject <IUsersActionsIdentity> [-Comment <String>] [-SendResponse] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
