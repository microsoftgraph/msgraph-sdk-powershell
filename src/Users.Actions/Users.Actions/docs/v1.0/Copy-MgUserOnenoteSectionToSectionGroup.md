...
```
Copy-MgUserOnenoteSectionToSectionGroup -OnenoteSectionId <String> -UserId <String> [-GroupId <String>]
...
```
Copy-MgUserOnenoteSectionToSectionGroup -InputObject <IUsersActionsIdentity> [-GroupId <String>]
 [-Id <String>] [-RenameAs <String>] [-SiteCollectionId <String>] [-SiteId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
