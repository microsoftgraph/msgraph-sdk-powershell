...
```
Invoke-MgCleanUserManagedDeviceWindowDevice -ManagedDeviceId <String> -UserId <String> [-KeepUserData]
...
```
Invoke-MgCleanUserManagedDeviceWindowDevice -InputObject <IUsersActionsIdentity> [-KeepUserData] [-PassThru]
