...
```yaml
Type: IPaths121Ojw9UsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
