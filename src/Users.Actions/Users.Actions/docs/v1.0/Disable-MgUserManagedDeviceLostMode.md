...
### Disable (Default)
```
Disable-MgUserManagedDeviceLostMode -ManagedDeviceId <String> -UserId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgUserManagedDeviceLostMode -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
