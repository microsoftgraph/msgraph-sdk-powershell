...
```
Get-MgUserMemberObject -UserId <String> [-SecurityEnabledOnly] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Get-MgUserMemberObject -InputObject <IUsersActionsIdentity> [-SecurityEnabledOnly] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
