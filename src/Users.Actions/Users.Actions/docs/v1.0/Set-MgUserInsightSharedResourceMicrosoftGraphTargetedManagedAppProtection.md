...
```yaml
Type: IPathsT095LbUsersUserIdInsightsSharedSharedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
