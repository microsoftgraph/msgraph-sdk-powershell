...
```
Export-MgUserPersonalData -UserId <String> [-StorageLocation <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Export-MgUserPersonalData -InputObject <IUsersActionsIdentity> [-StorageLocation <String>] [-PassThru]
