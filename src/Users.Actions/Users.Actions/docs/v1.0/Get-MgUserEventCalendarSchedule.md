...
### GetExpanded (Default)
```
Get-MgUserEventCalendarSchedule -EventId <String> -UserId <String> [-AvailabilityViewInterval <Int32>]
...
```
Get-MgUserEventCalendarSchedule -InputObject <IUsersActionsIdentity> [-AvailabilityViewInterval <Int32>]
 [-EndTimeDateTime <String>] [-EndTimeZone <String>] [-Schedules <String[]>] [-StartTimeDateTime <String>]
 [-StartTimeZone <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
