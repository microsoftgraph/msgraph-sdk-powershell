...
```
Move-MgUserMailFolder -MailFolderId <String> -UserId <String> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Move-MgUserMailFolder -InputObject <IUsersActionsIdentity> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
