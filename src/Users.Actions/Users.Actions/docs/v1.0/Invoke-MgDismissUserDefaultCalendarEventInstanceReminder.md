...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissuserdefaultcalendareventinstancereminder
schema: 2.0.0
---
...
### Dismiss (Default)
```
Invoke-MgDismissUserDefaultCalendarEventInstanceReminder -EventId <String> -EventId1 <String> -UserId <String>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissUserDefaultCalendarEventInstanceReminder -InputObject <IUsersActionsIdentity> [-PassThru]
