...
```
Invoke-MgAcceptUserEvent -EventId <String> -UserId <String> [-Comment <String>] [-SendResponse] [-PassThru]
...
```
Invoke-MgAcceptUserEvent -InputObject <IUsersActionsIdentity> [-Comment <String>] [-SendResponse] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
