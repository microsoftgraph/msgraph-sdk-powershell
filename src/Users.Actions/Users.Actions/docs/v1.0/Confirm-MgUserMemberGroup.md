...
```
Confirm-MgUserMemberGroup -UserId <String> [-GroupIds <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Confirm-MgUserMemberGroup -InputObject <IUsersActionsIdentity> [-GroupIds <String[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
