...
```
Copy-MgUserMailFolder -MailFolderId <String> -UserId <String> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Copy-MgUserMailFolder -InputObject <IUsersActionsIdentity> [-DestinationId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
