...
### Locate (Default)
```
Find-MgUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgUserManagedDevice -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
