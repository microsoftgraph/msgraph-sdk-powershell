...
### License (Default)
```
Invoke-MgLicenseUser -UserId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LicenseViaIdentity
```
Invoke-MgLicenseUser -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
