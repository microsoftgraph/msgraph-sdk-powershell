...
### Bypass (Default)
```
Skip-MgUserManagedDeviceActivationLock -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BypassViaIdentity
```
Skip-MgUserManagedDeviceActivationLock -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
