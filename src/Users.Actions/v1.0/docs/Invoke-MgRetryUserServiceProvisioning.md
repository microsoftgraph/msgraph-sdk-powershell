...
### Retry (Default)
```
Invoke-MgRetryUserServiceProvisioning -UserId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
