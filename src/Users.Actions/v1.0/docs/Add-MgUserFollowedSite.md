...
### AddExpanded (Default)
```
Add-MgUserFollowedSite -UserId <String> [-AdditionalProperties <Hashtable>]
...
### AddViaIdentity
```
Add-MgUserFollowedSite -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Add-MgUserFollowedSite -InputObject <IUsersActionsIdentity> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
