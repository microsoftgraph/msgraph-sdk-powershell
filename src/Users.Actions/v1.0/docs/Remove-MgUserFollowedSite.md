...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/remove-mguserfollowedsite
schema: 2.0.0
---
...
```
Remove-MgUserFollowedSite -UserId <String> [-AdditionalProperties <Hashtable>]
...
### RemoveViaIdentity
```
Remove-MgUserFollowedSite -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths4Vl3HqUsersUserIdFollowedsitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Remove-MgUserFollowedSite -InputObject <IUsersActionsIdentity> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
