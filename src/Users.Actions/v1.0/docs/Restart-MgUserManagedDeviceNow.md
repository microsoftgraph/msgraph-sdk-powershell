...
### Reboot (Default)
```
Restart-MgUserManagedDeviceNow -ManagedDeviceId <String> -UserId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgUserManagedDeviceNow -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
