...
### Revoke (Default)
```
Revoke-MgUserSignInSession -UserId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgUserSignInSession -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
