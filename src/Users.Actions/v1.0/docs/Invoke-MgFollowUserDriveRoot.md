...
### Follow (Default)
```
Invoke-MgFollowUserDriveRoot -DriveId <String> -UserId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-Confirm]
