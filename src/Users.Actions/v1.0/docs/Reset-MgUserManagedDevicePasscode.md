...
### Reset (Default)
```
Reset-MgUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
