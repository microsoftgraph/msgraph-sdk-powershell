...
### Disable (Default)
```
Disable-MgUserManagedDeviceLostMode -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgUserManagedDeviceLostMode -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
