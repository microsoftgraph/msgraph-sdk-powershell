...
### Disable (Default)
```
Disable-MgUserManagedDeviceLostMode -ManagedDeviceId <String> -UserId <String>
...
### DisableViaIdentity
```
Disable-MgUserManagedDeviceLostMode -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
