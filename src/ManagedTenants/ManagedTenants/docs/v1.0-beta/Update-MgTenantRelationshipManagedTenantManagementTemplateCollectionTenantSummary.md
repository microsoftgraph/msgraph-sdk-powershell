...
Update-MgTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 ...
 [-TenantId <String>] [-UnlicensedUsersCount <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 ...
 [-UnlicensedUsersCount <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
