...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/remove-mgtenantrelationshipmanagedtenantalertrule
schema: 2.0.0
---

# Remove-MgTenantRelationshipManagedTenantAlertRule
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantAlertRule -ManagedTenantAlertRuleId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantAlertRule -InputObject <IManagedTenantsIdentity> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
