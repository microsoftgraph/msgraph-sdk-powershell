...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/remove-mgtenantrelationshipmanagedtenantemailnotification
schema: 2.0.0
---

# Remove-MgTenantRelationshipManagedTenantEmailNotification
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantEmailNotification -ManagedTenantEmailNotificationId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantEmailNotification -InputObject <IManagedTenantsIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
key: id of managedTenantEmailNotification
