...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/get-mgtenantrelationshipmanagedtenantmanagementtemplatesteptenantsummary
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTenantRelationshipManagedTenantManagementTemplateStepTenantSummary [-ExpandProperty <String[]>]
