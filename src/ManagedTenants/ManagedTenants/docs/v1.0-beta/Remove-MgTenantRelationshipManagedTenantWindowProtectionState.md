...
# Remove-MgTenantRelationshipManagedTenantWindowProtectionState
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantWindowProtectionState -WindowsProtectionStateId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantWindowProtectionState -InputObject <IManagedTenantsIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
