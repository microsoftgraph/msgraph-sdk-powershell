...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/remove-mgtenantrelationshipmanagedtenantdetailedinformation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantDetailedInformation -TenantDetailedInformationId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantDetailedInformation -InputObject <IManagedTenantsIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
