...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/get-mgtenantrelationshipmanagedtenantcustomizedinformation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTenantRelationshipManagedTenantCustomizedInformation [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTenantRelationshipManagedTenantCustomizedInformation -TenantCustomizedInformationId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTenantRelationshipManagedTenantCustomizedInformation -InputObject <IManagedTenantsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
### Example 1: Using the Get-MgTenantRelationshipManagedTenantCustomizedInformation Cmdlet
```powershell
