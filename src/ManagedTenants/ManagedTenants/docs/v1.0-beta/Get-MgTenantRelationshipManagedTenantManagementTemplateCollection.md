...
### List (Default)
```
Get-MgTenantRelationshipManagedTenantManagementTemplateCollection [-Count] [-ExpandProperty <String[]>]
...
### List1
```
Get-MgTenantRelationshipManagedTenantManagementTemplateCollection -ManagementTemplateId <String> [-Count]
