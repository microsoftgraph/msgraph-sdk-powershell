...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/remove-mgtenantrelationshipmanagedtenantmanagementintent
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantManagementIntent -ManagementIntentId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantManagementIntent -InputObject <IManagedTenantsIdentity>
