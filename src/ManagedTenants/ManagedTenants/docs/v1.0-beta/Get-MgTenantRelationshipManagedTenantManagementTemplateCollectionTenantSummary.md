...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/get-mgtenantrelationshipmanagedtenantmanagementtemplatecollectiontenantsummary
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary [-ExpandProperty <String[]>]
