...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/remove-mgtenantrelationshipmanagedtenantalertlog
schema: 2.0.0
---

# Remove-MgTenantRelationshipManagedTenantAlertLog
...
### Delete (Default)
```
Remove-MgTenantRelationshipManagedTenantAlertLog -ManagedTenantAlertLogId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTenantRelationshipManagedTenantAlertLog -InputObject <IManagedTenantsIdentity> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
