...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.managedtenants/get-mgtenantrelationshipmanagedtenantalertrule
schema: 2.0.0
---

# Get-MgTenantRelationshipManagedTenantAlertRule
...
### List (Default)
```
Get-MgTenantRelationshipManagedTenantAlertRule [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTenantRelationshipManagedTenantAlertRule -ManagedTenantAlertRuleId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgTenantRelationshipManagedTenantAlertRule -ManagedTenantAlertId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTenantRelationshipManagedTenantAlertRule -InputObject <IManagedTenantsIdentity>
