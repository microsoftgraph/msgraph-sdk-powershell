...
### List (Default)
```
Get-MgUserCalendarGroupCalendar -CalendarGroupId <String> -UserId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgUserCalendarGroupCalendar -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
