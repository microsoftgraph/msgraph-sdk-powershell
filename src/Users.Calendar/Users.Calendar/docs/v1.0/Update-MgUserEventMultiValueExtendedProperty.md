...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/update-mgusereventmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserEventMultiValueExtendedProperty -InputObject <IUsersCalendarIdentity>
...
```
Update-MgUserEventMultiValueExtendedProperty -InputObject <IUsersCalendarIdentity> [-Id <String>]
