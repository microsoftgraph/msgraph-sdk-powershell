...
### CreateViaIdentity3
```
New-MgUserCalendarView -InputObject <IUsersCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Create3, Create4, Create5, Create6, CreateViaIdentity3, CreateViaIdentity4, CreateViaIdentity5, CreateViaIdentity6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create4, CreateExpanded3, CreateExpanded4, CreateExpanded5, CreateExpanded6, CreateViaIdentityExpanded3, CreateViaIdentityExpanded4, CreateViaIdentityExpanded5, CreateViaIdentityExpanded6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create6, CreateExpanded6
Aliases:
...
Parameter Sets: CreateViaIdentity3, CreateViaIdentity4, CreateViaIdentity5, CreateViaIdentity6, CreateViaIdentityExpanded3, CreateViaIdentityExpanded4, CreateViaIdentityExpanded5, CreateViaIdentityExpanded6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create3, Create4, Create5, Create6, CreateExpanded3, CreateExpanded4, CreateExpanded5, CreateExpanded6
Aliases:
