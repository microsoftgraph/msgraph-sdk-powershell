...
### List1 (Default)
```
Get-MgUserEventCalendarPermission -EventId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgUserEventCalendarPermission -InputObject <IUsersCalendarIdentity> [-ExpandProperty <String[]>]
