...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/get-mgusercalendarviewcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserCalendarViewCalendarMultiValueExtendedProperty -EventId <String> -UserId <String> [-Count]
...
### Get1
```
Get-MgUserCalendarViewCalendarMultiValueExtendedProperty -EventId <String>
...
### GetViaIdentity1
```
Get-MgUserCalendarViewCalendarMultiValueExtendedProperty -InputObject <IUsersCalendarIdentity>
