...
### UpdateViaIdentity1
```
Update-MgUserCalendarEventInstance -InputObject <IUsersCalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Update2, UpdateExpanded1, UpdateExpanded2, UpdateViaIdentityExpanded1, UpdateViaIdentityExpanded2
Aliases:
