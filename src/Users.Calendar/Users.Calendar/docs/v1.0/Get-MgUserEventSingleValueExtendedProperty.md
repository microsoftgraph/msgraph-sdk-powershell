...
### List1 (Default)
```
Get-MgUserEventSingleValueExtendedProperty -EventId <String> -UserId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgUserEventSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity> [-ExpandProperty <String[]>]
