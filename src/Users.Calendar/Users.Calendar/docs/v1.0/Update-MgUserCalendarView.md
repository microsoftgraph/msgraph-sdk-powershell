...
### UpdateViaIdentity3
```
Update-MgUserCalendarView -InputObject <IUsersCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Parameter Sets: Update3, Update4, Update5, Update6, UpdateViaIdentity3, UpdateViaIdentity4, UpdateViaIdentity5, UpdateViaIdentity6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update4, UpdateExpanded3, UpdateExpanded4, UpdateExpanded5, UpdateExpanded6, UpdateViaIdentityExpanded3, UpdateViaIdentityExpanded4, UpdateViaIdentityExpanded5, UpdateViaIdentityExpanded6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update3, Update4, Update5, Update6, UpdateExpanded3, UpdateExpanded4, UpdateExpanded5, UpdateExpanded6
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update6, UpdateExpanded6
Aliases:
...
Parameter Sets: UpdateViaIdentity3, UpdateViaIdentity4, UpdateViaIdentity5, UpdateViaIdentity6, UpdateViaIdentityExpanded3, UpdateViaIdentityExpanded4, UpdateViaIdentityExpanded5, UpdateViaIdentityExpanded6
Aliases:
