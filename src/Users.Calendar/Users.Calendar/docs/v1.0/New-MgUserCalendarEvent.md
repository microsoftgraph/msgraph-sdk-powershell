...
### Create2
```
New-MgUserCalendarEvent -UserId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity2
```
New-MgUserCalendarEvent -InputObject <IUsersCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Create3, CreateExpanded2, CreateExpanded3, CreateViaIdentityExpanded2, CreateViaIdentityExpanded3
Aliases:
