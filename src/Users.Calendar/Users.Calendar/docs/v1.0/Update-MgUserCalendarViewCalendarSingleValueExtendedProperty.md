...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/update-mgusercalendarviewcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgUserCalendarViewCalendarSingleValueExtendedProperty -EventId <String>
...
### UpdateViaIdentity1
```
Update-MgUserCalendarViewCalendarSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
