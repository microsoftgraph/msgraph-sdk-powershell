...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/get-mgusercalendareventsinglevalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserCalendarEventSingleValueExtendedProperty -EventId <String> -UserId <String> [-Count]
...
### Get
```
Get-MgUserCalendarEventSingleValueExtendedProperty -CalendarId <String> -EventId <String>
...
### Get1
```
Get-MgUserCalendarEventSingleValueExtendedProperty -EventId <String>
 -SingleValueLegacyExtendedPropertyId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgUserCalendarEventSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity> [-Expand <String[]>]
...
### List
```
Get-MgUserCalendarEventSingleValueExtendedProperty -CalendarId <String> -EventId <String> -UserId <String>
