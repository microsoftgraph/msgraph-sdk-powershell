...
### List (Default)
```
Get-MgUserCalendarViewCalendarPermission -EventId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserCalendarViewCalendarPermission -InputObject <IUsersCalendarIdentity> [-ExpandProperty <String[]>]
