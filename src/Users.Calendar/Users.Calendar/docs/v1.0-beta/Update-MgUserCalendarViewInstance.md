...
### UpdateViaIdentity
```
Update-MgUserCalendarViewInstance -InputObject <IUsersCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
...
```
Update-MgUserCalendarViewInstance -InputObject <IUsersCalendarIdentity> [-AddressCity <String>]
