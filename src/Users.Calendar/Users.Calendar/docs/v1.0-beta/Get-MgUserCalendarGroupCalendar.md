...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/get-mgusercalendargroupcalendar
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserCalendarGroupCalendar -CalendarGroupId <String> -UserId <String> [-Count]
...
### Get1
```
Get-MgUserCalendarGroupCalendar -CalendarGroupId <String> -CalendarId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgUserCalendarGroupCalendar -InputObject <IUsersCalendarIdentity> [-ExpandProperty <String[]>]
