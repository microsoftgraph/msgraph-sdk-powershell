...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.calendar/update-mgusereventcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgUserEventCalendarSingleValueExtendedProperty -EventId <String>
...
### UpdateViaIdentity
```
Update-MgUserEventCalendarSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserEventCalendarSingleValueExtendedProperty -InputObject <IUsersCalendarIdentity> [-Id <String>]
