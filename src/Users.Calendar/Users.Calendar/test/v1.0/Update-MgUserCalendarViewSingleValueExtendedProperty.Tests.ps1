...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgUserCalendarViewSingleValueExtendedProperty.Recording.json'
...
Describe 'Update-MgUserCalendarViewSingleValueExtendedProperty' {
