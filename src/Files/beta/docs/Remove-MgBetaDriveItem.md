...
### Delete (Default)
```
Remove-MgBetaDriveItem -DriveId <String> -DriveItemId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaDriveItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
