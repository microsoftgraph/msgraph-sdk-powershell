...
### Follow (Default)
```
Invoke-MgBetaFollowDriveRoot -DriveId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
