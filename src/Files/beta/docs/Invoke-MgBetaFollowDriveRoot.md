...
### Follow (Default)
```
Invoke-MgBetaFollowDriveRoot -DriveId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
