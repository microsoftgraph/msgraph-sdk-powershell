...
### Delta (Default)
```
Get-MgBetaDriveItemDelta -DriveId <String> -DriveItemId <String> [-ExpandProperty <String[]>]
...
### Delta1
```
Get-MgBetaDriveItemDelta -DriveId <String> -DriveItemId <String> -Token <String> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-All] [-CountVariable <String>] [-Headers <IDictionary>]
 [-PageSize <Int32>] [<CommonParameters>]
```
...
### DeltaViaIdentity
```
Get-MgBetaDriveItemDelta -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
