...
### Set (Default)
```
Set-MgBetaUserDriveSpecialContentStream -DriveId <String> -DriveItemId <String> -UserId <String>
...
### SetViaIdentity
```
Set-MgBetaUserDriveSpecialContentStream -InputObject <IFilesIdentity> -InFile <String> [-Data <Stream>]
