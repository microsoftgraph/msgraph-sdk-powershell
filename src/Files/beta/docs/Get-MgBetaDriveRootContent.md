...
### Get (Default)
```
Get-MgBetaDriveRootContent -DriveId <String> -OutFile <String> [-Format <String>] [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveRootContent -InputObject <IFilesIdentity> -OutFile <String> [-Format <String>]
