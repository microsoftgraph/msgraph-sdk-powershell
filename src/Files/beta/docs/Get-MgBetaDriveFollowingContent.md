...
### Get (Default)
```
Get-MgBetaDriveFollowingContent -DriveId <String> -DriveItemId <String> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveFollowingContent -InputObject <IFilesIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
