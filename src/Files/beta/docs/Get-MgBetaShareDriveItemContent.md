...
### Get (Default)
```
Get-MgBetaShareDriveItemContent -SharedDriveItemId <String> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaShareDriveItemContent -InputObject <IFilesIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
