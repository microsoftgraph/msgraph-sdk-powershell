...
### Checkout (Default)
```
Invoke-MgBetaCheckoutDriveRoot -DriveId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgBetaCheckoutDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
