...
### Checkout (Default)
```
Invoke-MgBetaCheckoutDriveRoot -DriveId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgBetaCheckoutDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
