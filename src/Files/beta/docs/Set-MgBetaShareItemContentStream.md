...
# Set-MgBetaShareItemContentStream
...
### Set (Default)
```
Set-MgBetaShareItemContentStream -DriveItemId <String> -SharedDriveItemId <String> -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaShareItemContentStream -InputObject <IFilesIdentity> -InFile <String> [-Data <Stream>]
