...
### Checkout (Default)
```
Invoke-MgCheckoutDriveRoot -DriveId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
