...
### Checkout (Default)
```
Invoke-MgCheckoutDriveRoot -DriveId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
