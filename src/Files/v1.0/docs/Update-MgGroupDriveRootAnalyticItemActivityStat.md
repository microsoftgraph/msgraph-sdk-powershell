...
Update-MgGroupDriveRootAnalyticItemActivityStat -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgGroupDriveRootAnalyticItemActivityStat -InputObject <IFilesIdentity>
 ...
 [-Move <IMicrosoftGraphItemActionStat>] [-StartDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm]
