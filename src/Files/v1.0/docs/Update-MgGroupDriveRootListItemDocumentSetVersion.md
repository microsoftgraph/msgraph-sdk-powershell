...
```
Update-MgGroupDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 -GroupId <String> -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-Headers <IDictionary>] [-Confirm]
...
Update-MgGroupDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
