...
### Follow (Default)
```
Invoke-MgFollowDriveItem -DriveId <String> -DriveItemId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowDriveItem -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
