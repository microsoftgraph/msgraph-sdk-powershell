...
### Delta (Default)
```
Get-MgDriveItemDelta -DriveId <String> -DriveItemId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Delta1
```
Get-MgDriveItemDelta -DriveId <String> -DriveItemId <String> -Token <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgDriveItemDelta -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
