...
### Reauthorize (Default)
```
Invoke-MgReauthorizeDriveListSubscription -DriveId <String> -SubscriptionId <String>
...
```
Invoke-MgReauthorizeDriveListSubscription -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
