...
### Get (Default)
```
Get-MgDriveRootListItemActivityByInterval -DriveId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDriveRootListItemActivityByInterval -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
