...
### Delete (Default)
```
Remove-MgDriveItem -DriveId <String> -DriveItemId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgDriveItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
