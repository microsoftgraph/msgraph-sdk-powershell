...
```
Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -GroupId <String>
 -ListItemId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-Headers <IDictionary>] [-Confirm]
...
Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
