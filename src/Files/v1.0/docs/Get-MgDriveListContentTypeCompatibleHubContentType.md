...
### Get (Default)
```
Get-MgDriveListContentTypeCompatibleHubContentType -DriveId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDriveListContentTypeCompatibleHubContentType -InputObject <IFilesIdentity> [-Count]
