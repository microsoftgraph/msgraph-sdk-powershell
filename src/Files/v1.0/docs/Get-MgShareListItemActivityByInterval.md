...
### Get2 (Default)
```
Get-MgShareListItemActivityByInterval -SharedDriveItemId <String> [-Count] [-ExpandProperty <String[]>]
...
Get-MgShareListItemActivityByInterval -EndDateTime <String> -Interval <String> -ListItemId <String>
 -SharedDriveItemId <String> -StartDateTime <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgShareListItemActivityByInterval -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
