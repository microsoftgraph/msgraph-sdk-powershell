...
### Unpublish (Default)
```
Unpublish-MgDriveListContentType -ContentTypeId <String> -DriveId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgDriveListContentType -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
