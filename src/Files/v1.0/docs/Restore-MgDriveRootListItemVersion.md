...
### Restore (Default)
```
Restore-MgDriveRootListItemVersion -DriveId <String> -ListItemVersionId <String> [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveRootListItemVersion -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru]
