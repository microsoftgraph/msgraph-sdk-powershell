...
### Restore (Default)
```
Restore-MgDriveRootListItemVersion -DriveId <String> -ListItemVersionId <String>
...
### RestoreViaIdentity
```
Restore-MgDriveRootListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
