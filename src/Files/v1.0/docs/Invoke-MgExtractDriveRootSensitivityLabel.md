...
### Extract (Default)
```
Invoke-MgExtractDriveRootSensitivityLabel -DriveId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgExtractDriveRootSensitivityLabel -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-Confirm]
