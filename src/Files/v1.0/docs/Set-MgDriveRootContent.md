...
### Set (Default)
```
Set-MgDriveRootContent -DriveId <String> -InFile <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
 [-ContentType <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgDriveRootContent -InputObject <IFilesIdentity> -InFile <String> [-Data <Stream>]
