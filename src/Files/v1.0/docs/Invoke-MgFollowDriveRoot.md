...
### Follow (Default)
```
Invoke-MgFollowDriveRoot -DriveId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
