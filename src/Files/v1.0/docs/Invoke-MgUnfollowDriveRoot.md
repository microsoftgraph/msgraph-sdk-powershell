...
### Unfollow (Default)
```
Invoke-MgUnfollowDriveRoot -DriveId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
