...
### Create
```
New-MgDriveRootPermission -DriveId <String> -BodyParameter <IMicrosoftGraphPermission> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission> [-Confirm]
