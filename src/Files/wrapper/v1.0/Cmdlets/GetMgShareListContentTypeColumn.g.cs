...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columns")]
    [Cmdlet(VerbsCommon.Get, "MgShareListContentTypeColumn", DefaultParameterSetName = "List")]
    ...
    public class GetMgShareListContentTypeColumnCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgShareListContentTypeColumn_Get or Get-MgShareListContentTypeColumn_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgShareListContentTypeColumn_Get" : "Get-MgShareListContentTypeColumn_List";
            try
            {
