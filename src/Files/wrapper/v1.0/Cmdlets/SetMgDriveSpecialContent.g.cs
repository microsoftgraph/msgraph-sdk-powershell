...
{
    [GraphRoute("PUT", "/drives/{drive-id}/special/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgDriveSpecialContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgDriveSpecialContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Drives[DriveId].Special[DriveItemId].Content.PutAsync(content, requestConfiguration =>
                {
