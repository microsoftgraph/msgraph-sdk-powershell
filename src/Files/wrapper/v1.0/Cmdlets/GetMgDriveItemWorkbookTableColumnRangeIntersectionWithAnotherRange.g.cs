...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/range()/intersection(anotherRange='{anotherRange}')")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookTableColumnRangeIntersectionWithAnotherRange")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookTableColumnRangeIntersectionWithAnotherRangeCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.RangeNamespace.IntersectionWithAnotherRange.IntersectionWithAnotherRangeRequestBuilder(pathParameters, requestAdapter);
