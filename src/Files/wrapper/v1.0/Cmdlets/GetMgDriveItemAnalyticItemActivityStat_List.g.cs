...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDriveItemAnalyticItemActivityStat_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ItemActivityStat))]
    public class GetMgDriveItemAnalyticItemActivityStat_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Files.Client.Models.ItemActivityStatCollectionResponse? result;
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Analytics.ItemActivityStats.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Drives[DriveId].Items[DriveItemId].Analytics.ItemActivityStats.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
