...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    public class SetMgDriveItemVersionContentCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DriveItemVersionId));
                return;
            }
