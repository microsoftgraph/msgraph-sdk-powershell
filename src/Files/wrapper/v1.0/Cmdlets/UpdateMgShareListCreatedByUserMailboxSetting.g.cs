...
{
    [GraphRoute("PATCH", "/shares/{sharedDriveItem-id}/list/createdByUser/mailboxSettings")]
    [Cmdlet(VerbsData.Update, "MgShareListCreatedByUserMailboxSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.MailboxSettings))]
    public class UpdateMgShareListCreatedByUserMailboxSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(WorkingHours)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.CreatedByUser.MailboxSettings.PatchAsync(body, requestConfiguration =>
                {
