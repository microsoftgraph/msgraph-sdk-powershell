...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/workbook/functions/ecma_Ceiling")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDriveItemWorkbookFunctionEcma_Ceiling", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookFunctionResult))]
    public class InvokeMgDriveItemWorkbookFunctionEcma_CeilingCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Functions.Ecma_Ceiling.Ecma_CeilingPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Significance)))
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Workbook.Functions.Ecma_Ceiling.PostAsync(body, requestConfiguration =>
                {
