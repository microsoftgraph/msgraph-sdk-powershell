...
{
    [GraphRoute("PUT", "/shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content")]
    [Cmdlet(VerbsCommon.Set, "MgShareListItemDriveItemContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgShareListItemDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Shares[SharedDriveItemId].List.Items[ListItemId].DriveItem.Content.PutAsync(content, requestConfiguration =>
                {
