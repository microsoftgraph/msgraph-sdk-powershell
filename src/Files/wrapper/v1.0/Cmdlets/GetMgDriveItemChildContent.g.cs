...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemChildContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveItemChildContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Children[DriveItemId1].Content.GetAsync(requestConfiguration =>
                {
