...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/createLink")]
    [Cmdlet(VerbsCommon.New, "MgDriveItemLink", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.Permission))]
    public class NewMgDriveItemLinkCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.CreateLink.CreateLinkPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Recipients)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].CreateLink.PostAsync(body, requestConfiguration =>
                {
