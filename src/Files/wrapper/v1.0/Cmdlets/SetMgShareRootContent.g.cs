...
{
    [GraphRoute("PUT", "/shares/{sharedDriveItem-id}/root/content")]
    [Cmdlet(VerbsCommon.Set, "MgShareRootContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgShareRootContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Shares[SharedDriveItemId].Root.Content.PutAsync(content, requestConfiguration =>
                {
