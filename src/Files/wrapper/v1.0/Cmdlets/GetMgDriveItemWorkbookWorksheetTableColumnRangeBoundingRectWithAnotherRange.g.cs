...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/range()/boundingRect(anotherRange='{anotherRange}')")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookWorksheetTableColumnRangeBoundingRectWithAnotherRange")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookWorksheetTableColumnRangeBoundingRectWithAnotherRangeCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.RangeNamespace.BoundingRectWithAnotherRange.BoundingRectWithAnotherRangeRequestBuilder(pathParameters, requestAdapter);
