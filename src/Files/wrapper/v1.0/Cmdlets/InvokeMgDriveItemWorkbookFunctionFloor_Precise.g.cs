...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/workbook/functions/floor_Precise")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDriveItemWorkbookFunctionFloor_Precise", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookFunctionResult))]
    public class InvokeMgDriveItemWorkbookFunctionFloor_PreciseCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Functions.Floor_Precise.Floor_PrecisePostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Significance)))
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Workbook.Functions.Floor_Precise.PostAsync(body, requestConfiguration =>
                {
