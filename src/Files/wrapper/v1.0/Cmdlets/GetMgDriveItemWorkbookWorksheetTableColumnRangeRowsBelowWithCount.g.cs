...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/range()/rowsBelow(count={count})")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookWorksheetTableColumnRangeRowsBelowWithCount")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookWorksheetTableColumnRangeRowsBelowWithCountCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.RangeNamespace.RowsBelowWithCount.RowsBelowWithCountRequestBuilder(pathParameters, requestAdapter);
