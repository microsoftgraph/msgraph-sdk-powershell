...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    public class GetMgShareListItemDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Items.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
