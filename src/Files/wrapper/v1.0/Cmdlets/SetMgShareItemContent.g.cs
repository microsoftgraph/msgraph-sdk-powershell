...
{
    [GraphRoute("PUT", "/shares/{sharedDriveItem-id}/items/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgShareItemContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgShareItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Shares[SharedDriveItemId].Items[DriveItemId].Content.PutAsync(content, requestConfiguration =>
                {
