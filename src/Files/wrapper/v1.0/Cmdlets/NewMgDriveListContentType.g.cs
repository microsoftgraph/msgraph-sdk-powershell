...
{
    [GraphRoute("POST", "/drives/{drive-id}/list/contentTypes")]
    [Cmdlet(VerbsCommon.New, "MgDriveListContentType", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ContentType))]
    public class NewMgDriveListContentTypeCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Order)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].List.ContentTypes.PostAsync(body, requestConfiguration =>
                {
