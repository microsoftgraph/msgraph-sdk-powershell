...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgShareListOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.RichLongRunningOperation))]
    public class GetMgShareListOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Operations[RichLongRunningOperationId].GetAsync(requestConfiguration =>
                {
