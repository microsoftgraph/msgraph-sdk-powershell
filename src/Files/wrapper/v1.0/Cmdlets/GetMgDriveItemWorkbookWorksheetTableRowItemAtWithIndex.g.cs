...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/rows/itemAt(index={index})")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookWorksheetTableRowItemAtWithIndex")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow))]
    public class GetMgDriveItemWorkbookWorksheetTableRowItemAtWithIndexCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Rows.ItemAtWithIndex.ItemAtWithIndexRequestBuilder(pathParameters, requestAdapter);
