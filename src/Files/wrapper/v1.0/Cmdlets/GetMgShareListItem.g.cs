...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/listItem")]
    [Cmdlet(VerbsCommon.Get, "MgShareListItem")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ListItem))]
    public class GetMgShareListItemCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].ListItem.GetAsync(requestConfiguration =>
                {
