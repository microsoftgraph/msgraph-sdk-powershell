...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserDrive_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.Drive))]
    public class GetMgUserDrive_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Files.Client.Models.DriveCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Drives.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Drives.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
