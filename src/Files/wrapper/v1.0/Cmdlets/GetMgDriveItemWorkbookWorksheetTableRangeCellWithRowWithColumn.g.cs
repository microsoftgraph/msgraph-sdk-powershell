...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/range()/cell(row={row},column={column})")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookWorksheetTableRangeCellWithRowWithColumn")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookWorksheetTableRangeCellWithRowWithColumnCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.RangeNamespace.CellWithRowWithColumn.CellWithRowWithColumnRequestBuilder(pathParameters, requestAdapter);
