...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgShareListColumn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ColumnDefinition))]
    public class GetMgShareListColumn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Columns[ColumnDefinitionId].GetAsync(requestConfiguration =>
                {
