...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgShare_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.SharedDriveItem))]
    public class GetMgShare_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Files.Client.Models.SharedDriveItemCollectionResponse? result;
            try
            {
                result = client.Shares.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Shares.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
