...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Inv_2T")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDriveItemWorkbookFunctionT_Inv_2T", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookFunctionResult))]
    public class InvokeMgDriveItemWorkbookFunctionT_Inv_2TCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Functions.T_Inv_2T.T_Inv_2TPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(DegFreedom)))
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Workbook.Functions.T_Inv_2T.PostAsync(body, requestConfiguration =>
                {
