...
{
    [GraphRoute("GET", "/drives/{drive-id}/list/items/{listItem-id}/versions")]
    [Cmdlet(VerbsCommon.Get, "MgDriveListItemVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ListItemVersion))]
    public class GetMgDriveListItemVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Files.Client.Models.ListItemVersionCollectionResponse? result;
            try
            {
                result = client.Drives[DriveId].List.Items[ListItemId].Versions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Drives[DriveId].List.Items[ListItemId].Versions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
