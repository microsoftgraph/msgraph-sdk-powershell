...
{
    [GraphRoute("PUT", "/drives/{drive-id}/items/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgDriveItemContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Drives[DriveId].Items[DriveItemId].Content.PutAsync(content, requestConfiguration =>
                {
