...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDriveItemPermission_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.Permission))]
    public class GetMgDriveItemPermission_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Files.Client.Models.PermissionCollectionResponse? result;
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Permissions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Drives[DriveId].Items[DriveItemId].Permissions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
