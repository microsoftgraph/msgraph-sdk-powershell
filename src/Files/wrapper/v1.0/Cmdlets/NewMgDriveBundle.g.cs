...
{
    [GraphRoute("POST", "/drives/{drive-id}/bundles")]
    [Cmdlet(VerbsCommon.New, "MgDriveBundle", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class NewMgDriveBundleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Video)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Bundles.PostAsync(body, requestConfiguration =>
                {
