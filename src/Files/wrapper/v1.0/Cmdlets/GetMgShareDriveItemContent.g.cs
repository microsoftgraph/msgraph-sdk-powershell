...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/driveItem/content")]
    [Cmdlet(VerbsCommon.Get, "MgShareDriveItemContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgShareDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].DriveItem.Content.GetAsync(requestConfiguration =>
                {
