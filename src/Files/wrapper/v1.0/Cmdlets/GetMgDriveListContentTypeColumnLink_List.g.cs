...
namespace Microsoft.Graph.PowerShell.Files
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDriveListContentTypeColumnLink_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ColumnLink))]
    public class GetMgDriveListContentTypeColumnLink_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].List.ContentTypes[ContentTypeId].ColumnLinks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Drives[DriveId].List.ContentTypes[ContentTypeId].ColumnLinks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
