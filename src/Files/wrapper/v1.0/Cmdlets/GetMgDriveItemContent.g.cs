...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Content.GetAsync(requestConfiguration =>
                {
