...
{
    [GraphRoute("PUT", "/drives/{drive-id}/bundles/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgDriveBundleContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgDriveBundleContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Drives[DriveId].Bundles[DriveItemId].Content.PutAsync(content, requestConfiguration =>
                {
