...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/root/content")]
    [Cmdlet(VerbsCommon.Get, "MgShareRootContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgShareRootContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].Root.Content.GetAsync(requestConfiguration =>
                {
