...
{
    [GraphRoute("POST", "/shares/{sharedDriveItem-id}/list/items")]
    [Cmdlet(VerbsCommon.New, "MgShareListItem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ListItem))]
    public class NewMgShareListItemCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SharepointIds)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Items.PostAsync(body, requestConfiguration =>
                {
