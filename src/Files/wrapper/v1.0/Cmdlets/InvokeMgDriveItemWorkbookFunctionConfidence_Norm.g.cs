...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/workbook/functions/confidence_Norm")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDriveItemWorkbookFunctionConfidence_Norm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookFunctionResult))]
    public class InvokeMgDriveItemWorkbookFunctionConfidence_NormCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Functions.Confidence_Norm.Confidence_NormPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Size)))
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Workbook.Functions.Confidence_Norm.PostAsync(body, requestConfiguration =>
                {
