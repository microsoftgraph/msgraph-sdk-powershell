...
{
    [GraphRoute("GET", "/drives/{drive-id}/special/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveSpecialContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveSpecialContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Special[DriveItemId].Content.GetAsync(requestConfiguration =>
                {
