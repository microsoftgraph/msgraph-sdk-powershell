...
{
    [GraphRoute("POST", "/drives/{drive-id}/items/{driveItem-id}/workbook/functions/binom_Dist_Range")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDriveItemWorkbookFunctionBinom_Dist_Range", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookFunctionResult))]
    public class InvokeMgDriveItemWorkbookFunctionBinom_Dist_RangeCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public object? NumberS2 { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Functions.Binom_Dist_Range.Binom_Dist_RangePostRequestBody();
    ...
    if (this.IsParameterBound(nameof(NumberS2)))
    {
        var untypedNumberS2 = UntypedValue.From(NumberS2);
        if (untypedNumberS2 is not null)
            body.NumberS2 = untypedNumberS2;
    }
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Items[DriveItemId].Workbook.Functions.Binom_Dist_Range.PostAsync(body, requestConfiguration =>
                {
