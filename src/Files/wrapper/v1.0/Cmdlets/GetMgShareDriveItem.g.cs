...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/driveItem")]
    [Cmdlet(VerbsCommon.Get, "MgShareDriveItem")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class GetMgShareDriveItemCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].DriveItem.GetAsync(requestConfiguration =>
                {
