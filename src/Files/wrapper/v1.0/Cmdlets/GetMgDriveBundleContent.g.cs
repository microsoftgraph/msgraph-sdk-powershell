...
{
    [GraphRoute("GET", "/drives/{drive-id}/bundles/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveBundleContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveBundleContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Bundles[DriveItemId].Content.GetAsync(requestConfiguration =>
                {
