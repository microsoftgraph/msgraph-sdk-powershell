...
{
    [GraphRoute("GET", "/drives/{drive-id}/root/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveRootContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveRootContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].Root.Content.GetAsync(requestConfiguration =>
                {
