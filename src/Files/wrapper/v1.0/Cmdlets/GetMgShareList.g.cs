...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list")]
    [Cmdlet(VerbsCommon.Get, "MgShareList")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.List))]
    public class GetMgShareListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.GetAsync(requestConfiguration =>
                {
