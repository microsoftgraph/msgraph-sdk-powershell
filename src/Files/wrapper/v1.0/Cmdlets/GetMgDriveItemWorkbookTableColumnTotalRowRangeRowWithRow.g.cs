...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/totalRowRange()/row(row={row})")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookTableColumnTotalRowRangeRowWithRow")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookTableColumnTotalRowRangeRowWithRowCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.TotalRowRange.RowWithRow.RowWithRowRequestBuilder(pathParameters, requestAdapter);
