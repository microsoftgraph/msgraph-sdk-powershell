...
{
    [GraphRoute("PUT", "/drives/{drive-id}/root/content")]
    [Cmdlet(VerbsCommon.Set, "MgDriveRootContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.DriveItem))]
    public class SetMgDriveRootContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Drives[DriveId].Root.Content.PutAsync(content, requestConfiguration =>
                {
