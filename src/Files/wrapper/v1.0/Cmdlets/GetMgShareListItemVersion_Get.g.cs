...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}")]
    [Cmdlet(VerbsCommon.Get, "MgShareListItemVersion_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ListItemVersion))]
    public class GetMgShareListItemVersion_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Items[ListItemId].Versions[ListItemVersionId].GetAsync(requestConfiguration =>
                {
