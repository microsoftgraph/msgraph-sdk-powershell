...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/totalRowRange()/intersection(anotherRange='{anotherRange}')")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookWorksheetTableColumnTotalRowRangeIntersectionWithAnotherRange")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookWorksheetTableColumnTotalRowRangeIntersectionWithAnotherRangeCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.TotalRowRange.IntersectionWithAnotherRange.IntersectionWithAnotherRangeRequestBuilder(pathParameters, requestAdapter);
