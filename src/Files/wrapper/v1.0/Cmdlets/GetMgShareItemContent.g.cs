...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/items/{driveItem-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgShareItemContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgShareItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].Items[DriveItemId].Content.GetAsync(requestConfiguration =>
                {
