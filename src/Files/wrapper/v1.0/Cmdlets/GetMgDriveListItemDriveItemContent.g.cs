...
{
    [GraphRoute("GET", "/drives/{drive-id}/list/items/{listItem-id}/driveItem/content")]
    [Cmdlet(VerbsCommon.Get, "MgDriveListItemDriveItemContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgDriveListItemDriveItemContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].List.Items[ListItemId].DriveItem.Content.GetAsync(requestConfiguration =>
                {
