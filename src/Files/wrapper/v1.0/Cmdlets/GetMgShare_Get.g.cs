...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}")]
    [Cmdlet(VerbsCommon.Get, "MgShare_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.SharedDriveItem))]
    public class GetMgShare_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].GetAsync(requestConfiguration =>
                {
