...
{
    [GraphRoute("GET", "/drives/{drive-id}/items/{driveItem-id}/workbook/tables/{workbookTable-id}/columns/{workbookTableColumn-id}/dataBodyRange()/row(row={row})")]
    [Cmdlet(VerbsCommon.Get, "MgDriveItemWorkbookTableColumnDataBodyRangeRowWithRow")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookRange))]
    public class GetMgDriveItemWorkbookTableColumnDataBodyRangeRowWithRowCommand : GraphClientCmdlet
    {
        ...
        var requestBuilder = new global::Microsoft.Graph.PowerShell.Files.Client.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.DataBodyRange.RowWithRow.RowWithRowRequestBuilder(pathParameters, requestAdapter);
