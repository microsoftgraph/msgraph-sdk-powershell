...
{
    [GraphRoute("GET", "/shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields")]
    [Cmdlet(VerbsCommon.Get, "MgShareListItemField")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.FieldValueSet))]
    public class GetMgShareListItemFieldCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Shares[SharedDriveItemId].List.Items[ListItemId].Fields.GetAsync(requestConfiguration =>
                {
