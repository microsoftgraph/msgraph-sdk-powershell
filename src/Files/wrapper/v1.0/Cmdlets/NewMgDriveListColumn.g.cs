...
{
    [GraphRoute("POST", "/drives/{drive-id}/list/columns")]
    [Cmdlet(VerbsCommon.New, "MgDriveListColumn", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Files.Client.Models.ColumnDefinition))]
    public class NewMgDriveListColumnCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Validation)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Drives[DriveId].List.Columns.PostAsync(body, requestConfiguration =>
                {
