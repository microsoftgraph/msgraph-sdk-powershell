...
namespace Microsoft.Graph.PowerShell.Files.Client.Models
{
    ...
    public partial class WindowsProtectionState : global::Microsoft.Graph.PowerShell.Files.Client.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceMalwareState>? DetectedMalwareState { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceMalwareState> DetectedMalwareState { get; set; }
#endif
        ...
        public global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceHealthState? DeviceState { get; set; }
...
#nullable restore
        ...
        public global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDefenderProductStatus? ProductStatus { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsProtectionState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsProtectionState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsProtectionState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "detectedMalwareState", n => { DetectedMalwareState = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceMalwareState>(global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceMalwareState.CreateFromDiscriminatorValue)?.AsList(); } },
                { "deviceState", n => { DeviceState = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceHealthState>(); } },
                ...
                { "productStatus", n => { ProductStatus = n.GetEnumValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDefenderProductStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceMalwareState>("detectedMalwareState", DetectedMalwareState);
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDeviceHealthState>("deviceState", DeviceState);
            ...
            writer.WriteEnumValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WindowsDefenderProductStatus>("productStatus", ProductStatus);
