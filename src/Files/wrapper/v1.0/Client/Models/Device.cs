...
namespace Microsoft.Graph.PowerShell.Files.Client.Models
{
    ...
    public partial class Device : global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject, IParsable
...
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.AlternativeSecurityId>? AlternativeSecurityIds { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.AlternativeSecurityId> AlternativeSecurityIds { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>? MemberOf { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject> MemberOf { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>? RegisteredOwners { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject> RegisteredOwners { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>? RegisteredUsers { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject> RegisteredUsers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>? TransitiveMemberOf { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject> TransitiveMemberOf { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Microsoft.Graph.PowerShell.Files.Client.Models.Device"/> and sets the default values.
        /// </summary>
        public Device() : base()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Files.Client.Models.Device"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Files.Client.Models.Device CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Files.Client.Models.Device();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "alternativeSecurityIds", n => { AlternativeSecurityIds = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.AlternativeSecurityId>(global::Microsoft.Graph.PowerShell.Files.Client.Models.AlternativeSecurityId.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "memberOf", n => { MemberOf = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>(global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "registeredOwners", n => { RegisteredOwners = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>(global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "registeredUsers", n => { RegisteredUsers = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>(global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "transitiveMemberOf", n => { TransitiveMemberOf = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>(global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.AlternativeSecurityId>("alternativeSecurityIds", AlternativeSecurityIds);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>("memberOf", MemberOf);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>("registeredOwners", RegisteredOwners);
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>("registeredUsers", RegisteredUsers);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.DirectoryObject>("transitiveMemberOf", TransitiveMemberOf);
