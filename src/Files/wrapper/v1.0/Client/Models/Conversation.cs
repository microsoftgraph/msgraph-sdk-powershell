...
namespace Microsoft.Graph.PowerShell.Files.Client.Models
{
    ...
    public partial class Conversation : global::Microsoft.Graph.PowerShell.Files.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.ConversationThread>? Threads { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.ConversationThread> Threads { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Microsoft.Graph.PowerShell.Files.Client.Models.Conversation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Microsoft.Graph.PowerShell.Files.Client.Models.Conversation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Files.Client.Models.Conversation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "threads", n => { Threads = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.ConversationThread>(global::Microsoft.Graph.PowerShell.Files.Client.Models.ConversationThread.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.ConversationThread>("threads", Threads);
