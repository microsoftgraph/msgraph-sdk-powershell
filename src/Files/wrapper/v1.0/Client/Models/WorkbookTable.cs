...
namespace Microsoft.Graph.PowerShell.Files.Client.Models
{
    ...
    public partial class WorkbookTable : global::Microsoft.Graph.PowerShell.Files.Client.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The list of all the columns in the table. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableColumn>? Columns { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableColumn> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow>? Rows { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow> Rows { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableSort? Sort { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableSort Sort { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTable CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTable();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableColumn>(global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableColumn.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rows", n => { Rows = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow>(global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableSort>(global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableSort.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableColumn>("columns", Columns);
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableRow>("rows", Rows);
            ...
            writer.WriteObjectValue<global::Microsoft.Graph.PowerShell.Files.Client.Models.WorkbookTableSort>("sort", Sort);
