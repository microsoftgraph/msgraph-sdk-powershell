...
### Delete3 (Default)
```
Remove-MgShareListItemDriveItemByRef -SharedDriveItemId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
...
### DeleteViaIdentity2
```
Remove-MgShareListItemDriveItemByRef -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
