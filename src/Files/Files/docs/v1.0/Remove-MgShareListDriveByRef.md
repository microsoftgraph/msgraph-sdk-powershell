...
### Delete1 (Default)
```
Remove-MgShareListDriveByRef -SharedDriveItemId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-MgShareListDriveByRef -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
