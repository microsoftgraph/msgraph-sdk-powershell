...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mggroupdriveitempermission
schema: 2.0.0
---
...
```
Update-MgGroupDriveItemPermission -DriveId <String> -DriveItemId <String> -GroupId <String>
 -PermissionId <String> -BodyParameter <IMicrosoftGraphPermission> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
