...
```
Update-MgBetaDriveRootSubscription -DriveId <String> -SubscriptionId <String> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity1
```
Update-MgBetaDriveRootSubscription -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphSubscription1>
