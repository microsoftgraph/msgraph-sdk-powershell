...
### Create1
```
New-MgBetaUserDriveListColumn -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphColumnDefinition1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaUserDriveListColumn -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
