...
```
New-MgBetaUserDriveItemPermission -DriveId <String> -DriveItemId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPermission1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaUserDriveItemPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
