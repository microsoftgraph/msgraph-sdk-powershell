...
```
Update-MgBetaDriveListSubscription -DriveId <String> -SubscriptionId <String> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaDriveListSubscription -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphSubscription1>
