...
online version: https://docs.microsoft.com/en-us/powershell/module/Microsoft.Graph.files/update-mguserdriverootpermission
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveRootPermission -DriveId <String> -PermissionId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPermission1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgBetaUserDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphPermission1
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSharingLink1
Parameter Sets: UpdateExpanded1, UpdateViaIdentityExpanded1
Aliases:
