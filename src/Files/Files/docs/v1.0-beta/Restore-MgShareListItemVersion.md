...
### Restore3 (Default)
```
Restore-MgBetaShareListItemVersion -ListItemVersionId <String> -SharedDriveItemId <String> [-PassThru] [-Confirm]
...
### RestoreViaIdentity2
```
Restore-MgBetaShareListItemVersion -InputObject <IFilesIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
