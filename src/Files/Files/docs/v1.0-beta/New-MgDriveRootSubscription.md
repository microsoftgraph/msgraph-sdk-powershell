...
### Create1
```
New-MgBetaDriveRootSubscription -DriveId <String> -BodyParameter <IMicrosoftGraphSubscription1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaDriveRootSubscription -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphSubscription1>
