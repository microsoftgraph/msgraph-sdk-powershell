...
### Create1
```
New-MgBetaGroupDriveRootThumbnail -DriveId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphThumbnailSet>
...
```
New-MgBetaGroupDriveRootThumbnail -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>] [-Id <String>]
