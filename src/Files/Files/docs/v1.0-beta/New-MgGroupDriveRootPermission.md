...
### Create1
```
New-MgBetaGroupDriveRootPermission -DriveId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphPermission1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaGroupDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
