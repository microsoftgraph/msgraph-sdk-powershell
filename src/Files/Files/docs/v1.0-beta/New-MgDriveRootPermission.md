...
### Create1
```
New-MgDriveRootPermission -DriveId <String> -BodyParameter <IMicrosoftGraphPermission1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1> [-Confirm]
