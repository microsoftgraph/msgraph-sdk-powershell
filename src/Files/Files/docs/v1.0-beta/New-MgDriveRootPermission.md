...
### Create1
```
New-MgBetaDriveRootPermission -DriveId <String> -BodyParameter <IMicrosoftGraphPermission1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1> [-Confirm]
