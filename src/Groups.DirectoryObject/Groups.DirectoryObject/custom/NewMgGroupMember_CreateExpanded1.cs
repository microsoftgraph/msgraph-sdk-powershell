namespace Microsoft.Graph.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"MgGroupMember_CreateExpanded1", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Graph.PowerShell.Profile("v1.0")]
    public partial class NewMgGroupMember_CreateExpanded1 : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMgGroupMember_CreateExpanded1" /> cmdlet class.
        /// </summary>
        public NewMgGroupMember_CreateExpanded1()
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateGroupMember(_apiVersion, GroupId, BodyParameterBody, onCreated, onDefault, this, Pipeline);
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Models.IOdataError> response)
        {
            using (NoSynchronizationContext)
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new System.Management.Automation.ErrorRecord(ex, ex.Code, System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId = GroupId, body = BodyParameterBody })
                    {
                ...
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId = GroupId, body = BodyParameterBody })
                    {
