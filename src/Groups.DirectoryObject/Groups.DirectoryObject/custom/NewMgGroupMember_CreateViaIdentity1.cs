namespace Microsoft.Graph.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"MgGroupMember_CreateViaIdentity1", SupportsShouldProcess = true)]
    ...
    public partial class NewMgGroupMember_CreateViaIdentity1 : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMgGroupMember_CreateViaIdentity1" /> cmdlet class.
        /// </summary>
        public NewMgGroupMember_CreateViaIdentity1()
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateGroupMember(_apiVersion, InputObject.GroupId ?? null, BodyParameter, onCreated, onDefault, this, Pipeline);
