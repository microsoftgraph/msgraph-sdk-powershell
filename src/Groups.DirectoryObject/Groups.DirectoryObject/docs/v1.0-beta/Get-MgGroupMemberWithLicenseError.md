...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.directoryobject/get-mggroupmemberwithlicenseerror
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupMemberWithLicenseError -InputObject <IGroupsDirectoryObjectIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
