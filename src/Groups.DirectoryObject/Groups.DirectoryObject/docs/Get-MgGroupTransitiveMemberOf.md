...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.directoryobject/get-mggrouptransitivememberof
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupTransitiveMemberOf -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupTransitiveMemberOf -DirectoryObjectId <String> -GroupId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupTransitiveMemberOf -InputObject <IGroupsDirectoryObjectIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
