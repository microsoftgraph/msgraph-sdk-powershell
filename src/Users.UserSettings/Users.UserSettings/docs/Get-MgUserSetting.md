...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.usersettings/get-mgusersetting
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserSetting -UserId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserSetting -InputObject <IUsersUserSettingsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
