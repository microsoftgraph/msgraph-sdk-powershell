...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.usersettings/get-mgusersettingregionalandlanguagesetting
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserSettingRegionalAndLanguageSetting -InputObject <IUsersUserSettingsIdentity>
