...
New-MgDataPolicyOperation [-AdditionalProperties <Hashtable>] [-CompletedDateTime <DateTime>] [-Id <String>]
 [-Progress <Double>] [-ResponseHeadersVariable <String>] [-Status <String>] [-StorageLocation <String>]
...
### Create
```
New-MgDataPolicyOperation -BodyParameter <IMicrosoftGraphDataPolicyOperation>
