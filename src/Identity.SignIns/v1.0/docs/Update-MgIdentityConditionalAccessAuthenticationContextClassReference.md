...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference
 ...
 [-DisplayName <String>] [-Id <String>] [-IsAvailable] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference
 ...
 -BodyParameter <IMicrosoftGraphAuthenticationContextClassReference> [-Headers <IDictionary>] [-Confirm]
...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference -InputObject <IIdentitySignInsIdentity>
 ...
 [-IsAvailable] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
