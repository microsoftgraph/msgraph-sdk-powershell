...
Update-MgInvitation -InvitationId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 ...
 [-InvitedUserSponsors <IMicrosoftGraphDirectoryObject[]>] [-InvitedUserType <String>]
 [-InviteRedeemUrl <String>] [-InviteRedirectUrl <String>] [-ResetRedemption]
 [-ResponseHeadersVariable <String>] [-SendInvitationMessage] [-Status <String>] [-Headers <IDictionary>]
