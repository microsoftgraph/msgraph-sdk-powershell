...
Update-MgPolicyPermissionGrantPolicy -PermissionGrantPolicyId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Includes <IMicrosoftGraphPermissionGrantConditionSet[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgPolicyPermissionGrantPolicy -PermissionGrantPolicyId <String>
 -BodyParameter <IMicrosoftGraphPermissionGrantPolicy> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
