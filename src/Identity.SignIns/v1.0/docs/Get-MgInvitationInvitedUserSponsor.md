...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mginvitationinvitedusersponsor
schema: 2.0.0
---
...
### List (Default)
```
Get-MgInvitationInvitedUserSponsor -InvitationId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgInvitationInvitedUserSponsor -DirectoryObjectId <String> -InvitationId <String>
...
### GetViaIdentity
```
Get-MgInvitationInvitedUserSponsor -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
