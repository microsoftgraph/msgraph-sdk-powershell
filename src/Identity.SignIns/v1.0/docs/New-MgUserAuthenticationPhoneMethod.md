...
New-MgUserAuthenticationPhoneMethod -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-PhoneNumber <String>] [-PhoneType <String>] [-ResponseHeadersVariable <String>] [-SmsSignInState <String>]
...
New-MgUserAuthenticationPhoneMethod -InputObject <IIdentitySignInsIdentity>
 ...
 [-ResponseHeadersVariable <String>] [-SmsSignInState <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
