...
New-MgBetaIdentityB2CUserFlowLanguage -B2CIdentityUserFlowId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-OverridesPages <IMicrosoftGraphUserFlowLanguagePage[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaIdentityB2CUserFlowLanguage -B2CIdentityUserFlowId <String>
 -BodyParameter <IMicrosoftGraphUserFlowLanguageConfiguration> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
