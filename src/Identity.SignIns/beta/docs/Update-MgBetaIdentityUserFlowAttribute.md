...
Update-MgBetaIdentityUserFlowAttribute -IdentityUserFlowAttributeId <String>
 ...
 [-Id <String>] [-UserFlowAttributeType <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaIdentityUserFlowAttribute -IdentityUserFlowAttributeId <String>
 -BodyParameter <IMicrosoftGraphIdentityUserFlowAttribute> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
