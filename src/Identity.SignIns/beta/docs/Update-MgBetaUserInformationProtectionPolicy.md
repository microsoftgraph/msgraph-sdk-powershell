...
Update-MgBetaUserInformationProtectionPolicy -UserId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Labels <IMicrosoftGraphInformationProtectionLabel[]>] [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaUserInformationProtectionPolicy -UserId <String>
 -BodyParameter <IMicrosoftGraphInformationProtectionPolicy> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
