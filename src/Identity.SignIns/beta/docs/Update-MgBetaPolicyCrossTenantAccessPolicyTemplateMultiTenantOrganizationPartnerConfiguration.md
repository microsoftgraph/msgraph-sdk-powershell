...
Update-MgBetaPolicyCrossTenantAccessPolicyTemplateMultiTenantOrganizationPartnerConfiguration
 ...
 [-InboundTrust <IMicrosoftGraphCrossTenantAccessPolicyInboundTrust>] [-ResponseHeadersVariable <String>]
 [-TemplateApplicationLevel <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
