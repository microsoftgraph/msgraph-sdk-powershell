...
New-MgBetaUserInformationProtectionPolicyLabel -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Parent <IMicrosoftGraphParentLabelDetails>] [-ResponseHeadersVariable <String>] [-Sensitivity <Int32>]
 [-Tooltip <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgBetaUserInformationProtectionPolicyLabel -InputObject <IIdentitySignInsIdentity>
 ...
 [-Name <String>] [-Parent <IMicrosoftGraphParentLabelDetails>] [-ResponseHeadersVariable <String>]
