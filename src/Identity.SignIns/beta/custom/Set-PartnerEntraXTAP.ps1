...
function Set-PartnerEntraXTAP {
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess($PartnerTenantId, 'Set-PartnerEntraXTAP')) {
            $splat = @{ CrossTenantAccessPolicyConfigurationPartnerTenantId = $PartnerTenantId }
            ...
            $result = Update-MgBetaPolicyCrossTenantAccessPolicyPartner @splat @PSBoundParameters
