...
Update-MgUserAuthenticationPasswordMethod -PasswordAuthenticationMethodId <String> -UserId <String>
 ...
 [-Id <String>] [-Password <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgUserAuthenticationPasswordMethod -PasswordAuthenticationMethodId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPasswordAuthenticationMethod> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mguserauthenticationpasswordmethod](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mguserauthenticationpasswordmethod)
