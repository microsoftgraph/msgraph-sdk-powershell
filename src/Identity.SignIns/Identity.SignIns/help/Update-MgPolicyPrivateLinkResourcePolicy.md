...
Update-MgPolicyPrivateLinkResourcePolicy -PrivateLinkResourcePolicyId <String>
 [-AdditionalProperties <Hashtable>] [-ExternalPrivateLinkId <String>] [-Id <String>]
 [-TenantApprovals <IMicrosoftGraphTenantApprovals[]>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mgpolicyprivatelinkresourcepolicy](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mgpolicyprivatelinkresourcepolicy)
