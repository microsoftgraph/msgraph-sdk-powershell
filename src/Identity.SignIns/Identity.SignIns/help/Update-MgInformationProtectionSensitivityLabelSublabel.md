...
```
Update-MgInformationProtectionSensitivityLabelSublabel -SensitivityLabelId <String>
 -SensitivityLabelId1 <String> -BodyParameter <IMicrosoftGraphSensitivityLabel> [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mginformationprotectionsensitivitylabelsublabel](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mginformationprotectionsensitivitylabelsublabel)
