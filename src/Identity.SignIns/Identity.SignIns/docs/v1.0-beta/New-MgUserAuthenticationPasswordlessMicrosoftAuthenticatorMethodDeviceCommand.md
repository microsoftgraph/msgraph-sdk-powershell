...
# New-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceCommand
...
```
New-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceCommand
 -InputObject <IIdentitySignInsIdentity> -BodyParameter <IMicrosoftGraphCommand> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
