...
# Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceExtension
...
### Get
```
Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceExtension -ExtensionId <String>
 -MicrosoftAuthenticatorAuthenticationMethodId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceExtension -InputObject <IIdentitySignInsIdentity>
