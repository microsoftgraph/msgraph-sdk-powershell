...
# Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberOf
...
### List (Default)
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberOf -UserId <String>
...
### Get
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberOf -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceMemberOf -InputObject <IIdentitySignInsIdentity>
