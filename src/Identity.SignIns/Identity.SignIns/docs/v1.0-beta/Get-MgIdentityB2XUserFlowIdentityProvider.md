...
### GetViaIdentity
```
Get-MgBetaIdentityB2XUserFlowIdentityProvider -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
...
### Example 1: Using the Get-MgBetaIdentityB2XUserFlowIdentityProvider Cmdlet
```powershell
