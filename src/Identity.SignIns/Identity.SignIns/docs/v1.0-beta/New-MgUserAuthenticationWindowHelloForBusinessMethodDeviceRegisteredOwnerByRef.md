...
# New-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceRegisteredOwnerByRef
...
```
New-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceRegisteredOwnerByRef -UserId <String>
