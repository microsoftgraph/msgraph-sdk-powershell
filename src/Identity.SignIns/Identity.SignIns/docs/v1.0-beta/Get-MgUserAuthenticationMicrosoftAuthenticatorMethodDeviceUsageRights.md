...
# Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceUsageRights
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceUsageRights -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
