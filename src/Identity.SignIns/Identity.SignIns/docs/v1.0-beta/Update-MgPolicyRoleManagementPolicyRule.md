...
Update-MgBetaPolicyRoleManagementPolicyRule -UnifiedRoleManagementPolicyId <String>
 ...
 [-Target <IMicrosoftGraphUnifiedRoleManagementPolicyRuleTarget1>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPolicyRoleManagementPolicyRule -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementPolicyRule1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
$params = @{
	...
	Target = @{
		"@odata.type" = "Microsoft.Graph.Beta.unifiedRoleManagementPolicyRuleTarget"
		Caller = "EndUser"
		Operations = @(
			"All"
		)
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUnifiedRoleManagementPolicyRuleTarget1
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
