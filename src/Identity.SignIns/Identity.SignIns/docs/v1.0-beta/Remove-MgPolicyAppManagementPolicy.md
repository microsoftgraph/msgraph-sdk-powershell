...
### Delete (Default)
```
Remove-MgBetaPolicyAppManagementPolicy -AppManagementPolicyId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
...
### Example 1: Using the Remove-MgBetaPolicyAppManagementPolicy Cmdlet
```powershell
