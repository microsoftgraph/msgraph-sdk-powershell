...
# Update-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceCommand
...
```
Update-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceCommand -CommandId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceCommand -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphCommand> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
