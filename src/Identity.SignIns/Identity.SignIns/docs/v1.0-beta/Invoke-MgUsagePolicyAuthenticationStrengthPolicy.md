...
### Usage (Default)
```
Invoke-MgBetaUsagePolicyAuthenticationStrengthPolicy -AuthenticationStrengthPolicyId <String> [<CommonParameters>]
```

### UsageViaIdentity
```
Invoke-MgBetaUsagePolicyAuthenticationStrengthPolicy -InputObject <IIdentitySignInsIdentity> [<CommonParameters>]
```
