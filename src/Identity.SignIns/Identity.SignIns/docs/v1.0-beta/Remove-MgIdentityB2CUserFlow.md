...
### Delete (Default)
```
Remove-MgBetaIdentityB2CUserFlow -B2CIdentityUserFlowId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityB2CUserFlow -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-PassThru]
...
### Example 1: Using the Remove-MgBetaIdentityB2CUserFlow Cmdlet
```powershell
