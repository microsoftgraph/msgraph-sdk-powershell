...
### Delete (Default)
```
Remove-MgIdentityB2CUserFlow -B2CIdentityUserFlowId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgIdentityB2CUserFlow -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-PassThru]
