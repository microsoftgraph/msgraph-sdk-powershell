...
### Delete (Default)
```
Remove-MgBetaPolicyFeatureRolloutPolicyApplyToByRef -DirectoryObjectId <String> -FeatureRolloutPolicyId <String>
...
### Example 1: Using the Remove-MgBetaPolicyFeatureRolloutPolicyApplyToByRef Cmdlet
```powershell
