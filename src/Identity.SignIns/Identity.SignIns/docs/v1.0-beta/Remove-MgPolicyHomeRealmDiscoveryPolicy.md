...
### Delete (Default)
```
Remove-MgBetaPolicyHomeRealmDiscoveryPolicy -HomeRealmDiscoveryPolicyId <String> [-IfMatch <String>] [-PassThru]
...
### Example 1: Using the Remove-MgBetaPolicyHomeRealmDiscoveryPolicy Cmdlet
```powershell
