...
Update-MgIdentityConditionalAccess [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-NamedLocations <IMicrosoftGraphNamedLocation[]>] [-Policies <IMicrosoftGraphConditionalAccessPolicy1[]>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update1
```
Update-MgIdentityConditionalAccess -BodyParameter <IMicrosoftGraphConditionalAccessRoot1> [-PassThru]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphConditionalAccessRoot1
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphConditionalAccessRoot1
...
BODYPARAMETER <IMicrosoftGraphConditionalAccessRoot1>: conditionalAccessRoot
  ...
  - `[Policies <IMicrosoftGraphConditionalAccessPolicy1[]>]`: 
    - `[Id <String>]`: Read-only.
