...
### Create1
```
New-MgIdentityB2XUserFlowIdentityProviderByRef -B2XIdentityUserFlowId <String> -BodyParameter <Hashtable>
...
### Microsoft.Graph.PowerShell.Models.IPaths1ExounrIdentityB2XuserflowsB2XidentityuserflowIdUserflowidentityprovidersRefPostResponses201ContentApplicationJsonSchema
