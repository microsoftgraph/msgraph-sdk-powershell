...
# Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceRegisteredOwner
...
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceRegisteredOwner -UserId <String>
