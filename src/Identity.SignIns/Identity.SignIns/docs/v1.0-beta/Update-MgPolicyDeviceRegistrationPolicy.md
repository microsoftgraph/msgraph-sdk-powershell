...
```
Update-MgPolicyDeviceRegistrationPolicy [-AdditionalProperties <Hashtable>] [-Id <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgPolicyDeviceRegistrationPolicy -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
