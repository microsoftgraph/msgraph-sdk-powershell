...
### List (Default)
```
Get-MgTrustFrameworkKeySet [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgTrustFrameworkKeySet -TrustFrameworkKeySetId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
