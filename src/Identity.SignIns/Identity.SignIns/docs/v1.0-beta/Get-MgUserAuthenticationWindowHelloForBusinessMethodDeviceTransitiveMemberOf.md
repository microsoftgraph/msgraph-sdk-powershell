...
# Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceTransitiveMemberOf
...
### List (Default)
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceTransitiveMemberOf -UserId <String>
...
### Get
```
Get-MgBetaUserAuthenticationWindowHelloForBusinessMethodDeviceTransitiveMemberOf -DirectoryObjectId <String>
