...
# Remove-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceCommand
...
### Delete (Default)
```
Remove-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceCommand -CommandId <String>
