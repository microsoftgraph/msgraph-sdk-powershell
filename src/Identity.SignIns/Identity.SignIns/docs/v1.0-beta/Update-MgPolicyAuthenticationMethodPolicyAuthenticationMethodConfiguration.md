...
Update-MgPolicyAuthenticationMethodPolicyAuthenticationMethodConfiguration
 ...
 [-ExcludeTargets <IMicrosoftGraphExcludeTarget[]>] [-Id <String>] [-State <String>] [-PassThru] [-Confirm]
...
Update-MgPolicyAuthenticationMethodPolicyAuthenticationMethodConfiguration
 ...
 -BodyParameter <IMicrosoftGraphAuthenticationMethodConfiguration1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
