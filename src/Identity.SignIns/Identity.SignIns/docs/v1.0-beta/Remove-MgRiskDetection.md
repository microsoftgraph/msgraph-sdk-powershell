...
### Delete (Default)
```
Remove-MgBetaRiskDetection -RiskDetectionId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaRiskDetection -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
