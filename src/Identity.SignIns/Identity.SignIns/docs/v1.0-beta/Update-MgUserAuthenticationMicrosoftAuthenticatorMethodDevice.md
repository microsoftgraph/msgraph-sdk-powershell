...
# Update-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDevice
...
### UpdateViaIdentity
```
Update-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDevice -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphDevice1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
