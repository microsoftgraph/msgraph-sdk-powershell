...
### Delete (Default)
```
Remove-MgBetaUserAuthenticationMicrosoftAuthenticatorMethod -MicrosoftAuthenticatorAuthenticationMethodId <String>
...
### Example 1: Using the Remove-MgBetaUserAuthenticationMicrosoftAuthenticatorMethod Cmdlet
```powershell
