...
# Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceCommandResponsepayload
...
### Get (Default)
```
Get-MgBetaUserAuthenticationMicrosoftAuthenticatorMethodDeviceCommandResponsepayload -CommandId <String>
