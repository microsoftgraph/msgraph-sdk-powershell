...
### Delete1 (Default)
```
Remove-MgUserAuthenticationWindowHelloForBusinessMethodDeviceExtension -ExtensionId <String> -UserId <String>
...
### DeleteViaIdentity1
```
Remove-MgUserAuthenticationWindowHelloForBusinessMethodDeviceExtension -InputObject <IIdentitySignInsIdentity>
