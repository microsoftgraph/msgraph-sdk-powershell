...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityB2XUserFlowUserAttributeAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityUserFlowAttributeAssignment))]
    public class GetMgIdentityB2XUserFlowUserAttributeAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityUserFlowAttributeAssignmentCollectionResponse? result;
            try
            {
                result = client.Identity.B2xUserFlows[B2xIdentityUserFlowId].UserAttributeAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.B2xUserFlows[B2xIdentityUserFlowId].UserAttributeAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
