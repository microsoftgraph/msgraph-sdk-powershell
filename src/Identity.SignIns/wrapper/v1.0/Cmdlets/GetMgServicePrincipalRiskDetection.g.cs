...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgServicePrincipalRiskDetectionCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? ServicePrincipalRiskDetectionId : null));
                return;
            }
        }
    }
