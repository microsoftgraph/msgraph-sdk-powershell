...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityRiskPreventionWebApplicationFirewallProvider_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.WebApplicationFirewallProvider))]
    public class GetMgIdentityRiskPreventionWebApplicationFirewallProvider_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.WebApplicationFirewallProviderCollectionResponse? result;
            try
            {
                result = client.Identity.RiskPrevention.WebApplicationFirewallProviders.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.RiskPrevention.WebApplicationFirewallProviders.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
