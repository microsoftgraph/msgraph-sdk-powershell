...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgPolicyPermissionGrantPolicyIncludeCountCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, PermissionGrantPolicyId));
                return;
            }
