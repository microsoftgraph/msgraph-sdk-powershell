...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgUserAuthenticationPlatformCredentialMethodCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? PlatformCredentialAuthenticationMethodId : UserId));
                return;
            }
        }
    }
