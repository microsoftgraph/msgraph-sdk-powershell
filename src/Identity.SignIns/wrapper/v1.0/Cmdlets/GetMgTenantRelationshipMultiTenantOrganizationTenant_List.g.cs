...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgTenantRelationshipMultiTenantOrganizationTenant_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.MultiTenantOrganizationMember))]
    public class GetMgTenantRelationshipMultiTenantOrganizationTenant_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.MultiTenantOrganizationMemberCollectionResponse? result;
            try
            {
                result = client.TenantRelationships.MultiTenantOrganization.Tenants.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.TenantRelationships.MultiTenantOrganization.Tenants.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
