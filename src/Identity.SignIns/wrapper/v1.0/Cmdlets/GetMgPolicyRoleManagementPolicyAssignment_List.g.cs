...
{
    [GraphRoute("GET", "/policies/roleManagementPolicyAssignments")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyRoleManagementPolicyAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.UnifiedRoleManagementPolicyAssignment))]
    public class GetMgPolicyRoleManagementPolicyAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.UnifiedRoleManagementPolicyAssignmentCollectionResponse? result;
            try
            {
                result = client.Policies.RoleManagementPolicyAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.RoleManagementPolicyAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
