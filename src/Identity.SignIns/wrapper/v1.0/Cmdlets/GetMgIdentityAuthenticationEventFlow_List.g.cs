...
{
    [GraphRoute("GET", "/identity/authenticationEventsFlows")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityAuthenticationEventFlow_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationEventsFlow))]
    public class GetMgIdentityAuthenticationEventFlow_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationEventsFlowCollectionResponse? result;
            try
            {
                result = client.Identity.AuthenticationEventsFlows.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.AuthenticationEventsFlows.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
