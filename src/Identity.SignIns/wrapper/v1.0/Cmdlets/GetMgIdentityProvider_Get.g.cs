...
{
    [GraphRoute("GET", "/identity/identityProviders/{identityProviderBase-id}")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityProvider_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityProviderBase))]
    public class GetMgIdentityProvider_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Identity.IdentityProviders[IdentityProviderBaseId].GetAsync(requestConfiguration =>
                {
