...
{
    [GraphRoute("POST", "/identity/apiConnectors")]
    [Cmdlet(VerbsCommon.New, "MgIdentityApiConnector", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityApiConnector))]
    public class NewMgIdentityApiConnectorCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(AuthenticationConfiguration)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Identity.ApiConnectors.PostAsync(body, requestConfiguration =>
                {
