...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class UpdateMgIdentityRiskPreventionWebApplicationFirewallVerificationCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(VerifiedDetails)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, WebApplicationFirewallVerificationModelId));
                return;
            }
