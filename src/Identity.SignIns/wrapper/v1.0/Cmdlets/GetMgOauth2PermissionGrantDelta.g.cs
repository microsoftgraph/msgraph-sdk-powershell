...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgOauth2PermissionGrantDelta")]
    ...
    public class GetMgOauth2PermissionGrantDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Identity.SignIns.Client.Oauth2PermissionGrants.Delta.DeltaGetResponse? result;
            try
            {
                result = client.Oauth2PermissionGrants.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
