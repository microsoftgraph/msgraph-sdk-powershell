...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgPolicyAuthenticationStrengthPolicyCombinationConfigurationCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgPolicyAuthenticationStrengthPolicyCombinationConfiguration_Get" : "Get-MgPolicyAuthenticationStrengthPolicyCombinationConfiguration_List";
            try
            {
