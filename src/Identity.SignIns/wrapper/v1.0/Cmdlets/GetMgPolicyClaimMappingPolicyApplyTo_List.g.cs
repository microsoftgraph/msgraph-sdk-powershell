...
{
    [GraphRoute("GET", "/policies/claimsMappingPolicies/{claimsMappingPolicy-id}/appliesTo")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyClaimMappingPolicyApplyTo_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.DirectoryObject))]
    public class GetMgPolicyClaimMappingPolicyApplyTo_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.ClaimsMappingPolicies[ClaimsMappingPolicyId].AppliesTo.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.ClaimsMappingPolicies[ClaimsMappingPolicyId].AppliesTo.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
