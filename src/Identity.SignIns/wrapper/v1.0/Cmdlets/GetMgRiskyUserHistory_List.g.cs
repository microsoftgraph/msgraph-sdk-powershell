...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRiskyUserHistory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.RiskyUserHistoryItem))]
    public class GetMgRiskyUserHistory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.RiskyUserHistoryItemCollectionResponse? result;
            try
            {
                result = client.IdentityProtection.RiskyUsers[RiskyUserId].History.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.IdentityProtection.RiskyUsers[RiskyUserId].History.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
