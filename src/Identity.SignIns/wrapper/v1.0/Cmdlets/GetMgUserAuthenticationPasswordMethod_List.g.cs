...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserAuthenticationPasswordMethod_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.PasswordAuthenticationMethod))]
    public class GetMgUserAuthenticationPasswordMethod_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.PasswordAuthenticationMethodCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Authentication.PasswordMethods.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Authentication.PasswordMethods.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
