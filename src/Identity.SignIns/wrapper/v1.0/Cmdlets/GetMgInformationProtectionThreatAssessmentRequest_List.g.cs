...
{
    [GraphRoute("GET", "/informationProtection/threatAssessmentRequests")]
    [Cmdlet(VerbsCommon.Get, "MgInformationProtectionThreatAssessmentRequest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ThreatAssessmentRequest))]
    public class GetMgInformationProtectionThreatAssessmentRequest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ThreatAssessmentRequestCollectionResponse? result;
            try
            {
                result = client.InformationProtection.ThreatAssessmentRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.InformationProtection.ThreatAssessmentRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
