...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityAuthenticationEventFlowIncludeApplication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationConditionApplication))]
    public class GetMgIdentityAuthenticationEventFlowIncludeApplication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Identity.AuthenticationEventsFlows[AuthenticationEventsFlowId].Conditions.Applications.IncludeApplications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.AuthenticationEventsFlows[AuthenticationEventsFlowId].Conditions.Applications.IncludeApplications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
