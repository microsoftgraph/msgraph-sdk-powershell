...
{
    [GraphRoute("GET", "/oauth2PermissionGrants/{oAuth2PermissionGrant-id}")]
    [Cmdlet(VerbsCommon.Get, "MgOauth2PermissionGrant_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.OAuth2PermissionGrant))]
    public class GetMgOauth2PermissionGrant_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Oauth2PermissionGrants[OAuth2PermissionGrantId].GetAsync(requestConfiguration =>
                {
