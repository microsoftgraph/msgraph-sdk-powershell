...
{
    [GraphRoute("GET", "/users/{user-id}/authentication/externalAuthenticationMethods")]
    [Cmdlet(VerbsCommon.Get, "MgUserAuthenticationExternalAuthenticationMethod_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ExternalAuthenticationMethod))]
    public class GetMgUserAuthenticationExternalAuthenticationMethod_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ExternalAuthenticationMethodCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Authentication.ExternalAuthenticationMethods.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Authentication.ExternalAuthenticationMethods.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
