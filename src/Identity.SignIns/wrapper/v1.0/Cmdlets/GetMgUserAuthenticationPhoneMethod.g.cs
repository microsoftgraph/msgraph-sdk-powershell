...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgUserAuthenticationPhoneMethodCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? PhoneAuthenticationMethodId : UserId));
                return;
            }
        }
    }
