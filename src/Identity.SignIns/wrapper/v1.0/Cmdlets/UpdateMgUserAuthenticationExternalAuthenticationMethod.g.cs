...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class UpdateMgUserAuthenticationExternalAuthenticationMethodCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(DisplayName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ExternalAuthenticationMethodId));
                return;
            }
