...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgOrganizationCertificateBasedAuthConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.CertificateBasedAuthConfiguration))]
    public class GetMgOrganizationCertificateBasedAuthConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.CertificateBasedAuthConfigurationCollectionResponse? result;
            try
            {
                result = client.Organization[OrganizationId].CertificateBasedAuthConfiguration.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Organization[OrganizationId].CertificateBasedAuthConfiguration.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
