...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPolicyActivityBasedTimeoutPolicyApplyTo_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.DirectoryObject))]
    public class GetMgPolicyActivityBasedTimeoutPolicyApplyTo_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.ActivityBasedTimeoutPolicies[ActivityBasedTimeoutPolicyId].AppliesTo.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.ActivityBasedTimeoutPolicies[ActivityBasedTimeoutPolicyId].AppliesTo.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
