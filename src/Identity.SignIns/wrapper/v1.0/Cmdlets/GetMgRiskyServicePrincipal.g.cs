...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgRiskyServicePrincipalCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? RiskyServicePrincipalId : null));
                return;
            }
        }
    }
