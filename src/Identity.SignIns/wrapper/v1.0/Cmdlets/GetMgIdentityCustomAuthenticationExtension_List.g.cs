...
{
    [GraphRoute("GET", "/identity/customAuthenticationExtensions")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityCustomAuthenticationExtension_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.CustomAuthenticationExtension))]
    public class GetMgIdentityCustomAuthenticationExtension_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.CustomAuthenticationExtensionCollectionResponse? result;
            try
            {
                result = client.Identity.CustomAuthenticationExtensions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.CustomAuthenticationExtensions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
