...
{
    [GraphRoute("GET", "/identity/riskPrevention/fraudProtectionProviders")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityRiskPreventionFraudProtectionProvider_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.FraudProtectionProvider))]
    public class GetMgIdentityRiskPreventionFraudProtectionProvider_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.FraudProtectionProviderCollectionResponse? result;
            try
            {
                result = client.Identity.RiskPrevention.FraudProtectionProviders.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.RiskPrevention.FraudProtectionProviders.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
