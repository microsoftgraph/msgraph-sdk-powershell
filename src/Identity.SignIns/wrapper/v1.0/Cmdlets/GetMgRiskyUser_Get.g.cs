...
{
    [GraphRoute("GET", "/identityProtection/riskyUsers/{riskyUser-id}")]
    [Cmdlet(VerbsCommon.Get, "MgRiskyUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.RiskyUser))]
    public class GetMgRiskyUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.IdentityProtection.RiskyUsers[RiskyUserId].GetAsync(requestConfiguration =>
                {
