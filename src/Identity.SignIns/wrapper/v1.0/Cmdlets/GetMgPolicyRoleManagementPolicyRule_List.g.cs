...
{
    [GraphRoute("GET", "/policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyRoleManagementPolicyRule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.UnifiedRoleManagementPolicyRule))]
    public class GetMgPolicyRoleManagementPolicyRule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.RoleManagementPolicies[UnifiedRoleManagementPolicyId].Rules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.RoleManagementPolicies[UnifiedRoleManagementPolicyId].Rules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
