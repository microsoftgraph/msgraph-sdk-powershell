...
{
    [GraphRoute("POST", "/identity/userFlowAttributes")]
    [Cmdlet(VerbsCommon.New, "MgIdentityUserFlowAttribute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityUserFlowAttribute))]
    public class NewMgIdentityUserFlowAttributeCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserFlowAttributeType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Identity.UserFlowAttributes.PostAsync(body, requestConfiguration =>
                {
