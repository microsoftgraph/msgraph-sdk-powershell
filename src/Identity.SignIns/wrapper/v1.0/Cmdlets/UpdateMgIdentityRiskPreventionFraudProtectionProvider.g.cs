...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class UpdateMgIdentityRiskPreventionFraudProtectionProviderCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(DisplayName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, FraudProtectionProviderId));
                return;
            }
