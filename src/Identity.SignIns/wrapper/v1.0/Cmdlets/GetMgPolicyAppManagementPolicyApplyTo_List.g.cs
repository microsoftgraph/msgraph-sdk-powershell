...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgPolicyAppManagementPolicyApplyTo_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AppManagementPolicyId));
                return;
            }
