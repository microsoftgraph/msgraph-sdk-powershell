...
{
    [GraphRoute("GET", "/policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyAppManagementPolicyApplyTo_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.DirectoryObject))]
    public class GetMgPolicyAppManagementPolicyApplyTo_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.DirectoryObjectCollectionResponse? result;
            try
            {
                result = client.Policies.AppManagementPolicies[AppManagementPolicyId].AppliesTo.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.AppManagementPolicies[AppManagementPolicyId].AppliesTo.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
