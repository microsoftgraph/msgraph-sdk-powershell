...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class UpdateMgTenantRelationshipMultiTenantOrganizationTenantCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TransitionDetails)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, MultiTenantOrganizationMemberId));
                return;
            }
