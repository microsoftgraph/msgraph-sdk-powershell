...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgIdentityConditionalAccessTemplate_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ConditionalAccessTemplateId));
                return;
            }
