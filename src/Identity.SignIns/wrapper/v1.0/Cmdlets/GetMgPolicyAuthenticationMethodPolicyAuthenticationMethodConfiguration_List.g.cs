...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPolicyAuthenticationMethodPolicyAuthenticationMethodConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationMethodConfiguration))]
    public class GetMgPolicyAuthenticationMethodPolicyAuthenticationMethodConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationMethodConfigurationCollectionResponse? result;
            try
            {
                result = client.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
