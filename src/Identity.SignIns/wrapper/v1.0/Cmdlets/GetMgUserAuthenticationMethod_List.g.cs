...
{
    [GraphRoute("GET", "/users/{user-id}/authentication/methods")]
    [Cmdlet(VerbsCommon.Get, "MgUserAuthenticationMethod_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationMethod))]
    public class GetMgUserAuthenticationMethod_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationMethodCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Authentication.Methods.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Authentication.Methods.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
