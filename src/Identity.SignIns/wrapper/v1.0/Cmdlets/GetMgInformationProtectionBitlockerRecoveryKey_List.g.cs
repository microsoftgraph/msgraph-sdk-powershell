...
{
    [GraphRoute("GET", "/informationProtection/bitlocker/recoveryKeys")]
    [Cmdlet(VerbsCommon.Get, "MgInformationProtectionBitlockerRecoveryKey_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.BitlockerRecoveryKey))]
    public class GetMgInformationProtectionBitlockerRecoveryKey_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.BitlockerRecoveryKeyCollectionResponse? result;
            try
            {
                result = client.InformationProtection.Bitlocker.RecoveryKeys.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.InformationProtection.Bitlocker.RecoveryKeys.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
