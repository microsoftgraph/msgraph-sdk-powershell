...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPolicyHomeRealmDiscoveryPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.HomeRealmDiscoveryPolicy))]
    public class GetMgPolicyHomeRealmDiscoveryPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.HomeRealmDiscoveryPolicyCollectionResponse? result;
            try
            {
                result = client.Policies.HomeRealmDiscoveryPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.HomeRealmDiscoveryPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
