...
{
    [GraphRoute("GET", "/identity/apiConnectors")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityApiConnector_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityApiConnector))]
    public class GetMgIdentityApiConnector_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.IdentityApiConnectorCollectionResponse? result;
            try
            {
                result = client.Identity.ApiConnectors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.ApiConnectors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
