...
{
    [GraphRoute("GET", "/policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyRoleManagementPolicy_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.UnifiedRoleManagementPolicy))]
    public class GetMgPolicyRoleManagementPolicy_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.RoleManagementPolicies[UnifiedRoleManagementPolicyId].GetAsync(requestConfiguration =>
                {
