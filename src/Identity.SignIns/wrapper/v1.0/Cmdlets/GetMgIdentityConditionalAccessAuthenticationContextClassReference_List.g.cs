...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgIdentityConditionalAccessAuthenticationContextClassReference_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationContextClassReference))]
    public class GetMgIdentityConditionalAccessAuthenticationContextClassReference_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationContextClassReferenceCollectionResponse? result;
            try
            {
                result = client.Identity.ConditionalAccess.AuthenticationContextClassReferences.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.ConditionalAccess.AuthenticationContextClassReferences.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
