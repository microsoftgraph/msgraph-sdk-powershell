...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgRiskyServicePrincipalHistory_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, RiskyServicePrincipalId));
                return;
            }
