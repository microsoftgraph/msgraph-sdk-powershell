...
{
    [GraphRoute("POST", "/identity/conditionalAccess/policies")]
    [Cmdlet(VerbsCommon.New, "MgIdentityConditionalAccessPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ConditionalAccessPolicy))]
    public class NewMgIdentityConditionalAccessPolicyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Identity.ConditionalAccess.Policies.PostAsync(body, requestConfiguration =>
                {
