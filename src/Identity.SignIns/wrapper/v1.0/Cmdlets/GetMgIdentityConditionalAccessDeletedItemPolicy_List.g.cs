...
{
    [GraphRoute("GET", "/identity/conditionalAccess/deletedItems/policies")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityConditionalAccessDeletedItemPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ConditionalAccessPolicy))]
    public class GetMgIdentityConditionalAccessDeletedItemPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ConditionalAccessPolicyCollectionResponse? result;
            try
            {
                result = client.Identity.ConditionalAccess.DeletedItems.Policies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.ConditionalAccess.DeletedItems.Policies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
