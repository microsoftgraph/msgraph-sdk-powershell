...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class RemoveMgInformationProtectionThreatAssessmentRequestResultCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ThreatAssessmentResultId));
                return;
            }
        }
    }
