...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgInformationProtectionBitlockerRecoveryKey_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, BitlockerRecoveryKeyId));
                return;
            }
