...
{
    [GraphRoute("GET", "/identity/authenticationEventListeners")]
    [Cmdlet(VerbsCommon.Get, "MgIdentityAuthenticationEventListener_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationEventListener))]
    public class GetMgIdentityAuthenticationEventListener_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.AuthenticationEventListenerCollectionResponse? result;
            try
            {
                result = client.Identity.AuthenticationEventListeners.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Identity.AuthenticationEventListeners.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
