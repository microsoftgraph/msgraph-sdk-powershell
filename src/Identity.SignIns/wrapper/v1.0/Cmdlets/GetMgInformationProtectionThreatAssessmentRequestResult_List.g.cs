...
{
    [GraphRoute("GET", "/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}/results")]
    [Cmdlet(VerbsCommon.Get, "MgInformationProtectionThreatAssessmentRequestResult_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ThreatAssessmentResult))]
    public class GetMgInformationProtectionThreatAssessmentRequestResult_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.ThreatAssessmentResultCollectionResponse? result;
            try
            {
                result = client.InformationProtection.ThreatAssessmentRequests[ThreatAssessmentRequestId].Results.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.InformationProtection.ThreatAssessmentRequests[ThreatAssessmentRequestId].Results.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
