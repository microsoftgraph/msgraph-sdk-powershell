...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserAuthenticationPlatformCredentialMethod_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.PlatformCredentialAuthenticationMethod))]
    public class GetMgUserAuthenticationPlatformCredentialMethod_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.PlatformCredentialAuthenticationMethodCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Authentication.PlatformCredentialMethods.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Authentication.PlatformCredentialMethods.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
