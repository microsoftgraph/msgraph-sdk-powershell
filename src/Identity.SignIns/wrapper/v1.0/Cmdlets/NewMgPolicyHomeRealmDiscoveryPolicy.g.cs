...
{
    [GraphRoute("POST", "/policies/homeRealmDiscoveryPolicies")]
    [Cmdlet(VerbsCommon.New, "MgPolicyHomeRealmDiscoveryPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.HomeRealmDiscoveryPolicy))]
    public class NewMgPolicyHomeRealmDiscoveryPolicyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(IsOrganizationDefault)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.HomeRealmDiscoveryPolicies.PostAsync(body, requestConfiguration =>
                {
