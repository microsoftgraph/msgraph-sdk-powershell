...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class RemoveMgPolicyAuthenticationMethodPolicyAuthenticationMethodConfigurationCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AuthenticationMethodConfigurationId));
                return;
            }
        }
    }
