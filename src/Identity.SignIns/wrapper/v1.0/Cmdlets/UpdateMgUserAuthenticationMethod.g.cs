...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class UpdateMgUserAuthenticationMethodCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CreatedDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, AuthenticationMethodId));
                return;
            }
