...
{
    [GraphRoute("GET", "/policies/tokenIssuancePolicies/{tokenIssuancePolicy-id}/appliesTo")]
    [Cmdlet(VerbsCommon.Get, "MgPolicyTokenIssuancePolicyApplyTo_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.SignIns.Client.Models.DirectoryObject))]
    public class GetMgPolicyTokenIssuancePolicyApplyTo_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Policies.TokenIssuancePolicies[TokenIssuancePolicyId].AppliesTo.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Policies.TokenIssuancePolicies[TokenIssuancePolicyId].AppliesTo.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
