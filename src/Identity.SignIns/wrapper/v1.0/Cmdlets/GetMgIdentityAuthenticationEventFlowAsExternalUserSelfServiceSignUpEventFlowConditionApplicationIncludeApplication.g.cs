...
namespace Microsoft.Graph.PowerShell.Identity.SignIns
{
    ...
    public class GetMgIdentityAuthenticationEventFlowAsExternalUserSelfServiceSignUpEventFlowConditionApplicationIncludeApplicationCommand : GraphClientCmdlet
    {
