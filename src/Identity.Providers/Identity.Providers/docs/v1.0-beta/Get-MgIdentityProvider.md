...
### List (Default)
```
Get-MgIdentityProvider [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgIdentityProvider -InputObject <IIdentityProvidersIdentity> [-ExpandProperty <String[]>]
