...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.devices/new-mguserdevice
schema: 2.0.0
---
...
```
New-MgUserDevice -UserId <String> [-AccountEnabled]
 ...
 [-TrustType <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgUserDevice -InputObject <IUsersDevicesIdentity> -BodyParameter <IMicrosoftGraphDevice> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserDevice -InputObject <IUsersDevicesIdentity> [-AccountEnabled]
 [-AlternativeSecurityIds <IMicrosoftGraphAlternativeSecurityId[]>]
 [-ApproximateLastSignInDateTime <DateTime>] [-Commands <IMicrosoftGraphCommand[]>]
 [-ComplianceExpirationDateTime <DateTime>] [-DeletedDateTime <DateTime>] [-DeviceId <String>]
 [-DeviceMetadata <String>] [-DeviceVersion <Int32>] [-DisplayName <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IUsersDevicesIdentity
...
### Microsoft.Graph.PowerShell.Models.IUsersDevicesIdentity
...
INPUTOBJECT <IUsersDevicesIdentity>: Identity Parameter
