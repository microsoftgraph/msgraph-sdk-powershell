...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthreadpost
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupThreadPost -ConversationThreadId <String> -GroupId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgGroupThreadPost -ConversationThreadId <String> -GroupId <String> -PostId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupThreadPost -InputObject <IGroupsConversationThreadIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
