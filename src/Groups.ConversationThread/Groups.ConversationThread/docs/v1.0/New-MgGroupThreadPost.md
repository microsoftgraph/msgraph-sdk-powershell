...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/new-mggroupthreadpost
schema: 2.0.0
---
...
```
New-MgGroupThreadPost -ConversationThreadId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgGroupThreadPost -InputObject <IGroupsConversationThreadIdentity> -BodyParameter <IMicrosoftGraphPost1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupThreadPost -InputObject <IGroupsConversationThreadIdentity> [-ConversationThreadId <String>]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Body <IMicrosoftGraphItemBody>] [-Categories <String[]>]
