...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/new-mggroupthreadpostattachment
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgGroupThreadPostAttachment -InputObject <IGroupsConversationThreadIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupThreadPostAttachment -InputObject <IGroupsConversationThreadIdentity> [-ContentType <String>]
