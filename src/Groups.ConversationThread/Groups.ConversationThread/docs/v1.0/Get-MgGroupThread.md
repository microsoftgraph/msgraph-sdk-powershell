...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthread
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupThread -GroupId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgGroupThread -InputObject <IGroupsConversationThreadIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
