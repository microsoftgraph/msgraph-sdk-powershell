...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/update-mggroupthreadpostsinglevalueextendedproperty
schema: 2.0.0
---
...
Update-MgGroupThreadPostSingleValueExtendedProperty -ConversationThreadId <String> -GroupId <String>
 -PostId <String> -SingleValueLegacyExtendedPropertyId <String> [-Id <String>] [-Value <String>] [-PassThru]
...
### UpdateViaIdentity
```
Update-MgGroupThreadPostSingleValueExtendedProperty -InputObject <IGroupsConversationThreadIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
