...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthreadpostattachment
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupThreadPostAttachment -ConversationThreadId <String> -GroupId <String> -PostId <String> [-Count]
...
### GetViaIdentity
```
Get-MgGroupThreadPostAttachment -InputObject <IGroupsConversationThreadIdentity> [-ExpandProperty <String[]>]
