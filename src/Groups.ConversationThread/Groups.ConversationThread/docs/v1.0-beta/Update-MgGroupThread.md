...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/update-mggroupthread
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupThread -InputObject <IGroupsConversationThreadIdentity>
 -BodyParameter <IMicrosoftGraphConversationThread1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
