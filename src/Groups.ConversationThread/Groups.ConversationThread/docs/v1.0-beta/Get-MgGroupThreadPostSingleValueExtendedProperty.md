...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/get-mggroupthreadpostsinglevalueextendedproperty
schema: 2.0.0
---
...
Get-MgGroupThreadPostSingleValueExtendedProperty -ConversationThreadId <String> -GroupId <String>
 -PostId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgGroupThreadPostSingleValueExtendedProperty -InputObject <IGroupsConversationThreadIdentity>
