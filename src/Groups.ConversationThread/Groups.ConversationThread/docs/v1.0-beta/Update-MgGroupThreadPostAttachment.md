...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.conversationthread/update-mggroupthreadpostattachment
schema: 2.0.0
---
...
Update-MgGroupThreadPostAttachment -AttachmentId <String> -ConversationThreadId <String> -GroupId <String>
 -PostId <String> [-ContentType <String>] [-Id <String>] [-IsInline] [-LastModifiedDateTime <DateTime>]
...
### UpdateViaIdentity
```
Update-MgGroupThreadPostAttachment -InputObject <IGroupsConversationThreadIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupThreadPostAttachment -InputObject <IGroupsConversationThreadIdentity> [-ContentType <String>]
