...
New-MgCommunicationPresence [-Activity <String>] [-AdditionalProperties <Hashtable>] [-Availability <String>]
 [-Id <String>] [-StatusMessage <IMicrosoftGraphPresenceStatusMessage>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgCommunicationPresence -BodyParameter <IMicrosoftGraphPresence> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
