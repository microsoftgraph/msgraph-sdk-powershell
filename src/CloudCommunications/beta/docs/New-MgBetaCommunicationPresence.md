...
New-MgBetaCommunicationPresence [-Activity <String>] [-AdditionalProperties <Hashtable>]
 ...
 [-StatusMessage <IMicrosoftGraphPresenceStatusMessage>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaCommunicationPresence -BodyParameter <IMicrosoftGraphPresence> [-Headers <IDictionary>] [-Confirm]
