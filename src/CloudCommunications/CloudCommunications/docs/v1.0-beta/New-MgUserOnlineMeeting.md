...
New-MgUserOnlineMeeting -UserId <String> [-AccessLevel <String>] [-AdditionalProperties <Hashtable>]
 [-AudioConferencing <IMicrosoftGraphAudioConferencing>] [-CanceledDateTime <DateTime>]
 ...
 [-Id <String>] [-IsBroadcast] [-IsCancelled] [-JoinInformation <IMicrosoftGraphItemBody>] [-JoinUrl <String>]
...
New-MgUserOnlineMeeting -InputObject <ICloudCommunicationsIdentity> [-AccessLevel <String>]
 [-AdditionalProperties <Hashtable>] [-AudioConferencing <IMicrosoftGraphAudioConferencing>]
 [-CanceledDateTime <DateTime>] [-Capabilities <String[]>] [-ChatInfo <IMicrosoftGraphChatInfo>]
