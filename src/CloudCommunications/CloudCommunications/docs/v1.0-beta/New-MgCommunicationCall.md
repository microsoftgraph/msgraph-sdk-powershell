...
```
New-MgCommunicationCall [-ActiveModalities <String[]>] [-AnsweredByCountryCode <String>]
 ...
 [-ToneInfoSequenceId <Int64>] [-ToneInfoTone <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
