...
Update-MgCommunicationOnlineMeeting -OnlineMeetingId <String> [-AccessLevel <String>]
 ...
 [-AlternativeRecordingInputFile <String>] [-AttendanceReports <IMicrosoftGraphMeetingAttendanceReport[]>]
 ...
 [-Transcripts <IMicrosoftGraphCallTranscript[]>] [-VideoTeleconferenceId <String>] [-PassThru] [-Confirm]
