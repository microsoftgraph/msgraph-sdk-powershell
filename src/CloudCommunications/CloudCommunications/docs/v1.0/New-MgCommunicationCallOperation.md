...
### Create1
```
New-MgCommunicationCallOperation -CallId <String> -BodyParameter <IMicrosoftGraphCommsOperation1> [-Confirm]
...
New-MgCommunicationCallOperation -InputObject <ICloudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphCommsOperation1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCommsOperation1
...
BODYPARAMETER <IMicrosoftGraphCommsOperation1>: commsOperation
  - `[Id <String>]`: Read-only.
