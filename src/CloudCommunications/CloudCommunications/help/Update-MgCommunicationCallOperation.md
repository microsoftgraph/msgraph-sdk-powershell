...
Update-MgCommunicationCallOperation -CallId <String> -CommsOperationId <String>
 ...
 [-ResultInfo <IMicrosoftGraphResultInfo1>] [-Status <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgCommunicationCallOperation -CallId <String> -CommsOperationId <String>
 -BodyParameter <IMicrosoftGraphCommsOperation1> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.cloudcommunications/update-mgcommunicationcalloperation](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.cloudcommunications/update-mgcommunicationcalloperation)
