...
New-MgCommunicationCall [-ActiveModalities <String[]>] [-AdditionalProperties <Hashtable>]
 ...
 [-RequestedModalities <String[]>] [-ResultInfo <IMicrosoftGraphResultInfo1>]
...
Read-only.
  ...
  \[Operations \<IMicrosoftGraphCommsOperation\[\]\>\]: Read-only.
Nullable.
    \[Id \<String\>\]: Read-only.
...
Max limit is 256 chars.
  ...
  \[Participants \<IMicrosoftGraphParticipant\[\]\>\]: Read-only.
Nullable.
    \[Id \<String\>\]: Read-only.
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.cloudcommunications/new-mgcommunicationcall](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.cloudcommunications/new-mgcommunicationcall)
