...
{
    [GraphRoute("POST", "/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation-id}/starter/replies/{engagementConversationMessage-id}/reactions")]
    [Cmdlet(VerbsCommon.New, "MgCommunicationOnlineMeetingConversationStarterReplyReaction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.EngagementConversationMessageReaction))]
    public class NewMgCommunicationOnlineMeetingConversationStarterReplyReactionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ReactionType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.OnlineMeetingConversations[OnlineMeetingEngagementConversationId].Starter.Replies[EngagementConversationMessageId].Reactions.PostAsync(body, requestConfiguration =>
                {
