...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCallTranscriptDelta")]
    ...
    public class GetMgCommunicationAdhocCallTranscriptDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.CloudCommunications.Client.Communications.AdhocCalls.Item.Transcripts.Delta.DeltaGetResponse? result;
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Transcripts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
