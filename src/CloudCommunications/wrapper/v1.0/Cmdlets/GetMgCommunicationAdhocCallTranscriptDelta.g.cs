        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Communications.AdhocCalls[AdhocCallId].Transcripts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Communications.AdhocCalls[AdhocCallId].Transcripts.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
