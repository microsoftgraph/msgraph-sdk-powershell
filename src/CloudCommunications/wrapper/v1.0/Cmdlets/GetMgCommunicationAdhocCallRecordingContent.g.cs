...
{
    [GraphRoute("GET", "/communications/adhocCalls/{adhocCall-id}/recordings/{callRecording-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCallRecordingContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgCommunicationAdhocCallRecordingContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Recordings[CallRecordingId].Content.GetAsync(requestConfiguration =>
                {
