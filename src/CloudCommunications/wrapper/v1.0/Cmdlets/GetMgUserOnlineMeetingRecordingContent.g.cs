...
{
    [GraphRoute("GET", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/recordings/{callRecording-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingRecordingContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnlineMeetingRecordingContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Recordings[CallRecordingId].Content.GetAsync(requestConfiguration =>
                {
