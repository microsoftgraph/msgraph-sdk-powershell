...
{
    [GraphRoute("GET", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/attendanceReports")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingAttendanceReport_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.MeetingAttendanceReport))]
    public class GetMgUserOnlineMeetingAttendanceReport_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].AttendanceReports.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].AttendanceReports.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
