...
{
    [GraphRoute("GET", "/communications/adhocCalls/{adhocCall-id}/transcripts/{callTranscript-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCallTranscriptContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgCommunicationAdhocCallTranscriptContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Transcripts[CallTranscriptId].Content.GetAsync(requestConfiguration =>
                {
