...
{
    [GraphRoute("GET", "/communications/onlineMeetings/{onlineMeeting-id}/attendanceReports")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationOnlineMeetingAttendanceReport_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.MeetingAttendanceReport))]
    public class GetMgCommunicationOnlineMeetingAttendanceReport_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.MeetingAttendanceReportCollectionResponse? result;
            try
            {
                result = client.Communications.OnlineMeetings[OnlineMeetingId].AttendanceReports.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.OnlineMeetings[OnlineMeetingId].AttendanceReports.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
