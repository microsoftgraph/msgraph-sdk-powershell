...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingAttendanceReportAttendanceRecord", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOnlineMeetingAttendanceReportAttendanceRecordCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOnlineMeetingAttendanceReportAttendanceRecord_Get or Get-MgUserOnlineMeetingAttendanceReportAttendanceRecord_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnlineMeetingAttendanceReportAttendanceRecord_Get" : "Get-MgUserOnlineMeetingAttendanceReportAttendanceRecord_List";
            try
            {
