...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCall_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.AdhocCall))]
    public class GetMgCommunicationAdhocCall_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.AdhocCallCollectionResponse? result;
            try
            {
                result = client.Communications.AdhocCalls.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.AdhocCalls.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
