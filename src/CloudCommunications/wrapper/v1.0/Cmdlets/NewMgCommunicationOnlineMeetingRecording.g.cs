...
{
    [GraphRoute("POST", "/communications/onlineMeetings/{onlineMeeting-id}/recordings")]
    [Cmdlet(VerbsCommon.New, "MgCommunicationOnlineMeetingRecording", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecording))]
    public class NewMgCommunicationOnlineMeetingRecordingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MeetingOrganizer)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.OnlineMeetings[OnlineMeetingId].Recordings.PostAsync(body, requestConfiguration =>
                {
