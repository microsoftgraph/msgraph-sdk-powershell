...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgCommunicationCallRecord_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, CallRecordId));
                return;
            }
