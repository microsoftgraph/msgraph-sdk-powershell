...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class InvokeMgMuteCommunicationCallParticipantCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ClientContext)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParticipantId));
                return;
            }
