...
{
    [GraphRoute("POST", "/communications/adhocCalls/{adhocCall-id}/recordings")]
    [Cmdlet(VerbsCommon.New, "MgCommunicationAdhocCallRecording", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecording))]
    public class NewMgCommunicationAdhocCallRecordingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MeetingOrganizer)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Recordings.PostAsync(body, requestConfiguration =>
                {
