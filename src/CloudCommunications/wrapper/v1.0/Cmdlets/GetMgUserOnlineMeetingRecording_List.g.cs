...
{
    [GraphRoute("GET", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/recordings")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingRecording_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecording))]
    public class GetMgUserOnlineMeetingRecording_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecordingCollectionResponse? result;
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Recordings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Recordings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
