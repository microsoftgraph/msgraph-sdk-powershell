...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCallRecordingDelta")]
    ...
    public class GetMgCommunicationAdhocCallRecordingDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Recordings.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
