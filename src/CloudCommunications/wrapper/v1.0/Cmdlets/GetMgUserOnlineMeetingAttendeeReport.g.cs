...
{
    [GraphRoute("GET", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/attendeeReport")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingAttendeeReport")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnlineMeetingAttendeeReportCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].AttendeeReport.GetAsync(requestConfiguration =>
                {
