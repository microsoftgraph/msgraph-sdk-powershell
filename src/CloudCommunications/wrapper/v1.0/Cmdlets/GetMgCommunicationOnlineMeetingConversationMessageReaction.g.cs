...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgCommunicationOnlineMeetingConversationMessageReaction", DefaultParameterSetName = "List")]
    ...
    public class GetMgCommunicationOnlineMeetingConversationMessageReactionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgCommunicationOnlineMeetingConversationMessageReaction_Get or Get-MgCommunicationOnlineMeetingConversationMessageReaction_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgCommunicationOnlineMeetingConversationMessageReaction_Get" : "Get-MgCommunicationOnlineMeetingConversationMessageReaction_List";
            try
            {
