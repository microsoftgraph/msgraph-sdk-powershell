...
{
    [GraphRoute("GET", "/communications/adhocCalls/{adhocCall-id}/recordings")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationAdhocCallRecording_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecording))]
    public class GetMgCommunicationAdhocCallRecording_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.AdhocCalls[AdhocCallId].Recordings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.AdhocCalls[AdhocCallId].Recordings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
