...
{
    [GraphRoute("POST", "/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation-id}/starter/replies")]
    [Cmdlet(VerbsCommon.New, "MgCommunicationOnlineMeetingConversationStarterReply", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.EngagementConversationMessage))]
    public class NewMgCommunicationOnlineMeetingConversationStarterReplyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Conversation)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.OnlineMeetingConversations[OnlineMeetingEngagementConversationId].Starter.Replies.PostAsync(body, requestConfiguration =>
                {
