...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgCommunicationOnlineMeetingConversationStarterReplyReactionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? EngagementConversationMessageReactionId : EngagementConversationMessageId);
                return;
            }
        }
    }
