...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgCommunicationCallRecordParticipantV2Count")]
    [OutputType(typeof(int))]
    public class GetMgCommunicationCallRecordParticipantV2CountCommand : GraphClientCmdlet
    {
