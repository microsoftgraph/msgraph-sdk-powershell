...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingRecording", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOnlineMeetingRecordingCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOnlineMeetingRecording_Get or Get-MgUserOnlineMeetingRecording_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnlineMeetingRecording_Get" : "Get-MgUserOnlineMeetingRecording_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? CallRecordingId : OnlineMeetingId);
                return;
            }
        }
    }
