...
{
    [GraphRoute("GET", "/communications/onlineMeetingConversations")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationOnlineMeetingConversation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.OnlineMeetingEngagementConversation))]
    public class GetMgCommunicationOnlineMeetingConversation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.OnlineMeetingEngagementConversationCollectionResponse? result;
            try
            {
                result = client.Communications.OnlineMeetingConversations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.OnlineMeetingConversations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
