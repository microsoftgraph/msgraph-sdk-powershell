...
{
    [GraphRoute("GET", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/transcripts/{callTranscript-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingTranscriptContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnlineMeetingTranscriptContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Transcripts[CallTranscriptId].Content.GetAsync(requestConfiguration =>
                {
