...
{
    [GraphRoute("PUT", "/users/{user-id}/onlineMeetings/{onlineMeeting-id}/recordings/{callRecording-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgUserOnlineMeetingRecordingContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.CallRecording))]
    public class SetMgUserOnlineMeetingRecordingContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Recordings[CallRecordingId].Content.PutAsync(content, requestConfiguration =>
                {
