...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgCommunicationPresenceCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? PresenceId : null));
                return;
            }
        }
    }
