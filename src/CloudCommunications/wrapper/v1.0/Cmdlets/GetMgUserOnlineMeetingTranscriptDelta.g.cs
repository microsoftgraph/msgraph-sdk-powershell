...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgUserOnlineMeetingTranscriptDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.CloudCommunications.Client.Users.Item.OnlineMeetings.Item.Transcripts.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Users[UserId].OnlineMeetings[OnlineMeetingId].Transcripts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Transcripts.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
