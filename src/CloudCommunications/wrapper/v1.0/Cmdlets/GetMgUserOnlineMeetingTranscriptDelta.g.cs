...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOnlineMeetingTranscriptDelta")]
    ...
    public class GetMgUserOnlineMeetingTranscriptDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnlineMeetings[OnlineMeetingId].Transcripts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
