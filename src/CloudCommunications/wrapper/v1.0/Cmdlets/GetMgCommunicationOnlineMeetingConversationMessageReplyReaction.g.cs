...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgCommunicationOnlineMeetingConversationMessageReplyReactionCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgCommunicationOnlineMeetingConversationMessageReplyReaction_Get" : "Get-MgCommunicationOnlineMeetingConversationMessageReplyReaction_List";
            try
            {
