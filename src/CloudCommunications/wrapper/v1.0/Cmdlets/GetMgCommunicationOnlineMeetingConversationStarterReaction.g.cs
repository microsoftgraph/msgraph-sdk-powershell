...
namespace Microsoft.Graph.PowerShell.CloudCommunications
{
    ...
    public class GetMgCommunicationOnlineMeetingConversationStarterReactionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? EngagementConversationMessageReactionId : OnlineMeetingEngagementConversationId);
                return;
            }
        }
    }
