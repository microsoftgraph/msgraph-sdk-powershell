...
{
    [GraphRoute("GET", "/communications/calls/{call-id}/audioRoutingGroups")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationCallAudioRoutingGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.AudioRoutingGroup))]
    public class GetMgCommunicationCallAudioRoutingGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.AudioRoutingGroupCollectionResponse? result;
            try
            {
                result = client.Communications.Calls[CallId].AudioRoutingGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.Calls[CallId].AudioRoutingGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
