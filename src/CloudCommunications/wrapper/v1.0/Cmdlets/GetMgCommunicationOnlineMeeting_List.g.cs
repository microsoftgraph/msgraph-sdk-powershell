...
{
    [GraphRoute("GET", "/communications/onlineMeetings")]
    [Cmdlet(VerbsCommon.Get, "MgCommunicationOnlineMeeting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.OnlineMeeting))]
    public class GetMgCommunicationOnlineMeeting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.OnlineMeetingCollectionResponse? result;
            try
            {
                result = client.Communications.OnlineMeetings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Communications.OnlineMeetings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
