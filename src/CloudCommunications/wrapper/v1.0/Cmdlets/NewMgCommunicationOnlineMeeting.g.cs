...
{
    [GraphRoute("POST", "/communications/onlineMeetings")]
    [Cmdlet(VerbsCommon.New, "MgCommunicationOnlineMeeting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CloudCommunications.Client.Models.OnlineMeeting))]
    public class NewMgCommunicationOnlineMeetingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Participants)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Communications.OnlineMeetings.PostAsync(body, requestConfiguration =>
                {
