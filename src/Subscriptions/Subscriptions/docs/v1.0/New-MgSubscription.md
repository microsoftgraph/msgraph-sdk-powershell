...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.subscriptions/new-mgsubscription
schema: 2.0.0
---
...
```
New-MgSubscription [-ApplicationId <String>] [-ChangeType <String>] [-ClientState <String>]
