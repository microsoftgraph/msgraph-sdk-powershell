...
### List (Default)
```
Get-MgDirectoryFeatureRolloutPolicy [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgDirectoryFeatureRolloutPolicy -FeatureRolloutPolicyId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDirectoryFeatureRolloutPolicy -InputObject <IIdentityDirectoryIdentity> [-Expand <String[]>]
