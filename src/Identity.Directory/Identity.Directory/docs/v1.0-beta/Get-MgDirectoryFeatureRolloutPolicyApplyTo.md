...
### List (Default)
```
Get-MgDirectoryFeatureRolloutPolicyApplyTo -FeatureRolloutPolicyId <String> [-Count]
...
### GetViaIdentity
```
Get-MgDirectoryFeatureRolloutPolicyApplyTo -InputObject <IIdentityDirectoryIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
