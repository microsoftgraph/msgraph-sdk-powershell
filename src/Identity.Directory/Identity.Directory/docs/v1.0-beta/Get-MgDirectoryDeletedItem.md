...
### List1 (Default)
```
Get-MgDirectoryDeletedItem [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity1
```
Get-MgDirectoryDeletedItem -InputObject <IIdentityDirectoryIdentity> [-ExpandProperty <String[]>]
