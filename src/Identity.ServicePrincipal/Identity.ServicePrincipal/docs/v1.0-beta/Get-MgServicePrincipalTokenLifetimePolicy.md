...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/get-mgserviceprincipaltokenlifetimepolicy
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgServicePrincipalTokenLifetimePolicy -ServicePrincipalId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgServicePrincipalTokenLifetimePolicy -InputObject <IIdentityServicePrincipalIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
