...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/new-mgserviceprincipalsynchronizationjob
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgServicePrincipalSynchronizationJob -InputObject <IIdentityServicePrincipalIdentity>
 -BodyParameter <IMicrosoftGraphSynchronizationJob> [-Confirm] [-WhatIf] [<CommonParameters>]
```
