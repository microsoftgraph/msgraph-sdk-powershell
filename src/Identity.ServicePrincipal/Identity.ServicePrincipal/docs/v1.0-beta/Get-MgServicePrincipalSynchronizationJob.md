...
### List (Default)
```
Get-MgServicePrincipalSynchronizationJob -ServicePrincipalId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgServicePrincipalSynchronizationJob -InputObject <IIdentityServicePrincipalIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
