...
### List (Default)
```
Get-MgServicePrincipalMember -ServicePrincipalId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgServicePrincipalMember -DirectoryObjectId <String> -ServicePrincipalId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgServicePrincipalMember -InputObject <IIdentityServicePrincipalIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
