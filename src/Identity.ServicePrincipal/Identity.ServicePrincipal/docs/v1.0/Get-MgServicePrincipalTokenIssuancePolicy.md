...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/get-mgserviceprincipaltokenissuancepolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgServicePrincipalTokenIssuancePolicy -ServicePrincipalId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgServicePrincipalTokenIssuancePolicy -InputObject <IIdentityServicePrincipalIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
