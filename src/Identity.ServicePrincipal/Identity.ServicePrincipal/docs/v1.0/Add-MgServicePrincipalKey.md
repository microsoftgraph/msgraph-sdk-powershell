...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.serviceprincipal/add-mgserviceprincipalkey
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-MgServicePrincipalKey -ServicePrincipalId <String> [-KeyCredentialCustomKeyIdentifierInputFile <String>]
...
### AddViaIdentity
```
Add-MgServicePrincipalKey -InputObject <IIdentityServicePrincipalIdentity>
 -BodyParameter <IPathsN3Fx9GServiceprincipalsServiceprincipalIdMicrosoftGraphAddkeyPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
