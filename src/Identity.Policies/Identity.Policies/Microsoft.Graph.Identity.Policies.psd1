#
# Module manifest for module 'Microsoft.Graph.Identity.Policies'
#
# Generated by: Microsoft Corporation
#
# Generated on: 6/6/2020
#

@{

# Script module or binary module file associated with this manifest.
RootModule = './Microsoft.Graph.Identity.Policies.psm1'
...
GUID = '0c2e41a4-44de-401f-9097-ca4581b6b8d9'
...
RequiredAssemblies = './bin/Microsoft.Graph.Identity.Policies.private.dll'
...
FormatsToProcess = './Microsoft.Graph.Identity.Policies.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
# NestedModules = @()

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-MgPolicyActivityBasedTimeoutPolicy', 
               'Get-MgPolicyAdminConsentRequestPolicy', 
               'Get-MgPolicyClaimMappingPolicy', 
               'Get-MgPolicyConditionalAccessPolicy', 
               'Get-MgPolicyHomeRealmDiscoveryPolicy', 
               'Get-MgPolicyIdentitySecurityDefaultEnforcementPolicy', 
               'Get-MgPolicyRoot', 'Get-MgPolicyTokenIssuancePolicy', 
               ...
               'Update-MgPolicyRoot', 'Update-MgPolicyTokenIssuancePolicy', 
