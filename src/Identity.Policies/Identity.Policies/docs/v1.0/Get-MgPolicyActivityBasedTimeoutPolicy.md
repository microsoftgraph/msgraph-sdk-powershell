...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.policies/get-mgpolicyactivitybasedtimeoutpolicy
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgPolicyActivityBasedTimeoutPolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgPolicyActivityBasedTimeoutPolicy -InputObject <IIdentityPoliciesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
...
key: activityBasedTimeoutPolicy-id of activityBasedTimeoutPolicy
