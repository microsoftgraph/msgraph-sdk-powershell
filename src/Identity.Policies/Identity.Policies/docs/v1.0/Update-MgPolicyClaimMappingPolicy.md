...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.policies/update-mgpolicyclaimmappingpolicy
schema: 2.0.0
---
...
```
Update-MgPolicyClaimMappingPolicy -ClaimsMappingPolicyId <String>
 -BodyParameter <IMicrosoftGraphClaimsMappingPolicy> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgPolicyClaimMappingPolicy -InputObject <IIdentityPoliciesIdentity>
 -BodyParameter <IMicrosoftGraphClaimsMappingPolicy> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
BODYPARAMETER <IMicrosoftGraphClaimsMappingPolicy>: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
  - `[AppliesTo <IMicrosoftGraphDirectoryObject[]>]`: 
    - `[Id <String>]`: Read-only.
    - `[DeletedDateTime <DateTime?>]`: 
