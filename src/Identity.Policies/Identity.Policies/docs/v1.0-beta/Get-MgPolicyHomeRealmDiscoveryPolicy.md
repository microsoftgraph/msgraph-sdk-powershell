...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.policies/get-mgpolicyhomerealmdiscoverypolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgPolicyHomeRealmDiscoveryPolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgPolicyHomeRealmDiscoveryPolicy -InputObject <IIdentityPoliciesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
