...
### List (Default)
```
Get-MgPolicyTokenLifetimePolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgPolicyTokenLifetimePolicy -InputObject <IIdentityPoliciesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
