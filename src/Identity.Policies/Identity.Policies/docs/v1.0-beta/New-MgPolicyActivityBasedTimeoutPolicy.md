...
New-MgPolicyActivityBasedTimeoutPolicy [-AppliesTo <IMicrosoftGraphDirectoryObject[]>]
 ...
 [-Id <String>] [-IsOrganizationDefault] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgPolicyActivityBasedTimeoutPolicy -BodyParameter <IMicrosoftGraphActivityBasedTimeoutPolicy1> [-Confirm]
...
BODYPARAMETER <IMicrosoftGraphActivityBasedTimeoutPolicy1>: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
  - `[AppliesTo <IMicrosoftGraphDirectoryObject[]>]`: 
    - `[Id <String>]`: Read-only.
    - `[DeletedDateTime <DateTime?>]`: 
