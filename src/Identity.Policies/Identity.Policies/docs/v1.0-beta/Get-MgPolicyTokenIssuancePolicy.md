...
### List (Default)
```
Get-MgPolicyTokenIssuancePolicy [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgPolicyTokenIssuancePolicy -InputObject <IIdentityPoliciesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
