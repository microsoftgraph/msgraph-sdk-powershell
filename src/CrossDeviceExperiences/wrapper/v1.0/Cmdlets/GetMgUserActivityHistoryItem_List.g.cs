...
namespace Microsoft.Graph.PowerShell.CrossDeviceExperiences
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserActivityHistoryItem_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CrossDeviceExperiences.Client.Models.ActivityHistoryItem))]
    public class GetMgUserActivityHistoryItem_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CrossDeviceExperiences.Client.Models.ActivityHistoryItemCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Activities[UserActivityId].HistoryItems.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Activities[UserActivityId].HistoryItems.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
