...
namespace Microsoft.Graph.PowerShell.CrossDeviceExperiences
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserActivity_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CrossDeviceExperiences.Client.Models.UserActivity))]
    public class GetMgUserActivity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.CrossDeviceExperiences.Client.Models.UserActivityCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Activities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Activities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
