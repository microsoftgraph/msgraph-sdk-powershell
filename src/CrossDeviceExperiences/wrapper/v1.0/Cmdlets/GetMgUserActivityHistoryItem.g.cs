...
{
    [GraphRoute("GET", "/users/{user-id}/activities/{userActivity-id}/historyItems")]
    ...
    public class GetMgUserActivityHistoryItemCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserActivityHistoryItem_Get" : "Get-MgUserActivityHistoryItem_List";
            try
            {
