...
{
    [GraphRoute("GET", "/users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserActivityHistoryItem_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.CrossDeviceExperiences.Client.Models.ActivityHistoryItem))]
    public class GetMgUserActivityHistoryItem_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Activities[UserActivityId].HistoryItems[ActivityHistoryItemId].GetAsync(requestConfiguration =>
                {
