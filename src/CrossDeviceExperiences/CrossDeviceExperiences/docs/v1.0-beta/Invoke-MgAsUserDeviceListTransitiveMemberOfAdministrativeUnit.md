...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.crossdeviceexperiences/invoke-mgasuserdevicelisttransitivememberofadministrativeunit
schema: 2.0.0
---

# Invoke-MgAsUserDeviceListTransitiveMemberOfAdministrativeUnit
...
### As (Default)
```
Invoke-MgAsUserDeviceListTransitiveMemberOfAdministrativeUnit -DeviceId <String> -UserId <String> [-Count]
...
### AsViaIdentity
```
Invoke-MgAsUserDeviceListTransitiveMemberOfAdministrativeUnit -InputObject <ICrossDeviceExperiencesIdentity>
