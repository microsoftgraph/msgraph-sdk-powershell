...
### Delete (Default)
```
Remove-MgBetaUserDevice -DeviceId <String> -UserId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserDevice -InputObject <ICrossDeviceExperiencesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
