...
New-MgBetaUserActivityHistoryItem -UserActivityId <String> -UserId <String> [-ActiveDurationSeconds <Int32>]
 ...
 [-LastModifiedDateTime <DateTime>] [-ResponseHeadersVariable <String>] [-StartedDateTime <DateTime>]
 [-Status <String>] [-UserTimezone <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaUserActivityHistoryItem -InputObject <ICrossDeviceExperiencesIdentity>
 ...
 [-ResponseHeadersVariable <String>] [-StartedDateTime <DateTime>] [-Status <String>] [-UserTimezone <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
