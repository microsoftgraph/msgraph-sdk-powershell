...
### Get (Default)
```
Get-MgGroupDrive -GroupId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### Get1
```
Get-MgGroupDrive -DriveId <String> -GroupId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDrive -InputObject <IGroupsDriveIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgGroupDrive -GroupId <String> [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
