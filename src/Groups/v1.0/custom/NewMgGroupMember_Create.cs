namespace Microsoft.Graph.PowerShell.Cmdlets
{
        ...
        Runtime.IEventListener
    {
        ...
        private Microsoft.Graph.PowerShell.Models.IDictionaryOfany1 _bodyParameter;
        ...
        SerializedName = @"body",
        PossibleTypes = new[] { typeof(Microsoft.Graph.PowerShell.Models.IDictionaryOfany1) })]
        public Microsoft.Graph.PowerShell.Models.IDictionaryOfany1 BodyParameter { get => this._bodyParameter; set => this._bodyParameter = value; }
