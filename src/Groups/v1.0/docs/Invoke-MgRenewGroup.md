...
### Renew (Default)
```
Invoke-MgRenewGroup -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RenewViaIdentity
```
Invoke-MgRenewGroup -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
