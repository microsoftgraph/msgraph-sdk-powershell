...
### Renew (Default)
```
Invoke-MgRenewGroup -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RenewViaIdentity
```
Invoke-MgRenewGroup -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
