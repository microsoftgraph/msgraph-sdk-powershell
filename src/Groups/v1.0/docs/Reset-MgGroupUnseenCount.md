...
### Reset (Default)
```
Reset-MgGroupUnseenCount -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgGroupUnseenCount -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
