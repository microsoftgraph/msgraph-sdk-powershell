...
### Subscribe (Default)
```
Invoke-MgSubscribeGroupByMail -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SubscribeViaIdentity
```
Invoke-MgSubscribeGroupByMail -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
