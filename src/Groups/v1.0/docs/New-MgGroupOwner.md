...
```
New-MgGroupOwner -GroupId <String> [-DirectoryObjectId <String>] [-ResponseHeadersVariable <String>]
...
```
New-MgGroupOwner -InputObject <IGroupsIdentity> [-DirectoryObjectId <String>]
