...
```
New-MgGroupOwner -GroupId <String> [-DirectoryObjectId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgGroupOwner -GroupId <String> -BodyParameter <Hashtable> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupOwner -InputObject <IGroupsIdentity> -BodyParameter <Hashtable> [-Headers <IDictionary>] [-Confirm]
