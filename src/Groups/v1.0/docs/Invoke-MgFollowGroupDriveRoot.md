...
### Follow (Default)
```
Invoke-MgFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
