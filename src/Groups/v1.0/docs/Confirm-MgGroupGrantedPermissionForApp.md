...
### Check (Default)
```
Confirm-MgGroupGrantedPermissionForApp -GroupId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckViaIdentity
```
Confirm-MgGroupGrantedPermissionForApp -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-Confirm]
