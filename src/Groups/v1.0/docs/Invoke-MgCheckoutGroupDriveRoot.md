...
### Checkout (Default)
```
Invoke-MgCheckoutGroupDriveRoot -DriveId <String> -GroupId <String> [-Headers <IDictionary>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutGroupDriveRoot -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
