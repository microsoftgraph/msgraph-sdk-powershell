...
### Restore (Default)
```
Restore-MgGroupSettingTemplate -GroupSettingTemplateId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgGroupSettingTemplate -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
