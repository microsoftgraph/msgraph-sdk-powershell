...
### Delete (Default)
```
Remove-MgGroupOwnerDirectoryObjectByRef -DirectoryObjectId <String> -GroupId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgGroupOwnerDirectoryObjectByRef -InputObject <IGroupsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
