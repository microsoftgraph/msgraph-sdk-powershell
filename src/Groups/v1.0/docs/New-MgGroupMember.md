...
```
New-MgGroupMember -GroupId <String> [-DirectoryObjectId <String>] [-ResponseHeadersVariable <String>]
...
```
New-MgGroupMember -InputObject <IGroupsIdentity> [-DirectoryObjectId <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
