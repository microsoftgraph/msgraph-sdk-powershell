...
### Remove (Default)
```
Remove-MgGroupFavorite -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgGroupFavorite -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
