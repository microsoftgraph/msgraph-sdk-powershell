...
### Delete (Default)
```
Remove-MgGroupAcceptedSenderDirectoryObjectByRef -DirectoryObjectId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupAcceptedSenderDirectoryObjectByRef -InputObject <IGroupsIdentity> [-IfMatch <String>]
