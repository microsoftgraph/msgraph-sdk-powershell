...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupMemberWithLicenseErrorAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
