...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsApplication", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOwnerAsApplicationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOwnerAsApplication_Get or Get-MgGroupOwnerAsApplication_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOwnerAsApplication_Get" : "Get-MgGroupOwnerAsApplication_List";
            try
            {
