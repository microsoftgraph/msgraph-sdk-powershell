...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseError", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberWithLicenseErrorCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberWithLicenseError_Get or Get-MgGroupMemberWithLicenseError_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberWithLicenseError_Get" : "Get-MgGroupMemberWithLicenseError_List";
            try
            {
