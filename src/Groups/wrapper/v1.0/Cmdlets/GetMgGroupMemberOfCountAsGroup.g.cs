...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
