...
{
    [GraphRoute("GET", "/groups/{group-id}/acceptedSenders")]
    [Cmdlet(VerbsCommon.Get, "MgGroupAcceptedSender")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.DirectoryObject))]
    public class GetMgGroupAcceptedSenderCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].AcceptedSenders.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].AcceptedSenders.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
