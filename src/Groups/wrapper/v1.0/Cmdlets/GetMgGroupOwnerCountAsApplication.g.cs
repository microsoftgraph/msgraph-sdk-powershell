...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
