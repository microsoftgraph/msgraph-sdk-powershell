...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphUser.Count.GetAsync(requestConfiguration =>
                {
