...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsOrgContact", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberWithLicenseErrorAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberWithLicenseErrorAsOrgContact_Get or Get-MgGroupMemberWithLicenseErrorAsOrgContact_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberWithLicenseErrorAsOrgContact_Get" : "Get-MgGroupMemberWithLicenseErrorAsOrgContact_List";
            try
            {
