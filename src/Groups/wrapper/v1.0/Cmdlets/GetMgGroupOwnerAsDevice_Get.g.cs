...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Device))]
    public class GetMgGroupOwnerAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
