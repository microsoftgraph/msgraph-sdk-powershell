...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupMemberWithLicenseErrorAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
