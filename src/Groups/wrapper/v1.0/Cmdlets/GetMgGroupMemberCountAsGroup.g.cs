...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
