...
{
    [GraphRoute("POST", "/groups")]
    [Cmdlet(VerbsCommon.New, "MgGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class NewMgGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ServiceProvisioningErrors)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups.PostAsync(body, requestConfiguration =>
                {
