...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMemberOf/graph.administrativeUnit/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOfCountAsAdministrativeUnit")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberOfCountAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMemberOf.GraphAdministrativeUnit.Count.GetAsync(requestConfiguration =>
                {
