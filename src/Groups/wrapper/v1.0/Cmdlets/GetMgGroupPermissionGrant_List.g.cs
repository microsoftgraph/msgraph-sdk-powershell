...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupPermissionGrant_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ResourceSpecificPermissionGrant))]
    public class GetMgGroupPermissionGrant_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.ResourceSpecificPermissionGrantCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].PermissionGrants.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].PermissionGrants.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
