...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsApplication_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Application))]
    public class GetMgGroupMemberAsApplication_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphApplication.GetAsync(requestConfiguration =>
                {
