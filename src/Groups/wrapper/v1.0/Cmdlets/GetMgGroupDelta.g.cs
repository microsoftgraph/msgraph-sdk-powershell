...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    public class GetMgGroupDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
