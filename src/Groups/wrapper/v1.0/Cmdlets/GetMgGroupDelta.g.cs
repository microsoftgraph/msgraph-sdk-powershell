...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    public class GetMgGroupDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Groups.Client.Groups.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Groups.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Groups.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
