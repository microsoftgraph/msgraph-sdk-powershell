...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupMemberAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
