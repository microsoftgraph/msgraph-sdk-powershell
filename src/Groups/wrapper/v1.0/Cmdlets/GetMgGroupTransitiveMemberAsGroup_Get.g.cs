...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupTransitiveMemberAsGroup_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
