...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsApplication_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Application))]
    public class GetMgGroupOwnerAsApplication_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphApplication.GetAsync(requestConfiguration =>
                {
