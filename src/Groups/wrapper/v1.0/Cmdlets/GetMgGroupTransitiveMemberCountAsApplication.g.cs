...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
