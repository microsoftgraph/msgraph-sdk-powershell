...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
