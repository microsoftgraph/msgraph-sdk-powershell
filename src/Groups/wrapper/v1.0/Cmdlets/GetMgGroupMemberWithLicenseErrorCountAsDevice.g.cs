...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
