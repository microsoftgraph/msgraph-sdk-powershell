...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberAsServicePrincipal_Get or Get-MgGroupMemberAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberAsServicePrincipal_Get" : "Get-MgGroupMemberAsServicePrincipal_List";
            try
            {
