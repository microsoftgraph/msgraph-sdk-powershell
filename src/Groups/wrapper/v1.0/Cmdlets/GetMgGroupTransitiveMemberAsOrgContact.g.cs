...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsOrgContact", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTransitiveMemberAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTransitiveMemberAsOrgContact_Get or Get-MgGroupTransitiveMemberAsOrgContact_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTransitiveMemberAsOrgContact_Get" : "Get-MgGroupTransitiveMemberAsOrgContact_List";
            try
            {
