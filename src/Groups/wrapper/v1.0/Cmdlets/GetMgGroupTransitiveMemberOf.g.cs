...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTransitiveMemberOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTransitiveMemberOf_Get or Get-MgGroupTransitiveMemberOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTransitiveMemberOf_Get" : "Get-MgGroupTransitiveMemberOf_List";
            try
            {
