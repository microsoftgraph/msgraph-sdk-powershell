...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsServicePrincipal", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ServicePrincipalCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ServicePrincipal), ParameterSetName = new[] { "Get" })]
    public class GetMgGroupMemberWithLicenseErrorAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberWithLicenseErrorAsServicePrincipal_Get or Get-MgGroupMemberWithLicenseErrorAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberWithLicenseErrorAsServicePrincipal_Get" : "Get-MgGroupMemberWithLicenseErrorAsServicePrincipal_List";
            try
            {
