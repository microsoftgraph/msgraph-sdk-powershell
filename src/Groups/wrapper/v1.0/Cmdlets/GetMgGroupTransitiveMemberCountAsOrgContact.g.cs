...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
