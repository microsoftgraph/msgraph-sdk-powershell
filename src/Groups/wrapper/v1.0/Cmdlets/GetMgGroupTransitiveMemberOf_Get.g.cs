...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMemberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.DirectoryObject))]
    public class GetMgGroupTransitiveMemberOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
