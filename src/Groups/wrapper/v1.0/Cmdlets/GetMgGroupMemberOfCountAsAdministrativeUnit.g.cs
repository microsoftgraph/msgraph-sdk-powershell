...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/graph.administrativeUnit/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfCountAsAdministrativeUnit")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberOfCountAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf.GraphAdministrativeUnit.Count.GetAsync(requestConfiguration =>
                {
