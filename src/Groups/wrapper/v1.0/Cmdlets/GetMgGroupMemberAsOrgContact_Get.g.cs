...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupMemberAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
