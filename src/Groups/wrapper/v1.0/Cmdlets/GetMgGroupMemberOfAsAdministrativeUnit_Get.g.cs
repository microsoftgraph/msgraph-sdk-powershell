...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/{directoryObject-id}/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfAsAdministrativeUnit_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.AdministrativeUnit))]
    public class GetMgGroupMemberOfAsAdministrativeUnit_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.AdministrativeUnit? result;
            try
            {
                result = client.Groups[GroupId].MemberOf[DirectoryObjectId].GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
