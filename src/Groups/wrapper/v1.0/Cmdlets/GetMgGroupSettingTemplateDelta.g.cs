...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    public class GetMgGroupSettingTemplateDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Groups.Client.GroupSettingTemplates.Delta.DeltaGetResponse? result;
            try
            {
                result = client.GroupSettingTemplates.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
