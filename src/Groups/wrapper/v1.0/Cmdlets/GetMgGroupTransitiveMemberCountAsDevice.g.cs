...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
