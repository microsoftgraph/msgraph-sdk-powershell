...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsApplication_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Application))]
    public class GetMgGroupTransitiveMemberAsApplication_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers[DirectoryObjectId].GraphApplication.GetAsync(requestConfiguration =>
                {
