...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMemberOf/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOfAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupTransitiveMemberOfAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMemberOf[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
