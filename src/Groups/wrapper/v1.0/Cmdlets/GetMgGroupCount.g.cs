...
{
    [GraphRoute("GET", "/groups/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups.Count.GetAsync(requestConfiguration =>
                {
