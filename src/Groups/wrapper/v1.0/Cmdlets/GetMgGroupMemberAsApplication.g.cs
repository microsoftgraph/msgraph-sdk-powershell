...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsApplication", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberAsApplicationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberAsApplication_Get or Get-MgGroupMemberAsApplication_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberAsApplication_Get" : "Get-MgGroupMemberAsApplication_List";
            try
            {
