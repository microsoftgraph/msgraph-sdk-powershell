...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.User))]
    public class GetMgGroupMemberWithLicenseErrorAsUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors[DirectoryObjectId].GraphUser.GetAsync(requestConfiguration =>
                {
