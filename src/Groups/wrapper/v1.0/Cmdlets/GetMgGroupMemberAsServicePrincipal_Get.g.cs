...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsServicePrincipal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ServicePrincipal))]
    public class GetMgGroupMemberAsServicePrincipal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
