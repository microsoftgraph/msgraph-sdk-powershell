...
{
    [GraphRoute("GET", "/groupSettingTemplates")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSettingTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.GroupSettingTemplate))]
    public class GetMgGroupSettingTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.GroupSettingTemplateCollectionResponse? result;
            try
            {
                result = client.GroupSettingTemplates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.GroupSettingTemplates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
