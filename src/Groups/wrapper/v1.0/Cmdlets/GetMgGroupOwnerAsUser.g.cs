...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsUser", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOwnerAsUserCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOwnerAsUser_Get or Get-MgGroupOwnerAsUser_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOwnerAsUser_Get" : "Get-MgGroupOwnerAsUser_List";
            try
            {
