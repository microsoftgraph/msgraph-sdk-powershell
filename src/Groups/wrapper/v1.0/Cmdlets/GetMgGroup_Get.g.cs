...
{
    [GraphRoute("GET", "/groups/{group-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].GetAsync(requestConfiguration =>
                {
