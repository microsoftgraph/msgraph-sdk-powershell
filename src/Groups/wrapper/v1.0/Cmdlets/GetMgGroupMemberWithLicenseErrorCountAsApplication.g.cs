...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
