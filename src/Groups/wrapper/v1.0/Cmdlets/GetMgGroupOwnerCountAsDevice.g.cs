...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
