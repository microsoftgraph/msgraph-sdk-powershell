...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsDevice", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTransitiveMemberAsDeviceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTransitiveMemberAsDevice_Get or Get-MgGroupTransitiveMemberAsDevice_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTransitiveMemberAsDevice_Get" : "Get-MgGroupTransitiveMemberAsDevice_List";
            try
            {
