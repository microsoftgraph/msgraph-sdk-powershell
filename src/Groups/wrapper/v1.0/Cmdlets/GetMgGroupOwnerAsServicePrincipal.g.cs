...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOwnerAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOwnerAsServicePrincipal_Get or Get-MgGroupOwnerAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOwnerAsServicePrincipal_Get" : "Get-MgGroupOwnerAsServicePrincipal_List";
            try
            {
