...
{
    [GraphRoute("GET", "/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupThreadPostExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Extension))]
    public class GetMgGroupThreadPostExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Threads[ConversationThreadId].Posts[PostId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
