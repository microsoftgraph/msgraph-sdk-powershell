...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberOfAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberOfAsGroup_Get or Get-MgGroupMemberOfAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberOfAsGroup_Get" : "Get-MgGroupMemberOfAsGroup_List";
            try
            {
