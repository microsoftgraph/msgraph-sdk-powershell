...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsDevice", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberWithLicenseErrorAsDeviceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberWithLicenseErrorAsDevice_Get or Get-MgGroupMemberWithLicenseErrorAsDevice_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberWithLicenseErrorAsDevice_Get" : "Get-MgGroupMemberWithLicenseErrorAsDevice_List";
            try
            {
