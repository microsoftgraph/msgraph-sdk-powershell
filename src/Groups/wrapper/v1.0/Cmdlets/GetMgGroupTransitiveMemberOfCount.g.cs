...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMemberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMemberOf.Count.GetAsync(requestConfiguration =>
                {
