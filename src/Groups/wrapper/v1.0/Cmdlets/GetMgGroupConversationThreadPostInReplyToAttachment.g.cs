...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupConversationThreadPostInReplyToAttachment", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupConversationThreadPostInReplyToAttachmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupConversationThreadPostInReplyToAttachment_Get or Get-MgGroupConversationThreadPostInReplyToAttachment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupConversationThreadPostInReplyToAttachment_Get" : "Get-MgGroupConversationThreadPostInReplyToAttachment_List";
            try
            {
