...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupSetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.GroupSetting))]
    public class GetMgGroupSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.GroupSettingCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Settings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Settings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
