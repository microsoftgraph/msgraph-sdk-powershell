...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsDevice", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOwnerAsDeviceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOwnerAsDevice_Get or Get-MgGroupOwnerAsDevice_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOwnerAsDevice_Get" : "Get-MgGroupOwnerAsDevice_List";
            try
            {
