...
{
    [GraphRoute("GET", "/groupSettingTemplates/{groupSettingTemplate-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupSettingTemplate_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.GroupSettingTemplate))]
    public class GetMgGroupSettingTemplate_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.GroupSettingTemplates[GroupSettingTemplateId].GetAsync(requestConfiguration =>
                {
