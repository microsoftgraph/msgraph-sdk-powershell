...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.User))]
    public class GetMgGroupTransitiveMemberAsUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers[DirectoryObjectId].GraphUser.GetAsync(requestConfiguration =>
                {
