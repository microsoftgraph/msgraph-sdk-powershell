...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.GraphUser.Count.GetAsync(requestConfiguration =>
                {
