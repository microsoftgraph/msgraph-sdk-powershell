...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
