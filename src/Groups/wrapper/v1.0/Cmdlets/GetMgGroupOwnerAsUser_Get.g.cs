...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.User))]
    public class GetMgGroupOwnerAsUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphUser.GetAsync(requestConfiguration =>
                {
