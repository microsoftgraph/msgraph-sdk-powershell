...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerByRef")]
    [OutputType(typeof(string))]
    public class GetMgGroupOwnerByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Owners.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
