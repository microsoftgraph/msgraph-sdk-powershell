...
{
    [GraphRoute("GET", "/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/attachments")]
    [Cmdlet(VerbsCommon.Get, "MgGroupThreadPostInReplyToAttachment", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupThreadPostInReplyToAttachmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupThreadPostInReplyToAttachment_Get or Get-MgGroupThreadPostInReplyToAttachment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupThreadPostInReplyToAttachment_Get" : "Get-MgGroupThreadPostInReplyToAttachment_List";
            try
            {
