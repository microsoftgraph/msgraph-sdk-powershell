...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf.Count.GetAsync(requestConfiguration =>
                {
