...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsOrgContact_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupMemberWithLicenseErrorAsOrgContact_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContactCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphOrgContact.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].MembersWithLicenseErrors.GraphOrgContact.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
