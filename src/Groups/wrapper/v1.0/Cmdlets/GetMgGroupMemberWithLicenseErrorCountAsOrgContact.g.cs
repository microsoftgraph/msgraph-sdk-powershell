...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
