...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsServicePrincipal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ServicePrincipal))]
    public class GetMgGroupOwnerAsServicePrincipal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
