...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupOwnerAsGroup_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
