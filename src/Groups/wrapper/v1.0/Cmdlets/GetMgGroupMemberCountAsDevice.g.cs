...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
