...
{
    [GraphRoute("POST", "/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/extensions")]
    [Cmdlet(VerbsCommon.New, "MgGroupThreadPostExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Extension))]
    public class NewMgGroupThreadPostExtensionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Threads[ConversationThreadId].Posts[PostId].Extensions.PostAsync(body, requestConfiguration =>
                {
