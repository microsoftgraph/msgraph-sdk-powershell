...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
