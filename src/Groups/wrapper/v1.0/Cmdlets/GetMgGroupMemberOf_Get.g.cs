...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.DirectoryObject))]
    public class GetMgGroupMemberOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
