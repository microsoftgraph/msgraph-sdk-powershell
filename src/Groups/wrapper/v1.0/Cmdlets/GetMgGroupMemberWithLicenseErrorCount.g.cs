...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.Count.GetAsync(requestConfiguration =>
                {
