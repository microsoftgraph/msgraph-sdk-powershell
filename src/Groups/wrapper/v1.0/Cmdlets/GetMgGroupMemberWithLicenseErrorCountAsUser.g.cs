...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphUser.Count.GetAsync(requestConfiguration =>
                {
