...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsApplication", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTransitiveMemberAsApplicationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTransitiveMemberAsApplication_Get or Get-MgGroupTransitiveMemberAsApplication_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTransitiveMemberAsApplication_Get" : "Get-MgGroupTransitiveMemberAsApplication_List";
            try
            {
