...
{
    [GraphRoute("GET", "/groups/{group-id}/members/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.Count.GetAsync(requestConfiguration =>
                {
