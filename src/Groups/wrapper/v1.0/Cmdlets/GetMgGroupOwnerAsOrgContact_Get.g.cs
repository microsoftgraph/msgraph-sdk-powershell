...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupOwnerAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
