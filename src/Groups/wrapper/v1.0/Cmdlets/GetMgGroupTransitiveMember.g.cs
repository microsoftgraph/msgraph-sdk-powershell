...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMember", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupTransitiveMemberCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupTransitiveMember_Get or Get-MgGroupTransitiveMember_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupTransitiveMember_Get" : "Get-MgGroupTransitiveMember_List";
            try
            {
