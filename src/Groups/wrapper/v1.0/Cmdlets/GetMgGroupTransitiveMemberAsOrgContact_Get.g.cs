...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupTransitiveMemberAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact? result;
            try
            {
                result = client.Groups[GroupId].TransitiveMembers[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
