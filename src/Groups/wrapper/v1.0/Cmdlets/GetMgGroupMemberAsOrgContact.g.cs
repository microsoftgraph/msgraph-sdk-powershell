...
{
    [GraphRoute("GET", "/groups/{group-id}/members/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsOrgContact", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupMemberAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupMemberAsOrgContact_Get or Get-MgGroupMemberAsOrgContact_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupMemberAsOrgContact_Get" : "Get-MgGroupMemberAsOrgContact_List";
            try
            {
