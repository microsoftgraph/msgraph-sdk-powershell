...
{
    [GraphRoute("GET", "/groups/{group-id}/permissionGrants/{resourceSpecificPermissionGrant-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPermissionGrant_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ResourceSpecificPermissionGrant))]
    public class GetMgGroupPermissionGrant_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].PermissionGrants[ResourceSpecificPermissionGrantId].GetAsync(requestConfiguration =>
                {
