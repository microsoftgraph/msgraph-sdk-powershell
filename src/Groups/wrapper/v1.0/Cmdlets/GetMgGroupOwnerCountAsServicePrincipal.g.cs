...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
