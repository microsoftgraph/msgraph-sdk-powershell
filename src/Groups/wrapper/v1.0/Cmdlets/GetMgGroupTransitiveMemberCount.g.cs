...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.Count.GetAsync(requestConfiguration =>
                {
