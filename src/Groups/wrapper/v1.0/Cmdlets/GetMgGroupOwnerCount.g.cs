...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCount")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.Count.GetAsync(requestConfiguration =>
                {
