...
{
    [GraphRoute("GET", "/groups/{group-id}/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgGroupPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Photo.Content.GetAsync(requestConfiguration =>
                {
