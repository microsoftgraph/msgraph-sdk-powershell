...
{
    [GraphRoute("GET", "/groups/{group-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Extension))]
    public class GetMgGroupExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
