...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Device))]
    public class GetMgGroupMemberAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
