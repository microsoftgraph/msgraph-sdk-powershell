...
{
    [GraphRoute("GET", "/groups/{group-id}/permissionGrants")]
    [Cmdlet(VerbsCommon.Get, "MgGroupPermissionGrant", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ResourceSpecificPermissionGrantCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.ResourceSpecificPermissionGrant), ParameterSetName = new[] { "Get" })]
    public class GetMgGroupPermissionGrantCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupPermissionGrant_Get or Get-MgGroupPermissionGrant_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupPermissionGrant_Get" : "Get-MgGroupPermissionGrant_List";
            try
            {
