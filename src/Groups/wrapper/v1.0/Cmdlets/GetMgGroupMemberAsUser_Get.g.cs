...
{
    [GraphRoute("GET", "/groups/{group-id}/members/{directoryObject-id}/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.User))]
    public class GetMgGroupMemberAsUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.User? result;
            try
            {
                result = client.Groups[GroupId].Members[DirectoryObjectId].GraphUser.GetAsync(requestConfiguration =>
                {
