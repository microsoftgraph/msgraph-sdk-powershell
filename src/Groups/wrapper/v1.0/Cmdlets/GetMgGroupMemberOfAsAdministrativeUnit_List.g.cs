...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfAsAdministrativeUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.AdministrativeUnit))]
    public class GetMgGroupMemberOfAsAdministrativeUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf.GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].MemberOf.GraphAdministrativeUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
