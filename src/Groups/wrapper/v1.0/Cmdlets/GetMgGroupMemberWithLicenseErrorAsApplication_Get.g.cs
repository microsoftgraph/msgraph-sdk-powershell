...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsApplication_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Application))]
    public class GetMgGroupMemberWithLicenseErrorAsApplication_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Groups.Client.Models.Application? result;
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors[DirectoryObjectId].GraphApplication.GetAsync(requestConfiguration =>
                {
