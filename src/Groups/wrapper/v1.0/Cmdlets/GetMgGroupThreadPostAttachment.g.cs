...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupThreadPostAttachment", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupThreadPostAttachmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupThreadPostAttachment_Get or Get-MgGroupThreadPostAttachment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupThreadPostAttachment_Get" : "Get-MgGroupThreadPostAttachment_List";
            try
            {
