...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMemberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
