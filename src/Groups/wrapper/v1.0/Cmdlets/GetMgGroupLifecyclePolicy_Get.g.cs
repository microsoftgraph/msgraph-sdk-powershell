...
{
    [GraphRoute("GET", "/groupLifecyclePolicies/{groupLifecyclePolicy-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupLifecyclePolicy_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.GroupLifecyclePolicy))]
    public class GetMgGroupLifecyclePolicy_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.GroupLifecyclePolicies[GroupLifecyclePolicyId].GetAsync(requestConfiguration =>
                {
