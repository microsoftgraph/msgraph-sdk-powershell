...
{
    [GraphRoute("GET", "/groups/{group-id}/acceptedSenders/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgGroupAcceptedSenderByRef")]
    [OutputType(typeof(string))]
    public class GetMgGroupAcceptedSenderByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].AcceptedSenders.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].AcceptedSenders.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
