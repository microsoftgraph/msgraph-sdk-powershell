...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Device))]
    public class GetMgGroupTransitiveMemberAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
