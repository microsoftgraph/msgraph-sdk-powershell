...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgGroupMemberWithLicenseErrorCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
