...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.GraphUser.Count.GetAsync(requestConfiguration =>
                {
