...
{
    [GraphRoute("GET", "/groups/{group-id}/transitiveMembers/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupTransitiveMemberCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgGroupTransitiveMemberCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].TransitiveMembers.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
