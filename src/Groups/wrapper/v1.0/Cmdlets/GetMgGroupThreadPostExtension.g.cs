...
{
    [GraphRoute("GET", "/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/extensions")]
    [Cmdlet(VerbsCommon.Get, "MgGroupThreadPostExtension", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupThreadPostExtensionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupThreadPostExtension_Get or Get-MgGroupThreadPostExtension_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupThreadPostExtension_Get" : "Get-MgGroupThreadPostExtension_List";
            try
            {
