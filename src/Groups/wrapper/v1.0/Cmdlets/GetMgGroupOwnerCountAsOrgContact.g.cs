...
{
    [GraphRoute("GET", "/groups/{group-id}/owners/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOwnerCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgGroupOwnerCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Owners.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
