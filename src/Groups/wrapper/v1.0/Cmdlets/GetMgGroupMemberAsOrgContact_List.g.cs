...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberAsOrgContact_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.OrgContact))]
    public class GetMgGroupMemberAsOrgContact_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Members.GraphOrgContact.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Members.GraphOrgContact.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
