...
{
    [GraphRoute("GET", "/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseError_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.DirectoryObject))]
    public class GetMgGroupMemberWithLicenseError_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
