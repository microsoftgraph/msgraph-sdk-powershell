...
namespace Microsoft.Graph.PowerShell.Groups
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberWithLicenseErrorAsUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.User))]
    public class GetMgGroupMemberWithLicenseErrorAsUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MembersWithLicenseErrors.GraphUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].MembersWithLicenseErrors.GraphUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
