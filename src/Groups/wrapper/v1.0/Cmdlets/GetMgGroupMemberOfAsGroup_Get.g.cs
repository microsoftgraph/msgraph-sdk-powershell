...
{
    [GraphRoute("GET", "/groups/{group-id}/memberOf/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgGroupMemberOfAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Groups.Client.Models.Group))]
    public class GetMgGroupMemberOfAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].MemberOf[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
