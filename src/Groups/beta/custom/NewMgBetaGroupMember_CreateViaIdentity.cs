namespace Microsoft.Graph.Beta.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"MgBetaGroupMember_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewMgBetaGroupMember_CreateViaIdentity : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        private Microsoft.Graph.Beta.PowerShell.Models.IDictionaryOfany1 _bodyParameter;

        /// <summary>Dictionary of <any></summary>
        [global::Microsoft.Graph.Beta.PowerShell.ExportAs(typeof(global::System.Collections.Hashtable))]
        ...
        SerializedName = @"body",
        PossibleTypes = new[] { typeof(Microsoft.Graph.Beta.PowerShell.Models.IDictionaryOfany1) })]
        public Microsoft.Graph.Beta.PowerShell.Models.IDictionaryOfany1 BodyParameter { get => this._bodyParameter; set => this._bodyParameter = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMgBetaGroupMember_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewMgBetaGroupMember_CreateViaIdentity()
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateMembersGraphBPreRef(InputObject.GroupId, BodyParameter, onNoContent, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphODataErrorsOdataError> response)
        {
            using (NoSynchronizationContext)
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId = InputObject.GroupId, body = BodyParameter })
                    {
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { GroupId = InputObject.GroupId, body = BodyParameter })
                    {
