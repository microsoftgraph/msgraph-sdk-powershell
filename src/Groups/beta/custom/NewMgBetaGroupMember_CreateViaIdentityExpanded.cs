namespace Microsoft.Graph.Beta.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"MgBetaGroupMember_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewMgBetaGroupMember_CreateViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMgBetaGroupMember_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewMgBetaGroupMember_CreateViaIdentityExpanded()
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                try
                {
                    ...
                    await this.Client.GroupsCreateMembersGraphBPreRef(InputObject.GroupId, _bodyParameter, onNoContent, onDefault, this, Pipeline);
