namespace Microsoft.Graph.Beta.PowerShell.Cmdlets
{
    ...
    /// <remarks>
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"MgBetaGroupMember_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Models.IMicrosoftGraphDirectoryObject))]
    [global::Microsoft.Graph.Beta.PowerShell.Description(@"Add a member to an Office 365 group or security group through the members navigation property.")]
    [global::Microsoft.Graph.Beta.PowerShell.Generated]
    public partial class NewMgBetaGroupMember_CreateExpanded : System.Management.Automation.PSCmdlet,
        Runtime.IEventListener
    {
        ...
        private Microsoft.Graph.Beta.PowerShell.Models.IReferenceCreate _bodyParameter = new Microsoft.Graph.Beta.PowerShell.Models.ReferenceCreate();

        /// <summary>Wait for .NET debugger to attach</summary>
        [System.Management.Automation.Parameter(Mandatory = false, DontShow = true, HelpMessage = "Wait for .NET debugger to attach")]
        [Category(global::Microsoft.Graph.Beta.PowerShell.ParameterCategory.Runtime)]
        ...
        [Category(global::Microsoft.Graph.Beta.PowerShell.ParameterCategory.Path)]
        ...
        [Category(global::Microsoft.Graph.Beta.PowerShell.ParameterCategory.Body)]
        [Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        protected override void BeginProcessing()
        {
            ...
            ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletBeginProcessing).Wait(); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
        }

        /// <summary>Performs clean-up after the command execution</summary>
        protected override void EndProcessing()
        {
            ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletEndProcessing).Wait(); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMgBetaGroupMember_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewMgBetaGroupMember_CreateExpanded()
        {
        ...
        {
            ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletProcessRecordStart).Wait(); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
            try
            {
                // work
            ...
            catch (System.AggregateException aggregateException)
            {
                ...
                {
                    ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletException, $"{innerException.GetType().Name} - {innerException.Message} : {innerException.StackTrace}").Wait(); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
            ...
            {
                ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletException, $"{exception.GetType().Name} - {exception.Message} : {exception.StackTrace}").Wait(); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
                // Write exception out to error channel.
                WriteError(new System.Management.Automation.ErrorRecord(exception, string.Empty, System.Management.Automation.ErrorCategory.NotSpecified, null));
            }
            finally
            {
                ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletProcessRecordEnd).Wait();
            }
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                await ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletProcessRecordAsyncStart); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
                await ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletGetPipeline); if (((Runtime.IEventListener)this).Token.IsCancellationRequested) { return; }
                Pipeline = Microsoft.Graph.Beta.PowerShell.Module.Instance.CreatePipeline(InvocationInformation);
                ...
                try
                {
                    ...
                    await this.Client.GroupCreateMembersGraphBPreRef(GroupId, _bodyParameter, onNoContent, onDefault, this, Pipeline);
                ...
                {
                    await ((Runtime.IEventListener)this).Signal(Microsoft.Graph.Beta.PowerShell.Runtime.Events.CmdletProcessRecordAsyncEnd);
                }
            }
        }
        ...
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphODataErrorsOdataError> response)
        {
            using (NoSynchronizationContext)
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Graph.Beta.PowerShell.Runtime.RestException<Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphODataErrorsOdataError>(responseMessage, await response);
