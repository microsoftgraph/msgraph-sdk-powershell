...
### Add (Default)
```
Add-MgBetaGroupFavorite -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AddViaIdentity
```
Add-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
