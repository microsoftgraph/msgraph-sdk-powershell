...
Copy-MgBetaGroupOnenotePageToSection -GroupId <String> -OnenotePageId <String>
 [-AdditionalProperties <Hashtable>] [-GroupId1 <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-SiteCollectionId <String>] [-SiteId <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
