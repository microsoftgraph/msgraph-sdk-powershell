...
Update-MgBetaGroupThreadPost -ConversationThreadId <String> -GroupId <String> -PostId <String>
 ...
 [-ResponseHeadersVariable <String>] [-Sender <IMicrosoftGraphRecipient>]
...
```
Update-MgBetaGroupThreadPost -ConversationThreadId <String> -GroupId <String> -PostId <String>
 -BodyParameter <IMicrosoftGraphPost> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm]
