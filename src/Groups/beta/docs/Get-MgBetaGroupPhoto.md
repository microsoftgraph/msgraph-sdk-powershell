...
### Get (Default)
```
Get-MgBetaGroupPhoto -GroupId <String> [-Property <String[]>] [-Headers <IDictionary>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgBetaGroupPhoto -InputObject <IGroupsIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
