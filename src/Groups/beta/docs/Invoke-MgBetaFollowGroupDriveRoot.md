...
### Follow (Default)
```
Invoke-MgBetaFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
