...
### Reset (Default)
```
Reset-MgBetaGroupUnseenCount -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaGroupUnseenCount -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
