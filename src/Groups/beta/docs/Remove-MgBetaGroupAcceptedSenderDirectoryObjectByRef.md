...
### Delete (Default)
```
Remove-MgBetaGroupAcceptedSenderDirectoryObjectByRef -DirectoryObjectId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaGroupAcceptedSenderDirectoryObjectByRef -InputObject <IGroupsIdentity> [-IfMatch <String>]
