...
Invoke-MgBetaReauthorizeGroupDriveListSubscription -DriveId <String> -GroupId <String>
 -SubscriptionId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeGroupDriveListSubscription -InputObject <IGroupsIdentity> [-Headers <IDictionary>]
