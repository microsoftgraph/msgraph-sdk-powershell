...
Invoke-MgBetaReauthorizeGroupDriveListSubscription -DriveId <String> -GroupId <String>
 -SubscriptionId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeGroupDriveListSubscription -InputObject <IGroupsIdentity>
