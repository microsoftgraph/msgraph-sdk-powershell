...
### Graph (Default)
```
Invoke-MgBetaGraphGroup -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GraphViaIdentity
```
Invoke-MgBetaGraphGroup -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
