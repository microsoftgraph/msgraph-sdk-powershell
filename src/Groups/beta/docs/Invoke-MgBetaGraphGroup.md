...
### Graph (Default)
```
Invoke-MgBetaGraphGroup -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GraphViaIdentity
```
Invoke-MgBetaGraphGroup -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
