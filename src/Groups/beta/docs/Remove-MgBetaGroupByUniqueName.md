...
### Delete (Default)
```
Remove-MgBetaGroupByUniqueName -UniqueName <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupByUniqueName -InputObject <IGroupsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
