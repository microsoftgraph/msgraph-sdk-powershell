...
```
New-MgBetaGroupOwner -GroupId <String> [-DirectoryObjectId <String>] [-ResponseHeadersVariable <String>]
...
```
New-MgBetaGroupOwner -InputObject <IGroupsIdentity> [-DirectoryObjectId <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
