...
### Remove (Default)
```
Remove-MgBetaGroupFavorite -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
