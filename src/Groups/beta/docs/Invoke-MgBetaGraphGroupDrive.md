...
### Graph (Default)
```
Invoke-MgBetaGraphGroupDrive -DriveId <String> -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### GraphViaIdentity
```
Invoke-MgBetaGraphGroupDrive -InputObject <IGroupsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
