...
```
New-MgBetaGroupMember -GroupId <String> [-DirectoryObjectId <String>] [-ResponseHeadersVariable <String>]
...
```
New-MgBetaGroupMember -InputObject <IGroupsIdentity> [-DirectoryObjectId <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
