...
### Renew (Default)
```
Invoke-MgBetaRenewGroup -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RenewViaIdentity
```
Invoke-MgBetaRenewGroup -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
