...
### Renew (Default)
```
Invoke-MgBetaRenewGroup -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RenewViaIdentity
```
Invoke-MgBetaRenewGroup -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
