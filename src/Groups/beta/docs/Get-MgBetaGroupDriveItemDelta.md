...
### Delta (Default)
```
Get-MgBetaGroupDriveItemDelta -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### DeltaViaIdentity
```
Get-MgBetaGroupDriveItemDelta -InputObject <IGroupsIdentity> [-Count] [-ExpandProperty <String[]>]
