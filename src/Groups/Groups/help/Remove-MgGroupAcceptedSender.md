...
### DeleteViaIdentity
```
Remove-MgGroupAcceptedSender -InputObject <IGroupsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/remove-mggroupacceptedsender](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/remove-mggroupacceptedsender)
