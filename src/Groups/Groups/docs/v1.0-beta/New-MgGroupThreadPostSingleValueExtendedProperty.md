...
```
New-MgBetaGroupThreadPostSingleValueExtendedProperty -ConversationThreadId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupThreadPostSingleValueExtendedProperty -InputObject <IGroupsIdentity>
