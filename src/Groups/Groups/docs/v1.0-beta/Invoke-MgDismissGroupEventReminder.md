...
### Dismiss1 (Default)
```
Invoke-MgDismissGroupEventReminder -EventId <String> -GroupId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DismissViaIdentity1
```
Invoke-MgDismissGroupEventReminder -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
