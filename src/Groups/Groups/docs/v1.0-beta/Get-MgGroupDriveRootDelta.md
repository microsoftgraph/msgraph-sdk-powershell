...
### Delta (Default)
```
Get-MgBetaGroupDriveRootDelta -DriveId <String> -GroupId <String> [-Count] [-Filter <String>]
...
### Delta1
```
Get-MgBetaGroupDriveRootDelta -DriveId <String> -GroupId <String> -Token <String> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [<CommonParameters>]
```
...
### DeltaViaIdentity
```
Get-MgBetaGroupDriveRootDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]
