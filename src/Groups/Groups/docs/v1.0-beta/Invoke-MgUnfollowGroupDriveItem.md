...
### Unfollow (Default)
```
Invoke-MgUnfollowGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowGroupDriveItem -InputObject <IGroupsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
