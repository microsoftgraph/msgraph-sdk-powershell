...
### Delta (Default)
```
Get-MgGroupCalendarEventDelta -GroupId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgGroupCalendarEventDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>]
