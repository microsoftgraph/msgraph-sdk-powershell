...
### Create1 (Default)
```
New-MgGroupRejectedSenderByRef -GroupId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupRejectedSenderByRef -InputObject <IGroupsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
