...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Woc1PdGroupsGroupIdPermissiongrantsMicrosoftGraphGetavailableextensionpropertiesPostRequestbodyContentApplicationJsonSchema
