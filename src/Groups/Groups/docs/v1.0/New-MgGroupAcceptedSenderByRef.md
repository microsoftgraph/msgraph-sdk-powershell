...
### Create1 (Default)
```
New-MgGroupAcceptedSenderByRef -GroupId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupAcceptedSenderByRef -InputObject <IGroupsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
