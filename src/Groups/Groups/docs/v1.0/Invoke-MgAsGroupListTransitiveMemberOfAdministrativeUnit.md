...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/invoke-mgasgrouplisttransitivememberofadministrativeunit
schema: 2.0.0
---
...
### As1 (Default)
```
Invoke-MgAsGroupListTransitiveMemberOfAdministrativeUnit -GroupId <String> [-Count]
...
### AsViaIdentity1
```
Invoke-MgAsGroupListTransitiveMemberOfAdministrativeUnit -InputObject <IGroupsIdentity> [-Count]
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [-ConsistencyLevel <String>] [<CommonParameters>]
```
