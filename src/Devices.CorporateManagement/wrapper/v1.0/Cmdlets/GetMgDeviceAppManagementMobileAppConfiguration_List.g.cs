...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileAppConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppConfiguration_List")]
    ...
    public class GetMgDeviceAppManagementMobileAppConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedDeviceMobileAppConfigurationCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileAppConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileAppConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
