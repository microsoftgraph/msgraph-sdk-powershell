...
{
    [GraphRoute("GET", "/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}/exemptAppLockerFiles")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementWindowsInformationProtectionPolicyExemptAppLockerFile_List")]
    ...
    public class GetMgDeviceAppManagementWindowsInformationProtectionPolicyExemptAppLockerFile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsInformationProtectionAppLockerFileCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.WindowsInformationProtectionPolicies[WindowsInformationProtectionPolicyId].ExemptAppLockerFiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.WindowsInformationProtectionPolicies[WindowsInformationProtectionPolicyId].ExemptAppLockerFiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
