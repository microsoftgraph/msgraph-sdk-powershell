...
{
    [GraphRoute("POST", "/users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates")]
    [Cmdlet(VerbsCommon.New, "MgUserManagedDeviceCompliancePolicyState", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceCompliancePolicyState))]
    public class NewMgUserManagedDeviceCompliancePolicyStateCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceCompliancePolicySettingState[]? SettingStates { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceCompliancePolicyState();
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ManagedDevices[ManagedDeviceId].DeviceCompliancePolicyStates.PostAsync(body, requestConfiguration =>
                {
