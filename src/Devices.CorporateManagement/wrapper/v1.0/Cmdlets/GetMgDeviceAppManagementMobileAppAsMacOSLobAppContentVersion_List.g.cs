...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/contentVersions")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsMacOSLobAppContentVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppContent))]
    public class GetMgDeviceAppManagementMobileAppAsMacOSLobAppContentVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphMacOSLobApp.ContentVersions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphMacOSLobApp.ContentVersions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
