...
{
    [GraphRoute("POST", "/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}/protectedAppLockerFiles")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementWindowsInformationProtectionPolicyProtectedAppLockerFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceAppManagementWindowsInformationProtectionPolicyProtectedAppLockerFileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Version)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.WindowsInformationProtectionPolicies[WindowsInformationProtectionPolicyId].ProtectedAppLockerFiles.PostAsync(body, requestConfiguration =>
                {
