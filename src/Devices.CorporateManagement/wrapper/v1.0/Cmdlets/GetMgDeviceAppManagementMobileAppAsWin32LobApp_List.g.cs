...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWin32LobApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.Win32LobApp))]
    public class GetMgDeviceAppManagementMobileAppAsWin32LobApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.Win32LobAppCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphWin32LobApp.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphWin32LobApp.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
