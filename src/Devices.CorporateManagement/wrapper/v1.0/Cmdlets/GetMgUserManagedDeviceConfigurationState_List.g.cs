...
{
    [GraphRoute("GET", "/users/{user-id}/managedDevices/{managedDevice-id}/deviceConfigurationStates")]
    [Cmdlet(VerbsCommon.Get, "MgUserManagedDeviceConfigurationState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceConfigurationState))]
    public class GetMgUserManagedDeviceConfigurationState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceConfigurationStateCollectionResponse? result;
            try
            {
                result = client.Users[UserId].ManagedDevices[ManagedDeviceId].DeviceConfigurationStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].ManagedDevices[ManagedDeviceId].DeviceConfigurationStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
