...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementMdmWindowsInformationProtectionPolicyAssignmentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TargetedManagedAppPolicyAssignmentId : MdmWindowsInformationProtectionPolicyId);
                return;
            }
        }
    }
