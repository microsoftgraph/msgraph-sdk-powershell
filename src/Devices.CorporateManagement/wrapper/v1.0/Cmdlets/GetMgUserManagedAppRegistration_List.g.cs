...
{
    [GraphRoute("GET", "/users/{user-id}/managedAppRegistrations")]
    [Cmdlet(VerbsCommon.Get, "MgUserManagedAppRegistration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppRegistration))]
    public class GetMgUserManagedAppRegistration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppRegistrationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].ManagedAppRegistrations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].ManagedAppRegistrations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
