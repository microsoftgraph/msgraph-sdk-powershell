...
{
    [GraphRoute("POST", "/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/exemptAppLockerFiles")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementMdmWindowsInformationProtectionPolicyExemptAppLockerFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceAppManagementMdmWindowsInformationProtectionPolicyExemptAppLockerFileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Version)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MdmWindowsInformationProtectionPolicies[MdmWindowsInformationProtectionPolicyId].ExemptAppLockerFiles.PostAsync(body, requestConfiguration =>
                {
