...
{
    [GraphRoute("GET", "/deviceAppManagement/targetedManagedAppConfigurations")]
    ...
    public class GetMgDeviceAppManagementTargetedManagedAppConfigurationCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementTargetedManagedAppConfiguration_Get" : "Get-MgDeviceAppManagementTargetedManagedAppConfiguration_List";
            try
            {
