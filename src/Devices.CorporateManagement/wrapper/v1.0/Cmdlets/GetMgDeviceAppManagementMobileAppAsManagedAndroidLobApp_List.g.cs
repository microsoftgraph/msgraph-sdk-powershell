...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/graph.managedAndroidLobApp")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsManagedAndroidLobApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAndroidLobApp))]
    public class GetMgDeviceAppManagementMobileAppAsManagedAndroidLobApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAndroidLobAppCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphManagedAndroidLobApp.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphManagedAndroidLobApp.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
