...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWin32LobAppAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppAssignment))]
    public class GetMgDeviceAppManagementMobileAppAsWin32LobAppAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphWin32LobApp.Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphWin32LobApp.Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
