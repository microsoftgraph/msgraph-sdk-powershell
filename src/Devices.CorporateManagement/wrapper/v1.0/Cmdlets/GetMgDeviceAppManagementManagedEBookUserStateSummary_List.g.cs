...
{
    [GraphRoute("GET", "/deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementManagedEBookUserStateSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.UserInstallStateSummary))]
    public class GetMgDeviceAppManagementManagedEBookUserStateSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.UserInstallStateSummaryCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.ManagedEBooks[ManagedEBookId].UserStateSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.ManagedEBooks[ManagedEBookId].UserStateSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
