...
{
    [GraphRoute("GET", "/users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates")]
    [Cmdlet(VerbsCommon.Get, "MgUserManagedDeviceCompliancePolicyState_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceCompliancePolicyState))]
    public class GetMgUserManagedDeviceCompliancePolicyState_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceCompliancePolicyStateCollectionResponse? result;
            try
            {
                result = client.Users[UserId].ManagedDevices[ManagedDeviceId].DeviceCompliancePolicyStates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].ManagedDevices[ManagedDeviceId].DeviceCompliancePolicyStates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
