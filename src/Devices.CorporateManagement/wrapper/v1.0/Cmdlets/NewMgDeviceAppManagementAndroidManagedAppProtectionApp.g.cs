...
{
    [GraphRoute("POST", "/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/apps")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementAndroidManagedAppProtectionApp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedMobileApp))]
    public class NewMgDeviceAppManagementAndroidManagedAppProtectionAppCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MobileAppIdentifier)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.AndroidManagedAppProtections[AndroidManagedAppProtectionId].Apps.PostAsync(body, requestConfiguration =>
                {
