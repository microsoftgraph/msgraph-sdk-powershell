...
{
    [GraphRoute("PATCH", "/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration-id}/deploymentSummary")]
    [Cmdlet(VerbsData.Update, "MgDeviceAppManagementTargetedManagedAppConfigurationDeploymentSummary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppPolicyDeploymentSummary))]
    public class UpdateMgDeviceAppManagementTargetedManagedAppConfigurationDeploymentSummaryCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ConfigurationDeploymentSummaryPerApp)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.TargetedManagedAppConfigurations[TargetedManagedAppConfigurationId].DeploymentSummary.PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, TargetedManagedAppConfigurationId));
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.DeviceAppManagement.TargetedManagedAppConfigurations[TargetedManagedAppConfigurationId].DeploymentSummary.GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, TargetedManagedAppConfigurationId));
