...
{
    [GraphRoute("POST", "/deviceAppManagement/defaultManagedAppProtections")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementDefaultManagedAppProtection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtection))]
    public class NewMgDeviceAppManagementDefaultManagedAppProtectionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtection();
    ...
    if (this.IsParameterBound(nameof(CustomSettings)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtection? result;
            try
            {
                result = client.DeviceAppManagement.DefaultManagedAppProtections.PostAsync(body, requestConfiguration =>
                {
