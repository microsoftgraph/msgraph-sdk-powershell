...
{
    [GraphRoute("POST", "/users/{user-id}/managedDevices/{managedDevice-id}/wipe")]
    [Cmdlet(VerbsCommon.Clear, "MgUserManagedDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class ClearMgUserManagedDeviceCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Users.Item.ManagedDevices.Item.Wipe.WipePostRequestBody();
    ...
    if (this.IsParameterBound(nameof(PersistEsimDataPlan)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                client.Users[UserId].ManagedDevices[ManagedDeviceId].Wipe.PostAsync(body, requestConfiguration =>
                {
