...
{
    [GraphRoute("POST", "/deviceAppManagement/mobileApps")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementMobileApp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileApp))]
    public class NewMgDeviceAppManagementMobileAppCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PublishingState)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps.PostAsync(body, requestConfiguration =>
                {
