...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementMobileAppConfigurationUserStatus_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ManagedDeviceMobileAppConfigurationUserStatusId));
                return;
            }
