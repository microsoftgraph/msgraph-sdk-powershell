...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsMobileMSIContentVersion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppContent))]
    public class GetMgDeviceAppManagementMobileAppAsWindowsMobileMSIContentVersion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppContentCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphWindowsMobileMSI.ContentVersions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphWindowsMobileMSI.ContentVersions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
