...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementMdmWindowsInformationProtectionPolicyProtectedAppLockerFileCountCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, MdmWindowsInformationProtectionPolicyId));
                return;
            }
