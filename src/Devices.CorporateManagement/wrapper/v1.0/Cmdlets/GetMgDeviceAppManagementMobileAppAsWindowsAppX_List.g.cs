...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/graph.windowsAppX")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsAppX_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsAppX))]
    public class GetMgDeviceAppManagementMobileAppAsWindowsAppX_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsAppXCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphWindowsAppX.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphWindowsAppX.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
