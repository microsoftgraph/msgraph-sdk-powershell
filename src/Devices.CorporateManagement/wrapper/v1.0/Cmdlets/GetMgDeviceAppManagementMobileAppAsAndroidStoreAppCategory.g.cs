...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/categories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsAndroidStoreAppCategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsAndroidStoreAppCategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsAndroidStoreAppCategory_Get or Get-MgDeviceAppManagementMobileAppAsAndroidStoreAppCategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsAndroidStoreAppCategory_Get" : "Get-MgDeviceAppManagementMobileAppAsAndroidStoreAppCategory_List";
            try
            {
