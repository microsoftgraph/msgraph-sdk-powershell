...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class UpdateMgDeviceAppManagementManagedEBookAssignmentCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ManagedEBookAssignmentId));
                return;
            }
