...
{
    [GraphRoute("GET", "/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/apps")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementDefaultManagedAppProtectionApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedMobileApp))]
    public class GetMgDeviceAppManagementDefaultManagedAppProtectionApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.DefaultManagedAppProtections[DefaultManagedAppProtectionId].Apps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.DefaultManagedAppProtections[DefaultManagedAppProtectionId].Apps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
