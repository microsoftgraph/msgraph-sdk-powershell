...
{
    [GraphRoute("POST", "/deviceAppManagement/mobileApps/{mobileApp-id}/assignments")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementMobileAppAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppAssignment))]
    public class NewMgDeviceAppManagementMobileAppAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].Assignments.PostAsync(body, requestConfiguration =>
                {
