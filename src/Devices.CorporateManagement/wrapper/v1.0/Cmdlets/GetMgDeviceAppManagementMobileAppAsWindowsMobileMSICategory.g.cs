...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsMobileMSI/categories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsMobileMSICategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsWindowsMobileMSICategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsWindowsMobileMSICategory_Get or Get-MgDeviceAppManagementMobileAppAsWindowsMobileMSICategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsWindowsMobileMSICategory_Get" : "Get-MgDeviceAppManagementMobileAppAsWindowsMobileMSICategory_List";
            try
            {
