...
{
    [GraphRoute("GET", "/users/{user-id}/managedDevices/{managedDevice-id}/users")]
    [Cmdlet(VerbsCommon.Get, "MgUserManagedDeviceUser")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.User))]
    public class GetMgUserManagedDeviceUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.Users[UserId].ManagedDevices[ManagedDeviceId].Users.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].ManagedDevices[ManagedDeviceId].Users.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
