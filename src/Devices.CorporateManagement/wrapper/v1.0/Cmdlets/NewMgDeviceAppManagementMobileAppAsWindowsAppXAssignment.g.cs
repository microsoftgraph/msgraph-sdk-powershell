...
{
    [GraphRoute("POST", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/assignments")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementMobileAppAsWindowsAppXAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppAssignment))]
    public class NewMgDeviceAppManagementMobileAppAsWindowsAppXAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphWindowsAppX.Assignments.PostAsync(body, requestConfiguration =>
                {
