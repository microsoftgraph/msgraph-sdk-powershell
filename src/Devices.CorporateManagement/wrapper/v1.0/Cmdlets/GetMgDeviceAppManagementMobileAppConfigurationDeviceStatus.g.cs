...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementMobileAppConfigurationDeviceStatusCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppConfigurationDeviceStatus_Get" : "Get-MgDeviceAppManagementMobileAppConfigurationDeviceStatus_List";
            try
            {
