...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementWindowsInformationProtectionPolicy_List")]
    ...
    public class GetMgDeviceAppManagementWindowsInformationProtectionPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsInformationProtectionPolicyCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.WindowsInformationProtectionPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.WindowsInformationProtectionPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
