...
{
    [GraphRoute("GET", "/deviceAppManagement/defaultManagedAppProtections")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementDefaultManagedAppProtection_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtection))]
    public class GetMgDeviceAppManagementDefaultManagedAppProtection_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtectionCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.DefaultManagedAppProtections.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.DefaultManagedAppProtections.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
