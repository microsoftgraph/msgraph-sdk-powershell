...
{
    [GraphRoute("GET", "/deviceAppManagement/managedAppRegistrations/{managedAppRegistration-id}/appliedPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementManagedAppRegistrationAppliedPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppPolicy))]
    public class GetMgDeviceAppManagementManagedAppRegistrationAppliedPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppPolicyCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.ManagedAppRegistrations[ManagedAppRegistrationId].AppliedPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.ManagedAppRegistrations[ManagedAppRegistrationId].AppliedPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
