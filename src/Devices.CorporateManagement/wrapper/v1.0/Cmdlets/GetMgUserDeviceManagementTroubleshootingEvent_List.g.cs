...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserDeviceManagementTroubleshootingEvent_List")]
    ...
    public class GetMgUserDeviceManagementTroubleshootingEvent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceManagementTroubleshootingEventCollectionResponse? result;
            try
            {
                result = client.Users[UserId].DeviceManagementTroubleshootingEvents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].DeviceManagementTroubleshootingEvents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
