...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX/categories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategory_Get or Get-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategory_Get" : "Get-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXCategory_List";
            try
            {
