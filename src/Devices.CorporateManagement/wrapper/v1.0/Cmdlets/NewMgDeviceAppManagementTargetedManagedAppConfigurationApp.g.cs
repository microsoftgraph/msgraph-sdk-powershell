...
{
    [GraphRoute("POST", "/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration-id}/apps")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementTargetedManagedAppConfigurationApp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedMobileApp))]
    public class NewMgDeviceAppManagementTargetedManagedAppConfigurationAppCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MobileAppIdentifier)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.TargetedManagedAppConfigurations[TargetedManagedAppConfigurationId].Apps.PostAsync(body, requestConfiguration =>
                {
