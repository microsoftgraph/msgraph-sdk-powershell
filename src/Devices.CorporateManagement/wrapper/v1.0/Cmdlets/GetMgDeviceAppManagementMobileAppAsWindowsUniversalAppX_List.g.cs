...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsUniversalAppX_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsUniversalAppX))]
    public class GetMgDeviceAppManagementMobileAppAsWindowsUniversalAppX_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsUniversalAppXCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphWindowsUniversalAppX.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphWindowsUniversalAppX.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
