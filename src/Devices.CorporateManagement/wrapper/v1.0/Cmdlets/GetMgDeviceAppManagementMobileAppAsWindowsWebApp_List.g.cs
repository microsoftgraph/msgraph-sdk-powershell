...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/graph.windowsWebApp")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsWebApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsWebApp))]
    public class GetMgDeviceAppManagementMobileAppAsWindowsWebApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.WindowsWebAppCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphWindowsWebApp.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphWindowsWebApp.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
