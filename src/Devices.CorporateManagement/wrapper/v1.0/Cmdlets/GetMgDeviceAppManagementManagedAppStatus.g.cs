...
{
    [GraphRoute("GET", "/deviceAppManagement/managedAppStatuses")]
    ...
    public class GetMgDeviceAppManagementManagedAppStatusCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementManagedAppStatus_Get" : "Get-MgDeviceAppManagementManagedAppStatus_List";
            try
            {
