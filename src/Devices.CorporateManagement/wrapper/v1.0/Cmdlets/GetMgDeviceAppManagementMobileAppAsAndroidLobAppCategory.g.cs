...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsAndroidLobAppCategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsAndroidLobAppCategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsAndroidLobAppCategory_Get or Get-MgDeviceAppManagementMobileAppAsAndroidLobAppCategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsAndroidLobAppCategory_Get" : "Get-MgDeviceAppManagementMobileAppAsAndroidLobAppCategory_List";
            try
            {
