...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementAndroidManagedAppProtectionAssignmentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TargetedManagedAppPolicyAssignmentId : AndroidManagedAppProtectionId);
                return;
            }
        }
    }
