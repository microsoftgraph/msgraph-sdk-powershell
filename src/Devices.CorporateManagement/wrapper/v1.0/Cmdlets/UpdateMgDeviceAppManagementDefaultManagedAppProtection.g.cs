...
{
    [GraphRoute("PATCH", "/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}")]
    [Cmdlet(VerbsData.Update, "MgDeviceAppManagementDefaultManagedAppProtection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DefaultManagedAppProtection))]
    public class UpdateMgDeviceAppManagementDefaultManagedAppProtectionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CustomSettings)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.DefaultManagedAppProtections[DefaultManagedAppProtectionId].PatchAsync(body, requestConfiguration =>
                {
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.DeviceAppManagement.DefaultManagedAppProtections[DefaultManagedAppProtectionId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowGraphRequestFailed(ex, DefaultManagedAppProtectionId);
