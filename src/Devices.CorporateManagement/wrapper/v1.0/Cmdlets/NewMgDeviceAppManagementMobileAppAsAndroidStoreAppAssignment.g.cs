...
{
    [GraphRoute("POST", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/assignments")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementMobileAppAsAndroidStoreAppAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MobileAppAssignment))]
    public class NewMgDeviceAppManagementMobileAppAsAndroidStoreAppAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.MobileApps[MobileAppId].GraphAndroidStoreApp.Assignments.PostAsync(body, requestConfiguration =>
                {
