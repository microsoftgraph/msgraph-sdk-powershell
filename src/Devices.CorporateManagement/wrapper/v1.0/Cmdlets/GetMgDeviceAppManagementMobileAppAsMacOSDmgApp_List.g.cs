...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/graph.macOSDmgApp")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsMacOSDmgApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MacOSDmgApp))]
    public class GetMgDeviceAppManagementMobileAppAsMacOSDmgApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MacOSDmgAppCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphMacOSDmgApp.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphMacOSDmgApp.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
