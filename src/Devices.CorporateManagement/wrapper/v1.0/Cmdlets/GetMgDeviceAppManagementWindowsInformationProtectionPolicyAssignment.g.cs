...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementWindowsInformationProtectionPolicyAssignmentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TargetedManagedAppPolicyAssignmentId : WindowsInformationProtectionPolicyId);
                return;
            }
        }
    }
