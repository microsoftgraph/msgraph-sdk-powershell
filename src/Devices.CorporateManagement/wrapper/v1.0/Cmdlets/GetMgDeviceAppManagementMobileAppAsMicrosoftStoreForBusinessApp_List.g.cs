...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessApp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MicrosoftStoreForBusinessApp))]
    public class GetMgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessApp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MicrosoftStoreForBusinessAppCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MobileApps.GraphMicrosoftStoreForBusinessApp.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MobileApps.GraphMicrosoftStoreForBusinessApp.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
