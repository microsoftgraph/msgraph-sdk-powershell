...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    public class GetMgDeviceAppManagementiOSManagedAppProtectionAssignmentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? TargetedManagedAppPolicyAssignmentId : IosManagedAppProtectionId);
                return;
            }
        }
    }
