...
{
    [GraphRoute("GET", "/deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp/categories")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategory_Get or Get-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategory_Get" : "Get-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategory_List";
            try
            {
