...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserManagedDeviceLogCollectionResponse_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceLogCollectionResponse))]
    public class GetMgUserManagedDeviceLogCollectionResponse_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.DeviceLogCollectionResponseCollectionResponse? result;
            try
            {
                result = client.Users[UserId].ManagedDevices[ManagedDeviceId].LogCollectionRequests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].ManagedDevices[ManagedDeviceId].LogCollectionRequests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
