...
{
    [GraphRoute("POST", "/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}/exemptAppLockerFiles")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementWindowsInformationProtectionPolicyExemptAppLockerFile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceAppManagementWindowsInformationProtectionPolicyExemptAppLockerFileCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Version)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.WindowsInformationProtectionPolicies[WindowsInformationProtectionPolicyId].ExemptAppLockerFiles.PostAsync(body, requestConfiguration =>
                {
