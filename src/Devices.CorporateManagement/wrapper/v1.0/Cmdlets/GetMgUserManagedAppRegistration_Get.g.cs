...
{
    [GraphRoute("GET", "/users/{user-id}/managedAppRegistrations/{managedAppRegistration-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserManagedAppRegistration_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.ManagedAppRegistration))]
    public class GetMgUserManagedAppRegistration_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ManagedAppRegistrations[ManagedAppRegistrationId].GetAsync(requestConfiguration =>
                {
