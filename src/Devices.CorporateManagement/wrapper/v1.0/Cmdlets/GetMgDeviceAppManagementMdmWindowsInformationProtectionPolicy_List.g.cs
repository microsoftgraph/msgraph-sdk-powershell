...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMdmWindowsInformationProtectionPolicy_List")]
    ...
    public class GetMgDeviceAppManagementMdmWindowsInformationProtectionPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Devices.CorporateManagement.Client.Models.MdmWindowsInformationProtectionPolicyCollectionResponse? result;
            try
            {
                result = client.DeviceAppManagement.MdmWindowsInformationProtectionPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceAppManagement.MdmWindowsInformationProtectionPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
