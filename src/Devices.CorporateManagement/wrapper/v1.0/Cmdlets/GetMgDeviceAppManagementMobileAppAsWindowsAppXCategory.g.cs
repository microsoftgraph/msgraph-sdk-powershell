...
namespace Microsoft.Graph.PowerShell.Devices.CorporateManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceAppManagementMobileAppAsWindowsAppXCategory", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceAppManagementMobileAppAsWindowsAppXCategoryCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceAppManagementMobileAppAsWindowsAppXCategory_Get or Get-MgDeviceAppManagementMobileAppAsWindowsAppXCategory_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceAppManagementMobileAppAsWindowsAppXCategory_Get" : "Get-MgDeviceAppManagementMobileAppAsWindowsAppXCategory_List";
            try
            {
