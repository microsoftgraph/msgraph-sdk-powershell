...
{
    [GraphRoute("POST", "/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments")]
    [Cmdlet(VerbsCommon.New, "MgDeviceAppManagementAndroidManagedAppProtectionAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceAppManagementAndroidManagedAppProtectionAssignmentCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(AndroidManagedAppProtectionId, "New"))
                return;
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceAppManagement.AndroidManagedAppProtections[AndroidManagedAppProtectionId].Assignments.PostAsync(body, requestConfiguration =>
                {
