...
```
Update-MgUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-AadRegistered]
 ...
 [-ExchangeLastSuccessfulSyncDateTime <DateTime>] [-FreeStorageSpaceInBytes <Int64>]
 [-HardwareInformation <IMicrosoftGraphHardwareInformation>] [-Iccid <String>] [-Id <String>] [-Imei <String>]
 [-IsEncrypted] [-IsSupervised] [-JailBroken <String>] [-JoinType <String>] [-LastSyncDateTime <DateTime>]
 ...
 [-UserId1 <String>] [-UserPrincipalName <String>] [-Users <IMicrosoftGraphUser[]>]
 ...
 [-WindowsRemediatedMalwareCount <Int32>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgUserManagedDevice [-UserId <String>] -InputObject <IDevicesCorporateManagementIdentity>
 [-AadRegistered] [-ActivationLockBypassCode <String>] [-AdditionalProperties <Hashtable>]
...
### -SkuNumber
Device sku number, see also: https://docs.microsoft.com/en-us/windows/win32/api/sysinfoapi/nf-sysinfoapi-getproductinfo.
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgusermanageddevice](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgusermanageddevice)
