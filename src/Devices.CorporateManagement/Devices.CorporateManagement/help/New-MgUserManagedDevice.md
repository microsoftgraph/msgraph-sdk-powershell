...
```
New-MgUserManagedDevice [-UserId <String>] -InputObject <IDevicesCorporateManagementIdentity> [-AadRegistered]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgusermanageddevice](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgusermanageddevice)
