...
New-MgDeviceAppMgtiOSManagedAppProtection [-AdditionalProperties <Hashtable>]
 ...
 [-TargetedAppManagementLevels <String>] [-ThirdPartyKeyboardsBlocked] [-Version <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### Create1
```
New-MgDeviceAppMgtiOSManagedAppProtection -BodyParameter <IMicrosoftGraphIosManagedAppProtection1> [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmgtiosmanagedappprotection](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmgtiosmanagedappprotection)
