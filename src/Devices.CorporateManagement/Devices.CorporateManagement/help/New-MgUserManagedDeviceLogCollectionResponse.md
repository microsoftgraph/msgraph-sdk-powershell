...
New-MgUserManagedDeviceLogCollectionResponse -ManagedDeviceId <String> -UserId <String>
 ...
 [-RequestedDateTimeUtc <DateTime>] [-Size <Double>] [-Status <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgusermanageddevicelogcollectionresponse](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgusermanageddevicelogcollectionresponse)
