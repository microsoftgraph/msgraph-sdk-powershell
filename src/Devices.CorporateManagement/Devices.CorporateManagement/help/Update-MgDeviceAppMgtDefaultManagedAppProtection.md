...
Update-MgDeviceAppMgtDefaultManagedAppProtection -DefaultManagedAppProtectionId <String>
 ...
 [-AppActionIfDeviceLockNotSet <String>] [-AppActionIfIosDeviceModelNotAllowed <String>]
 ...
 [-FaceIdBlocked] [-FilterOpenInToOnlyManagedApps] [-FingerprintBlocked] [-Id <String>]
 ...
 [-WipeAfterCompanyPortalUpdateDeferralInDays <Int32>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgDeviceAppMgtDefaultManagedAppProtection -DefaultManagedAppProtectionId <String>
 -BodyParameter <IMicrosoftGraphDefaultManagedAppProtection1> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmgtdefaultmanagedappprotection](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmgtdefaultmanagedappprotection)
