...
### List1 (Default)
```
Get-MgDeviceAppMgtMobileAppAsMobileLobApp [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgDeviceAppMgtMobileAppAsMobileLobApp -MobileAppId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgDeviceAppMgtMobileAppAsMobileLobApp -InputObject <IDevicesCorporateManagementIdentity>
