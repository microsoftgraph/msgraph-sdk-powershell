...
# New-MgBetaDeviceAppMgtMobileAppDeviceStatuses
...
```
New-MgBetaDeviceAppMgtMobileAppDeviceStatuses -MobileAppId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaDeviceAppMgtMobileAppDeviceStatuses -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphMobileAppInstallStatus> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceAppMgtMobileAppDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppInstallStatus> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### New-MgBetaDeviceAppManagementMobileAppDeviceStatuses
