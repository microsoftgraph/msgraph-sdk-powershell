...
# Remove-MgBetaDeviceAppMgtMobileAppConfigurationDeviceStatuses
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceAppMgtMobileAppConfigurationDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Remove-MgBetaDeviceAppManagementMobileAppConfigurationDeviceStatuses
