...
```
New-MgBetaDeviceAppMgtManagedEBookDeviceState -ManagedEBookId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaDeviceAppMgtManagedEBookDeviceState -ManagedEBookId <String>
 -BodyParameter <IMicrosoftGraphDeviceInstallState> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceAppMgtManagedEBookDeviceState -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceInstallState> [-Confirm] [-WhatIf] [<CommonParameters>]
```
