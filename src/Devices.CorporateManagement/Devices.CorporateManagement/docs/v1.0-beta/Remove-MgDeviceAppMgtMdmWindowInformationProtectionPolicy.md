...
### Delete (Default)
```
Remove-MgBetaDeviceAppMgtMdmWindowInformationProtectionPolicy -MdmWindowsInformationProtectionPolicyId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceAppMgtMdmWindowInformationProtectionPolicy -InputObject <IDevicesCorporateManagementIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Remove-MgBetaDeviceAppManagementMdmWindowInformationProtectionPolicy
