...
```
New-MgBetaDeviceAppMgtWindowManagedAppProtectionApp -WindowsManagedAppProtectionId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceAppMgtWindowManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### New-MgBetaDeviceAppManagementWindowManagedAppProtectionApp
