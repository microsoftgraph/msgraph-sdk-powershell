...
```
New-MgBetaDeviceAppMgtiOSManagedAppProtectionApp -IosManagedAppProtectionId <String>
...
### CreateViaIdentity1
```
New-MgBetaDeviceAppMgtiOSManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```
