...
```
New-MgBetaDeviceAppMgtManagedAppRegistrationAppliedPolicy -ManagedAppRegistrationId <String>
...
### CreateViaIdentity1
```
New-MgBetaDeviceAppMgtManagedAppRegistrationAppliedPolicy -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedAppPolicy1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
