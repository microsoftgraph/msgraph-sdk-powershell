...
```
Update-MgBetaDeviceAppMgtDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtDefaultManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
