...
# Invoke-MgBetaHasDeviceAppMgtTargetedManagedAppConfigurationPayloadLink
...
### HasExpanded (Default)
```
Invoke-MgBetaHasDeviceAppMgtTargetedManagedAppConfigurationPayloadLink [-AdditionalProperties <Hashtable>]
