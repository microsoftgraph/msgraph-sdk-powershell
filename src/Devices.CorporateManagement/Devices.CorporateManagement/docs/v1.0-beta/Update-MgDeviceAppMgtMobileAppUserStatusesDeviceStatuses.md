...
# Update-MgBetaDeviceAppMgtMobileAppUserStatusesDeviceStatuses
...
```
Update-MgBetaDeviceAppMgtMobileAppUserStatusesDeviceStatuses -MobileAppId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtMobileAppUserStatusesDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppInstallStatus> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Update-MgBetaDeviceAppManagementMobileAppUserStatusesDeviceStatuses
