...
### List (Default)
```
Get-MgBetaDeviceAppMgtMobileAppConfigurationAssignment -ManagedDeviceMobileAppConfigurationId <String>
...
### Get
```
Get-MgBetaDeviceAppMgtMobileAppConfigurationAssignment -ManagedDeviceMobileAppConfigurationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceAppMgtMobileAppConfigurationAssignment -InputObject <IDevicesCorporateManagementIdentity>
