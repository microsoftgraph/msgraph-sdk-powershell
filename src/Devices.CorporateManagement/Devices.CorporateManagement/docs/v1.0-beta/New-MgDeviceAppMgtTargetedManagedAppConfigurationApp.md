...
```
New-MgBetaDeviceAppMgtTargetedManagedAppConfigurationApp -TargetedManagedAppConfigurationId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceAppMgtTargetedManagedAppConfigurationApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```
