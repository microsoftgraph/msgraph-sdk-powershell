...
### Delete (Default)
```
Remove-MgBetaDeviceAppMgtMobileAppConfiguration -ManagedDeviceMobileAppConfigurationId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceAppMgtMobileAppConfiguration -InputObject <IDevicesCorporateManagementIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
