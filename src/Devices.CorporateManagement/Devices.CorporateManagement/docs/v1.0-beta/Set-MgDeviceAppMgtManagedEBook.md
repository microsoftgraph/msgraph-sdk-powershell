...
```
Set-MgBetaDeviceAppMgtManagedEBook -ManagedEBookId <String> [-AdditionalProperties <Hashtable>]
...
### Assign
```
Set-MgBetaDeviceAppMgtManagedEBook -ManagedEBookId <String>
...
### AssignViaIdentity
```
Set-MgBetaDeviceAppMgtManagedEBook -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPathsWfdti0DeviceappmanagementManagedebooksManagedebookIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
