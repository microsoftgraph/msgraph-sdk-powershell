...
### List (Default)
```
Get-MgBetaDeviceAppMgtWindowInformationProtectionDeviceRegistration [-ExpandProperty <String[]>]
...
### Get-MgBetaDeviceAppManagementWindowInformationProtectionDeviceRegistration
