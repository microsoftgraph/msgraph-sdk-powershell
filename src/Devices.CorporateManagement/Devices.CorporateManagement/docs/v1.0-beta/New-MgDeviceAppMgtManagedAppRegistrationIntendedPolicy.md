...
```
New-MgBetaDeviceAppMgtManagedAppRegistrationIntendedPolicy -ManagedAppRegistrationId <String>
...
### CreateViaIdentity1
```
New-MgBetaDeviceAppMgtManagedAppRegistrationIntendedPolicy -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedAppPolicy1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
