...
```
Update-MgBetaDeviceAppMgtPolicySetAssignment -PolicySetAssignmentId <String> -PolicySetId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtPolicySetAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphPolicySetAssignment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
