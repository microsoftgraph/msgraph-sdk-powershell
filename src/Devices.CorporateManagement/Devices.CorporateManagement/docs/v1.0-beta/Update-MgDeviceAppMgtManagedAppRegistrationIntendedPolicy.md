...
```
Update-MgBetaDeviceAppMgtManagedAppRegistrationIntendedPolicy -ManagedAppPolicyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtManagedAppRegistrationIntendedPolicy -InputObject <IDevicesCorporateManagementIdentity>
