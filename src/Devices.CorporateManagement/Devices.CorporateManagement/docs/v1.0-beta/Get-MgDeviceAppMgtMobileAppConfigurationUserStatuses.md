...
# Get-MgBetaDeviceAppMgtMobileAppConfigurationUserStatuses
...
### List (Default)
```
Get-MgBetaDeviceAppMgtMobileAppConfigurationUserStatuses -ManagedDeviceMobileAppConfigurationId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceAppMgtMobileAppConfigurationUserStatuses -InputObject <IDevicesCorporateManagementIdentity>
...
### Get-MgBetaDeviceAppManagementMobileAppConfigurationUserStatuses
