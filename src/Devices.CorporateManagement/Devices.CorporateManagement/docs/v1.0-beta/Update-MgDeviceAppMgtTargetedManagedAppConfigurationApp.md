...
```
Update-MgBetaDeviceAppMgtTargetedManagedAppConfigurationApp -ManagedMobileAppId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtTargetedManagedAppConfigurationApp -InputObject <IDevicesCorporateManagementIdentity>
