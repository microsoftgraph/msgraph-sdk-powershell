...
```
New-MgBetaDeviceAppMgtWindowManagedAppProtectionAssignment -WindowsManagedAppProtectionId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceAppMgtWindowManagedAppProtectionAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphTargetedManagedAppPolicyAssignment1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### New-MgBetaDeviceAppManagementWindowManagedAppProtectionAssignment
