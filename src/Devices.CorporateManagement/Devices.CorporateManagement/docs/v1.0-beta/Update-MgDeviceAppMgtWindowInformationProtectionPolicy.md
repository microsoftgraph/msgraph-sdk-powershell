...
```
Update-MgBetaDeviceAppMgtWindowInformationProtectionPolicy -WindowsInformationProtectionPolicyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppMgtWindowInformationProtectionPolicy -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphWindowsInformationProtectionPolicy1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Update-MgBetaDeviceAppManagementWindowInformationProtectionPolicy
