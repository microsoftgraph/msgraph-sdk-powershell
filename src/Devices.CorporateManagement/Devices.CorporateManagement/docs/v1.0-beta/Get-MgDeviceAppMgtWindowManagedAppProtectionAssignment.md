...
### List (Default)
```
Get-MgBetaDeviceAppMgtWindowManagedAppProtectionAssignment -WindowsManagedAppProtectionId <String>
...
### Get
```
Get-MgBetaDeviceAppMgtWindowManagedAppProtectionAssignment -TargetedManagedAppPolicyAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceAppMgtWindowManagedAppProtectionAssignment -InputObject <IDevicesCorporateManagementIdentity>
...
### Get-MgBetaDeviceAppManagementWindowManagedAppProtectionAssignment
