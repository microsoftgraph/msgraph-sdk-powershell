...
### Get (Default)
```
Get-MgDeviceAppMgtVppTokenLicenseForApp -BundleId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceAppMgtVppTokenLicenseForApp -InputObject <IDevicesCorporateManagementIdentity>
 [<CommonParameters>]
```
