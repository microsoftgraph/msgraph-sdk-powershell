...
# Remove-MgBetaDeviceAppMgtMobileAppDeviceStatuses
...
### Delete (Default)
```
Remove-MgBetaDeviceAppMgtMobileAppDeviceStatuses -MobileAppId <String> -MobileAppInstallStatusId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceAppMgtMobileAppDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Remove-MgBetaDeviceAppManagementMobileAppDeviceStatuses
