...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasmicrosoftstoreforbusinessappcategorycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppCategoryCount -MobileAppId <String>
