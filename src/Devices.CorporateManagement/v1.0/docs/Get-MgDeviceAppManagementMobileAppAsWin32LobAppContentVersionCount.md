...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappaswin32lobappcontentversioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppAsWin32LobAppContentVersionCount -MobileAppId <String> [-Filter <String>]
