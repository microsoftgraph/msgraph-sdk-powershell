...
Update-MgDeviceAppManagementiOSManagedAppProtection -IosManagedAppProtectionId <String>
 ...
 [-PrintBlocked] [-SaveAsBlocked] [-SimplePinBlocked] [-Version <String>] [-Headers <IDictionary>] [-Confirm]
...
```
Update-MgDeviceAppManagementiOSManagedAppProtection -IosManagedAppProtectionId <String>
 -BodyParameter <IMicrosoftGraphIosManagedAppProtection> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
