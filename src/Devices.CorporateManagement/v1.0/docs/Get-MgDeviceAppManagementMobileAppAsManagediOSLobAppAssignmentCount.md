...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasmanagedioslobappassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppAsManagediOSLobAppAssignmentCount -MobileAppId <String> [-Filter <String>]
