...
New-MgDeviceAppManagementDefaultManagedAppProtection [-AdditionalProperties <Hashtable>]
 ...
 [-ScreenCaptureBlocked] [-SimplePinBlocked] [-Version <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgDeviceAppManagementDefaultManagedAppProtection
 -BodyParameter <IMicrosoftGraphDefaultManagedAppProtection> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
