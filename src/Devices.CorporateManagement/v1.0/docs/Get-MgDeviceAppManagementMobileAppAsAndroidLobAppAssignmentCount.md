...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasandroidlobappassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppAsAndroidLobAppAssignmentCount -MobileAppId <String> [-Filter <String>]
