...
Update-MgDeviceAppManagementiOSManagedAppProtectionApp -IosManagedAppProtectionId <String>
 ...
 [-MobileAppIdentifier <Hashtable>] [-Version <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceAppManagementiOSManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
