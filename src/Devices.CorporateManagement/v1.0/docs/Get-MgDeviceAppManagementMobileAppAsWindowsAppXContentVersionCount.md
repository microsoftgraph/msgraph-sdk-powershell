...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappaswindowsappxcontentversioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppAsWindowsAppXContentVersionCount -MobileAppId <String> [-Filter <String>]
