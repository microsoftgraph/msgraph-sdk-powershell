if(($null -eq $TestName) -or ($TestName -contains 'Remove-MgDeviceAppManagementMobileAppContentVersion'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-MgDeviceAppManagementMobileAppContentVersion.Recording.json'
...
Describe 'Remove-MgDeviceAppManagementMobileAppContentVersion' {
    It 'Delete' -skip {
