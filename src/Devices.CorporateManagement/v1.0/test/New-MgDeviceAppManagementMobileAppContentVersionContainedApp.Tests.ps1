if(($null -eq $TestName) -or ($TestName -contains 'New-MgDeviceAppManagementMobileAppContentVersionContainedApp'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgDeviceAppManagementMobileAppContentVersionContainedApp.Recording.json'
...
Describe 'New-MgDeviceAppManagementMobileAppContentVersionContainedApp' {
