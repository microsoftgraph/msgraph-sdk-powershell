if(($null -eq $TestName) -or ($TestName -contains 'Update-MgDeviceAppManagementMobileAppContentVersion'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgDeviceAppManagementMobileAppContentVersion.Recording.json'
...
Describe 'Update-MgDeviceAppManagementMobileAppContentVersion' {
