if(($null -eq $TestName) -or ($TestName -contains 'Update-MgDeviceAppManagementMobileAppContentVersionFile'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgDeviceAppManagementMobileAppContentVersionFile.Recording.json'
...
Describe 'Update-MgDeviceAppManagementMobileAppContentVersionFile' {
