if(($null -eq $TestName) -or ($TestName -contains 'New-MgDeviceAppManagementMobileAppContentVersionFile'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-MgDeviceAppManagementMobileAppContentVersionFile.Recording.json'
...
Describe 'New-MgDeviceAppManagementMobileAppContentVersionFile' {
