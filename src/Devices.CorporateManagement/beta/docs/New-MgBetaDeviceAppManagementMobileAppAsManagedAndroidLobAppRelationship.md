...
New-MgBetaDeviceAppManagementMobileAppAsManagedAndroidLobAppRelationship -MobileAppId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-ResponseHeadersVariable <String>] [-TargetId <String>]
...
New-MgBetaDeviceAppManagementMobileAppAsManagedAndroidLobAppRelationship
 ...
 [-ResponseHeadersVariable <String>] [-TargetId <String>] [-TargetType <MobileAppRelationshipType>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
