...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementmobileappuserstatusdevicestatus
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceAppManagementMobileAppUserStatusDeviceStatus -MobileAppId <String>
 -UserAppInstallStatusId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
