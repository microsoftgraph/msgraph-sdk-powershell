...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappcatalogpackage
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppCatalogPackage -MobileAppCatalogPackageId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppManagementMobileAppCatalogPackage -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppCatalogPackage> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
The unique identifier of mobileAppCatalogPackage
