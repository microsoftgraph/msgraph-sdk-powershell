...
Update-MgBetaDeviceAppManagementSymantecCodeSigningCertificate [-AdditionalProperties <Hashtable>]
 ...
 [-IssuerName <String>] [-Password <String>] [-ResponseHeadersVariable <String>] [-Status <String>]
 [-Subject <String>] [-SubjectName <String>] [-UploadDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm]
