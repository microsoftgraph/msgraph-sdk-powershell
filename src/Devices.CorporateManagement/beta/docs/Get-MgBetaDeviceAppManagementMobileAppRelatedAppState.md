...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementmobileapprelatedappstate
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceAppManagementMobileAppRelatedAppState -DeviceId <String> -MobileAppId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceAppManagementMobileAppRelatedAppState -InputObject <IDevicesCorporateManagementIdentity>
