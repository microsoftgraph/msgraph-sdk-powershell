...
Update-MgBetaDeviceAppManagementPolicySetItem -PolicySetId <String> -PolicySetItemId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-PayloadId <String>] [-Status <PolicySetStatus>] [-Headers <IDictionary>]
...
```
Update-MgBetaDeviceAppManagementPolicySetItem -PolicySetId <String> -PolicySetItemId <String>
 -BodyParameter <IMicrosoftGraphPolicySetItem> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
