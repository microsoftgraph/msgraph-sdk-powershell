...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmanagedappregistrationmanagedapplogcollectionrequest
schema: 2.0.0
---
...
Update-MgBetaDeviceAppManagementManagedAppRegistrationManagedAppLogCollectionRequest
 ...
 [-ManagedAppRegistrationId1 <String>] [-RequestedBy <String>] [-RequestedByUserPrincipalName <String>]
 [-RequestedDateTime <DateTime>] [-ResponseHeadersVariable <String>] [-Status <String>]
...
Update-MgBetaDeviceAppManagementManagedAppRegistrationManagedAppLogCollectionRequest
 ...
 [-AdditionalProperties <Hashtable>] [-CompletedDateTime <DateTime>] [-Id <String>] [-RequestedBy <String>]
 [-RequestedByUserPrincipalName <String>] [-RequestedDateTime <DateTime>] [-ResponseHeadersVariable <String>]
 [-Status <String>] [-UploadedLogs <IMicrosoftGraphManagedAppLogUpload[]>]
 [-UserLogUploadConsent <ManagedAppLogUploadConsent>] [-Version <String>] [-Headers <IDictionary>] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphManagedAppLogUpload[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Support.ManagedAppLogUploadConsent
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
