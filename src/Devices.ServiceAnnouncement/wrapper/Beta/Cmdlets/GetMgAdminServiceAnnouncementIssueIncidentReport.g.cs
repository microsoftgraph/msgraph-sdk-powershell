...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementIssueIncidentReport")]
    [OutputType(typeof(byte[]))]
    public class GetMgAdminServiceAnnouncementIssueIncidentReportCommand : GraphClientCmdlet
    {
