...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementIssue", DefaultParameterSetName = "List")]
    ...
    public class GetMgAdminServiceAnnouncementIssueCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgAdminServiceAnnouncementIssue_Get or Get-MgAdminServiceAnnouncementIssue_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgAdminServiceAnnouncementIssue_Get" : "Get-MgAdminServiceAnnouncementIssue_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ServiceHealthIssueId : null);
                return;
            }
        }
    }
