...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAdminServiceAnnouncementMessageFavorite", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgAdminServiceAnnouncementMessageFavoriteCommand : GraphClientCmdlet
    {
