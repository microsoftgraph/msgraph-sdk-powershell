...
{
    [GraphRoute("GET", "/admin/serviceAnnouncement/healthOverviews/{serviceHealth-id}/issues")]
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementHealthOverviewIssue", DefaultParameterSetName = "List")]
    ...
    public class GetMgAdminServiceAnnouncementHealthOverviewIssueCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgAdminServiceAnnouncementHealthOverviewIssue_Get or Get-MgAdminServiceAnnouncementHealthOverviewIssue_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgAdminServiceAnnouncementHealthOverviewIssue_Get" : "Get-MgAdminServiceAnnouncementHealthOverviewIssue_List";
            try
            {
