...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementMessage", DefaultParameterSetName = "List")]
    ...
    public class GetMgAdminServiceAnnouncementMessageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgAdminServiceAnnouncementMessage_Get or Get-MgAdminServiceAnnouncementMessage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgAdminServiceAnnouncementMessage_Get" : "Get-MgAdminServiceAnnouncementMessage_List";
            try
            {
