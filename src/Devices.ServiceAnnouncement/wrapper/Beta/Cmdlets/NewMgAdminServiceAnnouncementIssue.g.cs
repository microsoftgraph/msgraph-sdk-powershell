...
{
    [GraphRoute("POST", "/admin/serviceAnnouncement/issues")]
    [Cmdlet(VerbsCommon.New, "MgAdminServiceAnnouncementIssue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement.Client.Models.ServiceHealthIssue))]
    public class NewMgAdminServiceAnnouncementIssueCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Admin.ServiceAnnouncement.Issues.PostAsync(body, requestConfiguration =>
                {
