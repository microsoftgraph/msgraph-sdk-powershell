...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementHealthOverviewIssueIncidentReport")]
    [OutputType(typeof(byte[]))]
    public class GetMgAdminServiceAnnouncementHealthOverviewIssueIncidentReportCommand : GraphClientCmdlet
    {
