...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncementMessageAttachmentCount")]
    [OutputType(typeof(int))]
    public class GetMgAdminServiceAnnouncementMessageAttachmentCountCommand : GraphClientCmdlet
    {
