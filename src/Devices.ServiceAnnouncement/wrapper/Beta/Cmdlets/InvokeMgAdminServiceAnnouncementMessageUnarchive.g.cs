...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAdminServiceAnnouncementMessageUnarchive", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgAdminServiceAnnouncementMessageUnarchiveCommand : GraphClientCmdlet
    {
