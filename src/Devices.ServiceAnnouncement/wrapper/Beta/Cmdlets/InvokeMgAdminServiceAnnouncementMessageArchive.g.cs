...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAdminServiceAnnouncementMessageArchive", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgAdminServiceAnnouncementMessageArchiveCommand : GraphClientCmdlet
    {
