...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAdminServiceAnnouncementMessageMarkUnread", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgAdminServiceAnnouncementMessageMarkUnreadCommand : GraphClientCmdlet
    {
