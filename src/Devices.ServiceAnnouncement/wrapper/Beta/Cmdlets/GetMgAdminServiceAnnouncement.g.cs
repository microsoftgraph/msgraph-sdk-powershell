...
{
    [GraphRoute("GET", "/admin/serviceAnnouncement")]
    [Cmdlet(VerbsCommon.Get, "MgAdminServiceAnnouncement")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement.Client.Models.ServiceAnnouncement))]
    public class GetMgAdminServiceAnnouncementCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Admin.ServiceAnnouncement.GetAsync(requestConfiguration =>
                {
