...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServiceAnnouncementMessageAttachmentArchive")]
    [OutputType(typeof(byte[]))]
    public class GetMgServiceAnnouncementMessageAttachmentArchiveCommand : GraphClientCmdlet
    {
