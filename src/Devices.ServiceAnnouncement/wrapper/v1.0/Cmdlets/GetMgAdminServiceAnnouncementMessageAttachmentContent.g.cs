...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    public class GetMgAdminServiceAnnouncementMessageAttachmentContentCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ServiceAnnouncementAttachmentId));
                return;
            }
