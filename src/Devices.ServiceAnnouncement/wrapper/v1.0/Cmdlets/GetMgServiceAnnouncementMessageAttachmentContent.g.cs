...
namespace Microsoft.Graph.PowerShell.Devices.ServiceAnnouncement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgServiceAnnouncementMessageAttachmentContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgServiceAnnouncementMessageAttachmentContentCommand : GraphClientCmdlet
    {
