...
### List1 (Default)
```
Get-MgReportDailyPrintUsageSummaryByUser [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgReportDailyPrintUsageSummaryByUser -PrintUsageSummaryByUserId <String> [-ExpandProperty <String[]>]
...
key: id of PrintUsageSummaryByUser
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportdailyprintusagesummarybyuser](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportdailyprintusagesummarybyuser)
