...
### List (Default)
```
Get-MgReportUserCredentialUsageDetail [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgReportUserCredentialUsageDetail -UserCredentialUsageDetailsId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportUserCredentialUsageDetail -InputObject <IReportsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
