...
### Get2 (Default)
```
Get-MgBetaReportSharePointActivityUserDetail -Date <DateTime> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### Get3
```
Get-MgBetaReportSharePointActivityUserDetail -Period <String> -OutFile <String> [-PassThru] [<CommonParameters>]
```
