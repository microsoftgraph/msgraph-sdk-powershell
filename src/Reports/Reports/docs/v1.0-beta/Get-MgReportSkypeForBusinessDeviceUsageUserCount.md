...
### Get (Default)
```
Get-MgBetaReportSkypeForBusinessDeviceUsageUserCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSkypeForBusinessDeviceUsageUserCount -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
