...
### List1 (Default)
```
Get-MgReportMonthlyPrintUsageSummaryByUser [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgReportMonthlyPrintUsageSummaryByUser -PrintUsageSummaryByUserId <String> [-ExpandProperty <String[]>]
