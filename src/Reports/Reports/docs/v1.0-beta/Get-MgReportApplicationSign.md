...
### List (Default)
```
Get-MgReportApplicationSign [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgReportApplicationSign -InputObject <IReportsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
