...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/update-mgreportcredentialuserregistrationdetail
schema: 2.0.0
---
...
```
Update-MgReportCredentialUserRegistrationDetail -CredentialUserRegistrationDetailsId <String>
 [-AuthMethods <String[]>] [-Id <String>] [-IsCapable] [-IsEnabled] [-IsMfaRegistered] [-IsRegistered]
...
```
Update-MgReportCredentialUserRegistrationDetail -CredentialUserRegistrationDetailsId <String>
 -BodyParameter <IMicrosoftGraphCredentialUserRegistrationDetails> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgReportCredentialUserRegistrationDetail -InputObject <IReportsIdentity>
 -BodyParameter <IMicrosoftGraphCredentialUserRegistrationDetails> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgReportCredentialUserRegistrationDetail -InputObject <IReportsIdentity> [-AuthMethods <String[]>]
 [-Id <String>] [-IsCapable] [-IsEnabled] [-IsMfaRegistered] [-IsRegistered] [-UserDisplayName <String>]
