...
### GetViaIdentity1
```
Get-MgBetaAuditLogProvisioning -InputObject <IReportsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphProvisioningObjectSummary1
