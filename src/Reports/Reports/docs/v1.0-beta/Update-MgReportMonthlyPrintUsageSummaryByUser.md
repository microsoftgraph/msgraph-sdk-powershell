...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/update-mgreportmonthlyprintusagesummarybyuser
schema: 2.0.0
---
...
```
Update-MgReportMonthlyPrintUsageSummaryByUser -PrintUsageSummaryByUserId <String>
...
### UpdateViaIdentity1
```
Update-MgReportMonthlyPrintUsageSummaryByUser -InputObject <IReportsIdentity>
 -BodyParameter <IMicrosoftGraphPrintUsageSummaryByUser> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
