...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/new-mgreportdailyprintusagesummarybyprinter
schema: 2.0.0
---
...
```
New-MgReportDailyPrintUsageSummaryByPrinter [-CompletedBlackAndWhiteJobCount <Int64>]
...
### Create
```
New-MgReportDailyPrintUsageSummaryByPrinter -BodyParameter <IMicrosoftGraphPrintUsageSummaryByPrinter>
