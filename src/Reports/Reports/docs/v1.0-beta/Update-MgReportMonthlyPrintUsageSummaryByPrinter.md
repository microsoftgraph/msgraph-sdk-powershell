...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/update-mgreportmonthlyprintusagesummarybyprinter
schema: 2.0.0
---
...
```
Update-MgReportMonthlyPrintUsageSummaryByPrinter -PrintUsageSummaryByPrinterId <String>
...
### UpdateViaIdentity
```
Update-MgReportMonthlyPrintUsageSummaryByPrinter -InputObject <IReportsIdentity>
 -BodyParameter <IMicrosoftGraphPrintUsageSummaryByPrinter> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
