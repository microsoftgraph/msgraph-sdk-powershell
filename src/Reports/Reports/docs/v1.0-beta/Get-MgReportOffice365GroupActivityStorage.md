...
### Get1 (Default)
```
Get-MgReportOffice365GroupActivityStorage -Period <String> [-Count] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365GroupActivityStorage -InputObject <IReportsIdentity> [-Count] [-Filter <String>]
