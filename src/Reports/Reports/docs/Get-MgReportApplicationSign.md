...
### List (Default)
```
Get-MgReportApplicationSign [-Count] [-Expand <String[]>] [-Filter <String>] [-Orderby <String[]>]
 [-Search <String>] [-Select <String[]>] [-Skip <Int32>] [-Top <Int32>] [<CommonParameters>]
```

### Get
```
Get-MgReportApplicationSign -ApplicationSignInDetailedSummaryId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportApplicationSign -InputObject <IReportsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
