...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAuthenticationMethodUserPasswordResetAndChangeSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserPasswordResetsAndChangesSummary))]
    public class GetMgReportAuthenticationMethodUserPasswordResetAndChangeSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserPasswordResetsAndChangesSummaryCollectionResponse? result;
            try
            {
                result = client.Reports.AuthenticationMethods.UserPasswordResetsAndChangesSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.AuthenticationMethods.UserPasswordResetsAndChangesSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
