...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAuthenticationMethodUserEventSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserEventsSummary))]
    public class GetMgReportAuthenticationMethodUserEventSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserEventsSummaryCollectionResponse? result;
            try
            {
                result = client.Reports.AuthenticationMethods.UserEventsSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.AuthenticationMethods.UserEventsSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
