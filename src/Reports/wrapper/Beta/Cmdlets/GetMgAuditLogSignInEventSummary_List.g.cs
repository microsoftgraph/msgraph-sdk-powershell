...
{
    [GraphRoute("GET", "/auditLogs/signInEventsSummary")]
    [Cmdlet(VerbsCommon.Get, "MgAuditLogSignInEventSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SignInEventsActivity))]
    public class GetMgAuditLogSignInEventSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.SignInEventsActivityCollectionResponse? result;
            try
            {
                result = client.AuditLogs.SignInEventsSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.SignInEventsSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
