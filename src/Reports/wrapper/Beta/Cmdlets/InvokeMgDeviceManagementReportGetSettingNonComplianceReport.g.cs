...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementReportGetSettingNonComplianceReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class InvokeMgDeviceManagementReportGetSettingNonComplianceReportCommand : GraphClientCmdlet
    {
