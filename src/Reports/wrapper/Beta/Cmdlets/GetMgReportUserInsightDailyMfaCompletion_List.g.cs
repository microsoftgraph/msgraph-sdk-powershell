...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyMfaCompletion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MfaCompletionMetric))]
    public class GetMgReportUserInsightDailyMfaCompletion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.UserInsights.Daily.MfaCompletions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.MfaCompletions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
