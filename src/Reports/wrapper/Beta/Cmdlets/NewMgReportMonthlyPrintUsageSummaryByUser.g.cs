...
{
    [GraphRoute("POST", "/reports/monthlyPrintUsageSummariesByUser")]
    [Cmdlet(VerbsCommon.New, "MgReportMonthlyPrintUsageSummaryByUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByUser))]
    public class NewMgReportMonthlyPrintUsageSummaryByUserCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserPrincipalName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.MonthlyPrintUsageSummariesByUser.PostAsync(body, requestConfiguration =>
                {
