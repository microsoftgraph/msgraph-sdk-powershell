...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyInactiveUserByApplication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MonthlyInactiveUsersByApplicationMetric))]
    public class GetMgReportUserInsightMonthlyInactiveUserByApplication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.MonthlyInactiveUsersByApplicationMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Monthly.InactiveUsersByApplication.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.InactiveUsersByApplication.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
