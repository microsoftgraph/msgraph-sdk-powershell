...
{
    [GraphRoute("POST", "/reports/dailyPrintUsage")]
    [Cmdlet(VerbsCommon.New, "MgReportDailyPrintUsage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsage))]
    public class NewMgReportDailyPrintUsageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UsageDate)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.DailyPrintUsage.PostAsync(body, requestConfiguration =>
                {
