...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyMfaRegisteredUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MfaUserCountMetric))]
    public class GetMgReportUserInsightMonthlyMfaRegisteredUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.MfaUserCountMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Monthly.MfaRegisteredUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.MfaRegisteredUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
