...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyMfaCompletion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MfaCompletionMetric))]
    public class GetMgReportUserInsightMonthlyMfaCompletion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.MfaCompletionMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Monthly.MfaCompletions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.MfaCompletions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
