...
{
    [GraphRoute("GET", "/auditLogs/auditActivityTypes")]
    [Cmdlet(VerbsCommon.Get, "MgAuditLogAuditActivityType_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.AuditActivityType))]
    public class GetMgAuditLogAuditActivityType_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.AuditActivityTypeCollectionResponse? result;
            try
            {
                result = client.AuditLogs.AuditActivityTypes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.AuditActivityTypes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
