...
{
    [GraphRoute("GET", "/reports/dailyPrintUsageSummariesByPrinter")]
    [Cmdlet(VerbsCommon.Get, "MgReportDailyPrintUsageSummaryByPrinter_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class GetMgReportDailyPrintUsageSummaryByPrinter_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.DailyPrintUsageSummariesByPrinter.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.DailyPrintUsageSummariesByPrinter.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
