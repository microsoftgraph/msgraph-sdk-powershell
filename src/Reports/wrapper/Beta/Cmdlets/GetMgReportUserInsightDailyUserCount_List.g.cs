...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyUserCount_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserCountMetric))]
    public class GetMgReportUserInsightDailyUserCount_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserCountMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.UserCount.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.UserCount.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
