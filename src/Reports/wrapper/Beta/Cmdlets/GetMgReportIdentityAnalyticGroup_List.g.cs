...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportIdentityAnalyticGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.GroupAnalytics))]
    public class GetMgReportIdentityAnalyticGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.GroupAnalyticsCollectionResponse? result;
            try
            {
                result = client.Reports.IdentityAnalytics.Groups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.IdentityAnalytics.Groups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
