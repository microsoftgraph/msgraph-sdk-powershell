...
{
    [GraphRoute("GET", "/reports/userInsights/daily/activeUsers")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyActiveUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.ActiveUsersMetric))]
    public class GetMgReportUserInsightDailyActiveUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.ActiveUsersMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.ActiveUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.ActiveUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
