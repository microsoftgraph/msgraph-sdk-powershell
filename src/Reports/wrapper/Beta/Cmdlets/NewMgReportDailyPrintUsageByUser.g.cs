...
{
    [GraphRoute("POST", "/reports/dailyPrintUsageByUser")]
    [Cmdlet(VerbsCommon.New, "MgReportDailyPrintUsageByUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByUser))]
    public class NewMgReportDailyPrintUsageByUserCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserPrincipalName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.DailyPrintUsageByUser.PostAsync(body, requestConfiguration =>
                {
