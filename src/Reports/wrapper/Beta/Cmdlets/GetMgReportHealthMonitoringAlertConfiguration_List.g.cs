...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportHealthMonitoringAlertConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.HealthMonitoring.AlertConfiguration))]
    public class GetMgReportHealthMonitoringAlertConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.HealthMonitoring.AlertConfigurationCollectionResponse? result;
            try
            {
                result = client.Reports.HealthMonitoring.AlertConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.HealthMonitoring.AlertConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
