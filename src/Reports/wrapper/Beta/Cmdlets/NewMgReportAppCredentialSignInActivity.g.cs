...
{
    [GraphRoute("POST", "/reports/appCredentialSignInActivities")]
    [Cmdlet(VerbsCommon.New, "MgReportAppCredentialSignInActivity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.AppCredentialSignInActivity))]
    public class NewMgReportAppCredentialSignInActivityCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SignInActivity)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.AppCredentialSignInActivities.PostAsync(body, requestConfiguration =>
                {
