...
{
    [GraphRoute("POST", "/reports/monthlyPrintUsageByUser")]
    [Cmdlet(VerbsCommon.New, "MgReportMonthlyPrintUsageByUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByUser))]
    public class NewMgReportMonthlyPrintUsageByUserCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserPrincipalName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.MonthlyPrintUsageByUser.PostAsync(body, requestConfiguration =>
                {
