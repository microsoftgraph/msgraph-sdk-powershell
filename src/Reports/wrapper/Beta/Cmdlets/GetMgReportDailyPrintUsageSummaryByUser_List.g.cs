...
{
    [GraphRoute("GET", "/reports/dailyPrintUsageSummariesByUser")]
    [Cmdlet(VerbsCommon.Get, "MgReportDailyPrintUsageSummaryByUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByUser))]
    public class GetMgReportDailyPrintUsageSummaryByUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.DailyPrintUsageSummariesByUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.DailyPrintUsageSummariesByUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
