...
{
    [GraphRoute("POST", "/auditLogs/directoryAudits")]
    [Cmdlet(VerbsCommon.New, "MgAuditLogDirectoryAudit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.DirectoryAudit))]
    public class NewMgAuditLogDirectoryAuditCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TargetResources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.AuditLogs.DirectoryAudits.PostAsync(body, requestConfiguration =>
                {
