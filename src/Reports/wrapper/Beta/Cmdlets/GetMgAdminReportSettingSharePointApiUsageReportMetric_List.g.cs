...
{
    [GraphRoute("GET", "/admin/reportSettings/sharePoint/apiUsageReportMetrics")]
    [Cmdlet(VerbsCommon.Get, "MgAdminReportSettingSharePointApiUsageReportMetric_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.ApiUsageReportEnablementStatus))]
    public class GetMgAdminReportSettingSharePointApiUsageReportMetric_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.ApiUsageReportEnablementStatusCollectionResponse? result;
            try
            {
                result = client.Admin.ReportSettings.SharePoint.ApiUsageReportMetrics.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.ReportSettings.SharePoint.ApiUsageReportMetrics.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
