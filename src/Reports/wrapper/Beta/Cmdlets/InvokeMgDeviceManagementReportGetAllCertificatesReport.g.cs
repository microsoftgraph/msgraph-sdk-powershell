...
{
    [GraphRoute("POST", "/deviceManagement/reports/getAllCertificatesReport")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementReportGetAllCertificatesReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class InvokeMgDeviceManagementReportGetAllCertificatesReportCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.DeviceManagement.Reports.GetAllCertificatesReport.GetAllCertificatesReportPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Filter)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Reports.GetAllCertificatesReport.PostAsync(body, requestConfiguration =>
                {
