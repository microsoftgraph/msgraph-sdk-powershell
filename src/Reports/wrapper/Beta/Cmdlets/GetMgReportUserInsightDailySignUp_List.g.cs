...
{
    [GraphRoute("GET", "/reports/userInsights/daily/signUps")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailySignUp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserSignUpMetric))]
    public class GetMgReportUserInsightDailySignUp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserSignUpMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.SignUps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.SignUps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
