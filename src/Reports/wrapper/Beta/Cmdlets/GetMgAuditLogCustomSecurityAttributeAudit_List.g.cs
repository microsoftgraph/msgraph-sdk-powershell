...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAuditLogCustomSecurityAttributeAudit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.CustomSecurityAttributeAudit))]
    public class GetMgAuditLogCustomSecurityAttributeAudit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.CustomSecurityAttributeAuditCollectionResponse? result;
            try
            {
                result = client.AuditLogs.CustomSecurityAttributeAudits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.CustomSecurityAttributeAudits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
