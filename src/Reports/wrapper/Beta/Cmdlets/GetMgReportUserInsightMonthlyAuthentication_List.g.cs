...
{
    [GraphRoute("GET", "/reports/userInsights/monthly/authentications")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyAuthentication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationsMetric))]
    public class GetMgReportUserInsightMonthlyAuthentication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.UserInsights.Monthly.Authentications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.Authentications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
