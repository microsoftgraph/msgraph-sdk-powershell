...
{
    [GraphRoute("POST", "/reports/monthlyPrintUsageByPrinter")]
    [Cmdlet(VerbsCommon.New, "MgReportMonthlyPrintUsageByPrinter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class NewMgReportMonthlyPrintUsageByPrinterCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PrinterName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.MonthlyPrintUsageByPrinter.PostAsync(body, requestConfiguration =>
                {
