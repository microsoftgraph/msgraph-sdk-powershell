...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementReportCachedReportConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.DeviceManagementCachedReportConfiguration))]
    public class GetMgDeviceManagementReportCachedReportConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.DeviceManagementCachedReportConfigurationCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.Reports.CachedReportConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.Reports.CachedReportConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
