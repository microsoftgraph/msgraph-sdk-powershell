...
{
    [GraphRoute("POST", "/reports/monthlyPrintUsageSummariesByPrinter")]
    [Cmdlet(VerbsCommon.New, "MgReportMonthlyPrintUsageSummaryByPrinter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class NewMgReportMonthlyPrintUsageSummaryByPrinterCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PrinterName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.MonthlyPrintUsageSummariesByPrinter.PostAsync(body, requestConfiguration =>
                {
