...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportApplicationSignInDetailedSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.ApplicationSignInDetailedSummary))]
    public class GetMgReportApplicationSignInDetailedSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.ApplicationSignInDetailedSummaryCollectionResponse? result;
            try
            {
                result = client.Reports.ApplicationSignInDetailedSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.ApplicationSignInDetailedSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
