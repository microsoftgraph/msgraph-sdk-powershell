...
{
    [GraphRoute("GET", "/reports/userInsights/daily/inactiveUsersByApplication")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyInactiveUserByApplication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.DailyInactiveUsersByApplicationMetric))]
    public class GetMgReportUserInsightDailyInactiveUserByApplication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.DailyInactiveUsersByApplicationMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.InactiveUsersByApplication.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.InactiveUsersByApplication.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
