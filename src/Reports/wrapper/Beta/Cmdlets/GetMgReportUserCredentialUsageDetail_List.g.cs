...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserCredentialUsageDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserCredentialUsageDetails))]
    public class GetMgReportUserCredentialUsageDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserCredentialUsageDetailsCollectionResponse? result;
            try
            {
                result = client.Reports.UserCredentialUsageDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserCredentialUsageDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
