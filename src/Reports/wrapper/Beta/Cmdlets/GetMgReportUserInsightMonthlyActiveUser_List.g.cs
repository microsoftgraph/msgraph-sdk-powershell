...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyActiveUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.ActiveUsersMetric))]
    public class GetMgReportUserInsightMonthlyActiveUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.UserInsights.Monthly.ActiveUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.ActiveUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
