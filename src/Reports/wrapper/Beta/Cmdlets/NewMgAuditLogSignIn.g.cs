...
{
    [GraphRoute("POST", "/auditLogs/signIns")]
    [Cmdlet(VerbsCommon.New, "MgAuditLogSignIn", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SignIn))]
    public class NewMgAuditLogSignInCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.AuditLogs.SignIns.PostAsync(body, requestConfiguration =>
                {
