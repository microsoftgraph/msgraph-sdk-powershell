...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyMfaTelecomFraud_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MfaTelecomFraudMetric))]
    public class GetMgReportUserInsightDailyMfaTelecomFraud_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.MfaTelecomFraudMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.MfaTelecomFraud.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.MfaTelecomFraud.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
