...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAuthenticationMethodUsersRegisteredByFeature")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserRegistrationFeatureSummary))]
    public class GetMgReportAuthenticationMethodUsersRegisteredByFeatureCommand : GraphClientCmdlet
    {
