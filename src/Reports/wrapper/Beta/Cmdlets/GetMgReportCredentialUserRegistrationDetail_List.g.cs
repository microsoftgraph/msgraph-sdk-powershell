...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportCredentialUserRegistrationDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.CredentialUserRegistrationDetails))]
    public class GetMgReportCredentialUserRegistrationDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.CredentialUserRegistrationDetailsCollectionResponse? result;
            try
            {
                result = client.Reports.CredentialUserRegistrationDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.CredentialUserRegistrationDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
