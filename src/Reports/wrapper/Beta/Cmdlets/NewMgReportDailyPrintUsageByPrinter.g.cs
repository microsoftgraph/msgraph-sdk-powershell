...
{
    [GraphRoute("POST", "/reports/dailyPrintUsageByPrinter")]
    [Cmdlet(VerbsCommon.New, "MgReportDailyPrintUsageByPrinter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class NewMgReportDailyPrintUsageByPrinterCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(PrinterName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.DailyPrintUsageByPrinter.PostAsync(body, requestConfiguration =>
                {
