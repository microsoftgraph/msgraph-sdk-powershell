...
{
    [GraphRoute("POST", "/reports/authenticationMethods/userRegistrationDetails")]
    [Cmdlet(VerbsCommon.New, "MgReportAuthenticationMethodUserRegistrationDetail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserRegistrationDetails))]
    public class NewMgReportAuthenticationMethodUserRegistrationDetailCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.Reports.Client.Models.DefaultMfaMethodType? DefaultMfaMethod { get; set; }
    ...
    if (this.IsParameterBound(nameof(DefaultMfaMethod)))
        body.DefaultMfaMethod = DefaultMfaMethod;
    ...
    if (this.IsParameterBound(nameof(UserType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.AuthenticationMethods.UserRegistrationDetails.PostAsync(body, requestConfiguration =>
                {
