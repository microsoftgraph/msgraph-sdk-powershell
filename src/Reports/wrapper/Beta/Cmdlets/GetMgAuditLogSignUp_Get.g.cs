...
{
    [GraphRoute("GET", "/auditLogs/signUps/{selfServiceSignUp-id}")]
    [Cmdlet(VerbsCommon.Get, "MgAuditLogSignUp_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SelfServiceSignUp))]
    public class GetMgAuditLogSignUp_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.AuditLogs.SignUps[SelfServiceSignUpId].GetAsync(requestConfiguration =>
                {
