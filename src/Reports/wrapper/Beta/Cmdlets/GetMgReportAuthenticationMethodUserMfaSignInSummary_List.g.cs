...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAuthenticationMethodUserMfaSignInSummary_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserMfaSignInSummary))]
    public class GetMgReportAuthenticationMethodUserMfaSignInSummary_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserMfaSignInSummaryCollectionResponse? result;
            try
            {
                result = client.Reports.AuthenticationMethods.UserMfaSignInSummary.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.AuthenticationMethods.UserMfaSignInSummary.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
