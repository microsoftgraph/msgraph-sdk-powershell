...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgAuditLogSignInConfirmCompromised", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgAuditLogSignInConfirmCompromisedCommand : GraphClientCmdlet
    {
