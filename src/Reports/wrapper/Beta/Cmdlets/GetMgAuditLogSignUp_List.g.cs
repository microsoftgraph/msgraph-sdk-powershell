...
{
    [GraphRoute("GET", "/auditLogs/signUps")]
    [Cmdlet(VerbsCommon.Get, "MgAuditLogSignUp_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SelfServiceSignUp))]
    public class GetMgAuditLogSignUp_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.SelfServiceSignUpCollectionResponse? result;
            try
            {
                result = client.AuditLogs.SignUps.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.SignUps.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
