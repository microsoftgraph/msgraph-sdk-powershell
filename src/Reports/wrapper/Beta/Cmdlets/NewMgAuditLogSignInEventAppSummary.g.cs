...
{
    [GraphRoute("POST", "/auditLogs/signInEventsAppSummary")]
    [Cmdlet(VerbsCommon.New, "MgAuditLogSignInEventAppSummary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SignInEventsAppActivity))]
    public class NewMgAuditLogSignInEventAppSummaryCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Application)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.AuditLogs.SignInEventsAppSummary.PostAsync(body, requestConfiguration =>
                {
