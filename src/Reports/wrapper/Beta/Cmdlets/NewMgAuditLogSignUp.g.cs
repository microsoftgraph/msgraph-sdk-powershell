...
{
    [GraphRoute("POST", "/auditLogs/signUps")]
    [Cmdlet(VerbsCommon.New, "MgAuditLogSignUp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SelfServiceSignUp))]
    public class NewMgAuditLogSignUpCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.AuditLogs.SignUps.PostAsync(body, requestConfiguration =>
                {
