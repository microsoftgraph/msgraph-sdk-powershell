...
{
    [GraphRoute("POST", "/deviceManagement/reports/getReportFilters")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementReportGetReportFilters", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class InvokeMgDeviceManagementReportGetReportFiltersCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.DeviceManagement.Reports.GetReportFilters.GetReportFiltersPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Filter)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Reports.GetReportFilters.PostAsync(body, requestConfiguration =>
                {
