...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyInactiveUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.DailyInactiveUsersMetric))]
    public class GetMgReportUserInsightDailyInactiveUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.DailyInactiveUsersMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.InactiveUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.InactiveUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
