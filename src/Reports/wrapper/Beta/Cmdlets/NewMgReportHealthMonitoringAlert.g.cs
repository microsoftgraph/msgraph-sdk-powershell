...
{
    [GraphRoute("POST", "/reports/healthMonitoring/alerts")]
    [Cmdlet(VerbsCommon.New, "MgReportHealthMonitoringAlert", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.HealthMonitoring.Alert))]
    public class NewMgReportHealthMonitoringAlertCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(State)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.HealthMonitoring.Alerts.PostAsync(body, requestConfiguration =>
                {
