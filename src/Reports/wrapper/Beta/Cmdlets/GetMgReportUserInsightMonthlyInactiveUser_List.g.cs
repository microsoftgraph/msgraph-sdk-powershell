...
{
    [GraphRoute("GET", "/reports/userInsights/monthly/inactiveUsers")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightMonthlyInactiveUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.MonthlyInactiveUsersMetric))]
    public class GetMgReportUserInsightMonthlyInactiveUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.MonthlyInactiveUsersMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Monthly.InactiveUsers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Monthly.InactiveUsers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
