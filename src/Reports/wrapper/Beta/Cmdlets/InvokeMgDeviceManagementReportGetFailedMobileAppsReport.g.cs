...
{
    [GraphRoute("POST", "/deviceManagement/reports/getFailedMobileAppsReport")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementReportGetFailedMobileAppsReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class InvokeMgDeviceManagementReportGetFailedMobileAppsReportCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.DeviceManagement.Reports.GetFailedMobileAppsReport.GetFailedMobileAppsReportPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Filter)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Reports.GetFailedMobileAppsReport.PostAsync(body, requestConfiguration =>
                {
