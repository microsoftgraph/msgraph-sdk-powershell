...
{
    [GraphRoute("POST", "/deviceManagement/reports/getCertificatesReport")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementReportGetCertificatesReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class InvokeMgDeviceManagementReportGetCertificatesReportCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.DeviceManagement.Reports.GetCertificatesReport.GetCertificatesReportPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Filter)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Reports.GetCertificatesReport.PostAsync(body, requestConfiguration =>
                {
