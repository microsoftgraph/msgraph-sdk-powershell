...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAppCredentialSignInActivity_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.AppCredentialSignInActivity))]
    public class GetMgReportAppCredentialSignInActivity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.AppCredentialSignInActivityCollectionResponse? result;
            try
            {
                result = client.Reports.AppCredentialSignInActivities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.AppCredentialSignInActivities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
