...
{
    [GraphRoute("GET", "/reports/userInsights/daily/authentications")]
    [Cmdlet(VerbsCommon.Get, "MgReportUserInsightDailyAuthentication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationsMetric))]
    public class GetMgReportUserInsightDailyAuthentication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationsMetricCollectionResponse? result;
            try
            {
                result = client.Reports.UserInsights.Daily.Authentications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.UserInsights.Daily.Authentications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
