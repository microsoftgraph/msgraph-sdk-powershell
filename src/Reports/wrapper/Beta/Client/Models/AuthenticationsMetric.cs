...
namespace Microsoft.Graph.PowerShell.Reports.Client.Models
{
    ...
    public partial class AuthenticationsMetric : global::Microsoft.Graph.PowerShell.Reports.Client.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationFailure>? Failures { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationFailure> Failures { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationsMetric CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationsMetric();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "failures", n => { Failures = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationFailure>(global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationFailure.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Reports.Client.Models.AuthenticationFailure>("failures", Failures);
