...
{
    [GraphRoute("GET", "/reports/monthlyPrintUsageByPrinter")]
    [Cmdlet(VerbsCommon.Get, "MgReportMonthlyPrintUsageByPrinter_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class GetMgReportMonthlyPrintUsageByPrinter_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.MonthlyPrintUsageByPrinter.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.MonthlyPrintUsageByPrinter.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
