...
{
    [GraphRoute("GET", "/reports/dailyPrintUsageByPrinter")]
    [Cmdlet(VerbsCommon.Get, "MgReportDailyPrintUsageByPrinter_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinter))]
    public class GetMgReportDailyPrintUsageByPrinter_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.PrintUsageByPrinterCollectionResponse? result;
            try
            {
                result = client.Reports.DailyPrintUsageByPrinter.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.DailyPrintUsageByPrinter.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
