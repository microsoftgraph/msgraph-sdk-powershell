...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAuditLogDirectoryAudit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.DirectoryAudit))]
    public class GetMgAuditLogDirectoryAudit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.DirectoryAuditCollectionResponse? result;
            try
            {
                result = client.AuditLogs.DirectoryAudits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.DirectoryAudits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
