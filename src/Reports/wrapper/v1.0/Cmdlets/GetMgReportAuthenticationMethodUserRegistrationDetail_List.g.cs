...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgReportAuthenticationMethodUserRegistrationDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.UserRegistrationDetails))]
    public class GetMgReportAuthenticationMethodUserRegistrationDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.UserRegistrationDetailsCollectionResponse? result;
            try
            {
                result = client.Reports.AuthenticationMethods.UserRegistrationDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Reports.AuthenticationMethods.UserRegistrationDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
