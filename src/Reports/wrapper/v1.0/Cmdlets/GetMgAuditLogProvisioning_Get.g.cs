...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    public class GetMgAuditLogProvisioning_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ProvisioningObjectSummaryId));
                return;
            }
