...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementReportHistoricalReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class GetMgDeviceManagementReportHistoricalReportCommand : GraphClientCmdlet
    {
