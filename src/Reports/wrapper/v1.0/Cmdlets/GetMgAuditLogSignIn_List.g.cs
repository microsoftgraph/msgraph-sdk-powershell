...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAuditLogSignIn_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.SignIn))]
    public class GetMgAuditLogSignIn_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.SignInCollectionResponse? result;
            try
            {
                result = client.AuditLogs.SignIns.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.SignIns.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
