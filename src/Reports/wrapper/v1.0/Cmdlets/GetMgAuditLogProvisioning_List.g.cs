...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgAuditLogProvisioning_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.ProvisioningObjectSummary))]
    public class GetMgAuditLogProvisioning_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Reports.Client.Models.ProvisioningObjectSummaryCollectionResponse? result;
            try
            {
                result = client.AuditLogs.Provisioning.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.AuditLogs.Provisioning.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
