...
{
    [GraphRoute("POST", "/deviceManagement/reports/getCachedReport")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementReportCachedReport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(byte[]))]
    public class GetMgDeviceManagementReportCachedReportCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.DeviceManagement.Reports.GetCachedReport.GetCachedReportPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Top)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.Reports.GetCachedReport.PostAsync(body, requestConfiguration =>
                {
