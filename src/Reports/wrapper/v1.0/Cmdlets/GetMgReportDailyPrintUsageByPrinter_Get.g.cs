...
namespace Microsoft.Graph.PowerShell.Reports
{
    ...
    public class GetMgReportDailyPrintUsageByPrinter_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, PrintUsageByPrinterId));
                return;
            }
