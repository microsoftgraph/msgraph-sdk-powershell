...
{
    [GraphRoute("POST", "/reports/partners/billing/usage/unbilled/microsoft.graph.partners.billing.export")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgReportPartnerBillingUsageUnbilledExport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Reports.Client.Models.Partners.Billing.Operation))]
    public class InvokeMgReportPartnerBillingUsageUnbilledExportCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Reports.Client.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(AttributeSet)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.PostAsync(body, requestConfiguration =>
                {
