...
### Get (Default)
```
Get-MgReportYammerActivityCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
