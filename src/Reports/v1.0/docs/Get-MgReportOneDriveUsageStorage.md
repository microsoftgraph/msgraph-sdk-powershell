...
### Get (Default)
```
Get-MgReportOneDriveUsageStorage -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveUsageStorage -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
