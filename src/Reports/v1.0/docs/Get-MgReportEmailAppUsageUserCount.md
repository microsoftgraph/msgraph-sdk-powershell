...
### Get (Default)
```
Get-MgReportEmailAppUsageUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailAppUsageUserCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
