...
### Get (Default)
```
Get-MgReportOneDriveUsageFileCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveUsageFileCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
