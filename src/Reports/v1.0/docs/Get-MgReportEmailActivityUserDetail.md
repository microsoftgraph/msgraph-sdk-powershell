...
### Get (Default)
```
Get-MgReportEmailActivityUserDetail -Date <DateTime> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgReportEmailActivityUserDetail -Period <String> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>
