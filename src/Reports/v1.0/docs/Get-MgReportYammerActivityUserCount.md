...
### Get (Default)
```
Get-MgReportYammerActivityUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerActivityUserCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
