...
### Get (Default)
```
Get-MgReportSkypeForBusinessDeviceUsageUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgReportSkypeForBusinessDeviceUsageUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```
