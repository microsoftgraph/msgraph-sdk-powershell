...
### Get (Default)
```
Get-MgBetaReportM365AppUserCount -Period <String> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportM365AppUserCount -InputObject <IReportsIdentity> -OutFile <String>
