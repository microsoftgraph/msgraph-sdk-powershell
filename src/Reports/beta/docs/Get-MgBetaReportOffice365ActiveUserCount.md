...
### Get (Default)
```
Get-MgBetaReportOffice365ActiveUserCount -Period <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportOffice365ActiveUserCount -InputObject <IReportsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
