...
### Get (Default)
```
Get-MgBetaReportEmailAppUsageUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportEmailAppUsageUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```
