...
### Get (Default)
```
Get-MgBetaReportOffice365GroupActivityFileCount -Period <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportOffice365GroupActivityFileCount -InputObject <IReportsIdentity> [-Count]
