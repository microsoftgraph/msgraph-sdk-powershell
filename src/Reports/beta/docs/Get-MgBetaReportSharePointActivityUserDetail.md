...
### Get (Default)
```
Get-MgBetaReportSharePointActivityUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportSharePointActivityUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```
