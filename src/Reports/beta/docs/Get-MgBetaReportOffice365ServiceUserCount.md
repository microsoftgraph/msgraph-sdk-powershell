...
### Get (Default)
```
Get-MgBetaReportOffice365ServiceUserCount -Period <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportOffice365ServiceUserCount -InputObject <IReportsIdentity> [-Count]
