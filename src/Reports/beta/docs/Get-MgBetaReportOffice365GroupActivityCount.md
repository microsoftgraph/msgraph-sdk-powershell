...
### Get (Default)
```
Get-MgBetaReportOffice365GroupActivityCount -Period <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportOffice365GroupActivityCount -InputObject <IReportsIdentity> [-Count]
