...
### Get (Default)
```
Get-MgBetaReportAzureAdApplicationSignInSummary -Period <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportAzureAdApplicationSignInSummary -InputObject <IReportsIdentity> [-Count]
