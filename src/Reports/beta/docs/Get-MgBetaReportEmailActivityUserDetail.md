...
### Get (Default)
```
Get-MgBetaReportEmailActivityUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportEmailActivityUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```
