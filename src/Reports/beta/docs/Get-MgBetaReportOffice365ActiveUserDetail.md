...
### Get (Default)
```
Get-MgBetaReportOffice365ActiveUserDetail -Date <DateTime> [-Count] [-ExpandProperty <String[]>]
...
### Get1
```
Get-MgBetaReportOffice365ActiveUserDetail -Period <String> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
 [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgBetaReportOffice365ActiveUserDetail -InputObject <IReportsIdentity> [-Count]
