...
### Get (Default)
```
Get-MgBetaReportOneDriveUsageAccountDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportOneDriveUsageAccountDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [<CommonParameters>]
```
