...
### Get (Default)
```
Get-MgBetaReportEmailActivityCount -Period <String> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailActivityCount -InputObject <IReportsIdentity> -OutFile <String>
