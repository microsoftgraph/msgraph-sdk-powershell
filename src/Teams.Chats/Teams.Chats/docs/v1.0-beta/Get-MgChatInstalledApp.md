...
### List (Default)
```
Get-MgChatInstalledApp -ChatId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgChatInstalledApp -InputObject <ITeamsChatsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
