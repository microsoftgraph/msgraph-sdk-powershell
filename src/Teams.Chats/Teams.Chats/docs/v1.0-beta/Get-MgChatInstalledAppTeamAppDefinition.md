...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchatinstalledappteamappdefinition
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgChatInstalledAppTeamAppDefinition -InputObject <ITeamsChatsIdentity> [-ExpandProperty <String[]>]
