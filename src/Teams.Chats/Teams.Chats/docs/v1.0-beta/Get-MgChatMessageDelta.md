...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchatmessagedelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgChatMessageDelta -InputObject <ITeamsChatsIdentity> [<CommonParameters>]
```
