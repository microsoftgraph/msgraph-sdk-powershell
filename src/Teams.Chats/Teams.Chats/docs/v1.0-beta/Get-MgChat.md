...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchat
schema: 2.0.0
---
...
### List (Default)
```
Get-MgChat [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgChat -InputObject <ITeamsChatsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
