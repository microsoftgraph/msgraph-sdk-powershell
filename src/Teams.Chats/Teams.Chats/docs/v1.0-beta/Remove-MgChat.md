...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/remove-mgchat
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgChat -InputObject <ITeamsChatsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
