...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/new-mgchatmember
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgChatMember -InputObject <ITeamsChatsIdentity> -BodyParameter <IMicrosoftGraphConversationMember>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgChatMember -InputObject <ITeamsChatsIdentity> [-DisplayName <String>] [-Id <String>] [-Roles <String[]>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
