...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/update-mgchatmember
schema: 2.0.0
---
...
```
Update-MgChatMember -ChatId <String> -ConversationMemberId <String> [-DisplayName <String>] [-Id <String>]
...
### UpdateViaIdentity
```
Update-MgChatMember -InputObject <ITeamsChatsIdentity> -BodyParameter <IMicrosoftGraphConversationMember>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgChatMember -InputObject <ITeamsChatsIdentity> [-DisplayName <String>] [-Id <String>]
 [-Roles <String[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
