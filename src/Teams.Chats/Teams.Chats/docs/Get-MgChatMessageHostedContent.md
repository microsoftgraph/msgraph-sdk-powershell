...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.chats/get-mgchatmessagehostedcontent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgChatMessageHostedContent -ChatId <String> -ChatMessageId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgChatMessageHostedContent -InputObject <ITeamsChatsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
