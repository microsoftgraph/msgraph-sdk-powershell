...
### Get (Default)
```
Get-MgChatInstalledAppTeamAppDefinition -ChatId <String> -TeamsAppInstallationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgChatInstalledAppTeamAppDefinition -InputObject <ITeamsChatsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
