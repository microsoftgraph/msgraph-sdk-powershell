...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.directoryobject/get-mguserregistereddevice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserRegisteredDevice -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserRegisteredDevice -InputObject <IUsersDirectoryObjectIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
