...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.directoryobject/get-mguserowneddevice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOwnedDevice -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserOwnedDevice -InputObject <IUsersDirectoryObjectIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
