...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.directoryobject/get-mguserdirectreport
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserDirectReport -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserDirectReport -InputObject <IUsersDirectoryObjectIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
