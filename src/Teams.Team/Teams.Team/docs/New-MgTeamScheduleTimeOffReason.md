...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduletimeoffreason
schema: 2.0.0
---
...
```
New-MgTeamScheduleTimeOffReason -TeamId <String> [-CreatedDateTime <DateTime>] [-DisplayName <String>]
...
### CreateViaIdentity
```
New-MgTeamScheduleTimeOffReason -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphTimeOffReason> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgTeamScheduleTimeOffReason -InputObject <ITeamsTeamIdentity> [-CreatedDateTime <DateTime>]
