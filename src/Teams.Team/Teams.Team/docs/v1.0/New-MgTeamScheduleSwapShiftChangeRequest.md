...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduleswapshiftchangerequest
schema: 2.0.0
---
...
```
New-MgTeamScheduleSwapShiftChangeRequest -TeamId <String> [-AssignedTo <String>] [-CreatedDateTime <DateTime>]
...
### CreateViaIdentity1
```
New-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphSwapShiftsChangeRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-AssignedTo <String>]
 ...
 [-SenderMessage <String>] [-SenderShiftId <String>] [-SenderUserId <String>] [-State <String>] [-Confirm]
