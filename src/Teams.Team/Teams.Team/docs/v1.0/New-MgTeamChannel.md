...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamchannel
schema: 2.0.0
---
...
```
New-MgTeamChannel -TeamId <String> [-Description <String>] [-DisplayName <String>] [-Email <String>]
 [-Id <String>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgTeamChannel -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgTeamChannel -InputObject <ITeamsTeamIdentity> [-Description <String>] [-DisplayName <String>]
 [-Email <String>] [-Id <String>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
