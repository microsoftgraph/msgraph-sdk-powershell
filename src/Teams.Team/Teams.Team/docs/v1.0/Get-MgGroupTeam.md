...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mggroupteam
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupTeam -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
