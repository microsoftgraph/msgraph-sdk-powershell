...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamworkworkforceintegration
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgTeamworkWorkforceIntegration [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgTeamworkWorkforceIntegration -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
