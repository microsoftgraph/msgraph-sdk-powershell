...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/update-mggroupteam
schema: 2.0.0
---
...
```
Update-MgGroupTeam -GroupId <String> [-Channels <IMicrosoftGraphChannel[]>]
...
### Update1
```
Update-MgGroupTeam -GroupId <String> -BodyParameter <IMicrosoftGraphTeam> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgGroupTeam -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphTeam> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupTeam -InputObject <ITeamsTeamIdentity> [-Channels <IMicrosoftGraphChannel[]>]
 [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-GuestSettings <IMicrosoftGraphTeamGuestSettings>]
 [-Id <String>] [-InstalledApps <IMicrosoftGraphTeamsAppInstallation[]>] [-IsArchived]
 [-MemberSettings <IMicrosoftGraphTeamMemberSettings>]
 [-MessagingSettings <IMicrosoftGraphTeamMessagingSettings>]
