...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduleschedulinggroup
schema: 2.0.0
---
...
```
New-MgTeamScheduleSchedulingGroup -TeamId <String> [-CreatedDateTime <DateTime>] [-DisplayName <String>]
...
### CreateViaIdentity1
```
New-MgTeamScheduleSchedulingGroup -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphSchedulingGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgTeamScheduleSchedulingGroup -InputObject <ITeamsTeamIdentity> [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-IsActive] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-UserIds <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
