...
```
New-MgTeamInstalledApp -TeamId <String> [-Id <String>] [-TeamAppDefinitionDisplayName <String>]
...
### CreateViaIdentity
```
New-MgTeamInstalledApp -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphTeamsAppInstallation>
