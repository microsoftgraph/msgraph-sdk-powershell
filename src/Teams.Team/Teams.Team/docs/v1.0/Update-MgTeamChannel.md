...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/update-mgteamchannel
schema: 2.0.0
---
...
```
Update-MgTeamChannel -ChannelId <String> -TeamId <String> [-Description <String>] [-DisplayName <String>]
...
### UpdateViaIdentity1
```
Update-MgTeamChannel -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphChannel> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgTeamChannel -InputObject <ITeamsTeamIdentity> [-Description <String>] [-DisplayName <String>]
 [-Email <String>] [-Id <String>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
