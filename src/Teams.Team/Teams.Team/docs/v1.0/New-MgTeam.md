...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteam
schema: 2.0.0
---
...
```
New-MgTeam [-Channels <IMicrosoftGraphChannel[]>] [-FunSettings <IMicrosoftGraphTeamFunSettings>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation[]>] [-IsArchived]
...
### Create
```
New-MgTeam -BodyParameter <IMicrosoftGraphTeam> [-Confirm] [-WhatIf] [<CommonParameters>]
```
