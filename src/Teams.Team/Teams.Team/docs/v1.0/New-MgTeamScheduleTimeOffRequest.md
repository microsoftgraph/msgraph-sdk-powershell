...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduletimeoffrequest
schema: 2.0.0
---
...
```
New-MgTeamScheduleTimeOffRequest -TeamId <String> [-AssignedTo <String>] [-CreatedDateTime <DateTime>]
...
### CreateViaIdentity1
```
New-MgTeamScheduleTimeOffRequest -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphTimeOffRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgTeamScheduleTimeOffRequest -InputObject <ITeamsTeamIdentity> [-AssignedTo <String>]
