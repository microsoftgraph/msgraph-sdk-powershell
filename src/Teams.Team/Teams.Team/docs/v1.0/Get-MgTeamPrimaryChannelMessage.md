...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannelmessage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamPrimaryChannelMessage -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgTeamPrimaryChannelMessage -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
