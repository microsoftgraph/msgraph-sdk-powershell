...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamchanneltabteamapp
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgTeamChannelTabTeamApp -ChannelId <String> -TeamId <String> -TeamsTabId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamChannelTabTeamApp -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
