...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteaminstalledappteamapp
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgTeamInstalledAppTeamApp -TeamId <String> -TeamsAppInstallationId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamInstalledAppTeamApp -InputObject <ITeamsTeamIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
