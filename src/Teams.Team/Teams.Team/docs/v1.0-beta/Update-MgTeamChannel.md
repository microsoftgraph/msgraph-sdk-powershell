...
Update-MgTeamChannel -ChannelId <String> -TeamId <String> [-Description <String>] [-DisplayName <String>]
 [-Email <String>] [-FilesFolder <IMicrosoftGraphDriveItem>] [-Id <String>] [-IsFavoriteByDefault]
 [-Members <IMicrosoftGraphConversationMember[]>] [-MembershipType <String>]
 [-Messages <IMicrosoftGraphChatMessage[]>] [-Tabs <IMicrosoftGraphTeamsTab1[]>] [-WebUrl <String>]
...
### UpdateViaIdentity
```
Update-MgTeamChannel -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphChannel1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
