...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamworkworkforceintegration
schema: 2.0.0
---
...
```
New-MgTeamworkWorkforceIntegration [-ApiVersion <Int32>] [-CreatedDateTime <DateTime>] [-DisplayName <String>]
 [-EligibilityFilteringEnabledEntities <String>] [-EncryptionProtocol <String>] [-EncryptionSecret <String>]
