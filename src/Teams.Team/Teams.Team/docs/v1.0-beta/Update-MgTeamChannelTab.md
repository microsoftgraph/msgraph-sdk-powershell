...
Update-MgTeamChannelTab -ChannelId <String> -TeamId <String> -TeamsTabId <String>
 ...
 [-Name <String>] [-SortOrderIndex <String>] [-TeamAppDefinitions <IMicrosoftGraphTeamsAppDefinition[]>]
 [-TeamAppDisplayName <String>] [-TeamAppDistributionMethod <String>] [-TeamAppExternalId <String>]
 [-TeamAppId <String>] [-TeamAppName <String>] [-TeamsAppId <String>] [-WebUrl <String>] [-PassThru]
...
### UpdateViaIdentity1
```
Update-MgTeamChannelTab -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphTeamsTab1>
