...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamscheduleopenshift
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgTeamScheduleOpenShift -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
