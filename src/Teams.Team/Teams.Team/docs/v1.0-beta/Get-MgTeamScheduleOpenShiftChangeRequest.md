...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamscheduleopenshiftchangerequest
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgTeamScheduleOpenShiftChangeRequest -TeamId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgTeamScheduleOpenShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
