...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannelfilefolder
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgTeamPrimaryChannelFileFolder -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
