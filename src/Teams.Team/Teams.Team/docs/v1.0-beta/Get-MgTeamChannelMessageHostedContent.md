...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamchannelmessagehostedcontent
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgTeamChannelMessageHostedContent -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
