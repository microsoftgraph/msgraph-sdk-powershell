...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/remove-mgteam
schema: 2.0.0
---
...
### DeleteViaIdentity1
```
Remove-MgTeam -InputObject <ITeamsTeamIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
