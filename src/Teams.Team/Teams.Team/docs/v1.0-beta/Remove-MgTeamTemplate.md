...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/remove-mgteamtemplate
schema: 2.0.0
---

# Remove-MgTeamTemplate
...
### Delete (Default)
```
Remove-MgTeamTemplate -TeamsTemplateId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamTemplate -InputObject <ITeamsTeamIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
