...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/new-mgteamscheduleoffershiftrequest
schema: 2.0.0
---
...
```
New-MgTeamScheduleOfferShiftRequest -TeamId <String> [-AssignedTo <String>] [-CreatedDateTime <DateTime>]
...
### CreateViaIdentity1
```
New-MgTeamScheduleOfferShiftRequest -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphOfferShiftRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgTeamScheduleOfferShiftRequest -InputObject <ITeamsTeamIdentity> [-AssignedTo <String>]
