...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannelmessagereplydelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgTeamPrimaryChannelMessageReplyDelta -InputObject <ITeamsTeamIdentity> [<CommonParameters>]
```
