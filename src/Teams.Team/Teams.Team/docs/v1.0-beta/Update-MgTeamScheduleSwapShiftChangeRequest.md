...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/update-mgteamscheduleswapshiftchangerequest
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity>
 -BodyParameter <IMicrosoftGraphSwapShiftsChangeRequest> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-AssignedTo <String>]
