...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamprimarychannel
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgTeamPrimaryChannel -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
