...
New-MgTeamPrimaryChannelMessage -TeamId <String> [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
 ...
 [-Replies <IMicrosoftGraphChatMessage1[]>] [-ReplyToId <String>] [-Subject <String>] [-Summary <String>]
...
### CreateViaIdentity1
```
New-MgTeamPrimaryChannelMessage -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphChatMessage1>
