...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamscheduleswapshiftchangerequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgTeamScheduleSwapShiftChangeRequest -TeamId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgTeamScheduleSwapShiftChangeRequest -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
...
key: swapShiftsChangeRequest-id of swapShiftsChangeRequest
