...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/update-mgteamphoto
schema: 2.0.0
---
...
```
Update-MgTeamPhoto -TeamId <String> [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-PassThru] [-Confirm]
...
### UpdateViaIdentity
```
Update-MgTeamPhoto -InputObject <ITeamsTeamIdentity> -BodyParameter <IMicrosoftGraphProfilePhoto> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgTeamPhoto -InputObject <ITeamsTeamIdentity> [-Height <Int32>] [-Id <String>] [-Width <Int32>]
