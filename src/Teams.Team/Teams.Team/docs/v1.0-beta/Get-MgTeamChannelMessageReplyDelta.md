...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams.team/get-mgteamchannelmessagereplydelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgTeamChannelMessageReplyDelta -InputObject <ITeamsTeamIdentity> [<CommonParameters>]
```
