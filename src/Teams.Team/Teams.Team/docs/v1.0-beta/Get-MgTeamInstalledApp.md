...
### List1 (Default)
```
Get-MgTeamInstalledApp -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgTeamInstalledApp -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
