...
### List (Default)
```
Get-MgTeamPrimaryChannelMember -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgTeamPrimaryChannelMember -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
