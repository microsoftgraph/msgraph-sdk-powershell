...
### List1 (Default)
```
Get-MgTeamScheduleOfferShiftRequest -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgTeamScheduleOfferShiftRequest -InputObject <ITeamsTeamIdentity> [-ExpandProperty <String[]>]
