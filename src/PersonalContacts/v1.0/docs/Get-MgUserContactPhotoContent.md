...
### Get (Default)
```
Get-MgUserContactPhotoContent -ContactId <String> -UserId <String> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserContactPhotoContent -InputObject <IPersonalContactsIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
