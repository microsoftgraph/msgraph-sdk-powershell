...
{
    [GraphRoute("GET", "/users/{user-id}/contacts/{contact-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserContactExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.PersonalContacts.Client.Models.Extension))]
    public class GetMgUserContactExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Contacts[ContactId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
