...
{
    [GraphRoute("GET", "/users/{user-id}/contacts/{contact-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.PersonalContacts.Client.Models.Contact))]
    public class GetMgUserContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Contacts[ContactId].GetAsync(requestConfiguration =>
                {
