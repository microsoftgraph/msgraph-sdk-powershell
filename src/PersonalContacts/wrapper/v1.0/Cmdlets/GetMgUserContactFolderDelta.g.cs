...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserContactFolderDelta")]
    ...
    public class GetMgUserContactFolderDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ContactFolders.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
