...
{
    [GraphRoute("GET", "/users/{user-id}/contactFolders/{contactFolder-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserContactFolder_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.PersonalContacts.Client.Models.ContactFolder))]
    public class GetMgUserContactFolder_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ContactFolders[ContactFolderId].GetAsync(requestConfiguration =>
                {
