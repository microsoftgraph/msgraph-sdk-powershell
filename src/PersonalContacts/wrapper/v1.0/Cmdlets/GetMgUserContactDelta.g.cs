...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    public class GetMgUserContactDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Contacts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
