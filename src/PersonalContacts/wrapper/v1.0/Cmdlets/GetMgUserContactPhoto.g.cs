...
{
    [GraphRoute("GET", "/users/{user-id}/contacts/{contact-id}/photo")]
    [Cmdlet(VerbsCommon.Get, "MgUserContactPhoto")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.PersonalContacts.Client.Models.ProfilePhoto))]
    public class GetMgUserContactPhotoCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Contacts[ContactId].Photo.GetAsync(requestConfiguration =>
                {
