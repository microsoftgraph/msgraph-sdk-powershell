...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserContactFolderChildFolderPermanentDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserContactFolderChildFolderPermanentDeleteCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(ContactFolderId1, "Invoke"))
                return;
