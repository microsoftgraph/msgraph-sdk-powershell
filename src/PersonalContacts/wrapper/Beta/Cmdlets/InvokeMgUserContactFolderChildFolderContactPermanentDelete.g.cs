...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserContactFolderChildFolderContactPermanentDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserContactFolderChildFolderContactPermanentDeleteCommand : GraphClientCmdlet
    {
