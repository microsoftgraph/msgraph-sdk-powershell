...
{
    [GraphRoute("GET", "/users/{user-id}/contacts/{contact-id}/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgUserContactPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserContactPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Contacts[ContactId].Photo.Content.GetAsync(requestConfiguration =>
                {
