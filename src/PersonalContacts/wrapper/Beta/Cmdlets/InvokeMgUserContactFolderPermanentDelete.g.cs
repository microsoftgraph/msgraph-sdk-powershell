...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserContactFolderPermanentDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserContactFolderPermanentDeleteCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(ContactFolderId, "Invoke"))
                return;
