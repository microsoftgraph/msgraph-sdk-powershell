...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserContactFolderContactPermanentDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserContactFolderContactPermanentDeleteCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(ContactId, "Invoke"))
                return;
