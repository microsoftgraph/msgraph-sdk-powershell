...
namespace Microsoft.Graph.PowerShell.PersonalContacts
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgUserContactPermanentDelete", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgUserContactPermanentDeleteCommand : GraphClientCmdlet
    {
