...
{
    [GraphRoute("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/contacts/{contact-id}/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgUserContactFolderContactPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserContactFolderContactPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ContactFolders[ContactFolderId].Contacts[ContactId].Photo.Content.GetAsync(requestConfiguration =>
                {
