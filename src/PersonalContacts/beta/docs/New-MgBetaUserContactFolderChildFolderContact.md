...
```
New-MgBetaUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphContact> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaUserContactFolderChildFolderContact -InputObject <IPersonalContactsIdentity>
 -BodyParameter <IMicrosoftGraphContact> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
