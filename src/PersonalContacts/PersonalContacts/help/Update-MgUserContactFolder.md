...
BODYPARAMETER \<IMicrosoftGraphContactFolder1\>: contactFolder
  ...
  \[Id \<String\>\]: Read-only.
  \[ChildFolders \<IMicrosoftGraphContactFolder1\[\]\>\]: The collection of child folders in the folder.
Navigation property.
Read-only.
Nullable.
  \[Contacts \<IMicrosoftGraphContact1\[\]\>\]: The contacts in the folder.
Navigation property.
Read-only.
Nullable.
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.personalcontacts/update-mgusercontactfolder](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.personalcontacts/update-mgusercontactfolder)
