...
# Get-MgBetaUserContactFolderChildFolderMultiValueExtendedProperty
...
### List1 (Default)
```
Get-MgBetaUserContactFolderChildFolderMultiValueExtendedProperty -ContactFolderId <String>
...
### GetViaIdentity1
```
Get-MgBetaUserContactFolderChildFolderMultiValueExtendedProperty -InputObject <IPersonalContactsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
