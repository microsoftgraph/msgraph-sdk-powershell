...
# New-MgBetaUserContactFolderContactMultiValueExtendedProperty
...
```
New-MgBetaUserContactFolderContactMultiValueExtendedProperty -ContactFolderId <String> -ContactId <String>
...
### CreateViaIdentity1
```
New-MgBetaUserContactFolderContactMultiValueExtendedProperty -InputObject <IPersonalContactsIdentity>
