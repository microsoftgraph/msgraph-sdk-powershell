...
### Update1
```
Update-MgBetaUserContact -ContactId <String> -UserId <String> -BodyParameter <IMicrosoftGraphContact1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgBetaUserContact -InputObject <IPersonalContactsIdentity> -BodyParameter <IMicrosoftGraphContact1>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphContact1
