...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
```
Get-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <IGroupsOneNoteIdentity> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```
