...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionParentNotebook -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
