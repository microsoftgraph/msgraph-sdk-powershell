...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupParentNotebookSectionParentSectionGroup -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupParentNotebookSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
