...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionGroupParentNotebook -GroupId <String> -NotebookId <String>
 -SectionGroupId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
