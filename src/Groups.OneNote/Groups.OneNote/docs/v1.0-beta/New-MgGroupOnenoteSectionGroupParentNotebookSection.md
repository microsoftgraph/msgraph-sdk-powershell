...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionGroupParentNotebookSection -GroupId <String> -SectionGroupId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
