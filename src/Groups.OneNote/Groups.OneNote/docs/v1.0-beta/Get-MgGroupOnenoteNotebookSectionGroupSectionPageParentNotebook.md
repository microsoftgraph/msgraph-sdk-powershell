...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionGroupSectionPageParentNotebook -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionGroupSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity>
