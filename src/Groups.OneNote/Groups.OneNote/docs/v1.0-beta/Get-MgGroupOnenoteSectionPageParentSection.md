...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionpageparentsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionPageParentSection -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>]
