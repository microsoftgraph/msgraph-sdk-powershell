...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteSectionParentSectionGroup -GroupId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>]
...
### List
```
Get-MgGroupOnenoteSectionParentSectionGroup -GroupId <String> -OnenoteSectionId <String> [-Count]
