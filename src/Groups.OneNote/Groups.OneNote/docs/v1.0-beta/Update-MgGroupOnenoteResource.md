...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenoteresource
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteResource -GroupId <String> -OnenoteResourceId <String> [-ContentInputFile <String>]
 [-ContentUrl <String>] [-Id <String>] [-Self <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgGroupOnenoteResource -GroupId <String> -OnenoteResourceId <String>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteResource -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupOnenoteResource -InputObject <IGroupsOneNoteIdentity> [-ContentInputFile <String>]
 [-ContentUrl <String>] [-Id <String>] [-Self <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
