...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupOnenotePageParentSection -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
