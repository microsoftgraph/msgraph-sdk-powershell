...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotepage
schema: 2.0.0
---
...
```
New-MgGroupOnenotePage -GroupId <String> [-ContentInputFile <String>] [-ContentUrl <String>]
...
### CreateViaIdentity1
```
New-MgGroupOnenotePage -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphOnenotePage1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgGroupOnenotePage -InputObject <IGroupsOneNoteIdentity> [-ContentInputFile <String>]
