...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
...
```
New-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
