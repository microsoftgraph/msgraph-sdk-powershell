...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupsectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteSectionGroupSectionPageParentSection -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupSectionPageParentSection -InputObject <IGroupsOneNoteIdentity>
