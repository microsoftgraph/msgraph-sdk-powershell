...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupParentNotebook -GroupId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
