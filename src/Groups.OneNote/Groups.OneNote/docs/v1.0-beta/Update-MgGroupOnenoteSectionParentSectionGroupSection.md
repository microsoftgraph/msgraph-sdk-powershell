...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
...
```
Update-MgGroupOnenoteSectionParentSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
