...
### List (Default)
```
Get-MgGroupOnenoteSectionGroupSection -GroupId <String> -SectionGroupId <String> [-Count]
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupSection -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>]
