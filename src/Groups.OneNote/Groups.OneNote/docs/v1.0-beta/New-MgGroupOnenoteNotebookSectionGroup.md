...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotenotebooksectiongroup
schema: 2.0.0
---
...
### Create
```
New-MgGroupOnenoteNotebookSectionGroup -GroupId <String> -NotebookId <String> -SectionGroupId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
