...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentNotebook -GroupId <String> -OnenotePageId <String>
...
```
Update-MgGroupOnenotePageParentNotebookSectionParentNotebook -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenotePageParentNotebookSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
