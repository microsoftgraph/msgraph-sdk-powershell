...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionGroupParentNotebookSectionGroup -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenotePageParentSectionGroupParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
