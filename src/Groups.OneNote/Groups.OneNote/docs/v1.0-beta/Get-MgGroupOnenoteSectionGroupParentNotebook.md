...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
