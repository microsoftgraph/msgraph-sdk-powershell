...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentsectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -GroupId <String>
