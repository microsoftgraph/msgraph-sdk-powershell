...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
