...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupsectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupSectionPageParentSection -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupSectionPageParentSection -InputObject <IGroupsOneNoteIdentity>
