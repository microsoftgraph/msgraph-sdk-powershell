...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupsectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionGroupSectionPageParentSection -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionGroupSectionPageParentSection -InputObject <IGroupsOneNoteIdentity>
