...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
...
```
Update-MgGroupOnenoteSectionGroupParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
