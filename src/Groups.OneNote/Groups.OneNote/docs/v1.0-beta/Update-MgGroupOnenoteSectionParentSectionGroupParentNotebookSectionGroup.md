...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -GroupId <String>
...
```
Update-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -GroupId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
