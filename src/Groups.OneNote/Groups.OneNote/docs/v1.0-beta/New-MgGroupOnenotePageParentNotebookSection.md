...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotepageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenotePageParentNotebookSection -GroupId <String> -OnenotePageId <String>
...
### CreateViaIdentity1
```
New-MgGroupOnenotePageParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
