...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -GroupId <String>
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru]
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm]
