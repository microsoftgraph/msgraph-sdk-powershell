...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -GroupId <String>
