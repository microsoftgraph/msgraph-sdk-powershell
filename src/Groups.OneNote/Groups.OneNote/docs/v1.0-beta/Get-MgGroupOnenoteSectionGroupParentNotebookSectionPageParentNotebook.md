...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionPageParentNotebook -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity>
