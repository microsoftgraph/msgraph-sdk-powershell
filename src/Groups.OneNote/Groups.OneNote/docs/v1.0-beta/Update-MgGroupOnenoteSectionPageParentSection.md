...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionPageParentSection -GroupId <String> -OnenotePageId <String>
...
```
Update-MgGroupOnenoteSectionPageParentSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionPageParentSection -InputObject <IGroupsOneNoteIdentity>
