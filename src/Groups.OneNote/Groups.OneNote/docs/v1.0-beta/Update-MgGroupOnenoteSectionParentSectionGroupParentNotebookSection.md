...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
