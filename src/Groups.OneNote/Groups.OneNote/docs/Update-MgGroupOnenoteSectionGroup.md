...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroup
schema: 2.0.0
---
...
### Update1
```
Update-MgGroupOnenoteSectionGroup -GroupId <String> -SectionGroupId <String> -SectionGroupId1 <String>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
