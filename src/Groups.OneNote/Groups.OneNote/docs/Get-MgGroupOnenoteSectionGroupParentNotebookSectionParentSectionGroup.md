...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionParentSectionGroup -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
