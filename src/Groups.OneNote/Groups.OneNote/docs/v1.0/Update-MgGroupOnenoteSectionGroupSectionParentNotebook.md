...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupSectionParentNotebook -GroupId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionGroupSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
