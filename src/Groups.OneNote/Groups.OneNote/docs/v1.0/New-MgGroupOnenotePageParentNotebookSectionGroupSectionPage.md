...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
```
New-MgGroupOnenotePageParentNotebookSectionGroupSectionPage -GroupId <String> -OnenotePageId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenotePageParentNotebookSectionGroupSectionPage -InputObject <IGroupsOneNoteIdentity>
