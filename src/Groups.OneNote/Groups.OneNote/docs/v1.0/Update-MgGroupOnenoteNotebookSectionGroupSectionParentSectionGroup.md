...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionGroupSectionParentSectionGroup -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionGroupSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
