...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionGroupSectionParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
...
```
New-MgGroupOnenoteSectionGroupSectionParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupOnenoteSectionGroupSectionParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
