...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup
 -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm]
