...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteSectionGroupParentNotebookSection -GroupId <String> -SectionGroupId <String> [-Count]
...
### Get1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
