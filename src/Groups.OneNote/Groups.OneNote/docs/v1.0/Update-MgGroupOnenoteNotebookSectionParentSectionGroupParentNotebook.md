...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupParentNotebook -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
