...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupParentNotebook -GroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
