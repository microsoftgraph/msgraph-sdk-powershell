...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionPage -GroupId <String> -OnenoteSectionId <String>
...
### Get1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
