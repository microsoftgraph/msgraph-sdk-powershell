...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionGroupSectionPageParentNotebook -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionGroupSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
