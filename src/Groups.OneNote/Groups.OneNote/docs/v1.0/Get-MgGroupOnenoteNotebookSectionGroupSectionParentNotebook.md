...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupOnenoteNotebookSectionGroupSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
