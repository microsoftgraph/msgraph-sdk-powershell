...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionGroup -GroupId <String> -OnenotePageId <String>
...
### Update3
```
Update-MgGroupOnenotePageParentSectionGroup -GroupId <String> -OnenotePageId <String> -SectionGroupId <String>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity2
```
Update-MgGroupOnenotePageParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
