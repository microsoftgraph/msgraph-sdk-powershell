...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionGroupParentNotebookSectionPage -GroupId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity1
```
New-MgGroupOnenoteSectionGroupParentNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
