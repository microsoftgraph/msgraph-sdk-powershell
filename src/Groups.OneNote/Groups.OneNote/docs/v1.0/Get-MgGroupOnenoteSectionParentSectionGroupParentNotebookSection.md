...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -GroupId <String> -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgGroupOnenoteSectionParentSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
