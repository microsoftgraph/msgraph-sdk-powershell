...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteSectionParentSectionGroupSection -GroupId <String> -OnenoteSectionId <String> [-Count]
...
### Get1
```
Get-MgGroupOnenoteSectionParentSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenoteSectionParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
