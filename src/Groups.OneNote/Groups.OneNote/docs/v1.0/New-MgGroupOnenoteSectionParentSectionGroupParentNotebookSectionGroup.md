...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -GroupId <String>
...
```
New-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -GroupId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
