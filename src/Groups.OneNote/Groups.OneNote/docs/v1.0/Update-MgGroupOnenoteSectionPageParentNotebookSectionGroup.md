...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
...
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroup -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SectionGroupId1 <String>
...
### UpdateViaIdentity2
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
