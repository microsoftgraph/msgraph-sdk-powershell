...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionPageParentSection -GroupId <String> -NotebookId <String>
...
```
Update-MgGroupOnenoteNotebookSectionPageParentSection -GroupId <String> -NotebookId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionPageParentSection -InputObject <IGroupsOneNoteIdentity>
