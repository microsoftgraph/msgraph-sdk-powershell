...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenotePageParentSectionGroupParentNotebookSection -GroupId <String> -OnenotePageId <String>
...
### CreateViaIdentity1
```
New-MgGroupOnenotePageParentSectionGroupParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
