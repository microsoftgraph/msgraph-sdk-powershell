...
```
Update-MgGroupOnenote -GroupId <String> [-Id <String>] [-Notebooks <IMicrosoftGraphNotebook1[]>]
...
### Update1
```
Update-MgGroupOnenote -GroupId <String> -BodyParameter <IMicrosoftGraphOnenote1> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgGroupOnenote -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphOnenote1>
