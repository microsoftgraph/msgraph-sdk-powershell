...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionParentSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity1
```
New-MgGroupOnenoteSectionParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
