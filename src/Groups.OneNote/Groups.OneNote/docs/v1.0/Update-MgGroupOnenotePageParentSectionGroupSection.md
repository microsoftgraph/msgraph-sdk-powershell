...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectiongroupsection
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionGroupSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
...
```
Update-MgGroupOnenotePageParentSectionGroupSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgGroupOnenotePageParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
