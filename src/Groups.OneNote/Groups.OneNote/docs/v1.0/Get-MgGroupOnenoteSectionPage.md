...
### List1 (Default)
```
Get-MgGroupOnenoteSectionPage -GroupId <String> -OnenoteSectionId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgGroupOnenoteSectionPage -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>]
