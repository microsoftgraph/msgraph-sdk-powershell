...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupParentNotebookSectionParentNotebook -GroupId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
...
```
Update-MgGroupOnenoteSectionGroupParentNotebookSectionParentNotebook -GroupId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionGroupParentNotebookSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
