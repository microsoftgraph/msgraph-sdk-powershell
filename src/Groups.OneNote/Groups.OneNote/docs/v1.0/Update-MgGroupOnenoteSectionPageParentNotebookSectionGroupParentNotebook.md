...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectionpageparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroupParentNotebook -GroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionPageParentNotebookSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
