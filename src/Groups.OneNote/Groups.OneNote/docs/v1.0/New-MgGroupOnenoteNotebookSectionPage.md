...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotenotebooksectionpage
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgGroupOnenoteNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupOnenoteNotebookSectionPage -InputObject <IGroupsOneNoteIdentity> [-ContentInputFile <String>]
