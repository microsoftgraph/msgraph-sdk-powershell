...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionGroupSectionParentNotebook -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionGroupSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
