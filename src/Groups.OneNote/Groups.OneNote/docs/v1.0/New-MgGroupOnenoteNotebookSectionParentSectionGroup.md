...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
New-MgGroupOnenoteNotebookSectionParentSectionGroup -GroupId <String> -NotebookId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteNotebookSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
