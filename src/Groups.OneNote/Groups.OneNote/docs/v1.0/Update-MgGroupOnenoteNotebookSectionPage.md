...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectionpage
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenotePageId <String>
...
```
Update-MgGroupOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenotePage1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupOnenoteNotebookSectionPage -InputObject <IGroupsOneNoteIdentity> [-ContentInputFile <String>]
