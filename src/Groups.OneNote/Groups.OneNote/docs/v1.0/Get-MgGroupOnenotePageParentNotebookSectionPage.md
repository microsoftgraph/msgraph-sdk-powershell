...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
...
```
Get-MgGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
 -OnenotePageId1 <String> -OnenoteSectionId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenotePageParentNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
