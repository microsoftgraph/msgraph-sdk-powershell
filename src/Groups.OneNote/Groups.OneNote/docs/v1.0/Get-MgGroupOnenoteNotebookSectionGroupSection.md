...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String> -SectionGroupId <String>
...
### Get1
```
Get-MgGroupOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String>
...
### GetViaIdentity1
```
Get-MgGroupOnenoteNotebookSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
