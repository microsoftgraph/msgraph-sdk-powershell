...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupParentSectionGroup -GroupId <String> -SectionGroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionGroupParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
