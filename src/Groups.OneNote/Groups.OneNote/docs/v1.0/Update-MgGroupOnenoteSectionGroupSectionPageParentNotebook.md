...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteSectionGroupSectionPageParentNotebook -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionGroupSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity>
