...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentsectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
```
Get-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup
 -InputObject <IGroupsOneNoteIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
