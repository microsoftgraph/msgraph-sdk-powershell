...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionParentNotebook -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenotePageParentSectionParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
