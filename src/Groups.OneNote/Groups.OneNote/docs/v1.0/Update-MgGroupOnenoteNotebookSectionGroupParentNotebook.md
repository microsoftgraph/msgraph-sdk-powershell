...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionGroupParentNotebook -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
