...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotepageparentnotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupOnenotePageParentNotebookSectionParentSectionGroupParentNotebook -GroupId <String>
 -OnenotePageId <String> -OnenoteSectionId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
