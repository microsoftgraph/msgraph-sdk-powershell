...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -GroupId <String>
 -OnenotePageId <String> -SectionGroupId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru]
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <IGroupsOneNoteIdentity> -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm]
