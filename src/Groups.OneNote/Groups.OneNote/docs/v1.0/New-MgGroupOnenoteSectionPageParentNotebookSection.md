...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
...
```
New-MgGroupOnenoteSectionPageParentNotebookSection -GroupId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupOnenoteSectionPageParentNotebookSection -InputObject <IGroupsOneNoteIdentity>
