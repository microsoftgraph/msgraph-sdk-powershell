...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionGroup -GroupId <String> -SectionGroupId <String> [-Count]
...
### Get1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionGroup -GroupId <String> -SectionGroupId <String>
 -SectionGroupId1 <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenoteSectionGroupParentNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
