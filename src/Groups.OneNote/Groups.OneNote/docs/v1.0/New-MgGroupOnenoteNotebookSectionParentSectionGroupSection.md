...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/new-mggrouponenotenotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteNotebookSectionParentSectionGroupSection -GroupId <String> -NotebookId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteNotebookSectionParentSectionGroupSection -InputObject <IGroupsOneNoteIdentity>
