...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupOnenoteSectionGroupSectionPageParentNotebook -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgGroupOnenoteSectionGroupSectionPageParentNotebook -InputObject <IGroupsOneNoteIdentity>
