...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/get-mggrouponenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupOnenoteNotebookSectionParentSectionGroup -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupOnenoteNotebookSectionParentSectionGroup -InputObject <IGroupsOneNoteIdentity>
