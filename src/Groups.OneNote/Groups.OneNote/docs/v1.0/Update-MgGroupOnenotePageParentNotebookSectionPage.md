...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
 -OnenotePageId1 <String> -OnenoteSectionId <String> [-ContentInputFile <String>] [-ContentUrl <String>]
...
```
Update-MgGroupOnenotePageParentNotebookSectionPage -GroupId <String> -OnenotePageId <String>
 -OnenotePageId1 <String> -OnenoteSectionId <String> -BodyParameter <IMicrosoftGraphOnenotePage1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgGroupOnenotePageParentNotebookSectionPage -InputObject <IGroupsOneNoteIdentity>
