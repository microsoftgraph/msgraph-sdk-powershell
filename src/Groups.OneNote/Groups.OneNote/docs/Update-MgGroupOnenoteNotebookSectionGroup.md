...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotenotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSectionGroup -GroupId <String> -NotebookId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionGroup -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
