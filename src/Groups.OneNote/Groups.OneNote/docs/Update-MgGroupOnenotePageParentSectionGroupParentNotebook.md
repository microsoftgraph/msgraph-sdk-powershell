...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.onenote/update-mggrouponenotepageparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionGroupParentNotebook -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgGroupOnenotePageParentSectionGroupParentNotebook -InputObject <IGroupsOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
