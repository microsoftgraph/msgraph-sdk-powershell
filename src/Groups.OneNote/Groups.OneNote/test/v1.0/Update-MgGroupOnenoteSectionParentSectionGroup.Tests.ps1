...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-MgGroupOnenoteSectionParentSectionGroup.Recording.json'
...
Describe 'Update-MgGroupOnenoteSectionParentSectionGroup' {
