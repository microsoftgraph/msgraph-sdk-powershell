...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement.administration/get-mgdevicemanagementvirtualendpointprovisioningpolicyassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementVirtualEndpointProvisioningPolicyAssignmentCount -CloudPcProvisioningPolicyId <String>
