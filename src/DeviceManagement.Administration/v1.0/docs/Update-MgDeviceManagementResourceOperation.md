...
Update-MgDeviceManagementResourceOperation -ResourceOperationId <String>
 -BodyParameter <IMicrosoftGraphResourceOperation> [-ResponseHeadersVariable <String>]
...
Update-MgDeviceManagementResourceOperation -InputObject <IDeviceManagementAdministrationIdentity>
 ...
 [-ResourceName <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
