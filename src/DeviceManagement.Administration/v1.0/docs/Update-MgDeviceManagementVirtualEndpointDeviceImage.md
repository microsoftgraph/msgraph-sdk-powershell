...
Update-MgDeviceManagementVirtualEndpointDeviceImage -CloudPcDeviceImageId <String>
 ...
 [-OSBuildNumber <String>] [-OSStatus <String>] [-ResponseHeadersVariable <String>]
 [-SourceImageResourceId <String>] [-Status <String>] [-Version <String>] [-Headers <IDictionary>] [-Confirm]
