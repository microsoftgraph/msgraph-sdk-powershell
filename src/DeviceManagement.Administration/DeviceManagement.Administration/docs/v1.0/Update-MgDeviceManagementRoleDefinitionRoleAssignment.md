...
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String> -RoleDefinitionId <String>
 ...
 [-ResourceScopes <String[]>] [-RoleDefinition <IMicrosoftGraphRoleDefinition>] [-PassThru] [-WhatIf]
...
```
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String> -RoleDefinitionId <String>
 -BodyParameter <IMicrosoftGraphRoleAssignment1> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
