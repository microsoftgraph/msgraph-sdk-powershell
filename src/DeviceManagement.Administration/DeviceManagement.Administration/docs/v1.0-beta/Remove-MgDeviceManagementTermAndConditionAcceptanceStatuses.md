...
# Remove-MgBetaDeviceManagementTermAndConditionAcceptanceStatuses
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementTermAndConditionAcceptanceStatuses -TermsAndConditionsAcceptanceStatusId <String>
