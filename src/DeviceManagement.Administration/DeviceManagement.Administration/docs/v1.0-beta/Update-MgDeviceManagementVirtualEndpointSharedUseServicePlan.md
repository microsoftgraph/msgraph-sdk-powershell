...
Update-MgDeviceManagementVirtualEndpointSharedUseServicePlan -CloudPcSharedUseServicePlanId <String>
 ...
 [-UsedCount <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgDeviceManagementVirtualEndpointSharedUseServicePlan -CloudPcSharedUseServicePlanId <String>
 -BodyParameter <IMicrosoftGraphCloudPcSharedUseServicePlan> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementVirtualEndpointSharedUseServicePlan
 ...
 [-DisplayName <String>] [-Id <String>] [-TotalCount <Int32>] [-UsedCount <Int32>] [-PassThru] [-Confirm]
