...
### Delete1 (Default)
```
Remove-MgBetaDeviceManagementAuditEvent -AuditEventId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-MgBetaDeviceManagementAuditEvent -InputObject <IDeviceManagementAdministrationIdentity> [-IfMatch <String>]
