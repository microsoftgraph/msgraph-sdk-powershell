...
```
Update-MgDeviceManagementIntuneBrandingProfileAssignment -InputObject <IDeviceManagementAdministrationIdentity>
...
```
Update-MgDeviceManagementIntuneBrandingProfileAssignment -InputObject <IDeviceManagementAdministrationIdentity>
 -BodyParameter <IMicrosoftGraphIntuneBrandingProfileAssignment> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
