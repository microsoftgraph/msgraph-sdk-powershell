...
### Delete (Default)
```
Remove-MgDeviceManagementVirtualEndpointSnapshot -CloudPcSnapshotId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceManagementVirtualEndpointSnapshot -InputObject <IDeviceManagementAdministrationIdentity>
