...
New-MgBetaDeviceManagementGroupPolicyDefinitionFile [-AdditionalProperties <Hashtable>]
 ...
 [-PolicyType <GroupPolicyType>] [-ResponseHeadersVariable <String>] [-Revision <String>]
 [-TargetNamespace <String>] [-TargetPrefix <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
