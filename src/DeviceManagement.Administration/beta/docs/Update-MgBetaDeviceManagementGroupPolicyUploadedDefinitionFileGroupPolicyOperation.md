...
Update-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFileGroupPolicyOperation
 ...
 [-ResponseHeadersVariable <String>] [-StatusDetails <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFileGroupPolicyOperation
 ...
 [-OperationType <GroupPolicyOperationType>] [-ResponseHeadersVariable <String>] [-StatusDetails <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
