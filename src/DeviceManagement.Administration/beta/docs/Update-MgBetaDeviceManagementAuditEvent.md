...
Update-MgBetaDeviceManagementAuditEvent -AuditEventId <String> [-Activity <String>]
 ...
 [-Id <String>] [-Resources <IMicrosoftGraphAuditResource[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementAuditEvent -InputObject <IDeviceManagementAdministrationIdentity>
 -BodyParameter <IMicrosoftGraphAuditEvent> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
