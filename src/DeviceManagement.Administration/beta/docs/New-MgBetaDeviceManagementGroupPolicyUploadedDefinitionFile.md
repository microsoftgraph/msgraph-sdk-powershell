...
New-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFile [-AdditionalProperties <Hashtable>]
 ...
 [-TargetPrefix <String>] [-UploadDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFile
 -BodyParameter <IMicrosoftGraphGroupPolicyUploadedDefinitionFile> [-Headers <IDictionary>] [-Confirm]
