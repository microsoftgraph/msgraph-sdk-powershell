...
Update-MgBetaDeviceManagementCartToClassAssociation -CartToClassAssociationId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-Version <Int32>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementCartToClassAssociation -CartToClassAssociationId <String>
 -BodyParameter <IMicrosoftGraphCartToClassAssociation> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
