...
Update-MgBetaDeviceManagementGroupPolicyObjectFile -GroupPolicyObjectFileId <String>
 ...
 [-OuDistinguishedName <String>] [-RoleScopeTagIds <String[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementGroupPolicyObjectFile -GroupPolicyObjectFileId <String>
 -BodyParameter <IMicrosoftGraphGroupPolicyObjectFile> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
