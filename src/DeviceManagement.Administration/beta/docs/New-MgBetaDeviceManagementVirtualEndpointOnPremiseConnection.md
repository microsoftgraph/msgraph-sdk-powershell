...
New-MgBetaDeviceManagementVirtualEndpointOnPremiseConnection [-AdditionalProperties <Hashtable>]
 ...
 [-VirtualNetworkId <String>] [-VirtualNetworkLocation <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementVirtualEndpointOnPremiseConnection
 -BodyParameter <IMicrosoftGraphCloudPcOnPremisesConnection> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
