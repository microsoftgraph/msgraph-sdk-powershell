...
Update-MgBetaDeviceManagementVirtualEndpointGalleryImage -CloudPcGalleryImageId <String>
 ...
 [-ResponseHeadersVariable <String>] [-SizeInGb <Int32>] [-Sku <String>] [-SkuDisplayName <String>]
 [-SkuName <String>] [-StartDate <DateTime>] [-Status <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
