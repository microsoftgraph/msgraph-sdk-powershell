...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    public class UpdateMgDeviceManagementTermAndConditionAcceptanceStatusCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserPrincipalName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, TermsAndConditionsAcceptanceStatusId));
                return;
            }
