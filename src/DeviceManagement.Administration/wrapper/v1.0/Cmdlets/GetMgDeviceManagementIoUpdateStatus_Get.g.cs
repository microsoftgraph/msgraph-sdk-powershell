...
{
    [GraphRoute("GET", "/deviceManagement/iosUpdateStatuses/{iosUpdateDeviceStatus-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIoUpdateStatus_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.IosUpdateDeviceStatus))]
    public class GetMgDeviceManagementIoUpdateStatus_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.IosUpdateStatuses[IosUpdateDeviceStatusId].GetAsync(requestConfiguration =>
                {
