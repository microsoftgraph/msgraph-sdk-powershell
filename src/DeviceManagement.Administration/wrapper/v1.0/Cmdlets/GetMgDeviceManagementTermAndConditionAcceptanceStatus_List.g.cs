...
{
    [GraphRoute("GET", "/deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTermAndConditionAcceptanceStatus_List")]
    ...
    public class GetMgDeviceManagementTermAndConditionAcceptanceStatus_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.TermsAndConditionsAcceptanceStatusCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.TermsAndConditions[TermsAndConditionsId].AcceptanceStatuses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.TermsAndConditions[TermsAndConditionsId].AcceptanceStatuses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
