...
{
    [GraphRoute("GET", "/deviceManagement/resourceOperations")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementResourceOperation_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.ResourceOperation))]
    public class GetMgDeviceManagementResourceOperation_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.ResourceOperationCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ResourceOperations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ResourceOperations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
