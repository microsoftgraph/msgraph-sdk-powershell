...
{
    [GraphRoute("GET", "/deviceManagement/virtualEndpoint/userSettings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementVirtualEndpointUserSetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcUserSetting))]
    public class GetMgDeviceManagementVirtualEndpointUserSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcUserSettingCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.UserSettings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.VirtualEndpoint.UserSettings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
