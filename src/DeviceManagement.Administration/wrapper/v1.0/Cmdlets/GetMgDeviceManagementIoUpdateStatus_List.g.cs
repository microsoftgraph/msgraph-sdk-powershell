...
{
    [GraphRoute("GET", "/deviceManagement/iosUpdateStatuses")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementIoUpdateStatus_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.IosUpdateDeviceStatus))]
    public class GetMgDeviceManagementIoUpdateStatus_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.IosUpdateDeviceStatusCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.IosUpdateStatuses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.IosUpdateStatuses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
