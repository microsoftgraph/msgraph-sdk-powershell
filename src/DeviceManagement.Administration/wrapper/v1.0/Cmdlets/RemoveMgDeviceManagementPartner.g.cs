...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    public class RemoveMgDeviceManagementPartnerCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeviceManagementPartnerId));
                return;
            }
        }
    }
