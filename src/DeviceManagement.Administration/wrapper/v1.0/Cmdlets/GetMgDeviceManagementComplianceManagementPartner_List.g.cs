...
{
    [GraphRoute("GET", "/deviceManagement/complianceManagementPartners")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementComplianceManagementPartner_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.ComplianceManagementPartner))]
    public class GetMgDeviceManagementComplianceManagementPartner_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.ComplianceManagementPartnerCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ComplianceManagementPartners.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ComplianceManagementPartners.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
