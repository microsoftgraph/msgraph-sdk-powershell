...
{
    [GraphRoute("GET", "/deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementPartner_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.DeviceManagementPartner))]
    public class GetMgDeviceManagementPartner_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DeviceManagementPartners[DeviceManagementPartnerId].GetAsync(requestConfiguration =>
                {
