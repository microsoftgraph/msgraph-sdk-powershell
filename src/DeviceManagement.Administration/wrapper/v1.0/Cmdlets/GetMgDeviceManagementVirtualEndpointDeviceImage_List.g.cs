...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementVirtualEndpointDeviceImage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcDeviceImage))]
    public class GetMgDeviceManagementVirtualEndpointDeviceImage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcDeviceImageCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.DeviceImages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.VirtualEndpoint.DeviceImages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
