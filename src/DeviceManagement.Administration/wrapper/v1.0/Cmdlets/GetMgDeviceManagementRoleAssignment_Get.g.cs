...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    public class GetMgDeviceManagementRoleAssignment_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DeviceAndAppManagementRoleAssignmentId));
                return;
            }
