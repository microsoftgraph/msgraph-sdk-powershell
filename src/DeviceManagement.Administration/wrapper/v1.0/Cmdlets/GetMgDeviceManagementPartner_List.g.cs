...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementPartner_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.DeviceManagementPartner))]
    public class GetMgDeviceManagementPartner_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.DeviceManagementPartnerCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceManagementPartners.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceManagementPartners.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
