...
{
    [GraphRoute("GET", "/deviceManagement/virtualEndpoint/cloudPCs")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementVirtualEndpointCloudPc_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPC))]
    public class GetMgDeviceManagementVirtualEndpointCloudPc_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPCCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.CloudPCs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.VirtualEndpoint.CloudPCs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
