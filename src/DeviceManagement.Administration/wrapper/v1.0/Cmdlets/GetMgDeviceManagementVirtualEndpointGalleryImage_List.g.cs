...
{
    [GraphRoute("GET", "/deviceManagement/virtualEndpoint/galleryImages")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementVirtualEndpointGalleryImage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcGalleryImage))]
    public class GetMgDeviceManagementVirtualEndpointGalleryImage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcGalleryImageCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.GalleryImages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.VirtualEndpoint.GalleryImages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
