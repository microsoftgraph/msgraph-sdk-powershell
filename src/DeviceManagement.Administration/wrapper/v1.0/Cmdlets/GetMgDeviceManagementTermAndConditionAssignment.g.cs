...
{
    [GraphRoute("GET", "/deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments")]
    ...
    public class GetMgDeviceManagementTermAndConditionAssignmentCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceManagementTermAndConditionAssignment_Get" : "Get-MgDeviceManagementTermAndConditionAssignment_List";
            try
            {
