...
{
    [GraphRoute("POST", "/deviceManagement/iosUpdateStatuses")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementIoUpdateStatus", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.IosUpdateDeviceStatus))]
    public class NewMgDeviceManagementIoUpdateStatusCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.IosUpdateStatuses.PostAsync(body, requestConfiguration =>
                {
