...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAuditEvent_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.AuditEvent))]
    public class GetMgDeviceManagementAuditEvent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.AuditEventCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AuditEvents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AuditEvents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
