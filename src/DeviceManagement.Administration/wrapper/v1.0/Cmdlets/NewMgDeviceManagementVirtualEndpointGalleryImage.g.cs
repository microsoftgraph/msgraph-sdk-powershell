...
{
    [GraphRoute("POST", "/deviceManagement/virtualEndpoint/galleryImages")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementVirtualEndpointGalleryImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcGalleryImage))]
    public class NewMgDeviceManagementVirtualEndpointGalleryImageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.GalleryImages.PostAsync(body, requestConfiguration =>
                {
