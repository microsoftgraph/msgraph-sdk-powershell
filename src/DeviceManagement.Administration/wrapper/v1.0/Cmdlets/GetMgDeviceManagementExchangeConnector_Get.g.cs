...
{
    [GraphRoute("GET", "/deviceManagement/exchangeConnectors/{deviceManagementExchangeConnector-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementExchangeConnector_Get")]
    ...
    public class GetMgDeviceManagementExchangeConnector_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ExchangeConnectors[DeviceManagementExchangeConnectorId].GetAsync(requestConfiguration =>
                {
