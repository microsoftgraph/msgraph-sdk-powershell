...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    public class GetMgDeviceManagementVirtualEndpointProvisioningPolicyAssignmentCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? CloudPcProvisioningPolicyAssignmentId : CloudPcProvisioningPolicyId);
                return;
            }
        }
    }
