...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementTermAndCondition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.TermsAndConditions))]
    public class GetMgDeviceManagementTermAndCondition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.TermsAndConditionsCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.TermsAndConditions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.TermsAndConditions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
