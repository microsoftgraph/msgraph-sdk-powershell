...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Administration
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementVirtualEndpointServicePlan_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcServicePlan))]
    public class GetMgDeviceManagementVirtualEndpointServicePlan_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Administration.Client.Models.CloudPcServicePlanCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.VirtualEndpoint.ServicePlans.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.VirtualEndpoint.ServicePlans.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
