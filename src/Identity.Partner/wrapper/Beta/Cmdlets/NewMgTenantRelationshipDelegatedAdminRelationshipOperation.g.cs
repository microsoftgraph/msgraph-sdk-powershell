...
{
    [GraphRoute("POST", "/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/operations")]
    [Cmdlet(VerbsCommon.New, "MgTenantRelationshipDelegatedAdminRelationshipOperation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminRelationshipOperation))]
    public class NewMgTenantRelationshipDelegatedAdminRelationshipOperationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.TenantRelationships.DelegatedAdminRelationships[DelegatedAdminRelationshipId].Operations.PostAsync(body, requestConfiguration =>
                {
