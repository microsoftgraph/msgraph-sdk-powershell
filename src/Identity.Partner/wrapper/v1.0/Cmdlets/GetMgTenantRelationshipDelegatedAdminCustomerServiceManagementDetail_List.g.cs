...
namespace Microsoft.Graph.PowerShell.Identity.Partner
{
    ...
    public class GetMgTenantRelationshipDelegatedAdminCustomerServiceManagementDetail_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DelegatedAdminCustomerId));
                return;
            }
