...
{
    [GraphRoute("GET", "/tenantRelationships/delegatedAdminCustomers")]
    [Cmdlet(VerbsCommon.Get, "MgTenantRelationshipDelegatedAdminCustomer_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminCustomer))]
    public class GetMgTenantRelationshipDelegatedAdminCustomer_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminCustomerCollectionResponse? result;
            try
            {
                result = client.TenantRelationships.DelegatedAdminCustomers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.TenantRelationships.DelegatedAdminCustomers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
