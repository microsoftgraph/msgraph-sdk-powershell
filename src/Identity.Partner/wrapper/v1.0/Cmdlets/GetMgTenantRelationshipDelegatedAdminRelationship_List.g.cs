...
{
    [GraphRoute("GET", "/tenantRelationships/delegatedAdminRelationships")]
    [Cmdlet(VerbsCommon.Get, "MgTenantRelationshipDelegatedAdminRelationship_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminRelationship))]
    public class GetMgTenantRelationshipDelegatedAdminRelationship_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminRelationshipCollectionResponse? result;
            try
            {
                result = client.TenantRelationships.DelegatedAdminRelationships.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.TenantRelationships.DelegatedAdminRelationships.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
