...
namespace Microsoft.Graph.PowerShell.Identity.Partner
{
    ...
    public class GetMgTenantRelationshipDelegatedAdminRelationshipOperation_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DelegatedAdminRelationshipId));
                return;
            }
