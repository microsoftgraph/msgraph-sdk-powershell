...
{
    [GraphRoute("GET", "/tenantRelationships/delegatedAdminCustomers/{delegatedAdminCustomer-id}")]
    [Cmdlet(VerbsCommon.Get, "MgTenantRelationshipDelegatedAdminCustomer_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.Partner.Client.Models.DelegatedAdminCustomer))]
    public class GetMgTenantRelationshipDelegatedAdminCustomer_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.TenantRelationships.DelegatedAdminCustomers[DelegatedAdminCustomerId].GetAsync(requestConfiguration =>
                {
