...
### List (Default)
```
Get-MgSettingDirectorySetting [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgSettingDirectorySetting -InputObject <IIdentityDirectorySettingsIdentity> [-ExpandProperty <String[]>]
