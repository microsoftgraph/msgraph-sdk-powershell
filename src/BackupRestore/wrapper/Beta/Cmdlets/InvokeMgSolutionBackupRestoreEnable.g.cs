...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreEnable", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ServiceStatus))]
    public class InvokeMgSolutionBackupRestoreEnableCommand : GraphClientCmdlet
    {
