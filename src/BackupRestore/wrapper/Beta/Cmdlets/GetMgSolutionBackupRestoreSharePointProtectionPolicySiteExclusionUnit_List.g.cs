...
{
    [GraphRoute("GET", "/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy-id}/siteExclusionUnits")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSharePointProtectionPolicySiteExclusionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteExclusionUnit))]
    public class GetMgSolutionBackupRestoreSharePointProtectionPolicySiteExclusionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteExclusionUnitCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.SharePointProtectionPolicies[SharePointProtectionPolicyId].SiteExclusionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SharePointProtectionPolicies[SharePointProtectionPolicyId].SiteExclusionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
