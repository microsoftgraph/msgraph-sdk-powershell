...
{
    [GraphRoute("GET", "/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicy-id}/driveExclusionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreOneDriveForBusinessProtectionPolicyDriveExclusionUnitBulkAdditionJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveExclusionUnitsBulkAdditionJob))]
    public class GetMgSolutionBackupRestoreOneDriveForBusinessProtectionPolicyDriveExclusionUnitBulkAdditionJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveExclusionUnitsBulkAdditionJobCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies[OneDriveForBusinessProtectionPolicyId].DriveExclusionUnitsBulkAdditionJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies[OneDriveForBusinessProtectionPolicyId].DriveExclusionUnitsBulkAdditionJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
