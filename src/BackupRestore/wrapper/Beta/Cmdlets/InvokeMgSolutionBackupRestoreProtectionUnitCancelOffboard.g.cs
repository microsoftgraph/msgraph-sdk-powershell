...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreProtectionUnitCancelOffboard", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionUnitBase))]
    public class InvokeMgSolutionBackupRestoreProtectionUnitCancelOffboardCommand : GraphClientCmdlet
    {
