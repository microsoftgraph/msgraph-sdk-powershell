...
{
    [GraphRoute("GET", "/solutions/backupRestore/sharePointProtectionPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSharePointProtectionPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointProtectionPolicy))]
    public class GetMgSolutionBackupRestoreSharePointProtectionPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointProtectionPolicyCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.SharePointProtectionPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SharePointProtectionPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
