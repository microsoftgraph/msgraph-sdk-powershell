...
{
    [GraphRoute("GET", "/solutions/backupRestore/driveExclusionUnits")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreDriveExclusionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveExclusionUnit))]
    public class GetMgSolutionBackupRestoreDriveExclusionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveExclusionUnitCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.DriveExclusionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.DriveExclusionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
