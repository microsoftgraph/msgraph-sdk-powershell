...
{
    [GraphRoute("POST", "/solutions/backupRestore/driveProtectionUnits")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreDriveProtectionUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveProtectionUnit))]
    public class NewMgSolutionBackupRestoreDriveProtectionUnitCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.DriveProtectionUnits.PostAsync(body, requestConfiguration =>
                {
