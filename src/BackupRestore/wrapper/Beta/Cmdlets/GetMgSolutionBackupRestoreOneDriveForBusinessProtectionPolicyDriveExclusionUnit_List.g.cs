...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreOneDriveForBusinessProtectionPolicyDriveExclusionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveExclusionUnit))]
    public class GetMgSolutionBackupRestoreOneDriveForBusinessProtectionPolicyDriveExclusionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies[OneDriveForBusinessProtectionPolicyId].DriveExclusionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies[OneDriveForBusinessProtectionPolicyId].DriveExclusionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
