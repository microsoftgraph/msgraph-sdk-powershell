...
{
    [GraphRoute("GET", "/solutions/backupRestore/exclusionUnits")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreExclusionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ExclusionUnitBase))]
    public class GetMgSolutionBackupRestoreExclusionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ExclusionUnitBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ExclusionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ExclusionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
