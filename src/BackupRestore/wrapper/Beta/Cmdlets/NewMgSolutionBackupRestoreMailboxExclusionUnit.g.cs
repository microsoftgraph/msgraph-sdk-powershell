...
{
    [GraphRoute("POST", "/solutions/backupRestore/mailboxExclusionUnits")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreMailboxExclusionUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxExclusionUnit))]
    public class NewMgSolutionBackupRestoreMailboxExclusionUnitCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(MailboxType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.MailboxExclusionUnits.PostAsync(body, requestConfiguration =>
                {
