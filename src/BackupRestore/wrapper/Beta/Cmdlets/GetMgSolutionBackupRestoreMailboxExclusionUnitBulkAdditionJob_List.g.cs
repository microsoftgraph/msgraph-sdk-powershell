...
{
    [GraphRoute("GET", "/solutions/backupRestore/mailboxExclusionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreMailboxExclusionUnitBulkAdditionJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxExclusionUnitsBulkAdditionJob))]
    public class GetMgSolutionBackupRestoreMailboxExclusionUnitBulkAdditionJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxExclusionUnitsBulkAdditionJobCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.MailboxExclusionUnitsBulkAdditionJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.MailboxExclusionUnitsBulkAdditionJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
