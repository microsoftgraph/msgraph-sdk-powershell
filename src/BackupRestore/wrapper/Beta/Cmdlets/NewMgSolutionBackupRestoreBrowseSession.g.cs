...
{
    [GraphRoute("POST", "/solutions/backupRestore/browseSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreBrowseSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.BrowseSessionBase))]
    public class NewMgSolutionBackupRestoreBrowseSessionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.BrowseSessions.PostAsync(body, requestConfiguration =>
                {
