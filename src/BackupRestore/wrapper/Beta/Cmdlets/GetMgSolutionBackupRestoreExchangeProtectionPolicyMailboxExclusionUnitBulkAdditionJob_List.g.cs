...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreExchangeProtectionPolicyMailboxExclusionUnitBulkAdditionJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxExclusionUnitsBulkAdditionJob))]
    public class GetMgSolutionBackupRestoreExchangeProtectionPolicyMailboxExclusionUnitBulkAdditionJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].MailboxExclusionUnitsBulkAdditionJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].MailboxExclusionUnitsBulkAdditionJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
