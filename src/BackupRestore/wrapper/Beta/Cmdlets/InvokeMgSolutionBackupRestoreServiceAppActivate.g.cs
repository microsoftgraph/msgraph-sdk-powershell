...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreServiceAppActivate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ServiceApp))]
    public class InvokeMgSolutionBackupRestoreServiceAppActivateCommand : GraphClientCmdlet
    {
