...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreBrowseSessionBrowse", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgSolutionBackupRestoreBrowseSessionBrowseCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(OptimizedBrowse)))
        body.OptimizedBrowse = OptimizedBrowse;
