...
{
    [GraphRoute("POST", "/solutions/backupRestore/siteExclusionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSiteExclusionUnitBulkAdditionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteExclusionUnitsBulkAdditionJob))]
    public class NewMgSolutionBackupRestoreSiteExclusionUnitBulkAdditionJobCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteExclusionUnitsBulkAdditionJobs.PostAsync(body, requestConfiguration =>
                {
