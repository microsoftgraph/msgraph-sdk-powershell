...
{
    [GraphRoute("POST", "/solutions/backupRestore/siteProtectionUnits")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSiteProtectionUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnit))]
    public class NewMgSolutionBackupRestoreSiteProtectionUnitCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnit();

    if (this.IsParameterBound(nameof(BackupRetentionPeriodInDays)))
        body.BackupRetentionPeriodInDays = BackupRetentionPeriodInDays;
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteProtectionUnits.PostAsync(body, requestConfiguration =>
                {
