...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreExchangeProtectionPolicyMailboxExclusionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxExclusionUnit))]
    public class GetMgSolutionBackupRestoreExchangeProtectionPolicyMailboxExclusionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].MailboxExclusionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].MailboxExclusionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
