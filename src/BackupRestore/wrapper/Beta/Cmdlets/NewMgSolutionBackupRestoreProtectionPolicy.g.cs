...
{
    [GraphRoute("POST", "/solutions/backupRestore/protectionPolicies")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreProtectionPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionPolicyBase))]
    public class NewMgSolutionBackupRestoreProtectionPolicyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.ProtectionPolicies.PostAsync(body, requestConfiguration =>
                {
