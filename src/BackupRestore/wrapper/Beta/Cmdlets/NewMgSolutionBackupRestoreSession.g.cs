...
{
    [GraphRoute("POST", "/solutions/backupRestore/restoreSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.RestoreSessionBase))]
    public class NewMgSolutionBackupRestoreSessionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.RestoreSessions.PostAsync(body, requestConfiguration =>
                {
