...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreProtectionPolicyDeactivate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionPolicyBase))]
    public class InvokeMgSolutionBackupRestoreProtectionPolicyDeactivateCommand : GraphClientCmdlet
    {
