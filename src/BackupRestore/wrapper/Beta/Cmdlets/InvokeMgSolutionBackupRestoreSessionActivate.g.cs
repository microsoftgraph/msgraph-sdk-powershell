...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSolutionBackupRestoreSessionActivate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.RestoreSessionBase))]
    public class InvokeMgSolutionBackupRestoreSessionActivateCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(RestoreSessionBaseId, "Invoke"))
                return;
