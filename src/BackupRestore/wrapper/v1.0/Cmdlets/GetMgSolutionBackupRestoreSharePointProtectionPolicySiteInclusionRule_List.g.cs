...
{
    [GraphRoute("GET", "/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy-id}/siteInclusionRules")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSharePointProtectionPolicySiteInclusionRule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionRule))]
    public class GetMgSolutionBackupRestoreSharePointProtectionPolicySiteInclusionRule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionRuleCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.SharePointProtectionPolicies[SharePointProtectionPolicyId].SiteInclusionRules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SharePointProtectionPolicies[SharePointProtectionPolicyId].SiteInclusionRules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
            ...
            {
                ThrowGraphRequestFailed(ex, SharePointProtectionPolicyId);
                return;
            }
        }
    }
