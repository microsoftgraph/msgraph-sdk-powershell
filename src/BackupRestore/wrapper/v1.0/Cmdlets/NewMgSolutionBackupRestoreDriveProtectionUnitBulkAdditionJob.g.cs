...
{
    [GraphRoute("POST", "/solutions/backupRestore/driveProtectionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreDriveProtectionUnitBulkAdditionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveProtectionUnitsBulkAdditionJob))]
    public class NewMgSolutionBackupRestoreDriveProtectionUnitBulkAdditionJobCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.DriveProtectionUnitsBulkAdditionJobs.PostAsync(body, requestConfiguration =>
                {
