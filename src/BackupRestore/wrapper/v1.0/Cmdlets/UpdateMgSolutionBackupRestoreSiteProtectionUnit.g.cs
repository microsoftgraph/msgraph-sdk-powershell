...
{
    [GraphRoute("PATCH", "/solutions/backupRestore/siteProtectionUnits/{siteProtectionUnit-id}")]
    [Cmdlet(VerbsData.Update, "MgSolutionBackupRestoreSiteProtectionUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnit))]
    public class UpdateMgSolutionBackupRestoreSiteProtectionUnitCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(SiteProtectionUnitId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteProtectionUnits[SiteProtectionUnitId].PatchAsync(body, requestConfiguration =>
                {
