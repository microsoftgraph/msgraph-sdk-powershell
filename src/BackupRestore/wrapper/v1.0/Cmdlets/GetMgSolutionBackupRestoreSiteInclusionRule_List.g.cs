...
{
    [GraphRoute("GET", "/solutions/backupRestore/siteInclusionRules")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSiteInclusionRule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionRule))]
    public class GetMgSolutionBackupRestoreSiteInclusionRule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteInclusionRules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SiteInclusionRules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
