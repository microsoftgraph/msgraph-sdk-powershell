...
{
    [GraphRoute("GET", "/solutions/backupRestore/protectionUnits")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreProtectionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionUnitBase))]
    public class GetMgSolutionBackupRestoreProtectionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionUnitBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ProtectionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ProtectionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
