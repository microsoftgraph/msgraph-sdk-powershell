...
{
    [GraphRoute("PATCH", "/solutions/backupRestore/exchangeProtectionPolicies/{exchangeProtectionPolicy-id}")]
    [Cmdlet(VerbsData.Update, "MgSolutionBackupRestoreExchangeProtectionPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ExchangeProtectionPolicy))]
    public class UpdateMgSolutionBackupRestoreExchangeProtectionPolicyCommand : PSCmdlet
    {
        ...
        {
            if (!ShouldProcess(ExchangeProtectionPolicyId, "Update"))
                return;
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].PatchAsync(body, requestConfiguration =>
                {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ExchangeProtectionPolicyId));
                return;
            }
            ...
            if (result is null)
            {
                ...
                try
                {
                    result = client.Solutions.BackupRestore.ExchangeProtectionPolicies[ExchangeProtectionPolicyId].GetAsync().GetAwaiter().GetResult();
                }
                catch (Exception ex)
                {
                    ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ExchangeProtectionPolicyId));
