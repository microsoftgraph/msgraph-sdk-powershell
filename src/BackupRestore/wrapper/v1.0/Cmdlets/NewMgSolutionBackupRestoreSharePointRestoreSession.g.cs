...
{
    [GraphRoute("POST", "/solutions/backupRestore/sharePointRestoreSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSharePointRestoreSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointRestoreSession))]
    public class NewMgSolutionBackupRestoreSharePointRestoreSessionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointRestoreSession();
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SharePointRestoreSessions.PostAsync(body, requestConfiguration =>
                {
