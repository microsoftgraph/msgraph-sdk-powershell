...
{
    [GraphRoute("GET", "/solutions/backupRestore/sharePointBrowseSessions")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSharePointBrowseSession_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointBrowseSession))]
    public class GetMgSolutionBackupRestoreSharePointBrowseSession_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointBrowseSessionCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.SharePointBrowseSessions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SharePointBrowseSessions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
