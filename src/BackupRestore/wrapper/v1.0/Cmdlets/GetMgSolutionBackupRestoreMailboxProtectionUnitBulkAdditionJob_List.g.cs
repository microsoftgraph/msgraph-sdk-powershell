...
{
    [GraphRoute("GET", "/solutions/backupRestore/mailboxProtectionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxProtectionUnitsBulkAdditionJob))]
    public class GetMgSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxProtectionUnitsBulkAdditionJobCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.MailboxProtectionUnitsBulkAdditionJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.MailboxProtectionUnitsBulkAdditionJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
