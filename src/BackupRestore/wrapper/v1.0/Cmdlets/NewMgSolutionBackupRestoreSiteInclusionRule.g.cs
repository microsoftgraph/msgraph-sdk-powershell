...
{
    [GraphRoute("POST", "/solutions/backupRestore/siteInclusionRules")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSiteInclusionRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionRule))]
    public class NewMgSolutionBackupRestoreSiteInclusionRuleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteInclusionRules.PostAsync(body, requestConfiguration =>
                {
