...
{
    [GraphRoute("GET", "/solutions/backupRestore/protectionUnits/graph.driveProtectionUnit")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreProtectionUnitAsDriveProtectionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveProtectionUnit))]
    public class GetMgSolutionBackupRestoreProtectionUnitAsDriveProtectionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveProtectionUnitCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ProtectionUnits.GraphDriveProtectionUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ProtectionUnits.GraphDriveProtectionUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
