...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class GetMgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifactBulkAdditionRequestCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? MailboxRestoreArtifactsBulkAdditionRequestId : ExchangeRestoreSessionId));
                return;
            }
        }
    }
