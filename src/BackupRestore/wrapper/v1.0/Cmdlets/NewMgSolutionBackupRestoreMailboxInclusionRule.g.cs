...
{
    [GraphRoute("POST", "/solutions/backupRestore/mailboxInclusionRules")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreMailboxInclusionRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxProtectionRule))]
    public class NewMgSolutionBackupRestoreMailboxInclusionRuleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.MailboxInclusionRules.PostAsync(body, requestConfiguration =>
                {
