...
{
    [GraphRoute("GET", "/solutions/backupRestore/protectionUnits/graph.siteProtectionUnit")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreProtectionUnitAsSiteProtectionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnit))]
    public class GetMgSolutionBackupRestoreProtectionUnitAsSiteProtectionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnitCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ProtectionUnits.GraphSiteProtectionUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ProtectionUnits.GraphSiteProtectionUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
