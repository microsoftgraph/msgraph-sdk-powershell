...
{
    [GraphRoute("POST", "/solutions/backupRestore/sharePointBrowseSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSharePointBrowseSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointBrowseSession))]
    public class NewMgSolutionBackupRestoreSharePointBrowseSessionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SharePointBrowseSessions.PostAsync(body, requestConfiguration =>
                {
