...
{
    [GraphRoute("POST", "/solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnitsBulkAdditionJob))]
    public class NewMgSolutionBackupRestoreSiteProtectionUnitBulkAdditionJobCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SiteProtectionUnitsBulkAdditionJobs.PostAsync(body, requestConfiguration =>
                {
