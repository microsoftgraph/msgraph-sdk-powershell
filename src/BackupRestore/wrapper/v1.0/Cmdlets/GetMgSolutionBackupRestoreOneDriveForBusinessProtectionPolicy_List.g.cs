...
{
    [GraphRoute("GET", "/solutions/backupRestore/oneDriveForBusinessProtectionPolicies")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreOneDriveForBusinessProtectionPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessProtectionPolicy))]
    public class GetMgSolutionBackupRestoreOneDriveForBusinessProtectionPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessProtectionPolicyCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.OneDriveForBusinessProtectionPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
