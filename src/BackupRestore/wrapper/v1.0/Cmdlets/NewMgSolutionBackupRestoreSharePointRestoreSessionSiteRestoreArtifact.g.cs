...
{
    [GraphRoute("POST", "/solutions/backupRestore/sharePointRestoreSessions/{sharePointRestoreSession-id}/siteRestoreArtifacts")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSharePointRestoreSessionSiteRestoreArtifact", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteRestoreArtifact))]
    public class NewMgSolutionBackupRestoreSharePointRestoreSessionSiteRestoreArtifactCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SharePointRestoreSessions[SharePointRestoreSessionId].SiteRestoreArtifacts.PostAsync(body, requestConfiguration =>
                {
