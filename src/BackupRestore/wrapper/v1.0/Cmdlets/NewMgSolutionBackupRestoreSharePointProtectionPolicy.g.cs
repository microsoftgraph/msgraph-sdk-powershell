...
{
    [GraphRoute("POST", "/solutions/backupRestore/sharePointProtectionPolicies")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreSharePointProtectionPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SharePointProtectionPolicy))]
    public class NewMgSolutionBackupRestoreSharePointProtectionPolicyCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.SharePointProtectionPolicies.PostAsync(body, requestConfiguration =>
                {
