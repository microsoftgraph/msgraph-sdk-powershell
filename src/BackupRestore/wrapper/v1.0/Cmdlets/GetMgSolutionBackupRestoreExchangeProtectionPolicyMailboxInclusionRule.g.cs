...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class GetMgSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRuleCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? MailboxProtectionRuleId : ExchangeProtectionPolicyId));
                return;
            }
        }
    }
