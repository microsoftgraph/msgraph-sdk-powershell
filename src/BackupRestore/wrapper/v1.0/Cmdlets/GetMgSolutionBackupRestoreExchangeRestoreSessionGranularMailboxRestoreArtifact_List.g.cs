...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreExchangeRestoreSessionGranularMailboxRestoreArtifact_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.GranularMailboxRestoreArtifact))]
    public class GetMgSolutionBackupRestoreExchangeRestoreSessionGranularMailboxRestoreArtifact_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.GranularMailboxRestoreArtifactCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ExchangeRestoreSessions[ExchangeRestoreSessionId].GranularMailboxRestoreArtifacts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ExchangeRestoreSessions[ExchangeRestoreSessionId].GranularMailboxRestoreArtifacts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
