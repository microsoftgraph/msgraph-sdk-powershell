...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreMailboxProtectionUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.MailboxProtectionUnit))]
    public class GetMgSolutionBackupRestoreMailboxProtectionUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.MailboxProtectionUnits.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.MailboxProtectionUnits.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
