...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class RemoveMgSolutionBackupRestoreProtectionPolicyCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ProtectionPolicyBaseId));
                return;
            }
        }
    }
