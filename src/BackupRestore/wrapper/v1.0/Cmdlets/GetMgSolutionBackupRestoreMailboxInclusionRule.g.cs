...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class GetMgSolutionBackupRestoreMailboxInclusionRuleCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? MailboxProtectionRuleId : null);
                return;
            }
        }
    }
