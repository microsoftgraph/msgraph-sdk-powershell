...
{
    [GraphRoute("POST", "/solutions/backupRestore/oneDriveForBusinessRestoreSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreOneDriveForBusinessRestoreSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessRestoreSession))]
    public class NewMgSolutionBackupRestoreOneDriveForBusinessRestoreSessionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessRestoreSession();
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessRestoreSession? result;
            try
            {
                result = client.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.PostAsync(body, requestConfiguration =>
                {
