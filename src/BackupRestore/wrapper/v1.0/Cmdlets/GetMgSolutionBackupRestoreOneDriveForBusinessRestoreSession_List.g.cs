...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreOneDriveForBusinessRestoreSession_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessRestoreSession))]
    public class GetMgSolutionBackupRestoreOneDriveForBusinessRestoreSession_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.OneDriveForBusinessRestoreSessionCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
