...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class UpdateMgSolutionBackupRestorePointCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Tags)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, RestorePointId));
                return;
            }
