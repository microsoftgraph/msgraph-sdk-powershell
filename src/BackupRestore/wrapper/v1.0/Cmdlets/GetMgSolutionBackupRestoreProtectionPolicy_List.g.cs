...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreProtectionPolicy_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionPolicyBase))]
    public class GetMgSolutionBackupRestoreProtectionPolicy_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ProtectionPolicyBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.ProtectionPolicies.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.ProtectionPolicies.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
