...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class GetMgSolutionBackupRestoreOneDriveForBusinessProtectionPolicyDriveProtectionUnit_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DriveProtectionUnitId));
                return;
            }
