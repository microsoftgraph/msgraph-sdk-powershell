...
{
    [GraphRoute("GET", "/solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs")]
    [Cmdlet(VerbsCommon.Get, "MgSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnitsBulkAdditionJob))]
    public class GetMgSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.BackupRestore.Client.Models.SiteProtectionUnitsBulkAdditionJobCollectionResponse? result;
            try
            {
                result = client.Solutions.BackupRestore.SiteProtectionUnitsBulkAdditionJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BackupRestore.SiteProtectionUnitsBulkAdditionJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
