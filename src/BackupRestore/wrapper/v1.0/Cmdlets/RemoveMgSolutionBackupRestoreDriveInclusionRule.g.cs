...
namespace Microsoft.Graph.PowerShell.BackupRestore
{
    ...
    public class RemoveMgSolutionBackupRestoreDriveInclusionRuleCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, DriveProtectionRuleId));
                return;
            }
        }
    }
