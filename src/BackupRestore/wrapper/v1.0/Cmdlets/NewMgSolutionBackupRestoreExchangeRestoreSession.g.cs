...
{
    [GraphRoute("POST", "/solutions/backupRestore/exchangeRestoreSessions")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreExchangeRestoreSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.ExchangeRestoreSession))]
    public class NewMgSolutionBackupRestoreExchangeRestoreSessionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.ExchangeRestoreSessions.PostAsync(body, requestConfiguration =>
                {
