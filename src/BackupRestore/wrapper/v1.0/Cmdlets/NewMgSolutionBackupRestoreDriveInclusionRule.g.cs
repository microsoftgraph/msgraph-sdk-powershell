...
{
    [GraphRoute("POST", "/solutions/backupRestore/driveInclusionRules")]
    [Cmdlet(VerbsCommon.New, "MgSolutionBackupRestoreDriveInclusionRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.BackupRestore.Client.Models.DriveProtectionRule))]
    public class NewMgSolutionBackupRestoreDriveInclusionRuleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BackupRestore.DriveInclusionRules.PostAsync(body, requestConfiguration =>
                {
