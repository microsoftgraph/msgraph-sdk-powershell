...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.actions/restore-mgsitelistactivitylistitemversion
schema: 2.0.0
---

# Restore-MgSiteListActivityListItemVersion
...
### Restore (Default)
```
Restore-MgSiteListActivityListItemVersion -ItemActivityOldId <String> -ListId <String>
 -ListItemVersionId <String> -SiteId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgSiteListActivityListItemVersion -InputObject <ISitesActionsIdentity> [-PassThru] [-Confirm]
