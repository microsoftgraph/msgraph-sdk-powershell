...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupeventattachment
schema: 2.0.0
---
...
```
New-MgGroupEventAttachment -EventId <String> -GroupId <String> [-ContentType <String>] [-Id <String>]
...
### CreateViaIdentity
```
New-MgGroupEventAttachment -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphAttachment>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupEventAttachment -InputObject <IGroupsCalendarIdentity> [-ContentType <String>] [-Id <String>]
 [-IsInline] [-LastModifiedDateTime <DateTime>] [-Name <String>] [-Size <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
