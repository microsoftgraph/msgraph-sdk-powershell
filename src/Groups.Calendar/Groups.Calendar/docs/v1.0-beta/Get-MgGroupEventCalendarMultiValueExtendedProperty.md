...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupEventCalendarMultiValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### Get
```
Get-MgGroupEventCalendarMultiValueExtendedProperty -EventId <String> -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupEventCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
