...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarview
schema: 2.0.0
---
...
```
Update-MgGroupCalendarView -EventId <String> -GroupId <String> [-AddressCity <String>]
 ...
 [-Calendar <IMicrosoftGraphCalendar1>] [-Categories <String[]>] [-ChangeKey <String>]
 ...
 [-Id <String>] [-Importance <String>] [-Instances <IMicrosoftGraphEvent1[]>] [-IsAllDay] [-IsCancelled]
...
### Update3
```
Update-MgGroupCalendarView -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update4
```
Update-MgGroupCalendarView -EventId <String> -EventId1 <String> -GroupId <String>
...
### UpdateExpanded4
```
Update-MgGroupCalendarView -EventId <String> -EventId1 <String> -GroupId <String> [-AddressCity <String>]
 [-AddressCountryOrRegion <String>] [-AddressPostalCode <String>] [-AddressPostOfficeBox <String>]
 [-AddressState <String>] [-AddressStreet <String>] [-AddressType <String>] [-AllowNewTimeProposals]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Attendees <IMicrosoftGraphAttendee1[]>]
 [-BodyContent <String>] [-BodyContentType <String>] [-BodyPreview <String>]
...
### UpdateViaIdentity3
```
Update-MgGroupCalendarView -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupCalendarView -InputObject <IGroupsCalendarIdentity> [-AddressCity <String>]
 [-AddressCountryOrRegion <String>] [-AddressPostalCode <String>] [-AddressPostOfficeBox <String>]
 [-AddressState <String>] [-AddressStreet <String>] [-AddressType <String>] [-AllowNewTimeProposals]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Attendees <IMicrosoftGraphAttendee1[]>]
 [-BodyContent <String>] [-BodyContentType <String>] [-BodyPreview <String>]
