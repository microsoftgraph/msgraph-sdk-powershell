...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupeventsinglevalueextendedproperty
schema: 2.0.0
---
...
```
New-MgGroupEventSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Id <String>]
...
### CreateViaIdentity
```
New-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
 [-Value <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
