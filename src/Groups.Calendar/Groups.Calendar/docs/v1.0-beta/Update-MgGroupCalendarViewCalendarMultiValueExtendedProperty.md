...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarviewcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgGroupCalendarViewCalendarMultiValueExtendedProperty -EventId <String> -GroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarViewCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
