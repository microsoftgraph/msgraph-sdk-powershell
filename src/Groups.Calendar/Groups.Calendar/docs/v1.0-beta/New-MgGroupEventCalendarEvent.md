...
### Create
```
New-MgGroupEventCalendarEvent -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupEventCalendarEvent -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
