...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupeventmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
...
```
Update-MgGroupEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
