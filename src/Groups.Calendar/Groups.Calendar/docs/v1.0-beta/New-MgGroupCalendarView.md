...
### Create3
```
New-MgGroupCalendarView -GroupId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Create5
```
New-MgGroupCalendarView -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
...
### CreateViaIdentity3
```
New-MgGroupCalendarView -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
