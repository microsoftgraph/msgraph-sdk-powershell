...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarviewextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarViewExtension -EventId <String> -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### Get1
```
Get-MgGroupCalendarViewExtension -EventId <String> -ExtensionId <String> -GroupId <String>
...
### GetViaIdentity1
```
Get-MgGroupCalendarViewExtension -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
...
```yaml
Type: System.String
Parameter Sets: Get1, Get3, List, List3
Aliases:
