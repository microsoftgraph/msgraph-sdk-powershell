...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupeventcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgGroupEventCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupEventCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgGroupEventCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
