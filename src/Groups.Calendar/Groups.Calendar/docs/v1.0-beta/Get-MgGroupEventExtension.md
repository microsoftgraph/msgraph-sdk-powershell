...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupEventExtension -EventId <String> -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgGroupEventExtension -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
