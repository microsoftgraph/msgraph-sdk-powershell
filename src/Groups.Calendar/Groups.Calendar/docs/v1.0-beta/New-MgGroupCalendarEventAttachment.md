...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupcalendareventattachment
schema: 2.0.0
---

# New-MgGroupCalendarEventAttachment
...
```
New-MgGroupCalendarEventAttachment -EventId <String> -GroupId <String> [-ContentType <String>] [-Id <String>]
...
### Create1
```
New-MgGroupCalendarEventAttachment -EventId <String> -GroupId <String>
 -BodyParameter <IMicrosoftGraphAttachment> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupCalendarEventAttachment -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgGroupCalendarEventAttachment -InputObject <IGroupsCalendarIdentity> [-ContentType <String>]
