...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendareventmultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgGroupCalendarEventMultiValueExtendedProperty -EventId <String> -GroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
...
```
Update-MgGroupCalendarEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
