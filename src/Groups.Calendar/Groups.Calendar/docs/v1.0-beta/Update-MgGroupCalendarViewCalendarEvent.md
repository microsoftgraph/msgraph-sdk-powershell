...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarviewcalendarevent
schema: 2.0.0
---
...
```
Update-MgGroupCalendarViewCalendarEvent -EventId <String> -EventId1 <String> -GroupId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarViewCalendarEvent -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupCalendarViewCalendarEvent -InputObject <IGroupsCalendarIdentity> [-AddressCity <String>]
