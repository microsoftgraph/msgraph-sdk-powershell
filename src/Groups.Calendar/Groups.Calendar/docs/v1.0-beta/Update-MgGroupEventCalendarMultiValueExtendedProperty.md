...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupeventcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgGroupEventCalendarMultiValueExtendedProperty -EventId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupEventCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
...
```
Update-MgGroupEventCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
