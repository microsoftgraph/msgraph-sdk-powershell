...
### List (Default)
```
Get-MgGroupCalendarViewAttachment -EventId <String> -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarViewAttachment -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
