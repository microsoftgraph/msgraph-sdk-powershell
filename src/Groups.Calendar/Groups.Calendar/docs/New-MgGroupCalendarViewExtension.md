...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupcalendarviewextension
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgGroupCalendarViewExtension -InputObject <IGroupsCalendarIdentity>
...
```
New-MgGroupCalendarViewExtension -InputObject <IGroupsCalendarIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
