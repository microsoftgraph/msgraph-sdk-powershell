...
### List (Default)
```
Get-MgGroupCalendarSingleValueExtendedProperty -GroupId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>]
