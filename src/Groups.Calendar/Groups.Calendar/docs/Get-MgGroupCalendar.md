...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendar
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupCalendar -GroupId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendar -InputObject <IGroupsCalendarIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
