...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupeventsinglevalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
