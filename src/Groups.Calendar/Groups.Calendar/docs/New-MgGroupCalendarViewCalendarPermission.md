...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupcalendarviewcalendarpermission
schema: 2.0.0
---
...
```
New-MgGroupCalendarViewCalendarPermission -EventId <String> -GroupId <String> [-AllowedRoles <String[]>]
...
### Create
```
New-MgGroupCalendarViewCalendarPermission -EventId <String> -GroupId <String>
 -BodyParameter <IMicrosoftGraphCalendarPermission> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupCalendarViewCalendarPermission -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphCalendarPermission> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupCalendarViewCalendarPermission -InputObject <IGroupsCalendarIdentity> [-AllowedRoles <String[]>]
 [-EmailAddressAddress <String>] [-EmailAddressName <String>] [-Id <String>] [-IsInsideOrganization]
 [-IsRemovable] [-Role <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
