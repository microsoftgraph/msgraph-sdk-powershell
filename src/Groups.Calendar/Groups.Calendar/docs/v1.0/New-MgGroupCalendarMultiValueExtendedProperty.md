...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
```
New-MgGroupCalendarMultiValueExtendedProperty -GroupId <String> [-Id <String>] [-Value <String[]>] [-Confirm]
...
### CreateViaIdentity
```
New-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
