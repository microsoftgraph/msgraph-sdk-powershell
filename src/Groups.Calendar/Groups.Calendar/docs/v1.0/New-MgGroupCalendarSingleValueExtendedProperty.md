...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/new-mggroupcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
```
New-MgGroupCalendarSingleValueExtendedProperty -GroupId <String> [-Id <String>] [-Value <String>] [-Confirm]
...
### CreateViaIdentity
```
New-MgGroupCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
