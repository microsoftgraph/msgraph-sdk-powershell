...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarviewcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarViewCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### Get
```
Get-MgGroupCalendarViewCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupCalendarViewCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
