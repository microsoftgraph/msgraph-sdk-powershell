...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarSingleValueExtendedProperty -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
