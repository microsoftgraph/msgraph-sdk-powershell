...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
...
```
Update-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-Id <String>]
