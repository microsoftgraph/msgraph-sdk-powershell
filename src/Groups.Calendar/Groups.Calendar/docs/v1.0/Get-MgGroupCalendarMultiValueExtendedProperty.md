...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarMultiValueExtendedProperty -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgGroupCalendarMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
