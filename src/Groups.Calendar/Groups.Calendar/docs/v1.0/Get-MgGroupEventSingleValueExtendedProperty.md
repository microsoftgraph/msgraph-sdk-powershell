...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventsinglevalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupEventSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgGroupEventSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
