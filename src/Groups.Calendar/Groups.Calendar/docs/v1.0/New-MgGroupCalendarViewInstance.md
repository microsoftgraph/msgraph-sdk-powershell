...
### Create1
```
New-MgGroupCalendarViewInstance -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgGroupCalendarViewInstance -InputObject <IGroupsCalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
