...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupEventCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### Get1
```
Get-MgGroupEventCalendarSingleValueExtendedProperty -EventId <String> -GroupId <String>
...
### GetViaIdentity1
```
Get-MgGroupEventCalendarSingleValueExtendedProperty -InputObject <IGroupsCalendarIdentity>
