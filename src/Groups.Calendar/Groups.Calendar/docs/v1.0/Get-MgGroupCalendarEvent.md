...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupcalendarevent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupCalendarEvent -GroupId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgGroupCalendarEvent -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
