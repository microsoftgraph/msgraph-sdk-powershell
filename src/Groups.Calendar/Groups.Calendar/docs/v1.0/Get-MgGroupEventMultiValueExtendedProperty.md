...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventmultivalueextendedproperty
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupEventMultiValueExtendedProperty -EventId <String> -GroupId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgGroupEventMultiValueExtendedProperty -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
