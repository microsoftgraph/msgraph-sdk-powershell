...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/get-mggroupeventcalendarpermission
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupEventCalendarPermission -EventId <String> -GroupId <String> [-Count] [-ExpandProperty <String[]>]
...
### Get1
```
Get-MgGroupEventCalendarPermission -CalendarPermissionId <String> -EventId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupEventCalendarPermission -InputObject <IGroupsCalendarIdentity> [-ExpandProperty <String[]>]
