...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups.calendar/update-mggroupcalendarviewinstance
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarViewInstance -InputObject <IGroupsCalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
