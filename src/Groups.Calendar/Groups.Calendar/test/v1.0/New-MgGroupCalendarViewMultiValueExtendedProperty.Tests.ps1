...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgGroupCalendarViewMultiValueExtendedProperty.Recording.json'
...
Describe 'New-MgGroupCalendarViewMultiValueExtendedProperty' {
