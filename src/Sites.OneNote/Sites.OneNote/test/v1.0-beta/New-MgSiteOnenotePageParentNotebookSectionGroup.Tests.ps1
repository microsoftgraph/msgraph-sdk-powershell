...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteOnenotePageParentNotebookSectionGroup.Recording.json'
...
Describe 'New-MgSiteOnenotePageParentNotebookSectionGroup' {
