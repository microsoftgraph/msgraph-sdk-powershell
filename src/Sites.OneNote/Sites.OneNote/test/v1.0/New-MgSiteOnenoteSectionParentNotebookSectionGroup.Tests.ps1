...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgSiteOnenoteSectionParentNotebookSectionGroup.Recording.json'
...
Describe 'New-MgSiteOnenoteSectionParentNotebookSectionGroup' {
