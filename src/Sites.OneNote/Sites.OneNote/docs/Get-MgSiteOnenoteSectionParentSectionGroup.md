...
### Get (Default)
```
Get-MgSiteOnenoteSectionParentSectionGroup -OnenoteSectionId <String> -SiteId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
