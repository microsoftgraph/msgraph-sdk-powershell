...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -OnenotePageId <String>
...
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
