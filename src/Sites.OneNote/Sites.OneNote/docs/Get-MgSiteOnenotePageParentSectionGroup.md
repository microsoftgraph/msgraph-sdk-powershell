...
### Get (Default)
```
Get-MgSiteOnenotePageParentSectionGroup -OnenotePageId <String> -SiteId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionGroup -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List
```
Get-MgSiteOnenotePageParentSectionGroup -OnenotePageId <String> -SiteId <String> [-Count] [-Expand <String[]>]
