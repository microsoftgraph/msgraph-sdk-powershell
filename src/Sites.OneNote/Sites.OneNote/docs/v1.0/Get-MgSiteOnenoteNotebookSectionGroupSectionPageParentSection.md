...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotenotebooksectiongroupsectionpageparentsection
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenoteNotebookSectionGroupSectionPageParentSection -NotebookId <String> -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteNotebookSectionGroupSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
