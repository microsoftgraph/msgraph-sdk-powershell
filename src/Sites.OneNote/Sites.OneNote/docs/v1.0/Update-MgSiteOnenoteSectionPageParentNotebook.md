...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionPageParentNotebook -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
