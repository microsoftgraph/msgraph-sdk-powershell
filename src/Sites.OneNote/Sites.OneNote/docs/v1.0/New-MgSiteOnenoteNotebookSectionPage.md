...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
```
New-MgSiteOnenoteNotebookSectionPage -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <ISitesOneNoteIdentity> [-ContentInputFile <String>]
