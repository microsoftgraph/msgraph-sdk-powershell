...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentNotebook -OnenoteSectionId <String> -SiteId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
