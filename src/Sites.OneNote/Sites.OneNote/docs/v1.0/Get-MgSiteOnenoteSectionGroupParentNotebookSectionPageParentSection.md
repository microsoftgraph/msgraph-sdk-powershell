...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupparentnotebooksectionpageparentsection
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentSection -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
