...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePage -SiteId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgSiteOnenotePage -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
