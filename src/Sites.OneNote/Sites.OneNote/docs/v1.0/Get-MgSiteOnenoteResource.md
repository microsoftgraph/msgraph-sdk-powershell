...
### List1 (Default)
```
Get-MgSiteOnenoteResource -SiteId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgSiteOnenoteResource -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
