...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
