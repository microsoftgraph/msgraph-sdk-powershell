...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -OnenotePageId <String>
 -OnenoteSectionId <String> -OnenoteSectionId1 <String> -SectionGroupId <String> -SiteId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
