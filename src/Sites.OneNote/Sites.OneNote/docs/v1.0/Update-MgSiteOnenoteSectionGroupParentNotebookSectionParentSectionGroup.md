...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionParentSectionGroup -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
