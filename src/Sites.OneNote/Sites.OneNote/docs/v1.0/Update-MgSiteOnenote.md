...
```
Update-MgSiteOnenote -SiteId <String> [-Id <String>] [-Notebooks <IMicrosoftGraphNotebook1[]>]
 [-Operations <IMicrosoftGraphOnenoteOperation[]>] [-Pages <IMicrosoftGraphOnenotePage1[]>]
 [-Resources <IMicrosoftGraphOnenoteResource[]>] [-SectionGroups <IMicrosoftGraphSectionGroup1[]>]
 [-Sections <IMicrosoftGraphOnenoteSection1[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update1
```
Update-MgSiteOnenote -SiteId <String> -BodyParameter <IMicrosoftGraphOnenote1> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgSiteOnenote -InputObject <ISitesOneNoteIdentity> -BodyParameter <IMicrosoftGraphOnenote1> [-PassThru]
...
Update-MgSiteOnenote -InputObject <ISitesOneNoteIdentity> [-Id <String>]
 [-Notebooks <IMicrosoftGraphNotebook1[]>] [-Operations <IMicrosoftGraphOnenoteOperation[]>]
 [-Pages <IMicrosoftGraphOnenotePage1[]>] [-Resources <IMicrosoftGraphOnenoteResource[]>]
 [-SectionGroups <IMicrosoftGraphSectionGroup1[]>] [-Sections <IMicrosoftGraphOnenoteSection1[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
BODYPARAMETER <IMicrosoftGraphOnenote1>: onenote
  - `[Id <String>]`: Read-only.
