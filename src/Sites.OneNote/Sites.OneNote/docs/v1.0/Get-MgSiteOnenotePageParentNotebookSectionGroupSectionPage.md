...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### Get
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -OnenotePageId <String> -OnenotePageId1 <String>
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -InputObject <ISitesOneNoteIdentity>
