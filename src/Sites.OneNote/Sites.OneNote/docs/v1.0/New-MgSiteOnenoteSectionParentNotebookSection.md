...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectionparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionParentNotebookSection -OnenoteSectionId <String> -SiteId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenoteSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
