...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentSectionGroup -OnenoteSectionId <String> -SiteId <String>
...
### Update3
```
Update-MgSiteOnenoteSectionParentSectionGroup -OnenoteSectionId <String> -SectionGroupId <String>
...
### UpdateViaIdentity2
```
Update-MgSiteOnenoteSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
