...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsectionpageparentsection
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenoteSectionGroupSectionPageParentSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
