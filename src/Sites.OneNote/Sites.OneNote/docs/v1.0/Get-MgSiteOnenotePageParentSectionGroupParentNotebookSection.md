...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String> -SiteId <String> [-Count]
...
### Get1
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSection -InputObject <ISitesOneNoteIdentity>
