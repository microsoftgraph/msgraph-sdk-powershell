...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionPageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
