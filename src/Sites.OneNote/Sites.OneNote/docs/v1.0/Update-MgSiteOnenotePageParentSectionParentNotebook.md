...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionParentNotebook -OnenotePageId <String> -SiteId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenotePageParentSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
