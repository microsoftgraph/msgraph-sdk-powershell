...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionParentSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
