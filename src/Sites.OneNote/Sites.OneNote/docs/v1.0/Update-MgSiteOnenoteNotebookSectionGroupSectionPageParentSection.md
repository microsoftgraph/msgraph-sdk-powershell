...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPageParentSection -NotebookId <String> -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
