...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -OnenotePageId <String>
...
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
