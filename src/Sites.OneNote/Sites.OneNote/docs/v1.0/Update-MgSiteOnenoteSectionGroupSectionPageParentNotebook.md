...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebook -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
