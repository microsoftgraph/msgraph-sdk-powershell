...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup -OnenotePageId <String>
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup
 -InputObject <ISitesOneNoteIdentity> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm]
