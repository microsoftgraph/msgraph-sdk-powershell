...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -OnenotePageId <String>
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity2
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
