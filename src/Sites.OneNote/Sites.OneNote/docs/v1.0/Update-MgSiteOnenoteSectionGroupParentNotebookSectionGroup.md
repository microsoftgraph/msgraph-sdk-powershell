...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionGroup -SectionGroupId <String> -SectionGroupId1 <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
