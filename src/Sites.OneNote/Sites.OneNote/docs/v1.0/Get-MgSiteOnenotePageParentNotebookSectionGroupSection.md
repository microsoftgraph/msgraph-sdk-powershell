...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -SectionGroupId <String>
...
### Get
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
