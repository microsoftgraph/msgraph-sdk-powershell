...
### List1 (Default)
```
Get-MgSiteOnenotePageParentSectionPage -OnenotePageId <String> -SiteId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentSectionPage -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>]
