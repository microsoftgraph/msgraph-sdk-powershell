...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionParentNotebook -OnenoteSectionId <String>
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionParentNotebook -OnenoteSectionId <String>
 -SectionGroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
