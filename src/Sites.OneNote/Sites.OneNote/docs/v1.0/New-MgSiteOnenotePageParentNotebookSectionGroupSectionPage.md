...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -InputObject <ISitesOneNoteIdentity>
