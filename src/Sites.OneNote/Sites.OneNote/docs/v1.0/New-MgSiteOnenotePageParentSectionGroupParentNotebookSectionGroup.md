...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentSectionGroupParentNotebookSectionGroup -OnenotePageId <String> -SiteId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
