...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -OnenotePageId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
