...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenoteSectionGroupSection -SectionGroupId <String> -SiteId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupSection -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>]
