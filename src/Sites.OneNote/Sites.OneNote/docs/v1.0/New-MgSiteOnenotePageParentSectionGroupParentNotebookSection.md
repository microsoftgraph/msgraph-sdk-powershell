...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentSectionGroupParentNotebookSection -OnenotePageId <String> -SiteId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentSectionGroupParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
