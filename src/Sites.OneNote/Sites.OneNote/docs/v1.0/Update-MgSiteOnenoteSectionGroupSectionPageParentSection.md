...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupsectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupSectionPageParentSection -OnenotePageId <String> -OnenoteSectionId <String>
...
```
Update-MgSiteOnenoteSectionGroupSectionPageParentSection -OnenotePageId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
