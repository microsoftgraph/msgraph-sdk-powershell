...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
