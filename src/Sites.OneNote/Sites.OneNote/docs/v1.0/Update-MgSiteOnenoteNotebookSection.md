...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSection -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
