...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentsectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentSectionGroup -OnenotePageId <String> -SiteId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
