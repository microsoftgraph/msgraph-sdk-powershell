...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenoteSectionGroupSectionParentNotebookSection -OnenoteSectionId <String> -SectionGroupId <String>
...
### Get1
```
Get-MgSiteOnenoteSectionGroupSectionParentNotebookSection -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SectionGroupId <String> -SiteId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity>
