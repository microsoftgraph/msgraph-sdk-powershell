...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### List2 (Default)
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroup -OnenotePageId <String> -SiteId <String> [-Count]
...
### Get2
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroup -OnenotePageId <String> -SectionGroupId <String>
...
### GetViaIdentity2
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
...
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroup -OnenotePageId <String> -SectionGroupId <String>
 -SiteId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
