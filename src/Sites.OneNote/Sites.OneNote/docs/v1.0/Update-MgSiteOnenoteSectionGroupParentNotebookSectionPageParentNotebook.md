...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentNotebook -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
