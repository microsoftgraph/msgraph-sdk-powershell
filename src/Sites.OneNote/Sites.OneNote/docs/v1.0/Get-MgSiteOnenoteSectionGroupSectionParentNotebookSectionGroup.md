...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenoteSectionGroupSectionParentNotebookSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupSectionParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
