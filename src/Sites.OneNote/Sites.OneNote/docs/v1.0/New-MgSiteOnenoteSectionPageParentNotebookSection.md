...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectionpageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionPageParentNotebookSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenoteSectionPageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
