...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupSectionParentNotebookSection -OnenoteSectionId <String> -SectionGroupId <String>
...
```
New-MgSiteOnenoteSectionGroupSectionParentNotebookSection -OnenoteSectionId <String> -SectionGroupId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgSiteOnenoteSectionGroupSectionParentNotebookSection -InputObject <ISitesOneNoteIdentity>
