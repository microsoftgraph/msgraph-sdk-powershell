...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupParentSectionGroup -OnenoteSectionId <String>
 -SectionGroupId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
