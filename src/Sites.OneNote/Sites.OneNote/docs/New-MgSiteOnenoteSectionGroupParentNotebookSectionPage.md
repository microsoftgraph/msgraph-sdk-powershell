...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupParentNotebookSectionPage -OnenoteSectionId <String> -SectionGroupId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
