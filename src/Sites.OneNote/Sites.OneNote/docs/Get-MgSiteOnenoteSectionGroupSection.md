...
### List (Default)
```
Get-MgSiteOnenoteSectionGroupSection -SectionGroupId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupSection -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
