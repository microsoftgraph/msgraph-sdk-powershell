...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupSection -OnenoteSectionId <String> -SectionGroupId <String>
...
### Get
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupSection -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SectionGroupId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
