...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroupParentNotebook -OnenotePageId <String>
