...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String> -SiteId <String>
...
### Update
```
Update-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String>
 -SectionGroupId1 <String> -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru]
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
