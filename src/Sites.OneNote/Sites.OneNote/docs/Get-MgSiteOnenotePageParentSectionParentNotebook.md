...
### Get (Default)
```
Get-MgSiteOnenotePageParentSectionParentNotebook -OnenotePageId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionParentNotebook -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
