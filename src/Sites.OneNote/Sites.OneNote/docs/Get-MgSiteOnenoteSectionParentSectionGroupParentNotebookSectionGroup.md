...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionParentSectionGroupParentNotebookSectionGroup -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
