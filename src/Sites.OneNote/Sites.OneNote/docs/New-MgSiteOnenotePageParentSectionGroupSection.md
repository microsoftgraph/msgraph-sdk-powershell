...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentSectionGroupSection -OnenotePageId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenotePageParentSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
