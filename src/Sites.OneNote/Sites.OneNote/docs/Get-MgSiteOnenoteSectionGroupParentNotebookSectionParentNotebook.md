...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionParentNotebook -OnenoteSectionId <String>
 -SectionGroupId <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
