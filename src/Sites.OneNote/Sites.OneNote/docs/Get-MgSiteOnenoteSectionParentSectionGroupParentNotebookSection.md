...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectionparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionParentSectionGroupParentNotebookSection -OnenoteSectionId <String> -SiteId <String>
...
### Get
```
Get-MgSiteOnenoteSectionParentSectionGroupParentNotebookSection -OnenoteSectionId <String>
 -OnenoteSectionId1 <String> -SiteId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentSectionGroupParentNotebookSection -InputObject <ISitesOneNoteIdentity>
