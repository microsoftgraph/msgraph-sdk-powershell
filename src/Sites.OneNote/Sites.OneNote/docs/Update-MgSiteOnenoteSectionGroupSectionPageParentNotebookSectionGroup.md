...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupsectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebookSectionGroup -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupSectionPageParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
