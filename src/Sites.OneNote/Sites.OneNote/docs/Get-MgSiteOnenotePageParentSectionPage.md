...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentSectionPage -OnenotePageId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgSiteOnenotePageParentSectionPage -OnenotePageId <String> -OnenotePageId1 <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionPage -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
