...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentNotebookSectionGroupParentNotebook -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentNotebookSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
