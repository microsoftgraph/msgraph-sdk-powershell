...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotenotebooksectiongroup
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SiteId <String> [-Count] [-Expand <String[]>]
...
### Get
```
Get-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String> -SectionGroupId1 <String>
...
### GetViaIdentity
```
Get-MgSiteOnenoteNotebookSectionGroup -InputObject <ISitesOneNoteIdentity> [-Expand <String[]>]
...
### List
```
Get-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String> -SiteId <String> [-Count]
