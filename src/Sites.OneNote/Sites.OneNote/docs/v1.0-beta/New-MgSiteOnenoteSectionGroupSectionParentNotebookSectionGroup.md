...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupsectionparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupSectionParentNotebookSectionGroup -OnenoteSectionId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupSectionParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
