...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotenotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteNotebookSectionGroupSection -NotebookId <String> -SectionGroupId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
