...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentSectionGroupParentNotebookSectionGroup -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
