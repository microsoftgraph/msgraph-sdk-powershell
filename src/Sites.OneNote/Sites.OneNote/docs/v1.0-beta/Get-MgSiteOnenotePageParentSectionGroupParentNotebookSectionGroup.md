...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSectionGroup -OnenotePageId <String> -SiteId <String>
...
### Get
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSectionGroup -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSectionGroup -InputObject <ISitesOneNoteIdentity>
