...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionPageParentSection -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
