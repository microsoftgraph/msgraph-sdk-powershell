...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotesectiongroupparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupParentNotebookSection -SectionGroupId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
