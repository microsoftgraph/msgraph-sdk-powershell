...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionPageParentNotebook -NotebookId <String> -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
