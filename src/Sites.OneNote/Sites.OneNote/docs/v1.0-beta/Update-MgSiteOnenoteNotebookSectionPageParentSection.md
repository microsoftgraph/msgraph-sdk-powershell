...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectionpageparentsection
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionPageParentSection -NotebookId <String> -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionPageParentSection -InputObject <ISitesOneNoteIdentity>
