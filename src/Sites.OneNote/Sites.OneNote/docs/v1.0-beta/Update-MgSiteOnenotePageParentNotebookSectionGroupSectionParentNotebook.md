...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSectionParentNotebook -OnenotePageId <String>
...
### UpdateViaIdentity1
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSectionParentNotebook -InputObject <ISitesOneNoteIdentity>
