...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentnotebooksection
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSection -OnenotePageId <String> -SiteId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentNotebookSection -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
