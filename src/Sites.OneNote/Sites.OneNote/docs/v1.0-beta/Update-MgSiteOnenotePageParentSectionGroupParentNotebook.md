...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebook -OnenotePageId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
