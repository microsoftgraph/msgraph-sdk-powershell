...
### List1 (Default)
```
Get-MgSiteOnenoteOperation -SiteId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgSiteOnenoteOperation -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
