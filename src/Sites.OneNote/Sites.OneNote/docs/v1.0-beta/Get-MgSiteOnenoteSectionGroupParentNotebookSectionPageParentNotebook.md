...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentNotebook -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
