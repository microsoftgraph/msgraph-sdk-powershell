...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebook -SectionGroupId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
