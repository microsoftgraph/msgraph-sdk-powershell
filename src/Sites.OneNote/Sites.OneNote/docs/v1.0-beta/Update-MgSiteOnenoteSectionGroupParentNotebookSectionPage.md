...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
