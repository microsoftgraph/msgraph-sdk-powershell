...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -OnenotePageId <String>
