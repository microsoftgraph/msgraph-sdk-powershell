...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupParentSectionGroup -NotebookId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
