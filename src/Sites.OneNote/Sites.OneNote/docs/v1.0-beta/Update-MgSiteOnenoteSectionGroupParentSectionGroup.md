...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionGroupParentSectionGroup -SectionGroupId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
