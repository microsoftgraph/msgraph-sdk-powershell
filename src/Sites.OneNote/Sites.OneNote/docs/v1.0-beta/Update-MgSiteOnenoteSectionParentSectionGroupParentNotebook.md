...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionParentSectionGroupParentNotebook -OnenoteSectionId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
