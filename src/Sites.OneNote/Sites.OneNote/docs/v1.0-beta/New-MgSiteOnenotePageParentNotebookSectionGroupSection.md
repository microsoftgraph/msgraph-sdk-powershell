...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionGroupSection -OnenotePageId <String> -SectionGroupId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentNotebookSectionGroupSection -InputObject <ISitesOneNoteIdentity>
