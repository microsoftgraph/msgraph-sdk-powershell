...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentsectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -OnenotePageId <String>
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook -OnenotePageId <String>
 -SectionGroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm]
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <ISitesOneNoteIdentity> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <ISitesOneNoteIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
