...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### Get
```
Get-MgSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenotePageId1 <String>
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
