...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPage -OnenoteSectionId <String> -SectionGroupId <String>
...
### Get
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
