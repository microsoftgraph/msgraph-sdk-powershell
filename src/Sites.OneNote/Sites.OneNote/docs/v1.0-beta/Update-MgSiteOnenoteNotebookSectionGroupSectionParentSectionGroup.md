...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionParentSectionGroup -NotebookId <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
