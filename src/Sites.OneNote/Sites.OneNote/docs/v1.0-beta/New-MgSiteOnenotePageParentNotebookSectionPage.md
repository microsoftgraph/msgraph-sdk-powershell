...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
 -SiteId <String> [-ContentInputFile <String>] [-ContentUrl <String>] [-CreatedByAppId <String>]
...
```
New-MgSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteOnenotePageParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
