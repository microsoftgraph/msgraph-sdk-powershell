...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotepageparentnotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
