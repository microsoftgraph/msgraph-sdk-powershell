...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/new-mgsiteonenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenoteNotebookSectionParentSectionGroup -NotebookId <String> -OnenoteSectionId <String>
...
### CreateViaIdentity1
```
New-MgSiteOnenoteNotebookSectionParentSectionGroup -InputObject <ISitesOneNoteIdentity>
