...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenotePageId1 <String>
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSectionPage -InputObject <ISitesOneNoteIdentity>
