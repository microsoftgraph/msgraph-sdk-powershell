...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPageParentNotebook -NotebookId <String> -OnenotePageId <String>
...
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPageParentNotebook -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionGroupSectionPageParentNotebook -InputObject <ISitesOneNoteIdentity>
