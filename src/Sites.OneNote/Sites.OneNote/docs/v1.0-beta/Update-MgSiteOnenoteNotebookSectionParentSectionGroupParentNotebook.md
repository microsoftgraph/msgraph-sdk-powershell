...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotenotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentNotebook -NotebookId <String>
...
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentNotebook -NotebookId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionParentSectionGroupParentNotebook -InputObject <ISitesOneNoteIdentity>
