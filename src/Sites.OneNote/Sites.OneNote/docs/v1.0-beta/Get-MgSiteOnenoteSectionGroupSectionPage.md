...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/get-mgsiteonenotesectiongroupsectionpage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteOnenoteSectionGroupSectionPage -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String>
...
### Get
```
Get-MgSiteOnenoteSectionGroupSectionPage -OnenotePageId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupSectionPage -InputObject <ISitesOneNoteIdentity> [-ExpandProperty <String[]>]
