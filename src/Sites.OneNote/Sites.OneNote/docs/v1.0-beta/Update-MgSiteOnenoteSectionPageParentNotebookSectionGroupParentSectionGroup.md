...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenotesectionpageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroupParentSectionGroup -OnenotePageId <String>
...
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroupParentSectionGroup
 -InputObject <ISitesOneNoteIdentity> -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
