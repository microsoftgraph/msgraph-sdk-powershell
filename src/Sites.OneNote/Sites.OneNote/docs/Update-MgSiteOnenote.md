...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.onenote/update-mgsiteonenote
schema: 2.0.0
---
...
```
Update-MgSiteOnenote -SiteId <String> [-Id <String>] [-Notebooks <IMicrosoftGraphNotebook[]>]
...
### Update
```
Update-MgSiteOnenote -SiteId <String> -BodyParameter <IMicrosoftGraphOnenote> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteOnenote -InputObject <ISitesOneNoteIdentity> -BodyParameter <IMicrosoftGraphOnenote> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenote -InputObject <ISitesOneNoteIdentity> [-Id <String>]
