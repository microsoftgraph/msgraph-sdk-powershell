...
Update-MgBetaWindowsUpdatesResourceConnection -ResourceConnectionId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-State <String>] [-Headers <IDictionary>] [-Confirm]
...
```
Update-MgBetaWindowsUpdatesResourceConnection -ResourceConnectionId <String>
 -BodyParameter <IMicrosoftGraphWindowsUpdatesResourceConnection> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
