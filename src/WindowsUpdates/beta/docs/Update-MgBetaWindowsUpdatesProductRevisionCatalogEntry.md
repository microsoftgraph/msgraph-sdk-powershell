...
Update-MgBetaWindowsUpdatesProductRevisionCatalogEntry -ProductId <String> -ProductRevisionId <String>
 [-AdditionalProperties <Hashtable>] [-DeployableUntilDateTime <DateTime>] [-DisplayName <String>]
 [-Id <String>] [-ReleaseDateTime <DateTime>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
...
The date on which the content is no longer available to deploy using the service.
