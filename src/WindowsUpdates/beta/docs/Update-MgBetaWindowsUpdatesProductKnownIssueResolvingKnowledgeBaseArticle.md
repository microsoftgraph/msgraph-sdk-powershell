...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/update-mgbetawindowsupdatesproductknownissueresolvingknowledgebasearticle
schema: 2.0.0
---
...
Update-MgBetaWindowsUpdatesProductKnownIssueResolvingKnowledgeBaseArticle -KnownIssueId <String>
 -ProductId <String> [-AdditionalProperties <Hashtable>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-Url <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgBetaWindowsUpdatesProductKnownIssueResolvingKnowledgeBaseArticle
 -InputObject <IWindowsUpdatesIdentity> [-AdditionalProperties <Hashtable>] [-Id <String>]
