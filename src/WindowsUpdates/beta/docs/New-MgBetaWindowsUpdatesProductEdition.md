...
```
New-MgBetaWindowsUpdatesProductEdition -ProductId <String> [-AdditionalProperties <Hashtable>]
 [-DeviceFamily <String>] [-EndOfServiceDateTime <DateTime>] [-GeneralAvailabilityDateTime <DateTime>]
 [-Id <String>] [-IsInService] [-Name <String>] [-ReleasedName <String>] [-ResponseHeadersVariable <String>]
 [-ServicingPeriods <IMicrosoftGraphWindowsUpdatesServicingPeriod[]>] [-Headers <IDictionary>] [-Confirm]
...
New-MgBetaWindowsUpdatesProductEdition -InputObject <IWindowsUpdatesIdentity>
 ...
 [-ReleasedName <String>] [-ResponseHeadersVariable <String>]
 [-ServicingPeriods <IMicrosoftGraphWindowsUpdatesServicingPeriod[]>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphWindowsUpdatesServicingPeriod[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
