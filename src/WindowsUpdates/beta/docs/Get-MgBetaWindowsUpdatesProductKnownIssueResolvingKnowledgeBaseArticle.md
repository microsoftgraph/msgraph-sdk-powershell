...
### Get (Default)
```
Get-MgBetaWindowsUpdatesProductKnownIssueResolvingKnowledgeBaseArticle -KnownIssueId <String>
...
### GetViaIdentity
```
Get-MgBetaWindowsUpdatesProductKnownIssueResolvingKnowledgeBaseArticle -InputObject <IWindowsUpdatesIdentity>
