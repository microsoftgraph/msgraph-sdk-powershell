...
Update-MgWindowsUpdatesPolicy -UpdatePolicyId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-DeploymentSettings <IMicrosoftGraphWindowsUpdatesDeploymentSettings>] [-Id <String>] [-PassThru] [-Confirm]
...
Update-MgWindowsUpdatesPolicy -UpdatePolicyId <String>
 -BodyParameter <IMicrosoftGraphWindowsUpdatesUpdatePolicy> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
