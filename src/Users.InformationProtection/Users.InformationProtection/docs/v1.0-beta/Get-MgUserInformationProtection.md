...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.informationprotection/get-mguserinformationprotection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserInformationProtection -InputObject <IUsersInformationProtectionIdentity>
