...
### Get (Default)
```
Get-MgUserInformationProtection -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInformationProtection -InputObject <IUsersInformationProtectionIdentity> [-Expand <String[]>]
