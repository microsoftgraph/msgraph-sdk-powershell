...
### List (Default)
```
Get-MgDataPolicyOperationDataPolicyOperationDataPolicyOperation [-Count] [-ExpandProperty <String[]>]
...
```
Get-MgDataPolicyOperationDataPolicyOperationDataPolicyOperation
 -InputObject <IIdentityDataPolicyOperationsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
