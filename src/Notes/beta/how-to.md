# How-To
This document describes how to develop for `Microsoft.Graph.Beta.Notes`.

## Building `Microsoft.Graph.Beta.Notes`
...
## Testing `Microsoft.Graph.Beta.Notes`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.Notes` into the session.
