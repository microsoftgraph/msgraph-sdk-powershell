...
```
New-MgSiteOnenoteNotebookSectionGroup -NotebookId <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mgsiteonenotenotebooksectiongroup](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mgsiteonenotenotebooksectiongroup)
