...
### Create1
```
New-MgSiteOnenotePage -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgSiteOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
...
Read-only.
        \[Links \<IMicrosoftGraphSectionLinks\>\]: sectionLinks
          ...
          \[OneNoteClientUrl \<IMicrosoftGraphExternalLink\>\]: externalLink
          \[OneNoteWebUrl \<IMicrosoftGraphExternalLink\>\]: externalLink
        \[Pages \<IMicrosoftGraphOnenotePage1\[\]\>\]: The collection of pages in the section. 
Read-only.
Nullable.
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mgsiteonenotepage](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mgsiteonenotepage)
