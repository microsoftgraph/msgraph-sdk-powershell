...
### DeleteViaIdentity1
```
Remove-MgSiteOnenoteSection -InputObject <INotesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/remove-mgsiteonenotesection](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/remove-mgsiteonenotesection)
