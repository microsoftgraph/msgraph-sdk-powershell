...
### Create
```
New-MgUserOnenoteSection -UserId <String> -BodyParameter <IMicrosoftGraphOnenoteSection1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mguseronenotesection](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mguseronenotesection)
