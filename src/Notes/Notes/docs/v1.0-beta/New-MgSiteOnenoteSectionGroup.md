...
### Create1
```
New-MgBetaSiteOnenoteSectionGroup -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgBetaSiteOnenoteSectionGroup -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphSectionGroup1>
