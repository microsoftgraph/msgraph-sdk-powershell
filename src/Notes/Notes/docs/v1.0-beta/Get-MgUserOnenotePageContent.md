...
### Get1 (Default)
```
Get-MgBetaUserOnenotePageContent -OnenotePageId <String> -UserId <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaUserOnenotePageContent -InputObject <INotesIdentity> -OutFile <String> [-PassThru] [<CommonParameters>]
```
