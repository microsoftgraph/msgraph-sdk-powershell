...
### Set1 (Default)
```
Set-MgBetaGroupOnenotePageContent -GroupId <String> -OnenotePageId <String> -InFile <String>
 [-BodyParameter <Stream>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgBetaGroupOnenotePageContent -InputObject <INotesIdentity> -InFile <String> [-BodyParameter <Stream>]
