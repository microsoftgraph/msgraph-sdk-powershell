...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenotePageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgSiteOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
