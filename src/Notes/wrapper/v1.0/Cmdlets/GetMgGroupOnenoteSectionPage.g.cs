...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOnenoteSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOnenoteSectionPage_Get or Get-MgGroupOnenoteSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOnenoteSectionPage_Get" : "Get-MgGroupOnenoteSectionPage_List";
            try
            {
