...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/pages/{onenotePage-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenotePage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class GetMgSiteOnenotePage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Pages[OnenotePageId].GetAsync(requestConfiguration =>
                {
