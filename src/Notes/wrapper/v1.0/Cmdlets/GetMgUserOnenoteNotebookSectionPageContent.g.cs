...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteNotebookSectionPageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnenoteNotebookSectionPageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
