...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/pages/{onenotePage-id}/preview()")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgPreviewSiteOnenotePage")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePagePreview))]
    public class InvokeMgPreviewSiteOnenotePageCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Pages[OnenotePageId].Preview.GetAsync(requestConfiguration =>
                {
