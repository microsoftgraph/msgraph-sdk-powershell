...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentSectionGroup")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupSectionParentSectionGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgUserOnenoteSectionGroupSectionParentSectionGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].ParentSectionGroup.GetAsync(requestConfiguration =>
                {
