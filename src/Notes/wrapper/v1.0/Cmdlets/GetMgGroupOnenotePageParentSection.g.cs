...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenotePageParentSection")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgGroupOnenotePageParentSectionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Pages[OnenotePageId].ParentSection.GetAsync(requestConfiguration =>
                {
