...
{
    [GraphRoute("PUT", "/sites/{site-id}/onenote/resources/{onenoteResource-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgSiteOnenoteResourceContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteResource))]
    public class SetMgSiteOnenoteResourceContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Sites[SiteId].Onenote.Resources[OnenoteResourceId].Content.PutAsync(content, requestConfiguration =>
                {
