...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}/sections")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSectionGroupSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteSectionGroupSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteSectionGroupSection_Get or Get-MgSiteOnenoteSectionGroupSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteSectionGroupSection_Get" : "Get-MgSiteOnenoteSectionGroupSection_List";
            try
            {
