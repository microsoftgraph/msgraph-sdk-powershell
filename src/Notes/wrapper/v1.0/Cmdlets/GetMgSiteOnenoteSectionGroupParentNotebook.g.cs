...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSectionGroupParentNotebook")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgSiteOnenoteSectionGroupParentNotebookCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.SectionGroups[SectionGroupId].ParentNotebook.GetAsync(requestConfiguration =>
                {
