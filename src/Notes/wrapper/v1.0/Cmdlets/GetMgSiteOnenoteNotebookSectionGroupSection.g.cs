...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSectionGroupSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteNotebookSectionGroupSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteNotebookSectionGroupSection_Get or Get-MgSiteOnenoteNotebookSectionGroupSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteNotebookSectionGroupSection_Get" : "Get-MgSiteOnenoteNotebookSectionGroupSection_List";
            try
            {
