...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/sections/{onenoteSection-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSection_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgGroupOnenoteSection_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Sections[OnenoteSectionId].GetAsync(requestConfiguration =>
                {
