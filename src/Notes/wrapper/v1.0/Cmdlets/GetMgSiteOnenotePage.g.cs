...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenotePage", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenotePageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenotePage_Get or Get-MgSiteOnenotePage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenotePage_Get" : "Get-MgSiteOnenotePage_List";
            try
            {
