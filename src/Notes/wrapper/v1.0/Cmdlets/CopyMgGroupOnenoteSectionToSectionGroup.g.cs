...
{
    [GraphRoute("POST", "/groups/{group-id}/onenote/sections/{onenoteSection-id}/copyToSectionGroup")]
    [Cmdlet(VerbsCommon.Copy, "MgGroupOnenoteSectionToSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class CopyMgGroupOnenoteSectionToSectionGroupCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Notes.Client.Groups.Item.Onenote.Sections.Item.CopyToSectionGroup.CopyToSectionGroupPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Sections[OnenoteSectionId].CopyToSectionGroup.PostAsync(body, requestConfiguration =>
                {
