...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/resources")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteResource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteResource))]
    public class GetMgSiteOnenoteResource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteResourceCollectionResponse? result;
            try
            {
                result = client.Sites[SiteId].Onenote.Resources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Sites[SiteId].Onenote.Resources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
