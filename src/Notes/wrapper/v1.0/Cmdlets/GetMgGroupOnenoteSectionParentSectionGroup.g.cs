...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSectionParentSectionGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgGroupOnenoteSectionParentSectionGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Sections[OnenoteSectionId].ParentSectionGroup.GetAsync(requestConfiguration =>
                {
