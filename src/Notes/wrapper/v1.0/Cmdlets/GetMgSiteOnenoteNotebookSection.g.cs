...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteNotebookSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteNotebookSection_Get or Get-MgSiteOnenoteNotebookSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteNotebookSection_Get" : "Get-MgSiteOnenoteNotebookSection_List";
            try
            {
