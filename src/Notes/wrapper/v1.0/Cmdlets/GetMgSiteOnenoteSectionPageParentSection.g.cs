...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSectionPageParentSection")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgSiteOnenoteSectionPageParentSectionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Sections[OnenoteSectionId].Pages[OnenotePageId].ParentSection.GetAsync(requestConfiguration =>
                {
