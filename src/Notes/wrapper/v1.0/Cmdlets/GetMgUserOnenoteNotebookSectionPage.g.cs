...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteNotebookSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOnenoteNotebookSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOnenoteNotebookSectionPage_Get or Get-MgUserOnenoteNotebookSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnenoteNotebookSectionPage_Get" : "Get-MgUserOnenoteNotebookSectionPage_List";
            try
            {
