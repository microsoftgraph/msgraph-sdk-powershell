...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOnenoteSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOnenoteSectionPage_Get or Get-MgUserOnenoteSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnenoteSectionPage_Get" : "Get-MgUserOnenoteSectionPage_List";
            try
            {
