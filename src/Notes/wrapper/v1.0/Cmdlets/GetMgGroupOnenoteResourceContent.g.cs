...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/resources/{onenoteResource-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteResourceContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgGroupOnenoteResourceContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Resources[OnenoteResourceId].Content.GetAsync(requestConfiguration =>
                {
