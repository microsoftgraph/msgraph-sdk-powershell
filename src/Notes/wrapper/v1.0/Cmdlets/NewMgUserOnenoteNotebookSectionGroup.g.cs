...
{
    [GraphRoute("POST", "/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups")]
    [Cmdlet(VerbsCommon.New, "MgUserOnenoteNotebookSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class NewMgUserOnenoteNotebookSectionGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Notebooks[NotebookId].SectionGroups.PostAsync(body, requestConfiguration =>
                {
