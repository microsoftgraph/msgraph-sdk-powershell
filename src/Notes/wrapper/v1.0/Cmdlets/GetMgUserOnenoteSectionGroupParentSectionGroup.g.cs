...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentSectionGroup")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupParentSectionGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgUserOnenoteSectionGroupParentSectionGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.SectionGroups[SectionGroupId].ParentSectionGroup.GetAsync(requestConfiguration =>
                {
