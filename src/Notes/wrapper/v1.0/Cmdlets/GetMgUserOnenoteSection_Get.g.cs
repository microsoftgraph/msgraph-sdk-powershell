...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sections/{onenoteSection-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSection_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgUserOnenoteSection_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Sections[OnenoteSectionId].GetAsync(requestConfiguration =>
                {
