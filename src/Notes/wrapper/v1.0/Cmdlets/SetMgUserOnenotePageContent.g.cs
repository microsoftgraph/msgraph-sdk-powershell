...
{
    [GraphRoute("PUT", "/users/{user-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgUserOnenotePageContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class SetMgUserOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Users[UserId].Onenote.Pages[OnenotePageId].Content.PutAsync(content, requestConfiguration =>
                {
