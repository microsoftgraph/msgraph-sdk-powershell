...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionParentSectionGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgUserOnenoteSectionParentSectionGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Sections[OnenoteSectionId].ParentSectionGroup.GetAsync(requestConfiguration =>
                {
