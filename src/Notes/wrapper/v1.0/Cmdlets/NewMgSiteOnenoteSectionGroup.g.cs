...
{
    [GraphRoute("POST", "/sites/{site-id}/onenote/sectionGroups")]
    [Cmdlet(VerbsCommon.New, "MgSiteOnenoteSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class NewMgSiteOnenoteSectionGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.SectionGroups.PostAsync(body, requestConfiguration =>
                {
