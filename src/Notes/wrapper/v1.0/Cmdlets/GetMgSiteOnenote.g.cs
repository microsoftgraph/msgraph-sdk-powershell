...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenote")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Onenote))]
    public class GetMgSiteOnenoteCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.GetAsync(requestConfiguration =>
                {
