...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenotePageParentNotebook")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgGroupOnenotePageParentNotebookCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Pages[OnenotePageId].ParentNotebook.GetAsync(requestConfiguration =>
                {
