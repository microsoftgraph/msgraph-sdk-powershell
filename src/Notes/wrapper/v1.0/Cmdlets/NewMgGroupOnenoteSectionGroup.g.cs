...
{
    [GraphRoute("POST", "/groups/{group-id}/onenote/sectionGroups")]
    [Cmdlet(VerbsCommon.New, "MgGroupOnenoteSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class NewMgGroupOnenoteSectionGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.SectionGroups.PostAsync(body, requestConfiguration =>
                {
