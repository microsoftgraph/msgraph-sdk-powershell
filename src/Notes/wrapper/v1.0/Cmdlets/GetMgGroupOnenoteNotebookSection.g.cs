...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/notebooks/{notebook-id}/sections")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOnenoteNotebookSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOnenoteNotebookSection_Get or Get-MgGroupOnenoteNotebookSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOnenoteNotebookSection_Get" : "Get-MgGroupOnenoteNotebookSection_List";
            try
            {
