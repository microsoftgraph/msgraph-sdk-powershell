...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/pages/{onenotePage-id}/preview()")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgPreviewGroupOnenotePage")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePagePreview))]
    public class InvokeMgPreviewGroupOnenotePageCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Pages[OnenotePageId].Preview.GetAsync(requestConfiguration =>
                {
