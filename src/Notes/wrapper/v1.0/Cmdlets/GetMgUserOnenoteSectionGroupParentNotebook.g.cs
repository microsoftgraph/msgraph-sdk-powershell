...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupParentNotebook")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgUserOnenoteSectionGroupParentNotebookCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.SectionGroups[SectionGroupId].ParentNotebook.GetAsync(requestConfiguration =>
                {
