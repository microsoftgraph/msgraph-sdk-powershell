...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/pages/{onenotePage-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenotePage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class GetMgUserOnenotePage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Pages[OnenotePageId].GetAsync(requestConfiguration =>
                {
