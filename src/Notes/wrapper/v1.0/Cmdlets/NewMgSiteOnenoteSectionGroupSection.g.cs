...
{
    [GraphRoute("POST", "/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}/sections")]
    [Cmdlet(VerbsCommon.New, "MgSiteOnenoteSectionGroupSection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class NewMgSiteOnenoteSectionGroupSectionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Links)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.SectionGroups[SectionGroupId].Sections.PostAsync(body, requestConfiguration =>
                {
