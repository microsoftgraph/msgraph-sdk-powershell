...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/preview()")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgPreviewUserOnenoteNotebookSectionPage")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePagePreview))]
    public class InvokeMgPreviewUserOnenoteNotebookSectionPageCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].Pages[OnenotePageId].Preview.GetAsync(requestConfiguration =>
                {
