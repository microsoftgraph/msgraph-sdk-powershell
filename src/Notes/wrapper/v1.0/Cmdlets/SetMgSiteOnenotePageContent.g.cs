...
{
    [GraphRoute("PUT", "/sites/{site-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Set, "MgSiteOnenotePageContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class SetMgSiteOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                ...
                result = client.Sites[SiteId].Onenote.Pages[OnenotePageId].Content.PutAsync(content, requestConfiguration =>
                {
