...
{
    [GraphRoute("POST", "/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/copyToSection")]
    [Cmdlet(VerbsCommon.Copy, "MgSiteOnenoteSectionPageToSection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class CopyMgSiteOnenoteSectionPageToSectionCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Notes.Client.Sites.Item.Onenote.Sections.Item.Pages.Item.CopyToSection.CopyToSectionPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId1)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Sections[OnenoteSectionId].Pages[OnenotePageId].CopyToSection.PostAsync(body, requestConfiguration =>
                {
