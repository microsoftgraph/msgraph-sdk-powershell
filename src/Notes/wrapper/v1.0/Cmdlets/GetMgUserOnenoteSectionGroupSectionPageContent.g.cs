...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupSectionPageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnenoteSectionGroupSectionPageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
