...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSectionGroupSectionPage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class GetMgGroupOnenoteSectionGroupSectionPage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].Pages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].Pages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
