...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/resources/{onenoteResource-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteResource_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteResource))]
    public class GetMgGroupOnenoteResource_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Resources[OnenoteResourceId].GetAsync(requestConfiguration =>
                {
