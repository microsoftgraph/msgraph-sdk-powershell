...
{
    [GraphRoute("GET", "/users/{user-id}/onenote")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenote")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Onenote))]
    public class GetMgUserOnenoteCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.GetAsync(requestConfiguration =>
                {
