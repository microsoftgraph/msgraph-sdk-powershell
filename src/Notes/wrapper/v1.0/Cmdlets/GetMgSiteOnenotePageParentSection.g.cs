...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/pages/{onenotePage-id}/parentSection")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenotePageParentSection")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgSiteOnenotePageParentSectionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Pages[OnenotePageId].ParentSection.GetAsync(requestConfiguration =>
                {
