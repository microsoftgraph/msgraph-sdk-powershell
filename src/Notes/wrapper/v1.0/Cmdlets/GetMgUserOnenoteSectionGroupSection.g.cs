...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOnenoteSectionGroupSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOnenoteSectionGroupSection_Get or Get-MgUserOnenoteSectionGroupSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnenoteSectionGroupSection_Get" : "Get-MgUserOnenoteSectionGroupSection_List";
            try
            {
