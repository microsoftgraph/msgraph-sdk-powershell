...
{
    [GraphRoute("POST", "/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/copyToSectionGroup")]
    [Cmdlet(VerbsCommon.Copy, "MgGroupOnenoteSectionGroupSectionToSectionGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class CopyMgGroupOnenoteSectionGroupSectionToSectionGroupCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Notes.Client.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup.CopyToSectionGroupPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].CopyToSectionGroup.PostAsync(body, requestConfiguration =>
                {
