...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteNotebookSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteNotebookSectionPage_Get or Get-MgSiteOnenoteNotebookSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteNotebookSectionPage_Get" : "Get-MgSiteOnenoteNotebookSectionPage_List";
            try
            {
