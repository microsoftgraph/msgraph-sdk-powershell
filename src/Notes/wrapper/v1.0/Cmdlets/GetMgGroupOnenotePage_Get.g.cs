...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/pages/{onenotePage-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenotePage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class GetMgGroupOnenotePage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Pages[OnenotePageId].GetAsync(requestConfiguration =>
                {
