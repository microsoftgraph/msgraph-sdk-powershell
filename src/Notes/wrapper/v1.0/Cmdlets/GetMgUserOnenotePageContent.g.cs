...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenotePageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
