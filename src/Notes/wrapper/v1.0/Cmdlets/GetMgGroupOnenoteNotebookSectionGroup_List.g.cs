...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgGroupOnenoteNotebookSectionGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroupCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Onenote.Notebooks[NotebookId].SectionGroups.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Onenote.Notebooks[NotebookId].SectionGroups.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
