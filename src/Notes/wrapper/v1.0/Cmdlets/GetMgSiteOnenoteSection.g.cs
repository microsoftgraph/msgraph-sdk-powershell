...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteSection_Get or Get-MgSiteOnenoteSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteSection_Get" : "Get-MgSiteOnenoteSection_List";
            try
            {
