...
{
    [GraphRoute("POST", "/sites/{site-id}/onenote/pages")]
    [Cmdlet(VerbsCommon.New, "MgSiteOnenotePage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class NewMgSiteOnenotePageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Links)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Pages.PostAsync(body, requestConfiguration =>
                {
