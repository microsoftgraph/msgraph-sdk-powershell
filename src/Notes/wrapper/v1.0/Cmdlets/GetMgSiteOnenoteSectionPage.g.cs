...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteSectionPage_Get or Get-MgSiteOnenoteSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteSectionPage_Get" : "Get-MgSiteOnenoteSectionPage_List";
            try
            {
