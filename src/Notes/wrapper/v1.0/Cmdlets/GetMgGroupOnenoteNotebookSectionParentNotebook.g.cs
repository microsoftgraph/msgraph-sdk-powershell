...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentNotebook")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionParentNotebook")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgGroupOnenoteNotebookSectionParentNotebookCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].ParentNotebook.GetAsync(requestConfiguration =>
                {
