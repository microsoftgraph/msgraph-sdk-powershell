...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    public class GetMgUserOnenoteNotebookSectionGroupSectionPageCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOnenoteNotebookSectionGroupSectionPage_Get" : "Get-MgUserOnenoteNotebookSectionGroupSectionPage_List";
            try
            {
