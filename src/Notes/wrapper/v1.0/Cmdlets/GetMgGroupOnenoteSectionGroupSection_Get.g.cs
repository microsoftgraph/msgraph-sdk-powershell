...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSectionGroupSection_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgGroupOnenoteSectionGroupSection_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].GetAsync(requestConfiguration =>
                {
