...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteNotebookSectionGroupSectionPageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserOnenoteNotebookSectionGroupSectionPageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Notebooks[NotebookId].SectionGroups[SectionGroupId].Sections[OnenoteSectionId].Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
