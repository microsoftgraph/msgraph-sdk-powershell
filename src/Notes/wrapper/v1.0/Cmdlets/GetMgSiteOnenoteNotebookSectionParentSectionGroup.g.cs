...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSectionParentSectionGroup")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgSiteOnenoteNotebookSectionParentSectionGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].ParentSectionGroup.GetAsync(requestConfiguration =>
                {
