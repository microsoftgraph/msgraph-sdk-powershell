...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteSectionPageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgGroupOnenoteSectionPageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Sections[OnenoteSectionId].Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
