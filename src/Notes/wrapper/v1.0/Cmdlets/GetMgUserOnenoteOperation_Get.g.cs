...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/operations/{onenoteOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class GetMgUserOnenoteOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Operations[OnenoteOperationId].GetAsync(requestConfiguration =>
                {
