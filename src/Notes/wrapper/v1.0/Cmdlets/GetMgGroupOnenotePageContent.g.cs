...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/pages/{onenotePage-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenotePageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgGroupOnenotePageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Pages[OnenotePageId].Content.GetAsync(requestConfiguration =>
                {
