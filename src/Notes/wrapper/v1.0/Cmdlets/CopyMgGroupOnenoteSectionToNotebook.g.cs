...
{
    [GraphRoute("POST", "/groups/{group-id}/onenote/sections/{onenoteSection-id}/copyToNotebook")]
    [Cmdlet(VerbsCommon.Copy, "MgGroupOnenoteSectionToNotebook", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class CopyMgGroupOnenoteSectionToNotebookCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Notes.Client.Groups.Item.Onenote.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(SiteId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Sections[OnenoteSectionId].CopyToNotebook.PostAsync(body, requestConfiguration =>
                {
