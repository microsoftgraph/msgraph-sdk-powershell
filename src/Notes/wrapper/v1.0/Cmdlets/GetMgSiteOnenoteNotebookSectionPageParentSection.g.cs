...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSectionPageParentSection")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgSiteOnenoteNotebookSectionPageParentSectionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].Pages[OnenotePageId].ParentSection.GetAsync(requestConfiguration =>
                {
