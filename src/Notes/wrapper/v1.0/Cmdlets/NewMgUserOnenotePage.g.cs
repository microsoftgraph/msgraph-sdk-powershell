...
{
    [GraphRoute("POST", "/users/{user-id}/onenote/pages")]
    [Cmdlet(VerbsCommon.New, "MgUserOnenotePage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenotePage))]
    public class NewMgUserOnenotePageCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Links)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.Pages.PostAsync(body, requestConfiguration =>
                {
