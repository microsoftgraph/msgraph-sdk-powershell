...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/operations/{onenoteOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class GetMgGroupOnenoteOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Operations[OnenoteOperationId].GetAsync(requestConfiguration =>
                {
