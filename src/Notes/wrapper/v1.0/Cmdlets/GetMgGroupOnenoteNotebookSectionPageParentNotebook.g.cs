...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentNotebook")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionPageParentNotebook")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgGroupOnenoteNotebookSectionPageParentNotebookCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].Pages[OnenotePageId].ParentNotebook.GetAsync(requestConfiguration =>
                {
