...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/operations/{onenoteOperation-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteOperation_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteOperation))]
    public class GetMgSiteOnenoteOperation_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Operations[OnenoteOperationId].GetAsync(requestConfiguration =>
                {
