...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebook_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Notebook))]
    public class GetMgSiteOnenoteNotebook_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Notebooks[NotebookId].GetAsync(requestConfiguration =>
                {
