...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSectionGroupSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgSiteOnenoteNotebookSectionGroupSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgSiteOnenoteNotebookSectionGroupSectionPage_Get or Get-MgSiteOnenoteNotebookSectionGroupSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgSiteOnenoteNotebookSectionGroupSectionPage_Get" : "Get-MgSiteOnenoteNotebookSectionGroupSectionPage_List";
            try
            {
