...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOnenoteNotebookSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOnenoteNotebookSectionPage_Get or Get-MgGroupOnenoteNotebookSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOnenoteNotebookSectionPage_Get" : "Get-MgGroupOnenoteNotebookSectionPage_List";
            try
            {
