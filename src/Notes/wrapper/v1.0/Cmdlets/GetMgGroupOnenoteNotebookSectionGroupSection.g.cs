...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionGroupSection", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOnenoteNotebookSectionGroupSectionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOnenoteNotebookSectionGroupSection_Get or Get-MgGroupOnenoteNotebookSectionGroupSection_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOnenoteNotebookSectionGroupSection_Get" : "Get-MgGroupOnenoteNotebookSectionGroupSection_List";
            try
            {
