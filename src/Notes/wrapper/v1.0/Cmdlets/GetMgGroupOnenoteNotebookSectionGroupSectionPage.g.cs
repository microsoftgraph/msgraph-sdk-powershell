...
namespace Microsoft.Graph.PowerShell.Notes
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenoteNotebookSectionGroupSectionPage", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupOnenoteNotebookSectionGroupSectionPageCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupOnenoteNotebookSectionGroupSectionPage_Get or Get-MgGroupOnenoteNotebookSectionGroupSectionPage_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupOnenoteNotebookSectionGroupSectionPage_Get" : "Get-MgGroupOnenoteNotebookSectionGroupSectionPage_List";
            try
            {
