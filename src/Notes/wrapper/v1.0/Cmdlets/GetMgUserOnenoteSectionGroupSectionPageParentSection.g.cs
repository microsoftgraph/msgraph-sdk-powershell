...
{
    [GraphRoute("GET", "/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnenoteSectionGroupSectionPageParentSection")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgUserOnenoteSectionGroupSectionPageParentSectionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Onenote.SectionGroups[SectionGroupId].Sections[OnenoteSectionId].Pages[OnenotePageId].ParentSection.GetAsync(requestConfiguration =>
                {
