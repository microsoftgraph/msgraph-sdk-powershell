...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteSectionGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.SectionGroup))]
    public class GetMgSiteOnenoteSectionGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.SectionGroups[SectionGroupId].GetAsync(requestConfiguration =>
                {
