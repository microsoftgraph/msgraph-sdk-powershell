...
{
    [GraphRoute("GET", "/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}")]
    [Cmdlet(VerbsCommon.Get, "MgSiteOnenoteNotebookSection_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.OnenoteSection))]
    public class GetMgSiteOnenoteNotebookSection_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Sites[SiteId].Onenote.Notebooks[NotebookId].Sections[OnenoteSectionId].GetAsync(requestConfiguration =>
                {
