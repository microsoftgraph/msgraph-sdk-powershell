...
{
    [GraphRoute("GET", "/groups/{group-id}/onenote")]
    [Cmdlet(VerbsCommon.Get, "MgGroupOnenote")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Notes.Client.Models.Onenote))]
    public class GetMgGroupOnenoteCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Onenote.GetAsync(requestConfiguration =>
                {
