...
### Delete (Default)
```
Remove-MgUserOnenotePage -OnenotePageId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserOnenotePage -InputObject <INotesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
