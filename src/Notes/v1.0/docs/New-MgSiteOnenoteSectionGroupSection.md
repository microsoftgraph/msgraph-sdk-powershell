...
New-MgSiteOnenoteSectionGroupSection -SectionGroupId <String> -SiteId <String>
 ...
 [-ParentSectionGroup <IMicrosoftGraphSectionGroup>] [-Self <String>] [-Headers <IDictionary>] [-Confirm]
...
```
New-MgSiteOnenoteSectionGroupSection -SectionGroupId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgSiteOnenoteSectionGroupSection -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Self <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
