...
### Get (Default)
```
Get-MgEducationMeAssignmentRubricByRef -EducationAssignmentId <String> [-Headers <IDictionary>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationMeAssignmentRubricByRef -InputObject <IEducationIdentity> [-Headers <IDictionary>]
 [<CommonParameters>]
```
