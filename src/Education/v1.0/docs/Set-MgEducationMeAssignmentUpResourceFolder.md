...
### Set (Default)
```
Set-MgEducationMeAssignmentUpResourceFolder -EducationAssignmentId <String> [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgEducationMeAssignmentUpResourceFolder -InputObject <IEducationIdentity> [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
