...
### Activate (Default)
```
Initialize-MgBetaEducationMeAssignment -EducationAssignmentId <String> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaEducationMeAssignment -InputObject <IEducationIdentity> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
