...
### List (Default)
```
Get-MgBetaEducationClassAssignmentSettingGradingScheme -EducationClassId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaEducationClassAssignmentSettingGradingScheme -EducationClassId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationClassAssignmentSettingGradingScheme -InputObject <IEducationIdentity>
