...
### Delta (Default)
```
Get-MgBetaEducationUserAssignmentDelta -EducationUserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaEducationUserAssignmentDelta -InputObject <IEducationIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
