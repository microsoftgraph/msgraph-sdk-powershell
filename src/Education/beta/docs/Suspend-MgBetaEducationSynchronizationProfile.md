...
### Pause (Default)
```
Suspend-MgBetaEducationSynchronizationProfile -EducationSynchronizationProfileId <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PauseViaIdentity
```
Suspend-MgBetaEducationSynchronizationProfile -InputObject <IEducationIdentity> [-PassThru] [-Confirm]
