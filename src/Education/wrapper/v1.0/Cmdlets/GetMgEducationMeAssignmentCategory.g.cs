...
{
    [GraphRoute("GET", "/education/me/assignments/{educationAssignment-id}/categories")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeAssignmentCategory")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationCategory))]
    public class GetMgEducationMeAssignmentCategoryCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Assignments[EducationAssignmentId].Categories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Me.Assignments[EducationAssignmentId].Categories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
