...
{
    [GraphRoute("GET", "/education/me/classes/{educationClass-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeClass_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationClass))]
    public class GetMgEducationMeClass_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Classes[EducationClassId].GetAsync(requestConfiguration =>
                {
