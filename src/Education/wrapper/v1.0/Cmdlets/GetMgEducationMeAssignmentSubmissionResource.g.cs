...
{
    [GraphRoute("GET", "/education/me/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/resources")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeAssignmentSubmissionResource", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationMeAssignmentSubmissionResourceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationMeAssignmentSubmissionResource_Get or Get-MgEducationMeAssignmentSubmissionResource_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationMeAssignmentSubmissionResource_Get" : "Get-MgEducationMeAssignmentSubmissionResource_List";
            try
            {
