...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/members/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassMemberByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationClassMemberByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Members.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Members.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
