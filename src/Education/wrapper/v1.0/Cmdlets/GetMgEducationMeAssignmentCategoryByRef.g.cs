...
{
    [GraphRoute("GET", "/education/me/assignments/{educationAssignment-id}/categories/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeAssignmentCategoryByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationMeAssignmentCategoryByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Assignments[EducationAssignmentId].Categories.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Me.Assignments[EducationAssignmentId].Categories.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
