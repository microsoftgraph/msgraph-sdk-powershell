...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentSettingGradingScheme_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationGradingScheme))]
    public class GetMgEducationClassAssignmentSettingGradingScheme_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationGradingSchemeCollectionResponse? result;
            try
            {
                result = client.Education.Classes[EducationClassId].AssignmentSettings.GradingSchemes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].AssignmentSettings.GradingSchemes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
