...
{
    [GraphRoute("GET", "/education/schools/{educationSchool-id}/users/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationSchoolUserByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationSchoolUserByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Schools[EducationSchoolId].Users.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Schools[EducationSchoolId].Users.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
