...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentResource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationAssignmentResource))]
    public class GetMgEducationUserAssignmentResource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Resources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Resources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
