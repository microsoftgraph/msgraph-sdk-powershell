...
{
    [GraphRoute("GET", "/education/me/user/serviceProvisioningErrors")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeUserServiceProvisioningError")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ServiceProvisioningError))]
    public class GetMgEducationMeUserServiceProvisioningErrorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.User.ServiceProvisioningErrors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Me.User.ServiceProvisioningErrors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
