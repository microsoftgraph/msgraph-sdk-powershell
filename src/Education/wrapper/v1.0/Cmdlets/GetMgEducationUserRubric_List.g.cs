...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/rubrics")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserRubric_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationRubric))]
    public class GetMgEducationUserRubric_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationRubricCollectionResponse? result;
            try
            {
                result = client.Education.Users[EducationUserId].Rubrics.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Rubrics.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
