...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/teachers/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassTeacherByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationClassTeacherByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Teachers.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Teachers.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
