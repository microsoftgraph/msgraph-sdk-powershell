...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/classes")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserClass_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationClass))]
    public class GetMgEducationUserClass_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationClassCollectionResponse? result;
            try
            {
                result = client.Education.Users[EducationUserId].Classes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Classes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
