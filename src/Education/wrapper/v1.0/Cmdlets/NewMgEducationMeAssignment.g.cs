...
{
    [GraphRoute("POST", "/education/me/assignments")]
    [Cmdlet(VerbsCommon.New, "MgEducationMeAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationAssignment))]
    public class NewMgEducationMeAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Instructions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Assignments.PostAsync(body, requestConfiguration =>
                {
