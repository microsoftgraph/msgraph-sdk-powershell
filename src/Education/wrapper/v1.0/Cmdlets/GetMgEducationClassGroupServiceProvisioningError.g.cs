...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/group/serviceProvisioningErrors")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassGroupServiceProvisioningError")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ServiceProvisioningError))]
    public class GetMgEducationClassGroupServiceProvisioningErrorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.ServiceProvisioningErrorCollectionResponse? result;
            try
            {
                result = client.Education.Classes[EducationClassId].Group.ServiceProvisioningErrors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Group.ServiceProvisioningErrors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
