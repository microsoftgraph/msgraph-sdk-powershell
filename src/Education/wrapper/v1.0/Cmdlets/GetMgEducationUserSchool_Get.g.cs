...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/schools/{educationSchool-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserSchool_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class GetMgEducationUserSchool_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users[EducationUserId].Schools[EducationSchoolId].GetAsync(requestConfiguration =>
                {
