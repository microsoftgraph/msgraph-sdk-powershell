...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/schools/{educationSchool-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassSchool_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class GetMgEducationClassSchool_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Schools[EducationSchoolId].GetAsync(requestConfiguration =>
                {
