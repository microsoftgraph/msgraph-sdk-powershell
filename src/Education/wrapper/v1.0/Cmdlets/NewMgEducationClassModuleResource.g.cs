...
{
    [GraphRoute("POST", "/education/classes/{educationClass-id}/modules/{educationModule-id}/resources")]
    [Cmdlet(VerbsCommon.New, "MgEducationClassModuleResource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationModuleResource))]
    public class NewMgEducationClassModuleResourceCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(EducationModuleId, "New"))
                return;
    ...
    if (this.IsParameterBound(nameof(Resource)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Modules[EducationModuleId].Resources.PostAsync(body, requestConfiguration =>
                {
