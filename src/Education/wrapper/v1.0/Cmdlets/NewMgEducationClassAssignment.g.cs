...
{
    [GraphRoute("POST", "/education/classes/{educationClass-id}/assignments")]
    [Cmdlet(VerbsCommon.New, "MgEducationClassAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationAssignment))]
    public class NewMgEducationClassAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Instructions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Assignments.PostAsync(body, requestConfiguration =>
                {
