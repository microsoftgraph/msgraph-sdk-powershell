...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class GetMgEducationMeAssignmentCategoryDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Education.Client.Education.Me.Assignments.Item.Categories.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Education.Me.Assignments[EducationAssignmentId].Categories.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Education.Me.Assignments[EducationAssignmentId].Categories.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
