...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationMeAssignmentCategoryDelta")]
    ...
    public class GetMgEducationMeAssignmentCategoryDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Assignments[EducationAssignmentId].Categories.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
