...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationReportReadingAssignmentSubmission_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ReadingAssignmentSubmission))]
    public class GetMgEducationReportReadingAssignmentSubmission_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.ReadingAssignmentSubmissionCollectionResponse? result;
            try
            {
                result = client.Education.Reports.ReadingAssignmentSubmissions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Reports.ReadingAssignmentSubmissions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
