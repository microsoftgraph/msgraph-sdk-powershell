...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationReportReadingCoachPassage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ReadingCoachPassage))]
    public class GetMgEducationReportReadingCoachPassage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.ReadingCoachPassageCollectionResponse? result;
            try
            {
                result = client.Education.Reports.ReadingCoachPassages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Reports.ReadingCoachPassages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
