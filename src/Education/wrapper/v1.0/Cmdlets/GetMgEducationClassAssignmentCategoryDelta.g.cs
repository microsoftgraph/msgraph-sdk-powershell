...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/assignmentCategories/delta()")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentCategoryDelta", DefaultParameterSetName = "DeltaSync")]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Education.Client.Education.Classes.Item.AssignmentCategories.Delta.DeltaGetResponse))]
    public class GetMgEducationClassAssignmentCategoryDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Education.Client.Education.Classes.Item.AssignmentCategories.Delta.DeltaGetResponse? result;
            try
            {
                result = ParameterSetName == "Resume"
                    ? client.Education.Classes[EducationClassId].AssignmentCategories.Delta.WithUrl(ValidateContinuationUrl(DeltaLink!, requestAdapter, nameof(DeltaLink))).GetAsDeltaGetResponseAsync(requestConfiguration =>
                        {

                AddRequestHeaders(requestConfiguration.Headers);
                        }).GetAwaiter().GetResult()
                    : client.Education.Classes[EducationClassId].AssignmentCategories.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Education.Classes[EducationClassId].AssignmentCategories.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
