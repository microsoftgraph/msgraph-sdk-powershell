...
{
    [GraphRoute("GET", "/education/schools/{educationSchool-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationSchool_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class GetMgEducationSchool_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Schools[EducationSchoolId].GetAsync(requestConfiguration =>
                {
