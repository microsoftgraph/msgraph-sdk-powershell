...
{
    [GraphRoute("GET", "/education/me/schools/{educationSchool-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationMeSchool_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class GetMgEducationMeSchool_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Schools[EducationSchoolId].GetAsync(requestConfiguration =>
                {
