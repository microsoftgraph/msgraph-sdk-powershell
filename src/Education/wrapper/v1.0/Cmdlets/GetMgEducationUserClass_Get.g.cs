...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/classes/{educationClass-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserClass_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationClass))]
    public class GetMgEducationUserClass_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users[EducationUserId].Classes[EducationClassId].GetAsync(requestConfiguration =>
                {
