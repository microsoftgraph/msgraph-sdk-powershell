...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/assignmentCategories")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationCategory))]
    public class GetMgEducationClassAssignmentCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].AssignmentCategories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].AssignmentCategories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
