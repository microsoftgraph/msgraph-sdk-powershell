...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class GetMgEducationMeRubricCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ParameterSetName == "Get" ? EducationRubricId : null));
                return;
            }
        }
    }
