...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class RemoveMgEducationUserAssignmentCategoryEducationCategoryByRefCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, EducationCategoryId));
                return;
            }
        }
    }
