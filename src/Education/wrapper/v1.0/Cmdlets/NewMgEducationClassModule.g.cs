...
{
    [GraphRoute("POST", "/education/classes/{educationClass-id}/modules")]
    [Cmdlet(VerbsCommon.New, "MgEducationClassModule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationModule))]
    public class NewMgEducationClassModuleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(IsPinned)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Modules.PostAsync(body, requestConfiguration =>
                {
