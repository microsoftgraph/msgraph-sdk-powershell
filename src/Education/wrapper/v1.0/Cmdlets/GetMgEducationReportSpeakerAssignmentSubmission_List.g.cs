...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationReportSpeakerAssignmentSubmission_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.SpeakerAssignmentSubmission))]
    public class GetMgEducationReportSpeakerAssignmentSubmission_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.SpeakerAssignmentSubmissionCollectionResponse? result;
            try
            {
                result = client.Education.Reports.SpeakerAssignmentSubmissions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Reports.SpeakerAssignmentSubmissions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
