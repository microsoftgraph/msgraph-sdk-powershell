...
{
    [GraphRoute("GET", "/education/schools/{educationSchool-id}/classes")]
    [Cmdlet(VerbsCommon.Get, "MgEducationSchoolClass")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationClass))]
    public class GetMgEducationSchoolClassCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Schools[EducationSchoolId].Classes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Schools[EducationSchoolId].Classes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
