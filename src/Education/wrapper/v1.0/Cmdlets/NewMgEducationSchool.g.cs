...
{
    [GraphRoute("POST", "/education/schools")]
    [Cmdlet(VerbsCommon.New, "MgEducationSchool", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class NewMgEducationSchoolCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(CreatedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Schools.PostAsync(body, requestConfiguration =>
                {
