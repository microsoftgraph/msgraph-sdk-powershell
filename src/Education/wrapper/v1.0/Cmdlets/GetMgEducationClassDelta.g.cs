...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class GetMgEducationClassDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
