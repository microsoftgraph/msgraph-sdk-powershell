...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/members")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassMember")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationUser))]
    public class GetMgEducationClassMemberCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationUserCollectionResponse? result;
            try
            {
                result = client.Education.Classes[EducationClassId].Members.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Members.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
