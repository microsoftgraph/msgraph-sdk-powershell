...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentSubmissionSubmittedResource", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationUserAssignmentSubmissionSubmittedResourceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationUserAssignmentSubmissionSubmittedResource_Get or Get-MgEducationUserAssignmentSubmissionSubmittedResource_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationUserAssignmentSubmissionSubmittedResource_Get" : "Get-MgEducationUserAssignmentSubmissionSubmittedResource_List";
            try
            {
