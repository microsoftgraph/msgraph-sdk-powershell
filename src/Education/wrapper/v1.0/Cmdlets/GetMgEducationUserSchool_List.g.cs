...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/schools")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserSchool_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchool))]
    public class GetMgEducationUserSchool_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationSchoolCollectionResponse? result;
            try
            {
                result = client.Education.Users[EducationUserId].Schools.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Schools.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
