...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/assignmentSettings/gradingCategories")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentSettingGradingCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationGradingCategory))]
    public class GetMgEducationClassAssignmentSettingGradingCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationGradingCategoryCollectionResponse? result;
            try
            {
                result = client.Education.Classes[EducationClassId].AssignmentSettings.GradingCategories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].AssignmentSettings.GradingCategories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
