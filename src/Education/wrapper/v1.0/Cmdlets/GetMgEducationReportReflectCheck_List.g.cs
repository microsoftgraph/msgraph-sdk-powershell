...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationReportReflectCheck_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ReflectCheckInResponse))]
    public class GetMgEducationReportReflectCheck_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.ReflectCheckInResponseCollectionResponse? result;
            try
            {
                result = client.Education.Reports.ReflectCheckInResponses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Reports.ReflectCheckInResponses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
