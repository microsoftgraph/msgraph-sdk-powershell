...
{
    [GraphRoute("GET", "/education/schools/{educationSchool-id}/users")]
    [Cmdlet(VerbsCommon.Get, "MgEducationSchoolUser")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationUser))]
    public class GetMgEducationSchoolUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Schools[EducationSchoolId].Users.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Schools[EducationSchoolId].Users.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
