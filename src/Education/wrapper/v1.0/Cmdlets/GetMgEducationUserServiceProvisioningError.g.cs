...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/user/serviceProvisioningErrors")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserServiceProvisioningError")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.ServiceProvisioningError))]
    public class GetMgEducationUserServiceProvisioningErrorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users[EducationUserId].User.ServiceProvisioningErrors.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].User.ServiceProvisioningErrors.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
