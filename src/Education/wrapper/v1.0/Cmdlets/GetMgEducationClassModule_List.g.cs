...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/modules")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassModule_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationModule))]
    public class GetMgEducationClassModule_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationModuleCollectionResponse? result;
            try
            {
                result = client.Education.Classes[EducationClassId].Modules.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Modules.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
