...
{
    [GraphRoute("POST", "/education/users")]
    [Cmdlet(VerbsCommon.New, "MgEducationUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationUser))]
    public class NewMgEducationUserCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Teacher)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users.PostAsync(body, requestConfiguration =>
                {
