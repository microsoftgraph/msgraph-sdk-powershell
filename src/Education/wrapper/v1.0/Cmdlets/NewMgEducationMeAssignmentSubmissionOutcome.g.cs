...
{
    [GraphRoute("POST", "/education/me/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/outcomes")]
    [Cmdlet(VerbsCommon.New, "MgEducationMeAssignmentSubmissionOutcome", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationOutcome))]
    public class NewMgEducationMeAssignmentSubmissionOutcomeCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(LastModifiedBy)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Me.Assignments[EducationAssignmentId].Submissions[EducationSubmissionId].Outcomes.PostAsync(body, requestConfiguration =>
                {
