...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationMeAssignmentSubmissionResourceDependentResource", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationMeAssignmentSubmissionResourceDependentResourceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationMeAssignmentSubmissionResourceDependentResource_Get or Get-MgEducationMeAssignmentSubmissionResourceDependentResource_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationMeAssignmentSubmissionResourceDependentResource_Get" : "Get-MgEducationMeAssignmentSubmissionResourceDependentResource_List";
            try
            {
