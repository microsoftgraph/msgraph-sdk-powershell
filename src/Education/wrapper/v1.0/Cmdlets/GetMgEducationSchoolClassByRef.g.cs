...
{
    [GraphRoute("GET", "/education/schools/{educationSchool-id}/classes/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationSchoolClassByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationSchoolClassByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.StringCollectionResponse? result;
            try
            {
                result = client.Education.Schools[EducationSchoolId].Classes.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Schools[EducationSchoolId].Classes.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
