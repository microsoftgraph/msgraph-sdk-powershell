...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentSubmissionSubmittedResource", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationClassAssignmentSubmissionSubmittedResourceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationClassAssignmentSubmissionSubmittedResource_Get or Get-MgEducationClassAssignmentSubmissionSubmittedResource_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationClassAssignmentSubmissionSubmittedResource_Get" : "Get-MgEducationClassAssignmentSubmissionSubmittedResource_List";
            try
            {
