...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class UpdateMgEducationReportReadingCoachPassageCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(StoryType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ReadingCoachPassageId));
                return;
            }
