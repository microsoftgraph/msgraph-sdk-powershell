...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}/teachers")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClassTeacher")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationUser))]
    public class GetMgEducationClassTeacherCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Teachers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Classes[EducationClassId].Teachers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
