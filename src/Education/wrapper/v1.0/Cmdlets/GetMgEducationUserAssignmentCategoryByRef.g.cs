...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentCategoryByRef")]
    [OutputType(typeof(string))]
    public class GetMgEducationUserAssignmentCategoryByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Categories.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Categories.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
