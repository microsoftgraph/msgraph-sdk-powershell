...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class GetMgEducationUserAssignmentSubmissionResourceDependentResourceCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationUserAssignmentSubmissionResourceDependentResource_Get" : "Get-MgEducationUserAssignmentSubmissionResourceDependentResource_List";
            try
            {
