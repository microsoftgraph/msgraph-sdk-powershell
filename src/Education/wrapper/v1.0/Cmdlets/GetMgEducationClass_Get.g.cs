...
{
    [GraphRoute("GET", "/education/classes/{educationClass-id}")]
    [Cmdlet(VerbsCommon.Get, "MgEducationClass_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationClass))]
    public class GetMgEducationClass_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].GetAsync(requestConfiguration =>
                {
