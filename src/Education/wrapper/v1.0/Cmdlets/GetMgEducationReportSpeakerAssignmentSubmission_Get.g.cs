...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    public class GetMgEducationReportSpeakerAssignmentSubmission_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, SpeakerAssignmentSubmissionId));
                return;
            }
