...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentSubmission", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationUserAssignmentSubmissionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationUserAssignmentSubmission_Get or Get-MgEducationUserAssignmentSubmission_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationUserAssignmentSubmission_Get" : "Get-MgEducationUserAssignmentSubmission_List";
            try
            {
