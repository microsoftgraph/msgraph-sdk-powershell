...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}/dependentResources")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentSubmissionSubmittedResourceDependentResource", DefaultParameterSetName = "List")]
    ...
    public class GetMgEducationUserAssignmentSubmissionSubmittedResourceDependentResourceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgEducationUserAssignmentSubmissionSubmittedResourceDependentResource_Get or Get-MgEducationUserAssignmentSubmissionSubmittedResourceDependentResource_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgEducationUserAssignmentSubmissionSubmittedResourceDependentResource_Get" : "Get-MgEducationUserAssignmentSubmissionSubmittedResourceDependentResource_List";
            try
            {
