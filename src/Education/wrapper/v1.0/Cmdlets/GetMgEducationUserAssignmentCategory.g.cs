...
{
    [GraphRoute("GET", "/education/users/{educationUser-id}/assignments/{educationAssignment-id}/categories")]
    [Cmdlet(VerbsCommon.Get, "MgEducationUserAssignmentCategory")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Education.Client.Models.EducationCategory))]
    public class GetMgEducationUserAssignmentCategoryCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Education.Client.Models.EducationCategoryCollectionResponse? result;
            try
            {
                result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Categories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Education.Users[EducationUserId].Assignments[EducationAssignmentId].Categories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
