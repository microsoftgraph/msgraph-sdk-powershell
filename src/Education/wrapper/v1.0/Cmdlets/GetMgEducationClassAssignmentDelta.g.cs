...
namespace Microsoft.Graph.PowerShell.Education
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgEducationClassAssignmentDelta")]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Education.Client.Education.Classes.Item.Assignments.Delta.DeltaGetResponse))]
    public class GetMgEducationClassAssignmentDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Education.Classes[EducationClassId].Assignments.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
