...
### Delete1 (Default)
```
Remove-MgBetaEducationClassAssignmentSubmissionResource -EducationAssignmentId <String> -EducationClassId <String>
...
### Example 1: Using the Remove-MgBetaEducationClassAssignmentSubmissionResource Cmdlet
```powershell
