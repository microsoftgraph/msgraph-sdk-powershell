...
```
New-MgEducationClassAssignmentCategory -EducationClassId <String> [-DisplayName <String>] [-Id <String>]
...
```
New-MgEducationClassAssignmentCategory -InputObject <IEducationIdentity> [-DisplayName <String>]
