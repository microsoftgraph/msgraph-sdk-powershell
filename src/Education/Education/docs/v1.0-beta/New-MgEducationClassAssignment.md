...
### Create
```
New-MgBetaEducationClassAssignment -EducationClassId <String> -BodyParameter <IMicrosoftGraphEducationAssignment>
...
$params = @{
	...
	Grading = @{
		"@odata.type" = "#Microsoft.Graph.Beta.educationAssignmentGradeType"
		MaxPoints = 
	}
	AssignTo = @{
		"@odata.type" = "#Microsoft.Graph.Beta.educationAssignmentGradeType"
