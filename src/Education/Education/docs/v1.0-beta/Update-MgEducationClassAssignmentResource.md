...
Update-MgEducationClassAssignmentResource -EducationAssignmentId <String>
 -EducationAssignmentResourceId <String> -EducationClassId <String> [-DistributeForStudentWork] [-Id <String>]
...
```
Update-MgEducationClassAssignmentResource -InputObject <IEducationIdentity> [-DistributeForStudentWork]
