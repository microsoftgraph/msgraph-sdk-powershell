...
### Get1
```
Get-MgBetaEducationClassAssignmentResource -EducationAssignmentId <String> -EducationAssignmentResourceId <String>
...
### Example 1: Using the Get-MgBetaEducationClassAssignmentResource Cmdlet
```powershell
