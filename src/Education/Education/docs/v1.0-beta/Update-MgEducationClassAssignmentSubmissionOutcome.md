...
Update-MgEducationClassAssignmentSubmissionOutcome -EducationAssignmentId <String> -EducationClassId <String>
 -EducationOutcomeId <String> -EducationSubmissionId <String> [-Id <String>]
...
```
Update-MgEducationClassAssignmentSubmissionOutcome -InputObject <IEducationIdentity> [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
