...
### Create1 (Default)
```
New-MgEducationMeAssignmentCategoryByRef -EducationAssignmentId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgEducationMeAssignmentCategoryByRef -InputObject <IEducationIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
