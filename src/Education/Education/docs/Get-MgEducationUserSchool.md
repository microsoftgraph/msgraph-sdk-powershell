...
### List (Default)
```
Get-MgEducationUserSchool -EducationUserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgEducationUserSchool -EducationSchoolId <String> -EducationUserId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationUserSchool -InputObject <IEducationIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
