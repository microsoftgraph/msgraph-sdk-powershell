...
### List1 (Default)
```
Get-MgEducationSchoolUser -EducationSchoolId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgEducationSchoolUser -EducationSchoolId <String> -EducationUserId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgEducationSchoolUser -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
