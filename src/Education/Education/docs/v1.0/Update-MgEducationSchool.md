...
Update-MgEducationSchool -EducationSchoolId <String> [-AdditionalProperties <Hashtable>]
 [-Address <IMicrosoftGraphPhysicalAddress>] [-Classes <IMicrosoftGraphEducationClass1[]>]
 ...
 [-PrincipalName <String>] [-SchoolNumber <String>] [-Users <IMicrosoftGraphEducationUser1[]>] [-PassThru]
