...
### List1 (Default)
```
Get-MgEducationUserRubric -EducationUserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity1
```
Get-MgEducationUserRubric -InputObject <IEducationIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
