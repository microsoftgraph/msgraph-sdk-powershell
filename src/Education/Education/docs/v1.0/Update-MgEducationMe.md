...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.education/update-mgeducationme
schema: 2.0.0
---
...
```
Update-MgEducationMe [-AccountEnabled] [-AssignedLicenses <IMicrosoftGraphAssignedLicense[]>]
 ...
 [-DisplayName <String>] [-ExternalSource <String>] [-GivenName <String>] [-Id <String>] [-Mail <String>]
 [-MailingAddressCity <String>] [-MailingAddressCountryOrRegion <String>] [-MailingAddressPostalCode <String>]
 [-MailingAddressState <String>] [-MailingAddressStreet <String>] [-MailNickname <String>]
 [-MiddleName <String>] [-MobilePhone <String>] [-OfficeLocation <String>] [-PasswordPolicies <String>]
 [-PasswordProfileForceChangePasswordNextSignIn] [-PasswordProfileForceChangePasswordNextSignInWithMfa]
 [-PasswordProfilePassword <String>] [-PreferredLanguage <String>] [-PrimaryRole <String>]
 [-ProvisionedPlans <IMicrosoftGraphProvisionedPlan[]>] [-RefreshTokensValidFromDateTime <DateTime>]
 [-ResidenceAddressCity <String>] [-ResidenceAddressCountryOrRegion <String>]
 [-ResidenceAddressPostalCode <String>] [-ResidenceAddressState <String>] [-ResidenceAddressStreet <String>]
 [-Schools <IMicrosoftGraphEducationSchool[]>] [-ShowInAddressList] [-StudentBirthDate <DateTime>]
 [-StudentExternalId <String>] [-StudentGender <String>] [-StudentGrade <String>]
 [-StudentGraduationYear <String>] [-StudentNumber <String>] [-Surname <String>] [-TeacherExternalId <String>]
 [-TeacherNumber <String>] [-UsageLocation <String>] [-User <IMicrosoftGraphUser1>]
 [-UserPrincipalName <String>] [-UserType <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgEducationMe -BodyParameter <IMicrosoftGraphEducationUser1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
The two can be specified together; for example: 'DisablePasswordExpiration, DisableStrongPassword'.
...
### -PasswordProfileForceChangePasswordNextSignIn
...
### -PasswordProfileForceChangePasswordNextSignInWithMfa
...
### -ResidenceAddressCountryOrRegion
The country or region.
It's a free-format string value, for example, 'United States'.
...
BODYPARAMETER <IMicrosoftGraphEducationUser1>: educationUser
  ...
  - `[Classes <IMicrosoftGraphEducationClass[]>]`: Classes to which the user belongs. Nullable.
    ...
    - `[Group <IMicrosoftGraphGroup>]`: Represents an Azure Active Directory object. The directoryObject type is the base type for many other directory entity types.
      ...
      - `[CalendarCalendarView <IMicrosoftGraphEvent1[]>]`: The calendar view for the calendar. Navigation property. Read-only.
  ...
  - `[Schools <IMicrosoftGraphEducationSchool[]>]`: Schools to which the user belongs. Nullable.
