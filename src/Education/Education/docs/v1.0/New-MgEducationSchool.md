...
New-MgEducationSchool [-AdditionalProperties <Hashtable>] [-Address <IMicrosoftGraphPhysicalAddress>]
 ...
 [-ExternalSource <String>] [-Fax <String>] [-HighestGrade <String>] [-Id <String>] [-LowestGrade <String>]
 [-Phone <String>] [-PrincipalEmail <String>] [-PrincipalName <String>] [-SchoolNumber <String>]
 [-Users <IMicrosoftGraphEducationUser1[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
