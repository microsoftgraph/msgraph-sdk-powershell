...
New-MgEducationSchool [-AdditionalProperties <Hashtable>] [-Address <IMicrosoftGraphPhysicalAddress1>]
 ...
 [-SchoolNumber <String>] [-Users <IMicrosoftGraphEducationUser1[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create1
```
New-MgEducationSchool -BodyParameter <IMicrosoftGraphEducationSchool1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
