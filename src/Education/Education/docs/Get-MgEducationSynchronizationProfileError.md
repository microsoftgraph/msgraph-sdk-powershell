...
### List (Default)
```
Get-MgEducationSynchronizationProfileError -EducationSynchronizationProfileId <String> [-Count]
...
Get-MgEducationSynchronizationProfileError -EducationSynchronizationErrorId <String>
 -EducationSynchronizationProfileId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationSynchronizationProfileError -InputObject <IEducationIdentity> [-Expand <String[]>]
