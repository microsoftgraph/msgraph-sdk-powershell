...
### List1 (Default)
```
Get-MgUserOnlineMeeting -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgUserOnlineMeeting -InputObject <IOnlineMeetingsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
