...
### List (Default)
```
Get-MgPrivilegedApproval [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgPrivilegedApproval -InputObject <IIdentityAzureAdpimIdentity> [-ExpandProperty <String[]>]
