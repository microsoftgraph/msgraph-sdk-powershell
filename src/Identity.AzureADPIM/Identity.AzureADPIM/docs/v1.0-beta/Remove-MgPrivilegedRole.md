...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.azureadpim/remove-mgprivilegedrole
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgPrivilegedRole -InputObject <IIdentityAzureAdpimIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
