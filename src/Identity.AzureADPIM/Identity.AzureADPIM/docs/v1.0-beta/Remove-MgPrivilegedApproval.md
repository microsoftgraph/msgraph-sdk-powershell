...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.azureadpim/remove-mgprivilegedapproval
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgPrivilegedApproval -InputObject <IIdentityAzureAdpimIdentity> [-IfMatch <String>] [-PassThru]
