...
namespace Microsoft.Graph.PowerShell.ChangeNotifications
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgSubscriptionReauthorize", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgSubscriptionReauthorizeCommand : GraphClientCmdlet
    {
