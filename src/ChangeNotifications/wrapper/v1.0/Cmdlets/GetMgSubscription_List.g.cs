...
namespace Microsoft.Graph.PowerShell.ChangeNotifications
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgSubscription_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.ChangeNotifications.Client.Models.Subscription))]
    public class GetMgSubscription_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.ChangeNotifications.Client.Models.SubscriptionCollectionResponse? result;
            try
            {
                result = client.Subscriptions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Subscriptions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
