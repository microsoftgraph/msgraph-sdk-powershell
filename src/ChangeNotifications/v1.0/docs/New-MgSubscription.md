...
New-MgSubscription [-AdditionalProperties <Hashtable>] [-ApplicationId <String>] [-ChangeType <String>]
 ...
 [-Resource <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgSubscription -BodyParameter <IMicrosoftGraphSubscription> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
