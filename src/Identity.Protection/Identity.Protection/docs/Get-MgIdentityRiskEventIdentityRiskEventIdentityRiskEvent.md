...
### List (Default)
```
Get-MgIdentityRiskEventIdentityRiskEventIdentityRiskEvent [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgIdentityRiskEventIdentityRiskEventIdentityRiskEvent -IdentityRiskEventId <String> [-Expand <String[]>]
