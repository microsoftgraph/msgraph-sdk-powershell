...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/remove-mganonymouipriskeventanonymouipriskeventanonymouipriskevent
schema: 2.0.0
---

# Remove-MgAnonymouIPRiskEventAnonymouIpriskEventAnonymouIPRiskEvent
...
### Delete (Default)
```
Remove-MgAnonymouIPRiskEventAnonymouIpriskEventAnonymouIPRiskEvent -AnonymousIPRiskEventId <String>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgAnonymouIPRiskEventAnonymouIpriskEventAnonymouIPRiskEvent -InputObject <IIdentityProtectionIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
