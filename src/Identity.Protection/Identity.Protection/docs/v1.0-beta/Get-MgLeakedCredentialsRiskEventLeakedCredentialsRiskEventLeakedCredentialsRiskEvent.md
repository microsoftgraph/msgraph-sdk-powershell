...
```
Get-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
 -LeakedCredentialsRiskEventId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
```
Get-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
 -InputObject <IIdentityProtectionIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
