...
### List (Default)
```
Get-MgRiskDetection [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgRiskDetection -InputObject <IIdentityProtectionIdentity> [-ExpandProperty <String[]>]
