...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/update-mgleakedcredentialsriskeventleakedcredentialsriskeventleakedcredentialsriskevent
schema: 2.0.0
---

# Update-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
...
```
Update-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
 -LeakedCredentialsRiskEventId <String> [-ClosedDateTime <DateTime>] [-CreatedDateTime <DateTime>]
 [-Id <String>] [-ImpactedUser <IMicrosoftGraphUser>] [-RiskEventDateTime <DateTime>]
...
```
Update-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
 -LeakedCredentialsRiskEventId <String> -BodyParameter <IMicrosoftGraphLeakedCredentialsRiskEvent> [-PassThru]
...
```
Update-MgLeakedCredentialsRiskEventLeakedCredentialsRiskEventLeakedCredentialsRiskEvent
 -InputObject <IIdentityProtectionIdentity> -BodyParameter <IMicrosoftGraphLeakedCredentialsRiskEvent>
