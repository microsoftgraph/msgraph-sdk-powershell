...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.protection/new-mgimpossibletravelriskeventimpossibletravelriskeventimpossibletravelriskevent
schema: 2.0.0
---

# New-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
...
```
New-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent [-ClosedDateTime <DateTime>]
 [-CreatedDateTime <DateTime>] [-DeviceInformation <String>] [-GeoCoordinateAltitude <Double>]
 [-GeoCoordinateLatitude <Double>] [-GeoCoordinateLongitude <Double>] [-Id <String>]
 [-ImpactedUser <IMicrosoftGraphUser>] [-IPAddress <String>] [-IsAtypicalLocation] [-LocationCity <String>]
 [-LocationCountryOrRegion <String>] [-LocationState <String>] [-PreviouLocationCity <String>]
 [-PreviouLocationCountryOrRegion <String>] [-PreviouLocationState <String>] [-PreviousIPAddress <String>]
 [-PreviousLocationGeoCoordinatesAltitude <Double>] [-PreviousLocationGeoCoordinatesLatitude <Double>]
 [-PreviousLocationGeoCoordinatesLongitude <Double>] [-PreviousSigninDateTime <DateTime>]
 [-RiskEventDateTime <DateTime>] [-RiskEventStatus <String>] [-RiskEventType <String>] [-RiskLevel <String>]
 [-UserAgent <String>] [-UserDisplayName <String>] [-UserId <String>] [-UserPrincipalName <String>] [-Confirm]
...
```
New-MgImpossibleTravelRiskEventImpossibleTravelRiskEventImpossibleTravelRiskEvent
 -BodyParameter <IMicrosoftGraphImpossibleTravelRiskEvent> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphImpossibleTravelRiskEvent
...
### -PreviouLocationCountryOrRegion
Provides the country code info (2 letter code) where the sign-in originated.
This is calculated using latitude/longitude information from the sign-in activity.
...
### -PreviousLocationGeoCoordinatesAltitude
Optional.
The altitude (height), in feet, above sea level for the item.
Read-only.
...
### -PreviousLocationGeoCoordinatesLatitude
Optional.
The latitude, in decimal, for the item.
Read-only.
...
### -PreviousLocationGeoCoordinatesLongitude
Optional.
The longitude, in decimal, for the item.
Read-only.
...
BODYPARAMETER <IMicrosoftGraphImpossibleTravelRiskEvent>: impossibleTravelRiskEvent
  ...
  - `[PreviouLocationCity <String>]`: Provides the city where the sign-in originated. This is calculated using latitude/longitude information from the sign-in activity.
  - `[PreviouLocationCountryOrRegion <String>]`: Provides the country code info (2 letter code) where the sign-in originated.  This is calculated using latitude/longitude information from the sign-in activity.
  - `[PreviouLocationState <String>]`: Provides the State where the sign-in originated. This is calculated using latitude/longitude information from the sign-in activity.
  - `[PreviousIPAddress <String>]`: 
  - `[PreviousLocationGeoCoordinatesAltitude <Double?>]`: Optional. The altitude (height), in feet,  above sea level for the item. Read-only.
  - `[PreviousLocationGeoCoordinatesLatitude <Double?>]`: Optional. The latitude, in decimal, for the item. Read-only.
  - `[PreviousLocationGeoCoordinatesLongitude <Double?>]`: Optional. The longitude, in decimal, for the item. Read-only.
  - `[PreviousSigninDateTime <DateTime?>]`: 
  - `[UserAgent <String>]`: 
