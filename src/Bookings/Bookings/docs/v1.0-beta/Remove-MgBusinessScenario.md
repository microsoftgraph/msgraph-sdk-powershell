...
### Delete (Default)
```
Remove-MgBetaBusinessScenario -BusinessScenarioId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaBusinessScenario -InputObject <IBookingsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
