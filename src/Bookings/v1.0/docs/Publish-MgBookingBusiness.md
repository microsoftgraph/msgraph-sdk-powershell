...
### Publish (Default)
```
Publish-MgBookingBusiness -BookingBusinessId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBookingBusiness -InputObject <IBookingsIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
