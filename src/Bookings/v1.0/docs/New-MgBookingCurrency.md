...
```
New-MgBookingCurrency [-AdditionalProperties <Hashtable>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-Symbol <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBookingCurrency -BodyParameter <IMicrosoftGraphBookingCurrency> [-ResponseHeadersVariable <String>]
