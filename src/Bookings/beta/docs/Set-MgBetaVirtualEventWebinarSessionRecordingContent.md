...
Set-MgBetaVirtualEventWebinarSessionRecordingContent -CallRecordingId <String> -VirtualEventSessionId <String>
 -VirtualEventWebinarId <String> -InFile <String> [-Data <Stream>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaVirtualEventWebinarSessionRecordingContent -InputObject <IBookingsIdentity> -InFile <String>
