...
Update-MgBetaBusinessScenarioPlannerTaskProgressTaskBoardFormat -BusinessScenarioId <String>
 ...
 [-OrderHint <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaBusinessScenarioPlannerTaskProgressTaskBoardFormat -BusinessScenarioId <String>
 ...
 -BodyParameter <IMicrosoftGraphPlannerProgressTaskBoardTaskFormat> [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaBusinessScenarioPlannerTaskProgressTaskBoardFormat -InputObject <IBookingsIdentity>
 -IfMatch <String> -BodyParameter <IMicrosoftGraphPlannerProgressTaskBoardTaskFormat> [-Headers <IDictionary>]
