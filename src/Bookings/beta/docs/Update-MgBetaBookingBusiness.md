...
`BODYPARAMETER <IMicrosoftGraphBookingBusiness>`: Represents a Microsoft Bookings Business.
  ...
  - `[BookingPageSettings <IMicrosoftGraphBookingPageSettings>]`: bookingPageSettings
    ...
    - `[IsSearchEngineIndexabilityDisabled <Boolean?>]`: Disable booking page to be indexed by search engines. False by default.
    - `[IsTimeSlotTimeZoneSetToBusinessTimeZone <Boolean?>]`: If business time zone the default value for the time slots that we show in the bookings page. False by default.
