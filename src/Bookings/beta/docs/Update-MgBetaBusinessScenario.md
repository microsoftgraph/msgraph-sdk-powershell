...
```
Update-MgBetaBusinessScenario -BusinessScenarioId <String> [-UniqueName <String>]
...
### Update1
```
Update-MgBetaBusinessScenario -UniqueName <String> -BodyParameter <IMicrosoftGraphBusinessScenario>
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateExpanded1
```
Update-MgBetaBusinessScenario -UniqueName <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgBetaBusinessScenario -InputObject <IBookingsIdentity> [-UniqueName <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-OwnerAppIds <String[]>]
 [-Planner <IMicrosoftGraphBusinessScenarioPlanner>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
