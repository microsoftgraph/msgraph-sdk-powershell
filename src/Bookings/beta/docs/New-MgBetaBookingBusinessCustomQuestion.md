...
New-MgBetaBookingBusinessCustomQuestion -BookingBusinessId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-LastUpdatedDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaBookingBusinessCustomQuestion -BookingBusinessId <String>
 -BodyParameter <IMicrosoftGraphBookingCustomQuestion> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
