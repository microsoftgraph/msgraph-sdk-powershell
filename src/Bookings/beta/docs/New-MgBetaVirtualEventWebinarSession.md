...
### Create
```
New-MgBetaVirtualEventWebinarSession -VirtualEventWebinarId <String> -BodyParameter <Hashtable> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaVirtualEventWebinarSession -InputObject <IBookingsIdentity> -BodyParameter <Hashtable> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
