...
New-MgBetaVirtualEvent [-AdditionalProperties <Hashtable>]
 ...
 [-StartDateTime <IMicrosoftGraphDateTimeZone>] [-Status <String>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaVirtualEvent -BodyParameter <IMicrosoftGraphVirtualEvent> [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
