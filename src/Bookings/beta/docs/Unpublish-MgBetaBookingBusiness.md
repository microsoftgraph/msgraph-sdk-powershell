...
### Unpublish (Default)
```
Unpublish-MgBetaBookingBusiness -BookingBusinessId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm]
...
```
Unpublish-MgBetaBookingBusiness -InputObject <IBookingsIdentity> [-Headers <IDictionary>] [-PassThru]
