...
### Unpublish (Default)
```
Unpublish-MgBetaBookingBusiness -BookingBusinessId <String> [-ResponseHeadersVariable <String>]
...
```
Unpublish-MgBetaBookingBusiness -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
