...
{
    [GraphRoute("GET", "/solutions/virtualEvents/events/{virtualEvent-id}")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEvent_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEvent))]
    public class GetMgVirtualEvent_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Events[VirtualEventId].GetAsync(requestConfiguration =>
                {
