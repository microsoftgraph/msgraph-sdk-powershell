...
{
    [GraphRoute("GET", "/solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/{bookingAppointment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessCalendarView_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingAppointment))]
    public class GetMgBookingBusinessCalendarView_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].CalendarView[BookingAppointmentId].GetAsync(requestConfiguration =>
                {
