...
{
    [GraphRoute("POST", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/registrations")]
    [Cmdlet(VerbsCommon.New, "MgVirtualEventTownhallRegistration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventRegistration))]
    public class NewMgVirtualEventTownhallRegistrationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].Registrations.PostAsync(body, requestConfiguration =>
                {
