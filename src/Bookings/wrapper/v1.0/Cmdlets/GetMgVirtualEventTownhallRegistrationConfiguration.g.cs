...
{
    [GraphRoute("GET", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/registrationConfiguration")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventTownhallRegistrationConfiguration")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventTownhallRegistrationConfiguration))]
    public class GetMgVirtualEventTownhallRegistrationConfigurationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].RegistrationConfiguration.GetAsync(requestConfiguration =>
                {
