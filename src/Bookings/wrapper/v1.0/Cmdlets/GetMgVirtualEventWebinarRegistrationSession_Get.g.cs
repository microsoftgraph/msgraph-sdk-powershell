...
{
    [GraphRoute("GET", "/solutions/virtualEvents/webinars/{virtualEventWebinar-id}/registrations/{virtualEventRegistration-id}/sessions/{virtualEventSession-id}")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventWebinarRegistrationSession_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventSession))]
    public class GetMgVirtualEventWebinarRegistrationSession_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Webinars[VirtualEventWebinarId].Registrations[VirtualEventRegistrationId].Sessions[VirtualEventSessionId].GetAsync(requestConfiguration =>
                {
