...
{
    [GraphRoute("GET", "/solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessAppointment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingAppointment))]
    public class GetMgBookingBusinessAppointment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].Appointments[BookingAppointmentId].GetAsync(requestConfiguration =>
                {
