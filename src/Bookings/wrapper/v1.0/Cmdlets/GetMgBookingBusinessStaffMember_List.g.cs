...
{
    [GraphRoute("GET", "/solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers")]
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessStaffMember_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingStaffMemberBase))]
    public class GetMgBookingBusinessStaffMember_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingStaffMemberBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].StaffMembers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BookingBusinesses[BookingBusinessId].StaffMembers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
