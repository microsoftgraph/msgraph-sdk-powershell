...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    public class RemoveMgBookingBusinessCustomerCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, BookingCustomerBaseId));
                return;
            }
        }
    }
