...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    public class GetMgVirtualEventTownhallSession_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, VirtualEventTownhallId));
                return;
            }
