...
{
    [GraphRoute("GET", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/registrations/{virtualEventRegistration-id}/sessions/{virtualEventSession-id}")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventTownhallRegistrationSession_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventSession))]
    public class GetMgVirtualEventTownhallRegistrationSession_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].Registrations[VirtualEventRegistrationId].Sessions[VirtualEventSessionId].GetAsync(requestConfiguration =>
                {
