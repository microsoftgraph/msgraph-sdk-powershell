...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventTownhallRegistrationSession_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventSession))]
    public class GetMgVirtualEventTownhallRegistrationSession_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].Registrations[VirtualEventRegistrationId].Sessions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].Registrations[VirtualEventRegistrationId].Sessions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
