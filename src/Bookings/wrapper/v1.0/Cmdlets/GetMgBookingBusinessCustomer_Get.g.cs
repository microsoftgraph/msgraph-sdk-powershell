...
{
    [GraphRoute("GET", "/solutions/bookingBusinesses/{bookingBusiness-id}/customers/{bookingCustomerBase-id}")]
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessCustomer_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingCustomerBase))]
    public class GetMgBookingBusinessCustomer_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].Customers[BookingCustomerBaseId].GetAsync(requestConfiguration =>
                {
