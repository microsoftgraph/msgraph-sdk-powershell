...
{
    [GraphRoute("GET", "/solutions/virtualEvents/webinars/{virtualEventWebinar-id}/sessions")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventWebinarSession_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventSession))]
    public class GetMgVirtualEventWebinarSession_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Webinars[VirtualEventWebinarId].Sessions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.VirtualEvents.Webinars[VirtualEventWebinarId].Sessions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
