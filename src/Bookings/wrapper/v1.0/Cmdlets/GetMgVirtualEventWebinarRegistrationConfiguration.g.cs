...
{
    [GraphRoute("GET", "/solutions/virtualEvents/webinars/{virtualEventWebinar-id}/registrationConfiguration")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventWebinarRegistrationConfiguration")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventWebinarRegistrationConfiguration))]
    public class GetMgVirtualEventWebinarRegistrationConfigurationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Webinars[VirtualEventWebinarId].RegistrationConfiguration.GetAsync(requestConfiguration =>
                {
