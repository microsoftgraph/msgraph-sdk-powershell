...
{
    [GraphRoute("POST", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/registrationConfiguration/questions")]
    [Cmdlet(VerbsCommon.New, "MgVirtualEventTownhallRegistrationConfigurationQuestion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventRegistrationQuestionBase))]
    public class NewMgVirtualEventTownhallRegistrationConfigurationQuestionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(IsRequired)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].RegistrationConfiguration.Questions.PostAsync(body, requestConfiguration =>
                {
