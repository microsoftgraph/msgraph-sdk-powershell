...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessCustomer_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingCustomerBase))]
    public class GetMgBookingBusinessCustomer_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingCustomerBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].Customers.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BookingBusinesses[BookingBusinessId].Customers.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
