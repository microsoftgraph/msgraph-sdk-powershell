...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgBookingBusinessService_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingService))]
    public class GetMgBookingBusinessService_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingServiceCollectionResponse? result;
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].Services.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.BookingBusinesses[BookingBusinessId].Services.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
