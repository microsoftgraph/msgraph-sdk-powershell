...
{
    [GraphRoute("PATCH", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}")]
    [Cmdlet(VerbsData.Update, "MgVirtualEventTownhall", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventTownhall))]
    public class UpdateMgVirtualEventTownhallCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(InvitedAttendees)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].PatchAsync(body, requestConfiguration =>
                {
