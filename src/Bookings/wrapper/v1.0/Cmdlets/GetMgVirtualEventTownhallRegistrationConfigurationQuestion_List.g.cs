...
namespace Microsoft.Graph.PowerShell.Bookings
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventTownhallRegistrationConfigurationQuestion_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventRegistrationQuestionBase))]
    public class GetMgVirtualEventTownhallRegistrationConfigurationQuestion_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventRegistrationQuestionBaseCollectionResponse? result;
            try
            {
                result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].RegistrationConfiguration.Questions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Solutions.VirtualEvents.Townhalls[VirtualEventTownhallId].RegistrationConfiguration.Questions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
