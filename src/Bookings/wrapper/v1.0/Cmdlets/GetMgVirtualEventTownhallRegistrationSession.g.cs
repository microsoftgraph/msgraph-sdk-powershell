...
{
    [GraphRoute("GET", "/solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/registrations/{virtualEventRegistration-id}/sessions")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventTownhallRegistrationSession", DefaultParameterSetName = "List")]
    ...
    public class GetMgVirtualEventTownhallRegistrationSessionCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgVirtualEventTownhallRegistrationSession_Get or Get-MgVirtualEventTownhallRegistrationSession_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgVirtualEventTownhallRegistrationSession_Get" : "Get-MgVirtualEventTownhallRegistrationSession_List";
            try
            {
