...
{
    [GraphRoute("POST", "/solutions/bookingBusinesses/{bookingBusiness-id}/appointments")]
    [Cmdlet(VerbsCommon.New, "MgBookingBusinessAppointment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.BookingAppointment))]
    public class NewMgBookingBusinessAppointmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(StartDateTime)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.BookingBusinesses[BookingBusinessId].Appointments.PostAsync(body, requestConfiguration =>
                {
