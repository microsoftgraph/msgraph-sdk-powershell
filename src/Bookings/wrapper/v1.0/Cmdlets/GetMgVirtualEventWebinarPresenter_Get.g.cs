...
{
    [GraphRoute("GET", "/solutions/virtualEvents/webinars/{virtualEventWebinar-id}/presenters/{virtualEventPresenter-id}")]
    [Cmdlet(VerbsCommon.Get, "MgVirtualEventWebinarPresenter_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Bookings.Client.Models.VirtualEventPresenter))]
    public class GetMgVirtualEventWebinarPresenter_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Solutions.VirtualEvents.Webinars[VirtualEventWebinarId].Presenters[VirtualEventPresenterId].GetAsync(requestConfiguration =>
                {
