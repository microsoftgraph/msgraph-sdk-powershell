...
namespace Microsoft.Graph.PowerShell.Bookings.Client.Models
{
    ...
    public partial class MeetingAttendanceReport : global::Microsoft.Graph.PowerShell.Bookings.Client.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>List of attendance records of an attendance report. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.PowerShell.Bookings.Client.Models.AttendanceRecord>? AttendanceRecords { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.PowerShell.Bookings.Client.Models.AttendanceRecord> AttendanceRecords { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::Microsoft.Graph.PowerShell.Bookings.Client.Models.MeetingAttendanceReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Microsoft.Graph.PowerShell.Bookings.Client.Models.MeetingAttendanceReport();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attendanceRecords", n => { AttendanceRecords = n.GetCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Bookings.Client.Models.AttendanceRecord>(global::Microsoft.Graph.PowerShell.Bookings.Client.Models.AttendanceRecord.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Microsoft.Graph.PowerShell.Bookings.Client.Models.AttendanceRecord>("attendanceRecords", AttendanceRecords);
