...
### List (Default)
```
Get-MgSiteListColumn -ListId <String> -SiteId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSiteListColumn -ColumnDefinitionId <String> -ListId <String> -SiteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListColumn -InputObject <ISitesListIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
