...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistactivitylistitemfield
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteListActivityListItemField -ItemActivityOldId <String> -ListId <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListActivityListItemField -InputObject <ISitesListIdentity> [-Expand <String[]>]
