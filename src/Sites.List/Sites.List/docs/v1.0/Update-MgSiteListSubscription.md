...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/update-mgsitelistsubscription
schema: 2.0.0
---
...
Update-MgSiteListSubscription -ListId <String> -SiteId <String> -SubscriptionId <String>
 ...
 [-ExpirationDateTime <DateTime>] [-Id <String>] [-LatestSupportedTlsVersion <String>]
...
### UpdateViaIdentity
```
Update-MgSiteListSubscription -InputObject <ISitesListIdentity> -BodyParameter <IMicrosoftGraphSubscription>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListSubscription -InputObject <ISitesListIdentity> [-ApplicationId <String>]
