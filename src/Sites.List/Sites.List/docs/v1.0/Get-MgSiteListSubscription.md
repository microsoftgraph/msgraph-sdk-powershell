...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistsubscription
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListSubscription -ListId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgSiteListSubscription -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>]
