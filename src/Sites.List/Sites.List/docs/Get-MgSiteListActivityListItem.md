...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistactivitylistitem
schema: 2.0.0
---

# Get-MgSiteListActivityListItem
...
### Get (Default)
```
Get-MgSiteListActivityListItem -ItemActivityOldId <String> -ListId <String> -SiteId <String>
 [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListActivityListItem -InputObject <ISitesListIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
