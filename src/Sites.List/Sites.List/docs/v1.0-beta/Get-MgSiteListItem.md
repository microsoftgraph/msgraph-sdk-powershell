...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistitem
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListItem -ListId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgSiteListItem -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
