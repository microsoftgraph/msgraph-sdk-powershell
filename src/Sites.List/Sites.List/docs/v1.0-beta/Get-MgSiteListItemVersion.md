...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistitemversion
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListItemVersion -ListId <String> -ListItemId <String> -SiteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgSiteListItemVersion -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>]
