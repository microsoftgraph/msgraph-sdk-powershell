...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistcolumn
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListColumn -ListId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgSiteListColumn -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
