...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistitemversionfield
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListItemVersionField -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>]
