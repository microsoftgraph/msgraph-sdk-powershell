...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/new-mgsitelistactivitylistitemactivity
schema: 2.0.0
---

# New-MgSiteListActivityListItemActivity
...
```
New-MgSiteListActivityListItemActivity -ItemActivityOldId <String> -ListId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteListActivityListItemActivity -InputObject <ISitesListIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
