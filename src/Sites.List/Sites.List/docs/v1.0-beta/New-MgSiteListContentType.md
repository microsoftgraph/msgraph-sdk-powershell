...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/new-mgsitelistcontenttype
schema: 2.0.0
---
...
```
New-MgSiteListContentType -ListId <String> -SiteId <String> [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
...
### CreateViaIdentity
```
New-MgSiteListContentType -InputObject <ISitesListIdentity> -BodyParameter <IMicrosoftGraphContentType>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteListContentType -InputObject <ISitesListIdentity> [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
 [-Description <String>] [-Group <String>] [-Hidden] [-Id <String>]
 [-InheritedFrom <IMicrosoftGraphItemReference>] [-Name <String>] [-OrderDefault] [-OrderPosition <Int32>]
 [-ParentId <String>] [-ReadOnly] [-Sealed] [-Confirm] [-WhatIf] [<CommonParameters>]
```
