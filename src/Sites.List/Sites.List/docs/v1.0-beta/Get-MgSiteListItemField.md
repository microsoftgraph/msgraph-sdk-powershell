...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistitemfield
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListItemField -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
