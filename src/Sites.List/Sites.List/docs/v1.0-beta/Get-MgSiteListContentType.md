...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistcontenttype
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteListContentType -ListId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgSiteListContentType -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>]
