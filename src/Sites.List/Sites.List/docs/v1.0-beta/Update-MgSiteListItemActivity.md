...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/update-mgsitelistitemactivity
schema: 2.0.0
---

# Update-MgSiteListItemActivity
...
```
Update-MgSiteListItemActivity -ItemActivityOldId <String> -ListId <String> -ListItemId <String>
 -SiteId <String> [-ActionCreate <IMicrosoftGraphCreateAction>] [-ActionEdit <IMicrosoftGraphEditAction>]
 ...
 [-DeleteName <String>] [-DeleteObjectType <String>] [-DriveItem <IMicrosoftGraphDriveItem1>] [-Id <String>]
 [-ListItem <IMicrosoftGraphListItem1>] [-MentionMentionees <IMicrosoftGraphIdentitySet[]>]
...
```
Update-MgSiteListItemActivity -ItemActivityOldId <String> -ListId <String> -ListItemId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteListItemActivity -InputObject <ISitesListIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListItemActivity -InputObject <ISitesListIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
 ...
 [-DriveItem <IMicrosoftGraphDriveItem1>] [-Id <String>] [-ListItem <IMicrosoftGraphListItem1>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphListItem1
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
BODYPARAMETER <IMicrosoftGraphItemActivityOld>: itemActivityOLD
  ...
  - `[DriveItem <IMicrosoftGraphDriveItem1>]`: driveItem
    ...
    - `[WorkbookWorksheets <IMicrosoftGraphWorkbookWorksheet1[]>]`: Represents a collection of worksheets associated with the workbook. Read-only.
      - `[Id <String>]`: Read-only.
