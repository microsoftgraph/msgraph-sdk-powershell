...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/update-mgsitelistactivitylistitemactivity
schema: 2.0.0
---
...
```
Update-MgSiteListActivityListItemActivity -ItemActivityOldId <String> -ItemActivityOldId1 <String>
 -ListId <String> -SiteId <String> [-ActionCreate <IMicrosoftGraphCreateAction>]
...
```
Update-MgSiteListActivityListItemActivity -ItemActivityOldId <String> -ItemActivityOldId1 <String>
 -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphItemActivityOld> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteListActivityListItemActivity -InputObject <ISitesListIdentity>
