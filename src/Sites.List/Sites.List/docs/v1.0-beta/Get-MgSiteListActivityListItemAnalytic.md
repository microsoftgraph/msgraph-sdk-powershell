...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/get-mgsitelistactivitylistitemanalytic
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteListActivityListItemAnalytic -ItemActivityOldId <String> -ListId <String> -SiteId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteListActivityListItemAnalytic -InputObject <ISitesListIdentity> [-ExpandProperty <String[]>]
