...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.list/update-mgsitelistactivity
schema: 2.0.0
---

# Update-MgSiteListActivity
...
```
Update-MgSiteListActivity -ItemActivityOldId <String> -ListId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteListActivity -InputObject <ISitesListIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListActivity -InputObject <ISitesListIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
