...
### Delta (Default)
```
Get-MgUserCalendarEventDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### Delta1
```
Get-MgUserCalendarEventDelta -CalendarId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
