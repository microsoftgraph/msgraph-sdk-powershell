...
### Delta (Default)
```
Get-MgUserEventInstanceDelta -EventId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserEventInstanceDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
