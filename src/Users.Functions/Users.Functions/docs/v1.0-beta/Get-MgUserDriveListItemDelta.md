...
### Delta (Default)
```
Get-MgUserDriveListItemDelta -DriveId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### Delta1
```
Get-MgUserDriveListItemDelta -DriveId <String> -Token <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
