...
### Delta1 (Default)
```
Get-MgBetaUserEventInstanceDelta -EventId <String> -UserId <String> [-Count] [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgBetaUserEventInstanceDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [<CommonParameters>]
```
