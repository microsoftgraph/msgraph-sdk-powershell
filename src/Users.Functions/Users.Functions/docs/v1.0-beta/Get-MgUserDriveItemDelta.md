...
### Delta (Default)
```
Get-MgUserDriveItemDelta -DriveId <String> -DriveItemId <String> -UserId <String> [-Count] [-Filter <String>]
...
### Delta1
```
Get-MgUserDriveItemDelta -DriveId <String> -DriveItemId <String> -Token <String> -UserId <String> [-Count]
