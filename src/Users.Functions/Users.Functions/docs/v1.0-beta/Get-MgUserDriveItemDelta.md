...
### Delta (Default)
```
Get-MgBetaUserDriveItemDelta -DriveId <String> -DriveItemId <String> -UserId <String> [-Count] [-Filter <String>]
...
### Delta1
```
Get-MgBetaUserDriveItemDelta -DriveId <String> -DriveItemId <String> -Token <String> -UserId <String> [-Count]
