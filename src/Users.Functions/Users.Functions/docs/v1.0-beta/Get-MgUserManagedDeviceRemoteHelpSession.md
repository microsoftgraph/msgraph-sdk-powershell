...
# Get-MgBetaUserManagedDeviceRemoteHelpSession
...
### Retrieve (Default)
```
Get-MgBetaUserManagedDeviceRemoteHelpSession -ManagedDeviceId <String> -SessionKey <String> -UserId <String>
 [<CommonParameters>]
```

### RetrieveViaIdentity
```
Get-MgBetaUserManagedDeviceRemoteHelpSession -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
