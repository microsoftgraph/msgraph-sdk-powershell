...
# Get-MgBetaUserTaskAlltaskDelta
...
### Delta (Default)
```
Get-MgBetaUserTaskAlltaskDelta -UserId <String> [-Count] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```

### DeltaViaIdentity
```
Get-MgBetaUserTaskAlltaskDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
