...
### Search (Default)
```
Search-MgUserDriveRoot -DriveId <String> -Q <String> -UserId <String> [<CommonParameters>]
```

### SearchViaIdentity
```
Search-MgUserDriveRoot -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
