...
### Delta (Default)
```
Get-MgBetaUserPlannerPlanBucketDelta -PlannerPlanId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaUserPlannerPlanBucketDelta -InputObject <IUsersFunctionsIdentity> [-Count]
