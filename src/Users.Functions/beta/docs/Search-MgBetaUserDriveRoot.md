...
### Search (Default)
```
Search-MgBetaUserDriveRoot -DriveId <String> -Q <String> -UserId <String> [-Count]
...
### SearchViaIdentity
```
Search-MgBetaUserDriveRoot -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
