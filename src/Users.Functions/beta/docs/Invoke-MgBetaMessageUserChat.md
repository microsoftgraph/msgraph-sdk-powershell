...
### Message (Default)
```
Invoke-MgBetaMessageUserChat -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### MessageViaIdentity
```
Invoke-MgBetaMessageUserChat -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
