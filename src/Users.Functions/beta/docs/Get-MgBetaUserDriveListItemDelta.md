...
### Delta (Default)
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### Delta1
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -Token <String> -UserId <String>
...
### DeltaViaIdentity
```
Get-MgBetaUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]
