...
```
Invoke-MgBetaFilterUserAppConsentRequestForApprovalUserConsentRequestByCurrentUser
 -AppConsentRequestId <String> -On <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
```
Invoke-MgBetaFilterUserAppConsentRequestForApprovalUserConsentRequestByCurrentUser
 -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
