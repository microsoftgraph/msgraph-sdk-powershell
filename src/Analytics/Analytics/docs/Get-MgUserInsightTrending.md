...
### List (Default)
```
Get-MgUserInsightTrending -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserInsightTrending -TrendingId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInsightTrending -InputObject <IAnalyticsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
