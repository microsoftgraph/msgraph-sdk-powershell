...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.analytics/get-mguseranalytic
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserAnalytic -InputObject <IAnalyticsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
