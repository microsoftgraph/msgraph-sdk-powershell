...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.analytics/get-mguserinsightusedresource
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserInsightUsedResource -InputObject <IAnalyticsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
