...
### List (Default)
```
Get-MgUserInsightShared -UserId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserInsightShared -SharedInsightId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserInsightShared -InputObject <IAnalyticsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
