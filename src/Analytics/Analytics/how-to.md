# How-To
This document describes how to develop for `Microsoft.Graph.Analytics`.

## Building `Microsoft.Graph.Analytics`
...
## Testing `Microsoft.Graph.Analytics`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Analytics` into the session.
