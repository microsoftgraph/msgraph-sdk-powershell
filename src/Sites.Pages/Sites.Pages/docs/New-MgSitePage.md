...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.pages/new-mgsitepage
schema: 2.0.0
---
...
```
New-MgSitePage -SiteId <String> [-ContentTypeId <String>] [-ContentTypeName <String>]
...
### Create
```
New-MgSitePage -SiteId <String> -BodyParameter <IMicrosoftGraphSitePage> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSitePage -InputObject <ISitesPagesIdentity> -BodyParameter <IMicrosoftGraphSitePage> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSitePage -InputObject <ISitesPagesIdentity> [-ContentTypeId <String>] [-ContentTypeName <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedByUser <IMicrosoftGraphUser>]
 [-CreatedDateTime <DateTime>] [-Description <String>] [-ETag <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedByUser <IMicrosoftGraphUser>]
 [-LastModifiedDateTime <DateTime>] [-Name <String>] [-PageLayoutType <String>]
