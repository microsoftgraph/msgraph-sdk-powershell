...
{
    [GraphRoute("GET", "/users/{user-id}/profile/positions/{workPosition-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePosition_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.WorkPosition))]
    public class GetMgUserProfilePosition_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Positions[WorkPositionId].GetAsync(requestConfiguration =>
                {
