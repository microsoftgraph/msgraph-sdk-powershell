...
{
    [GraphRoute("GET", "/users/{user-id}/profile/certifications")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileCertification_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonCertification))]
    public class GetMgUserProfileCertification_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonCertificationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Certifications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Certifications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
