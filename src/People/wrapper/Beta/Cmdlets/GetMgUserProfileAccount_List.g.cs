...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileAccount_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.UserAccountInformation))]
    public class GetMgUserProfileAccount_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.UserAccountInformationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Account.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Account.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
