...
{
    [GraphRoute("POST", "/users/{user-id}/profile/interests")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileInterest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonInterest))]
    public class NewMgUserProfileInterestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Interests.PostAsync(body, requestConfiguration =>
                {
