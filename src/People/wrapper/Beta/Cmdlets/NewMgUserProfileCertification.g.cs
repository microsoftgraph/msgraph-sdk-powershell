...
{
    [GraphRoute("POST", "/users/{user-id}/profile/certifications")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileCertification", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonCertification))]
    public class NewMgUserProfileCertificationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Certifications.PostAsync(body, requestConfiguration =>
                {
