...
{
    [GraphRoute("GET", "/users/{user-id}/profile/webAccounts/{webAccount-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileWebAccount_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.WebAccount))]
    public class GetMgUserProfileWebAccount_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.WebAccounts[WebAccountId].GetAsync(requestConfiguration =>
                {
