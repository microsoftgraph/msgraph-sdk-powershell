...
{
    [GraphRoute("GET", "/users/{user-id}/profile/webAccounts")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileWebAccount_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.WebAccount))]
    public class GetMgUserProfileWebAccount_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.WebAccountCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.WebAccounts.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.WebAccounts.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
