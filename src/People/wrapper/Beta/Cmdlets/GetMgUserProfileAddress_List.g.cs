...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileAddress_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemAddress))]
    public class GetMgUserProfileAddress_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ItemAddressCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Addresses.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Addresses.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
