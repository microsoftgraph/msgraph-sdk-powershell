...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileInterest_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonInterest))]
    public class GetMgUserProfileInterest_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonInterestCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Interests.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Interests.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
