...
{
    [GraphRoute("GET", "/users/{user-id}/profile/projects")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileProject_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ProjectParticipation))]
    public class GetMgUserProfileProject_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ProjectParticipationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Projects.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Projects.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
