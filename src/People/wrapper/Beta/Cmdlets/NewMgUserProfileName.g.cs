...
{
    [GraphRoute("POST", "/users/{user-id}/profile/names")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileName", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonName))]
    public class NewMgUserProfileNameCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Pronunciation)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Names.PostAsync(body, requestConfiguration =>
                {
