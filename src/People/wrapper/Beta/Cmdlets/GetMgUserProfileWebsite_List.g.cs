...
{
    [GraphRoute("GET", "/users/{user-id}/profile/websites")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileWebsite_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonWebsite))]
    public class GetMgUserProfileWebsite_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonWebsiteCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Websites.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Websites.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
