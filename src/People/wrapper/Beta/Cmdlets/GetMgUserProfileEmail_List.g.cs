...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileEmail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemEmail))]
    public class GetMgUserProfileEmail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ItemEmailCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Emails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Emails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
