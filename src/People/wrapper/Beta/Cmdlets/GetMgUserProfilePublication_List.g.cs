...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePublication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPublication))]
    public class GetMgUserProfilePublication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ItemPublicationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Publications.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Publications.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
