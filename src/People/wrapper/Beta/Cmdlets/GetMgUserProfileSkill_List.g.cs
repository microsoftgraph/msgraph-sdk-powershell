...
{
    [GraphRoute("GET", "/users/{user-id}/profile/skills")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileSkill_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiency))]
    public class GetMgUserProfileSkill_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiencyCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Skills.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Skills.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
