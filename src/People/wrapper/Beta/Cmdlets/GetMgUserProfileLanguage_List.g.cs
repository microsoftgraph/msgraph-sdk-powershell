...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileLanguage_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.LanguageProficiency))]
    public class GetMgUserProfileLanguage_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.LanguageProficiencyCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Languages.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Languages.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
