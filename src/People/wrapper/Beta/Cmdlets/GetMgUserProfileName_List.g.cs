...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileName_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonName))]
    public class GetMgUserProfileName_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonNameCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Names.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Names.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
