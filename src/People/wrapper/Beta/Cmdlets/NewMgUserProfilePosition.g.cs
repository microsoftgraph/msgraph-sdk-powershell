...
{
    [GraphRoute("POST", "/users/{user-id}/profile/positions")]
    [Cmdlet(VerbsCommon.New, "MgUserProfilePosition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.WorkPosition))]
    public class NewMgUserProfilePositionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Manager)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Positions.PostAsync(body, requestConfiguration =>
                {
