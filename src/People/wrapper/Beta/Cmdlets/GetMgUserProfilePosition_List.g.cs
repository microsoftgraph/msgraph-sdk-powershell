...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePosition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.WorkPosition))]
    public class GetMgUserProfilePosition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.WorkPositionCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Positions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Positions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
