...
{
    [GraphRoute("POST", "/users/{user-id}/profile/anniversaries")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileAnniversary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnualEvent))]
    public class NewMgUserProfileAnniversaryCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public global::Microsoft.Kiota.Abstractions.Date? Date { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnualEventType? Type { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnualEvent();
    ...
    if (this.IsParameterBound(nameof(Date)))
        body.Date = Date;
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnualEvent? result;
            try
            {
                result = client.Users[UserId].Profile.Anniversaries.PostAsync(body, requestConfiguration =>
                {
