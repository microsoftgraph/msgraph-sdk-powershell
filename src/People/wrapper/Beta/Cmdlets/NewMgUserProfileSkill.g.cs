...
{
    [GraphRoute("POST", "/users/{user-id}/profile/skills")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileSkill", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiency))]
    public class NewMgUserProfileSkillCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiencyLevel? Proficiency { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiency();
    ...
    if (this.IsParameterBound(nameof(Proficiency)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.SkillProficiency? result;
            try
            {
                result = client.Users[UserId].Profile.Skills.PostAsync(body, requestConfiguration =>
                {
