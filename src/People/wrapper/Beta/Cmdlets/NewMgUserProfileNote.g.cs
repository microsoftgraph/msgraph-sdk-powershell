...
{
    [GraphRoute("POST", "/users/{user-id}/profile/notes")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileNote", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnotation))]
    public class NewMgUserProfileNoteCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.People.Client.Models.ItemBody? Detail { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnotation();
    ...
    if (this.IsParameterBound(nameof(Detail)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonAnnotation? result;
            try
            {
                result = client.Users[UserId].Profile.Notes.PostAsync(body, requestConfiguration =>
                {
