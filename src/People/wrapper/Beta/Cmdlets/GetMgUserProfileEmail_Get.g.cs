...
{
    [GraphRoute("GET", "/users/{user-id}/profile/emails/{itemEmail-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileEmail_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemEmail))]
    public class GetMgUserProfileEmail_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Emails[ItemEmailId].GetAsync(requestConfiguration =>
                {
