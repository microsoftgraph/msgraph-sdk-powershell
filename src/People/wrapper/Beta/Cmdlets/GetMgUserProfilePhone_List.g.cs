...
{
    [GraphRoute("GET", "/users/{user-id}/profile/phones")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePhone_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPhone))]
    public class GetMgUserProfilePhone_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ItemPhoneCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Phones.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Phones.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
