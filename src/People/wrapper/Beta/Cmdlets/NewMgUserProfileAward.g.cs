...
{
    [GraphRoute("POST", "/users/{user-id}/profile/awards")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileAward", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonAward))]
    public class NewMgUserProfileAwardCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Awards.PostAsync(body, requestConfiguration =>
                {
