...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePhone", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPhoneCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPhone), ParameterSetName = new[] { "Get" })]
    public class GetMgUserProfilePhoneCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserProfilePhone_Get or Get-MgUserProfilePhone_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserProfilePhone_Get" : "Get-MgUserProfilePhone_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ItemPhoneId : UserId);
                return;
            }
        }
    }
