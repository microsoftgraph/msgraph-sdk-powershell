...
{
    [GraphRoute("POST", "/users/{user-id}/profile/patents")]
    [Cmdlet(VerbsCommon.New, "MgUserProfilePatent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPatent))]
    public class NewMgUserProfilePatentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Patents.PostAsync(body, requestConfiguration =>
                {
