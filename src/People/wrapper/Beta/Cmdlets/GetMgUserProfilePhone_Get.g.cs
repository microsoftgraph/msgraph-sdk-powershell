...
{
    [GraphRoute("GET", "/users/{user-id}/profile/phones/{itemPhone-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePhone_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPhone))]
    public class GetMgUserProfilePhone_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Phones[ItemPhoneId].GetAsync(requestConfiguration =>
                {
