...
{
    [GraphRoute("GET", "/users/{user-id}/profile/names")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileName", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonNameCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonName), ParameterSetName = new[] { "Get" })]
    public class GetMgUserProfileNameCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserProfileName_Get or Get-MgUserProfileName_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserProfileName_Get" : "Get-MgUserProfileName_List";
            try
            {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? PersonNameId : UserId);
                return;
            }
        }
    }
