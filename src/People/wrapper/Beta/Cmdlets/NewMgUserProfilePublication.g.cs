...
{
    [GraphRoute("POST", "/users/{user-id}/profile/publications")]
    [Cmdlet(VerbsCommon.New, "MgUserProfilePublication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPublication))]
    public class NewMgUserProfilePublicationCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Publications.PostAsync(body, requestConfiguration =>
                {
