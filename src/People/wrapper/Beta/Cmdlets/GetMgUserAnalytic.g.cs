...
{
    [GraphRoute("GET", "/users/{user-id}/analytics")]
    [Cmdlet(VerbsCommon.Get, "MgUserAnalytic")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.UserAnalytics))]
    public class GetMgUserAnalyticCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Analytics.GetAsync(requestConfiguration =>
                {
