...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfileAward_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonAward))]
    public class GetMgUserProfileAward_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonAwardCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Awards.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Awards.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
