...
{
    [GraphRoute("POST", "/users/{user-id}/profile/phones")]
    [Cmdlet(VerbsCommon.New, "MgUserProfilePhone", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPhone))]
    public class NewMgUserProfilePhoneCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Phones.PostAsync(body, requestConfiguration =>
                {
