...
{
    [GraphRoute("GET", "/users/{user-id}/profile/certifications/{personCertification-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileCertification_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonCertification))]
    public class GetMgUserProfileCertification_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Certifications[PersonCertificationId].GetAsync(requestConfiguration =>
                {
