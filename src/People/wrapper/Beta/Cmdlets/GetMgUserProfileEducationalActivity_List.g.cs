...
{
    [GraphRoute("GET", "/users/{user-id}/profile/educationalActivities")]
    [Cmdlet(VerbsCommon.Get, "MgUserProfileEducationalActivity_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.EducationalActivity))]
    public class GetMgUserProfileEducationalActivity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.EducationalActivityCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.EducationalActivities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.EducationalActivities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
