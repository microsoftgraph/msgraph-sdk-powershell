...
{
    [GraphRoute("POST", "/users/{user-id}/profile/emails")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileEmail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemEmail))]
    public class NewMgUserProfileEmailCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Type)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Profile.Emails.PostAsync(body, requestConfiguration =>
                {
