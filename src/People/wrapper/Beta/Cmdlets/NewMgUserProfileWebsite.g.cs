...
{
    [GraphRoute("POST", "/users/{user-id}/profile/websites")]
    [Cmdlet(VerbsCommon.New, "MgUserProfileWebsite", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.PersonWebsite))]
    public class NewMgUserProfileWebsiteCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new Microsoft.Graph.PowerShell.People.Client.Models.PersonWebsite();
    ...
    if (this.IsParameterBound(nameof(Sources)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonWebsite? result;
            try
            {
                result = client.Users[UserId].Profile.Websites.PostAsync(body, requestConfiguration =>
                {
