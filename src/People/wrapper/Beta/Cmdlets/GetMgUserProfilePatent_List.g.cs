...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserProfilePatent_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.ItemPatent))]
    public class GetMgUserProfilePatent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.ItemPatentCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Profile.Patents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Profile.Patents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
