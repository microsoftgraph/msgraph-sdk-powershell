...
namespace Microsoft.Graph.PowerShell.People
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserPerson_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.People.Client.Models.Person))]
    public class GetMgUserPerson_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.People.Client.Models.PersonCollectionResponse? result;
            try
            {
                result = client.Users[UserId].People.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].People.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
