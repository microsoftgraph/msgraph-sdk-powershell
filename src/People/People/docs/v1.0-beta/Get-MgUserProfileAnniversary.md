...
### List (Default)
```
Get-MgUserProfileAnniversary -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String> [-ExpandProperty <String[]>]
