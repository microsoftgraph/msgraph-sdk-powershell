...
### Delete (Default)
```
Remove-MgBetaUserProfileAnniversary -PersonAnnualEventId <String> -UserId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileAnniversary -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
