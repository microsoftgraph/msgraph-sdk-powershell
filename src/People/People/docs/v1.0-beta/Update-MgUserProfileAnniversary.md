...
Update-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String>
 ...
 [-Source <IMicrosoftGraphPersonDataSource>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPersonAnniversary> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
