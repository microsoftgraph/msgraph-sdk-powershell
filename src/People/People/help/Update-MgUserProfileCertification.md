...
Update-MgUserProfileCertification -PersonCertificationId <String> -UserId <String>
 ...
 [-IssuedDate <DateTime>] [-IssuingAuthority <String>] [-IssuingCompany <String>]
...
```
Update-MgUserProfileCertification -PersonCertificationId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPersonCertification> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgUserProfileCertification -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-Inference <IMicrosoftGraphInferenceData>] [-IssuedDate <DateTime>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilecertification](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilecertification)
