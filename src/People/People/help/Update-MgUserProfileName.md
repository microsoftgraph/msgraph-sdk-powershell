...
Update-MgUserProfileName -PersonNameId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Suffix <String>] [-Title <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilename](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilename)
