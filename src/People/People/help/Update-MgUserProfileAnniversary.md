...
```
Update-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String>
 [-AdditionalProperties <Hashtable>] [-AllowedAudiences <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-Date <DateTime>] [-Id <String>] [-Inference <IMicrosoftGraphInferenceData>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-Source <IMicrosoftGraphPersonDataSources>] [-Type <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPersonAnniversary> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofileanniversary](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofileanniversary)
