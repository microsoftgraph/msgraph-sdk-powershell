...
Update-MgUserProfileProject -ProjectParticipationId <String> -UserId <String>
 ...
 [-Sponsors <IMicrosoftGraphRelatedPerson[]>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofileproject](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofileproject)
