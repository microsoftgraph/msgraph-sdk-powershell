...
Update-MgUserProfileWebAccount -UserId <String> -WebAccountId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Description <String>] [-Id <String>] [-Inference <IMicrosoftGraphInferenceData>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-Service <IMicrosoftGraphServiceInformation>] [-Source <IMicrosoftGraphPersonDataSources>]
 [-StatusMessage <String>] [-UserId1 <String>] [-WebUrl <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgUserProfileWebAccount [-UserId <String>] -InputObject <IPeopleIdentity>
 ...
 [-Source <IMicrosoftGraphPersonDataSources>] [-StatusMessage <String>] [-WebUrl <String>] [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilewebaccount](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilewebaccount)
