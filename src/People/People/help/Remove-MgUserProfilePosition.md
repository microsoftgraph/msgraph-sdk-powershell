...
### DeleteViaIdentity
```
Remove-MgUserProfilePosition -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mguserprofileposition](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mguserprofileposition)
