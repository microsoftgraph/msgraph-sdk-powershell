...
Update-MgUserProfilePatent -ItemPatentId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-IsPending] [-IssuedDate <DateTime>] [-IssuingAuthority <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilepatent](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilepatent)
