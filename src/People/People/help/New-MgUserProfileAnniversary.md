...
### Create
```
New-MgUserProfileAnniversary -UserId <String> -BodyParameter <IMicrosoftGraphPersonAnniversary> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofileanniversary](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofileanniversary)
