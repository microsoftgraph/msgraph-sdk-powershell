...
Update-MgUserProfileNote -PersonAnnotationId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastModifiedDateTime <DateTime>] [-Source <IMicrosoftGraphPersonDataSources>] [-PassThru] [-WhatIf]
...
Update-MgUserProfileNote -PersonAnnotationId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphPersonAnnotation> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilenote](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserprofilenote)
