...
New-MgUserProfileLanguage -UserId <String> [-AdditionalProperties <Hashtable>] [-AllowedAudiences <String>]
 ...
 [-Source <IMicrosoftGraphPersonDataSources>] [-Spoken <String>] [-Tag <String>] [-Written <String>] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilelanguage](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilelanguage)
