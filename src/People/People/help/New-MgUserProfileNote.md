...
### Create
```
New-MgUserProfileNote -UserId <String> -BodyParameter <IMicrosoftGraphPersonAnnotation> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
New-MgUserProfileNote -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-LastModifiedDateTime <DateTime>] [-Source <IMicrosoftGraphPersonDataSources>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserProfileNote -InputObject <IPeopleIdentity> -BodyParameter <IMicrosoftGraphPersonAnnotation> [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilenote](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilenote)
