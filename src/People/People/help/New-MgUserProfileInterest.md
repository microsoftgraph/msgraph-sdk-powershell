...
New-MgUserProfileInterest -UserId <String> [-AdditionalProperties <Hashtable>] [-AllowedAudiences <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-Source <IMicrosoftGraphPersonDataSources>] [-WebUrl <String>] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofileinterest](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofileinterest)
