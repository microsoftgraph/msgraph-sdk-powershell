...
New-MgUserProfileName -UserId <String> [-AdditionalProperties <Hashtable>] [-AllowedAudiences <String>]
 ...
 [-Pronunciation <IMicrosoftGraphYomiPersonName>] [-Source <IMicrosoftGraphPersonDataSources>]
...
```yaml
Type: IMicrosoftGraphYomiPersonName
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilename](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/new-mguserprofilename)
