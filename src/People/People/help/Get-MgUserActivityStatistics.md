...
### List (Default)
```
Get-MgUserActivityStatistics -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgUserActivityStatistics -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguseractivitystatistics](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguseractivitystatistics)
