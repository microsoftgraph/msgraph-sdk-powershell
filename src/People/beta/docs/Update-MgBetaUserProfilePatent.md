...
Update-MgBetaUserProfilePatent -ItemPatentId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Source <IMicrosoftGraphPersonDataSources>] [-WebUrl <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserProfilePatent -ItemPatentId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphItemPatent> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
