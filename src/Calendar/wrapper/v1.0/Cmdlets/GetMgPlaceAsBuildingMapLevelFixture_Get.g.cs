...
{
    [GraphRoute("GET", "/places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/{fixtureMap-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMapLevelFixture_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.FixtureMap))]
    public class GetMgPlaceAsBuildingMapLevelFixture_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.Levels[LevelMapId].Fixtures[FixtureMapId].GetAsync(requestConfiguration =>
                {
