...
{
    [GraphRoute("GET", "/users/{user-id}/calendars/{calendar-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserCalendar_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class GetMgUserCalendar_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendars[CalendarId].GetAsync(requestConfiguration =>
                {
