...
{
    [GraphRoute("GET", "/users/{user-id}/calendar/calendarView")]
    [Cmdlet(VerbsCommon.Get, "MgUserCalendarView")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Event))]
    public class GetMgUserCalendarViewCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendar.CalendarView.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Calendar.CalendarView.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
