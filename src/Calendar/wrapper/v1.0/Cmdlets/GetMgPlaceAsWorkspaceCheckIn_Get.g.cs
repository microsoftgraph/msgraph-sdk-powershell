...
{
    [GraphRoute("GET", "/places/{place-id}/graph.workspace/checkIns/{checkInClaim-calendarEventId}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsWorkspaceCheckIn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CheckInClaim))]
    public class GetMgPlaceAsWorkspaceCheckIn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphWorkspace.CheckIns[CheckInClaimCalendarEventId].GetAsync(requestConfiguration =>
                {
