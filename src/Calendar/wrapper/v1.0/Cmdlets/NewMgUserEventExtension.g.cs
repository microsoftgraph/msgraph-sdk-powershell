...
{
    [GraphRoute("POST", "/users/{user-id}/events/{event-id}/extensions")]
    [Cmdlet(VerbsCommon.New, "MgUserEventExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Extension))]
    public class NewMgUserEventExtensionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Events[EventId].Extensions.PostAsync(body, requestConfiguration =>
                {
