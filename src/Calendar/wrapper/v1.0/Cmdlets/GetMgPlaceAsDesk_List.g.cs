...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsDesk_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Desk))]
    public class GetMgPlaceAsDesk_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.DeskCollectionResponse? result;
            try
            {
                result = client.Places.GraphDesk.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphDesk.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
