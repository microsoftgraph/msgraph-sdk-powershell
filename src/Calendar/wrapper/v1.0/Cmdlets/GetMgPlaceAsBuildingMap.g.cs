...
{
    [GraphRoute("GET", "/places/{place-id}/graph.building/map")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMap")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.BuildingMap))]
    public class GetMgPlaceAsBuildingMapCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.GetAsync(requestConfiguration =>
                {
