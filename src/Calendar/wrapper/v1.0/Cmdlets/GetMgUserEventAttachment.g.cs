...
{
    [GraphRoute("GET", "/users/{user-id}/events/{event-id}/attachments")]
    ...
    public class GetMgUserEventAttachmentCommand : GraphClientCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserEventAttachment_Get" : "Get-MgUserEventAttachment_List";
            try
            {
