...
{
    [GraphRoute("POST", "/users/{user-id}/calendarGroups")]
    [Cmdlet(VerbsCommon.New, "MgUserCalendarGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CalendarGroup))]
    public class NewMgUserCalendarGroupCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Name)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].CalendarGroups.PostAsync(body, requestConfiguration =>
                {
