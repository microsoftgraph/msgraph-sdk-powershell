...
{
    [GraphRoute("GET", "/users/{user-id}/calendar")]
    [Cmdlet(VerbsCommon.Get, "MgUserDefaultCalendar")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class GetMgUserDefaultCalendarCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendar.GetAsync(requestConfiguration =>
                {
