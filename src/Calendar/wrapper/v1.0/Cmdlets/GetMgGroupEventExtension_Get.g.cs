...
{
    [GraphRoute("GET", "/groups/{group-id}/events/{event-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupEventExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Extension))]
    public class GetMgGroupEventExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Events[EventId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
