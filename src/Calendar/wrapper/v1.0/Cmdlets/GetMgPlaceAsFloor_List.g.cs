...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsFloor_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Floor))]
    public class GetMgPlaceAsFloor_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.FloorCollectionResponse? result;
            try
            {
                result = client.Places.GraphFloor.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphFloor.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
