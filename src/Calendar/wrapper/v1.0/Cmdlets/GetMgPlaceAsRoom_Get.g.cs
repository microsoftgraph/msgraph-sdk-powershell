...
{
    [GraphRoute("GET", "/places/{place-id}/graph.room")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoom_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Room))]
    public class GetMgPlaceAsRoom_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphRoom.GetAsync(requestConfiguration =>
                {
