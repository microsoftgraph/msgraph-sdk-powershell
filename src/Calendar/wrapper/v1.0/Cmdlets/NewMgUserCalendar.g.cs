...
{
    [GraphRoute("POST", "/users/{user-id}/calendars")]
    [Cmdlet(VerbsCommon.New, "MgUserCalendar", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class NewMgUserCalendarCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Owner)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendars.PostAsync(body, requestConfiguration =>
                {
