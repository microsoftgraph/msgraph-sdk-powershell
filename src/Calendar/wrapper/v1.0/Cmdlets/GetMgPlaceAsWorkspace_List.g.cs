...
{
    [GraphRoute("GET", "/places/graph.workspace")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsWorkspace_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Workspace))]
    public class GetMgPlaceAsWorkspace_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.WorkspaceCollectionResponse? result;
            try
            {
                result = client.Places.GraphWorkspace.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphWorkspace.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
