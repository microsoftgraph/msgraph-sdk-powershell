...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMapLevel_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.LevelMap))]
    public class GetMgPlaceAsBuildingMapLevel_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.LevelMapCollectionResponse? result;
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.Levels.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places[PlaceId].GraphBuilding.Map.Levels.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
