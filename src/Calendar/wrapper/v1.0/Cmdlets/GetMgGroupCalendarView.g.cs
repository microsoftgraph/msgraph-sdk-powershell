...
{
    [GraphRoute("GET", "/groups/{group-id}/calendar/calendarView")]
    [Cmdlet(VerbsCommon.Get, "MgGroupCalendarView")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Event))]
    public class GetMgGroupCalendarViewCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Calendar.CalendarView.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Calendar.CalendarView.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
