...
{
    [GraphRoute("GET", "/places/{place-id}/checkIns/{checkInClaim-calendarEventId}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceCheckIn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CheckInClaim))]
    public class GetMgPlaceCheckIn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].CheckIns[CheckInClaimCalendarEventId].GetAsync(requestConfiguration =>
                {
