...
{
    [GraphRoute("GET", "/users/{user-id}/events/{event-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserEvent_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Event))]
    public class GetMgUserEvent_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Events[EventId].GetAsync(requestConfiguration =>
                {
