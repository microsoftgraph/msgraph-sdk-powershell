...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMapFootprint_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.FootprintMap))]
    public class GetMgPlaceAsBuildingMapFootprint_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.FootprintMapCollectionResponse? result;
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.Footprints.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places[PlaceId].GraphBuilding.Map.Footprints.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
