...
{
    [GraphRoute("GET", "/users/{user-id}/calendar/events")]
    [Cmdlet(VerbsCommon.Get, "MgUserDefaultCalendarEvent")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Event))]
    public class GetMgUserDefaultCalendarEventCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendar.Events.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Calendar.Events.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
