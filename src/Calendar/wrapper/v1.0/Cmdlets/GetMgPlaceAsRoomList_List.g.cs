...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoomList_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.RoomList))]
    public class GetMgPlaceAsRoomList_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.RoomListCollectionResponse? result;
            try
            {
                result = client.Places.GraphRoomList.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphRoomList.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
