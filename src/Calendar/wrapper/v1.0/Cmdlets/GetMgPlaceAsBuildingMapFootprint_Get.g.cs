...
{
    [GraphRoute("GET", "/places/{place-id}/graph.building/map/footprints/{footprintMap-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMapFootprint_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.FootprintMap))]
    public class GetMgPlaceAsBuildingMapFootprint_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.Footprints[FootprintMapId].GetAsync(requestConfiguration =>
                {
