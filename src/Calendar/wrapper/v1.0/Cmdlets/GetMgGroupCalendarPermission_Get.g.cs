...
{
    [GraphRoute("GET", "/groups/{group-id}/calendar/calendarPermissions/{calendarPermission-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupCalendarPermission_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CalendarPermission))]
    public class GetMgGroupCalendarPermission_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Calendar.CalendarPermissions[CalendarPermissionId].GetAsync(requestConfiguration =>
                {
