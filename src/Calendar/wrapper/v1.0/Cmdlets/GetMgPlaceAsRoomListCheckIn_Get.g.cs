...
{
    [GraphRoute("GET", "/places/{place-id}/graph.roomList/checkIns/{checkInClaim-calendarEventId}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoomListCheckIn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CheckInClaim))]
    public class GetMgPlaceAsRoomListCheckIn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphRoomList.CheckIns[CheckInClaimCalendarEventId].GetAsync(requestConfiguration =>
                {
