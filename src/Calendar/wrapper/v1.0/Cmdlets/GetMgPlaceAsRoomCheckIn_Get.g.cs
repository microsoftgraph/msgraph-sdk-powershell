...
{
    [GraphRoute("GET", "/places/{place-id}/graph.room/checkIns/{checkInClaim-calendarEventId}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoomCheckIn_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CheckInClaim))]
    public class GetMgPlaceAsRoomCheckIn_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphRoom.CheckIns[CheckInClaimCalendarEventId].GetAsync(requestConfiguration =>
                {
