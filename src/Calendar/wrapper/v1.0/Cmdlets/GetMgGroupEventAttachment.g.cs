...
{
    [GraphRoute("GET", "/groups/{group-id}/events/{event-id}/attachments")]
    [Cmdlet(VerbsCommon.Get, "MgGroupEventAttachment", DefaultParameterSetName = "List")]
    ...
    public class GetMgGroupEventAttachmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgGroupEventAttachment_Get or Get-MgGroupEventAttachment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgGroupEventAttachment_Get" : "Get-MgGroupEventAttachment_List";
            try
            {
