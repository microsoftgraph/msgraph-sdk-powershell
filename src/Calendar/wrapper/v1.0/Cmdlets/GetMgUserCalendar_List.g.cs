...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserCalendar_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class GetMgUserCalendar_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.CalendarCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Calendars.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Calendars.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
