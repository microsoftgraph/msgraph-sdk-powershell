...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupEventExtension_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Extension))]
    public class GetMgGroupEventExtension_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.ExtensionCollectionResponse? result;
            try
            {
                result = client.Groups[GroupId].Events[EventId].Extensions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Groups[GroupId].Events[EventId].Extensions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
