...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    public class GetMgPlaceAsBuildingMapLevelSection_GetCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, SectionMapId));
                return;
            }
