...
{
    [GraphRoute("GET", "/groups/{group-id}/events/{event-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupEvent_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Event))]
    public class GetMgGroupEvent_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Events[EventId].GetAsync(requestConfiguration =>
                {
