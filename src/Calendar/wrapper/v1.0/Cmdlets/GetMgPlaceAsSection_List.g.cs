...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsSection_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Section))]
    public class GetMgPlaceAsSection_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.SectionCollectionResponse? result;
            try
            {
                result = client.Places.GraphSection.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphSection.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
