...
{
    [GraphRoute("GET", "/places/{place-id}/graph.workspace")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsWorkspace_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Workspace))]
    public class GetMgPlaceAsWorkspace_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphWorkspace.GetAsync(requestConfiguration =>
                {
