...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuilding_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Building))]
    public class GetMgPlaceAsBuilding_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.BuildingCollectionResponse? result;
            try
            {
                result = client.Places.GraphBuilding.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places.GraphBuilding.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
