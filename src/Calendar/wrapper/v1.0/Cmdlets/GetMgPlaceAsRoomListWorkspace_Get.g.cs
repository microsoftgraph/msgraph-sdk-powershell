...
{
    [GraphRoute("GET", "/places/{place-id}/graph.roomList/workspaces/{workspace-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoomListWorkspace_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Workspace))]
    public class GetMgPlaceAsRoomListWorkspace_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphRoomList.Workspaces[WorkspaceId].GetAsync(requestConfiguration =>
                {
