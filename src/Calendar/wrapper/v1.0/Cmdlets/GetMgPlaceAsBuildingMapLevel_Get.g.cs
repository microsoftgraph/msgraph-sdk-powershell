...
{
    [GraphRoute("GET", "/places/{place-id}/graph.building/map/levels/{levelMap-id}")]
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsBuildingMapLevel_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.LevelMap))]
    public class GetMgPlaceAsBuildingMapLevel_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Places[PlaceId].GraphBuilding.Map.Levels[LevelMapId].GetAsync(requestConfiguration =>
                {
