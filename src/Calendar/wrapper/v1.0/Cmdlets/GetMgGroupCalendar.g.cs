...
{
    [GraphRoute("GET", "/groups/{group-id}/calendar")]
    [Cmdlet(VerbsCommon.Get, "MgGroupCalendar")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class GetMgGroupCalendarCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Calendar.GetAsync(requestConfiguration =>
                {
