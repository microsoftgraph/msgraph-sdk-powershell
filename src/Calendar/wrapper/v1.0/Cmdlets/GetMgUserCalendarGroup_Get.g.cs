...
{
    [GraphRoute("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserCalendarGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CalendarGroup))]
    public class GetMgUserCalendarGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].CalendarGroups[CalendarGroupId].GetAsync(requestConfiguration =>
                {
