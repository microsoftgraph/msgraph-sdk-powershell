...
{
    [GraphRoute("GET", "/users/{user-id}/events/{event-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserEventExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Extension))]
    public class GetMgUserEventExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Events[EventId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
