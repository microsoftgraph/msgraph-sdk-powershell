...
{
    [GraphRoute("GET", "/groups/{group-id}/events/{event-id}/calendar")]
    [Cmdlet(VerbsCommon.Get, "MgGroupEventCalendar")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Calendar))]
    public class GetMgGroupEventCalendarCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Events[EventId].Calendar.GetAsync(requestConfiguration =>
                {
