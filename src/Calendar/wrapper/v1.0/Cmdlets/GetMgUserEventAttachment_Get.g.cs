...
{
    [GraphRoute("GET", "/users/{user-id}/events/{event-id}/attachments/{attachment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserEventAttachment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Attachment))]
    public class GetMgUserEventAttachment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Events[EventId].Attachments[AttachmentId].GetAsync(requestConfiguration =>
                {
