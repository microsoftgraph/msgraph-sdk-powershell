...
{
    [GraphRoute("GET", "/groups/{group-id}/events/{event-id}/attachments/{attachment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgGroupEventAttachment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Attachment))]
    public class GetMgGroupEventAttachment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Events[EventId].Attachments[AttachmentId].GetAsync(requestConfiguration =>
                {
