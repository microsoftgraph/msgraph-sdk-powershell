...
{
    [GraphRoute("GET", "/users/{user-id}/calendar/calendarPermissions/{calendarPermission-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserCalendarPermission_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.CalendarPermission))]
    public class GetMgUserCalendarPermission_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Calendar.CalendarPermissions[CalendarPermissionId].GetAsync(requestConfiguration =>
                {
