...
{
    [GraphRoute("GET", "/users/{user-id}/events/{event-id}/instances/delta()")]
    [Cmdlet(VerbsCommon.Get, "MgUserEventInstanceDelta", DefaultParameterSetName = "DeltaSync")]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Calendar.Client.Users.Item.Events.Item.Instances.Delta.DeltaGetResponse))]
    public class GetMgUserEventInstanceDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Calendar.Client.Users.Item.Events.Item.Instances.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Users[UserId].Events[EventId].Instances.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Users[UserId].Events[EventId].Instances.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
