...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgPlaceAsRoomListRoom_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Calendar.Client.Models.Room))]
    public class GetMgPlaceAsRoomListRoom_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Calendar.Client.Models.RoomCollectionResponse? result;
            try
            {
                result = client.Places[PlaceId].GraphRoomList.Rooms.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Places[PlaceId].GraphRoomList.Rooms.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
