...
namespace Microsoft.Graph.PowerShell.Calendar
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgGroupEventInstanceDelta")]
    ...
    public class GetMgGroupEventInstanceDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Groups[GroupId].Events[EventId].Instances.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
