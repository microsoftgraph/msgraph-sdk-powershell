...
### Get (Default)
```
Get-MgBetaGroupEventCalendar -EventId <String> -GroupId <String> [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupEventCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [<CommonParameters>]
```
