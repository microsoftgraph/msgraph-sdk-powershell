...
```
Update-MgBetaUserEventExceptionOccurrenceInstanceSingleValueExtendedProperty -EventId <String> -EventId1 <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserEventExceptionOccurrenceInstanceSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
