...
### List (Default)
```
Get-MgGroupEventExceptionOccurrenceInstance -EventId <String> -EventId1 <String> -GroupId <String> [-Count]
...
### GetViaIdentity
```
Get-MgGroupEventExceptionOccurrenceInstance -InputObject <ICalendarIdentity> [-Property <String[]>]
 [<CommonParameters>]
```
