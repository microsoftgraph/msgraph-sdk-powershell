...
```
Update-MgBetaUserEventSingleValueExtendedProperty -EventId <String> -SingleValueLegacyExtendedPropertyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserEventSingleValueExtendedProperty -InputObject <ICalendarIdentity>
