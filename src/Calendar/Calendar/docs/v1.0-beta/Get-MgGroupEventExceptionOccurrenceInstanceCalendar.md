...
### Get (Default)
```
Get-MgGroupEventExceptionOccurrenceInstanceCalendar -EventId <String> -EventId1 <String> -EventId2 <String>
 -GroupId <String> [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventExceptionOccurrenceInstanceCalendar -InputObject <ICalendarIdentity> [-Property <String[]>]
 [<CommonParameters>]
```
