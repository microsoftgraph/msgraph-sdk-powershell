...
### Get (Default)
```
Get-MgBetaUserEventInstanceCalendar -EventId <String> -EventId1 <String> -UserId <String> [-Property <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserEventInstanceCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [<CommonParameters>]
```
