...
```
Update-MgBetaUserCalendarMultiValueExtendedProperty -MultiValueLegacyExtendedPropertyId <String> -UserId <String>
...
### Update1
```
Update-MgBetaUserCalendarMultiValueExtendedProperty -CalendarId <String>
