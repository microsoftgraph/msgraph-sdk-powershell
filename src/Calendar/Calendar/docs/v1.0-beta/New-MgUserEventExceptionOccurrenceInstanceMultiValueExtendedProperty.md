...
```
New-MgUserEventExceptionOccurrenceInstanceMultiValueExtendedProperty -EventId <String> -EventId1 <String>
...
### CreateViaIdentity
```
New-MgUserEventExceptionOccurrenceInstanceMultiValueExtendedProperty -InputObject <ICalendarIdentity>
