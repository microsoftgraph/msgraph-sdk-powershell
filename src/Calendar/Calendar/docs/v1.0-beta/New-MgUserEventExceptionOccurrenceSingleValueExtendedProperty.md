...
```
New-MgBetaUserEventExceptionOccurrenceSingleValueExtendedProperty -EventId <String> -EventId1 <String>
...
### CreateViaIdentity
```
New-MgBetaUserEventExceptionOccurrenceSingleValueExtendedProperty -InputObject <ICalendarIdentity>
