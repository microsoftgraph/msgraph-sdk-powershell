...
Remove-MgBetaGroupEventInstanceExceptionOccurrenceAttachment -AttachmentId <String> -EventId <String>
 -EventId1 <String> -EventId2 <String> -GroupId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupEventInstanceExceptionOccurrenceAttachment -InputObject <ICalendarIdentity> [-IfMatch <String>]
