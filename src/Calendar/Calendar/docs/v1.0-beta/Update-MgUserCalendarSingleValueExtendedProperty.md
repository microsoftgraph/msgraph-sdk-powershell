...
```
Update-MgBetaUserCalendarSingleValueExtendedProperty -SingleValueLegacyExtendedPropertyId <String>
...
### Update1
```
Update-MgBetaUserCalendarSingleValueExtendedProperty -CalendarId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserCalendarSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
