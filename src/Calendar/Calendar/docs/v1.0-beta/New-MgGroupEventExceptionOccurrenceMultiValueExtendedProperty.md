...
```
New-MgGroupEventExceptionOccurrenceMultiValueExtendedProperty -EventId <String> -EventId1 <String>
...
### CreateViaIdentity
```
New-MgGroupEventExceptionOccurrenceMultiValueExtendedProperty -InputObject <ICalendarIdentity>
