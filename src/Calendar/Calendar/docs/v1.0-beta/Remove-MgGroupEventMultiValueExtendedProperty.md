...
### Delete (Default)
```
Remove-MgBetaGroupEventMultiValueExtendedProperty -EventId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaGroupEventMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-IfMatch <String>] [-PassThru]
