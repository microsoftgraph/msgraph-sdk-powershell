...
### Create
```
New-MgBetaGroupCalendarEvent -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaGroupCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent> [-Confirm]
