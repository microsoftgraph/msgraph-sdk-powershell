...
### Get (Default)
```
Get-MgBetaGroupCalendar -GroupId <String> [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupCalendar -InputObject <ICalendarIdentity> [-Property <String[]>]
