...
### Get (Default)
```
Get-MgBetaGroupCalendar -GroupId <String> [-Property <String[]>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
