...
### Delete (Default)
```
Remove-MgBetaPlaceWorkspace -PlaceId <String> -WorkspaceId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlaceWorkspace -InputObject <ICalendarIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
