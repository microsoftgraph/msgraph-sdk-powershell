...
### Delete (Default)
```
Remove-MgBetaPlace -PlaceId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlace -InputObject <ICalendarIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
