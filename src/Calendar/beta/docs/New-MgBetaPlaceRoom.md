...
### Create
```
New-MgBetaPlaceRoom -PlaceId <String> -BodyParameter <IMicrosoftGraphRoom> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaPlaceRoom -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphRoom> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
