...
### Get (Default)
```
Get-MgUserEventCalendar -EventId <String> -UserId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserEventCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
