...
### Get (Default)
```
Get-MgGroupEventCalendar -EventId <String> -GroupId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
