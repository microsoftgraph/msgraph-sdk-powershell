...
### Get (Default)
```
Get-MgGroupCalendar -GroupId <String> [-Property <String[]>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
