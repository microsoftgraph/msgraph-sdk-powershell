...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.sharedresources/get-mgusermobileapptroubleshootingevent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserMobileAppTroubleshootingEvent -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserMobileAppTroubleshootingEvent -InputObject <IDevicesAppsSharedResourcesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
