...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicesapps.sharedresources/get-mgusermobileapptroubleshootingeventapplogcollectionrequest
schema: 2.0.0
---
...
Get-MgUserMobileAppTroubleshootingEventAppLogCollectionRequest -AppLogCollectionRequestId <String>
 -MobileAppTroubleshootingEventId <String> -UserId <String> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
...
```
Get-MgUserMobileAppTroubleshootingEventAppLogCollectionRequest
 -InputObject <IDevicesAppsSharedResourcesIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
