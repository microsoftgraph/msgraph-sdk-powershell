...
### GetViaIdentity
```
Get-MgUserPhoto -InputObject <IUsersProfilePhotoIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
### List
```
Get-MgUserPhoto -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
