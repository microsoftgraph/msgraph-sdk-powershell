...
### List (Default)
```
Get-MgUserScopedRoleMember -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserScopedRoleMember -InputObject <IIdentityAdministrativeUnitsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
