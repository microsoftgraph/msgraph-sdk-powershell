...
### List (Default)
```
Get-MgAdministrativeUnit [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-PageSize <Int32>]
...
### GetViaIdentity
```
Get-MgAdministrativeUnit -InputObject <IIdentityAdministrativeUnitsIdentity> [-ExpandProperty <String[]>]
