...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.administrativeunits/remove-mgadministrativeunit
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgAdministrativeUnit -InputObject <IIdentityAdministrativeUnitsIdentity> [-IfMatch <String>]
