...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/new-mgbetarolemanagementexchangetransitiveroleassignment
schema: 2.0.0
---
...
```
New-MgBetaRoleManagementExchangeTransitiveRoleAssignment [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaRoleManagementExchangeTransitiveRoleAssignment -BodyParameter <IMicrosoftGraphUnifiedRoleAssignment>
