...
New-MgBetaDeviceManagementAndroidForWorkEnrollmentProfile [-AccountId <String>]
 ...
 [-QrCodeContent <String>] [-QrCodeImage <IMicrosoftGraphMimeContent>] [-ResponseHeadersVariable <String>]
 [-TokenExpirationDateTime <DateTime>] [-TokenValue <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
