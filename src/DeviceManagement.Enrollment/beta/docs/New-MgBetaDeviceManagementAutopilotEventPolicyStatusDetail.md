...
New-MgBetaDeviceManagementAutopilotEventPolicyStatusDetail -DeviceManagementAutopilotEventId <String>
 ...
 [-Id <String>] [-LastReportedDateTime <DateTime>] [-PolicyType <String>] [-ResponseHeadersVariable <String>]
 [-TrackedOnEnrollmentStatus] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
