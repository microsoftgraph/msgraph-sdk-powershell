...
New-MgBetaDeviceManagementAppleUserInitiatedEnrollmentProfile [-AdditionalProperties <Hashtable>]
 ...
 [-Platform <DevicePlatformType>] [-Priority <Int32>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementAppleUserInitiatedEnrollmentProfile
 -BodyParameter <IMicrosoftGraphAppleUserInitiatedEnrollmentProfile> [-Headers <IDictionary>] [-Confirm]
