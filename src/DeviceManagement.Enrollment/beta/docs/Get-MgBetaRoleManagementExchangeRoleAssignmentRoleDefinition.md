...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementexchangeroleassignmentroledefinition
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementExchangeRoleAssignmentRoleDefinition -UnifiedRoleAssignmentId <String>
