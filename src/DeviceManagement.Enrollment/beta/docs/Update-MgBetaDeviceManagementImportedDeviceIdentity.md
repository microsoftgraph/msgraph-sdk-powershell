...
Update-MgBetaDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-Platform <Platform>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String>
 -BodyParameter <IMicrosoftGraphImportedDeviceIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
