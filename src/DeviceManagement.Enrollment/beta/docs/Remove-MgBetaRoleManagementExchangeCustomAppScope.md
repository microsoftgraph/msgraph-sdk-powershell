...
### Delete (Default)
```
Remove-MgBetaRoleManagementExchangeCustomAppScope -CustomAppScopeId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaRoleManagementExchangeCustomAppScope -InputObject <IDeviceManagementEnrollmentIdentity>
