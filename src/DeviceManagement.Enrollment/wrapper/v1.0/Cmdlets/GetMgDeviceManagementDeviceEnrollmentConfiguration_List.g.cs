...
{
    [GraphRoute("GET", "/deviceManagement/deviceEnrollmentConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDeviceEnrollmentConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceEnrollmentConfiguration))]
    public class GetMgDeviceManagementDeviceEnrollmentConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceEnrollmentConfigurationCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DeviceEnrollmentConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DeviceEnrollmentConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
