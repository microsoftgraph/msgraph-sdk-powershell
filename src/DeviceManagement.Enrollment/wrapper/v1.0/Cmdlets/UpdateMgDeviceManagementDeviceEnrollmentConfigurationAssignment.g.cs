...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    public class UpdateMgDeviceManagementDeviceEnrollmentConfigurationAssignmentCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Target)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, EnrollmentConfigurationAssignmentId));
                return;
            }
