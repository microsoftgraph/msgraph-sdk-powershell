...
{
    [GraphRoute("GET", "/roleManagement")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagement")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.RoleManagement))]
    public class GetMgRoleManagementCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.GetAsync(requestConfiguration =>
                {
