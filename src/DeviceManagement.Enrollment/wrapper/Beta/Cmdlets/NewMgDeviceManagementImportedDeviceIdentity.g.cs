...
{
    [GraphRoute("POST", "/deviceManagement/importedDeviceIdentities")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementImportedDeviceIdentity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.ImportedDeviceIdentity))]
    public class NewMgDeviceManagementImportedDeviceIdentityCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Platform)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.ImportedDeviceIdentities.PostAsync(body, requestConfiguration =>
                {
