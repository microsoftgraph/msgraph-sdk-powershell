...
{
    [GraphRoute("GET", "/deviceManagement/depOnboardingSettings")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDepOnboardingSetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DepOnboardingSetting))]
    public class GetMgDeviceManagementDepOnboardingSetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DepOnboardingSettingCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DepOnboardingSettings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DepOnboardingSettings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
