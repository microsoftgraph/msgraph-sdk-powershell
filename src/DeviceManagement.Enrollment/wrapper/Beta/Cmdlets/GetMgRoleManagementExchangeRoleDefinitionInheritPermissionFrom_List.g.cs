...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementExchangeRoleDefinitionInheritPermissionFrom_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementExchangeRoleDefinitionInheritPermissionFrom_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Exchange.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Exchange.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
