...
{
    [GraphRoute("POST", "/deviceManagement/depOnboardingSettings")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDepOnboardingSetting", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DepOnboardingSetting))]
    public class NewMgDeviceManagementDepOnboardingSettingCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(TokenType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DepOnboardingSettings.PostAsync(body, requestConfiguration =>
                {
