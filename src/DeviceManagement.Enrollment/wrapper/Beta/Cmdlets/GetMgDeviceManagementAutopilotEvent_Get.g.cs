...
{
    [GraphRoute("GET", "/deviceManagement/autopilotEvents/{deviceManagementAutopilotEvent-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAutopilotEvent_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceManagementAutopilotEvent))]
    public class GetMgDeviceManagementAutopilotEvent_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.AutopilotEvents[DeviceManagementAutopilotEventId].GetAsync(requestConfiguration =>
                {
