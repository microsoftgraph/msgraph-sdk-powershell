...
{
    [GraphRoute("POST", "/deviceManagement/autopilotEvents")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementAutopilotEvent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceManagementAutopilotEvent))]
    public class NewMgDeviceManagementAutopilotEventCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(EnrollmentType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.AutopilotEvents.PostAsync(body, requestConfiguration =>
                {
