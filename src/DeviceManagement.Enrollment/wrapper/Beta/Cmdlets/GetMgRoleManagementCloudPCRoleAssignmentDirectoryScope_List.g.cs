...
{
    [GraphRoute("GET", "/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple-id}/directoryScopes")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementCloudPCRoleAssignmentDirectoryScope_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DirectoryObject))]
    public class GetMgRoleManagementCloudPCRoleAssignmentDirectoryScope_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.RoleAssignments[UnifiedRoleAssignmentMultipleId].DirectoryScopes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.CloudPC.RoleAssignments[UnifiedRoleAssignmentMultipleId].DirectoryScopes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
