...
{
    [GraphRoute("GET", "/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple-id}/directoryScopes")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDeviceManagementRoleAssignmentDirectoryScope_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DirectoryObject))]
    public class GetMgRoleManagementDeviceManagementRoleAssignmentDirectoryScope_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DirectoryObjectCollectionResponse? result;
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleAssignments[UnifiedRoleAssignmentMultipleId].DirectoryScopes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.DeviceManagement.RoleAssignments[UnifiedRoleAssignmentMultipleId].DirectoryScopes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
