...
{
    [GraphRoute("GET", "/deviceManagement/windowsFeatureUpdateProfiles/{windowsFeatureUpdateProfile-id}/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementWindowsFeatureUpdateProfileAssignment_List")]
    ...
    public class GetMgDeviceManagementWindowsFeatureUpdateProfileAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsFeatureUpdateProfileAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.WindowsFeatureUpdateProfiles[WindowsFeatureUpdateProfileId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.WindowsFeatureUpdateProfiles[WindowsFeatureUpdateProfileId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
