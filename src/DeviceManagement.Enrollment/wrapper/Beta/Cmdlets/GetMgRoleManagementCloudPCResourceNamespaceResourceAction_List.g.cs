...
{
    [GraphRoute("GET", "/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace-id}/resourceActions")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementCloudPCResourceNamespaceResourceAction_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceAction))]
    public class GetMgRoleManagementCloudPCResourceNamespaceResourceAction_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceActionCollectionResponse? result;
            try
            {
                result = client.RoleManagement.CloudPC.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.CloudPC.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
