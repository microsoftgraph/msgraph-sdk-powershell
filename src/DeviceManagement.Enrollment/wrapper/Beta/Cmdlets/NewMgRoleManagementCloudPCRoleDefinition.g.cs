...
{
    [GraphRoute("POST", "/roleManagement/cloudPC/roleDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementCloudPCRoleDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class NewMgRoleManagementCloudPCRoleDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RolePermissions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.RoleDefinitions.PostAsync(body, requestConfiguration =>
                {
