...
{
    [GraphRoute("POST", "/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile-id}/assignedDevices")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementWindowsAutopilotDeploymentProfileAssignedDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsAutopilotDeviceIdentity))]
    public class NewMgDeviceManagementWindowsAutopilotDeploymentProfileAssignedDeviceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(UserlessEnrollmentStatus)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.WindowsAutopilotDeploymentProfiles[WindowsAutopilotDeploymentProfileId].AssignedDevices.PostAsync(body, requestConfiguration =>
                {
