...
{
    [GraphRoute("POST", "/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace-id}/resourceActions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementExchangeResourceNamespaceResourceAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceAction))]
    public class NewMgRoleManagementExchangeResourceNamespaceResourceActionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ResourceScopeId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Exchange.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.PostAsync(body, requestConfiguration =>
                {
