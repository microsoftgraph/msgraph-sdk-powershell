...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDeviceManagementRoleAssignmentAppScope_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AppScope))]
    public class GetMgRoleManagementDeviceManagementRoleAssignmentAppScope_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleAssignments[UnifiedRoleAssignmentMultipleId].AppScopes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.DeviceManagement.RoleAssignments[UnifiedRoleAssignmentMultipleId].AppScopes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
