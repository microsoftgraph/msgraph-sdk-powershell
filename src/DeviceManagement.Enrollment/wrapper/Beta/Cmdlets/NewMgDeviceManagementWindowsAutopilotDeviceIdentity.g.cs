...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    public class NewMgDeviceManagementWindowsAutopilotDeviceIdentityCommand : GraphClientCmdlet
    {
        ...
        [Parameter(Mandatory = false)]
        public global::System.DateTimeOffset? DeploymentProfileAssignedDateTime { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public global::System.DateTimeOffset? RemediationStateLastModifiedDateTime { get; set; }
        ...
        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsAutopilotProfileAssignmentDetailedStatus? DeploymentProfileAssignmentDetailedStatus { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsAutopilotProfileAssignmentStatus? DeploymentProfileAssignmentStatus { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.EnrollmentState? EnrollmentState { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsAutopilotDeviceRemediationState? RemediationState { get; set; }

        [Parameter(Mandatory = false)]
        public Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.WindowsAutopilotUserlessEnrollmentStatus? UserlessEnrollmentStatus { get; set; }
    ...
    if (this.IsParameterBound(nameof(DeploymentProfileAssignedDateTime)))
        body.DeploymentProfileAssignedDateTime = DeploymentProfileAssignedDateTime;
    ...
    if (this.IsParameterBound(nameof(RemediationStateLastModifiedDateTime)))
        body.RemediationStateLastModifiedDateTime = RemediationStateLastModifiedDateTime;
    ...
    if (this.IsParameterBound(nameof(DeploymentProfileAssignmentDetailedStatus)))
        body.DeploymentProfileAssignmentDetailedStatus = DeploymentProfileAssignmentDetailedStatus;

    if (this.IsParameterBound(nameof(DeploymentProfileAssignmentStatus)))
        body.DeploymentProfileAssignmentStatus = DeploymentProfileAssignmentStatus;
    ...
    if (this.IsParameterBound(nameof(UserlessEnrollmentStatus)))
        body.UserlessEnrollmentStatus = UserlessEnrollmentStatus;
