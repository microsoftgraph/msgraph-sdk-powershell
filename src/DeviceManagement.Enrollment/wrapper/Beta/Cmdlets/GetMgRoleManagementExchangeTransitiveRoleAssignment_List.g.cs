...
{
    [GraphRoute("GET", "/roleManagement/exchange/transitiveRoleAssignments")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementExchangeTransitiveRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignment))]
    public class GetMgRoleManagementExchangeTransitiveRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignmentCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Exchange.TransitiveRoleAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Exchange.TransitiveRoleAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
