...
{
    [GraphRoute("GET", "/roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDeviceManagementRoleDefinitionInheritPermissionFrom_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementDeviceManagementRoleDefinitionInheritPermissionFrom_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.DeviceManagement.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
