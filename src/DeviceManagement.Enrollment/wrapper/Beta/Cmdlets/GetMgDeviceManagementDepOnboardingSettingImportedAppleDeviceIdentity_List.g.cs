...
{
    [GraphRoute("GET", "/deviceManagement/depOnboardingSettings/{depOnboardingSetting-id}/importedAppleDeviceIdentities")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementDepOnboardingSettingImportedAppleDeviceIdentity_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.ImportedAppleDeviceIdentity))]
    public class GetMgDeviceManagementDepOnboardingSettingImportedAppleDeviceIdentity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.ImportedAppleDeviceIdentityCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.DepOnboardingSettings[DepOnboardingSettingId].ImportedAppleDeviceIdentities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.DepOnboardingSettings[DepOnboardingSettingId].ImportedAppleDeviceIdentities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
