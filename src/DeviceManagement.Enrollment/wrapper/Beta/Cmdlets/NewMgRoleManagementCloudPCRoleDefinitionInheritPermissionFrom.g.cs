...
{
    [GraphRoute("POST", "/roleManagement/cloudPC/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementCloudPCRoleDefinitionInheritPermissionFrom", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class NewMgRoleManagementCloudPCRoleDefinitionInheritPermissionFromCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RolePermissions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.RoleDefinitions[UnifiedRoleDefinitionId].InheritsPermissionsFrom.PostAsync(body, requestConfiguration =>
                {
