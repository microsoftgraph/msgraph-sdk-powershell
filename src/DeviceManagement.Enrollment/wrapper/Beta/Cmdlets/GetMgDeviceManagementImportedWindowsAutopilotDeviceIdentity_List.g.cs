...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementImportedWindowsAutopilotDeviceIdentity_List")]
    ...
    public class GetMgDeviceManagementImportedWindowsAutopilotDeviceIdentity_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.ImportedWindowsAutopilotDeviceIdentityCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
