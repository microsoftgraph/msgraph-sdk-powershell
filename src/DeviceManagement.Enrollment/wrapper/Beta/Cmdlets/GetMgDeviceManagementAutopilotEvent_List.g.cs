...
{
    [GraphRoute("GET", "/deviceManagement/autopilotEvents")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAutopilotEvent_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceManagementAutopilotEvent))]
    public class GetMgDeviceManagementAutopilotEvent_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DeviceManagementAutopilotEventCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AutopilotEvents.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AutopilotEvents.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
