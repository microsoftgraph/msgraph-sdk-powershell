...
{
    [GraphRoute("GET", "/roleManagement/exchange/resourceNamespaces")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementExchangeResourceNamespace_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceNamespace))]
    public class GetMgRoleManagementExchangeResourceNamespace_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceNamespaceCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Exchange.ResourceNamespaces.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Exchange.ResourceNamespaces.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
