...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAndroidDeviceOwnerEnrollmentProfile_List")]
    ...
    public class GetMgDeviceManagementAndroidDeviceOwnerEnrollmentProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AndroidDeviceOwnerEnrollmentProfileCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
