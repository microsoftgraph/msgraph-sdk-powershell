...
{
    [GraphRoute("GET", "/roleManagement/deviceManagement/roleDefinitions")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDeviceManagementRoleDefinition_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class GetMgRoleManagementDeviceManagementRoleDefinition_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinitionCollectionResponse? result;
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleDefinitions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.DeviceManagement.RoleDefinitions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
