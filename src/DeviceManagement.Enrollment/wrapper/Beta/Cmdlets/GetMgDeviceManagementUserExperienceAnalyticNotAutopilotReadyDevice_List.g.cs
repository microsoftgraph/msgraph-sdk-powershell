...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice_List")]
    ...
    public class GetMgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UserExperienceAnalyticsNotAutopilotReadyDeviceCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.UserExperienceAnalyticsNotAutopilotReadyDevice.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.UserExperienceAnalyticsNotAutopilotReadyDevice.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
