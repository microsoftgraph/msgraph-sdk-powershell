...
{
    [GraphRoute("POST", "/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace-id}/resourceActions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementCloudPCResourceNamespaceResourceAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRbacResourceAction))]
    public class NewMgRoleManagementCloudPCResourceNamespaceResourceActionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(ResourceScopeId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.ResourceNamespaces[UnifiedRbacResourceNamespaceId].ResourceActions.PostAsync(body, requestConfiguration =>
                {
