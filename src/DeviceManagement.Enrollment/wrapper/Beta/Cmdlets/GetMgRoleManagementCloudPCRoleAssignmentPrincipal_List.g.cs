...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementCloudPCRoleAssignmentPrincipal_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.DirectoryObject))]
    public class GetMgRoleManagementCloudPCRoleAssignmentPrincipal_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.RoleAssignments[UnifiedRoleAssignmentMultipleId].Principals.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.CloudPC.RoleAssignments[UnifiedRoleAssignmentMultipleId].Principals.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
