...
{
    [GraphRoute("POST", "/deviceManagement/userExperienceAnalyticsNotAutopilotReadyDevice")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDeviceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SerialNumber)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.UserExperienceAnalyticsNotAutopilotReadyDevice.PostAsync(body, requestConfiguration =>
                {
