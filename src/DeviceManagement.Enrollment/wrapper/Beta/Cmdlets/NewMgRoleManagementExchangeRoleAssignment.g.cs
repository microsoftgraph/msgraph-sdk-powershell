...
{
    [GraphRoute("POST", "/roleManagement/exchange/roleAssignments")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementExchangeRoleAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignment))]
    public class NewMgRoleManagementExchangeRoleAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RoleDefinitionId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.Exchange.RoleAssignments.PostAsync(body, requestConfiguration =>
                {
