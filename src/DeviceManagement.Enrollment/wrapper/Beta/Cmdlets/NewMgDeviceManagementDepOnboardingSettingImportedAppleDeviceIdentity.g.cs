...
{
    [GraphRoute("POST", "/deviceManagement/depOnboardingSettings/{depOnboardingSetting-id}/importedAppleDeviceIdentities")]
    [Cmdlet(VerbsCommon.New, "MgDeviceManagementDepOnboardingSettingImportedAppleDeviceIdentity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.ImportedAppleDeviceIdentity))]
    public class NewMgDeviceManagementDepOnboardingSettingImportedAppleDeviceIdentityCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Platform)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DeviceManagement.DepOnboardingSettings[DepOnboardingSettingId].ImportedAppleDeviceIdentities.PostAsync(body, requestConfiguration =>
                {
