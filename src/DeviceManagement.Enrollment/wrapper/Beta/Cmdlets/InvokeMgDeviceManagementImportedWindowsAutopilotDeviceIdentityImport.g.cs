...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementImportedWindowsAutopilotDeviceIdentityImport", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDeviceManagementImportedWindowsAutopilotDeviceIdentityImportCommand : GraphClientCmdlet
    {
