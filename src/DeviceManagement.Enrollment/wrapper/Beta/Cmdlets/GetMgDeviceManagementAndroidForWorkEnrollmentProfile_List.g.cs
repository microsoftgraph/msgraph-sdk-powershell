...
{
    [GraphRoute("GET", "/deviceManagement/androidForWorkEnrollmentProfiles")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAndroidForWorkEnrollmentProfile_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AndroidForWorkEnrollmentProfile))]
    public class GetMgDeviceManagementAndroidForWorkEnrollmentProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AndroidForWorkEnrollmentProfileCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AndroidForWorkEnrollmentProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AndroidForWorkEnrollmentProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
