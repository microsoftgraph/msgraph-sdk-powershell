...
{
    [GraphRoute("POST", "/roleManagement/deviceManagement/roleDefinitions")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementDeviceManagementRoleDefinition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleDefinition))]
    public class NewMgRoleManagementDeviceManagementRoleDefinitionCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RolePermissions)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleDefinitions.PostAsync(body, requestConfiguration =>
                {
