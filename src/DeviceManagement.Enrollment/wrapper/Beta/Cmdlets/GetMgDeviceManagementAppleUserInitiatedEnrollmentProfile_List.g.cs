...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAppleUserInitiatedEnrollmentProfile_List")]
    ...
    public class GetMgDeviceManagementAppleUserInitiatedEnrollmentProfile_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AppleUserInitiatedEnrollmentProfileCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AppleUserInitiatedEnrollmentProfiles.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AppleUserInitiatedEnrollmentProfiles.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
