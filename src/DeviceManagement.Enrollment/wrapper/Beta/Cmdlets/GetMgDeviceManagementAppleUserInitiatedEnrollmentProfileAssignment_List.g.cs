...
{
    [GraphRoute("GET", "/deviceManagement/appleUserInitiatedEnrollmentProfiles/{appleUserInitiatedEnrollmentProfile-id}/assignments")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementAppleUserInitiatedEnrollmentProfileAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AppleEnrollmentProfileAssignment))]
    public class GetMgDeviceManagementAppleUserInitiatedEnrollmentProfileAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.AppleEnrollmentProfileAssignmentCollectionResponse? result;
            try
            {
                result = client.DeviceManagement.AppleUserInitiatedEnrollmentProfiles[AppleUserInitiatedEnrollmentProfileId].Assignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DeviceManagement.AppleUserInitiatedEnrollmentProfiles[AppleUserInitiatedEnrollmentProfileId].Assignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
