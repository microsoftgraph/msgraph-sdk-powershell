...
{
    [GraphRoute("GET", "/roleManagement/exchange/customAppScopes")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementExchangeCustomAppScope_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.CustomAppScope))]
    public class GetMgRoleManagementExchangeCustomAppScope_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.CustomAppScopeCollectionResponse? result;
            try
            {
                result = client.RoleManagement.Exchange.CustomAppScopes.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.Exchange.CustomAppScopes.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
