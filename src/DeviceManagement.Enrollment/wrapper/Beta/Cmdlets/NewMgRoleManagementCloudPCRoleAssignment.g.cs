...
{
    [GraphRoute("POST", "/roleManagement/cloudPC/roleAssignments")]
    [Cmdlet(VerbsCommon.New, "MgRoleManagementCloudPCRoleAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignmentMultiple))]
    public class NewMgRoleManagementCloudPCRoleAssignmentCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RoleDefinitionId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.RoleManagement.CloudPC.RoleAssignments.PostAsync(body, requestConfiguration =>
                {
