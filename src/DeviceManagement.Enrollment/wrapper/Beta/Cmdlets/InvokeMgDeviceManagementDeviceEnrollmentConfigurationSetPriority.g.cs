...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Enrollment
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDeviceManagementDeviceEnrollmentConfigurationSetPriority", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgDeviceManagementDeviceEnrollmentConfigurationSetPriorityCommand : GraphClientCmdlet
    {
        ...
        {
            if (!ShouldProcess(DeviceEnrollmentConfigurationId, "Invoke"))
                return;
