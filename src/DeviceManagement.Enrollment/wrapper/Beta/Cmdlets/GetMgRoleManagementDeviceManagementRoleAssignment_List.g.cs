...
{
    [GraphRoute("GET", "/roleManagement/deviceManagement/roleAssignments")]
    [Cmdlet(VerbsCommon.Get, "MgRoleManagementDeviceManagementRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignmentMultiple))]
    public class GetMgRoleManagementDeviceManagementRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.DeviceManagement.Enrollment.Client.Models.UnifiedRoleAssignmentMultipleCollectionResponse? result;
            try
            {
                result = client.RoleManagement.DeviceManagement.RoleAssignments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.RoleManagement.DeviceManagement.RoleAssignments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
