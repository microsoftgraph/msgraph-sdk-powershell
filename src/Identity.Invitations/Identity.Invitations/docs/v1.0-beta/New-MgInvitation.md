...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.invitations/new-mginvitation
schema: 2.0.0
---
...
```
New-MgInvitation [-Id <String>] [-InvitedUser <IMicrosoftGraphUser1>] [-InvitedUserDisplayName <String>]
 [-InvitedUserEmailAddress <String>] [-InvitedUserMessageInfoCcRecipients <IMicrosoftGraphRecipient[]>]
 [-InvitedUserMessageInfoCustomizedMessageBody <String>] [-InvitedUserMessageInfoMessageLanguage <String>]
 [-InvitedUserType <String>] [-InviteRedeemUrl <String>] [-InviteRedirectUrl <String>] [-ResetRedemption]
 [-SendInvitationMessage] [-Status <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -InvitedUserMessageInfoCcRecipients
Additional recipients the invitation message should be sent to.
Currently only 1 additional recipient is supported.
To construct, see NOTES section for INVITEDUSERMESSAGEINFOCCRECIPIENTS properties and create a hash table.
...
### -InvitedUserMessageInfoCustomizedMessageBody
...
### -InvitedUserMessageInfoMessageLanguage
...
BODYPARAMETER <IMicrosoftGraphInvitation1>: invitation
  ...
  - `[InvitedUser <IMicrosoftGraphUser1>]`: Represents an Azure Active Directory user object.
    ...
    - `[Drive <IMicrosoftGraphDrive1>]`: drive
      ...
      - `[Bundles <IMicrosoftGraphDriveItem1[]>]`: 
  ...
  - `[InvitedUserMessageInfoCcRecipients <IMicrosoftGraphRecipient[]>]`: Additional recipients the invitation message should be sent to. Currently only 1 additional recipient is supported.
  - `[InvitedUserMessageInfoCustomizedMessageBody <String>]`: Customized message body you want to send if you don't want the default message.
  - `[InvitedUserMessageInfoMessageLanguage <String>]`: The language you want to send the default message in. If the customizedMessageBody is specified, this property is ignored, and the message is sent using the customizedMessageBody. The language format should be in ISO 639. The default is en-US.
