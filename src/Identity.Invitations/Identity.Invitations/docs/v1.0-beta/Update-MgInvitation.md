...
```
Update-MgInvitation -InvitationId <String> [-Id <String>] [-InvitedUser <IMicrosoftGraphUser1>]
...
### Update
```
Update-MgInvitation -InvitationId <String> -BodyParameter <IMicrosoftGraphInvitation1> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgInvitation -InputObject <IIdentityInvitationsIdentity> -BodyParameter <IMicrosoftGraphInvitation1>
...
Update-MgInvitation -InputObject <IIdentityInvitationsIdentity> [-Id <String>]
 [-InvitedUser <IMicrosoftGraphUser1>] [-InvitedUserDisplayName <String>] [-InvitedUserEmailAddress <String>]
 [-InvitedUserMessageInfoCcRecipients <IMicrosoftGraphRecipient[]>]
 [-InvitedUserMessageInfoCustomizedMessageBody <String>] [-InvitedUserMessageInfoMessageLanguage <String>]
 [-InvitedUserType <String>] [-InviteRedeemUrl <String>] [-InviteRedirectUrl <String>] [-ResetRedemption]
 [-SendInvitationMessage] [-Status <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
