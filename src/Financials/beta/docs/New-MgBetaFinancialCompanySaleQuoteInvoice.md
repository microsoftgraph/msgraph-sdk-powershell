...
### Make (Default)
```
New-MgBetaFinancialCompanySaleQuoteInvoice -CompanyId <String> -SalesQuoteId <String>
...
### MakeViaIdentity
```
New-MgBetaFinancialCompanySaleQuoteInvoice -InputObject <IFinancialsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
