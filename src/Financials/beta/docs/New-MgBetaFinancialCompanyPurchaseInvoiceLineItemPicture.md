...
New-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PurchaseInvoiceLineId <String>
 ...
 [-Id <String>] [-Width <Int32>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PurchaseInvoiceLineId <String>
 -BodyParameter <IMicrosoftGraphPicture> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create1
```
New-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PurchaseInvoiceId <String>
 -PurchaseInvoiceLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-Headers <IDictionary>] [-Confirm]
...
New-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PurchaseInvoiceId <String>
 ...
 [-ContentType <String>] [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-Headers <IDictionary>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
