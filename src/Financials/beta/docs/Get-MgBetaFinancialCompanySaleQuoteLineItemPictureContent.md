...
Get-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteId <String> -SalesQuoteLineId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [<CommonParameters>]
```
