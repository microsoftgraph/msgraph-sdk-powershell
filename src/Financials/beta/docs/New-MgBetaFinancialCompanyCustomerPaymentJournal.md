...
New-MgBetaFinancialCompanyCustomerPaymentJournal -CompanyId <String> [-Account <IMicrosoftGraphAccount>]
 ...
 [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaFinancialCompanyCustomerPaymentJournal -CompanyId <String>
 -BodyParameter <IMicrosoftGraphCustomerPaymentJournal> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaFinancialCompanyCustomerPaymentJournal -InputObject <IFinancialsIdentity>
 ...
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm]
