...
Update-MgBetaFinancialCompanyEmployee -CompanyId <String> -EmployeeId <String>
 ...
 [-ResponseHeadersVariable <String>] [-StatisticsGroupCode <String>] [-Status <String>] [-Surname <String>]
 [-TerminationDate <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
