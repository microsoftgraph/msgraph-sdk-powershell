...
Set-MgBetaFinancialCompanyPurchaseInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> -InFile <String> [-Data <Stream>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set1
```
Set-MgBetaFinancialCompanyPurchaseInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceId <String> -PurchaseInvoiceLineId <String> -InFile <String> [-Data <Stream>] [-Confirm]
