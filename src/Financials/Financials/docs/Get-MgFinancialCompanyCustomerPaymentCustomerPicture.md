...
### List (Default)
```
Get-MgFinancialCompanyCustomerPaymentCustomerPicture -CompanyId <String> -CustomerPaymentId <String> [-Count]
...
Get-MgFinancialCompanyCustomerPaymentCustomerPicture -CompanyId <String> -CustomerPaymentId <String>
 -PictureId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyCustomerPaymentCustomerPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
