...
```
New-MgFinancialCompanyItemPicture -CompanyId <String> -ItemId <String> [-ContentInputFile <String>]
...
```
New-MgFinancialCompanyItemPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
 [-ContentType <String>] [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
