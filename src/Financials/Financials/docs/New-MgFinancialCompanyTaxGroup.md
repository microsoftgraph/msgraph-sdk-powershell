...
```
New-MgFinancialCompanyTaxGroup -CompanyId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
 [-LastModifiedDateTime <DateTime>] [-TaxType <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgFinancialCompanyTaxGroup -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
 [-Id <String>] [-LastModifiedDateTime <DateTime>] [-TaxType <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
