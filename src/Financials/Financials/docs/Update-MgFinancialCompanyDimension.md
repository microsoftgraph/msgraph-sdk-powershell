...
```
Update-MgFinancialCompanyDimension -CompanyId <String> -DimensionId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyDimension -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DimensionValues <IMicrosoftGraphDimensionValue[]>] [-DisplayName <String>] [-Id <String>]
 [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
