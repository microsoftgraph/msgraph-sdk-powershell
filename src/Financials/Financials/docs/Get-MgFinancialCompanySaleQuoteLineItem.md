...
### Get (Default)
```
Get-MgFinancialCompanySaleQuoteLineItem -CompanyId <String> -SalesQuoteLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleQuoteLineItem -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
