...
```
Update-MgFinancialCompanySaleOrderLineItemCategory -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleOrderLineItemCategory -InputObject <IFinancialsIdentity> [-Code <String>]
