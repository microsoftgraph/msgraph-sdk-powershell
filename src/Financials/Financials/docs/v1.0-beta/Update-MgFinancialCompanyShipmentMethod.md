...
```
Update-MgFinancialCompanyShipmentMethod -CompanyId <String> -ShipmentMethodId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyShipmentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -ShipmentMethodId
key: shipmentMethod-id of shipmentMethod
