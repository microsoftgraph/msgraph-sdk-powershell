...
### Get (Default)
```
Get-MgBetaFinancialCompanyInformationPicture -CompanyId <String> -CompanyInformationId <String> -OutFile <String>
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaFinancialCompanyInformationPicture -InputObject <IFinancialsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
