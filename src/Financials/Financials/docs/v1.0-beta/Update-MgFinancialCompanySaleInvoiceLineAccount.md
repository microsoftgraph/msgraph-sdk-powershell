...
# Update-MgBetaFinancialCompanySaleInvoiceLineAccount
...
```
Update-MgBetaFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceLineId <String>
...
### Update1
```
Update-MgBetaFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleInvoiceLineAccount -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
