...
```
Update-MgFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceLineId <String> [-Blocked]
...
```
Update-MgFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> [-Blocked] [-Category <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleInvoiceLineAccount -InputObject <IFinancialsIdentity> [-Blocked]
 [-Category <String>] [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Number <String>] [-SubCategory <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
