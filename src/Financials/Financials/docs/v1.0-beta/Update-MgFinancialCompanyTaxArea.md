...
```
Update-MgFinancialCompanyTaxArea -CompanyId <String> -TaxAreaId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyTaxArea -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
