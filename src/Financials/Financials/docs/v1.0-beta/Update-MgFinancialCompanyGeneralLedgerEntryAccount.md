...
# Update-MgBetaFinancialCompanyGeneralLedgerEntryAccount
...
```
Update-MgBetaFinancialCompanyGeneralLedgerEntryAccount -CompanyId <String> -GeneralLedgerEntryId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyGeneralLedgerEntryAccount -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
