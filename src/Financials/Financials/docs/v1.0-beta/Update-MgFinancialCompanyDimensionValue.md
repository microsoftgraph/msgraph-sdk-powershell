...
```
Update-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionValueId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyDimensionValue -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
