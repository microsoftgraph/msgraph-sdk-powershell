...
```
New-MgFinancialCompanyVendorPicture -CompanyId <String> -VendorId <String> [-ContentInputFile <String>]
...
```
New-MgFinancialCompanyVendorPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
 [-ContentType <String>] [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
