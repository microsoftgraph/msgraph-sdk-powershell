...
```
New-MgFinancialCompanyAgedAccountReceivable -CompanyId <String> [-AgedAsOfDate <DateTime>]
 ...
 [-Period3Amount <Decimal>] [-PeriodLengthFilter <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgFinancialCompanyAgedAccountReceivable -InputObject <IFinancialsIdentity> [-AgedAsOfDate <DateTime>]
 [-BalanceDue <Decimal>] [-CurrencyCode <String>] [-CurrentAmount <Decimal>] [-CustomerNumber <String>]
 [-Id <String>] [-Name <String>] [-Period1Amount <Decimal>] [-Period2Amount <Decimal>]
 [-Period3Amount <Decimal>] [-PeriodLengthFilter <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
