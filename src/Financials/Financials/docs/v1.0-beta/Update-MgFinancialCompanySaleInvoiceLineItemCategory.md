...
```
Update-MgFinancialCompanySaleInvoiceLineItemCategory -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleInvoiceLineItemCategory -InputObject <IFinancialsIdentity> [-Code <String>]
