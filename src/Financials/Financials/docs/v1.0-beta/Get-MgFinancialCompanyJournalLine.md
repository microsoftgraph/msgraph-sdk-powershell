...
### List (Default)
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### List1
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> -JournalId <String> [-Count]
