...
Update-MgFinancialCompanyGeneralLedgerEntry -CompanyId <String> -GeneralLedgerEntryId <String>
 ...
 [-AdditionalProperties <Hashtable>] [-CreditAmount <Decimal>] [-DebitAmount <Decimal>] [-Description <String>]
 [-DocumentNumber <String>] [-DocumentType <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
...
```
Update-MgFinancialCompanyGeneralLedgerEntry -CompanyId <String> -GeneralLedgerEntryId <String>
 -BodyParameter <IMicrosoftGraphGeneralLedgerEntry> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
