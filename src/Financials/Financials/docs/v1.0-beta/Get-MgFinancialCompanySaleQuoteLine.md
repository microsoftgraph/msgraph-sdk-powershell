...
### List (Default)
```
Get-MgFinancialCompanySaleQuoteLine -CompanyId <String> [-Count] [-ExpandProperty <String[]>]
...
### List1
```
Get-MgFinancialCompanySaleQuoteLine -CompanyId <String> -SalesQuoteId <String> [-Count]
