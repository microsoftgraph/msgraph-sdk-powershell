...
```
Update-MgFinancialCompanySaleQuoteShipmentMethod -CompanyId <String> -SalesQuoteId <String> [-Code <String>]
...
```
Update-MgFinancialCompanySaleQuoteShipmentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
