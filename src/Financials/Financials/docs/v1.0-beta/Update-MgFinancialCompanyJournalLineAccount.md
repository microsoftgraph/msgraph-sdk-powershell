...
```
Update-MgFinancialCompanyJournalLineAccount -CompanyId <String> -JournalLineId <String> [-Blocked]
...
```
Update-MgFinancialCompanyJournalLineAccount -InputObject <IFinancialsIdentity> [-Blocked] [-Category <String>]
