...
# Update-MgBetaFinancialCompanyJournalLineAccount
...
```
Update-MgBetaFinancialCompanyJournalLineAccount -CompanyId <String> -JournalLineId <String>
...
### Update1
```
Update-MgBetaFinancialCompanyJournalLineAccount -CompanyId <String> -JournalId <String> -JournalLineId <String>
 -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyJournalLineAccount -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
