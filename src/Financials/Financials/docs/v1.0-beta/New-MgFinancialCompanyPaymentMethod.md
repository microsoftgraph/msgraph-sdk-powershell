...
```
New-MgFinancialCompanyPaymentMethod -CompanyId <String> [-Code <String>] [-DisplayName <String>]
...
```
New-MgFinancialCompanyPaymentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
