...
```
Update-MgBetaFinancialCompanyCustomer -CompanyId <String> -CustomerId <String> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyCustomer -InputObject <IFinancialsIdentity> -BodyParameter <IMicrosoftGraphCustomer>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
