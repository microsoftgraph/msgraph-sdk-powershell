...
### Delete (Default)
```
Remove-MgFinancialCompany -CompanyId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgFinancialCompany -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
