...
```
New-MgFinancialCompanyPicture -CompanyId <String> [-ContentInputFile <String>] [-ContentType <String>]
 [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgFinancialCompanyPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
