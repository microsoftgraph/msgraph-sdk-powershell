...
```
New-MgFinancialCompanyPaymentTerm -CompanyId <String> [-CalculateDiscountOnCreditMemos] [-Code <String>]
...
```
New-MgFinancialCompanyPaymentTerm -InputObject <IFinancialsIdentity> [-CalculateDiscountOnCreditMemos]
