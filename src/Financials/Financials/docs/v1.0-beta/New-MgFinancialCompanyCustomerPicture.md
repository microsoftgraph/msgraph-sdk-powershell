...
```
New-MgFinancialCompanyCustomerPicture -CompanyId <String> -CustomerId <String> [-ContentInputFile <String>]
...
```
New-MgFinancialCompanyCustomerPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
 [-ContentType <String>] [-Height <Int32>] [-Id <String>] [-Width <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
