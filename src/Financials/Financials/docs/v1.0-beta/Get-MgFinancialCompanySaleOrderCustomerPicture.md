...
### Get
```
Get-MgBetaFinancialCompanySaleOrderCustomerPicture -CompanyId <String> -PictureId <String> -SalesOrderId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaFinancialCompanySaleOrderCustomerPicture -InputObject <IFinancialsIdentity> [-ExpandProperty <String[]>]
