...
```
Update-MgFinancialCompanySaleQuoteLineAccount -CompanyId <String> -SalesQuoteLineId <String> [-Blocked]
...
```
Update-MgFinancialCompanySaleQuoteLineAccount -CompanyId <String> -SalesQuoteId <String>
 -SalesQuoteLineId <String> [-Blocked] [-Category <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgFinancialCompanySaleQuoteLineAccount -InputObject <IFinancialsIdentity> [-Blocked]
 [-Category <String>] [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Number <String>] [-SubCategory <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
