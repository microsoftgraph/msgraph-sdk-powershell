...
Update-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> [-ContentInputFile <String>] [-ContentType <String>] [-Height <Int32>]
...
```
Update-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceId <String> -SalesInvoiceLineId <String> [-ContentInputFile <String>] [-ContentType <String>]
