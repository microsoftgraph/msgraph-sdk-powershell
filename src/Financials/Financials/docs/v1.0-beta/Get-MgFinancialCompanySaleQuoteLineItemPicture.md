...
```
Get-MgFinancialCompanySaleQuoteLineItemPicture -CompanyId <String> -SalesQuoteLineId <String>
 -SalesQuoteId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
Get-MgFinancialCompanySaleQuoteLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -SalesQuoteId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
