...
```
Update-MgFinancialCompanyCustomerShipmentMethod -CompanyId <String> -CustomerId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyCustomerShipmentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
