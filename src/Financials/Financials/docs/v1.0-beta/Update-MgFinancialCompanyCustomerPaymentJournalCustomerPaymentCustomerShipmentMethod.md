...
Update-MgFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomerShipmentMethod -CompanyId <String>
 -CustomerPaymentId <String> -CustomerPaymentJournalId <String> [-Code <String>] [-DisplayName <String>]
...
```
Update-MgFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomerShipmentMethod
 -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
key: customerPaymentJournal-id of customerPaymentJournal
