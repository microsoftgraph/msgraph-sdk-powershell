...
Set-MgFinancialCompanySaleCreditMemoLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesCreditMemoLineId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgFinancialCompanySaleCreditMemoLineItemPictureContent -InputObject <IFinancialsIdentity>
