...
```
New-MgFinancialCompanyAccount -CompanyId <String> [-Blocked] [-Category <String>] [-DisplayName <String>]
 [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Number <String>] [-SubCategory <String>] [-Confirm]
...
```
New-MgFinancialCompanyAccount -InputObject <IFinancialsIdentity> [-Blocked] [-Category <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Number <String>]
 [-SubCategory <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
