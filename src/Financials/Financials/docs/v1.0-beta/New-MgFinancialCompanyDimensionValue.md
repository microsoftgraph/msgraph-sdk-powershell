...
```
New-MgFinancialCompanyDimensionValue -CompanyId <String> [-Code <String>] [-DisplayName <String>]
...
### CreateExpanded
```
New-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionId <String> [-Code <String>]
...
```
New-MgFinancialCompanyDimensionValue -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
