...
```
Update-MgFinancialCompanyJournalAccount -CompanyId <String> -JournalId <String> [-Blocked]
...
```
Update-MgFinancialCompanyJournalAccount -InputObject <IFinancialsIdentity> [-Blocked] [-Category <String>]
