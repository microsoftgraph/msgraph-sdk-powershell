...
```
New-MgFinancialCompanySaleOrderLineItemPicture -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> [-ContentInputFile <String>] [-ContentType <String>] [-Height <Int32>]
...
```
New-MgFinancialCompanySaleOrderLineItemPicture -InputObject <IFinancialsIdentity> [-ContentInputFile <String>]
