...
# Invoke-MgBetaFinancialCompanySaleInvoice
...
### Post (Default)
```
Invoke-MgBetaFinancialCompanySaleInvoice -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-MgBetaFinancialCompanySaleInvoice -InputObject <IFinancialsIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
