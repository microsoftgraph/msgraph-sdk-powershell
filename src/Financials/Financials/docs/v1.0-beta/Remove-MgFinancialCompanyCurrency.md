...
### Delete (Default)
```
Remove-MgBetaFinancialCompanyCurrency -CompanyId <String> -CurrencyId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaFinancialCompanyCurrency -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
