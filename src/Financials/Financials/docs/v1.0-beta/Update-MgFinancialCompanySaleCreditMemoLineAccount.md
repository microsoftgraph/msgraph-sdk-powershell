...
# Update-MgBetaFinancialCompanySaleCreditMemoLineAccount
...
```
Update-MgBetaFinancialCompanySaleCreditMemoLineAccount -CompanyId <String> -SalesCreditMemoLineId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleCreditMemoLineAccount -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
