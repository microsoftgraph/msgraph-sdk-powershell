...
```
New-MgFinancialCompanyCountryRegion -CompanyId <String> [-AddressFormat <String>] [-Code <String>]
...
```
New-MgFinancialCompanyCountryRegion -InputObject <IFinancialsIdentity> [-AddressFormat <String>]
