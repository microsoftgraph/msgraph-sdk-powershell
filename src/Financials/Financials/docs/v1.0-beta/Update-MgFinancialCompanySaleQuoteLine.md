...
```
Update-MgFinancialCompanySaleQuoteLine -CompanyId <String> -SalesQuoteLineId <String> [-AccountBlocked]
 ...
 [-Id <String>] [-ItemBaseUnitOfMeasureId <String>] [-ItemBlocked] [-ItemCategoryCode <String>]
...
Update-MgFinancialCompanySaleQuoteLine -CompanyId <String> -SalesQuoteId <String> -SalesQuoteLineId <String>
 ...
 [-DiscountPercent <Decimal>] [-DocumentId <String>] [-Id <String>] [-ItemBaseUnitOfMeasureId <String>]
 [-ItemBlocked] [-ItemCategoryCode <String>] [-ItemCategoryDisplayName <String>] [-ItemCategoryId <String>]
...
```
Update-MgFinancialCompanySaleQuoteLine -InputObject <IFinancialsIdentity> [-AccountBlocked]
 [-AccountCategory <String>] [-AccountDisplayName <String>] [-AccountId <String>] [-AccountId1 <String>]
 [-AccountLastModifiedDateTime <DateTime>] [-AccountNumber <String>] [-AccountSubCategory <String>]
 [-AmountExcludingTax <Decimal>] [-AmountIncludingTax <Decimal>] [-Code <String>] [-Description <String>]
 [-DiscountAmount <Decimal>] [-DiscountAppliedBeforeTax] [-DiscountPercent <Decimal>] [-DocumentId <String>]
...
### -SalesQuoteLineId
key: salesQuoteLine-id of salesQuoteLine
