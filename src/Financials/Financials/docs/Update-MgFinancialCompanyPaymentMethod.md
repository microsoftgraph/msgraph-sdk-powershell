...
```
Update-MgFinancialCompanyPaymentMethod -CompanyId <String> -PaymentMethodId <String> [-Code <String>]
...
```
Update-MgFinancialCompanyPaymentMethod -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -PaymentMethodId
key: paymentMethod-id of paymentMethod
