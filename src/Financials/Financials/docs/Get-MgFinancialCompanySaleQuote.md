...
### List (Default)
```
Get-MgFinancialCompanySaleQuote -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanySaleQuote -CompanyId <String> -SalesQuoteId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleQuote -InputObject <IFinancialsIdentity> [-Expand <String[]>] [-Select <String[]>]
 [<CommonParameters>]
```
