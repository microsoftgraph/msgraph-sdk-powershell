...
### Get (Default)
```
Get-MgFinancialCompanySaleInvoiceCustomer -CompanyId <String> -SalesInvoiceId <String> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoiceCustomer -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
