...
Get-MgFinancialCompanySaleCreditMemoLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesCreditMemoLineId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleCreditMemoLineItemPicture -InputObject <IFinancialsIdentity> [-Expand <String[]>]
