...
```
Update-MgFinancialCompanyItemCategory -CompanyId <String> -ItemCategoryId <String> [-Code <String>]
...
### UpdateExpanded1
```
Update-MgFinancialCompanyItemCategory -CompanyId <String> -ItemId <String> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgFinancialCompanyItemCategory -InputObject <IFinancialsIdentity> [-Code <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
