...
```
New-MgFinancialCompanyItemCategory -CompanyId <String> [-Code <String>] [-DisplayName <String>] [-Id <String>]
...
```
New-MgFinancialCompanyItemCategory -InputObject <IFinancialsIdentity> [-Code <String>] [-DisplayName <String>]
