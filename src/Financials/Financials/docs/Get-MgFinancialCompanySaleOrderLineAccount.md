...
### Get (Default)
```
Get-MgFinancialCompanySaleOrderLineAccount -CompanyId <String> -SalesOrderLineId <String> [-Expand <String[]>]
...
### GetViaIdentity
```
Get-MgFinancialCompanySaleOrderLineAccount -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
