...
### List (Default)
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> [-Count] [-Expand <String[]>] [-Filter <String>]
...
### Get
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceLineId <String> [-Expand <String[]>]
...
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> [-Expand <String[]>] [-Select <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanySaleInvoiceLine -InputObject <IFinancialsIdentity> [-Expand <String[]>]
 [-Select <String[]>] [<CommonParameters>]
```
...
### List1
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceId <String> [-Count]
