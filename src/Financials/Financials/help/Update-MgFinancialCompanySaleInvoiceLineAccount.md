...
```
Update-MgFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceLineId <String>
 -SalesInvoiceId <String> [-AdditionalProperties <Hashtable>] [-Blocked] [-Category <String>]
...
```
Update-MgFinancialCompanySaleInvoiceLineAccount -CompanyId <String> -SalesInvoiceLineId <String>
 -SalesInvoiceId <String> -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleinvoicelineaccount](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleinvoicelineaccount)
