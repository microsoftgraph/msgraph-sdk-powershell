...
```
Get-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -SalesInvoiceLineId <String>
 -SalesInvoiceId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
Get-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> -SalesInvoiceId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/get-mgfinancialcompanysaleinvoicelineitempicture](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/get-mgfinancialcompanysaleinvoicelineitempicture)
