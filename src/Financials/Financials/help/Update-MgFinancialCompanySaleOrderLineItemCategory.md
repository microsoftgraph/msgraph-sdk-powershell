...
```
Update-MgFinancialCompanySaleOrderLineItemCategory -CompanyId <String> -SalesOrderLineId <String>
 -SalesOrderId <String> -BodyParameter <IMicrosoftGraphItemCategory> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleorderlineitemcategory](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleorderlineitemcategory)
