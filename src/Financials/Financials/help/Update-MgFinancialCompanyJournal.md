...
Update-MgFinancialCompanyJournal -CompanyId <String> -JournalId <String>
 -BodyParameter <IMicrosoftGraphJournal> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanyjournal](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanyjournal)
