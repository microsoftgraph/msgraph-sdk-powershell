...
```
Update-MgFinancialCompanySaleQuoteLineAccount -CompanyId <String> -SalesQuoteLineId <String>
 -SalesQuoteId <String> [-AdditionalProperties <Hashtable>] [-Blocked] [-Category <String>]
...
```
Update-MgFinancialCompanySaleQuoteLineAccount -CompanyId <String> -SalesQuoteLineId <String>
 -SalesQuoteId <String> -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalequotelineaccount](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalequotelineaccount)
