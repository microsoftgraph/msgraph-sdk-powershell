...
### DeleteViaIdentity
```
Remove-MgFinancialCompanyTaxGroup -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanytaxgroup](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanytaxgroup)
