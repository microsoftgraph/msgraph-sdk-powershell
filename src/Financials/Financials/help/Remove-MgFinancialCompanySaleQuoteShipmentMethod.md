...
### Delete (Default)
```
Remove-MgFinancialCompanySaleQuoteShipmentMethod -CompanyId <String> -SalesQuoteId <String> [-IfMatch <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanysalequoteshipmentmethod](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanysalequoteshipmentmethod)
