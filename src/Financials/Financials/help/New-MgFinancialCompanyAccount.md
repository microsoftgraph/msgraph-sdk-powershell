...
New-MgFinancialCompanyAccount -CompanyId <String> [-AdditionalProperties <Hashtable>] [-Blocked]
 ...
 [-Number <String>] [-SubCategory <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgFinancialCompanyAccount -CompanyId <String> -BodyParameter <IMicrosoftGraphAccount> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgFinancialCompanyAccount -InputObject <IFinancialsIdentity> [-AdditionalProperties <Hashtable>] [-Blocked]
 [-Category <String>] [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Number <String>] [-SubCategory <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/new-mgfinancialcompanyaccount](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/new-mgfinancialcompanyaccount)
