...
### Post (Default)
```
Invoke-MgFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-MgFinancialCompanyPurchaseInvoice -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/invoke-mgfinancialcompanypurchaseinvoice](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/invoke-mgfinancialcompanypurchaseinvoice)
