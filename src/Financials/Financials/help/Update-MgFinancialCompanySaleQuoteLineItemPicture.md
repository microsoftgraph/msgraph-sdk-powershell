...
```
Update-MgFinancialCompanySaleQuoteLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -SalesQuoteId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru]
...
```
Update-MgFinancialCompanySaleQuoteLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalequotelineitempicture](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalequotelineitempicture)
