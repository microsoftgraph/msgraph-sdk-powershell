...
```
Update-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionValueId <String>
 -BodyParameter <IMicrosoftGraphDimensionValue> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanydimensionvalue](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanydimensionvalue)
