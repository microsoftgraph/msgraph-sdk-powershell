...
### Cancel (Default)
```
Stop-MgFinancialCompanySaleInvoice -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgFinancialCompanySaleInvoice -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/stop-mgfinancialcompanysaleinvoice](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/stop-mgfinancialcompanysaleinvoice)
