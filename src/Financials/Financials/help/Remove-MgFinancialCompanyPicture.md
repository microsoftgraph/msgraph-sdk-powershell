...
### DeleteViaIdentity
```
Remove-MgFinancialCompanyPicture -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanypicture](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanypicture)
