...
### Delete1
```
Remove-MgFinancialCompanyJournalLineAccount -CompanyId <String> -JournalLineId <String> -JournalId <String>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanyjournallineaccount](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanyjournallineaccount)
