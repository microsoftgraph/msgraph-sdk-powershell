...
```
Update-MgFinancialCompanySaleOrder -CompanyId <String> -SalesOrderId <String>
 -BodyParameter <IMicrosoftGraphSalesOrder> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleorder](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleorder)
