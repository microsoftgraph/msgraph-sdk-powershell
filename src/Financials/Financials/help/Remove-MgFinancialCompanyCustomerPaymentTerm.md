...
### DeleteViaIdentity1
```
Remove-MgFinancialCompanyCustomerPaymentTerm -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanycustomerpaymentterm](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanycustomerpaymentterm)
