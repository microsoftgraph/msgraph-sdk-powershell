...
### Get (Default)
```
Get-MgFinancialCompanySaleOrderCustomer -CompanyId <String> -SalesOrderId <String> [-ExpandProperty <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/get-mgfinancialcompanysaleordercustomer](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/get-mgfinancialcompanysaleordercustomer)
