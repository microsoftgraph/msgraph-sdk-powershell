...
### List (Default)
```
Get-MgBetaUserMessageSingleValueExtendedProperty -MessageId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaUserMessageSingleValueExtendedProperty -MessageId <String> -SingleValueLegacyExtendedPropertyId <String>
