...
```
Update-MgBetaUserMailFolderSingleValueExtendedProperty -MailFolderId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserMailFolderSingleValueExtendedProperty -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
