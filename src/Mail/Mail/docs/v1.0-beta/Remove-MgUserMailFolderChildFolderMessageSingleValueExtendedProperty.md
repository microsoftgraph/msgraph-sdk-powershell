...
### Delete1 (Default)
```
Remove-MgBetaUserMailFolderChildFolderMessageSingleValueExtendedProperty -MailFolderId <String>
...
### DeleteViaIdentity1
```
Remove-MgBetaUserMailFolderChildFolderMessageSingleValueExtendedProperty -InputObject <IMailIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
