...
```
New-MgBetaUserMessageMultiValueExtendedProperty -MessageId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgBetaUserMessageMultiValueExtendedProperty -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaUserMessageMultiValueExtendedProperty -InputObject <IMailIdentity> [-AdditionalProperties <Hashtable>]
