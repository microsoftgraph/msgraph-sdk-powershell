...
### List1 (Default)
```
Get-MgBetaUserMailFolderChildFolderMultiValueExtendedProperty -MailFolderId <String> -MailFolderId1 <String>
...
### GetViaIdentity1
```
Get-MgBetaUserMailFolderChildFolderMultiValueExtendedProperty -InputObject <IMailIdentity>
