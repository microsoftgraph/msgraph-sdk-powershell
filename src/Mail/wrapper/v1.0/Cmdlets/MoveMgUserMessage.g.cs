...
{
    [GraphRoute("POST", "/users/{user-id}/messages/{message-id}/move")]
    [Cmdlet(VerbsCommon.Move, "MgUserMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Message))]
    public class MoveMgUserMessageCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.Messages.Item.Move.MovePostRequestBody();
    ...
    if (this.IsParameterBound(nameof(DestinationId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].Move.PostAsync(body, requestConfiguration =>
                {
