...
{
    [GraphRoute("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/delta()")]
    [Cmdlet(VerbsCommon.Get, "MgUserMailFolderMessageDelta", DefaultParameterSetName = "DeltaSync")]
    [OutputType(typeof(global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.MailFolders.Item.Messages.Delta.DeltaGetResponse))]
    public class GetMgUserMailFolderMessageDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.MailFolders.Item.Messages.Delta.DeltaGetResponse? result;
            try
            {
                result = ParameterSetName == "Resume"
                    ? client.Users[UserId].MailFolders[MailFolderId].Messages.Delta.WithUrl(ValidateContinuationUrl(DeltaLink!, requestAdapter, nameof(DeltaLink))).GetAsDeltaGetResponseAsync(requestConfiguration =>
                        {

                AddRequestHeaders(requestConfiguration.Headers);
                        }).GetAwaiter().GetResult()
                    : client.Users[UserId].MailFolders[MailFolderId].Messages.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Users[UserId].MailFolders[MailFolderId].Messages.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
