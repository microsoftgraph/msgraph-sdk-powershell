...
{
    [GraphRoute("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/forward")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgForwardUserMailFolderChildFolderMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgForwardUserMailFolderChildFolderMessageCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward.ForwardPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Message)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                client.Users[UserId].MailFolders[MailFolderId].ChildFolders[MailFolderId1].Messages[MessageId].Forward.PostAsync(body, requestConfiguration =>
                {
