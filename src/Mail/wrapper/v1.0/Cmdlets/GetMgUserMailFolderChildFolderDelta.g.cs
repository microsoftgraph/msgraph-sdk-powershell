...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    public class GetMgUserMailFolderChildFolderDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MailFolders[MailFolderId].ChildFolders.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
