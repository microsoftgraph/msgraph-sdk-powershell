...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    public class GetMgUserMailFolderChildFolderDeltaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.MailFolders.Item.ChildFolders.Delta.DeltaGetResponse? result;
            try
            {
                ...
                AddRequestHeaders(requestConfiguration.Headers);
                    ...
                    : client.Users[UserId].MailFolders[MailFolderId].ChildFolders.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
                ...
                while (true)
                {
                    ...
                    result = client.Users[UserId].MailFolders[MailFolderId].ChildFolders.Delta.WithUrl(nextLink).GetAsDeltaGetResponseAsync(requestConfiguration =>
                    {
