...
{
    [GraphRoute("GET", "/users/{user-id}/inferenceClassification")]
    [Cmdlet(VerbsCommon.Get, "MgUserInferenceClassification")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.InferenceClassification))]
    public class GetMgUserInferenceClassificationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].InferenceClassification.GetAsync(requestConfiguration =>
                {
