...
{
    [GraphRoute("GET", "/users/{user-id}/messages/{message-id}/$value")]
    [Cmdlet(VerbsCommon.Get, "MgUserMessageContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserMessageContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].Content.GetAsync(requestConfiguration =>
                {
