...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    public class GetMgUserMailFolderChildFolderMessage_ListCommand : PSCmdlet
    {
        ...
        if (this.IsParameterBound(nameof(Headers)))
        {
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, MailFolderId1));
                return;
            }
