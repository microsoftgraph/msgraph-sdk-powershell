...
{
    [GraphRoute("POST", "/users/{user-id}/messages/{message-id}/extensions")]
    [Cmdlet(VerbsCommon.New, "MgUserMessageExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Extension))]
    public class NewMgUserMessageExtensionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].Extensions.PostAsync(body, requestConfiguration =>
                {
