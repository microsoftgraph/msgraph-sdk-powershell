...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserMailFolderChildFolderMessageDelta")]
    ...
    public class GetMgUserMailFolderChildFolderMessageDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MailFolders[MailFolderId].ChildFolders[MailFolderId1].Messages.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
