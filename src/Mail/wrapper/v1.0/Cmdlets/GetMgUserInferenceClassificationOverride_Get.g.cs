...
{
    [GraphRoute("GET", "/users/{user-id}/inferenceClassification/overrides/{inferenceClassificationOverride-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserInferenceClassificationOverride_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.InferenceClassificationOverride))]
    public class GetMgUserInferenceClassificationOverride_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].InferenceClassification.Overrides[InferenceClassificationOverrideId].GetAsync(requestConfiguration =>
                {
