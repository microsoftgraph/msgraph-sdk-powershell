...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserMessageAttachment", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserMessageAttachmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserMessageAttachment_Get or Get-MgUserMessageAttachment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserMessageAttachment_Get" : "Get-MgUserMessageAttachment_List";
            try
            {
