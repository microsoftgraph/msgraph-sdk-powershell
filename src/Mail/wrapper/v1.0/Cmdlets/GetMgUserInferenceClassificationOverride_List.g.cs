...
namespace Microsoft.Graph.PowerShell.Mail
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserInferenceClassificationOverride_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.InferenceClassificationOverride))]
    public class GetMgUserInferenceClassificationOverride_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Mail.Client.Models.InferenceClassificationOverrideCollectionResponse? result;
            try
            {
                result = client.Users[UserId].InferenceClassification.Overrides.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].InferenceClassification.Overrides.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
