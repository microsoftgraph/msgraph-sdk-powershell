...
{
    [GraphRoute("GET", "/users/{user-id}/messages/{message-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserMessage_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Message))]
    public class GetMgUserMessage_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].GetAsync(requestConfiguration =>
                {
