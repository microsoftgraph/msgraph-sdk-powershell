...
{
    [GraphRoute("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/forward")]
    [Cmdlet(VerbsLifecycle.Invoke, "MgForwardUserMailFolderMessage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]

    public class InvokeMgForwardUserMailFolderMessageCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.MailFolders.Item.Messages.Item.Forward.ForwardPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Message)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                client.Users[UserId].MailFolders[MailFolderId].Messages[MessageId].Forward.PostAsync(body, requestConfiguration =>
                {
