...
{
    [GraphRoute("POST", "/users/{user-id}/messages/{message-id}/createReply")]
    [Cmdlet(VerbsCommon.New, "MgUserMessageReply", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Message))]
    public class NewMgUserMessageReplyCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.Messages.Item.CreateReply.CreateReplyPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Message)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].CreateReply.PostAsync(body, requestConfiguration =>
                {
