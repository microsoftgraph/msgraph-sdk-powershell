...
{
    [GraphRoute("POST", "/users/{user-id}/messages/{message-id}/createReplyAll")]
    [Cmdlet(VerbsCommon.New, "MgUserMessageReplyAll", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Message))]
    public class NewMgUserMessageReplyAllCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var body = new global::Microsoft.Graph.PowerShell.Mail.Client.Users.Item.Messages.Item.CreateReplyAll.CreateReplyAllPostRequestBody();
    ...
    if (this.IsParameterBound(nameof(Message)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].CreateReplyAll.PostAsync(body, requestConfiguration =>
                {
