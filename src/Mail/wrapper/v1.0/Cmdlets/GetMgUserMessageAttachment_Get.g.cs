...
{
    [GraphRoute("GET", "/users/{user-id}/messages/{message-id}/attachments/{attachment-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserMessageAttachment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Mail.Client.Models.Attachment))]
    public class GetMgUserMessageAttachment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Messages[MessageId].Attachments[AttachmentId].GetAsync(requestConfiguration =>
                {
