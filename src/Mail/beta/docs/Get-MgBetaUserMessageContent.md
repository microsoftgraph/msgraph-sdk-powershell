...
### Get (Default)
```
Get-MgBetaUserMessageContent -MessageId <String> -UserId <String> -OutFile <String> [-Format <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserMessageContent -InputObject <IMailIdentity> -OutFile <String> [-Format <String>]
 [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
