...
### Delete (Default)
```
Remove-MgUserMailFolder -MailFolderId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserMailFolder -InputObject <IMailIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
