...
### Delete (Default)
```
Remove-MgUserMessage -MessageId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserMessage -InputObject <IMailIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
