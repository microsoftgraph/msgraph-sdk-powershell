...
### Get (Default)
```
Get-MgUserMessageContent -MessageId <String> -UserId <String> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserMessageContent -InputObject <IMailIdentity> -OutFile <String> [-Format <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [<CommonParameters>]
```
