...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/new-mgusercontactfoldersinglevalueextendedproperty
schema: 2.0.0
---
...
```
New-MgUserContactFolderSingleValueExtendedProperty -ContactFolderId <String> -UserId <String> [-Id <String>]
...
### CreateViaIdentity
```
New-MgUserContactFolderSingleValueExtendedProperty -InputObject <IUsersContactsIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserContactFolderSingleValueExtendedProperty -InputObject <IUsersContactsIdentity> [-Id <String>]
 [-Value <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
