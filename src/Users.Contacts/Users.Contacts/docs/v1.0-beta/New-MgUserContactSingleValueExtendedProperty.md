...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/new-mgusercontactsinglevalueextendedproperty
schema: 2.0.0
---
...
```
New-MgUserContactSingleValueExtendedProperty -ContactId <String> -UserId <String> [-Id <String>]
...
### CreateViaIdentity1
```
New-MgUserContactSingleValueExtendedProperty -InputObject <IUsersContactsIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserContactSingleValueExtendedProperty -InputObject <IUsersContactsIdentity> [-Id <String>]
 [-Value <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
