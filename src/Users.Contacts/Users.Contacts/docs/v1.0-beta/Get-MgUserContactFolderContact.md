...
### List1 (Default)
```
Get-MgUserContactFolderContact -ContactFolderId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserContactFolderContact -InputObject <IUsersContactsIdentity> [-ExpandProperty <String[]>]
