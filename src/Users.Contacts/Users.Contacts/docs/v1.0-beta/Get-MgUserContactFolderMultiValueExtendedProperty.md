...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldermultivalueextendedproperty
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserContactFolderMultiValueExtendedProperty -ContactFolderId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgUserContactFolderMultiValueExtendedProperty -InputObject <IUsersContactsIdentity>
