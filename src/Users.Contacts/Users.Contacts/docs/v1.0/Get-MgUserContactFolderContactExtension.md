...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldercontactextension
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserContactFolderContactExtension -InputObject <IUsersContactsIdentity> [-ExpandProperty <String[]>]
