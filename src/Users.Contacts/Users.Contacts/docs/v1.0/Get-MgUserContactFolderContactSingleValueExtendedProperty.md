...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfoldercontactsinglevalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserContactFolderContactSingleValueExtendedProperty -InputObject <IUsersContactsIdentity>
