...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactfolderchildfolder
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserContactFolderChildFolder -InputObject <IUsersContactsIdentity> [-ExpandProperty <String[]>]
