...
```
New-MgUserContact -UserId <String> [-AssistantName <String>] [-Birthday <DateTime>]
...
### CreateViaIdentity1
```
New-MgUserContact -InputObject <IUsersContactsIdentity> -BodyParameter <IMicrosoftGraphContact1> [-Confirm]
