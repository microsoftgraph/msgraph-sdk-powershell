...
Update-MgUserContactFolderContact -ContactFolderId <String> -ContactId <String> -UserId <String>
 [-AssistantName <String>] [-Birthday <DateTime>] [-BusinessAddressCity <String>]
 [-BusinessAddressCountryOrRegion <String>] [-BusinessAddressPostalCode <String>]
 [-BusinessAddressState <String>] [-BusinessAddressStreet <String>] [-BusinessHomePage <String>]
 ...
 [-FileAs <String>] [-Generation <String>] [-GivenName <String>] [-HomeAddressCity <String>]
 [-HomeAddressCountryOrRegion <String>] [-HomeAddressPostalCode <String>] [-HomeAddressState <String>]
 [-HomeAddressStreet <String>] [-HomePhones <String[]>] [-Id <String>] [-ImAddresses <String[]>]
 [-Initials <String>] [-JobTitle <String>] [-LastModifiedDateTime <DateTime>] [-Manager <String>]
 [-MiddleName <String>] [-MobilePhone <String>]
...
Update-MgUserContactFolderContact -InputObject <IUsersContactsIdentity> [-AssistantName <String>]
 [-Birthday <DateTime>] [-BusinessAddressCity <String>] [-BusinessAddressCountryOrRegion <String>]
