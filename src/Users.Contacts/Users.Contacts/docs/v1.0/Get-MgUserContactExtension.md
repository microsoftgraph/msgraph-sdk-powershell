...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.contacts/get-mgusercontactextension
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserContactExtension -ContactId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgUserContactExtension -InputObject <IUsersContactsIdentity> [-ExpandProperty <String[]>]
