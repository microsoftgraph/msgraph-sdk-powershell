...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/{directoryObject-id}/graph.appRoleAssignment")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsAppRoleAssignment_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignment))]
    public class GetMgUserOwnedDeviceAsAppRoleAssignment_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices[DirectoryObjectId].GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
