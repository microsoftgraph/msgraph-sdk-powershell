...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDevice_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserRegisteredDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObjectCollectionResponse? result;
            try
            {
                result = client.Users[UserId].RegisteredDevices.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].RegisteredDevices.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
