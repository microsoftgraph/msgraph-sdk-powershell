...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgUserMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
