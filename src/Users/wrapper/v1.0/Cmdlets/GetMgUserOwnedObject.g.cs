...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObject", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOwnedObjectCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedObject_Get or Get-MgUserOwnedObject_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedObject_Get" : "Get-MgUserOwnedObject_List";
            try
            {
