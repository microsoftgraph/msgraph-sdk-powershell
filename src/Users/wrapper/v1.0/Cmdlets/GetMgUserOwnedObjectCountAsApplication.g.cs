...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedObjectCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
