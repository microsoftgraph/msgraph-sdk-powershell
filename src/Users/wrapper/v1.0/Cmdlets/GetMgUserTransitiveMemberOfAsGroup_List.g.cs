...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfAsGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Group))]
    public class GetMgUserTransitiveMemberOfAsGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.GroupCollectionResponse? result;
            try
            {
                result = client.Users[UserId].TransitiveMemberOf.GraphGroup.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].TransitiveMemberOf.GraphGroup.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
