...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/{directoryObject-id}/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsApplication_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Application))]
    public class GetMgUserOwnedObjectAsApplication_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.Application? result;
            try
            {
                result = client.Users[UserId].OwnedObjects[DirectoryObjectId].GraphApplication.GetAsync(requestConfiguration =>
                {
