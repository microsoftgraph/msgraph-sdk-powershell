...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgUserTransitiveMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].TransitiveMemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
