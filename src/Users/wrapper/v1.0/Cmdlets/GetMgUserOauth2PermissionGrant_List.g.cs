...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOauth2PermissionGrant_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OAuth2PermissionGrant))]
    public class GetMgUserOauth2PermissionGrant_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.OAuth2PermissionGrantCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Oauth2PermissionGrants.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Oauth2PermissionGrants.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
