...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOwnedObjectAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedObjectAsGroup_Get or Get-MgUserOwnedObjectAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedObjectAsGroup_Get" : "Get-MgUserOwnedObjectAsGroup_List";
            try
            {
