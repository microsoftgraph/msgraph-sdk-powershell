...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsDevice_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Device))]
    public class GetMgUserRegisteredDeviceAsDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.DeviceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphDevice.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].RegisteredDevices.GraphDevice.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
