...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWorkHourAndLocationOccurrence_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WorkPlanOccurrence))]
    public class GetMgUserSettingWorkHourAndLocationOccurrence_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.WorkPlanOccurrenceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Settings.WorkHoursAndLocations.Occurrences.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Settings.WorkHoursAndLocations.Occurrences.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
