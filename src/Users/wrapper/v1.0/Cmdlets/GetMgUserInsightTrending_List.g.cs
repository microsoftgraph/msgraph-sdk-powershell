...
{
    [GraphRoute("GET", "/users/{user-id}/insights/trending")]
    [Cmdlet(VerbsCommon.Get, "MgUserInsightTrending_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Trending))]
    public class GetMgUserInsightTrending_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.TrendingCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Insights.Trending.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Insights.Trending.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
