...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedObjectCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
