...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class UpdateMgUserOutlookMasterCategoryCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Color)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, OutlookCategoryId));
                return;
            }
