...
{
    [GraphRoute("GET", "/users/{user-id}/settings/workHoursAndLocations")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWorkHourAndLocation")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WorkHoursAndLocationsSetting))]
    public class GetMgUserSettingWorkHourAndLocationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.WorkHoursAndLocations.GetAsync(requestConfiguration =>
                {
