...
{
    [GraphRoute("GET", "/users/{user-id}/outlook/masterCategories/{outlookCategory-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookMasterCategory_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OutlookCategory))]
    public class GetMgUserOutlookMasterCategory_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Outlook.MasterCategories[OutlookCategoryId].GetAsync(requestConfiguration =>
                {
