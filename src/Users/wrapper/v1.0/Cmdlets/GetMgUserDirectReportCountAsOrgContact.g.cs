...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgUserDirectReportCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].DirectReports.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
