...
{
    [GraphRoute("GET", "/users/{user-id}/settings/shiftPreferences")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingShiftPreference")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ShiftPreferences))]
    public class GetMgUserSettingShiftPreferenceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.ShiftPreferences.GetAsync(requestConfiguration =>
                {
