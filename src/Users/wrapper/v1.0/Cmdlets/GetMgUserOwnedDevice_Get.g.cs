...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserOwnedDevice_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
