...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/graph.directoryRole/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfCountAsDirectoryRole")]
    [OutputType(typeof(int))]
    public class GetMgUserMemberOfCountAsDirectoryRoleCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf.GraphDirectoryRole.Count.GetAsync(requestConfiguration =>
                {
