...
{
    [GraphRoute("GET", "/users/{user-id}/settings/storage/quota")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingStorageQuota")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UnifiedStorageQuota))]
    public class GetMgUserSettingStorageQuotaCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.Storage.Quota.GetAsync(requestConfiguration =>
                {
