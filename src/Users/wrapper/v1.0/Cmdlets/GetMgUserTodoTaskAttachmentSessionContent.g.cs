...
{
    [GraphRoute("GET", "/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/attachmentSessions/{attachmentSession-id}/content")]
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTaskAttachmentSessionContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserTodoTaskAttachmentSessionContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].AttachmentSessions[AttachmentSessionId].Content.GetAsync(requestConfiguration =>
                {
