...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectCount")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedObjectCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.Count.GetAsync(requestConfiguration =>
                {
