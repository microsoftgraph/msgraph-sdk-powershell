...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.endpoint/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceCountAsEndpoint")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedDeviceCountAsEndpointCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphEndpoint.Count.GetAsync(requestConfiguration =>
                {
