...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceCount")]
    [OutputType(typeof(int))]
    public class GetMgUserRegisteredDeviceCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices.Count.GetAsync(requestConfiguration =>
                {
