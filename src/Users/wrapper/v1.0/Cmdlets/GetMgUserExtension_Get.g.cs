...
{
    [GraphRoute("GET", "/users/{user-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Extension))]
    public class GetMgUserExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
