...
{
    [GraphRoute("GET", "/users/{user-id}/licenseDetails/{licenseDetails-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserLicenseDetail_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.LicenseDetails))]
    public class GetMgUserLicenseDetail_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].LicenseDetails[LicenseDetailsId].GetAsync(requestConfiguration =>
                {
