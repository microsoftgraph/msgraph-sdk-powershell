...
{
    [GraphRoute("GET", "/users/{user-id}/settings/itemInsights")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingItemInsight")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UserInsightsSettings))]
    public class GetMgUserSettingItemInsightCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.ItemInsights.GetAsync(requestConfiguration =>
                {
