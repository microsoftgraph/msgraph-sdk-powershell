...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfAsAdministrativeUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AdministrativeUnit))]
    public class GetMgUserTransitiveMemberOfAsAdministrativeUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].TransitiveMemberOf.GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].TransitiveMemberOf.GraphAdministrativeUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
