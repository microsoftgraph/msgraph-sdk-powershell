...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class UpdateMgUserSettingStorageQuotaServiceCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Used)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ServiceStorageQuotaBreakdownId));
                return;
            }
