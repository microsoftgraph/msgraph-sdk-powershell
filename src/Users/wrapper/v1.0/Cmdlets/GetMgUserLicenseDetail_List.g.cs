...
{
    [GraphRoute("GET", "/users/{user-id}/licenseDetails")]
    [Cmdlet(VerbsCommon.Get, "MgUserLicenseDetail_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.LicenseDetails))]
    public class GetMgUserLicenseDetail_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.LicenseDetailsCollectionResponse? result;
            try
            {
                result = client.Users[UserId].LicenseDetails.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].LicenseDetails.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
