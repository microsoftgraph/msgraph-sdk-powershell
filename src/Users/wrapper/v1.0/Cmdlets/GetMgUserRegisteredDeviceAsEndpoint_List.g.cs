...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsEndpoint_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint))]
    public class GetMgUserRegisteredDeviceAsEndpoint_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.EndpointCollectionResponse? result;
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphEndpoint.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].RegisteredDevices.GraphEndpoint.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
