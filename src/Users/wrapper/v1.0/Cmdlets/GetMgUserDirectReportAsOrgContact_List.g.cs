...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsOrgContact_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OrgContact))]
    public class GetMgUserDirectReportAsOrgContact_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.OrgContactCollectionResponse? result;
            try
            {
                result = client.Users[UserId].DirectReports.GraphOrgContact.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].DirectReports.GraphOrgContact.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
