...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedDeviceCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
