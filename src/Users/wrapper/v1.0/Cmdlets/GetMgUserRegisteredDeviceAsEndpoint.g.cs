...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsEndpoint", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.EndpointCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint), ParameterSetName = new[] { "Get" })]
    public class GetMgUserRegisteredDeviceAsEndpointCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserRegisteredDeviceAsEndpoint_Get or Get-MgUserRegisteredDeviceAsEndpoint_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserRegisteredDeviceAsEndpoint_Get" : "Get-MgUserRegisteredDeviceAsEndpoint_List";
            try
            {
