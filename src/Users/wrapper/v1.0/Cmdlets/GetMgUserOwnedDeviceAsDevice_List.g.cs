...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsDevice_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Device))]
    public class GetMgUserOwnedDeviceAsDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphDevice.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedDevices.GraphDevice.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
