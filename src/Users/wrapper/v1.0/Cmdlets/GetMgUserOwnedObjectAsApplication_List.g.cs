...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsApplication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Application))]
    public class GetMgUserOwnedObjectAsApplication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.ApplicationCollectionResponse? result;
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphApplication.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedObjects.GraphApplication.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
