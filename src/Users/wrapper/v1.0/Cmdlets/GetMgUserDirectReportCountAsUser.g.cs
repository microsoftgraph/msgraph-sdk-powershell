...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgUserDirectReportCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].DirectReports.GraphUser.Count.GetAsync(requestConfiguration =>
                {
