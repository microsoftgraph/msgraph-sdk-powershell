...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWorkHourAndLocationRecurrence_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WorkPlanRecurrence))]
    public class GetMgUserSettingWorkHourAndLocationRecurrence_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.WorkPlanRecurrenceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Settings.WorkHoursAndLocations.Recurrences.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Settings.WorkHoursAndLocations.Recurrences.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
