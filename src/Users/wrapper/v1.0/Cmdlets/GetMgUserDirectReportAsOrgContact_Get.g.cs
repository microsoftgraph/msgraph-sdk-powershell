...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OrgContact))]
    public class GetMgUserDirectReportAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.OrgContact? result;
            try
            {
                result = client.Users[UserId].DirectReports[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
