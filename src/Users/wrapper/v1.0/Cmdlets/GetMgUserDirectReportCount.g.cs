...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportCount")]
    [OutputType(typeof(int))]
    public class GetMgUserDirectReportCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].DirectReports.Count.GetAsync(requestConfiguration =>
                {
