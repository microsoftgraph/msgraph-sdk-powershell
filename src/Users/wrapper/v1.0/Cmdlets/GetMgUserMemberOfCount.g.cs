...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgUserMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf.Count.GetAsync(requestConfiguration =>
                {
