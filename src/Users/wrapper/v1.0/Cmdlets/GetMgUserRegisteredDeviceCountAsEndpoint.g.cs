...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/graph.endpoint/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceCountAsEndpoint")]
    [OutputType(typeof(int))]
    public class GetMgUserRegisteredDeviceCountAsEndpointCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphEndpoint.Count.GetAsync(requestConfiguration =>
                {
