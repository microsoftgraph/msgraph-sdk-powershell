...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgUserRegisteredDeviceCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
