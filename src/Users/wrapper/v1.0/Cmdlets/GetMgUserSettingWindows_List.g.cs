...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWindows_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WindowsSetting))]
    public class GetMgUserSettingWindows_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.WindowsSettingCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Settings.Windows.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Settings.Windows.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
