...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOutlookMasterCategory_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OutlookCategory))]
    public class GetMgUserOutlookMasterCategory_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.OutlookCategoryCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Outlook.MasterCategories.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Outlook.MasterCategories.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
