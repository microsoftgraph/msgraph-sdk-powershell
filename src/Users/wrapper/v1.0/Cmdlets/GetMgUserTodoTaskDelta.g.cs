...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class GetMgUserTodoTaskDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.Users.Client.Users.Item.Todo.Lists.Item.Tasks.Delta.DeltaGetResponse? result;
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
