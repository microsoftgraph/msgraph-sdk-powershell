...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/{directoryObject-id}/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsEndpoint_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint))]
    public class GetMgUserRegisteredDeviceAsEndpoint_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices[DirectoryObjectId].GraphEndpoint.GetAsync(requestConfiguration =>
                {
