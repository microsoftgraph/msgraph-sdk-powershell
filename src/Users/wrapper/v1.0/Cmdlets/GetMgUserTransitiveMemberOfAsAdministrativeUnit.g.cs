...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfAsAdministrativeUnit", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AdministrativeUnitCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AdministrativeUnit), ParameterSetName = new[] { "Get" })]
    public class GetMgUserTransitiveMemberOfAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserTransitiveMemberOfAsAdministrativeUnit_Get or Get-MgUserTransitiveMemberOfAsAdministrativeUnit_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserTransitiveMemberOfAsAdministrativeUnit_Get" : "Get-MgUserTransitiveMemberOfAsAdministrativeUnit_List";
            try
            {
