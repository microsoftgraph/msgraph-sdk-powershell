...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsUser", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserDirectReportAsUserCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserDirectReportAsUser_Get or Get-MgUserDirectReportAsUser_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserDirectReportAsUser_Get" : "Get-MgUserDirectReportAsUser_List";
            try
            {
