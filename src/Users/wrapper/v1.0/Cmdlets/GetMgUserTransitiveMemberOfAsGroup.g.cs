...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfAsGroup", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.GroupCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Group), ParameterSetName = new[] { "Get" })]
    public class GetMgUserTransitiveMemberOfAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserTransitiveMemberOfAsGroup_Get or Get-MgUserTransitiveMemberOfAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserTransitiveMemberOfAsGroup_Get" : "Get-MgUserTransitiveMemberOfAsGroup_List";
            try
            {
