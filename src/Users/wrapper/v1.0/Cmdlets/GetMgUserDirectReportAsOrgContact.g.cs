...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsOrgContact", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OrgContactCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OrgContact), ParameterSetName = new[] { "Get" })]
    public class GetMgUserDirectReportAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserDirectReportAsOrgContact_Get or Get-MgUserDirectReportAsOrgContact_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserDirectReportAsOrgContact_Get" : "Get-MgUserDirectReportAsOrgContact_List";
            try
            {
