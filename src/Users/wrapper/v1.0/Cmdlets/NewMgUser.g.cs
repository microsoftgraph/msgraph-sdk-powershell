...
{
    [GraphRoute("POST", "/users")]
    [Cmdlet(VerbsCommon.New, "MgUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.User))]
    public class NewMgUserCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SignInActivity)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users.PostAsync(body, requestConfiguration =>
                {
