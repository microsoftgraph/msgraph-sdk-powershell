...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class UpdateMgUserSettingWindowsCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(SettingType)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, WindowsSettingId));
                return;
            }
