...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWindowsInstance_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WindowsSettingInstance))]
    public class GetMgUserSettingWindowsInstance_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.WindowsSettingInstanceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Settings.Windows[WindowsSettingId].Instances.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Settings.Windows[WindowsSettingId].Instances.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
