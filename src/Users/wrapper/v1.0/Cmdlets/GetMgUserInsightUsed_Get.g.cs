...
{
    [GraphRoute("GET", "/users/{user-id}/insights/used/{usedInsight-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserInsightUsed_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UsedInsight))]
    public class GetMgUserInsightUsed_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Insights.Used[UsedInsightId].GetAsync(requestConfiguration =>
                {
