...
{
    [GraphRoute("GET", "/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTask_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.TodoTask))]
    public class GetMgUserTodoTask_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].GetAsync(requestConfiguration =>
                {
