...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Group))]
    public class GetMgUserOwnedObjectAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
