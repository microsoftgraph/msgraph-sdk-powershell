...
{
    [GraphRoute("GET", "/users/{user-id}/sponsorOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserSponsorOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserSponsorOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].SponsorOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
