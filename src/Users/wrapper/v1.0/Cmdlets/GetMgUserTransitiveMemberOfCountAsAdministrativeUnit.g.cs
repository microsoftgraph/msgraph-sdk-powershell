...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/graph.administrativeUnit/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfCountAsAdministrativeUnit")]
    [OutputType(typeof(int))]
    public class GetMgUserTransitiveMemberOfCountAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].TransitiveMemberOf.GraphAdministrativeUnit.Count.GetAsync(requestConfiguration =>
                {
