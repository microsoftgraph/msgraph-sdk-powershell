...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/graph.appRoleAssignment")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsAppRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignment))]
    public class GetMgUserRegisteredDeviceAsAppRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].RegisteredDevices.GraphAppRoleAssignment.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
