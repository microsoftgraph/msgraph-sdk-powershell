...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsEndpoint", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOwnedDeviceAsEndpointCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedDeviceAsEndpoint_Get or Get-MgUserOwnedDeviceAsEndpoint_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedDeviceAsEndpoint_Get" : "Get-MgUserOwnedDeviceAsEndpoint_List";
            try
            {
