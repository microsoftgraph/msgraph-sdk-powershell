...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserInsightUsed_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UsedInsight))]
    public class GetMgUserInsightUsed_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.UsedInsightCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Insights.Used.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Insights.Used.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
