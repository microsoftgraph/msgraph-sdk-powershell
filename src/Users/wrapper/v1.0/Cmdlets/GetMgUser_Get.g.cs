...
{
    [GraphRoute("GET", "/users/{user-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.User))]
    public class GetMgUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].GetAsync(requestConfiguration =>
                {
