...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgUserTransitiveMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].TransitiveMemberOf.Count.GetAsync(requestConfiguration =>
                {
