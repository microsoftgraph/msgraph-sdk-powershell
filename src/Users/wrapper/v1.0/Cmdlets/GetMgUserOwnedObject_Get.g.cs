...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObject_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserOwnedObject_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
