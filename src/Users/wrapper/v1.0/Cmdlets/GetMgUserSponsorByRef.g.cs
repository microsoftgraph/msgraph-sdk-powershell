...
{
    [GraphRoute("GET", "/users/{user-id}/sponsors/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgUserSponsorByRef")]
    [OutputType(typeof(string))]
    public class GetMgUserSponsorByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.StringCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Sponsors.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Sponsors.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
