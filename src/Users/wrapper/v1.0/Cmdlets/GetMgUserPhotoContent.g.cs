...
{
    [GraphRoute("GET", "/users/{user-id}/photo/$value")]
    [Cmdlet(VerbsCommon.Get, "MgUserPhotoContent")]
    [OutputType(typeof(byte[]))]
    public class GetMgUserPhotoContentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Photo.Content.GetAsync(requestConfiguration =>
                {
