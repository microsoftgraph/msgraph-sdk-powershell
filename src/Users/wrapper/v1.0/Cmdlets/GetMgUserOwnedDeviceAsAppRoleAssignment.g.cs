...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsAppRoleAssignment", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignmentCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignment), ParameterSetName = new[] { "Get" })]
    public class GetMgUserOwnedDeviceAsAppRoleAssignmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedDeviceAsAppRoleAssignment_Get or Get-MgUserOwnedDeviceAsAppRoleAssignment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedDeviceAsAppRoleAssignment_Get" : "Get-MgUserOwnedDeviceAsAppRoleAssignment_List";
            try
            {
