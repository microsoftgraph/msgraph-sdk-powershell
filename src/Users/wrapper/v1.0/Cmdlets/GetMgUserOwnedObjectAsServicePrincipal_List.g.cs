...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsServicePrincipal_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipal))]
    public class GetMgUserOwnedObjectAsServicePrincipal_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedObjects.GraphServicePrincipal.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
