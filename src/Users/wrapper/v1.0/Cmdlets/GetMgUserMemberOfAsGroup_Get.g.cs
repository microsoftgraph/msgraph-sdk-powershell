...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/{directoryObject-id}/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Group))]
    public class GetMgUserMemberOfAsGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf[DirectoryObjectId].GraphGroup.GetAsync(requestConfiguration =>
                {
