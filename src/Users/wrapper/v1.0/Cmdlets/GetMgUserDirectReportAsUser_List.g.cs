...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.User))]
    public class GetMgUserDirectReportAsUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.UserCollectionResponse? result;
            try
            {
                result = client.Users[UserId].DirectReports.GraphUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].DirectReports.GraphUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
