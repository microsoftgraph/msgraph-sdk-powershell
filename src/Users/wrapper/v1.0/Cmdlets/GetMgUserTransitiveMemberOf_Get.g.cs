...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserTransitiveMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserTransitiveMemberOf_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].TransitiveMemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
