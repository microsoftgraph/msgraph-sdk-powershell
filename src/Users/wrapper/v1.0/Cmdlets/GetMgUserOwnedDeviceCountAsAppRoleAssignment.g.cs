...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.appRoleAssignment/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceCountAsAppRoleAssignment")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedDeviceCountAsAppRoleAssignmentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphAppRoleAssignment.Count.GetAsync(requestConfiguration =>
                {
