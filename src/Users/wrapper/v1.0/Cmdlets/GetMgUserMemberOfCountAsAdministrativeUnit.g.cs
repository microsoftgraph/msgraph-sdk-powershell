...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/graph.administrativeUnit/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfCountAsAdministrativeUnit")]
    [OutputType(typeof(int))]
    public class GetMgUserMemberOfCountAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf.GraphAdministrativeUnit.Count.GetAsync(requestConfiguration =>
                {
