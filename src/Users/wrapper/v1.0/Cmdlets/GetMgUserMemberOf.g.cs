...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserMemberOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserMemberOf_Get or Get-MgUserMemberOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserMemberOf_Get" : "Get-MgUserMemberOf_List";
            try
            {
