...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserSettingStorageQuotaService_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServiceStorageQuotaBreakdown))]
    public class GetMgUserSettingStorageQuotaService_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.ServiceStorageQuotaBreakdownCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Settings.Storage.Quota.Services.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Settings.Storage.Quota.Services.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
