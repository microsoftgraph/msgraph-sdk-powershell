...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.appRoleAssignment")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsAppRoleAssignment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignment))]
    public class GetMgUserOwnedDeviceAsAppRoleAssignment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.AppRoleAssignmentCollectionResponse? result;
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphAppRoleAssignment.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedDevices.GraphAppRoleAssignment.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
