...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/{directoryObject-id}/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsAdministrativeUnit_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AdministrativeUnit))]
    public class GetMgUserMemberOfAsAdministrativeUnit_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf[DirectoryObjectId].GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
