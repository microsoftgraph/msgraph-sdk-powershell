...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/{directoryObject-id}/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsEndpoint_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint))]
    public class GetMgUserOwnedDeviceAsEndpoint_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint? result;
            try
            {
                result = client.Users[UserId].OwnedDevices[DirectoryObjectId].GraphEndpoint.GetAsync(requestConfiguration =>
                {
