...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/graph.directoryRole")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsDirectoryRole_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryRole))]
    public class GetMgUserMemberOfAsDirectoryRole_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf.GraphDirectoryRole.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].MemberOf.GraphDirectoryRole.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
