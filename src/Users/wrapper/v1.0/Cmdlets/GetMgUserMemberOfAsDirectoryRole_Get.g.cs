...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/{directoryObject-id}/graph.directoryRole")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsDirectoryRole_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryRole))]
    public class GetMgUserMemberOfAsDirectoryRole_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].MemberOf[DirectoryObjectId].GraphDirectoryRole.GetAsync(requestConfiguration =>
                {
