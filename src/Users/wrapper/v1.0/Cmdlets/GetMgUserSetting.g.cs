...
{
    [GraphRoute("GET", "/users/{user-id}/settings")]
    [Cmdlet(VerbsCommon.Get, "MgUserSetting")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UserSettings))]
    public class GetMgUserSettingCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.GetAsync(requestConfiguration =>
                {
