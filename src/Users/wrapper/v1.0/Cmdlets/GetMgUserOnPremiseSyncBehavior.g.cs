...
{
    [GraphRoute("GET", "/users/{user-id}/onPremisesSyncBehavior")]
    [Cmdlet(VerbsCommon.Get, "MgUserOnPremiseSyncBehavior")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.OnPremisesSyncBehavior))]
    public class GetMgUserOnPremiseSyncBehaviorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OnPremisesSyncBehavior.GetAsync(requestConfiguration =>
                {
