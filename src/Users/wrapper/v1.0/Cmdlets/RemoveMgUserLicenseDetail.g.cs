...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class RemoveMgUserLicenseDetailCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, LicenseDetailsId));
                return;
            }
        }
    }
