...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedObjectCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
