...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsEndpoint_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Endpoint))]
    public class GetMgUserOwnedDeviceAsEndpoint_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.GraphEndpoint.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedDevices.GraphEndpoint.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
