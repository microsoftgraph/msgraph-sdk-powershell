...
{
    [GraphRoute("GET", "/users/{user-id}/createdObjects/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgUserCreatedObjectAsServicePrincipal", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipalCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipal), ParameterSetName = new[] { "Get" })]
    public class GetMgUserCreatedObjectAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserCreatedObjectAsServicePrincipal_Get or Get-MgUserCreatedObjectAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserCreatedObjectAsServicePrincipal_Get" : "Get-MgUserCreatedObjectAsServicePrincipal_List";
            try
            {
