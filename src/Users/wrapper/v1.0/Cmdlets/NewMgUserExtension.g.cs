...
{
    [GraphRoute("POST", "/users/{user-id}/extensions")]
    [Cmdlet(VerbsCommon.New, "MgUserExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Extension))]
    public class NewMgUserExtensionCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Extensions.PostAsync(body, requestConfiguration =>
                {
