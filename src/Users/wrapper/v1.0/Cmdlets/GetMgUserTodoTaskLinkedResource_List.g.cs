...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTaskLinkedResource_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.LinkedResource))]
    public class GetMgUserTodoTaskLinkedResource_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.LinkedResourceCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].LinkedResources.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].LinkedResources.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
