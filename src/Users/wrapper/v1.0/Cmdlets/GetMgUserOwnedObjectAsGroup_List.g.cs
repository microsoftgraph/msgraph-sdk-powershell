...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Group))]
    public class GetMgUserOwnedObjectAsGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects.GraphGroup.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].OwnedObjects.GraphGroup.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
