...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsDirectoryRole", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserMemberOfAsDirectoryRoleCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserMemberOfAsDirectoryRole_Get or Get-MgUserMemberOfAsDirectoryRole_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserMemberOfAsDirectoryRole_Get" : "Get-MgUserMemberOfAsDirectoryRole_List";
            try
            {
