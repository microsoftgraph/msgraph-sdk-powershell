...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Device))]
    public class GetMgUserRegisteredDeviceAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
