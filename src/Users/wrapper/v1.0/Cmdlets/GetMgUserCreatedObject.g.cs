...
{
    [GraphRoute("GET", "/users/{user-id}/createdObjects")]
    [Cmdlet(VerbsCommon.Get, "MgUserCreatedObject", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserCreatedObjectCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserCreatedObject_Get or Get-MgUserCreatedObject_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserCreatedObject_Get" : "Get-MgUserCreatedObject_List";
            try
            {
