...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    public class GetMgUserTodoListDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
