...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTask_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.TodoTask))]
    public class GetMgUserTodoTask_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.TodoTaskCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
