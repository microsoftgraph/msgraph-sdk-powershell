...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOwnedObjectAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedObjectAsServicePrincipal_Get or Get-MgUserOwnedObjectAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedObjectAsServicePrincipal_Get" : "Get-MgUserOwnedObjectAsServicePrincipal_List";
            try
            {
