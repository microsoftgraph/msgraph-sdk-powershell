...
{
    [GraphRoute("GET", "/users/{user-id}/createdObjects/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserCreatedObject_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserCreatedObject_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].CreatedObjects[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
