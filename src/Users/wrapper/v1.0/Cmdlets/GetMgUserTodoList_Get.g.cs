...
{
    [GraphRoute("GET", "/users/{user-id}/todo/lists/{todoTaskList-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserTodoList_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.TodoTaskList))]
    public class GetMgUserTodoList_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].GetAsync(requestConfiguration =>
                {
