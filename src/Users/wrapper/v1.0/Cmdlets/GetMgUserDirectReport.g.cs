...
{
    [GraphRoute("GET", "/users/{user-id}/directReports")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReport", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserDirectReportCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserDirectReport_Get or Get-MgUserDirectReport_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserDirectReport_Get" : "Get-MgUserDirectReport_List";
            try
            {
