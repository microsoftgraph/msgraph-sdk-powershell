...
{
    [GraphRoute("GET", "/users/{user-id}/settings/windows/{windowsSetting-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingWindows_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.WindowsSetting))]
    public class GetMgUserSettingWindows_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.Windows[WindowsSettingId].GetAsync(requestConfiguration =>
                {
