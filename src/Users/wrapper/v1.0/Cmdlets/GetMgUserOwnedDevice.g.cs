...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDevice", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserOwnedDeviceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedDevice_Get or Get-MgUserOwnedDevice_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedDevice_Get" : "Get-MgUserOwnedDevice_List";
            try
            {
