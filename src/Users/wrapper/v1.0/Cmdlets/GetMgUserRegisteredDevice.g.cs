...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDevice", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserRegisteredDeviceCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserRegisteredDevice_Get or Get-MgUserRegisteredDevice_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserRegisteredDevice_Get" : "Get-MgUserRegisteredDevice_List";
            try
            {
