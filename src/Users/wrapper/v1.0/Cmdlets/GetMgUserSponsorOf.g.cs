...
{
    [GraphRoute("GET", "/users/{user-id}/sponsorOf")]
    [Cmdlet(VerbsCommon.Get, "MgUserSponsorOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserSponsorOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserSponsorOf_Get or Get-MgUserSponsorOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserSponsorOf_Get" : "Get-MgUserSponsorOf_List";
            try
            {
