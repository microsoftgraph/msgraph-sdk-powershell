...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTaskAttachment_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.AttachmentBase))]
    public class GetMgUserTodoTaskAttachment_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.AttachmentBaseCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].Attachments.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].Attachments.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
