...
{
    [GraphRoute("GET", "/users/{user-id}/memberOf/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgUserMemberOfAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserMemberOfAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserMemberOfAsGroup_Get or Get-MgUserMemberOfAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserMemberOfAsGroup_Get" : "Get-MgUserMemberOfAsGroup_List";
            try
            {
