...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceAsAppRoleAssignment", DefaultParameterSetName = "List")]
    ...
    public class GetMgUserRegisteredDeviceAsAppRoleAssignmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserRegisteredDeviceAsAppRoleAssignment_Get or Get-MgUserRegisteredDeviceAsAppRoleAssignment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserRegisteredDeviceAsAppRoleAssignment_Get" : "Get-MgUserRegisteredDeviceAsAppRoleAssignment_List";
            try
            {
