...
{
    [GraphRoute("GET", "/users/{user-id}/todo/lists/{todoTaskList-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserTodoListExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Extension))]
    public class GetMgUserTodoListExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
