...
{
    [GraphRoute("GET", "/users/{user-id}/registeredDevices/graph.appRoleAssignment/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserRegisteredDeviceCountAsAppRoleAssignment")]
    [OutputType(typeof(int))]
    public class GetMgUserRegisteredDeviceCountAsAppRoleAssignmentCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].RegisteredDevices.GraphAppRoleAssignment.Count.GetAsync(requestConfiguration =>
                {
