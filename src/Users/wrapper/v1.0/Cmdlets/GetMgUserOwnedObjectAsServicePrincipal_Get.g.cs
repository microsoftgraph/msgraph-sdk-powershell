...
{
    [GraphRoute("GET", "/users/{user-id}/ownedObjects/{directoryObject-id}/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsServicePrincipal_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipal))]
    public class GetMgUserOwnedObjectAsServicePrincipal_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedObjects[DirectoryObjectId].GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
