...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTaskExtension_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Extension))]
    public class GetMgUserTodoTaskExtension_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.ExtensionCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].Extensions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].Extensions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
