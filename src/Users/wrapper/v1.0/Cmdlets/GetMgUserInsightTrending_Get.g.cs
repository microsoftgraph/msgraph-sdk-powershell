...
{
    [GraphRoute("GET", "/users/{user-id}/insights/trending/{trending-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserInsightTrending_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Trending))]
    public class GetMgUserInsightTrending_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Insights.Trending[TrendingId].GetAsync(requestConfiguration =>
                {
