...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserCreatedObjectAsServicePrincipal_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipal))]
    public class GetMgUserCreatedObjectAsServicePrincipal_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.ServicePrincipalCollectionResponse? result;
            try
            {
                result = client.Users[UserId].CreatedObjects.GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].CreatedObjects.GraphServicePrincipal.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
