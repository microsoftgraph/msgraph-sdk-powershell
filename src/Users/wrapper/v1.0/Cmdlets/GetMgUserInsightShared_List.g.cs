...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserInsightShared_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.SharedInsight))]
    public class GetMgUserInsightShared_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.SharedInsightCollectionResponse? result;
            try
            {
                result = client.Users[UserId].Insights.Shared.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Users[UserId].Insights.Shared.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
