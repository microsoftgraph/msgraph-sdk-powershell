...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceCount")]
    [OutputType(typeof(int))]
    public class GetMgUserOwnedDeviceCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].OwnedDevices.Count.GetAsync(requestConfiguration =>
                {
