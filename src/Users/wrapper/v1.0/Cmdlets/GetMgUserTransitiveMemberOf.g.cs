...
{
    [GraphRoute("GET", "/users/{user-id}/transitiveMemberOf")]
    ...
    public class GetMgUserTransitiveMemberOfCommand : PSCmdlet
    {
        ...
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserTransitiveMemberOf_Get" : "Get-MgUserTransitiveMemberOf_List";
            try
            {
