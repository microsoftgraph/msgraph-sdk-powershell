...
{
    [GraphRoute("GET", "/users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/extensions/{extension-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserTodoTaskExtension_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Extension))]
    public class GetMgUserTodoTaskExtension_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Todo.Lists[TodoTaskListId].Tasks[TodoTaskId].Extensions[ExtensionId].GetAsync(requestConfiguration =>
                {
