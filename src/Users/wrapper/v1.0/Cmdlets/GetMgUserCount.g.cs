...
{
    [GraphRoute("GET", "/users/$count")]
    [Cmdlet(VerbsCommon.Get, "MgUserCount")]
    [OutputType(typeof(int))]
    public class GetMgUserCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users.Count.GetAsync(requestConfiguration =>
                {
