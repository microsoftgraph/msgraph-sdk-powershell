...
{
    [GraphRoute("GET", "/users/{user-id}/ownedDevices/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedDeviceAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Device))]
    public class GetMgUserOwnedDeviceAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Users.Client.Models.Device? result;
            try
            {
                result = client.Users[UserId].OwnedDevices[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
