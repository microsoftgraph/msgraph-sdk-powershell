...
{
    [GraphRoute("GET", "/users/{user-id}/settings/storage")]
    [Cmdlet(VerbsCommon.Get, "MgUserSettingStorage")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.UserStorage))]
    public class GetMgUserSettingStorageCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].Settings.Storage.GetAsync(requestConfiguration =>
                {
