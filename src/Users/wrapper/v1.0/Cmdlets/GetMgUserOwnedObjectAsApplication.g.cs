...
namespace Microsoft.Graph.PowerShell.Users
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgUserOwnedObjectAsApplication", DefaultParameterSetName = "List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.ApplicationCollectionResponse), ParameterSetName = new[] { "List" })]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.Application), ParameterSetName = new[] { "Get" })]
    public class GetMgUserOwnedObjectAsApplicationCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgUserOwnedObjectAsApplication_Get or Get-MgUserOwnedObjectAsApplication_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgUserOwnedObjectAsApplication_Get" : "Get-MgUserOwnedObjectAsApplication_List";
            try
            {
