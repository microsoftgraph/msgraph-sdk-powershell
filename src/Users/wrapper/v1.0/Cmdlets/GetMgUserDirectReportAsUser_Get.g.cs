...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/{directoryObject-id}/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReportAsUser_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.User))]
    public class GetMgUserDirectReportAsUser_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].DirectReports[DirectoryObjectId].GraphUser.GetAsync(requestConfiguration =>
                {
