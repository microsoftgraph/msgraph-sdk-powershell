...
{
    [GraphRoute("GET", "/users/{user-id}/directReports/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserDirectReport_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Users.Client.Models.DirectoryObject))]
    public class GetMgUserDirectReport_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].DirectReports[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
