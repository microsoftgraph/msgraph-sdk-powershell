...
### Get (Default)
```
Get-MgUserManagerByRef -UserId <String> [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserManagerByRef -InputObject <IUsersIdentity> [-Headers <IDictionary>] [<CommonParameters>]
```
