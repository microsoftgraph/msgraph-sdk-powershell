...
```
New-MgUserSettingWindows -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
...
```
New-MgUserSettingWindows -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-Instances <IMicrosoftGraphWindowsSettingInstance[]>] [-PayloadType <String>]
 [-ResponseHeadersVariable <String>] [-SettingType <String>] [-WindowsDeviceId <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
