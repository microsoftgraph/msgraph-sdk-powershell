...
### Get (Default)
```
Get-MgUserPhoto -UserId <String> [-Property <String[]>] [-Headers <IDictionary>] [<CommonParameters>]
```

### Get1
```
Get-MgUserPhoto -ProfilePhotoId <String> -UserId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [<CommonParameters>]
```
