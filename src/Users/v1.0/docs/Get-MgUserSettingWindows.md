...
### List (Default)
```
Get-MgUserSettingWindows -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserSettingWindows -UserId <String> -WindowsSettingId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserSettingWindows -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
