...
```
New-MgUser [-AboutMe <String>] [-AccountEnabled] [-AdditionalProperties <Hashtable>] [-AgeGroup <String>]
...
### Create
```
New-MgUser -BodyParameter <IMicrosoftGraphUser> [-Confirm] [-WhatIf] [<CommonParameters>]
```
