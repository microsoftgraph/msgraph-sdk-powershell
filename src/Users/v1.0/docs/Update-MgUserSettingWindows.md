...
```
Update-MgUserSettingWindows -UserId <String> -WindowsSettingId <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgUserSettingWindows -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>] [-Id <String>]
