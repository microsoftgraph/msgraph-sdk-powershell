...
### Delete (Default)
```
Remove-MgUserTodoList -TodoTaskListId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserTodoList -InputObject <IUsersIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
