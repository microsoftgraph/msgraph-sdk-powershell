...
### Delete (Default)
```
Remove-MgUserManagerByRef -UserId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserManagerByRef -InputObject <IUsersIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
