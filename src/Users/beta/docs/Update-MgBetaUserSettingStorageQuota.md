...
```
Update-MgBetaUserSettingStorageQuota -UserId <String> [-AdditionalProperties <Hashtable>] [-Deleted <Int64>]
 [-Id <String>] [-ManageWebUrl <String>] [-Remaining <Int64>] [-ResponseHeadersVariable <String>]
 [-Services <IMicrosoftGraphServiceStorageQuotaBreakdown[]>] [-State <String>] [-Total <Int64>]
 [-Used <Int64>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgBetaUserSettingStorageQuota -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]
 [-Deleted <Int64>] [-Id <String>] [-ManageWebUrl <String>] [-Remaining <Int64>]
 [-ResponseHeadersVariable <String>] [-Services <IMicrosoftGraphServiceStorageQuotaBreakdown[]>]
 [-State <String>] [-Total <Int64>] [-Used <Int64>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
