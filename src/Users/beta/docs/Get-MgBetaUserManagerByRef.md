...
### Get (Default)
```
Get-MgBetaUserManagerByRef -UserId <String> [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserManagerByRef -InputObject <IUsersIdentity> [-Headers <IDictionary>] [<CommonParameters>]
```
