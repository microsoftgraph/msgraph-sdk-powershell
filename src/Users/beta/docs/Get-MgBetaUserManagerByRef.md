...
### Get (Default)
```
Get-MgBetaUserManagerByRef -UserId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserManagerByRef -InputObject <IUsersIdentity> [-ResponseHeadersVariable <String>]
