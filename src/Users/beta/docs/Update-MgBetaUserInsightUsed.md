...
Update-MgBetaUserInsightUsed -UsedInsightId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ResourceVisualization <IMicrosoftGraphResourceVisualization>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserInsightUsed -UsedInsightId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphUsedInsight> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
