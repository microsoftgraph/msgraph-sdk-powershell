...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/new-mgbetauseroutlooktaskgrouptaskfoldertask
schema: 2.0.0
---
...
New-MgBetaUserOutlookTaskGroupTaskFolderTask -OutlookTaskFolderId <String> -OutlookTaskGroupId <String>
 -UserId <String> [-AdditionalProperties <Hashtable>] [-AssignedTo <String>] [-Body <IMicrosoftGraphItemBody>]
 ...
 [-Importance <String>] [-IsReminderOn] [-LastModifiedDateTime <DateTime>] [-Owner <String>]
