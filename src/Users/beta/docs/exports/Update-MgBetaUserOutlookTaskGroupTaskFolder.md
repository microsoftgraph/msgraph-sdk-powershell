...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/update-mgbetauseroutlooktaskgrouptaskfolder
schema: 2.0.0
---
...
Update-MgBetaUserOutlookTaskGroupTaskFolder -OutlookTaskFolderId <String> -OutlookTaskGroupId <String>
 ...
 [-Name <String>] [-ParentGroupKey <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
