...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/update-mgbetauseroutlooktaskgroup
schema: 2.0.0
---
...
Update-MgBetaUserOutlookTaskGroup -OutlookTaskGroupId <String> -UserId <String>
 ...
 [-IsDefaultGroup] [-Name <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
