...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/update-mgbetauseroutlooktaskfoldersinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgBetaUserOutlookTaskFolderSingleValueExtendedProperty -OutlookTaskFolderId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserOutlookTaskFolderSingleValueExtendedProperty -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
