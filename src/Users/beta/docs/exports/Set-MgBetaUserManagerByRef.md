...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/set-mgbetausermanagerbyref
schema: 2.0.0
---
...
```
Set-MgBetaUserManagerByRef -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]
