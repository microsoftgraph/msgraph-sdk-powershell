...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/update-mgbetauser
schema: 2.0.0
---
...
```
Update-MgBetaUser -UserId <String> [-AboutMe <String>] [-AccountEnabled] [-AdditionalProperties <Hashtable>]
 [-AgeGroup <String>] [-Analytics <IMicrosoftGraphUserAnalytics>]
...
### Update
```
Update-MgBetaUser -UserId <String> -BodyParameter <IMicrosoftGraphUser> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaUser -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphUser> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaUser -InputObject <IUsersIdentity> [-AboutMe <String>] [-AccountEnabled]
 [-AdditionalProperties <Hashtable>] [-AgeGroup <String>] [-Analytics <IMicrosoftGraphUserAnalytics>]
 [-AssignedLicenses <IMicrosoftGraphAssignedLicense[]>] [-AssignedPlans <IMicrosoftGraphAssignedPlan[]>]
 [-Authentication <IMicrosoftGraphAuthentication>] [-AuthorizationInfo <IMicrosoftGraphAuthorizationInfo>]
 [-Birthday <DateTime>] [-BusinessPhones <String[]>] [-Calendar <IMicrosoftGraphCalendar>] [-City <String>]
 [-CompanyName <String>] [-ConsentProvidedForMinor <String>] [-Country <String>] [-CreatedDateTime <DateTime>]
