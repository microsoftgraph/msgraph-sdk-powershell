...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.beta.users/get-mgbetausertodolisttaskchecklistitem
schema: 2.0.0
---
...
### Get
```
Get-MgBetaUserTodoListTaskChecklistItem -ChecklistItemId <String> -TodoTaskId <String>
