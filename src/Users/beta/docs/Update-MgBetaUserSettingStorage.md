...
```
Update-MgBetaUserSettingStorage -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-Quota <IMicrosoftGraphUnifiedStorageQuota>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
...
```
Update-MgBetaUserSettingStorage -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Quota <IMicrosoftGraphUnifiedStorageQuota>] [-ResponseHeadersVariable <String>]
