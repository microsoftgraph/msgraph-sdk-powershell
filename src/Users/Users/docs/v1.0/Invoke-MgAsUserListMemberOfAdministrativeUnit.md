...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/invoke-mgasuserlistmemberofadministrativeunit
schema: 2.0.0
---
...
### As (Default)
```
Invoke-MgAsUserListMemberOfAdministrativeUnit -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### AsViaIdentity
```
Invoke-MgAsUserListMemberOfAdministrativeUnit -InputObject <IUsersIdentity> [-Count]
