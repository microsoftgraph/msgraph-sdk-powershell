...
```
New-MgBetaUserOutlookTaskGroupTaskFolderTaskMultiValueExtendedProperty -OutlookTaskFolderId <String>
...
### CreateViaIdentity
```
New-MgBetaUserOutlookTaskGroupTaskFolderTaskMultiValueExtendedProperty -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
