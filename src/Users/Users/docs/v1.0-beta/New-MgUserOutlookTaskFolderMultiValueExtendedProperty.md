...
```
New-MgBetaUserOutlookTaskFolderMultiValueExtendedProperty -OutlookTaskFolderId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgBetaUserOutlookTaskFolderMultiValueExtendedProperty -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
