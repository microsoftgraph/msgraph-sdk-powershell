...
```
Update-MgUserOutlook -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
...
### UpdateViaIdentity1
```
Update-MgUserOutlook -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphOutlookUser1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserOutlook -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-MasterCategories <IMicrosoftGraphOutlookCategory[]>] [-TaskFolders <IMicrosoftGraphOutlookTaskFolder[]>]
 [-TaskGroups <IMicrosoftGraphOutlookTaskGroup[]>] [-Tasks <IMicrosoftGraphOutlookTask[]>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
