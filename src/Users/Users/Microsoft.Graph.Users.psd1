...
GUID = '7f02508f-4aa2-4385-9725-b06f6cb630f6'
...
FunctionsToExport = 'Get-MgUser', 'Get-MgUserCreatedObject', 
               ...
               'Get-MgUserManagerByRef', 'Get-MgUserMember', 'Get-MgUserMemberByRef', 
               'Get-MgUserNotification', 'Get-MgUserOauth2PermissionGrant', 
               'Get-MgUserOauth2PermissionGrantByRef', 'Get-MgUserOutlook', 
               ...
               'Remove-MgUserOutlook', 'Remove-MgUserOutlookMasterCategory', 
               'Remove-MgUserOutlookTask', 'Remove-MgUserOutlookTaskAttachment', 
