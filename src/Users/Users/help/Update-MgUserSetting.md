...
Update-MgUserSetting -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-RegionalAndLanguageSettings <IMicrosoftGraphRegionalAndLanguageSettings>]
 [-ShiftPreferences <IMicrosoftGraphShiftPreferences1>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/update-mgusersetting](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/update-mgusersetting)
