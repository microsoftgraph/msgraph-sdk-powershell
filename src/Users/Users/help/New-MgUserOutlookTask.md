...
### Create
```
New-MgUserOutlookTask -UserId <String> -BodyParameter <IMicrosoftGraphOutlookTask> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgUserOutlookTask -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphOutlookTask> [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/new-mguseroutlooktask](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/new-mguseroutlooktask)
