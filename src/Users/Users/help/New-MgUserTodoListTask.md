...
New-MgUserTodoListTask -TodoTaskListId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ReminderDateTime <IMicrosoftGraphDateTimeZone>] [-Status <String>] [-Title <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgUserTodoListTask -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphTodoTask> [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/new-mgusertodolisttask](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/new-mgusertodolisttask)
