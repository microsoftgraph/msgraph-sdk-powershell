...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.activityfeed/update-mguseractivity
schema: 2.0.0
---
...
Update-MgUserActivity -UserActivityId <String> -UserId <String> [-ActivationUrl <String>]
 ...
 [-VisualElementDisplayText <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity1
```
Update-MgUserActivity -InputObject <IUsersActivityFeedIdentity> -BodyParameter <IMicrosoftGraphUserActivity1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserActivity -InputObject <IUsersActivityFeedIdentity> [-ActivationUrl <String>]
 [-ActivitySourceHost <String>] [-AppActivityId <String>] [-AppDisplayName <String>]
 [-AttributionAddImageQuery] [-AttributionAlternateText <String>] [-AttributionAlternativeText <String>]
 [-AttributionIconUrl <String>] [-ContentInfo <IMicrosoftGraphJson>] [-ContentUrl <String>]
 [-CreatedDateTime <DateTime>] [-ExpirationDateTime <DateTime>] [-FallbackUrl <String>]
