...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.activityfeed/get-mguseractivityhistoryitem
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserActivityHistoryItem -UserActivityId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgUserActivityHistoryItem -InputObject <IUsersActivityFeedIdentity> [-ExpandProperty <String[]>]
