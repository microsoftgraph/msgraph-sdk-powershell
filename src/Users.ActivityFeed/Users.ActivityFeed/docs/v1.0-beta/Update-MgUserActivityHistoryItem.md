...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.activityfeed/update-mguseractivityhistoryitem
schema: 2.0.0
---
...
Update-MgUserActivityHistoryItem -ActivityHistoryItemId <String> -UserActivityId <String> -UserId <String>
 [-ActiveDurationSeconds <Int32>] [-Activity <IMicrosoftGraphUserActivity1>] [-CreatedDateTime <DateTime>]
...
### UpdateViaIdentity1
```
Update-MgUserActivityHistoryItem -InputObject <IUsersActivityFeedIdentity>
 -BodyParameter <IMicrosoftGraphActivityHistoryItem1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserActivityHistoryItem -InputObject <IUsersActivityFeedIdentity> [-ActiveDurationSeconds <Int32>]
 [-Activity <IMicrosoftGraphUserActivity1>] [-CreatedDateTime <DateTime>] [-ExpirationDateTime <DateTime>]
