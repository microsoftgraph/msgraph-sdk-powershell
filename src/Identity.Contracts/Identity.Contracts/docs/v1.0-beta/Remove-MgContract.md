...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.contracts/remove-mgcontract
schema: 2.0.0
---
...
### DeleteViaIdentity1
```
Remove-MgContract -InputObject <IIdentityContractsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
