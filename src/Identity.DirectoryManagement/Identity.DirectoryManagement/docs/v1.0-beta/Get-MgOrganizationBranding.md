...
### List (Default)
```
Get-MgOrganizationBranding -OrganizationId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgOrganizationBranding -OrganizationalBrandingId <String> -OrganizationId <String>
