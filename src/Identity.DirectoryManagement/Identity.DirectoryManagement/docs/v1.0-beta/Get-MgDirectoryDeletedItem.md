...
### List (Default)
```
Get-MgBetaDirectoryDeletedItem [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDirectoryDeletedItem -InputObject <IIdentityDirectoryManagementIdentity> [-ExpandProperty <String[]>]
