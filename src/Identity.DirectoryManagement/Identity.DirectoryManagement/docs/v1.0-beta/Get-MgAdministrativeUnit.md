...
### List (Default)
```
Get-MgAdministrativeUnit [-Property <String[]>] [-Search <String>] [-Sort <String[]>] [-Top <Int32>]
 [-ConsistencyLevel <String>] [<CommonParameters>]
```

### Get
```
Get-MgAdministrativeUnit -AdministrativeUnitId <String> [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgAdministrativeUnit -InputObject <IIdentityDirectoryManagementIdentity> [-Property <String[]>]
 [<CommonParameters>]
```
