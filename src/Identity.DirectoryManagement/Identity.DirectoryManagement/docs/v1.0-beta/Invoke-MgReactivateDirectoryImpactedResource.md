...
### Reactivate (Default)
```
Invoke-MgBetaReactivateDirectoryImpactedResource -RecommendationResourceId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ReactivateViaIdentity
```
Invoke-MgBetaReactivateDirectoryImpactedResource -InputObject <IIdentityDirectoryManagementIdentity> [-Confirm]
