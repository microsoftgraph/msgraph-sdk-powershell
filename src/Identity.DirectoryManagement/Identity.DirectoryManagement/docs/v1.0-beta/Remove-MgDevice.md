...
### Delete1 (Default)
```
Remove-MgBetaDevice -DeviceId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-MgBetaDevice -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
...
### Example 1: Using the Remove-MgBetaDevice Cmdlet
```powershell
