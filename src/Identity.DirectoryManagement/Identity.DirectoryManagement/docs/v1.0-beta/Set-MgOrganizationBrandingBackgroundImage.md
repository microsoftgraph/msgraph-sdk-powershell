...
### Set (Default)
```
Set-MgBetaOrganizationBrandingBackgroundImage -OrganizationId <String> -InFile <String> [-BodyParameter <Stream>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaOrganizationBrandingBackgroundImage -InputObject <IIdentityDirectoryManagementIdentity> -InFile <String>
