...
### Create (Default)
```
New-MgAdministrativeUnitMemberByRef -AdministrativeUnitId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgAdministrativeUnitMemberByRef -InputObject <IIdentityDirectoryManagementIdentity> [-PassThru] [-Confirm]
