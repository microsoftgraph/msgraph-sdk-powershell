...
### Complete (Default)
```
Complete-MgDirectoryImpactedResource -ImpactedResourceId <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgDirectoryImpactedResource -InputObject <IIdentityDirectoryManagementIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
