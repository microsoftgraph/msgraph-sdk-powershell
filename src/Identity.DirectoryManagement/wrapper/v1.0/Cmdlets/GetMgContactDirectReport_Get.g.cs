...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReport_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgContactDirectReport_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].DirectReports[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
