...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    public class GetMgOrganizationBrandingCustomCSSCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Organization[OrganizationId].Branding.CustomCSS.GetAsync(requestConfiguration =>
                {
