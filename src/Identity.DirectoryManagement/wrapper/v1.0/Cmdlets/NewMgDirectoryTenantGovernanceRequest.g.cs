...
{
    [GraphRoute("POST", "/directory/tenantGovernance/governanceRequests")]
    [Cmdlet(VerbsCommon.New, "MgDirectoryTenantGovernanceRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.GovernanceRequest))]
    public class NewMgDirectoryTenantGovernanceRequestCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.TenantGovernance.GovernanceRequests.PostAsync(body, requestConfiguration =>
                {
