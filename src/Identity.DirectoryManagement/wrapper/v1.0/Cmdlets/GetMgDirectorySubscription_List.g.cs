...
{
    [GraphRoute("GET", "/directory/subscriptions")]
    [Cmdlet(VerbsCommon.Get, "MgDirectorySubscription_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.CompanySubscription))]
    public class GetMgDirectorySubscription_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.CompanySubscriptionCollectionResponse? result;
            try
            {
                result = client.Directory.Subscriptions.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.Subscriptions.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
