...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberByRef")]
    [OutputType(typeof(string))]
    public class GetMgDirectoryAdministrativeUnitMemberByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
