...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReportCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgContactDirectReportCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].DirectReports.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
