...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgContactTransitiveMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf.Count.GetAsync(requestConfiguration =>
                {
