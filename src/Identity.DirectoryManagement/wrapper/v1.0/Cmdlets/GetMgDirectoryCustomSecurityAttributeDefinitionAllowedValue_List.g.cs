...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryCustomSecurityAttributeDefinitionAllowedValue_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AllowedValue))]
    public class GetMgDirectoryCustomSecurityAttributeDefinitionAllowedValue_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AllowedValueCollectionResponse? result;
            try
            {
                result = client.Directory.CustomSecurityAttributeDefinitions[CustomSecurityAttributeDefinitionId].AllowedValues.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.CustomSecurityAttributeDefinitions[CustomSecurityAttributeDefinitionId].AllowedValues.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
