...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReportAsUser", DefaultParameterSetName = "List")]
    ...
    public class GetMgContactDirectReportAsUserCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgContactDirectReportAsUser_Get or Get-MgContactDirectReportAsUser_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgContactDirectReportAsUser_Get" : "Get-MgContactDirectReportAsUser_List";
            try
            {
