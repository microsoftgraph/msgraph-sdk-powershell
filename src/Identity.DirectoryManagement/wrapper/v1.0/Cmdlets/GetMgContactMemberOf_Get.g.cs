...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgContactMemberOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].MemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
