...
{
    [GraphRoute("GET", "/admin/people/profilePropertySettings")]
    [Cmdlet(VerbsCommon.Get, "MgAdminPeopleProfilePropertySetting_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.ProfilePropertySetting))]
    public class GetMgAdminPeopleProfilePropertySetting_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.ProfilePropertySettingCollectionResponse? result;
            try
            {
                result = client.Admin.People.ProfilePropertySettings.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Admin.People.ProfilePropertySettings.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
