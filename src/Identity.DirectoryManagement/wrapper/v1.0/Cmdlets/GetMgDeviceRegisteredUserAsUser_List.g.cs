...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserAsUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.User))]
    public class GetMgDeviceRegisteredUserAsUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredUsers.GraphUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Devices[DeviceId].RegisteredUsers.GraphUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
