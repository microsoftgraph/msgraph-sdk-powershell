...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.servicePrincipal/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberCountAsServicePrincipal")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryRoleMemberCountAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members.GraphServicePrincipal.Count.GetAsync(requestConfiguration =>
                {
