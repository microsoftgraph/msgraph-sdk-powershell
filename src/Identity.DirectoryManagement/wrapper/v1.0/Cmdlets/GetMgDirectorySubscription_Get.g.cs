...
{
    [GraphRoute("GET", "/directory/subscriptions/{companySubscription-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDirectorySubscription_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.CompanySubscription))]
    public class GetMgDirectorySubscription_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.Subscriptions[CompanySubscriptionId].GetAsync(requestConfiguration =>
                {
