...
{
    [GraphRoute("GET", "/directory/deletedItems/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItem_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgDirectoryDeletedItem_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.DeletedItems[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
