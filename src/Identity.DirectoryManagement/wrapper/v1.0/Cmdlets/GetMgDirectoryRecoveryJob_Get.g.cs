...
{
    [GraphRoute("GET", "/directory/recovery/jobs/{recoveryJobBase-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRecoveryJob_Get")]
    ...
    public class GetMgDirectoryRecoveryJob_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.Recovery.Jobs[RecoveryJobBaseId].GetAsync(requestConfiguration =>
                {
