...
{
    [GraphRoute("GET", "/directory/tenantGovernance/governancePolicyTemplates")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryTenantGovernancePolicyTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.TenantGovernancePolicyTemplate))]
    public class GetMgDirectoryTenantGovernancePolicyTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.TenantGovernancePolicyTemplateCollectionResponse? result;
            try
            {
                result = client.Directory.TenantGovernance.GovernancePolicyTemplates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.TenantGovernance.GovernancePolicyTemplates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
