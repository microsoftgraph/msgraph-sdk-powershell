...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/graph.administrativeUnit/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOfCountAsAdministrativeUnit")]
    [OutputType(typeof(int))]
    public class GetMgContactMemberOfCountAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].MemberOf.GraphAdministrativeUnit.Count.GetAsync(requestConfiguration =>
                {
