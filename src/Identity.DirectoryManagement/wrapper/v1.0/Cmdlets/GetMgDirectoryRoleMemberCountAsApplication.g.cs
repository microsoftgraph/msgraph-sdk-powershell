...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.application/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberCountAsApplication")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryRoleMemberCountAsApplicationCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members.GraphApplication.Count.GetAsync(requestConfiguration =>
                {
