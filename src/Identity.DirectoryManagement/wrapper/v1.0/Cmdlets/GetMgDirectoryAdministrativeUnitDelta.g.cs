...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitDelta")]
    ...
    public class GetMgDirectoryAdministrativeUnitDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
