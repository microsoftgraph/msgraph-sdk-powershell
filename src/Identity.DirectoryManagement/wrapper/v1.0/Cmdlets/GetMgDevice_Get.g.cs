...
{
    [GraphRoute("GET", "/devices/{device-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Device))]
    public class GetMgDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].GetAsync(requestConfiguration =>
                {
