...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.orgContact/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberCountAsOrgContact")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryRoleMemberCountAsOrgContactCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members.GraphOrgContact.Count.GetAsync(requestConfiguration =>
                {
