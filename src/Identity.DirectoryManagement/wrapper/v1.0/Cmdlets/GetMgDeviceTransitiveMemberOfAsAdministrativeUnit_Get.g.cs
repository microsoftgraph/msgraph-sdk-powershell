...
{
    [GraphRoute("GET", "/devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceTransitiveMemberOfAsAdministrativeUnit_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AdministrativeUnit))]
    public class GetMgDeviceTransitiveMemberOfAsAdministrativeUnit_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].TransitiveMemberOf[DirectoryObjectId].GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
