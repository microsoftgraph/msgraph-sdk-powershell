...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryOnPremiseSynchronization_List")]
    ...
    public class GetMgDirectoryOnPremiseSynchronization_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OnPremisesDirectorySynchronizationCollectionResponse? result;
            try
            {
                result = client.Directory.OnPremisesSynchronization.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.OnPremisesSynchronization.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
