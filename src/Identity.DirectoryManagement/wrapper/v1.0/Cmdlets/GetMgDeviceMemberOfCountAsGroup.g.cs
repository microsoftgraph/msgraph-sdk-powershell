...
{
    [GraphRoute("GET", "/devices/{device-id}/memberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgDeviceMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].MemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
