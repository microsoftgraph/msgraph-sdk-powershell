...
{
    [GraphRoute("POST", "/contracts")]
    [Cmdlet(VerbsCommon.New, "MgContract", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Contract))]
    public class NewMgContractCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(DisplayName)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contracts.PostAsync(body, requestConfiguration =>
                {
