...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserByRef")]
    [OutputType(typeof(string))]
    public class GetMgDeviceRegisteredUserByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredUsers.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Devices[DeviceId].RegisteredUsers.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
