...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    public class GetMgContactDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
