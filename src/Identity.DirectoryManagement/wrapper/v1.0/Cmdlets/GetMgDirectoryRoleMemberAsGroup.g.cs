...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgDirectoryRoleMemberAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDirectoryRoleMemberAsGroup_Get or Get-MgDirectoryRoleMemberAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDirectoryRoleMemberAsGroup_Get" : "Get-MgDirectoryRoleMemberAsGroup_List";
            try
            {
