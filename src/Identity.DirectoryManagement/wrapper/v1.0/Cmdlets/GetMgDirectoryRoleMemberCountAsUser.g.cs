...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryRoleMemberCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members.GraphUser.Count.GetAsync(requestConfiguration =>
                {
