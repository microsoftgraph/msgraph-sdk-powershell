...
{
    [GraphRoute("GET", "/organization/{organization-id}")]
    [Cmdlet(VerbsCommon.Get, "MgOrganization_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Organization))]
    public class GetMgOrganization_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Organization[OrganizationId].GetAsync(requestConfiguration =>
                {
