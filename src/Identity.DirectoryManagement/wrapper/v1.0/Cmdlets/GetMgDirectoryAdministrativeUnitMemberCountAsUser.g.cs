...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryAdministrativeUnitMemberCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.GraphUser.Count.GetAsync(requestConfiguration =>
                {
