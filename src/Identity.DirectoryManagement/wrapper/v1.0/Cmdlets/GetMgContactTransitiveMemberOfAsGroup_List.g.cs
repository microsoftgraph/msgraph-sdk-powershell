...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfAsGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Group))]
    public class GetMgContactTransitiveMemberOfAsGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf.GraphGroup.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Contacts[OrgContactId].TransitiveMemberOf.GraphGroup.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
