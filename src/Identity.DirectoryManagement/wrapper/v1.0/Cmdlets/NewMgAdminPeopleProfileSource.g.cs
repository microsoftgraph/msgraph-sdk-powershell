...
{
    [GraphRoute("POST", "/admin/people/profileSources")]
    [Cmdlet(VerbsCommon.New, "MgAdminPeopleProfileSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.ProfileSource))]
    public class NewMgAdminPeopleProfileSourceCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Localizations)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Admin.People.ProfileSources.PostAsync(body, requestConfiguration =>
                {
