...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Device))]
    public class GetMgDirectoryAdministrativeUnitMemberAsDevice_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
