...
{
    [GraphRoute("GET", "/devices/{device-id}/transitiveMemberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceTransitiveMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgDeviceTransitiveMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].TransitiveMemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
