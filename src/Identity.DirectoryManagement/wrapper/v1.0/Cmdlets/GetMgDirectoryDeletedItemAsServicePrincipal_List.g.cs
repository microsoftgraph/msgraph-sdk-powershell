...
{
    [GraphRoute("GET", "/directory/deletedItems/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItemAsServicePrincipal_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.ServicePrincipal))]
    public class GetMgDirectoryDeletedItemAsServicePrincipal_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.DeletedItems.GraphServicePrincipal.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.DeletedItems.GraphServicePrincipal.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
