...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgContactMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].MemberOf.Count.GetAsync(requestConfiguration =>
                {
