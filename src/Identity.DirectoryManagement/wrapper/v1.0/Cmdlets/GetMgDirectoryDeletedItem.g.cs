...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItem", DefaultParameterSetName = "List")]
    ...
    public class GetMgDirectoryDeletedItemCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDirectoryDeletedItem_Get or Get-MgDirectoryDeletedItem_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDirectoryDeletedItem_Get" : "Get-MgDirectoryDeletedItem_List";
            try
            {
