...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfAsAdministrativeUnit", DefaultParameterSetName = "List")]
    ...
    public class GetMgContactTransitiveMemberOfAsAdministrativeUnitCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgContactTransitiveMemberOfAsAdministrativeUnit_Get or Get-MgContactTransitiveMemberOfAsAdministrativeUnit_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgContactTransitiveMemberOfAsAdministrativeUnit_Get" : "Get-MgContactTransitiveMemberOfAsAdministrativeUnit_List";
            try
            {
