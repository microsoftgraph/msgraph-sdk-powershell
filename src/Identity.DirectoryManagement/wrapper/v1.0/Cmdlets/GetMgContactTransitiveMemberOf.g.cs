...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgContactTransitiveMemberOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgContactTransitiveMemberOf_Get or Get-MgContactTransitiveMemberOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgContactTransitiveMemberOf_Get" : "Get-MgContactTransitiveMemberOf_List";
            try
            {
