...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/{directoryObject-id}/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOfAsAdministrativeUnit_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AdministrativeUnit))]
    public class GetMgContactMemberOfAsAdministrativeUnit_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].MemberOf[DirectoryObjectId].GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
