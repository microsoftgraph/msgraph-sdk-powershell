...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleTemplateDelta")]
    ...
    public class GetMgDirectoryRoleTemplateDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoleTemplates.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
