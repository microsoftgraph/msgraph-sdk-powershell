...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/graph.endpoint/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserCountAsEndpoint")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredUserCountAsEndpointCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredUsers.GraphEndpoint.Count.GetAsync(requestConfiguration =>
                {
