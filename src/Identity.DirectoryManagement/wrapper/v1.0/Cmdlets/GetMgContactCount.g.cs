...
{
    [GraphRoute("GET", "/contacts/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactCount")]
    [OutputType(typeof(int))]
    public class GetMgContactCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts.Count.GetAsync(requestConfiguration =>
                {
