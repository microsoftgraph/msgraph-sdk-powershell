...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReport", DefaultParameterSetName = "List")]
    ...
    public class GetMgContactDirectReportCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgContactDirectReport_Get or Get-MgContactDirectReport_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgContactDirectReport_Get" : "Get-MgContactDirectReport_List";
            try
            {
