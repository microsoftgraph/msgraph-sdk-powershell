...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgContactMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].MemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
