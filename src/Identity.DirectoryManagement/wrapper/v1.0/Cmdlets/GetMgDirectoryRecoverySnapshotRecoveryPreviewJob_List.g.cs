...
{
    [GraphRoute("GET", "/directory/recovery/snapshots/{snapshot-id}/recoveryPreviewJobs")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRecoverySnapshotRecoveryPreviewJob_List")]
    ...
    public class GetMgDirectoryRecoverySnapshotRecoveryPreviewJob_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.EntraRecoveryServices.RecoveryPreviewJobCollectionResponse? result;
            try
            {
                result = client.Directory.Recovery.Snapshots[SnapshotId].RecoveryPreviewJobs.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.Recovery.Snapshots[SnapshotId].RecoveryPreviewJobs.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
