...
{
    [GraphRoute("GET", "/users/{user-id}/scopedRoleMemberOf/{scopedRoleMembership-id}")]
    [Cmdlet(VerbsCommon.Get, "MgUserScopedRoleMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.ScopedRoleMembership))]
    public class GetMgUserScopedRoleMemberOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Users[UserId].ScopedRoleMemberOf[ScopedRoleMembershipId].GetAsync(requestConfiguration =>
                {
