...
{
    [GraphRoute("GET", "/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryPublicKeyInfrastructureCertificateBasedAuthConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.CertificateBasedAuthPki))]
    public class GetMgDirectoryPublicKeyInfrastructureCertificateBasedAuthConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.CertificateBasedAuthPkiCollectionResponse? result;
            try
            {
                result = client.Directory.PublicKeyInfrastructure.CertificateBasedAuthConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.PublicKeyInfrastructure.CertificateBasedAuthConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
