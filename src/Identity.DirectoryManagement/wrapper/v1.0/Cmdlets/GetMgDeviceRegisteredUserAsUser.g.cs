...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserAsUser", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceRegisteredUserAsUserCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceRegisteredUserAsUser_Get or Get-MgDeviceRegisteredUserAsUser_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceRegisteredUserAsUser_Get" : "Get-MgDeviceRegisteredUserAsUser_List";
            try
            {
