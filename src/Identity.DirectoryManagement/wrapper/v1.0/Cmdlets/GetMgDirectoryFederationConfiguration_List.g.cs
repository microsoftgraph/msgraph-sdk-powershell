...
{
    [GraphRoute("GET", "/directory/federationConfigurations")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryFederationConfiguration_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.IdentityProviderBase))]
    public class GetMgDirectoryFederationConfiguration_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.IdentityProviderBaseCollectionResponse? result;
            try
            {
                result = client.Directory.FederationConfigurations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.FederationConfigurations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
