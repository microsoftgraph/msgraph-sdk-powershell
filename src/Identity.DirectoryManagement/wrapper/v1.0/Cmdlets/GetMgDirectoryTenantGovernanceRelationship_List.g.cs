...
{
    [GraphRoute("GET", "/directory/tenantGovernance/governanceRelationships")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryTenantGovernanceRelationship_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.GovernanceRelationship))]
    public class GetMgDirectoryTenantGovernanceRelationship_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.GovernanceRelationshipCollectionResponse? result;
            try
            {
                result = client.Directory.TenantGovernance.GovernanceRelationships.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.TenantGovernance.GovernanceRelationships.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
