...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserAsAppRoleAssignment", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceRegisteredUserAsAppRoleAssignmentCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceRegisteredUserAsAppRoleAssignment_Get or Get-MgDeviceRegisteredUserAsAppRoleAssignment_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceRegisteredUserAsAppRoleAssignment_Get" : "Get-MgDeviceRegisteredUserAsAppRoleAssignment_List";
            try
            {
