...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OrgContact))]
    public class GetMgDirectoryRoleMemberAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
