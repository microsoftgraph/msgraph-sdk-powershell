...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgOrganizationBrandingLocalization_List")]
    ...
    public class GetMgOrganizationBrandingLocalization_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OrganizationalBrandingLocalizationCollectionResponse? result;
            try
            {
                result = client.Organization[OrganizationId].Branding.Localizations.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Organization[OrganizationId].Branding.Localizations.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
