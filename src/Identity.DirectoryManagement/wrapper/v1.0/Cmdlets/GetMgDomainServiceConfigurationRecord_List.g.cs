...
{
    [GraphRoute("GET", "/domains/{domain-id}/serviceConfigurationRecords")]
    [Cmdlet(VerbsCommon.Get, "MgDomainServiceConfigurationRecord_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DomainDnsRecord))]
    public class GetMgDomainServiceConfigurationRecord_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DomainDnsRecordCollectionResponse? result;
            try
            {
                result = client.Domains[DomainId].ServiceConfigurationRecords.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Domains[DomainId].ServiceConfigurationRecords.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
