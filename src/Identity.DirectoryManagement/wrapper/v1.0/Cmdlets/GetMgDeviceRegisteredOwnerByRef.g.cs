...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredOwners/$ref")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredOwnerByRef")]
    [OutputType(typeof(string))]
    public class GetMgDeviceRegisteredOwnerByRefCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredOwners.Ref.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Devices[DeviceId].RegisteredOwners.Ref.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
