...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserCount")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredUserCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredUsers.Count.GetAsync(requestConfiguration =>
                {
