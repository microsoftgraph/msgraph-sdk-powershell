...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceMemberOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceMemberOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceMemberOf_Get or Get-MgDeviceMemberOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceMemberOf_Get" : "Get-MgDeviceMemberOf_List";
            try
            {
