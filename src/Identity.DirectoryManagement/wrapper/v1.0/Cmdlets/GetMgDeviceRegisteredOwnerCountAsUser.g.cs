...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredOwners/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredOwnerCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredOwnerCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredOwners.GraphUser.Count.GetAsync(requestConfiguration =>
                {
