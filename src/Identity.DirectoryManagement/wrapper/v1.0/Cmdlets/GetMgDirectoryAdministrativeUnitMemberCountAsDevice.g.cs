...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/graph.device/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberCountAsDevice")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryAdministrativeUnitMemberCountAsDeviceCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.GraphDevice.Count.GetAsync(requestConfiguration =>
                {
