...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    public class RemoveMgDirectoryCustomSecurityAttributeDefinitionCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, CustomSecurityAttributeDefinitionId));
                return;
            }
        }
    }
