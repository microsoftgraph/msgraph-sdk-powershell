...
{
    [GraphRoute("GET", "/devices/{device-id}/transitiveMemberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceTransitiveMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgDeviceTransitiveMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].TransitiveMemberOf.Count.GetAsync(requestConfiguration =>
                {
