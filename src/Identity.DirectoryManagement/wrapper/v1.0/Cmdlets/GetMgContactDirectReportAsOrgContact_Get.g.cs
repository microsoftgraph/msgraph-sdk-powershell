...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReportAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OrgContact))]
    public class GetMgContactDirectReportAsOrgContact_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].DirectReports[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
