...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfAsAdministrativeUnit_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AdministrativeUnit))]
    public class GetMgContactTransitiveMemberOfAsAdministrativeUnit_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf.GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Contacts[OrgContactId].TransitiveMemberOf.GraphAdministrativeUnit.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
