...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberCount")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryAdministrativeUnitMemberCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.Count.GetAsync(requestConfiguration =>
                {
