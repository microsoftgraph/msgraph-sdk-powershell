...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredOwners/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredOwnerCount")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredOwnerCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredOwners.Count.GetAsync(requestConfiguration =>
                {
