...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgDirectoryRoleMemberAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDirectoryRoleMemberAsServicePrincipal_Get or Get-MgDirectoryRoleMemberAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDirectoryRoleMemberAsServicePrincipal_Get" : "Get-MgDirectoryRoleMemberAsServicePrincipal_List";
            try
            {
