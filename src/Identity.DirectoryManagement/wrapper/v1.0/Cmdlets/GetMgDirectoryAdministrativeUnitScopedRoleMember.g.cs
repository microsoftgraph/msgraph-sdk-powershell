...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    public class GetMgDirectoryAdministrativeUnitScopedRoleMemberCommand : GraphClientCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                ThrowGraphRequestFailed(ex, ParameterSetName == "Get" ? ScopedRoleMembershipId : AdministrativeUnitId);
                return;
            }
        }
    }
