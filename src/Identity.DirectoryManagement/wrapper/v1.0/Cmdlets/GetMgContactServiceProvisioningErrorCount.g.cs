...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/serviceProvisioningErrors/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactServiceProvisioningErrorCount")]
    [OutputType(typeof(int))]
    public class GetMgContactServiceProvisioningErrorCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].ServiceProvisioningErrors.Count.GetAsync(requestConfiguration =>
                {
