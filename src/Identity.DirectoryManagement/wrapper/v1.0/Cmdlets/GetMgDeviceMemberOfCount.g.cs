...
{
    [GraphRoute("GET", "/devices/{device-id}/memberOf/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceMemberOfCount")]
    [OutputType(typeof(int))]
    public class GetMgDeviceMemberOfCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].MemberOf.Count.GetAsync(requestConfiguration =>
                {
