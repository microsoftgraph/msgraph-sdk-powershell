...
{
    [GraphRoute("GET", "/directory/deletedItems/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItemAsDevice_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Device))]
    public class GetMgDirectoryDeletedItemAsDevice_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DeviceCollectionResponse? result;
            try
            {
                result = client.Directory.DeletedItems.GraphDevice.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.DeletedItems.GraphDevice.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
