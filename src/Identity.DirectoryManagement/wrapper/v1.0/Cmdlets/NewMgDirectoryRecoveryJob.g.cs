...
{
    [GraphRoute("POST", "/directory/recovery/jobs")]
    [Cmdlet(VerbsCommon.New, "MgDirectoryRecoveryJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class NewMgDirectoryRecoveryJobCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Status)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.Recovery.Jobs.PostAsync(body, requestConfiguration =>
                {
