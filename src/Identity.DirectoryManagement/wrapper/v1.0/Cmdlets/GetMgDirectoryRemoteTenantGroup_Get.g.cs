...
{
    [GraphRoute("GET", "/directory/remoteTenantGroups/{remoteTenantGroup-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRemoteTenantGroup_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.RemoteTenantGroup))]
    public class GetMgDirectoryRemoteTenantGroup_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.RemoteTenantGroups[RemoteTenantGroupId].GetAsync(requestConfiguration =>
                {
