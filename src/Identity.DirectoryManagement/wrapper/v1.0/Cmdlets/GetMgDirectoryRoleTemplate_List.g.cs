...
{
    [GraphRoute("GET", "/directoryRoleTemplates")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleTemplate_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryRoleTemplate))]
    public class GetMgDirectoryRoleTemplate_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryRoleTemplateCollectionResponse? result;
            try
            {
                result = client.DirectoryRoleTemplates.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DirectoryRoleTemplates.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
