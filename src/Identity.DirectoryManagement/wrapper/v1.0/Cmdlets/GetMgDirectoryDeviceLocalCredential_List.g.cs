...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeviceLocalCredential_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DeviceLocalCredentialInfo))]
    public class GetMgDirectoryDeviceLocalCredential_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DeviceLocalCredentialInfoCollectionResponse? result;
            try
            {
                result = client.Directory.DeviceLocalCredentials.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.DeviceLocalCredentials.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
