...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/memberOf/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgContactMemberOfAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgContactMemberOfAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgContactMemberOfAsGroup_Get or Get-MgContactMemberOfAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgContactMemberOfAsGroup_Get" : "Get-MgContactMemberOfAsGroup_List";
            try
            {
