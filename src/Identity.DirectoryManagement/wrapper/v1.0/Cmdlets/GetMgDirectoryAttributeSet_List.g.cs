...
{
    [GraphRoute("GET", "/directory/attributeSets")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAttributeSet_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AttributeSet))]
    public class GetMgDirectoryAttributeSet_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AttributeSetCollectionResponse? result;
            try
            {
                result = client.Directory.AttributeSets.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.AttributeSets.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
