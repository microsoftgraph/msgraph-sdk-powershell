...
{
    [GraphRoute("POST", "/directoryRoles")]
    [Cmdlet(VerbsCommon.New, "MgDirectoryRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryRole))]
    public class NewMgDirectoryRoleCommand : GraphClientCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(RoleTemplateId)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles.PostAsync(body, requestConfiguration =>
                {
