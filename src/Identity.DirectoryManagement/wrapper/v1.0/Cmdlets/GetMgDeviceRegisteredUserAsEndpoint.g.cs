...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/graph.endpoint")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserAsEndpoint", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceRegisteredUserAsEndpointCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceRegisteredUserAsEndpoint_Get or Get-MgDeviceRegisteredUserAsEndpoint_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceRegisteredUserAsEndpoint_Get" : "Get-MgDeviceRegisteredUserAsEndpoint_List";
            try
            {
