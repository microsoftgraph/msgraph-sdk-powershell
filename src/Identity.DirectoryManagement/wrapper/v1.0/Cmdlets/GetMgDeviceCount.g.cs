...
{
    [GraphRoute("GET", "/devices/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceCount")]
    [OutputType(typeof(int))]
    public class GetMgDeviceCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices.Count.GetAsync(requestConfiguration =>
                {
