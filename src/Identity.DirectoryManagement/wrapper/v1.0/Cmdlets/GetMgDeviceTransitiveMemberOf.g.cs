...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceTransitiveMemberOf", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceTransitiveMemberOfCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceTransitiveMemberOf_Get or Get-MgDeviceTransitiveMemberOf_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceTransitiveMemberOf_Get" : "Get-MgDeviceTransitiveMemberOf_List";
            try
            {
