...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItemAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgDirectoryDeletedItemAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDirectoryDeletedItemAsServicePrincipal_Get or Get-MgDirectoryDeletedItemAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDirectoryDeletedItemAsServicePrincipal_Get" : "Get-MgDirectoryDeletedItemAsServicePrincipal_List";
            try
            {
