...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/manager")]
    [Cmdlet(VerbsCommon.Get, "MgContactManager")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgContactManagerCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].Manager.GetAsync(requestConfiguration =>
                {
