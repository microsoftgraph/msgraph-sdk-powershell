...
{
    [GraphRoute("GET", "/directory/deletedItems/graph.application")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItemAsApplication_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Application))]
    public class GetMgDirectoryDeletedItemAsApplication_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.DeletedItems.GraphApplication.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.DeletedItems.GraphApplication.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
