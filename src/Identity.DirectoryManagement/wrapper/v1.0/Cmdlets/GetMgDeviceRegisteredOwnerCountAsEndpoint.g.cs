...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredOwners/graph.endpoint/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredOwnerCountAsEndpoint")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredOwnerCountAsEndpointCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredOwners.GraphEndpoint.Count.GetAsync(requestConfiguration =>
                {
