...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/graph.group/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfCountAsGroup")]
    [OutputType(typeof(int))]
    public class GetMgContactTransitiveMemberOfCountAsGroupCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf.GraphGroup.Count.GetAsync(requestConfiguration =>
                {
