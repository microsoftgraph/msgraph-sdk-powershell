...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsUser", DefaultParameterSetName = "List")]
    ...
    public class GetMgDirectoryRoleMemberAsUserCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDirectoryRoleMemberAsUser_Get or Get-MgDirectoryRoleMemberAsUser_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDirectoryRoleMemberAsUser_Get" : "Get-MgDirectoryRoleMemberAsUser_List";
            try
            {
