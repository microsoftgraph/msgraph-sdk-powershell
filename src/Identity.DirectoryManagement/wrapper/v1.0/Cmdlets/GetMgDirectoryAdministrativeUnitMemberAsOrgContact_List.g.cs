...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberAsOrgContact_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OrgContact))]
    public class GetMgDirectoryAdministrativeUnitMemberAsOrgContact_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.GraphOrgContact.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members.GraphOrgContact.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
