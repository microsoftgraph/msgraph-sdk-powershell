...
{
    [GraphRoute("GET", "/directory/deletedItems/graph.group")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeletedItemAsGroup_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Group))]
    public class GetMgDirectoryDeletedItemAsGroup_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.DeletedItems.GraphGroup.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.Directory.DeletedItems.GraphGroup.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
