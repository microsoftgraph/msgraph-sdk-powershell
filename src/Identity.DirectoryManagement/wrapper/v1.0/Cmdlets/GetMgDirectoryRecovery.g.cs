...
{
    [GraphRoute("GET", "/directory/recovery")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRecovery")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.EntraRecoveryServices.Recovery))]
    public class GetMgDirectoryRecoveryCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.Recovery.GetAsync(requestConfiguration =>
                {
