...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReportCount")]
    [OutputType(typeof(int))]
    public class GetMgContactDirectReportCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].DirectReports.Count.GetAsync(requestConfiguration =>
                {
