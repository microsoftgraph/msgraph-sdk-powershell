...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    public class UpdateMgAdminPeopleProfileSourceCommand : PSCmdlet
    {
    ...
    if (this.IsParameterBound(nameof(Localizations)))
        ...
        var client = new ApiClient(requestAdapter);
            ...
            {
                ThrowTerminatingError(new ErrorRecord(ex, "GraphRequestFailed", ErrorCategory.InvalidOperation, ProfileSourceId));
                return;
            }
