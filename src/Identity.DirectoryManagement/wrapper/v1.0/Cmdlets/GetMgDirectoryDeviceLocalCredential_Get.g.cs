...
{
    [GraphRoute("GET", "/directory/deviceLocalCredentials/{deviceLocalCredentialInfo-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryDeviceLocalCredential_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DeviceLocalCredentialInfo))]
    public class GetMgDirectoryDeviceLocalCredential_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.DeviceLocalCredentials[DeviceLocalCredentialInfoId].GetAsync(requestConfiguration =>
                {
