...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/graph.user")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsUser_List")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.User))]
    public class GetMgDirectoryRoleMemberAsUser_ListCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members.GraphUser.GetAsync(requestConfiguration =>
                {
        ...
        AddRequestHeaders(requestConfiguration.Headers);
                ...
                if (All.IsPresent)
                {
                    ...
                    while (!string.IsNullOrEmpty(nextLink) && !Stopping && (!this.IsParameterBound(nameof(Top)) || fetched < Top))
                    {
                        ...
                        result = client.DirectoryRoles[DirectoryRoleId].Members.GraphUser.WithUrl(nextLink).GetAsync(requestConfiguration =>
                        {
