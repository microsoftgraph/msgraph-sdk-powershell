...
{
    [GraphRoute("GET", "/devices/{device-id}/memberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgDeviceMemberOf_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].MemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
