...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredOwners/graph.servicePrincipal")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredOwnerAsServicePrincipal", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceRegisteredOwnerAsServicePrincipalCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceRegisteredOwnerAsServicePrincipal_Get or Get-MgDeviceRegisteredOwnerAsServicePrincipal_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceRegisteredOwnerAsServicePrincipal_Get" : "Get-MgDeviceRegisteredOwnerAsServicePrincipal_List";
            try
            {
