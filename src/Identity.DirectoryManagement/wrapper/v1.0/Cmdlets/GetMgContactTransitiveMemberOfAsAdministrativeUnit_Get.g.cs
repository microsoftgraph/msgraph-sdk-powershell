...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/{directoryObject-id}/graph.administrativeUnit")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOfAsAdministrativeUnit_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.AdministrativeUnit))]
    public class GetMgContactTransitiveMemberOfAsAdministrativeUnit_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf[DirectoryObjectId].GraphAdministrativeUnit.GetAsync(requestConfiguration =>
                {
