...
{
    [GraphRoute("GET", "/directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.orgContact")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryAdministrativeUnitMemberAsOrgContact_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OrgContact))]
    public class GetMgDirectoryAdministrativeUnitMemberAsOrgContact_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Directory.AdministrativeUnits[AdministrativeUnitId].Members[DirectoryObjectId].GraphOrgContact.GetAsync(requestConfiguration =>
                {
