...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/transitiveMemberOf/{directoryObject-id}")]
    [Cmdlet(VerbsCommon.Get, "MgContactTransitiveMemberOf_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.DirectoryObject))]
    public class GetMgContactTransitiveMemberOf_GetCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].TransitiveMemberOf[DirectoryObjectId].GetAsync(requestConfiguration =>
                {
