...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/onPremisesSyncBehavior")]
    [Cmdlet(VerbsCommon.Get, "MgContactOnPremiseSyncBehavior")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.OnPremisesSyncBehavior))]
    public class GetMgContactOnPremiseSyncBehaviorCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].OnPremisesSyncBehavior.GetAsync(requestConfiguration =>
                {
