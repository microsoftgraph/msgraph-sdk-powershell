...
{
    [GraphRoute("GET", "/directoryRoles/{directoryRole-id}/members/{directoryObject-id}/graph.device")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryRoleMemberAsDevice_Get")]
    [OutputType(typeof(Microsoft.Graph.PowerShell.Identity.DirectoryManagement.Client.Models.Device))]
    public class GetMgDirectoryRoleMemberAsDevice_GetCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryRoles[DirectoryRoleId].Members[DirectoryObjectId].GraphDevice.GetAsync(requestConfiguration =>
                {
