...
{
    [GraphRoute("GET", "/contacts/{orgContact-id}/directReports/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgContactDirectReportCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgContactDirectReportCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Contacts[OrgContactId].DirectReports.GraphUser.Count.GetAsync(requestConfiguration =>
                {
