...
{
    [GraphRoute("GET", "/devices/{device-id}/registeredUsers/graph.user/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDeviceRegisteredUserCountAsUser")]
    [OutputType(typeof(int))]
    public class GetMgDeviceRegisteredUserCountAsUserCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.Devices[DeviceId].RegisteredUsers.GraphUser.Count.GetAsync(requestConfiguration =>
                {
