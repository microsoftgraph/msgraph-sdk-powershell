...
namespace Microsoft.Graph.PowerShell.Identity.DirectoryManagement
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceMemberOfAsGroup", DefaultParameterSetName = "List")]
    ...
    public class GetMgDeviceMemberOfAsGroupCommand : GraphClientCmdlet
    {
        ...
        // Delegates to Get-MgDeviceMemberOfAsGroup_Get or Get-MgDeviceMemberOfAsGroup_List, the two cmdlets
        // that actually call Graph.
        protected override void ProcessRecord()
        {
            var internalCmdletName = ParameterSetName == "Get" ? "Get-MgDeviceMemberOfAsGroup_Get" : "Get-MgDeviceMemberOfAsGroup_List";
            try
            {
