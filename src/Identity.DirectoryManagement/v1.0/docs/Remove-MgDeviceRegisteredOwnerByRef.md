...
### Delete (Default)
```
Remove-MgDeviceRegisteredOwnerByRef -DeviceId <String> -DirectoryObjectId <String> [-IfMatch <String>]
...
### Delete1
```
Remove-MgDeviceRegisteredOwnerByRef -DeviceId <String> -Id <String> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### DeleteViaIdentity
```
Remove-MgDeviceRegisteredOwnerByRef -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
