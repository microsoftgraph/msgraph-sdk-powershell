...
### Verify (Default)
```
Confirm-MgDomain -DomainId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### VerifyViaIdentity
```
Confirm-MgDomain -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>] [-Confirm]
