...
```
Update-MgBetaDirectorySubscription -CompanySubscriptionId <String> [-CommerceSubscriptionId <String>]
 [-OcpSubscriptionId <String>] [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
...
### Update1
```
Update-MgBetaDirectorySubscription -CommerceSubscriptionId <String>
 -BodyParameter <IMicrosoftGraphCompanySubscription> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Update2
```
Update-MgBetaDirectorySubscription -OcpSubscriptionId <String>
 -BodyParameter <IMicrosoftGraphCompanySubscription> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateExpanded1
```
Update-MgBetaDirectorySubscription -CommerceSubscriptionId <String> [-OcpSubscriptionId <String>]
...
### UpdateExpanded2
```
Update-MgBetaDirectorySubscription -OcpSubscriptionId <String> [-CommerceSubscriptionId <String>]
...
```
Update-MgBetaDirectorySubscription -InputObject <IIdentityDirectoryManagementIdentity>
 [-CommerceSubscriptionId <String>] [-OcpSubscriptionId <String>] [-AdditionalProperties <Hashtable>]
...
```yaml
Type: System.String
Parameter Sets: Update1, UpdateExpanded, UpdateExpanded1, UpdateExpanded2, UpdateViaIdentityExpanded, UpdateViaIdentityExpanded1, UpdateViaIdentityExpanded2
Aliases:
