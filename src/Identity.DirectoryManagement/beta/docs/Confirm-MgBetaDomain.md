...
### Verify (Default)
```
Confirm-MgBetaDomain -DomainId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### VerifyViaIdentity
```
Confirm-MgBetaDomain -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>] [-Confirm]
