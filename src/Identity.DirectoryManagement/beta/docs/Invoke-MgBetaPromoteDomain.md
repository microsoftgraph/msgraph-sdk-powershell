...
### Promote (Default)
```
Invoke-MgBetaPromoteDomain -DomainId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-MgBetaPromoteDomain -InputObject <IIdentityDirectoryManagementIdentity>
