...
### Promote (Default)
```
Invoke-MgBetaPromoteDomain -DomainId <String> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-MgBetaPromoteDomain -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>]
