...
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-IsActive] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId <String>
 -BodyParameter <IMicrosoftGraphAllowedValue> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue
 ...
 [-IsActive] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
