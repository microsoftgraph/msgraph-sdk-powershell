...
Update-MgBetaDirectoryAdministrativeUnitScopedRoleMember -AdministrativeUnitId <String>
 ...
 [-Id <String>] [-ResponseHeadersVariable <String>] [-RoleId <String>]
 [-RoleMemberInfo <IMicrosoftGraphIdentity>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDirectoryAdministrativeUnitScopedRoleMember -InputObject <IIdentityDirectoryManagementIdentity>
 [-AdministrativeUnitId <String>] [-AdditionalProperties <Hashtable>] [-Id <String>]
