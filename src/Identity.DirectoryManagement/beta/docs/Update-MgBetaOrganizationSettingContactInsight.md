...
Update-MgBetaOrganizationSettingContactInsight -OrganizationId <String> [-AdditionalProperties <Hashtable>]
 [-DisabledForGroup <String>] [-Id <String>] [-IsEnabledInOrganization] [-Headers <IDictionary>] [-Confirm]
...
Update-MgBetaOrganizationSettingContactInsight -OrganizationId <String>
 -BodyParameter <IMicrosoftGraphInsightsSettings> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
