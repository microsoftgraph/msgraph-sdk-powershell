...
Remove-MgBetaDirectoryOutboundSharedUserProfileTenantPersonalData -OutboundSharedUserProfileUserId <String>
 -TenantReferenceTenantId <String> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Remove-MgBetaDirectoryOutboundSharedUserProfileTenantPersonalData
 -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
