...
Update-MgBetaOrganizationSettingMicrosoftApplicationDataAccess -OrganizationId <String>
 ...
 [-IsEnabledForAllMicrosoftApplications] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
...
Update-MgBetaOrganizationSettingMicrosoftApplicationDataAccess
 ...
 [-DisabledForGroup <String>] [-Id <String>] [-IsEnabledForAllMicrosoftApplications]
