...
### List (Default)
```
Get-MgBetaSubscribedSku [-Property <String[]>] [-Search <String>] [-Sort <String[]>]
...
### Get
```
Get-MgBetaSubscribedSku -SubscribedSkuId <String> [-Property <String[]>] [-ResponseHeadersVariable <String>]
