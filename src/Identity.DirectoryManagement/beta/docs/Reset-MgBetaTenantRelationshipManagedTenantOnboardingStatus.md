...
### Reset (Default)
```
Reset-MgBetaTenantRelationshipManagedTenantOnboardingStatus -TenantId <String> [-Headers <IDictionary>]
...
```
Reset-MgBetaTenantRelationshipManagedTenantOnboardingStatus
 -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
