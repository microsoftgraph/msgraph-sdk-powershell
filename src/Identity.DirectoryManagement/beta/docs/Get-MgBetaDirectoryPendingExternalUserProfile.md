...
### List (Default)
```
Get-MgBetaDirectoryPendingExternalUserProfile [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDirectoryPendingExternalUserProfile -PendingExternalUserProfileId <String>
...
### GetViaIdentity
```
Get-MgBetaDirectoryPendingExternalUserProfile -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [<CommonParameters>]
```
