...
### Complete (Default)
```
Complete-MgBetaDirectoryImpactedResource -ImpactedResourceId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaDirectoryImpactedResource -InputObject <IIdentityDirectoryManagementIdentity> [-Confirm]
