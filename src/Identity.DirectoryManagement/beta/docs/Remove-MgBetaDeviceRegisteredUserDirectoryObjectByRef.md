...
### Delete (Default)
```
Remove-MgBetaDeviceRegisteredUserDirectoryObjectByRef -DeviceId <String> -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceRegisteredUserDirectoryObjectByRef -InputObject <IIdentityDirectoryManagementIdentity>
 [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
