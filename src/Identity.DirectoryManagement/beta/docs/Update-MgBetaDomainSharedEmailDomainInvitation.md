...
Update-MgBetaDomainSharedEmailDomainInvitation -DomainId <String> -SharedEmailDomainInvitationId <String>
 ...
 [-InvitationStatus <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDomainSharedEmailDomainInvitation -DomainId <String> -SharedEmailDomainInvitationId <String>
 -BodyParameter <IMicrosoftGraphSharedEmailDomainInvitation> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
