...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 ...
 [-Issuer <String>] [-IssuerSubjectKeyIdentifier <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 -CertificateAuthorityAsEntityId <String> -CertificateBasedApplicationConfigurationId <String>
 -BodyParameter <IMicrosoftGraphCertificateAuthorityAsEntity> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 ...
 [-IssuerSubjectKeyIdentifier <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
