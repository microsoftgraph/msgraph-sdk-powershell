...
Update-MgBetaDirectorySharedEmailDomain -SharedEmailDomainId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-ProvisioningStatus <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectorySharedEmailDomain -SharedEmailDomainId <String>
 -BodyParameter <IMicrosoftGraphSharedEmailDomain> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
