...
Update-MgBetaOrganizationPartnerInformation -OrganizationId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SupportUrl <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaOrganizationPartnerInformation -OrganizationId <String>
 -BodyParameter <IMicrosoftGraphPartnerInformation> [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
