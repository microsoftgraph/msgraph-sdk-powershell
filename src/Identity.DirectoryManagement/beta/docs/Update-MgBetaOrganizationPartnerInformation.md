...
Update-MgBetaOrganizationPartnerInformation -OrganizationId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-PartnerTenantId <String>] [-ResponseHeadersVariable <String>] [-SupportEmails <String[]>]
 [-SupportTelephones <String[]>] [-SupportUrl <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaOrganizationPartnerInformation -InputObject <IIdentityDirectoryManagementIdentity>
 ...
 [-HelpUrl <String>] [-PartnerTenantId <String>] [-ResponseHeadersVariable <String>]
