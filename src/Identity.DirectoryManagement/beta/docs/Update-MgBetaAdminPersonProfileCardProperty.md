...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetaadminpersonprofilecardproperty
schema: 2.0.0
---
...
```
Update-MgBetaAdminPersonProfileCardProperty -ProfileCardPropertyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaAdminPersonProfileCardProperty -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphProfileCardProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
