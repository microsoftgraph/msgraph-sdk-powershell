...
Update-MgBetaDeviceUsageRights -DeviceId <String> -UsageRightId <String> [-AdditionalProperties <Hashtable>]
 [-CatalogId <String>] [-Id <String>] [-ResponseHeadersVariable <String>] [-ServiceIdentifier <String>]
...
```
Update-MgBetaDeviceUsageRights -InputObject <IIdentityDirectoryManagementIdentity>
 [-AdditionalProperties <Hashtable>] [-CatalogId <String>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-ServiceIdentifier <String>] [-State <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
