...
namespace Microsoft.Graph.PowerShell.DirectoryObjects
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDirectoryObjectGetMemberObjects", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDirectoryObjectGetMemberObjectsCommand : GraphClientCmdlet
    {
