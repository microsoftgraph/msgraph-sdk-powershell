...
namespace Microsoft.Graph.PowerShell.DirectoryObjects
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDirectoryObjectGetByIds", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDirectoryObjectGetByIdsCommand : GraphClientCmdlet
    {
