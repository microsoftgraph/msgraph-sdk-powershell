...
namespace Microsoft.Graph.PowerShell.DirectoryObjects
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDirectoryObjectGetMemberGroups", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDirectoryObjectGetMemberGroupsCommand : GraphClientCmdlet
    {
