...
namespace Microsoft.Graph.PowerShell.DirectoryObjects
{
    ...
    [Cmdlet(VerbsLifecycle.Invoke, "MgDirectoryObjectCheckMemberGroups", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    ...
    public class InvokeMgDirectoryObjectCheckMemberGroupsCommand : GraphClientCmdlet
    {
