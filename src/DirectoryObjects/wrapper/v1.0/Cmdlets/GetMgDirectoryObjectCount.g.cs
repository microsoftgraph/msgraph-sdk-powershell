...
{
    [GraphRoute("GET", "/directoryObjects/$count")]
    [Cmdlet(VerbsCommon.Get, "MgDirectoryObjectCount")]
    [OutputType(typeof(int))]
    public class GetMgDirectoryObjectCountCommand : GraphClientCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            try
            {
                result = client.DirectoryObjects.Count.GetAsync(requestConfiguration =>
                {
