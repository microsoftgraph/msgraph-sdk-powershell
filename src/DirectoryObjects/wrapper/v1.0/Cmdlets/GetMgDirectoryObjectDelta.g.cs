...
namespace Microsoft.Graph.PowerShell.DirectoryObjects
{
    ...
    public class GetMgDirectoryObjectDeltaCommand : PSCmdlet
    {
        ...
        var client = new ApiClient(requestAdapter);
            ...
            global::Microsoft.Graph.PowerShell.DirectoryObjects.Client.DirectoryObjects.Delta.DeltaGetResponse? result;
            try
            {
                result = client.DirectoryObjects.Delta.GetAsDeltaGetResponseAsync(requestConfiguration =>
                {
