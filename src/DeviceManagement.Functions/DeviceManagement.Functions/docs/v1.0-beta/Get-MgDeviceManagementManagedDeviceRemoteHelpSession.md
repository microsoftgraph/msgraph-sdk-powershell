...
### Retrieve (Default)
```
Get-MgDeviceManagementManagedDeviceRemoteHelpSession -ManagedDeviceId <String> -SessionKey <String>
 [<CommonParameters>]
```

### RetrieveViaIdentity
```
Get-MgDeviceManagementManagedDeviceRemoteHelpSession -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
