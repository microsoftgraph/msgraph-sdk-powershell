...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementcomanageddevicecloudpcremoteactionresult
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementComanagedDeviceCloudPcRemoteActionResult -ManagedDeviceId <String> [<CommonParameters>]
```
