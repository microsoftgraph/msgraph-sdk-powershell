...
### Get (Default)
```
Get-MgBetaDeviceManagementManagedDeviceOemWarranty -ManagedDeviceId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceOemWarranty -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
