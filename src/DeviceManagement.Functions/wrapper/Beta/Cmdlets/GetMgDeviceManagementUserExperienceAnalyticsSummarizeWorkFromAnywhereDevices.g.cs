...
namespace Microsoft.Graph.PowerShell.DeviceManagement.Functions
{
    ...
    [Cmdlet(VerbsCommon.Get, "MgDeviceManagementUserExperienceAnalyticsSummarizeWorkFromAnywhereDevices")]
    ...
    public class GetMgDeviceManagementUserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesCommand : GraphClientCmdlet
    {
