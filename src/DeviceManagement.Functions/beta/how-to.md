# How-To
This document describes how to develop for `Microsoft.Graph.Beta.DeviceManagement.Functions`.

## Building `Microsoft.Graph.Beta.DeviceManagement.Functions`
...
## Testing `Microsoft.Graph.Beta.DeviceManagement.Functions`
...
## Packing `Microsoft.Graph.Beta.DeviceManagement.Functions`
...
There are multiple scripts created for performing different actions for developing `Microsoft.Graph.Beta.DeviceManagement.Functions`.
- `build-module.ps1`
  - Builds the module DLL (`./bin/Microsoft.Graph.Beta.DeviceManagement.Functions.private.dll`), creates the exported cmdlets and documentation, generates custom cmdlet test stubs and exported cmdlet example stubs, and updates `./Microsoft.Graph.Beta.DeviceManagement.Functions.psd1` with Azure profile information.
  - **Parameters**: [`Switch` parameters]
    - `-Run`: After building, creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.DeviceManagement.Functions`.
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Microsoft.Graph.Beta.DeviceManagement.Functions` into the session.
