...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      /planner/buckets/{plannerBucket-id}/tasks/microsoft.graph.delta(): v1.0-beta
      /planner/buckets/microsoft.graph.delta(): v1.0-beta
      ...
      /planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/microsoft.graph.delta(): v1.0-beta
      /planner/plans/{plannerPlan-id}/buckets/microsoft.graph.delta(): v1.0-beta
      ...
      /planner/plans/{plannerPlan-id}/tasks/microsoft.graph.delta(): v1.0-beta
      /planner/plans/microsoft.graph.delta(): v1.0-beta
      ...
      /planner/rosters/{plannerRoster-id}/plans/{plannerPlan-id}: v1.0-beta
      ...
      /planner/tasks/microsoft.graph.delta(): v1.0-beta
      ...
      /users/{user-id}/planner/rosterPlans/{plannerPlan-id}: v1.0-beta
