...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      ? /compliance/ediscovery/cases/{case-id}/sourceCollections/{sourceCollection-id}/noncustodialSources/microsoft.graph.ediscovery.applyHold
      : v1.0-beta
      ? /compliance/ediscovery/cases/{case-id}/sourceCollections/{sourceCollection-id}/noncustodialSources/microsoft.graph.ediscovery.removeHold
      : v1.0-beta
