...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      /print/printerShares/{printerShare-id}/allowedUsers/{user-id}/mailboxSettings: v1.0-beta
      ...
      /print/shares/{printerShare-id}/allowedUsers/{user-id}/mailboxSettings: v1.0-beta
