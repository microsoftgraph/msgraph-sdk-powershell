...
profiles:
  v1.0:
    ...
    operations:
      ...
      /applications/{application-id}/appManagementPolicies: v1.0
      /applications/{application-id}/appManagementPolicies/{appManagementPolicy-id}/$ref: v1.0
      /applications/{application-id}/appManagementPolicies/$ref: v1.0
      ...
      /servicePrincipals/{servicePrincipal-id}/appManagementPolicies: v1.0
      /servicePrincipals/{servicePrincipal-id}/appManagementPolicies/{appManagementPolicy-id}: v1.0
