...
profiles:
  v1.0:
    ...
    operations:
      ...
      /deviceManagement/auditEvents: v1.0
      /deviceManagement/auditEvents/{auditEvent-id}: v1.0
      ...
      /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus-id}/termsAndConditions: v1.0
